...
def forward(self, primals, tangents):
    ...
    full: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_1: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_2: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_3: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_4: "f32[8, 196, 1000]" = torch.ops.aten.full.default([8, 196, 1000], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_11: "f32[8, 1, 384]" = torch.ops.aten.full.default([8, 1, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_18: "f32[8, 1, 384]" = torch.ops.aten.full.default([8, 1, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    view_669: "f32[192]" = torch.ops.aten.view.default(sum_221, [192]);  sum_221 = None
    ...
    view_672: "f32[576]" = torch.ops.aten.view.default(sum_222, [576]);  sum_222 = None
    ...
    mul_587: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_583, sum_224);  sum_224 = None
    ...
    view_674: "f32[192]" = torch.ops.aten.view.default(sum_227, [192]);  sum_227 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/volo.py:88, code: x = F.fold(x, output_size=(H, W), kernel_size=self.kernel_size, padding=self.padding, stride=self.stride)
    iota_32: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_62: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_32, 0);  iota_32 = None
    iota_33: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_34: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_64: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_34, 0);  iota_34 = None
    iota_35: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    view_684: "f32[486]" = torch.ops.aten.view.default(sum_229, [486]);  sum_229 = None
    ...
    iota_36: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_68: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_36, 0);  iota_36 = None
    iota_37: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_38: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_72: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_38, 0);  iota_38 = None
    iota_39: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    full_23: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    mul_597: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_593, sum_231);  sum_231 = None
    ...
    view_691: "f32[192]" = torch.ops.aten.view.default(sum_234, [192]);  sum_234 = None
    ...
    view_694: "f32[576]" = torch.ops.aten.view.default(sum_235, [576]);  sum_235 = None
    ...
    mul_611: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_607, sum_237);  sum_237 = None
    ...
    view_696: "f32[192]" = torch.ops.aten.view.default(sum_240, [192]);  sum_240 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/volo.py:88, code: x = F.fold(x, output_size=(H, W), kernel_size=self.kernel_size, padding=self.padding, stride=self.stride)
    iota_40: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_74: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_40, 0);  iota_40 = None
    iota_41: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_42: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_76: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_42, 0);  iota_42 = None
    iota_43: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    view_706: "f32[486]" = torch.ops.aten.view.default(sum_242, [486]);  sum_242 = None
    ...
    iota_44: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_80: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_44, 0);  iota_44 = None
    iota_45: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_46: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_84: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_46, 0);  iota_46 = None
    iota_47: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    full_24: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    mul_621: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_617, sum_244);  sum_244 = None
    ...
    view_713: "f32[192]" = torch.ops.aten.view.default(sum_247, [192]);  sum_247 = None
    ...
    view_716: "f32[576]" = torch.ops.aten.view.default(sum_248, [576]);  sum_248 = None
    ...
    mul_635: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_631, sum_250);  sum_250 = None
    ...
    view_718: "f32[192]" = torch.ops.aten.view.default(sum_253, [192]);  sum_253 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/volo.py:88, code: x = F.fold(x, output_size=(H, W), kernel_size=self.kernel_size, padding=self.padding, stride=self.stride)
    iota_48: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_86: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_48, 0);  iota_48 = None
    iota_49: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_50: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_88: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_50, 0);  iota_50 = None
    iota_51: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    view_728: "f32[486]" = torch.ops.aten.view.default(sum_255, [486]);  sum_255 = None
    ...
    iota_52: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_92: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_52, 0);  iota_52 = None
    iota_53: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_54: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_96: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_54, 0);  iota_54 = None
    iota_55: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    full_25: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    mul_645: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_641, sum_257);  sum_257 = None
    ...
    view_735: "f32[192]" = torch.ops.aten.view.default(sum_260, [192]);  sum_260 = None
    ...
    view_738: "f32[576]" = torch.ops.aten.view.default(sum_261, [576]);  sum_261 = None
    ...
    mul_659: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_655, sum_263);  sum_263 = None
    ...
    view_740: "f32[192]" = torch.ops.aten.view.default(sum_266, [192]);  sum_266 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/volo.py:88, code: x = F.fold(x, output_size=(H, W), kernel_size=self.kernel_size, padding=self.padding, stride=self.stride)
    iota_56: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_98: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_56, 0);  iota_56 = None
    iota_57: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_58: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_100: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_58, 0);  iota_58 = None
    iota_59: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    view_750: "f32[486]" = torch.ops.aten.view.default(sum_268, [486]);  sum_268 = None
    ...
    iota_60: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_104: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_60, 0);  iota_60 = None
    iota_61: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    iota_62: "i64[14]" = torch.ops.prims.iota.default(14, start = 0, step = 2, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    unsqueeze_108: "i64[1, 14]" = torch.ops.aten.unsqueeze.default(iota_62, 0);  iota_62 = None
    iota_63: "i64[3]" = torch.ops.prims.iota.default(3, start = 0, step = 1, dtype = torch.int64, device = device(type='cpu'), requires_grad = False)
    ...
    full_26: "f32[8, 192, 30, 30]" = torch.ops.aten.full.default([8, 192, 30, 30], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    mul_669: "f32[8, 28, 28, 192]" = torch.ops.aten.mul.Tensor(mul_665, sum_270);  sum_270 = None
