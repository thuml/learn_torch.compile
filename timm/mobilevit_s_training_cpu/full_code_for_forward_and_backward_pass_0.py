...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 25792240)) \
        and (___check_obj_id(L['___stack0'], 24865728)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 141485136)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(139893735029440))) \
        and (___compile_config_hash() == '1acb90c3968cea7dfb22a2932fdb4e04') \
