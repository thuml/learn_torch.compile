...
def forward(self, L_cloned_inputs_0_ : torch.Tensor):
    ...
    getattr_getattr_l__mod___blocks___9_____0___bn1_num_batches_tracked = self.getattr_getattr_L__mod___blocks___9_____0___bn1_num_batches_tracked
    ...
    add_ = getattr_getattr_l__mod___blocks___9_____0___bn1_num_batches_tracked.add_(1);  getattr_getattr_l__mod___blocks___9_____0___bn1_num_batches_tracked = None
    ...
    pred = torch._C._nn.linear(x_78, l__mod___classifier_weight, l__mod___classifier_bias);  x_78 = l__mod___classifier_weight = l__mod___classifier_bias = None
    return (pred,)
