...
def forward(self, primals, tangents):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_1: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_2: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_3: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_4: "f32[62720]" = torch.ops.aten.full.default([62720], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_5: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_6: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_7: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_8: "f32[62720]" = torch.ops.aten.full.default([62720], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_9: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_10: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_11: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_12: "f32[62720]" = torch.ops.aten.full.default([62720], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_13: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_14: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_15: "f32[8, 960, 7, 7]" = torch.ops.aten.full.default([8, 960, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_16: "f32[62720]" = torch.ops.aten.full.default([62720], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_17: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_18: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_19: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_21: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_22: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_23: "f32[8, 672, 14, 14]" = torch.ops.aten.full.default([8, 672, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_24: "f32[175616]" = torch.ops.aten.full.default([175616], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_25: "f32[8, 480, 14, 14]" = torch.ops.aten.full.default([8, 480, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_26: "f32[8, 480, 14, 14]" = torch.ops.aten.full.default([8, 480, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_27: "f32[8, 480, 14, 14]" = torch.ops.aten.full.default([8, 480, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_29: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_30: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_31: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_32: "f32[125440]" = torch.ops.aten.full.default([125440], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_33: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_34: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_35: "f32[8, 184, 14, 14]" = torch.ops.aten.full.default([8, 184, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_36: "f32[125440]" = torch.ops.aten.full.default([125440], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_37: "f32[8, 200, 14, 14]" = torch.ops.aten.full.default([8, 200, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_38: "f32[8, 200, 14, 14]" = torch.ops.aten.full.default([8, 200, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_39: "f32[8, 200, 14, 14]" = torch.ops.aten.full.default([8, 200, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_40: "f32[125440]" = torch.ops.aten.full.default([125440], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_41: "f32[8, 240, 28, 28]" = torch.ops.aten.full.default([8, 240, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_42: "f32[8, 240, 28, 28]" = torch.ops.aten.full.default([8, 240, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_43: "f32[8, 240, 28, 28]" = torch.ops.aten.full.default([8, 240, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_45: "f32[8, 120, 28, 28]" = torch.ops.aten.full.default([8, 120, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_46: "f32[8, 120, 28, 28]" = torch.ops.aten.full.default([8, 120, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_47: "f32[8, 120, 28, 28]" = torch.ops.aten.full.default([8, 120, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_48: "f32[250880]" = torch.ops.aten.full.default([250880], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_49: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_50: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_51: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_53: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_54: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_55: "f32[8, 72, 56, 56]" = torch.ops.aten.full.default([8, 72, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:182, code: x += self.shortcut(shortcut)
    full_56: "f32[602112]" = torch.ops.aten.full.default([602112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_57: "f32[8, 48, 112, 112]" = torch.ops.aten.full.default([8, 48, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_58: "f32[8, 48, 112, 112]" = torch.ops.aten.full.default([8, 48, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_59: "f32[8, 48, 112, 112]" = torch.ops.aten.full.default([8, 48, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/ghostnet.py:63, code: return out[:, :self.out_chs, :, :]
    full_61: "f32[8, 16, 112, 112]" = torch.ops.aten.full.default([8, 16, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_62: "f32[8, 16, 112, 112]" = torch.ops.aten.full.default([8, 16, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_63: "f32[8, 16, 112, 112]" = torch.ops.aten.full.default([8, 16, 112, 112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
