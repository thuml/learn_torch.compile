...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    conv2d = torch.conv2d(l_inputs_0_, weight, l__mod___stem_conv1_bias, (2, 2), (1, 1), (1, 1), 1);  l_inputs_0_ = weight = l__mod___stem_conv1_bias = None
    ...
    x_10 = self.L__mod___head_flatten(x_9);  x_9 = None
    return (x_10,)
