...
def forward(self, primals, tangents):
    ...
    full_1: "f32[8, 185, 7, 7]" = torch.ops.aten.full.default([8, 185, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_2: "f32[8, 185, 7, 7]" = torch.ops.aten.full.default([8, 185, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_3: "f32[8, 185, 7, 7]" = torch.ops.aten.full.default([8, 185, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_2: "f32[8, 185, 7, 7]" = torch.ops.aten.slice_scatter.default(full_3, slice_45, 1, 0, 174);  full_3 = None
    full_4: "f32[8, 185, 7, 7]" = torch.ops.aten.full.default([8, 185, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_5: "f32[8, 1044, 7, 7]" = torch.ops.aten.full.default([8, 1044, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_6: "f32[8, 174, 7, 7]" = torch.ops.aten.full.default([8, 174, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_7: "f32[8, 174, 7, 7]" = torch.ops.aten.full.default([8, 174, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_8: "f32[8, 174, 7, 7]" = torch.ops.aten.full.default([8, 174, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_6: "f32[8, 174, 7, 7]" = torch.ops.aten.slice_scatter.default(full_8, slice_47, 1, 0, 162);  full_8 = None
    full_9: "f32[8, 174, 7, 7]" = torch.ops.aten.full.default([8, 174, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_10: "f32[8, 972, 7, 7]" = torch.ops.aten.full.default([8, 972, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_11: "f32[8, 162, 7, 7]" = torch.ops.aten.full.default([8, 162, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_12: "f32[8, 162, 7, 7]" = torch.ops.aten.full.default([8, 162, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_13: "f32[8, 162, 7, 7]" = torch.ops.aten.full.default([8, 162, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_10: "f32[8, 162, 7, 7]" = torch.ops.aten.slice_scatter.default(full_13, slice_49, 1, 0, 151);  full_13 = None
    full_14: "f32[8, 162, 7, 7]" = torch.ops.aten.full.default([8, 162, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_15: "f32[8, 906, 7, 7]" = torch.ops.aten.full.default([8, 906, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_16: "f32[8, 151, 7, 7]" = torch.ops.aten.full.default([8, 151, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_17: "f32[8, 151, 7, 7]" = torch.ops.aten.full.default([8, 151, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_18: "f32[8, 151, 7, 7]" = torch.ops.aten.full.default([8, 151, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_14: "f32[8, 151, 7, 7]" = torch.ops.aten.slice_scatter.default(full_18, slice_51, 1, 0, 140);  full_18 = None
    full_19: "f32[8, 151, 7, 7]" = torch.ops.aten.full.default([8, 151, 7, 7], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_20: "f32[8, 840, 7, 7]" = torch.ops.aten.full.default([8, 840, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_21: "f32[8, 768, 14, 14]" = torch.ops.aten.full.default([8, 768, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_22: "f32[8, 128, 14, 14]" = torch.ops.aten.full.default([8, 128, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_23: "f32[8, 128, 14, 14]" = torch.ops.aten.full.default([8, 128, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_24: "f32[8, 128, 14, 14]" = torch.ops.aten.full.default([8, 128, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_18: "f32[8, 128, 14, 14]" = torch.ops.aten.slice_scatter.default(full_24, slice_53, 1, 0, 117);  full_24 = None
    full_25: "f32[8, 128, 14, 14]" = torch.ops.aten.full.default([8, 128, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_26: "f32[8, 702, 14, 14]" = torch.ops.aten.full.default([8, 702, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_27: "f32[8, 117, 14, 14]" = torch.ops.aten.full.default([8, 117, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_28: "f32[8, 117, 14, 14]" = torch.ops.aten.full.default([8, 117, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_29: "f32[8, 117, 14, 14]" = torch.ops.aten.full.default([8, 117, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_22: "f32[8, 117, 14, 14]" = torch.ops.aten.slice_scatter.default(full_29, slice_55, 1, 0, 106);  full_29 = None
    full_30: "f32[8, 117, 14, 14]" = torch.ops.aten.full.default([8, 117, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_31: "f32[8, 636, 14, 14]" = torch.ops.aten.full.default([8, 636, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_32: "f32[8, 106, 14, 14]" = torch.ops.aten.full.default([8, 106, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_33: "f32[8, 106, 14, 14]" = torch.ops.aten.full.default([8, 106, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_34: "f32[8, 106, 14, 14]" = torch.ops.aten.full.default([8, 106, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_26: "f32[8, 106, 14, 14]" = torch.ops.aten.slice_scatter.default(full_34, slice_57, 1, 0, 95);  full_34 = None
    full_35: "f32[8, 106, 14, 14]" = torch.ops.aten.full.default([8, 106, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_36: "f32[8, 570, 14, 14]" = torch.ops.aten.full.default([8, 570, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_37: "f32[8, 95, 14, 14]" = torch.ops.aten.full.default([8, 95, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_38: "f32[8, 95, 14, 14]" = torch.ops.aten.full.default([8, 95, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_39: "f32[8, 95, 14, 14]" = torch.ops.aten.full.default([8, 95, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_30: "f32[8, 95, 14, 14]" = torch.ops.aten.slice_scatter.default(full_39, slice_59, 1, 0, 84);  full_39 = None
    full_40: "f32[8, 95, 14, 14]" = torch.ops.aten.full.default([8, 95, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_41: "f32[8, 504, 14, 14]" = torch.ops.aten.full.default([8, 504, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_42: "f32[8, 84, 14, 14]" = torch.ops.aten.full.default([8, 84, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_43: "f32[8, 84, 14, 14]" = torch.ops.aten.full.default([8, 84, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_44: "f32[8, 84, 14, 14]" = torch.ops.aten.full.default([8, 84, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_34: "f32[8, 84, 14, 14]" = torch.ops.aten.slice_scatter.default(full_44, slice_61, 1, 0, 72);  full_44 = None
    full_45: "f32[8, 84, 14, 14]" = torch.ops.aten.full.default([8, 84, 14, 14], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_46: "f32[8, 432, 14, 14]" = torch.ops.aten.full.default([8, 432, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_47: "f32[8, 366, 28, 28]" = torch.ops.aten.full.default([8, 366, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_48: "f32[8, 61, 28, 28]" = torch.ops.aten.full.default([8, 61, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_49: "f32[8, 61, 28, 28]" = torch.ops.aten.full.default([8, 61, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_50: "f32[8, 61, 28, 28]" = torch.ops.aten.full.default([8, 61, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_38: "f32[8, 61, 28, 28]" = torch.ops.aten.slice_scatter.default(full_50, slice_63, 1, 0, 50);  full_50 = None
    full_51: "f32[8, 61, 28, 28]" = torch.ops.aten.full.default([8, 61, 28, 28], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_52: "f32[8, 300, 28, 28]" = torch.ops.aten.full.default([8, 300, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_53: "f32[8, 228, 56, 56]" = torch.ops.aten.full.default([8, 228, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_54: "f32[8, 38, 56, 56]" = torch.ops.aten.full.default([8, 38, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_55: "f32[8, 38, 56, 56]" = torch.ops.aten.full.default([8, 38, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_56: "f32[8, 38, 56, 56]" = torch.ops.aten.full.default([8, 38, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_42: "f32[8, 38, 56, 56]" = torch.ops.aten.slice_scatter.default(full_56, slice_65, 1, 0, 27);  full_56 = None
    full_57: "f32[8, 38, 56, 56]" = torch.ops.aten.full.default([8, 38, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_58: "f32[8, 162, 56, 56]" = torch.ops.aten.full.default([8, 162, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_59: "f32[8, 96, 112, 112]" = torch.ops.aten.full.default([8, 96, 112, 112], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_60: "f32[8, 32, 112, 112]" = torch.ops.aten.full.default([8, 32, 112, 112], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
