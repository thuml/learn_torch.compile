...
def forward(self, primals, tangents):
    ...
    full: "f32[8, 1280, 8, 8]" = torch.ops.aten.full.default([8, 1280, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_1: "f32[8, 1536, 8, 8]" = torch.ops.aten.full.default([8, 1536, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_2: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:49, code: x = x_pad[:, :W, W - 1:]
    full_6: "f32[256, 8, 15]" = torch.ops.aten.full.default([256, 8, 15], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_8: "f32[256, 9, 15]" = torch.ops.aten.full.default([256, 9, 15], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_9: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_10: "f32[8, 1536, 8, 8]" = torch.ops.aten.full.default([8, 1536, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_11: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_18: "f32[8, 512, 16, 16]" = torch.ops.aten.full.default([8, 512, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_19: "f32[8, 1024, 16, 16]" = torch.ops.aten.full.default([8, 1024, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_20: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:49, code: x = x_pad[:, :W, W - 1:]
    full_21: "f32[512, 16, 31]" = torch.ops.aten.full.default([512, 16, 31], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_23: "f32[512, 17, 31]" = torch.ops.aten.full.default([512, 17, 31], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:49, code: x = x_pad[:, :W, W - 1:]
    full_24: "f32[512, 16, 31]" = torch.ops.aten.full.default([512, 16, 31], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_26: "f32[512, 17, 31]" = torch.ops.aten.full.default([512, 17, 31], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_27: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_28: "f32[8, 1024, 16, 16]" = torch.ops.aten.full.default([8, 1024, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_40: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_463, [0, 2, 3])
    convolution_backward_12 = torch.ops.aten.convolution_backward.default(mul_463, relu_5, primals_133, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_463 = primals_133 = None
    getitem_124: "f32[8, 16, 1, 1]" = convolution_backward_12[0]
    getitem_125: "f32[256, 16, 1, 1]" = convolution_backward_12[1];  convolution_backward_12 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_41: "f32[16]" = torch.ops.aten.sum.dim_IntList(where, [0, 2, 3])
    convolution_backward_13 = torch.ops.aten.convolution_backward.default(where, mean_5, primals_131, [16], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where = mean_5 = primals_131 = None
    getitem_127: "f32[8, 256, 1, 1]" = convolution_backward_13[0]
    getitem_128: "f32[16, 256, 1, 1]" = convolution_backward_13[1];  convolution_backward_13 = None
    ...
    full_29: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_42: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_466, [0, 2, 3])
    ...
    sum_43: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_467, [0, 2, 3]);  mul_467 = None
    mul_468: "f32[256]" = torch.ops.aten.mul.Tensor(sum_42, 0.00048828125)
    ...
    mul_469: "f32[256]" = torch.ops.aten.mul.Tensor(sum_43, 0.00048828125)
    ...
    mul_475: "f32[256]" = torch.ops.aten.mul.Tensor(sum_43, squeeze_76);  sum_43 = squeeze_76 = None
    ...
    full_30: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_44: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_478, [0, 2, 3])
    ...
    sum_45: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_479, [0, 2, 3]);  mul_479 = None
    mul_480: "f32[256]" = torch.ops.aten.mul.Tensor(sum_44, 0.00048828125)
    ...
    mul_481: "f32[256]" = torch.ops.aten.mul.Tensor(sum_45, 0.00048828125)
    ...
    mul_487: "f32[256]" = torch.ops.aten.mul.Tensor(sum_45, squeeze_73);  sum_45 = squeeze_73 = None
    ...
    full_31: "f32[8, 1024, 16, 16]" = torch.ops.aten.full.default([8, 1024, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_47: "f32[1024]" = torch.ops.aten.sum.dim_IntList(mul_491, [0, 2, 3]);  mul_491 = None
    mul_492: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_46, 0.00048828125)
    ...
    mul_493: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_47, 0.00048828125)
    ...
    mul_499: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_47, squeeze_70);  sum_47 = squeeze_70 = None
    ...
    sum_48: "f32[1024]" = torch.ops.aten.sum.dim_IntList(mul_490, [0, 2, 3])
    ...
    sum_49: "f32[1024]" = torch.ops.aten.sum.dim_IntList(mul_500, [0, 2, 3]);  mul_500 = None
    mul_501: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_48, 0.00048828125)
    ...
    mul_502: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_49, 0.00048828125)
    ...
    mul_508: "f32[1024]" = torch.ops.aten.mul.Tensor(sum_49, squeeze_67);  sum_49 = squeeze_67 = None
    ...
    sum_50: "f32[8, 256, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_509, [2, 3], True);  mul_509 = None
    ...
    mul_512: "f32[8, 256, 1, 1]" = torch.ops.aten.mul.Tensor(sum_50, mul_511);  sum_50 = mul_511 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_51: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_512, [0, 2, 3])
    convolution_backward_18 = torch.ops.aten.convolution_backward.default(mul_512, relu_4, primals_125, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_512 = primals_125 = None
    getitem_142: "f32[8, 16, 1, 1]" = convolution_backward_18[0]
    getitem_143: "f32[256, 16, 1, 1]" = convolution_backward_18[1];  convolution_backward_18 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_52: "f32[16]" = torch.ops.aten.sum.dim_IntList(where_1, [0, 2, 3])
    convolution_backward_19 = torch.ops.aten.convolution_backward.default(where_1, mean_4, primals_123, [16], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where_1 = mean_4 = primals_123 = None
    getitem_145: "f32[8, 256, 1, 1]" = convolution_backward_19[0]
    getitem_146: "f32[16, 256, 1, 1]" = convolution_backward_19[1];  convolution_backward_19 = None
    ...
    sum_53: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_515, [0, 2, 3])
    ...
    sum_54: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_516, [0, 2, 3]);  mul_516 = None
    mul_517: "f32[256]" = torch.ops.aten.mul.Tensor(sum_53, 0.00048828125)
    ...
    mul_518: "f32[256]" = torch.ops.aten.mul.Tensor(sum_54, 0.00048828125)
    ...
    mul_524: "f32[256]" = torch.ops.aten.mul.Tensor(sum_54, squeeze_64);  sum_54 = squeeze_64 = None
    ...
    full_33: "f32[8, 256, 32, 32]" = torch.ops.aten.full.default([8, 256, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_55: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_527, [0, 2, 3])
    ...
    sum_56: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_528, [0, 2, 3]);  mul_528 = None
    mul_529: "f32[256]" = torch.ops.aten.mul.Tensor(sum_55, 0.0001220703125)
    ...
    mul_530: "f32[256]" = torch.ops.aten.mul.Tensor(sum_56, 0.0001220703125)
    ...
    mul_536: "f32[256]" = torch.ops.aten.mul.Tensor(sum_56, squeeze_61);  sum_56 = squeeze_61 = None
    ...
    full_34: "f32[8, 512, 32, 32]" = torch.ops.aten.full.default([8, 512, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_57: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_539, [0, 2, 3])
    ...
    sum_58: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_540, [0, 2, 3]);  mul_540 = None
    mul_541: "f32[512]" = torch.ops.aten.mul.Tensor(sum_57, 0.0001220703125)
    ...
    mul_542: "f32[512]" = torch.ops.aten.mul.Tensor(sum_58, 0.0001220703125)
    ...
    mul_548: "f32[512]" = torch.ops.aten.mul.Tensor(sum_58, squeeze_58);  sum_58 = squeeze_58 = None
    ...
    full_35: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_59: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_551, [0, 2, 3])
    ...
    sum_60: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_552, [0, 2, 3]);  mul_552 = None
    mul_553: "f32[128]" = torch.ops.aten.mul.Tensor(sum_59, 0.0001220703125)
    ...
    mul_554: "f32[128]" = torch.ops.aten.mul.Tensor(sum_60, 0.0001220703125)
    ...
    mul_560: "f32[128]" = torch.ops.aten.mul.Tensor(sum_60, squeeze_55);  sum_60 = squeeze_55 = None
    ...
    sum_61: "f32[32, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_561, [-1], True)
    mul_562: "f32[32, 1024, 1024]" = torch.ops.aten.mul.Tensor(alias_27, sum_61);  alias_27 = sum_61 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:52, code: x = x.reshape(B, H, 1, W, W).expand(-1, -1, H, -1, -1)
    sum_62: "f32[32, 32, 1, 32, 32]" = torch.ops.aten.sum.dim_IntList(permute_112, [2], True);  permute_112 = None
    view_176: "f32[1024, 32, 32]" = torch.ops.aten.view.default(sum_62, [1024, 32, 32]);  sum_62 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:49, code: x = x_pad[:, :W, W - 1:]
    full_36: "f32[1024, 32, 63]" = torch.ops.aten.full.default([1024, 32, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_37: "f32[1024, 33, 63]" = torch.ops.aten.full.default([1024, 33, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_38: "f32[1024, 33, 63]" = torch.ops.aten.full.default([1024, 33, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:52, code: x = x.reshape(B, H, 1, W, W).expand(-1, -1, H, -1, -1)
    sum_63: "f32[32, 32, 1, 32, 32]" = torch.ops.aten.sum.dim_IntList(permute_118, [2], True);  permute_118 = None
    view_182: "f32[1024, 32, 32]" = torch.ops.aten.view.default(sum_63, [1024, 32, 32]);  sum_63 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:49, code: x = x_pad[:, :W, W - 1:]
    full_39: "f32[1024, 32, 63]" = torch.ops.aten.full.default([1024, 32, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_40: "f32[1024, 33, 63]" = torch.ops.aten.full.default([1024, 33, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_41: "f32[1024, 33, 63]" = torch.ops.aten.full.default([1024, 33, 63], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_42: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_64: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_566, [0, 2, 3])
    ...
    sum_65: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_567, [0, 2, 3]);  mul_567 = None
    mul_568: "f32[128]" = torch.ops.aten.mul.Tensor(sum_64, 0.0001220703125)
    ...
    mul_569: "f32[128]" = torch.ops.aten.mul.Tensor(sum_65, 0.0001220703125)
    ...
    mul_575: "f32[128]" = torch.ops.aten.mul.Tensor(sum_65, squeeze_52);  sum_65 = squeeze_52 = None
    ...
    full_43: "f32[8, 512, 32, 32]" = torch.ops.aten.full.default([8, 512, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_66: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_578, [0, 2, 3])
    ...
    sum_67: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_579, [0, 2, 3]);  mul_579 = None
    mul_580: "f32[512]" = torch.ops.aten.mul.Tensor(sum_66, 0.0001220703125)
    ...
    mul_581: "f32[512]" = torch.ops.aten.mul.Tensor(sum_67, 0.0001220703125)
    ...
    mul_587: "f32[512]" = torch.ops.aten.mul.Tensor(sum_67, squeeze_49);  sum_67 = squeeze_49 = None
    ...
    sum_68: "f32[8, 128, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_588, [2, 3], True);  mul_588 = None
    ...
    mul_591: "f32[8, 128, 1, 1]" = torch.ops.aten.mul.Tensor(sum_68, mul_590);  sum_68 = mul_590 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_69: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_591, [0, 2, 3])
    convolution_backward_26 = torch.ops.aten.convolution_backward.default(mul_591, relu_3, primals_115, [128], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_591 = primals_115 = None
    getitem_166: "f32[8, 8, 1, 1]" = convolution_backward_26[0]
    getitem_167: "f32[128, 8, 1, 1]" = convolution_backward_26[1];  convolution_backward_26 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_70: "f32[8]" = torch.ops.aten.sum.dim_IntList(where_2, [0, 2, 3])
    convolution_backward_27 = torch.ops.aten.convolution_backward.default(where_2, mean_3, primals_113, [8], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where_2 = mean_3 = primals_113 = None
    getitem_169: "f32[8, 128, 1, 1]" = convolution_backward_27[0]
    getitem_170: "f32[8, 128, 1, 1]" = convolution_backward_27[1];  convolution_backward_27 = None
    ...
    full_44: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_71: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_594, [0, 2, 3])
    ...
    sum_72: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_595, [0, 2, 3]);  mul_595 = None
    mul_596: "f32[128]" = torch.ops.aten.mul.Tensor(sum_71, 0.0001220703125)
    ...
    mul_597: "f32[128]" = torch.ops.aten.mul.Tensor(sum_72, 0.0001220703125)
    ...
    mul_603: "f32[128]" = torch.ops.aten.mul.Tensor(sum_72, squeeze_46);  sum_72 = squeeze_46 = None
    ...
    full_45: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_73: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_606, [0, 2, 3])
    ...
    sum_74: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_607, [0, 2, 3]);  mul_607 = None
    mul_608: "f32[128]" = torch.ops.aten.mul.Tensor(sum_73, 0.0001220703125)
    ...
    mul_609: "f32[128]" = torch.ops.aten.mul.Tensor(sum_74, 0.0001220703125)
    ...
    mul_615: "f32[128]" = torch.ops.aten.mul.Tensor(sum_74, squeeze_43);  sum_74 = squeeze_43 = None
    ...
    full_46: "f32[8, 512, 32, 32]" = torch.ops.aten.full.default([8, 512, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_75: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_618, [0, 2, 3])
    ...
    sum_76: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_619, [0, 2, 3]);  mul_619 = None
    mul_620: "f32[512]" = torch.ops.aten.mul.Tensor(sum_75, 0.0001220703125)
    ...
    mul_621: "f32[512]" = torch.ops.aten.mul.Tensor(sum_76, 0.0001220703125)
    ...
    mul_627: "f32[512]" = torch.ops.aten.mul.Tensor(sum_76, squeeze_40);  sum_76 = squeeze_40 = None
    ...
    sum_77: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_618, [0, 2, 3])
    ...
    sum_78: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_628, [0, 2, 3]);  mul_628 = None
    mul_629: "f32[512]" = torch.ops.aten.mul.Tensor(sum_77, 0.0001220703125)
    ...
    mul_630: "f32[512]" = torch.ops.aten.mul.Tensor(sum_78, 0.0001220703125)
    ...
    mul_636: "f32[512]" = torch.ops.aten.mul.Tensor(sum_78, squeeze_37);  sum_78 = squeeze_37 = None
    ...
    sum_79: "f32[8, 128, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_637, [2, 3], True);  mul_637 = None
    ...
    mul_640: "f32[8, 128, 1, 1]" = torch.ops.aten.mul.Tensor(sum_79, mul_639);  sum_79 = mul_639 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_80: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_640, [0, 2, 3])
    convolution_backward_32 = torch.ops.aten.convolution_backward.default(mul_640, relu_2, primals_107, [128], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_640 = primals_107 = None
    getitem_184: "f32[8, 8, 1, 1]" = convolution_backward_32[0]
    getitem_185: "f32[128, 8, 1, 1]" = convolution_backward_32[1];  convolution_backward_32 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_81: "f32[8]" = torch.ops.aten.sum.dim_IntList(where_3, [0, 2, 3])
    convolution_backward_33 = torch.ops.aten.convolution_backward.default(where_3, mean_2, primals_105, [8], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where_3 = mean_2 = primals_105 = None
    getitem_187: "f32[8, 128, 1, 1]" = convolution_backward_33[0]
    getitem_188: "f32[8, 128, 1, 1]" = convolution_backward_33[1];  convolution_backward_33 = None
    ...
    full_47: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_82: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_643, [0, 2, 3])
    ...
    sum_83: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_644, [0, 2, 3]);  mul_644 = None
    mul_645: "f32[128]" = torch.ops.aten.mul.Tensor(sum_82, 0.0001220703125)
    ...
    mul_646: "f32[128]" = torch.ops.aten.mul.Tensor(sum_83, 0.0001220703125)
    ...
    mul_652: "f32[128]" = torch.ops.aten.mul.Tensor(sum_83, squeeze_34);  sum_83 = squeeze_34 = None
    ...
    full_48: "f32[8, 128, 64, 64]" = torch.ops.aten.full.default([8, 128, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_84: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_655, [0, 2, 3])
    ...
    sum_85: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_656, [0, 2, 3]);  mul_656 = None
    mul_657: "f32[128]" = torch.ops.aten.mul.Tensor(sum_84, 3.0517578125e-05)
    ...
    mul_658: "f32[128]" = torch.ops.aten.mul.Tensor(sum_85, 3.0517578125e-05)
    ...
    mul_664: "f32[128]" = torch.ops.aten.mul.Tensor(sum_85, squeeze_31);  sum_85 = squeeze_31 = None
    ...
    full_49: "f32[8, 256, 64, 64]" = torch.ops.aten.full.default([8, 256, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_86: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_667, [0, 2, 3])
    ...
    sum_87: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_668, [0, 2, 3]);  mul_668 = None
    mul_669: "f32[256]" = torch.ops.aten.mul.Tensor(sum_86, 3.0517578125e-05)
    ...
    mul_670: "f32[256]" = torch.ops.aten.mul.Tensor(sum_87, 3.0517578125e-05)
    ...
    mul_676: "f32[256]" = torch.ops.aten.mul.Tensor(sum_87, squeeze_28);  sum_87 = squeeze_28 = None
    ...
    sum_88: "f32[8, 64, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_677, [2, 3], True);  mul_677 = None
    ...
    mul_680: "f32[8, 64, 1, 1]" = torch.ops.aten.mul.Tensor(sum_88, mul_679);  sum_88 = mul_679 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_89: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_680, [0, 2, 3])
    convolution_backward_37 = torch.ops.aten.convolution_backward.default(mul_680, relu_1, primals_100, [64], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_680 = primals_100 = None
    getitem_199: "f32[8, 8, 1, 1]" = convolution_backward_37[0]
    getitem_200: "f32[64, 8, 1, 1]" = convolution_backward_37[1];  convolution_backward_37 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_90: "f32[8]" = torch.ops.aten.sum.dim_IntList(where_4, [0, 2, 3])
    convolution_backward_38 = torch.ops.aten.convolution_backward.default(where_4, mean_1, primals_98, [8], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where_4 = mean_1 = primals_98 = None
    getitem_202: "f32[8, 64, 1, 1]" = convolution_backward_38[0]
    getitem_203: "f32[8, 64, 1, 1]" = convolution_backward_38[1];  convolution_backward_38 = None
    ...
    full_50: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_91: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_683, [0, 2, 3])
    ...
    sum_92: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_684, [0, 2, 3]);  mul_684 = None
    mul_685: "f32[64]" = torch.ops.aten.mul.Tensor(sum_91, 3.0517578125e-05)
    ...
    mul_686: "f32[64]" = torch.ops.aten.mul.Tensor(sum_92, 3.0517578125e-05)
    ...
    mul_692: "f32[64]" = torch.ops.aten.mul.Tensor(sum_92, squeeze_25);  sum_92 = squeeze_25 = None
    ...
    full_51: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_93: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_695, [0, 2, 3])
    ...
    sum_94: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_696, [0, 2, 3]);  mul_696 = None
    mul_697: "f32[64]" = torch.ops.aten.mul.Tensor(sum_93, 3.0517578125e-05)
    ...
    mul_698: "f32[64]" = torch.ops.aten.mul.Tensor(sum_94, 3.0517578125e-05)
    ...
    mul_704: "f32[64]" = torch.ops.aten.mul.Tensor(sum_94, squeeze_22);  sum_94 = squeeze_22 = None
    ...
    full_52: "f32[8, 256, 64, 64]" = torch.ops.aten.full.default([8, 256, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_95: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_707, [0, 2, 3])
    ...
    sum_96: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_708, [0, 2, 3]);  mul_708 = None
    mul_709: "f32[256]" = torch.ops.aten.mul.Tensor(sum_95, 3.0517578125e-05)
    ...
    mul_710: "f32[256]" = torch.ops.aten.mul.Tensor(sum_96, 3.0517578125e-05)
    ...
    mul_716: "f32[256]" = torch.ops.aten.mul.Tensor(sum_96, squeeze_19);  sum_96 = squeeze_19 = None
    ...
    sum_97: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_707, [0, 2, 3])
    ...
    sum_98: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_717, [0, 2, 3]);  mul_717 = None
    mul_718: "f32[256]" = torch.ops.aten.mul.Tensor(sum_97, 3.0517578125e-05)
    ...
    mul_719: "f32[256]" = torch.ops.aten.mul.Tensor(sum_98, 3.0517578125e-05)
    ...
    mul_725: "f32[256]" = torch.ops.aten.mul.Tensor(sum_98, squeeze_16);  sum_98 = squeeze_16 = None
    ...
    sum_99: "f32[8, 64, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_726, [2, 3], True);  mul_726 = None
    ...
    mul_729: "f32[8, 64, 1, 1]" = torch.ops.aten.mul.Tensor(sum_99, mul_728);  sum_99 = mul_728 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    sum_100: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_729, [0, 2, 3])
    convolution_backward_43 = torch.ops.aten.convolution_backward.default(mul_729, relu, primals_92, [64], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_729 = primals_92 = None
    getitem_217: "f32[8, 8, 1, 1]" = convolution_backward_43[0]
    getitem_218: "f32[64, 8, 1, 1]" = convolution_backward_43[1];  convolution_backward_43 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    sum_101: "f32[8]" = torch.ops.aten.sum.dim_IntList(where_5, [0, 2, 3])
    convolution_backward_44 = torch.ops.aten.convolution_backward.default(where_5, mean, primals_90, [8], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  where_5 = mean = primals_90 = None
    getitem_220: "f32[8, 64, 1, 1]" = convolution_backward_44[0]
    getitem_221: "f32[8, 64, 1, 1]" = convolution_backward_44[1];  convolution_backward_44 = None
    ...
    full_53: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_102: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_732, [0, 2, 3])
    ...
    sum_103: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_733, [0, 2, 3]);  mul_733 = None
    mul_734: "f32[64]" = torch.ops.aten.mul.Tensor(sum_102, 3.0517578125e-05)
    ...
    mul_735: "f32[64]" = torch.ops.aten.mul.Tensor(sum_103, 3.0517578125e-05)
    ...
    mul_741: "f32[64]" = torch.ops.aten.mul.Tensor(sum_103, squeeze_13);  sum_103 = squeeze_13 = None
    ...
    full_54: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_104: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_744, [0, 2, 3])
    ...
    sum_105: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_745, [0, 2, 3]);  mul_745 = None
    mul_746: "f32[64]" = torch.ops.aten.mul.Tensor(sum_104, 3.0517578125e-05)
    ...
    mul_747: "f32[64]" = torch.ops.aten.mul.Tensor(sum_105, 3.0517578125e-05)
    ...
    mul_753: "f32[64]" = torch.ops.aten.mul.Tensor(sum_105, squeeze_10);  sum_105 = squeeze_10 = None
    ...
    full_55: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_106: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_756, [0, 2, 3])
    ...
    sum_107: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_757, [0, 2, 3]);  mul_757 = None
    mul_758: "f32[64]" = torch.ops.aten.mul.Tensor(sum_106, 3.0517578125e-05)
    ...
    mul_759: "f32[64]" = torch.ops.aten.mul.Tensor(sum_107, 3.0517578125e-05)
    ...
    mul_765: "f32[64]" = torch.ops.aten.mul.Tensor(sum_107, squeeze_7);  sum_107 = squeeze_7 = None
    ...
    full_56: "f32[8, 32, 128, 128]" = torch.ops.aten.full.default([8, 32, 128, 128], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_108: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_768, [0, 2, 3])
    ...
    sum_109: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_769, [0, 2, 3]);  mul_769 = None
    mul_770: "f32[32]" = torch.ops.aten.mul.Tensor(sum_108, 7.62939453125e-06)
    ...
    mul_771: "f32[32]" = torch.ops.aten.mul.Tensor(sum_109, 7.62939453125e-06)
    ...
    mul_777: "f32[32]" = torch.ops.aten.mul.Tensor(sum_109, squeeze_4);  sum_109 = squeeze_4 = None
    ...
    full_57: "f32[8, 24, 128, 128]" = torch.ops.aten.full.default([8, 24, 128, 128], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    sum_110: "f32[24]" = torch.ops.aten.sum.dim_IntList(mul_780, [0, 2, 3])
    ...
    sum_111: "f32[24]" = torch.ops.aten.sum.dim_IntList(mul_781, [0, 2, 3]);  mul_781 = None
    mul_782: "f32[24]" = torch.ops.aten.mul.Tensor(sum_110, 7.62939453125e-06)
    ...
    mul_783: "f32[24]" = torch.ops.aten.mul.Tensor(sum_111, 7.62939453125e-06)
    ...
    mul_789: "f32[24]" = torch.ops.aten.mul.Tensor(sum_111, squeeze_1);  sum_111 = squeeze_1 = None
    ...
    return pytree.tree_unflatten([addmm, mul_789, sum_110, mul_777, sum_108, mul_765, sum_106, mul_753, sum_104, mul_741, sum_102, mul_725, sum_97, mul_716, sum_95, mul_704, sum_93, mul_692, sum_91, mul_676, sum_86, mul_664, sum_84, mul_652, sum_82, mul_636, sum_77, mul_627, sum_75, mul_615, sum_73, mul_603, sum_71, mul_587, sum_66, mul_575, sum_64, permute_122, permute_116, mul_560, sum_59, mul_548, sum_57, mul_536, sum_55, mul_524, sum_53, mul_508, sum_48, mul_499, sum_46, mul_487, sum_44, mul_475, sum_42, mul_459, sum_37, mul_447, sum_35, permute_95, permute_89, mul_432, sum_30, mul_420, sum_28, mul_408, sum_26, permute_74, permute_68, mul_393, sum_21, mul_381, sum_19, mul_372, sum_17, mul_360, sum_15, permute_53, permute_47, mul_345, sum_10, mul_333, sum_8, mul_321, sum_6, getitem_236, getitem_233, getitem_230, getitem_227, getitem_224, getitem_221, sum_101, getitem_218, sum_100, getitem_215, getitem_212, getitem_209, getitem_206, getitem_203, sum_90, getitem_200, sum_89, getitem_197, getitem_194, getitem_191, getitem_188, sum_81, getitem_185, sum_80, getitem_182, getitem_179, getitem_176, getitem_173, getitem_170, sum_70, getitem_167, sum_69, getitem_164, getitem_161, getitem_158, getitem_155, getitem_152, getitem_149, getitem_146, sum_52, getitem_143, sum_51, getitem_140, getitem_137, getitem_134, getitem_131, getitem_128, sum_41, getitem_125, sum_40, getitem_122, getitem_119, getitem_116, getitem_113, getitem_110, getitem_107, getitem_104, getitem_101, getitem_98, getitem_95, getitem_92, getitem_89, permute_36, view_97, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None], self._out_spec)
