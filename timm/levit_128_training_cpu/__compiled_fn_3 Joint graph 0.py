...
def forward(self, primals, tangents):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    index_put: "f32[12, 16]" = torch.ops.aten.index_put.default(full, [None, primals_222], view_369, True);  full = primals_222 = view_369 = None
    full_1: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_2: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_3: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_4: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_5: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_6: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_7: "f32[12, 16]" = torch.ops.aten.full.default([12, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:311, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_8: "f32[16, 49]" = torch.ops.aten.full.default([16, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_9: "f32[16, 49]" = torch.ops.aten.full.default([16, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:161, code: x = x[:, ::self.stride, ::self.stride]
    full_10: "f32[8, 4, 7, 256]" = torch.ops.aten.full.default([8, 4, 7, 256], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_11: "f32[8, 7, 7, 256]" = torch.ops.aten.full.default([8, 7, 7, 256], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_12: "f32[8, 7, 7, 256]" = torch.ops.aten.full.default([8, 7, 7, 256], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_13: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_14: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_15: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_16: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_17: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_18: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_19: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_20: "f32[8, 49]" = torch.ops.aten.full.default([8, 49], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:311, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_21: "f32[8, 196]" = torch.ops.aten.full.default([8, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_22: "f32[8, 196]" = torch.ops.aten.full.default([8, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:161, code: x = x[:, ::self.stride, ::self.stride]
    full_23: "f32[8, 7, 14, 128]" = torch.ops.aten.full.default([8, 7, 14, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_24: "f32[8, 14, 14, 128]" = torch.ops.aten.full.default([8, 14, 14, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_25: "f32[8, 14, 14, 128]" = torch.ops.aten.full.default([8, 14, 14, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_26: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_27: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_28: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_29: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_30: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_31: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/levit.py:211, code: return self.attention_biases[:, self.attention_bias_idxs]
    full_32: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_33: "f32[4, 196]" = torch.ops.aten.full.default([4, 196], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
