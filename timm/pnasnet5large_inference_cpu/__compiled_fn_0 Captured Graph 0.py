...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    x = self.L__mod___conv_0_conv(l_inputs_0_);  l_inputs_0_ = None
    ...
    x_1 = torch.nn.functional.batch_norm(x, l__mod___conv_0_bn_running_mean, l__mod___conv_0_bn_running_var, l__mod___conv_0_bn_weight, l__mod___conv_0_bn_bias, False, 0.1, 0.001);  x = l__mod___conv_0_bn_running_mean = l__mod___conv_0_bn_running_var = l__mod___conv_0_bn_weight = l__mod___conv_0_bn_bias = None
    ...
    x_1008 = self.L__mod___last_linear(x_1007);  x_1007 = None
    return (x_1008,)
