...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 30822224)) \
        and (___check_obj_id(L['___stack0'], 29895712)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 146531696)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(139645885790912))) \
        and (___compile_config_hash() == '5346d23fbe5fbaf895f6c0e83f4a83bf') \
...
def __guard_1_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___compile_config_hash() == '5346d23fbe5fbaf895f6c0e83f4a83bf') \
        and (not ___needs_nopython()) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0], 7617760)) \
        and (len(G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0]) == 2) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[1], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[1] == 0) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_hooks.keys()) == set()) \
        and (___check_obj_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[0], 7628576)) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1], 7617760)) \
        and (len(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1]) == 2) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2], 7617760)) \
        and (len(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2]) == 2) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3], 7617760)) \
        and (len(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3]) == 2) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[4], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[4] == 1) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0][0], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0][0] == 1) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0][1], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].pad_same.__defaults__[0][1] == 1) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_pre_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_pre_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1][0], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1][0] == 1) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1][1], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[1][1] == 1) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2][0], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2][0] == 0) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2][1], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[2][1] == 0) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3][0], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3][0] == 1) \
        and (___check_type_id(G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3][1], 7640416)) \
        and (G['__import_timm_dot_layers_dot_conv2d_same'].conv2d_same.__defaults__[3][1] == 1) \
