...
def forward(self, primals, tangents):
    ...
    constant_pad_nd: "f32[8, 3, 193, 193]" = torch.ops.aten.constant_pad_nd.default(primals_234, [0, 1, 0, 1], 0.0);  primals_234 = None
    ...
    convolution: "f32[8, 16, 96, 96]" = torch.ops.aten.convolution.default(constant_pad_nd, view_2, primals_3, [2, 2], [0, 0], [1, 1], False, [0, 0], 1);  primals_3 = None
    ...
    mul_3: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(convolution, 0.5)
    mul_4: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(convolution, 0.7071067811865476)
    erf: "f32[8, 16, 96, 96]" = torch.ops.aten.erf.default(mul_4);  mul_4 = None
    add_1: "f32[8, 16, 96, 96]" = torch.ops.aten.add.Tensor(erf, 1);  erf = None
    mul_5: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(mul_3, add_1);  mul_3 = add_1 = None
    ...
    mul_6: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(mul_5, 1.7015043497085571);  mul_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_1: "f32[8, 32, 96, 96]" = torch.ops.aten.convolution.default(mul_6, view_5, primals_6, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_10: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_1, 0.5)
    mul_11: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_1, 0.7071067811865476)
    erf_1: "f32[8, 32, 96, 96]" = torch.ops.aten.erf.default(mul_11);  mul_11 = None
    add_3: "f32[8, 32, 96, 96]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_12: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(mul_10, add_3);  mul_10 = add_3 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_13: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(mul_12, 1.7015043497085571);  mul_12 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_2: "f32[8, 64, 96, 96]" = torch.ops.aten.convolution.default(mul_13, view_8, primals_9, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_17: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_2, 0.5)
    mul_18: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_2, 0.7071067811865476)
    erf_2: "f32[8, 64, 96, 96]" = torch.ops.aten.erf.default(mul_18);  mul_18 = None
    add_5: "f32[8, 64, 96, 96]" = torch.ops.aten.add.Tensor(erf_2, 1);  erf_2 = None
    mul_19: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(mul_17, add_5);  mul_17 = add_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_20: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(mul_19, 1.7015043497085571);  mul_19 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_1: "f32[8, 64, 97, 97]" = torch.ops.aten.constant_pad_nd.default(mul_20, [0, 1, 0, 1], 0.0);  mul_20 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_3: "f32[8, 128, 48, 48]" = torch.ops.aten.convolution.default(constant_pad_nd_1, view_11, primals_12, [2, 2], [0, 0], [1, 1], False, [0, 0], 1);  primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_24: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_3, 0.5)
    mul_25: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_3, 0.7071067811865476)
    erf_3: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_25);  mul_25 = None
    add_7: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_3, 1);  erf_3 = None
    mul_26: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_24, add_7);  mul_24 = add_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_27: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_26, 1.7015043497085571);  mul_26 = None
    ...
    mul_28: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_27, 1.0);  mul_27 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_4: "f32[8, 256, 48, 48]" = torch.ops.aten.convolution.default(mul_28, view_14, primals_15, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_15 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_5: "f32[8, 128, 48, 48]" = torch.ops.aten.convolution.default(mul_28, view_17, primals_18, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_35: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_5, 0.5)
    mul_36: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_5, 0.7071067811865476)
    erf_4: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_36);  mul_36 = None
    add_10: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_4, 1);  erf_4 = None
    mul_37: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_35, add_10);  mul_35 = add_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_38: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_37, 1.7015043497085571);  mul_37 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_6: "f32[8, 128, 48, 48]" = torch.ops.aten.convolution.default(mul_38, view_20, primals_21, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_21 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_42: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_6, 0.5)
    mul_43: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_6, 0.7071067811865476)
    erf_5: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_43);  mul_43 = None
    add_12: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_5, 1);  erf_5 = None
    mul_44: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_42, add_12);  mul_42 = add_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_45: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_44, 1.7015043497085571);  mul_44 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_7: "f32[8, 128, 48, 48]" = torch.ops.aten.convolution.default(mul_45, view_23, primals_24, [1, 1], [1, 1], [1, 1], False, [0, 0], 1);  primals_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_49: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_7, 0.5)
    mul_50: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_7, 0.7071067811865476)
    erf_6: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_50);  mul_50 = None
    add_14: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_6, 1);  erf_6 = None
    mul_51: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_49, add_14);  mul_49 = add_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_52: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_51, 1.7015043497085571);  mul_51 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_8: "f32[8, 256, 48, 48]" = torch.ops.aten.convolution.default(mul_52, view_26, primals_27, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_27 = None
    ...
    convolution_9: "f32[8, 128, 1, 1]" = torch.ops.aten.convolution.default(mean, primals_184, primals_185, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_185 = None
    ...
    convolution_10: "f32[8, 256, 1, 1]" = torch.ops.aten.convolution.default(relu, primals_186, primals_187, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_187 = None
    ...
    alias_1: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(sigmoid)
    ...
    mul_56: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_8, sigmoid)
    ...
    mul_57: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_56, 2.0);  mul_56 = None
    ...
    clone: "f32[8, 256, 48, 48]" = torch.ops.aten.clone.default(mul_57)
    mul_58: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_57, primals_28);  mul_57 = None
    ...
    mul_59: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_58, 0.2);  mul_58 = None
    add_16: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(mul_59, convolution_4);  mul_59 = convolution_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_60: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_16, 0.5)
    mul_61: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_16, 0.7071067811865476)
    erf_7: "f32[8, 256, 48, 48]" = torch.ops.aten.erf.default(mul_61);  mul_61 = None
    add_17: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(erf_7, 1);  erf_7 = None
    mul_62: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_60, add_17);  mul_60 = add_17 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_63: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_62, 1.7015043497085571);  mul_62 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_64: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_63, 0.9805806756909201);  mul_63 = None
    ...
    avg_pool2d: "f32[8, 256, 24, 24]" = torch.ops.aten.avg_pool2d.default(mul_64, [2, 2], [2, 2], [0, 0], True, False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_11: "f32[8, 512, 24, 24]" = torch.ops.aten.convolution.default(avg_pool2d, view_29, primals_31, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_31 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_12: "f32[8, 256, 48, 48]" = torch.ops.aten.convolution.default(mul_64, view_32, primals_34, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_34 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_71: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_12, 0.5)
    mul_72: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_12, 0.7071067811865476)
    erf_8: "f32[8, 256, 48, 48]" = torch.ops.aten.erf.default(mul_72);  mul_72 = None
    add_20: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(erf_8, 1);  erf_8 = None
    mul_73: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_71, add_20);  mul_71 = add_20 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_74: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_73, 1.7015043497085571);  mul_73 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_2: "f32[8, 256, 49, 49]" = torch.ops.aten.constant_pad_nd.default(mul_74, [0, 1, 0, 1], 0.0);  mul_74 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_13: "f32[8, 256, 24, 24]" = torch.ops.aten.convolution.default(constant_pad_nd_2, view_35, primals_37, [2, 2], [0, 0], [1, 1], False, [0, 0], 2);  primals_37 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_78: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_13, 0.5)
    mul_79: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_13, 0.7071067811865476)
    erf_9: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_79);  mul_79 = None
    add_22: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_9, 1);  erf_9 = None
    mul_80: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_78, add_22);  mul_78 = add_22 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_81: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_80, 1.7015043497085571);  mul_80 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_14: "f32[8, 256, 24, 24]" = torch.ops.aten.convolution.default(mul_81, view_38, primals_40, [1, 1], [1, 1], [1, 1], False, [0, 0], 2);  primals_40 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_85: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_14, 0.5)
    mul_86: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_14, 0.7071067811865476)
    erf_10: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_86);  mul_86 = None
    add_24: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_10, 1);  erf_10 = None
    mul_87: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_85, add_24);  mul_85 = add_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_88: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_87, 1.7015043497085571);  mul_87 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_15: "f32[8, 512, 24, 24]" = torch.ops.aten.convolution.default(mul_88, view_41, primals_43, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_43 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_1: "f32[8, 512, 1, 1]" = torch.ops.aten.mean.dim(convolution_15, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_16: "f32[8, 256, 1, 1]" = torch.ops.aten.convolution.default(mean_1, primals_188, primals_189, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_189 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_1: "f32[8, 256, 1, 1]" = torch.ops.aten.relu.default(convolution_16);  convolution_16 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_17: "f32[8, 512, 1, 1]" = torch.ops.aten.convolution.default(relu_1, primals_190, primals_191, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_191 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_1: "f32[8, 512, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_17);  convolution_17 = None
    alias_3: "f32[8, 512, 1, 1]" = torch.ops.aten.alias.default(sigmoid_1)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_92: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_15, sigmoid_1)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_93: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_92, 2.0);  mul_92 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_1: "f32[8, 512, 24, 24]" = torch.ops.aten.clone.default(mul_93)
    mul_94: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_93, primals_44);  mul_93 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_95: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_94, 0.2);  mul_94 = None
    add_26: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_95, convolution_11);  mul_95 = convolution_11 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_96: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_26, 0.5)
    mul_97: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_26, 0.7071067811865476)
    erf_11: "f32[8, 512, 24, 24]" = torch.ops.aten.erf.default(mul_97);  mul_97 = None
    add_27: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(erf_11, 1);  erf_11 = None
    mul_98: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_96, add_27);  mul_96 = add_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_99: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_98, 1.7015043497085571);  mul_98 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_100: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_99, 0.9805806756909201);  mul_99 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_18: "f32[8, 256, 24, 24]" = torch.ops.aten.convolution.default(mul_100, view_44, primals_47, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_47 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_104: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_18, 0.5)
    mul_105: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_18, 0.7071067811865476)
    erf_12: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_105);  mul_105 = None
    add_29: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_12, 1);  erf_12 = None
    mul_106: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_104, add_29);  mul_104 = add_29 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_107: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_106, 1.7015043497085571);  mul_106 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_19: "f32[8, 256, 24, 24]" = torch.ops.aten.convolution.default(mul_107, view_47, primals_50, [1, 1], [1, 1], [1, 1], False, [0, 0], 2);  primals_50 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_111: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_19, 0.5)
    mul_112: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_19, 0.7071067811865476)
    erf_13: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_112);  mul_112 = None
    add_31: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_13, 1);  erf_13 = None
    mul_113: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_111, add_31);  mul_111 = add_31 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_114: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_113, 1.7015043497085571);  mul_113 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_20: "f32[8, 256, 24, 24]" = torch.ops.aten.convolution.default(mul_114, view_50, primals_53, [1, 1], [1, 1], [1, 1], False, [0, 0], 2);  primals_53 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_118: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_20, 0.5)
    mul_119: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_20, 0.7071067811865476)
    erf_14: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_119);  mul_119 = None
    add_33: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_14, 1);  erf_14 = None
    mul_120: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_118, add_33);  mul_118 = add_33 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_121: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_120, 1.7015043497085571);  mul_120 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_21: "f32[8, 512, 24, 24]" = torch.ops.aten.convolution.default(mul_121, view_53, primals_56, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_56 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_2: "f32[8, 512, 1, 1]" = torch.ops.aten.mean.dim(convolution_21, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_22: "f32[8, 256, 1, 1]" = torch.ops.aten.convolution.default(mean_2, primals_192, primals_193, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_193 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_2: "f32[8, 256, 1, 1]" = torch.ops.aten.relu.default(convolution_22);  convolution_22 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_23: "f32[8, 512, 1, 1]" = torch.ops.aten.convolution.default(relu_2, primals_194, primals_195, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_195 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_2: "f32[8, 512, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_23);  convolution_23 = None
    alias_5: "f32[8, 512, 1, 1]" = torch.ops.aten.alias.default(sigmoid_2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_125: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_21, sigmoid_2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_126: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_125, 2.0);  mul_125 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_2: "f32[8, 512, 24, 24]" = torch.ops.aten.clone.default(mul_126)
    mul_127: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_126, primals_57);  mul_126 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_128: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_127, 0.2);  mul_127 = None
    add_35: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_128, add_26);  mul_128 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_129: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_35, 0.5)
    mul_130: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_35, 0.7071067811865476)
    erf_15: "f32[8, 512, 24, 24]" = torch.ops.aten.erf.default(mul_130);  mul_130 = None
    add_36: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(erf_15, 1);  erf_15 = None
    mul_131: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_129, add_36);  mul_129 = add_36 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_132: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_131, 1.7015043497085571);  mul_131 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_133: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_132, 0.9622504486493761);  mul_132 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    avg_pool2d_1: "f32[8, 512, 12, 12]" = torch.ops.aten.avg_pool2d.default(mul_133, [2, 2], [2, 2], [0, 0], True, False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_24: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(avg_pool2d_1, view_56, primals_60, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_60 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_25: "f32[8, 768, 24, 24]" = torch.ops.aten.convolution.default(mul_133, view_59, primals_63, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_63 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_140: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_25, 0.5)
    mul_141: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_25, 0.7071067811865476)
    erf_16: "f32[8, 768, 24, 24]" = torch.ops.aten.erf.default(mul_141);  mul_141 = None
    add_39: "f32[8, 768, 24, 24]" = torch.ops.aten.add.Tensor(erf_16, 1);  erf_16 = None
    mul_142: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(mul_140, add_39);  mul_140 = add_39 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_143: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(mul_142, 1.7015043497085571);  mul_142 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_3: "f32[8, 768, 25, 25]" = torch.ops.aten.constant_pad_nd.default(mul_143, [0, 1, 0, 1], 0.0);  mul_143 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_26: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(constant_pad_nd_3, view_62, primals_66, [2, 2], [0, 0], [1, 1], False, [0, 0], 6);  primals_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_147: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_26, 0.5)
    mul_148: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_26, 0.7071067811865476)
    erf_17: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_148);  mul_148 = None
    add_41: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_17, 1);  erf_17 = None
    mul_149: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_147, add_41);  mul_147 = add_41 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_150: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_149, 1.7015043497085571);  mul_149 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_27: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_150, view_65, primals_69, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_69 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_154: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_27, 0.5)
    mul_155: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_27, 0.7071067811865476)
    erf_18: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_155);  mul_155 = None
    add_43: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_18, 1);  erf_18 = None
    mul_156: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_154, add_43);  mul_154 = add_43 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_157: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_156, 1.7015043497085571);  mul_156 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_28: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_157, view_68, primals_72, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_72 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_3: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_28, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_29: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_3, primals_196, primals_197, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_197 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_3: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_29);  convolution_29 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_30: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_3, primals_198, primals_199, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_199 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_3: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_30);  convolution_30 = None
    alias_7: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_3)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_161: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_28, sigmoid_3)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_162: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_161, 2.0);  mul_161 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_3: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_162)
    mul_163: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_162, primals_73);  mul_162 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_164: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_163, 0.2);  mul_163 = None
    add_45: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_164, convolution_24);  mul_164 = convolution_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_165: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_45, 0.5)
    mul_166: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_45, 0.7071067811865476)
    erf_19: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_166);  mul_166 = None
    add_46: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_19, 1);  erf_19 = None
    mul_167: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_165, add_46);  mul_165 = add_46 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_168: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_167, 1.7015043497085571);  mul_167 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_169: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_168, 0.9805806756909201);  mul_168 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_31: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_169, view_71, primals_76, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_76 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_173: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_31, 0.5)
    mul_174: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_31, 0.7071067811865476)
    erf_20: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_174);  mul_174 = None
    add_48: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_20, 1);  erf_20 = None
    mul_175: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_173, add_48);  mul_173 = add_48 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_176: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_175, 1.7015043497085571);  mul_175 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_32: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_176, view_74, primals_79, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_79 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_180: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_32, 0.5)
    mul_181: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_32, 0.7071067811865476)
    erf_21: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_181);  mul_181 = None
    add_50: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_21, 1);  erf_21 = None
    mul_182: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_180, add_50);  mul_180 = add_50 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_183: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_182, 1.7015043497085571);  mul_182 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_33: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_183, view_77, primals_82, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_82 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_187: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_33, 0.5)
    mul_188: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_33, 0.7071067811865476)
    erf_22: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_188);  mul_188 = None
    add_52: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_22, 1);  erf_22 = None
    mul_189: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_187, add_52);  mul_187 = add_52 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_190: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_189, 1.7015043497085571);  mul_189 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_34: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_190, view_80, primals_85, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_85 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_4: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_34, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_35: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_4, primals_200, primals_201, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_201 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_4: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_35);  convolution_35 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_36: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_4, primals_202, primals_203, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_203 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_4: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_36);  convolution_36 = None
    alias_9: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_4)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_194: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_34, sigmoid_4)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_195: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_194, 2.0);  mul_194 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_4: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_195)
    mul_196: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_195, primals_86);  mul_195 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_197: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_196, 0.2);  mul_196 = None
    add_54: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_197, add_45);  mul_197 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_198: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_54, 0.5)
    mul_199: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_54, 0.7071067811865476)
    erf_23: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_199);  mul_199 = None
    add_55: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_23, 1);  erf_23 = None
    mul_200: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_198, add_55);  mul_198 = add_55 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_201: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_200, 1.7015043497085571);  mul_200 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_202: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_201, 0.9622504486493761);  mul_201 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_37: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_202, view_83, primals_89, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_89 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_206: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_37, 0.5)
    mul_207: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_37, 0.7071067811865476)
    erf_24: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_207);  mul_207 = None
    add_57: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_24, 1);  erf_24 = None
    mul_208: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_206, add_57);  mul_206 = add_57 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_209: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_208, 1.7015043497085571);  mul_208 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_38: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_209, view_86, primals_92, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_92 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_213: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_38, 0.5)
    mul_214: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_38, 0.7071067811865476)
    erf_25: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_214);  mul_214 = None
    add_59: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_25, 1);  erf_25 = None
    mul_215: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_213, add_59);  mul_213 = add_59 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_216: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_215, 1.7015043497085571);  mul_215 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_39: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_216, view_89, primals_95, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_95 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_220: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_39, 0.5)
    mul_221: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_39, 0.7071067811865476)
    erf_26: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_221);  mul_221 = None
    add_61: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_26, 1);  erf_26 = None
    mul_222: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_220, add_61);  mul_220 = add_61 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_223: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_222, 1.7015043497085571);  mul_222 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_40: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_223, view_92, primals_98, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_98 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_5: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_40, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_41: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_5, primals_204, primals_205, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_205 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_5: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_41);  convolution_41 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_42: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_5, primals_206, primals_207, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_207 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_5: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_42);  convolution_42 = None
    alias_11: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_5)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_227: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_40, sigmoid_5)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_228: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_227, 2.0);  mul_227 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_5: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_228)
    mul_229: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_228, primals_99);  mul_228 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_230: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_229, 0.2);  mul_229 = None
    add_63: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_230, add_54);  mul_230 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_231: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_63, 0.5)
    mul_232: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_63, 0.7071067811865476)
    erf_27: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_232);  mul_232 = None
    add_64: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_27, 1);  erf_27 = None
    mul_233: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_231, add_64);  mul_231 = add_64 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_234: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_233, 1.7015043497085571);  mul_233 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_235: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_234, 0.9449111825230679);  mul_234 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_43: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_235, view_95, primals_102, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_102 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_239: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_43, 0.5)
    mul_240: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_43, 0.7071067811865476)
    erf_28: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_240);  mul_240 = None
    add_66: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_28, 1);  erf_28 = None
    mul_241: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_239, add_66);  mul_239 = add_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_242: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_241, 1.7015043497085571);  mul_241 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_44: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_242, view_98, primals_105, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_105 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_246: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_44, 0.5)
    mul_247: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_44, 0.7071067811865476)
    erf_29: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_247);  mul_247 = None
    add_68: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_29, 1);  erf_29 = None
    mul_248: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_246, add_68);  mul_246 = add_68 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_249: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_248, 1.7015043497085571);  mul_248 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_45: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_249, view_101, primals_108, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_108 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_253: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_45, 0.5)
    mul_254: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_45, 0.7071067811865476)
    erf_30: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_254);  mul_254 = None
    add_70: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_30, 1);  erf_30 = None
    mul_255: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_253, add_70);  mul_253 = add_70 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_256: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_255, 1.7015043497085571);  mul_255 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_46: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_256, view_104, primals_111, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_111 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_6: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_46, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_47: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_6, primals_208, primals_209, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_209 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_6: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_47);  convolution_47 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_48: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_6, primals_210, primals_211, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_211 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_6: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_48);  convolution_48 = None
    alias_13: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_6)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_260: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_46, sigmoid_6)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_261: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_260, 2.0);  mul_260 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_6: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_261)
    mul_262: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_261, primals_112);  mul_261 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_263: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_262, 0.2);  mul_262 = None
    add_72: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_263, add_63);  mul_263 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_264: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_72, 0.5)
    mul_265: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_72, 0.7071067811865476)
    erf_31: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_265);  mul_265 = None
    add_73: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_31, 1);  erf_31 = None
    mul_266: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_264, add_73);  mul_264 = add_73 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_267: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_266, 1.7015043497085571);  mul_266 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_268: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_267, 0.9284766908852592);  mul_267 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_49: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_268, view_107, primals_115, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_115 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_272: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_49, 0.5)
    mul_273: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_49, 0.7071067811865476)
    erf_32: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_273);  mul_273 = None
    add_75: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_32, 1);  erf_32 = None
    mul_274: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_272, add_75);  mul_272 = add_75 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_275: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_274, 1.7015043497085571);  mul_274 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_50: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_275, view_110, primals_118, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_118 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_279: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_50, 0.5)
    mul_280: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_50, 0.7071067811865476)
    erf_33: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_280);  mul_280 = None
    add_77: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_33, 1);  erf_33 = None
    mul_281: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_279, add_77);  mul_279 = add_77 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_282: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_281, 1.7015043497085571);  mul_281 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_51: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_282, view_113, primals_121, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_121 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_286: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_51, 0.5)
    mul_287: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_51, 0.7071067811865476)
    erf_34: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_287);  mul_287 = None
    add_79: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_34, 1);  erf_34 = None
    mul_288: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_286, add_79);  mul_286 = add_79 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_289: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_288, 1.7015043497085571);  mul_288 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_52: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_289, view_116, primals_124, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_124 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_7: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_52, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_53: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_7, primals_212, primals_213, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_213 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_7: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_53);  convolution_53 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_54: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_7, primals_214, primals_215, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_215 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_7: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_54);  convolution_54 = None
    alias_15: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_7)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_293: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_52, sigmoid_7)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_294: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_293, 2.0);  mul_293 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_7: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_294)
    mul_295: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_294, primals_125);  mul_294 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_296: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_295, 0.2);  mul_295 = None
    add_81: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_296, add_72);  mul_296 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_297: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_81, 0.5)
    mul_298: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_81, 0.7071067811865476)
    erf_35: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_298);  mul_298 = None
    add_82: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_35, 1);  erf_35 = None
    mul_299: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_297, add_82);  mul_297 = add_82 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_300: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_299, 1.7015043497085571);  mul_299 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_301: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_300, 0.9128709291752768);  mul_300 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_55: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_301, view_119, primals_128, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_128 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_305: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_55, 0.5)
    mul_306: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_55, 0.7071067811865476)
    erf_36: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_306);  mul_306 = None
    add_84: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_36, 1);  erf_36 = None
    mul_307: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_305, add_84);  mul_305 = add_84 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_308: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_307, 1.7015043497085571);  mul_307 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_56: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_308, view_122, primals_131, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_131 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_312: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_56, 0.5)
    mul_313: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_56, 0.7071067811865476)
    erf_37: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_313);  mul_313 = None
    add_86: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_37, 1);  erf_37 = None
    mul_314: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_312, add_86);  mul_312 = add_86 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_315: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_314, 1.7015043497085571);  mul_314 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_57: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_315, view_125, primals_134, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_134 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_319: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_57, 0.5)
    mul_320: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_57, 0.7071067811865476)
    erf_38: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_320);  mul_320 = None
    add_88: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_38, 1);  erf_38 = None
    mul_321: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_319, add_88);  mul_319 = add_88 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_322: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_321, 1.7015043497085571);  mul_321 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_58: "f32[8, 1536, 12, 12]" = torch.ops.aten.convolution.default(mul_322, view_128, primals_137, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_137 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_8: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_58, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_59: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_8, primals_216, primals_217, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_217 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_8: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_59);  convolution_59 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_60: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_8, primals_218, primals_219, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_219 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_8: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_60);  convolution_60 = None
    alias_17: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_326: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_58, sigmoid_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_327: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_326, 2.0);  mul_326 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_8: "f32[8, 1536, 12, 12]" = torch.ops.aten.clone.default(mul_327)
    mul_328: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_327, primals_138);  mul_327 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_329: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_328, 0.2);  mul_328 = None
    add_90: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_329, add_81);  mul_329 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_330: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_90, 0.5)
    mul_331: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_90, 0.7071067811865476)
    erf_39: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_331);  mul_331 = None
    add_91: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_39, 1);  erf_39 = None
    mul_332: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_330, add_91);  mul_330 = add_91 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_333: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_332, 1.7015043497085571);  mul_332 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_334: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_333, 0.8980265101338745);  mul_333 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    avg_pool2d_2: "f32[8, 1536, 6, 6]" = torch.ops.aten.avg_pool2d.default(mul_334, [2, 2], [2, 2], [0, 0], True, False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_61: "f32[8, 1536, 6, 6]" = torch.ops.aten.convolution.default(avg_pool2d_2, view_131, primals_141, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_141 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_62: "f32[8, 768, 12, 12]" = torch.ops.aten.convolution.default(mul_334, view_134, primals_144, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_144 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_341: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_62, 0.5)
    mul_342: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_62, 0.7071067811865476)
    erf_40: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_342);  mul_342 = None
    add_94: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_40, 1);  erf_40 = None
    mul_343: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_341, add_94);  mul_341 = add_94 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_344: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_343, 1.7015043497085571);  mul_343 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_4: "f32[8, 768, 13, 13]" = torch.ops.aten.constant_pad_nd.default(mul_344, [0, 1, 0, 1], 0.0);  mul_344 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_63: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(constant_pad_nd_4, view_137, primals_147, [2, 2], [0, 0], [1, 1], False, [0, 0], 6);  primals_147 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_348: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_63, 0.5)
    mul_349: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_63, 0.7071067811865476)
    erf_41: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_349);  mul_349 = None
    add_96: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_41, 1);  erf_41 = None
    mul_350: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_348, add_96);  mul_348 = add_96 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_351: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_350, 1.7015043497085571);  mul_350 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_64: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_351, view_140, primals_150, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_150 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_355: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_64, 0.5)
    mul_356: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_64, 0.7071067811865476)
    erf_42: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_356);  mul_356 = None
    add_98: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_42, 1);  erf_42 = None
    mul_357: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_355, add_98);  mul_355 = add_98 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_358: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_357, 1.7015043497085571);  mul_357 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_65: "f32[8, 1536, 6, 6]" = torch.ops.aten.convolution.default(mul_358, view_143, primals_153, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_153 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_9: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_65, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_66: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_9, primals_220, primals_221, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_221 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_9: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_66);  convolution_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_67: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_9, primals_222, primals_223, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_223 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_9: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_67);  convolution_67 = None
    alias_19: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_9)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_362: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_65, sigmoid_9)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_363: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_362, 2.0);  mul_362 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_9: "f32[8, 1536, 6, 6]" = torch.ops.aten.clone.default(mul_363)
    mul_364: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_363, primals_154);  mul_363 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_365: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_364, 0.2);  mul_364 = None
    add_100: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_365, convolution_61);  mul_365 = convolution_61 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_366: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_100, 0.5)
    mul_367: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_100, 0.7071067811865476)
    erf_43: "f32[8, 1536, 6, 6]" = torch.ops.aten.erf.default(mul_367);  mul_367 = None
    add_101: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(erf_43, 1);  erf_43 = None
    mul_368: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_366, add_101);  mul_366 = add_101 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_369: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_368, 1.7015043497085571);  mul_368 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_370: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_369, 0.9805806756909201);  mul_369 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_68: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_370, view_146, primals_157, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_157 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_374: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_68, 0.5)
    mul_375: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_68, 0.7071067811865476)
    erf_44: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_375);  mul_375 = None
    add_103: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_44, 1);  erf_44 = None
    mul_376: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_374, add_103);  mul_374 = add_103 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_377: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_376, 1.7015043497085571);  mul_376 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_69: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_377, view_149, primals_160, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_160 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_381: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_69, 0.5)
    mul_382: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_69, 0.7071067811865476)
    erf_45: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_382);  mul_382 = None
    add_105: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_45, 1);  erf_45 = None
    mul_383: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_381, add_105);  mul_381 = add_105 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_384: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_383, 1.7015043497085571);  mul_383 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_70: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_384, view_152, primals_163, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_163 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_388: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_70, 0.5)
    mul_389: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_70, 0.7071067811865476)
    erf_46: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_389);  mul_389 = None
    add_107: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_46, 1);  erf_46 = None
    mul_390: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_388, add_107);  mul_388 = add_107 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_391: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_390, 1.7015043497085571);  mul_390 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_71: "f32[8, 1536, 6, 6]" = torch.ops.aten.convolution.default(mul_391, view_155, primals_166, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_166 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_10: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_71, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_72: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_10, primals_224, primals_225, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_225 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_10: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_72);  convolution_72 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_73: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_10, primals_226, primals_227, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_227 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_10: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_73);  convolution_73 = None
    alias_21: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_10)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_395: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_71, sigmoid_10)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_396: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_395, 2.0);  mul_395 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_10: "f32[8, 1536, 6, 6]" = torch.ops.aten.clone.default(mul_396)
    mul_397: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_396, primals_167);  mul_396 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_398: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_397, 0.2);  mul_397 = None
    add_109: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_398, add_100);  mul_398 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_399: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_109, 0.5)
    mul_400: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_109, 0.7071067811865476)
    erf_47: "f32[8, 1536, 6, 6]" = torch.ops.aten.erf.default(mul_400);  mul_400 = None
    add_110: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(erf_47, 1);  erf_47 = None
    mul_401: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_399, add_110);  mul_399 = add_110 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_402: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_401, 1.7015043497085571);  mul_401 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_403: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_402, 0.9622504486493761);  mul_402 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_74: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_403, view_158, primals_170, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_170 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_407: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_74, 0.5)
    mul_408: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_74, 0.7071067811865476)
    erf_48: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_408);  mul_408 = None
    add_112: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_48, 1);  erf_48 = None
    mul_409: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_407, add_112);  mul_407 = add_112 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_410: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_409, 1.7015043497085571);  mul_409 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_75: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_410, view_161, primals_173, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_173 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_414: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_75, 0.5)
    mul_415: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_75, 0.7071067811865476)
    erf_49: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_415);  mul_415 = None
    add_114: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_49, 1);  erf_49 = None
    mul_416: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_414, add_114);  mul_414 = add_114 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_417: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_416, 1.7015043497085571);  mul_416 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_76: "f32[8, 768, 6, 6]" = torch.ops.aten.convolution.default(mul_417, view_164, primals_176, [1, 1], [1, 1], [1, 1], False, [0, 0], 6);  primals_176 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_421: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_76, 0.5)
    mul_422: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_76, 0.7071067811865476)
    erf_50: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_422);  mul_422 = None
    add_116: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_50, 1);  erf_50 = None
    mul_423: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_421, add_116);  mul_421 = add_116 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_424: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_423, 1.7015043497085571);  mul_423 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_77: "f32[8, 1536, 6, 6]" = torch.ops.aten.convolution.default(mul_424, view_167, primals_179, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_179 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    mean_11: "f32[8, 1536, 1, 1]" = torch.ops.aten.mean.dim(convolution_77, [2, 3], True)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_78: "f32[8, 768, 1, 1]" = torch.ops.aten.convolution.default(mean_11, primals_228, primals_229, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_229 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    relu_11: "f32[8, 768, 1, 1]" = torch.ops.aten.relu.default(convolution_78);  convolution_78 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_79: "f32[8, 1536, 1, 1]" = torch.ops.aten.convolution.default(relu_11, primals_230, primals_231, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_231 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    sigmoid_11: "f32[8, 1536, 1, 1]" = torch.ops.aten.sigmoid.default(convolution_79);  convolution_79 = None
    alias_23: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(sigmoid_11)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_428: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_77, sigmoid_11)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_429: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_428, 2.0);  mul_428 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    clone_11: "f32[8, 1536, 6, 6]" = torch.ops.aten.clone.default(mul_429)
    mul_430: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_429, primals_180);  mul_429 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_431: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_430, 0.2);  mul_430 = None
    add_118: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_431, add_109);  mul_431 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_80: "f32[8, 3072, 6, 6]" = torch.ops.aten.convolution.default(add_118, view_170, primals_183, [1, 1], [0, 0], [1, 1], False, [0, 0], 1);  primals_183 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_435: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_80, 0.5)
    mul_436: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_80, 0.7071067811865476)
    erf_51: "f32[8, 3072, 6, 6]" = torch.ops.aten.erf.default(mul_436);  mul_436 = None
    add_120: "f32[8, 3072, 6, 6]" = torch.ops.aten.add.Tensor(erf_51, 1);  erf_51 = None
    mul_437: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(mul_435, add_120);  mul_435 = add_120 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_438: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(mul_437, 1.7015043497085571);  mul_437 = None
    ...
    view_171: "f32[8, 3072]" = torch.ops.aten.view.default(mean_12, [8, 3072]);  mean_12 = None
    ...
    clone_12: "f32[8, 3072]" = torch.ops.aten.clone.default(view_171);  view_171 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/classifier.py:134, code: x = self.fc(x)
    permute: "f32[3072, 1000]" = torch.ops.aten.permute.default(primals_232, [1, 0]);  primals_232 = None
    addmm: "f32[8, 1000]" = torch.ops.aten.addmm.default(primals_233, clone_12, permute);  primals_233 = None
    permute_1: "f32[1000, 3072]" = torch.ops.aten.permute.default(permute, [1, 0]);  permute = None
    mm: "f32[8, 3072]" = torch.ops.aten.mm.default(tangents_1, permute_1);  permute_1 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/adaptive_avgmax_pool.py:168, code: x = self.flatten(x)
    view_173: "f32[8, 3072, 1, 1]" = torch.ops.aten.view.default(mm, [8, 3072, 1, 1]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/adaptive_avgmax_pool.py:167, code: x = self.pool(x)
    expand: "f32[8, 3072, 6, 6]" = torch.ops.aten.expand.default(view_173, [8, 3072, 6, 6]);  view_173 = None
    div: "f32[8, 3072, 6, 6]" = torch.ops.aten.div.Scalar(expand, 36);  expand = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_439: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(div, 1.7015043497085571);  div = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_440: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_80, 0.7071067811865476)
    erf_52: "f32[8, 3072, 6, 6]" = torch.ops.aten.erf.default(mul_440);  mul_440 = None
    add_121: "f32[8, 3072, 6, 6]" = torch.ops.aten.add.Tensor(erf_52, 1);  erf_52 = None
    mul_441: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(add_121, 0.5);  add_121 = None
    mul_442: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_80, convolution_80)
    mul_443: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(mul_442, -0.5);  mul_442 = None
    exp: "f32[8, 3072, 6, 6]" = torch.ops.aten.exp.default(mul_443);  mul_443 = None
    mul_444: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(exp, 0.3989422804014327);  exp = None
    mul_445: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_80, mul_444);  convolution_80 = mul_444 = None
    add_122: "f32[8, 3072, 6, 6]" = torch.ops.aten.add.Tensor(mul_441, mul_445);  mul_441 = mul_445 = None
    mul_446: "f32[8, 3072, 6, 6]" = torch.ops.aten.mul.Tensor(mul_439, add_122);  mul_439 = add_122 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward = torch.ops.aten.convolution_backward.default(mul_446, add_118, view_170, [3072], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_446 = add_118 = view_170 = None
    getitem_114: "f32[8, 1536, 6, 6]" = convolution_backward[0]
    getitem_115: "f32[3072, 1536, 1, 1]" = convolution_backward[1]
    getitem_116: "f32[3072]" = convolution_backward[2];  convolution_backward = None
    ...
    sum_2: "f32[3072]" = torch.ops.aten.sum.dim_IntList(view_174, [0, 2])
    ...
    sum_3: "f32[3072]" = torch.ops.aten.sum.dim_IntList(mul_447, [0, 2]);  mul_447 = None
    mul_448: "f32[3072]" = torch.ops.aten.mul.Tensor(sum_2, 0.0006510416666666666);  sum_2 = None
    ...
    mul_449: "f32[3072]" = torch.ops.aten.mul.Tensor(sum_3, 0.0006510416666666666)
    ...
    mul_455: "f32[3072]" = torch.ops.aten.mul.Tensor(sum_3, squeeze_113);  sum_3 = squeeze_113 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_457: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_114, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_458: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_457, clone_11);  clone_11 = None
    mul_459: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_457, primals_180);  mul_457 = primals_180 = None
    sum_4: "f32[]" = torch.ops.aten.sum.default(mul_458);  mul_458 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_460: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_459, 2.0);  mul_459 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_461: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_460, convolution_77);  convolution_77 = None
    mul_462: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_460, sigmoid_11);  mul_460 = sigmoid_11 = None
    sum_5: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_461, [2, 3], True);  mul_461 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_24: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_23);  alias_23 = None
    sub_61: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_24)
    mul_463: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_24, sub_61);  alias_24 = sub_61 = None
    mul_464: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_5, mul_463);  sum_5 = mul_463 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_1 = torch.ops.aten.convolution_backward.default(mul_464, relu_11, primals_230, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_464 = primals_230 = None
    getitem_117: "f32[8, 768, 1, 1]" = convolution_backward_1[0]
    getitem_118: "f32[1536, 768, 1, 1]" = convolution_backward_1[1]
    getitem_119: "f32[1536]" = convolution_backward_1[2];  convolution_backward_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_26: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_11);  relu_11 = None
    alias_27: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_26);  alias_26 = None
    le: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_27, 0);  alias_27 = None
    scalar_tensor: "f32[]" = torch.ops.aten.scalar_tensor.default(0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'))
    where: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le, scalar_tensor, getitem_117);  le = scalar_tensor = getitem_117 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_2 = torch.ops.aten.convolution_backward.default(where, mean_11, primals_228, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where = mean_11 = primals_228 = None
    getitem_120: "f32[8, 1536, 1, 1]" = convolution_backward_2[0]
    getitem_121: "f32[768, 1536, 1, 1]" = convolution_backward_2[1]
    getitem_122: "f32[768]" = convolution_backward_2[2];  convolution_backward_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_1: "f32[8, 1536, 6, 6]" = torch.ops.aten.expand.default(getitem_120, [8, 1536, 6, 6]);  getitem_120 = None
    div_1: "f32[8, 1536, 6, 6]" = torch.ops.aten.div.Scalar(expand_1, 36);  expand_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_123: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_462, div_1);  mul_462 = div_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_3 = torch.ops.aten.convolution_backward.default(add_123, mul_424, view_167, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_123 = mul_424 = view_167 = None
    getitem_123: "f32[8, 768, 6, 6]" = convolution_backward_3[0]
    getitem_124: "f32[1536, 768, 1, 1]" = convolution_backward_3[1]
    getitem_125: "f32[1536]" = convolution_backward_3[2];  convolution_backward_3 = None
    ...
    sum_6: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_177, [0, 2])
    ...
    sum_7: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_465, [0, 2]);  mul_465 = None
    mul_466: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_6, 0.0013020833333333333);  sum_6 = None
    ...
    mul_467: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_7, 0.0013020833333333333)
    ...
    mul_473: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_7, squeeze_111);  sum_7 = squeeze_111 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_475: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_123, 1.7015043497085571);  getitem_123 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_476: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_76, 0.7071067811865476)
    erf_53: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_476);  mul_476 = None
    add_124: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_53, 1);  erf_53 = None
    mul_477: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_124, 0.5);  add_124 = None
    mul_478: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_76, convolution_76)
    mul_479: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_478, -0.5);  mul_478 = None
    exp_1: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_479);  mul_479 = None
    mul_480: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_1, 0.3989422804014327);  exp_1 = None
    mul_481: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_76, mul_480);  convolution_76 = mul_480 = None
    add_125: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_477, mul_481);  mul_477 = mul_481 = None
    mul_482: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_475, add_125);  mul_475 = add_125 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_4 = torch.ops.aten.convolution_backward.default(mul_482, mul_417, view_164, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_482 = mul_417 = view_164 = None
    getitem_126: "f32[8, 768, 6, 6]" = convolution_backward_4[0]
    getitem_127: "f32[768, 128, 3, 3]" = convolution_backward_4[1]
    getitem_128: "f32[768]" = convolution_backward_4[2];  convolution_backward_4 = None
    ...
    sum_8: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_180, [0, 2])
    ...
    sum_9: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_483, [0, 2]);  mul_483 = None
    mul_484: "f32[768]" = torch.ops.aten.mul.Tensor(sum_8, 0.0008680555555555555);  sum_8 = None
    ...
    mul_485: "f32[768]" = torch.ops.aten.mul.Tensor(sum_9, 0.0008680555555555555)
    ...
    mul_491: "f32[768]" = torch.ops.aten.mul.Tensor(sum_9, squeeze_109);  sum_9 = squeeze_109 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_493: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_126, 1.7015043497085571);  getitem_126 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_494: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_75, 0.7071067811865476)
    erf_54: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_494);  mul_494 = None
    add_126: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_54, 1);  erf_54 = None
    mul_495: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_126, 0.5);  add_126 = None
    mul_496: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_75, convolution_75)
    mul_497: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_496, -0.5);  mul_496 = None
    exp_2: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_497);  mul_497 = None
    mul_498: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_2, 0.3989422804014327);  exp_2 = None
    mul_499: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_75, mul_498);  convolution_75 = mul_498 = None
    add_127: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_495, mul_499);  mul_495 = mul_499 = None
    mul_500: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_493, add_127);  mul_493 = add_127 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_5 = torch.ops.aten.convolution_backward.default(mul_500, mul_410, view_161, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_500 = mul_410 = view_161 = None
    getitem_129: "f32[8, 768, 6, 6]" = convolution_backward_5[0]
    getitem_130: "f32[768, 128, 3, 3]" = convolution_backward_5[1]
    getitem_131: "f32[768]" = convolution_backward_5[2];  convolution_backward_5 = None
    ...
    sum_10: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_183, [0, 2])
    ...
    sum_11: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_501, [0, 2]);  mul_501 = None
    mul_502: "f32[768]" = torch.ops.aten.mul.Tensor(sum_10, 0.0008680555555555555);  sum_10 = None
    ...
    mul_503: "f32[768]" = torch.ops.aten.mul.Tensor(sum_11, 0.0008680555555555555)
    ...
    mul_509: "f32[768]" = torch.ops.aten.mul.Tensor(sum_11, squeeze_107);  sum_11 = squeeze_107 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_511: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_129, 1.7015043497085571);  getitem_129 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_512: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_74, 0.7071067811865476)
    erf_55: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_512);  mul_512 = None
    add_128: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_55, 1);  erf_55 = None
    mul_513: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_128, 0.5);  add_128 = None
    mul_514: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_74, convolution_74)
    mul_515: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_514, -0.5);  mul_514 = None
    exp_3: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_515);  mul_515 = None
    mul_516: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_3, 0.3989422804014327);  exp_3 = None
    mul_517: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_74, mul_516);  convolution_74 = mul_516 = None
    add_129: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_513, mul_517);  mul_513 = mul_517 = None
    mul_518: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_511, add_129);  mul_511 = add_129 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_6 = torch.ops.aten.convolution_backward.default(mul_518, mul_403, view_158, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_518 = mul_403 = view_158 = None
    getitem_132: "f32[8, 1536, 6, 6]" = convolution_backward_6[0]
    getitem_133: "f32[768, 1536, 1, 1]" = convolution_backward_6[1]
    getitem_134: "f32[768]" = convolution_backward_6[2];  convolution_backward_6 = None
    ...
    sum_12: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_186, [0, 2])
    ...
    sum_13: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_519, [0, 2]);  mul_519 = None
    mul_520: "f32[768]" = torch.ops.aten.mul.Tensor(sum_12, 0.0006510416666666666);  sum_12 = None
    ...
    mul_521: "f32[768]" = torch.ops.aten.mul.Tensor(sum_13, 0.0006510416666666666)
    ...
    mul_527: "f32[768]" = torch.ops.aten.mul.Tensor(sum_13, squeeze_105);  sum_13 = squeeze_105 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_529: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_132, 0.9622504486493761);  getitem_132 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_530: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_529, 1.7015043497085571);  mul_529 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_531: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_109, 0.7071067811865476)
    erf_56: "f32[8, 1536, 6, 6]" = torch.ops.aten.erf.default(mul_531);  mul_531 = None
    add_130: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(erf_56, 1);  erf_56 = None
    mul_532: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_130, 0.5);  add_130 = None
    mul_533: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_109, add_109)
    mul_534: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_533, -0.5);  mul_533 = None
    exp_4: "f32[8, 1536, 6, 6]" = torch.ops.aten.exp.default(mul_534);  mul_534 = None
    mul_535: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(exp_4, 0.3989422804014327);  exp_4 = None
    mul_536: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_109, mul_535);  add_109 = mul_535 = None
    add_131: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_532, mul_536);  mul_532 = mul_536 = None
    mul_537: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_530, add_131);  mul_530 = add_131 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_132: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(getitem_114, mul_537);  getitem_114 = mul_537 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_538: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_132, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_539: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_538, clone_10);  clone_10 = None
    mul_540: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_538, primals_167);  mul_538 = primals_167 = None
    sum_14: "f32[]" = torch.ops.aten.sum.default(mul_539);  mul_539 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_541: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_540, 2.0);  mul_540 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_542: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_541, convolution_71);  convolution_71 = None
    mul_543: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_541, sigmoid_10);  mul_541 = sigmoid_10 = None
    sum_15: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_542, [2, 3], True);  mul_542 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_28: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_21);  alias_21 = None
    sub_78: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_28)
    mul_544: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_28, sub_78);  alias_28 = sub_78 = None
    mul_545: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_15, mul_544);  sum_15 = mul_544 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_7 = torch.ops.aten.convolution_backward.default(mul_545, relu_10, primals_226, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_545 = primals_226 = None
    getitem_135: "f32[8, 768, 1, 1]" = convolution_backward_7[0]
    getitem_136: "f32[1536, 768, 1, 1]" = convolution_backward_7[1]
    getitem_137: "f32[1536]" = convolution_backward_7[2];  convolution_backward_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_30: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_10);  relu_10 = None
    alias_31: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_30);  alias_30 = None
    le_1: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_31, 0);  alias_31 = None
    ...
    where_1: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_1, scalar_tensor_1, getitem_135);  le_1 = scalar_tensor_1 = getitem_135 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_8 = torch.ops.aten.convolution_backward.default(where_1, mean_10, primals_224, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_1 = mean_10 = primals_224 = None
    getitem_138: "f32[8, 1536, 1, 1]" = convolution_backward_8[0]
    getitem_139: "f32[768, 1536, 1, 1]" = convolution_backward_8[1]
    getitem_140: "f32[768]" = convolution_backward_8[2];  convolution_backward_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_2: "f32[8, 1536, 6, 6]" = torch.ops.aten.expand.default(getitem_138, [8, 1536, 6, 6]);  getitem_138 = None
    div_2: "f32[8, 1536, 6, 6]" = torch.ops.aten.div.Scalar(expand_2, 36);  expand_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_133: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_543, div_2);  mul_543 = div_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_9 = torch.ops.aten.convolution_backward.default(add_133, mul_391, view_155, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_133 = mul_391 = view_155 = None
    getitem_141: "f32[8, 768, 6, 6]" = convolution_backward_9[0]
    getitem_142: "f32[1536, 768, 1, 1]" = convolution_backward_9[1]
    getitem_143: "f32[1536]" = convolution_backward_9[2];  convolution_backward_9 = None
    ...
    sum_16: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_189, [0, 2])
    ...
    sum_17: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_546, [0, 2]);  mul_546 = None
    mul_547: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_16, 0.0013020833333333333);  sum_16 = None
    ...
    mul_548: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_17, 0.0013020833333333333)
    ...
    mul_554: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_17, squeeze_103);  sum_17 = squeeze_103 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_556: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_141, 1.7015043497085571);  getitem_141 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_557: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_70, 0.7071067811865476)
    erf_57: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_557);  mul_557 = None
    add_134: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_57, 1);  erf_57 = None
    mul_558: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_134, 0.5);  add_134 = None
    mul_559: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_70, convolution_70)
    mul_560: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_559, -0.5);  mul_559 = None
    exp_5: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_560);  mul_560 = None
    mul_561: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_5, 0.3989422804014327);  exp_5 = None
    mul_562: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_70, mul_561);  convolution_70 = mul_561 = None
    add_135: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_558, mul_562);  mul_558 = mul_562 = None
    mul_563: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_556, add_135);  mul_556 = add_135 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_10 = torch.ops.aten.convolution_backward.default(mul_563, mul_384, view_152, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_563 = mul_384 = view_152 = None
    getitem_144: "f32[8, 768, 6, 6]" = convolution_backward_10[0]
    getitem_145: "f32[768, 128, 3, 3]" = convolution_backward_10[1]
    getitem_146: "f32[768]" = convolution_backward_10[2];  convolution_backward_10 = None
    ...
    sum_18: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_192, [0, 2])
    ...
    sum_19: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_564, [0, 2]);  mul_564 = None
    mul_565: "f32[768]" = torch.ops.aten.mul.Tensor(sum_18, 0.0008680555555555555);  sum_18 = None
    ...
    mul_566: "f32[768]" = torch.ops.aten.mul.Tensor(sum_19, 0.0008680555555555555)
    ...
    mul_572: "f32[768]" = torch.ops.aten.mul.Tensor(sum_19, squeeze_101);  sum_19 = squeeze_101 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_574: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_144, 1.7015043497085571);  getitem_144 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_575: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_69, 0.7071067811865476)
    erf_58: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_575);  mul_575 = None
    add_136: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_58, 1);  erf_58 = None
    mul_576: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_136, 0.5);  add_136 = None
    mul_577: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_69, convolution_69)
    mul_578: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_577, -0.5);  mul_577 = None
    exp_6: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_578);  mul_578 = None
    mul_579: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_6, 0.3989422804014327);  exp_6 = None
    mul_580: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_69, mul_579);  convolution_69 = mul_579 = None
    add_137: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_576, mul_580);  mul_576 = mul_580 = None
    mul_581: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_574, add_137);  mul_574 = add_137 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_11 = torch.ops.aten.convolution_backward.default(mul_581, mul_377, view_149, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_581 = mul_377 = view_149 = None
    getitem_147: "f32[8, 768, 6, 6]" = convolution_backward_11[0]
    getitem_148: "f32[768, 128, 3, 3]" = convolution_backward_11[1]
    getitem_149: "f32[768]" = convolution_backward_11[2];  convolution_backward_11 = None
    ...
    sum_20: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_195, [0, 2])
    ...
    sum_21: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_582, [0, 2]);  mul_582 = None
    mul_583: "f32[768]" = torch.ops.aten.mul.Tensor(sum_20, 0.0008680555555555555);  sum_20 = None
    ...
    mul_584: "f32[768]" = torch.ops.aten.mul.Tensor(sum_21, 0.0008680555555555555)
    ...
    mul_590: "f32[768]" = torch.ops.aten.mul.Tensor(sum_21, squeeze_99);  sum_21 = squeeze_99 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_592: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_147, 1.7015043497085571);  getitem_147 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_593: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_68, 0.7071067811865476)
    erf_59: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_593);  mul_593 = None
    add_138: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_59, 1);  erf_59 = None
    mul_594: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_138, 0.5);  add_138 = None
    mul_595: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_68, convolution_68)
    mul_596: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_595, -0.5);  mul_595 = None
    exp_7: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_596);  mul_596 = None
    mul_597: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_7, 0.3989422804014327);  exp_7 = None
    mul_598: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_68, mul_597);  convolution_68 = mul_597 = None
    add_139: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_594, mul_598);  mul_594 = mul_598 = None
    mul_599: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_592, add_139);  mul_592 = add_139 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_12 = torch.ops.aten.convolution_backward.default(mul_599, mul_370, view_146, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_599 = mul_370 = view_146 = None
    getitem_150: "f32[8, 1536, 6, 6]" = convolution_backward_12[0]
    getitem_151: "f32[768, 1536, 1, 1]" = convolution_backward_12[1]
    getitem_152: "f32[768]" = convolution_backward_12[2];  convolution_backward_12 = None
    ...
    sum_22: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_198, [0, 2])
    ...
    sum_23: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_600, [0, 2]);  mul_600 = None
    mul_601: "f32[768]" = torch.ops.aten.mul.Tensor(sum_22, 0.0006510416666666666);  sum_22 = None
    ...
    mul_602: "f32[768]" = torch.ops.aten.mul.Tensor(sum_23, 0.0006510416666666666)
    ...
    mul_608: "f32[768]" = torch.ops.aten.mul.Tensor(sum_23, squeeze_97);  sum_23 = squeeze_97 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_610: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_150, 0.9805806756909201);  getitem_150 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_611: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_610, 1.7015043497085571);  mul_610 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_612: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_100, 0.7071067811865476)
    erf_60: "f32[8, 1536, 6, 6]" = torch.ops.aten.erf.default(mul_612);  mul_612 = None
    add_140: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(erf_60, 1);  erf_60 = None
    mul_613: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_140, 0.5);  add_140 = None
    mul_614: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_100, add_100)
    mul_615: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_614, -0.5);  mul_614 = None
    exp_8: "f32[8, 1536, 6, 6]" = torch.ops.aten.exp.default(mul_615);  mul_615 = None
    mul_616: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(exp_8, 0.3989422804014327);  exp_8 = None
    mul_617: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_100, mul_616);  add_100 = mul_616 = None
    add_141: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_613, mul_617);  mul_613 = mul_617 = None
    mul_618: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_611, add_141);  mul_611 = add_141 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_142: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(add_132, mul_618);  add_132 = mul_618 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_619: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(add_142, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_620: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_619, clone_9);  clone_9 = None
    mul_621: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_619, primals_154);  mul_619 = primals_154 = None
    sum_24: "f32[]" = torch.ops.aten.sum.default(mul_620);  mul_620 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_622: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_621, 2.0);  mul_621 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_623: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_622, convolution_65);  convolution_65 = None
    mul_624: "f32[8, 1536, 6, 6]" = torch.ops.aten.mul.Tensor(mul_622, sigmoid_9);  mul_622 = sigmoid_9 = None
    sum_25: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_623, [2, 3], True);  mul_623 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_32: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_19);  alias_19 = None
    sub_95: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_32)
    mul_625: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_32, sub_95);  alias_32 = sub_95 = None
    mul_626: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_25, mul_625);  sum_25 = mul_625 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_13 = torch.ops.aten.convolution_backward.default(mul_626, relu_9, primals_222, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_626 = primals_222 = None
    getitem_153: "f32[8, 768, 1, 1]" = convolution_backward_13[0]
    getitem_154: "f32[1536, 768, 1, 1]" = convolution_backward_13[1]
    getitem_155: "f32[1536]" = convolution_backward_13[2];  convolution_backward_13 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_34: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_9);  relu_9 = None
    alias_35: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_34);  alias_34 = None
    le_2: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_35, 0);  alias_35 = None
    ...
    where_2: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_2, scalar_tensor_2, getitem_153);  le_2 = scalar_tensor_2 = getitem_153 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_14 = torch.ops.aten.convolution_backward.default(where_2, mean_9, primals_220, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_2 = mean_9 = primals_220 = None
    getitem_156: "f32[8, 1536, 1, 1]" = convolution_backward_14[0]
    getitem_157: "f32[768, 1536, 1, 1]" = convolution_backward_14[1]
    getitem_158: "f32[768]" = convolution_backward_14[2];  convolution_backward_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_3: "f32[8, 1536, 6, 6]" = torch.ops.aten.expand.default(getitem_156, [8, 1536, 6, 6]);  getitem_156 = None
    div_3: "f32[8, 1536, 6, 6]" = torch.ops.aten.div.Scalar(expand_3, 36);  expand_3 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_143: "f32[8, 1536, 6, 6]" = torch.ops.aten.add.Tensor(mul_624, div_3);  mul_624 = div_3 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_15 = torch.ops.aten.convolution_backward.default(add_143, mul_358, view_143, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_143 = mul_358 = view_143 = None
    getitem_159: "f32[8, 768, 6, 6]" = convolution_backward_15[0]
    getitem_160: "f32[1536, 768, 1, 1]" = convolution_backward_15[1]
    getitem_161: "f32[1536]" = convolution_backward_15[2];  convolution_backward_15 = None
    ...
    sum_26: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_201, [0, 2])
    ...
    sum_27: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_627, [0, 2]);  mul_627 = None
    mul_628: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_26, 0.0013020833333333333);  sum_26 = None
    ...
    mul_629: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_27, 0.0013020833333333333)
    ...
    mul_635: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_27, squeeze_95);  sum_27 = squeeze_95 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_637: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_159, 1.7015043497085571);  getitem_159 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_638: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_64, 0.7071067811865476)
    erf_61: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_638);  mul_638 = None
    add_144: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_61, 1);  erf_61 = None
    mul_639: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_144, 0.5);  add_144 = None
    mul_640: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_64, convolution_64)
    mul_641: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_640, -0.5);  mul_640 = None
    exp_9: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_641);  mul_641 = None
    mul_642: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_9, 0.3989422804014327);  exp_9 = None
    mul_643: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_64, mul_642);  convolution_64 = mul_642 = None
    add_145: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_639, mul_643);  mul_639 = mul_643 = None
    mul_644: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_637, add_145);  mul_637 = add_145 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_16 = torch.ops.aten.convolution_backward.default(mul_644, mul_351, view_140, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_644 = mul_351 = view_140 = None
    getitem_162: "f32[8, 768, 6, 6]" = convolution_backward_16[0]
    getitem_163: "f32[768, 128, 3, 3]" = convolution_backward_16[1]
    getitem_164: "f32[768]" = convolution_backward_16[2];  convolution_backward_16 = None
    ...
    sum_28: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_204, [0, 2])
    ...
    sum_29: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_645, [0, 2]);  mul_645 = None
    mul_646: "f32[768]" = torch.ops.aten.mul.Tensor(sum_28, 0.0008680555555555555);  sum_28 = None
    ...
    mul_647: "f32[768]" = torch.ops.aten.mul.Tensor(sum_29, 0.0008680555555555555)
    ...
    mul_653: "f32[768]" = torch.ops.aten.mul.Tensor(sum_29, squeeze_93);  sum_29 = squeeze_93 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_655: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(getitem_162, 1.7015043497085571);  getitem_162 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_656: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_63, 0.7071067811865476)
    erf_62: "f32[8, 768, 6, 6]" = torch.ops.aten.erf.default(mul_656);  mul_656 = None
    add_146: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(erf_62, 1);  erf_62 = None
    mul_657: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(add_146, 0.5);  add_146 = None
    mul_658: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_63, convolution_63)
    mul_659: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_658, -0.5);  mul_658 = None
    exp_10: "f32[8, 768, 6, 6]" = torch.ops.aten.exp.default(mul_659);  mul_659 = None
    mul_660: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(exp_10, 0.3989422804014327);  exp_10 = None
    mul_661: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(convolution_63, mul_660);  convolution_63 = mul_660 = None
    add_147: "f32[8, 768, 6, 6]" = torch.ops.aten.add.Tensor(mul_657, mul_661);  mul_657 = mul_661 = None
    mul_662: "f32[8, 768, 6, 6]" = torch.ops.aten.mul.Tensor(mul_655, add_147);  mul_655 = add_147 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_17 = torch.ops.aten.convolution_backward.default(mul_662, constant_pad_nd_4, view_137, [768], [2, 2], [0, 0], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_662 = constant_pad_nd_4 = view_137 = None
    getitem_165: "f32[8, 768, 13, 13]" = convolution_backward_17[0]
    getitem_166: "f32[768, 128, 3, 3]" = convolution_backward_17[1]
    getitem_167: "f32[768]" = convolution_backward_17[2];  convolution_backward_17 = None
    ...
    sum_30: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_207, [0, 2])
    ...
    sum_31: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_663, [0, 2]);  mul_663 = None
    mul_664: "f32[768]" = torch.ops.aten.mul.Tensor(sum_30, 0.0008680555555555555);  sum_30 = None
    ...
    mul_665: "f32[768]" = torch.ops.aten.mul.Tensor(sum_31, 0.0008680555555555555)
    ...
    mul_671: "f32[768]" = torch.ops.aten.mul.Tensor(sum_31, squeeze_91);  sum_31 = squeeze_91 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_5: "f32[8, 768, 12, 12]" = torch.ops.aten.constant_pad_nd.default(getitem_165, [0, -1, 0, -1]);  getitem_165 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_673: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(constant_pad_nd_5, 1.7015043497085571);  constant_pad_nd_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_674: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_62, 0.7071067811865476)
    erf_63: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_674);  mul_674 = None
    add_148: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_63, 1);  erf_63 = None
    mul_675: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_148, 0.5);  add_148 = None
    mul_676: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_62, convolution_62)
    mul_677: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_676, -0.5);  mul_676 = None
    exp_11: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_677);  mul_677 = None
    mul_678: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_11, 0.3989422804014327);  exp_11 = None
    mul_679: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_62, mul_678);  convolution_62 = mul_678 = None
    add_149: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_675, mul_679);  mul_675 = mul_679 = None
    mul_680: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_673, add_149);  mul_673 = add_149 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_18 = torch.ops.aten.convolution_backward.default(mul_680, mul_334, view_134, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_680 = view_134 = None
    getitem_168: "f32[8, 1536, 12, 12]" = convolution_backward_18[0]
    getitem_169: "f32[768, 1536, 1, 1]" = convolution_backward_18[1]
    getitem_170: "f32[768]" = convolution_backward_18[2];  convolution_backward_18 = None
    ...
    sum_32: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_210, [0, 2])
    ...
    sum_33: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_681, [0, 2]);  mul_681 = None
    mul_682: "f32[768]" = torch.ops.aten.mul.Tensor(sum_32, 0.0006510416666666666);  sum_32 = None
    ...
    mul_683: "f32[768]" = torch.ops.aten.mul.Tensor(sum_33, 0.0006510416666666666)
    ...
    mul_689: "f32[768]" = torch.ops.aten.mul.Tensor(sum_33, squeeze_89);  sum_33 = squeeze_89 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_19 = torch.ops.aten.convolution_backward.default(add_142, avg_pool2d_2, view_131, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_142 = avg_pool2d_2 = view_131 = None
    getitem_171: "f32[8, 1536, 6, 6]" = convolution_backward_19[0]
    getitem_172: "f32[1536, 1536, 1, 1]" = convolution_backward_19[1]
    getitem_173: "f32[1536]" = convolution_backward_19[2];  convolution_backward_19 = None
    ...
    sum_34: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_213, [0, 2])
    ...
    sum_35: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_691, [0, 2]);  mul_691 = None
    mul_692: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_34, 0.0006510416666666666);  sum_34 = None
    ...
    mul_693: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_35, 0.0006510416666666666)
    ...
    mul_699: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_35, squeeze_87);  sum_35 = squeeze_87 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    avg_pool2d_backward: "f32[8, 1536, 12, 12]" = torch.ops.aten.avg_pool2d_backward.default(getitem_171, mul_334, [2, 2], [2, 2], [0, 0], True, False, None);  getitem_171 = mul_334 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    add_150: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(getitem_168, avg_pool2d_backward);  getitem_168 = avg_pool2d_backward = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_701: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_150, 0.8980265101338745);  add_150 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_702: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_701, 1.7015043497085571);  mul_701 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_703: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_90, 0.7071067811865476)
    erf_64: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_703);  mul_703 = None
    add_151: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_64, 1);  erf_64 = None
    mul_704: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_151, 0.5);  add_151 = None
    mul_705: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_90, add_90)
    mul_706: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_705, -0.5);  mul_705 = None
    exp_12: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_706);  mul_706 = None
    mul_707: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_12, 0.3989422804014327);  exp_12 = None
    mul_708: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_90, mul_707);  add_90 = mul_707 = None
    add_152: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_704, mul_708);  mul_704 = mul_708 = None
    mul_709: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_702, add_152);  mul_702 = add_152 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_710: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_709, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_711: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_710, clone_8);  clone_8 = None
    mul_712: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_710, primals_138);  mul_710 = primals_138 = None
    sum_36: "f32[]" = torch.ops.aten.sum.default(mul_711);  mul_711 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_713: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_712, 2.0);  mul_712 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_714: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_713, convolution_58);  convolution_58 = None
    mul_715: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_713, sigmoid_8);  mul_713 = sigmoid_8 = None
    sum_37: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_714, [2, 3], True);  mul_714 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_36: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_17);  alias_17 = None
    sub_116: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_36)
    mul_716: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_36, sub_116);  alias_36 = sub_116 = None
    mul_717: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_37, mul_716);  sum_37 = mul_716 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_20 = torch.ops.aten.convolution_backward.default(mul_717, relu_8, primals_218, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_717 = primals_218 = None
    getitem_174: "f32[8, 768, 1, 1]" = convolution_backward_20[0]
    getitem_175: "f32[1536, 768, 1, 1]" = convolution_backward_20[1]
    getitem_176: "f32[1536]" = convolution_backward_20[2];  convolution_backward_20 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_38: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_8);  relu_8 = None
    alias_39: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_38);  alias_38 = None
    le_3: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_39, 0);  alias_39 = None
    ...
    where_3: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_3, scalar_tensor_3, getitem_174);  le_3 = scalar_tensor_3 = getitem_174 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_21 = torch.ops.aten.convolution_backward.default(where_3, mean_8, primals_216, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_3 = mean_8 = primals_216 = None
    getitem_177: "f32[8, 1536, 1, 1]" = convolution_backward_21[0]
    getitem_178: "f32[768, 1536, 1, 1]" = convolution_backward_21[1]
    getitem_179: "f32[768]" = convolution_backward_21[2];  convolution_backward_21 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_4: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_177, [8, 1536, 12, 12]);  getitem_177 = None
    div_4: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_4, 144);  expand_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_153: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_715, div_4);  mul_715 = div_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_22 = torch.ops.aten.convolution_backward.default(add_153, mul_322, view_128, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_153 = mul_322 = view_128 = None
    getitem_180: "f32[8, 768, 12, 12]" = convolution_backward_22[0]
    getitem_181: "f32[1536, 768, 1, 1]" = convolution_backward_22[1]
    getitem_182: "f32[1536]" = convolution_backward_22[2];  convolution_backward_22 = None
    ...
    sum_38: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_216, [0, 2])
    ...
    sum_39: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_718, [0, 2]);  mul_718 = None
    mul_719: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_38, 0.0013020833333333333);  sum_38 = None
    ...
    mul_720: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_39, 0.0013020833333333333)
    ...
    mul_726: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_39, squeeze_85);  sum_39 = squeeze_85 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_728: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_180, 1.7015043497085571);  getitem_180 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_729: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_57, 0.7071067811865476)
    erf_65: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_729);  mul_729 = None
    add_154: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_65, 1);  erf_65 = None
    mul_730: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_154, 0.5);  add_154 = None
    mul_731: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_57, convolution_57)
    mul_732: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_731, -0.5);  mul_731 = None
    exp_13: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_732);  mul_732 = None
    mul_733: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_13, 0.3989422804014327);  exp_13 = None
    mul_734: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_57, mul_733);  convolution_57 = mul_733 = None
    add_155: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_730, mul_734);  mul_730 = mul_734 = None
    mul_735: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_728, add_155);  mul_728 = add_155 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_23 = torch.ops.aten.convolution_backward.default(mul_735, mul_315, view_125, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_735 = mul_315 = view_125 = None
    getitem_183: "f32[8, 768, 12, 12]" = convolution_backward_23[0]
    getitem_184: "f32[768, 128, 3, 3]" = convolution_backward_23[1]
    getitem_185: "f32[768]" = convolution_backward_23[2];  convolution_backward_23 = None
    ...
    sum_40: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_219, [0, 2])
    ...
    sum_41: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_736, [0, 2]);  mul_736 = None
    mul_737: "f32[768]" = torch.ops.aten.mul.Tensor(sum_40, 0.0008680555555555555);  sum_40 = None
    ...
    mul_738: "f32[768]" = torch.ops.aten.mul.Tensor(sum_41, 0.0008680555555555555)
    ...
    mul_744: "f32[768]" = torch.ops.aten.mul.Tensor(sum_41, squeeze_83);  sum_41 = squeeze_83 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_746: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_183, 1.7015043497085571);  getitem_183 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_747: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_56, 0.7071067811865476)
    erf_66: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_747);  mul_747 = None
    add_156: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_66, 1);  erf_66 = None
    mul_748: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_156, 0.5);  add_156 = None
    mul_749: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_56, convolution_56)
    mul_750: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_749, -0.5);  mul_749 = None
    exp_14: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_750);  mul_750 = None
    mul_751: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_14, 0.3989422804014327);  exp_14 = None
    mul_752: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_56, mul_751);  convolution_56 = mul_751 = None
    add_157: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_748, mul_752);  mul_748 = mul_752 = None
    mul_753: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_746, add_157);  mul_746 = add_157 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_24 = torch.ops.aten.convolution_backward.default(mul_753, mul_308, view_122, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_753 = mul_308 = view_122 = None
    getitem_186: "f32[8, 768, 12, 12]" = convolution_backward_24[0]
    getitem_187: "f32[768, 128, 3, 3]" = convolution_backward_24[1]
    getitem_188: "f32[768]" = convolution_backward_24[2];  convolution_backward_24 = None
    ...
    sum_42: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_222, [0, 2])
    ...
    sum_43: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_754, [0, 2]);  mul_754 = None
    mul_755: "f32[768]" = torch.ops.aten.mul.Tensor(sum_42, 0.0008680555555555555);  sum_42 = None
    ...
    mul_756: "f32[768]" = torch.ops.aten.mul.Tensor(sum_43, 0.0008680555555555555)
    ...
    mul_762: "f32[768]" = torch.ops.aten.mul.Tensor(sum_43, squeeze_81);  sum_43 = squeeze_81 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_764: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_186, 1.7015043497085571);  getitem_186 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_765: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_55, 0.7071067811865476)
    erf_67: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_765);  mul_765 = None
    add_158: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_67, 1);  erf_67 = None
    mul_766: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_158, 0.5);  add_158 = None
    mul_767: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_55, convolution_55)
    mul_768: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_767, -0.5);  mul_767 = None
    exp_15: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_768);  mul_768 = None
    mul_769: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_15, 0.3989422804014327);  exp_15 = None
    mul_770: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_55, mul_769);  convolution_55 = mul_769 = None
    add_159: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_766, mul_770);  mul_766 = mul_770 = None
    mul_771: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_764, add_159);  mul_764 = add_159 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_25 = torch.ops.aten.convolution_backward.default(mul_771, mul_301, view_119, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_771 = mul_301 = view_119 = None
    getitem_189: "f32[8, 1536, 12, 12]" = convolution_backward_25[0]
    getitem_190: "f32[768, 1536, 1, 1]" = convolution_backward_25[1]
    getitem_191: "f32[768]" = convolution_backward_25[2];  convolution_backward_25 = None
    ...
    sum_44: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_225, [0, 2])
    ...
    sum_45: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_772, [0, 2]);  mul_772 = None
    mul_773: "f32[768]" = torch.ops.aten.mul.Tensor(sum_44, 0.0006510416666666666);  sum_44 = None
    ...
    mul_774: "f32[768]" = torch.ops.aten.mul.Tensor(sum_45, 0.0006510416666666666)
    ...
    mul_780: "f32[768]" = torch.ops.aten.mul.Tensor(sum_45, squeeze_79);  sum_45 = squeeze_79 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_782: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_189, 0.9128709291752768);  getitem_189 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_783: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_782, 1.7015043497085571);  mul_782 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_784: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_81, 0.7071067811865476)
    erf_68: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_784);  mul_784 = None
    add_160: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_68, 1);  erf_68 = None
    mul_785: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_160, 0.5);  add_160 = None
    mul_786: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_81, add_81)
    mul_787: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_786, -0.5);  mul_786 = None
    exp_16: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_787);  mul_787 = None
    mul_788: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_16, 0.3989422804014327);  exp_16 = None
    mul_789: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_81, mul_788);  add_81 = mul_788 = None
    add_161: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_785, mul_789);  mul_785 = mul_789 = None
    mul_790: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_783, add_161);  mul_783 = add_161 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_162: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_709, mul_790);  mul_709 = mul_790 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_791: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_162, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_792: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_791, clone_7);  clone_7 = None
    mul_793: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_791, primals_125);  mul_791 = primals_125 = None
    sum_46: "f32[]" = torch.ops.aten.sum.default(mul_792);  mul_792 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_794: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_793, 2.0);  mul_793 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_795: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_794, convolution_52);  convolution_52 = None
    mul_796: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_794, sigmoid_7);  mul_794 = sigmoid_7 = None
    sum_47: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_795, [2, 3], True);  mul_795 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_40: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_15);  alias_15 = None
    sub_133: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_40)
    mul_797: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_40, sub_133);  alias_40 = sub_133 = None
    mul_798: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_47, mul_797);  sum_47 = mul_797 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_26 = torch.ops.aten.convolution_backward.default(mul_798, relu_7, primals_214, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_798 = primals_214 = None
    getitem_192: "f32[8, 768, 1, 1]" = convolution_backward_26[0]
    getitem_193: "f32[1536, 768, 1, 1]" = convolution_backward_26[1]
    getitem_194: "f32[1536]" = convolution_backward_26[2];  convolution_backward_26 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_42: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_7);  relu_7 = None
    alias_43: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_42);  alias_42 = None
    le_4: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_43, 0);  alias_43 = None
    ...
    where_4: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_4, scalar_tensor_4, getitem_192);  le_4 = scalar_tensor_4 = getitem_192 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_27 = torch.ops.aten.convolution_backward.default(where_4, mean_7, primals_212, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_4 = mean_7 = primals_212 = None
    getitem_195: "f32[8, 1536, 1, 1]" = convolution_backward_27[0]
    getitem_196: "f32[768, 1536, 1, 1]" = convolution_backward_27[1]
    getitem_197: "f32[768]" = convolution_backward_27[2];  convolution_backward_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_5: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_195, [8, 1536, 12, 12]);  getitem_195 = None
    div_5: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_5, 144);  expand_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_163: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_796, div_5);  mul_796 = div_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_28 = torch.ops.aten.convolution_backward.default(add_163, mul_289, view_116, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_163 = mul_289 = view_116 = None
    getitem_198: "f32[8, 768, 12, 12]" = convolution_backward_28[0]
    getitem_199: "f32[1536, 768, 1, 1]" = convolution_backward_28[1]
    getitem_200: "f32[1536]" = convolution_backward_28[2];  convolution_backward_28 = None
    ...
    sum_48: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_228, [0, 2])
    ...
    sum_49: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_799, [0, 2]);  mul_799 = None
    mul_800: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_48, 0.0013020833333333333);  sum_48 = None
    ...
    mul_801: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_49, 0.0013020833333333333)
    ...
    mul_807: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_49, squeeze_77);  sum_49 = squeeze_77 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_809: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_198, 1.7015043497085571);  getitem_198 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_810: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_51, 0.7071067811865476)
    erf_69: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_810);  mul_810 = None
    add_164: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_69, 1);  erf_69 = None
    mul_811: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_164, 0.5);  add_164 = None
    mul_812: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_51, convolution_51)
    mul_813: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_812, -0.5);  mul_812 = None
    exp_17: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_813);  mul_813 = None
    mul_814: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_17, 0.3989422804014327);  exp_17 = None
    mul_815: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_51, mul_814);  convolution_51 = mul_814 = None
    add_165: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_811, mul_815);  mul_811 = mul_815 = None
    mul_816: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_809, add_165);  mul_809 = add_165 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_29 = torch.ops.aten.convolution_backward.default(mul_816, mul_282, view_113, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_816 = mul_282 = view_113 = None
    getitem_201: "f32[8, 768, 12, 12]" = convolution_backward_29[0]
    getitem_202: "f32[768, 128, 3, 3]" = convolution_backward_29[1]
    getitem_203: "f32[768]" = convolution_backward_29[2];  convolution_backward_29 = None
    ...
    sum_50: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_231, [0, 2])
    ...
    sum_51: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_817, [0, 2]);  mul_817 = None
    mul_818: "f32[768]" = torch.ops.aten.mul.Tensor(sum_50, 0.0008680555555555555);  sum_50 = None
    ...
    mul_819: "f32[768]" = torch.ops.aten.mul.Tensor(sum_51, 0.0008680555555555555)
    ...
    mul_825: "f32[768]" = torch.ops.aten.mul.Tensor(sum_51, squeeze_75);  sum_51 = squeeze_75 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_827: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_201, 1.7015043497085571);  getitem_201 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_828: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_50, 0.7071067811865476)
    erf_70: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_828);  mul_828 = None
    add_166: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_70, 1);  erf_70 = None
    mul_829: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_166, 0.5);  add_166 = None
    mul_830: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_50, convolution_50)
    mul_831: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_830, -0.5);  mul_830 = None
    exp_18: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_831);  mul_831 = None
    mul_832: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_18, 0.3989422804014327);  exp_18 = None
    mul_833: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_50, mul_832);  convolution_50 = mul_832 = None
    add_167: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_829, mul_833);  mul_829 = mul_833 = None
    mul_834: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_827, add_167);  mul_827 = add_167 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_30 = torch.ops.aten.convolution_backward.default(mul_834, mul_275, view_110, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_834 = mul_275 = view_110 = None
    getitem_204: "f32[8, 768, 12, 12]" = convolution_backward_30[0]
    getitem_205: "f32[768, 128, 3, 3]" = convolution_backward_30[1]
    getitem_206: "f32[768]" = convolution_backward_30[2];  convolution_backward_30 = None
    ...
    sum_52: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_234, [0, 2])
    ...
    sum_53: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_835, [0, 2]);  mul_835 = None
    mul_836: "f32[768]" = torch.ops.aten.mul.Tensor(sum_52, 0.0008680555555555555);  sum_52 = None
    ...
    mul_837: "f32[768]" = torch.ops.aten.mul.Tensor(sum_53, 0.0008680555555555555)
    ...
    mul_843: "f32[768]" = torch.ops.aten.mul.Tensor(sum_53, squeeze_73);  sum_53 = squeeze_73 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_845: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_204, 1.7015043497085571);  getitem_204 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_846: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_49, 0.7071067811865476)
    erf_71: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_846);  mul_846 = None
    add_168: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_71, 1);  erf_71 = None
    mul_847: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_168, 0.5);  add_168 = None
    mul_848: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_49, convolution_49)
    mul_849: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_848, -0.5);  mul_848 = None
    exp_19: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_849);  mul_849 = None
    mul_850: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_19, 0.3989422804014327);  exp_19 = None
    mul_851: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_49, mul_850);  convolution_49 = mul_850 = None
    add_169: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_847, mul_851);  mul_847 = mul_851 = None
    mul_852: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_845, add_169);  mul_845 = add_169 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_31 = torch.ops.aten.convolution_backward.default(mul_852, mul_268, view_107, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_852 = mul_268 = view_107 = None
    getitem_207: "f32[8, 1536, 12, 12]" = convolution_backward_31[0]
    getitem_208: "f32[768, 1536, 1, 1]" = convolution_backward_31[1]
    getitem_209: "f32[768]" = convolution_backward_31[2];  convolution_backward_31 = None
    ...
    sum_54: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_237, [0, 2])
    ...
    sum_55: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_853, [0, 2]);  mul_853 = None
    mul_854: "f32[768]" = torch.ops.aten.mul.Tensor(sum_54, 0.0006510416666666666);  sum_54 = None
    ...
    mul_855: "f32[768]" = torch.ops.aten.mul.Tensor(sum_55, 0.0006510416666666666)
    ...
    mul_861: "f32[768]" = torch.ops.aten.mul.Tensor(sum_55, squeeze_71);  sum_55 = squeeze_71 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_863: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_207, 0.9284766908852592);  getitem_207 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_864: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_863, 1.7015043497085571);  mul_863 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_865: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_72, 0.7071067811865476)
    erf_72: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_865);  mul_865 = None
    add_170: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_72, 1);  erf_72 = None
    mul_866: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_170, 0.5);  add_170 = None
    mul_867: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_72, add_72)
    mul_868: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_867, -0.5);  mul_867 = None
    exp_20: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_868);  mul_868 = None
    mul_869: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_20, 0.3989422804014327);  exp_20 = None
    mul_870: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_72, mul_869);  add_72 = mul_869 = None
    add_171: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_866, mul_870);  mul_866 = mul_870 = None
    mul_871: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_864, add_171);  mul_864 = add_171 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_172: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(add_162, mul_871);  add_162 = mul_871 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_872: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_172, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_873: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_872, clone_6);  clone_6 = None
    mul_874: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_872, primals_112);  mul_872 = primals_112 = None
    sum_56: "f32[]" = torch.ops.aten.sum.default(mul_873);  mul_873 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_875: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_874, 2.0);  mul_874 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_876: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_875, convolution_46);  convolution_46 = None
    mul_877: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_875, sigmoid_6);  mul_875 = sigmoid_6 = None
    sum_57: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_876, [2, 3], True);  mul_876 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_44: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_13);  alias_13 = None
    sub_150: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_44)
    mul_878: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_44, sub_150);  alias_44 = sub_150 = None
    mul_879: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_57, mul_878);  sum_57 = mul_878 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_32 = torch.ops.aten.convolution_backward.default(mul_879, relu_6, primals_210, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_879 = primals_210 = None
    getitem_210: "f32[8, 768, 1, 1]" = convolution_backward_32[0]
    getitem_211: "f32[1536, 768, 1, 1]" = convolution_backward_32[1]
    getitem_212: "f32[1536]" = convolution_backward_32[2];  convolution_backward_32 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_46: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_6);  relu_6 = None
    alias_47: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_46);  alias_46 = None
    le_5: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_47, 0);  alias_47 = None
    ...
    where_5: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_5, scalar_tensor_5, getitem_210);  le_5 = scalar_tensor_5 = getitem_210 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_33 = torch.ops.aten.convolution_backward.default(where_5, mean_6, primals_208, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_5 = mean_6 = primals_208 = None
    getitem_213: "f32[8, 1536, 1, 1]" = convolution_backward_33[0]
    getitem_214: "f32[768, 1536, 1, 1]" = convolution_backward_33[1]
    getitem_215: "f32[768]" = convolution_backward_33[2];  convolution_backward_33 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_6: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_213, [8, 1536, 12, 12]);  getitem_213 = None
    div_6: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_6, 144);  expand_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_173: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_877, div_6);  mul_877 = div_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_34 = torch.ops.aten.convolution_backward.default(add_173, mul_256, view_104, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_173 = mul_256 = view_104 = None
    getitem_216: "f32[8, 768, 12, 12]" = convolution_backward_34[0]
    getitem_217: "f32[1536, 768, 1, 1]" = convolution_backward_34[1]
    getitem_218: "f32[1536]" = convolution_backward_34[2];  convolution_backward_34 = None
    ...
    sum_58: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_240, [0, 2])
    ...
    sum_59: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_880, [0, 2]);  mul_880 = None
    mul_881: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_58, 0.0013020833333333333);  sum_58 = None
    ...
    mul_882: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_59, 0.0013020833333333333)
    ...
    mul_888: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_59, squeeze_69);  sum_59 = squeeze_69 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_890: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_216, 1.7015043497085571);  getitem_216 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_891: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_45, 0.7071067811865476)
    erf_73: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_891);  mul_891 = None
    add_174: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_73, 1);  erf_73 = None
    mul_892: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_174, 0.5);  add_174 = None
    mul_893: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_45, convolution_45)
    mul_894: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_893, -0.5);  mul_893 = None
    exp_21: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_894);  mul_894 = None
    mul_895: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_21, 0.3989422804014327);  exp_21 = None
    mul_896: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_45, mul_895);  convolution_45 = mul_895 = None
    add_175: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_892, mul_896);  mul_892 = mul_896 = None
    mul_897: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_890, add_175);  mul_890 = add_175 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_35 = torch.ops.aten.convolution_backward.default(mul_897, mul_249, view_101, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_897 = mul_249 = view_101 = None
    getitem_219: "f32[8, 768, 12, 12]" = convolution_backward_35[0]
    getitem_220: "f32[768, 128, 3, 3]" = convolution_backward_35[1]
    getitem_221: "f32[768]" = convolution_backward_35[2];  convolution_backward_35 = None
    ...
    sum_60: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_243, [0, 2])
    ...
    sum_61: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_898, [0, 2]);  mul_898 = None
    mul_899: "f32[768]" = torch.ops.aten.mul.Tensor(sum_60, 0.0008680555555555555);  sum_60 = None
    ...
    mul_900: "f32[768]" = torch.ops.aten.mul.Tensor(sum_61, 0.0008680555555555555)
    ...
    mul_906: "f32[768]" = torch.ops.aten.mul.Tensor(sum_61, squeeze_67);  sum_61 = squeeze_67 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_908: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_219, 1.7015043497085571);  getitem_219 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_909: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_44, 0.7071067811865476)
    erf_74: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_909);  mul_909 = None
    add_176: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_74, 1);  erf_74 = None
    mul_910: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_176, 0.5);  add_176 = None
    mul_911: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_44, convolution_44)
    mul_912: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_911, -0.5);  mul_911 = None
    exp_22: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_912);  mul_912 = None
    mul_913: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_22, 0.3989422804014327);  exp_22 = None
    mul_914: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_44, mul_913);  convolution_44 = mul_913 = None
    add_177: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_910, mul_914);  mul_910 = mul_914 = None
    mul_915: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_908, add_177);  mul_908 = add_177 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_36 = torch.ops.aten.convolution_backward.default(mul_915, mul_242, view_98, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_915 = mul_242 = view_98 = None
    getitem_222: "f32[8, 768, 12, 12]" = convolution_backward_36[0]
    getitem_223: "f32[768, 128, 3, 3]" = convolution_backward_36[1]
    getitem_224: "f32[768]" = convolution_backward_36[2];  convolution_backward_36 = None
    ...
    sum_62: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_246, [0, 2])
    ...
    sum_63: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_916, [0, 2]);  mul_916 = None
    mul_917: "f32[768]" = torch.ops.aten.mul.Tensor(sum_62, 0.0008680555555555555);  sum_62 = None
    ...
    mul_918: "f32[768]" = torch.ops.aten.mul.Tensor(sum_63, 0.0008680555555555555)
    ...
    mul_924: "f32[768]" = torch.ops.aten.mul.Tensor(sum_63, squeeze_65);  sum_63 = squeeze_65 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_926: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_222, 1.7015043497085571);  getitem_222 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_927: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_43, 0.7071067811865476)
    erf_75: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_927);  mul_927 = None
    add_178: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_75, 1);  erf_75 = None
    mul_928: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_178, 0.5);  add_178 = None
    mul_929: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_43, convolution_43)
    mul_930: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_929, -0.5);  mul_929 = None
    exp_23: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_930);  mul_930 = None
    mul_931: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_23, 0.3989422804014327);  exp_23 = None
    mul_932: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_43, mul_931);  convolution_43 = mul_931 = None
    add_179: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_928, mul_932);  mul_928 = mul_932 = None
    mul_933: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_926, add_179);  mul_926 = add_179 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_37 = torch.ops.aten.convolution_backward.default(mul_933, mul_235, view_95, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_933 = mul_235 = view_95 = None
    getitem_225: "f32[8, 1536, 12, 12]" = convolution_backward_37[0]
    getitem_226: "f32[768, 1536, 1, 1]" = convolution_backward_37[1]
    getitem_227: "f32[768]" = convolution_backward_37[2];  convolution_backward_37 = None
    ...
    sum_64: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_249, [0, 2])
    ...
    sum_65: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_934, [0, 2]);  mul_934 = None
    mul_935: "f32[768]" = torch.ops.aten.mul.Tensor(sum_64, 0.0006510416666666666);  sum_64 = None
    ...
    mul_936: "f32[768]" = torch.ops.aten.mul.Tensor(sum_65, 0.0006510416666666666)
    ...
    mul_942: "f32[768]" = torch.ops.aten.mul.Tensor(sum_65, squeeze_63);  sum_65 = squeeze_63 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_944: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_225, 0.9449111825230679);  getitem_225 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_945: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_944, 1.7015043497085571);  mul_944 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_946: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_63, 0.7071067811865476)
    erf_76: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_946);  mul_946 = None
    add_180: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_76, 1);  erf_76 = None
    mul_947: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_180, 0.5);  add_180 = None
    mul_948: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_63, add_63)
    mul_949: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_948, -0.5);  mul_948 = None
    exp_24: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_949);  mul_949 = None
    mul_950: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_24, 0.3989422804014327);  exp_24 = None
    mul_951: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_63, mul_950);  add_63 = mul_950 = None
    add_181: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_947, mul_951);  mul_947 = mul_951 = None
    mul_952: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_945, add_181);  mul_945 = add_181 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_182: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(add_172, mul_952);  add_172 = mul_952 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_953: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_182, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_954: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_953, clone_5);  clone_5 = None
    mul_955: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_953, primals_99);  mul_953 = primals_99 = None
    sum_66: "f32[]" = torch.ops.aten.sum.default(mul_954);  mul_954 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_956: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_955, 2.0);  mul_955 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_957: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_956, convolution_40);  convolution_40 = None
    mul_958: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_956, sigmoid_5);  mul_956 = sigmoid_5 = None
    sum_67: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_957, [2, 3], True);  mul_957 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_48: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_11);  alias_11 = None
    sub_167: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_48)
    mul_959: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_48, sub_167);  alias_48 = sub_167 = None
    mul_960: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_67, mul_959);  sum_67 = mul_959 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_38 = torch.ops.aten.convolution_backward.default(mul_960, relu_5, primals_206, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_960 = primals_206 = None
    getitem_228: "f32[8, 768, 1, 1]" = convolution_backward_38[0]
    getitem_229: "f32[1536, 768, 1, 1]" = convolution_backward_38[1]
    getitem_230: "f32[1536]" = convolution_backward_38[2];  convolution_backward_38 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_50: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_5);  relu_5 = None
    alias_51: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_50);  alias_50 = None
    le_6: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_51, 0);  alias_51 = None
    ...
    where_6: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_6, scalar_tensor_6, getitem_228);  le_6 = scalar_tensor_6 = getitem_228 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_39 = torch.ops.aten.convolution_backward.default(where_6, mean_5, primals_204, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_6 = mean_5 = primals_204 = None
    getitem_231: "f32[8, 1536, 1, 1]" = convolution_backward_39[0]
    getitem_232: "f32[768, 1536, 1, 1]" = convolution_backward_39[1]
    getitem_233: "f32[768]" = convolution_backward_39[2];  convolution_backward_39 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_7: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_231, [8, 1536, 12, 12]);  getitem_231 = None
    div_7: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_7, 144);  expand_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_183: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_958, div_7);  mul_958 = div_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_40 = torch.ops.aten.convolution_backward.default(add_183, mul_223, view_92, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_183 = mul_223 = view_92 = None
    getitem_234: "f32[8, 768, 12, 12]" = convolution_backward_40[0]
    getitem_235: "f32[1536, 768, 1, 1]" = convolution_backward_40[1]
    getitem_236: "f32[1536]" = convolution_backward_40[2];  convolution_backward_40 = None
    ...
    sum_68: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_252, [0, 2])
    ...
    sum_69: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_961, [0, 2]);  mul_961 = None
    mul_962: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_68, 0.0013020833333333333);  sum_68 = None
    ...
    mul_963: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_69, 0.0013020833333333333)
    ...
    mul_969: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_69, squeeze_61);  sum_69 = squeeze_61 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_971: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_234, 1.7015043497085571);  getitem_234 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_972: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_39, 0.7071067811865476)
    erf_77: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_972);  mul_972 = None
    add_184: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_77, 1);  erf_77 = None
    mul_973: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_184, 0.5);  add_184 = None
    mul_974: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_39, convolution_39)
    mul_975: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_974, -0.5);  mul_974 = None
    exp_25: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_975);  mul_975 = None
    mul_976: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_25, 0.3989422804014327);  exp_25 = None
    mul_977: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_39, mul_976);  convolution_39 = mul_976 = None
    add_185: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_973, mul_977);  mul_973 = mul_977 = None
    mul_978: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_971, add_185);  mul_971 = add_185 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_41 = torch.ops.aten.convolution_backward.default(mul_978, mul_216, view_89, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_978 = mul_216 = view_89 = None
    getitem_237: "f32[8, 768, 12, 12]" = convolution_backward_41[0]
    getitem_238: "f32[768, 128, 3, 3]" = convolution_backward_41[1]
    getitem_239: "f32[768]" = convolution_backward_41[2];  convolution_backward_41 = None
    ...
    sum_70: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_255, [0, 2])
    ...
    sum_71: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_979, [0, 2]);  mul_979 = None
    mul_980: "f32[768]" = torch.ops.aten.mul.Tensor(sum_70, 0.0008680555555555555);  sum_70 = None
    ...
    mul_981: "f32[768]" = torch.ops.aten.mul.Tensor(sum_71, 0.0008680555555555555)
    ...
    mul_987: "f32[768]" = torch.ops.aten.mul.Tensor(sum_71, squeeze_59);  sum_71 = squeeze_59 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_989: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_237, 1.7015043497085571);  getitem_237 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_990: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_38, 0.7071067811865476)
    erf_78: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_990);  mul_990 = None
    add_186: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_78, 1);  erf_78 = None
    mul_991: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_186, 0.5);  add_186 = None
    mul_992: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_38, convolution_38)
    mul_993: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_992, -0.5);  mul_992 = None
    exp_26: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_993);  mul_993 = None
    mul_994: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_26, 0.3989422804014327);  exp_26 = None
    mul_995: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_38, mul_994);  convolution_38 = mul_994 = None
    add_187: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_991, mul_995);  mul_991 = mul_995 = None
    mul_996: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_989, add_187);  mul_989 = add_187 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_42 = torch.ops.aten.convolution_backward.default(mul_996, mul_209, view_86, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_996 = mul_209 = view_86 = None
    getitem_240: "f32[8, 768, 12, 12]" = convolution_backward_42[0]
    getitem_241: "f32[768, 128, 3, 3]" = convolution_backward_42[1]
    getitem_242: "f32[768]" = convolution_backward_42[2];  convolution_backward_42 = None
    ...
    sum_72: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_258, [0, 2])
    ...
    sum_73: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_997, [0, 2]);  mul_997 = None
    mul_998: "f32[768]" = torch.ops.aten.mul.Tensor(sum_72, 0.0008680555555555555);  sum_72 = None
    ...
    mul_999: "f32[768]" = torch.ops.aten.mul.Tensor(sum_73, 0.0008680555555555555)
    ...
    mul_1005: "f32[768]" = torch.ops.aten.mul.Tensor(sum_73, squeeze_57);  sum_73 = squeeze_57 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1007: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_240, 1.7015043497085571);  getitem_240 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1008: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_37, 0.7071067811865476)
    erf_79: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1008);  mul_1008 = None
    add_188: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_79, 1);  erf_79 = None
    mul_1009: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_188, 0.5);  add_188 = None
    mul_1010: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_37, convolution_37)
    mul_1011: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1010, -0.5);  mul_1010 = None
    exp_27: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1011);  mul_1011 = None
    mul_1012: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_27, 0.3989422804014327);  exp_27 = None
    mul_1013: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_37, mul_1012);  convolution_37 = mul_1012 = None
    add_189: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1009, mul_1013);  mul_1009 = mul_1013 = None
    mul_1014: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1007, add_189);  mul_1007 = add_189 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_43 = torch.ops.aten.convolution_backward.default(mul_1014, mul_202, view_83, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1014 = mul_202 = view_83 = None
    getitem_243: "f32[8, 1536, 12, 12]" = convolution_backward_43[0]
    getitem_244: "f32[768, 1536, 1, 1]" = convolution_backward_43[1]
    getitem_245: "f32[768]" = convolution_backward_43[2];  convolution_backward_43 = None
    ...
    sum_74: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_261, [0, 2])
    ...
    sum_75: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1015, [0, 2]);  mul_1015 = None
    mul_1016: "f32[768]" = torch.ops.aten.mul.Tensor(sum_74, 0.0006510416666666666);  sum_74 = None
    ...
    mul_1017: "f32[768]" = torch.ops.aten.mul.Tensor(sum_75, 0.0006510416666666666)
    ...
    mul_1023: "f32[768]" = torch.ops.aten.mul.Tensor(sum_75, squeeze_55);  sum_75 = squeeze_55 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1025: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_243, 0.9622504486493761);  getitem_243 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1026: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1025, 1.7015043497085571);  mul_1025 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1027: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_54, 0.7071067811865476)
    erf_80: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_1027);  mul_1027 = None
    add_190: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_80, 1);  erf_80 = None
    mul_1028: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_190, 0.5);  add_190 = None
    mul_1029: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_54, add_54)
    mul_1030: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1029, -0.5);  mul_1029 = None
    exp_28: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_1030);  mul_1030 = None
    mul_1031: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_28, 0.3989422804014327);  exp_28 = None
    mul_1032: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_54, mul_1031);  add_54 = mul_1031 = None
    add_191: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_1028, mul_1032);  mul_1028 = mul_1032 = None
    mul_1033: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1026, add_191);  mul_1026 = add_191 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_192: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(add_182, mul_1033);  add_182 = mul_1033 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_1034: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_192, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_1035: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1034, clone_4);  clone_4 = None
    mul_1036: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1034, primals_86);  mul_1034 = primals_86 = None
    sum_76: "f32[]" = torch.ops.aten.sum.default(mul_1035);  mul_1035 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_1037: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1036, 2.0);  mul_1036 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_1038: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1037, convolution_34);  convolution_34 = None
    mul_1039: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1037, sigmoid_4);  mul_1037 = sigmoid_4 = None
    sum_77: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1038, [2, 3], True);  mul_1038 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_52: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_9);  alias_9 = None
    sub_184: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_52)
    mul_1040: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_52, sub_184);  alias_52 = sub_184 = None
    mul_1041: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_77, mul_1040);  sum_77 = mul_1040 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_44 = torch.ops.aten.convolution_backward.default(mul_1041, relu_4, primals_202, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1041 = primals_202 = None
    getitem_246: "f32[8, 768, 1, 1]" = convolution_backward_44[0]
    getitem_247: "f32[1536, 768, 1, 1]" = convolution_backward_44[1]
    getitem_248: "f32[1536]" = convolution_backward_44[2];  convolution_backward_44 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_54: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_4);  relu_4 = None
    alias_55: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_54);  alias_54 = None
    le_7: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_55, 0);  alias_55 = None
    ...
    where_7: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_7, scalar_tensor_7, getitem_246);  le_7 = scalar_tensor_7 = getitem_246 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_45 = torch.ops.aten.convolution_backward.default(where_7, mean_4, primals_200, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_7 = mean_4 = primals_200 = None
    getitem_249: "f32[8, 1536, 1, 1]" = convolution_backward_45[0]
    getitem_250: "f32[768, 1536, 1, 1]" = convolution_backward_45[1]
    getitem_251: "f32[768]" = convolution_backward_45[2];  convolution_backward_45 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_8: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_249, [8, 1536, 12, 12]);  getitem_249 = None
    div_8: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_8, 144);  expand_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_193: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_1039, div_8);  mul_1039 = div_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_46 = torch.ops.aten.convolution_backward.default(add_193, mul_190, view_80, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_193 = mul_190 = view_80 = None
    getitem_252: "f32[8, 768, 12, 12]" = convolution_backward_46[0]
    getitem_253: "f32[1536, 768, 1, 1]" = convolution_backward_46[1]
    getitem_254: "f32[1536]" = convolution_backward_46[2];  convolution_backward_46 = None
    ...
    sum_78: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_264, [0, 2])
    ...
    sum_79: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_1042, [0, 2]);  mul_1042 = None
    mul_1043: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_78, 0.0013020833333333333);  sum_78 = None
    ...
    mul_1044: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_79, 0.0013020833333333333)
    ...
    mul_1050: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_79, squeeze_53);  sum_79 = squeeze_53 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1052: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_252, 1.7015043497085571);  getitem_252 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1053: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_33, 0.7071067811865476)
    erf_81: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1053);  mul_1053 = None
    add_194: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_81, 1);  erf_81 = None
    mul_1054: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_194, 0.5);  add_194 = None
    mul_1055: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_33, convolution_33)
    mul_1056: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1055, -0.5);  mul_1055 = None
    exp_29: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1056);  mul_1056 = None
    mul_1057: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_29, 0.3989422804014327);  exp_29 = None
    mul_1058: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_33, mul_1057);  convolution_33 = mul_1057 = None
    add_195: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1054, mul_1058);  mul_1054 = mul_1058 = None
    mul_1059: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1052, add_195);  mul_1052 = add_195 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_47 = torch.ops.aten.convolution_backward.default(mul_1059, mul_183, view_77, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_1059 = mul_183 = view_77 = None
    getitem_255: "f32[8, 768, 12, 12]" = convolution_backward_47[0]
    getitem_256: "f32[768, 128, 3, 3]" = convolution_backward_47[1]
    getitem_257: "f32[768]" = convolution_backward_47[2];  convolution_backward_47 = None
    ...
    sum_80: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_267, [0, 2])
    ...
    sum_81: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1060, [0, 2]);  mul_1060 = None
    mul_1061: "f32[768]" = torch.ops.aten.mul.Tensor(sum_80, 0.0008680555555555555);  sum_80 = None
    ...
    mul_1062: "f32[768]" = torch.ops.aten.mul.Tensor(sum_81, 0.0008680555555555555)
    ...
    mul_1068: "f32[768]" = torch.ops.aten.mul.Tensor(sum_81, squeeze_51);  sum_81 = squeeze_51 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1070: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_255, 1.7015043497085571);  getitem_255 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1071: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_32, 0.7071067811865476)
    erf_82: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1071);  mul_1071 = None
    add_196: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_82, 1);  erf_82 = None
    mul_1072: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_196, 0.5);  add_196 = None
    mul_1073: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_32, convolution_32)
    mul_1074: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1073, -0.5);  mul_1073 = None
    exp_30: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1074);  mul_1074 = None
    mul_1075: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_30, 0.3989422804014327);  exp_30 = None
    mul_1076: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_32, mul_1075);  convolution_32 = mul_1075 = None
    add_197: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1072, mul_1076);  mul_1072 = mul_1076 = None
    mul_1077: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1070, add_197);  mul_1070 = add_197 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_48 = torch.ops.aten.convolution_backward.default(mul_1077, mul_176, view_74, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_1077 = mul_176 = view_74 = None
    getitem_258: "f32[8, 768, 12, 12]" = convolution_backward_48[0]
    getitem_259: "f32[768, 128, 3, 3]" = convolution_backward_48[1]
    getitem_260: "f32[768]" = convolution_backward_48[2];  convolution_backward_48 = None
    ...
    sum_82: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_270, [0, 2])
    ...
    sum_83: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1078, [0, 2]);  mul_1078 = None
    mul_1079: "f32[768]" = torch.ops.aten.mul.Tensor(sum_82, 0.0008680555555555555);  sum_82 = None
    ...
    mul_1080: "f32[768]" = torch.ops.aten.mul.Tensor(sum_83, 0.0008680555555555555)
    ...
    mul_1086: "f32[768]" = torch.ops.aten.mul.Tensor(sum_83, squeeze_49);  sum_83 = squeeze_49 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1088: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_258, 1.7015043497085571);  getitem_258 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1089: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_31, 0.7071067811865476)
    erf_83: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1089);  mul_1089 = None
    add_198: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_83, 1);  erf_83 = None
    mul_1090: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_198, 0.5);  add_198 = None
    mul_1091: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_31, convolution_31)
    mul_1092: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1091, -0.5);  mul_1091 = None
    exp_31: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1092);  mul_1092 = None
    mul_1093: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_31, 0.3989422804014327);  exp_31 = None
    mul_1094: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_31, mul_1093);  convolution_31 = mul_1093 = None
    add_199: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1090, mul_1094);  mul_1090 = mul_1094 = None
    mul_1095: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1088, add_199);  mul_1088 = add_199 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_49 = torch.ops.aten.convolution_backward.default(mul_1095, mul_169, view_71, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1095 = mul_169 = view_71 = None
    getitem_261: "f32[8, 1536, 12, 12]" = convolution_backward_49[0]
    getitem_262: "f32[768, 1536, 1, 1]" = convolution_backward_49[1]
    getitem_263: "f32[768]" = convolution_backward_49[2];  convolution_backward_49 = None
    ...
    sum_84: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_273, [0, 2])
    ...
    sum_85: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1096, [0, 2]);  mul_1096 = None
    mul_1097: "f32[768]" = torch.ops.aten.mul.Tensor(sum_84, 0.0006510416666666666);  sum_84 = None
    ...
    mul_1098: "f32[768]" = torch.ops.aten.mul.Tensor(sum_85, 0.0006510416666666666)
    ...
    mul_1104: "f32[768]" = torch.ops.aten.mul.Tensor(sum_85, squeeze_47);  sum_85 = squeeze_47 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1106: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_261, 0.9805806756909201);  getitem_261 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1107: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1106, 1.7015043497085571);  mul_1106 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1108: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_45, 0.7071067811865476)
    erf_84: "f32[8, 1536, 12, 12]" = torch.ops.aten.erf.default(mul_1108);  mul_1108 = None
    add_200: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(erf_84, 1);  erf_84 = None
    mul_1109: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_200, 0.5);  add_200 = None
    mul_1110: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_45, add_45)
    mul_1111: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1110, -0.5);  mul_1110 = None
    exp_32: "f32[8, 1536, 12, 12]" = torch.ops.aten.exp.default(mul_1111);  mul_1111 = None
    mul_1112: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(exp_32, 0.3989422804014327);  exp_32 = None
    mul_1113: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_45, mul_1112);  add_45 = mul_1112 = None
    add_201: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_1109, mul_1113);  mul_1109 = mul_1113 = None
    mul_1114: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1107, add_201);  mul_1107 = add_201 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_202: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(add_192, mul_1114);  add_192 = mul_1114 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_1115: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(add_202, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_1116: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1115, clone_3);  clone_3 = None
    mul_1117: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1115, primals_73);  mul_1115 = primals_73 = None
    sum_86: "f32[]" = torch.ops.aten.sum.default(mul_1116);  mul_1116 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_1118: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1117, 2.0);  mul_1117 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_1119: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1118, convolution_28);  convolution_28 = None
    mul_1120: "f32[8, 1536, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1118, sigmoid_3);  mul_1118 = sigmoid_3 = None
    sum_87: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1119, [2, 3], True);  mul_1119 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_56: "f32[8, 1536, 1, 1]" = torch.ops.aten.alias.default(alias_7);  alias_7 = None
    sub_201: "f32[8, 1536, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_56)
    mul_1121: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(alias_56, sub_201);  alias_56 = sub_201 = None
    mul_1122: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_87, mul_1121);  sum_87 = mul_1121 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_50 = torch.ops.aten.convolution_backward.default(mul_1122, relu_3, primals_198, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1122 = primals_198 = None
    getitem_264: "f32[8, 768, 1, 1]" = convolution_backward_50[0]
    getitem_265: "f32[1536, 768, 1, 1]" = convolution_backward_50[1]
    getitem_266: "f32[1536]" = convolution_backward_50[2];  convolution_backward_50 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_58: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(relu_3);  relu_3 = None
    alias_59: "f32[8, 768, 1, 1]" = torch.ops.aten.alias.default(alias_58);  alias_58 = None
    le_8: "b8[8, 768, 1, 1]" = torch.ops.aten.le.Scalar(alias_59, 0);  alias_59 = None
    ...
    where_8: "f32[8, 768, 1, 1]" = torch.ops.aten.where.self(le_8, scalar_tensor_8, getitem_264);  le_8 = scalar_tensor_8 = getitem_264 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_51 = torch.ops.aten.convolution_backward.default(where_8, mean_3, primals_196, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_8 = mean_3 = primals_196 = None
    getitem_267: "f32[8, 1536, 1, 1]" = convolution_backward_51[0]
    getitem_268: "f32[768, 1536, 1, 1]" = convolution_backward_51[1]
    getitem_269: "f32[768]" = convolution_backward_51[2];  convolution_backward_51 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_9: "f32[8, 1536, 12, 12]" = torch.ops.aten.expand.default(getitem_267, [8, 1536, 12, 12]);  getitem_267 = None
    div_9: "f32[8, 1536, 12, 12]" = torch.ops.aten.div.Scalar(expand_9, 144);  expand_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_203: "f32[8, 1536, 12, 12]" = torch.ops.aten.add.Tensor(mul_1120, div_9);  mul_1120 = div_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_52 = torch.ops.aten.convolution_backward.default(add_203, mul_157, view_68, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_203 = mul_157 = view_68 = None
    getitem_270: "f32[8, 768, 12, 12]" = convolution_backward_52[0]
    getitem_271: "f32[1536, 768, 1, 1]" = convolution_backward_52[1]
    getitem_272: "f32[1536]" = convolution_backward_52[2];  convolution_backward_52 = None
    ...
    sum_88: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_276, [0, 2])
    ...
    sum_89: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_1123, [0, 2]);  mul_1123 = None
    mul_1124: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_88, 0.0013020833333333333);  sum_88 = None
    ...
    mul_1125: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_89, 0.0013020833333333333)
    ...
    mul_1131: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_89, squeeze_45);  sum_89 = squeeze_45 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1133: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_270, 1.7015043497085571);  getitem_270 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1134: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_27, 0.7071067811865476)
    erf_85: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1134);  mul_1134 = None
    add_204: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_85, 1);  erf_85 = None
    mul_1135: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_204, 0.5);  add_204 = None
    mul_1136: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_27, convolution_27)
    mul_1137: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1136, -0.5);  mul_1136 = None
    exp_33: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1137);  mul_1137 = None
    mul_1138: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_33, 0.3989422804014327);  exp_33 = None
    mul_1139: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_27, mul_1138);  convolution_27 = mul_1138 = None
    add_205: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1135, mul_1139);  mul_1135 = mul_1139 = None
    mul_1140: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1133, add_205);  mul_1133 = add_205 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_53 = torch.ops.aten.convolution_backward.default(mul_1140, mul_150, view_65, [768], [1, 1], [1, 1], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_1140 = mul_150 = view_65 = None
    getitem_273: "f32[8, 768, 12, 12]" = convolution_backward_53[0]
    getitem_274: "f32[768, 128, 3, 3]" = convolution_backward_53[1]
    getitem_275: "f32[768]" = convolution_backward_53[2];  convolution_backward_53 = None
    ...
    sum_90: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_279, [0, 2])
    ...
    sum_91: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1141, [0, 2]);  mul_1141 = None
    mul_1142: "f32[768]" = torch.ops.aten.mul.Tensor(sum_90, 0.0008680555555555555);  sum_90 = None
    ...
    mul_1143: "f32[768]" = torch.ops.aten.mul.Tensor(sum_91, 0.0008680555555555555)
    ...
    mul_1149: "f32[768]" = torch.ops.aten.mul.Tensor(sum_91, squeeze_43);  sum_91 = squeeze_43 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1151: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(getitem_273, 1.7015043497085571);  getitem_273 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1152: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_26, 0.7071067811865476)
    erf_86: "f32[8, 768, 12, 12]" = torch.ops.aten.erf.default(mul_1152);  mul_1152 = None
    add_206: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(erf_86, 1);  erf_86 = None
    mul_1153: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(add_206, 0.5);  add_206 = None
    mul_1154: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_26, convolution_26)
    mul_1155: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1154, -0.5);  mul_1154 = None
    exp_34: "f32[8, 768, 12, 12]" = torch.ops.aten.exp.default(mul_1155);  mul_1155 = None
    mul_1156: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(exp_34, 0.3989422804014327);  exp_34 = None
    mul_1157: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(convolution_26, mul_1156);  convolution_26 = mul_1156 = None
    add_207: "f32[8, 768, 12, 12]" = torch.ops.aten.add.Tensor(mul_1153, mul_1157);  mul_1153 = mul_1157 = None
    mul_1158: "f32[8, 768, 12, 12]" = torch.ops.aten.mul.Tensor(mul_1151, add_207);  mul_1151 = add_207 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_54 = torch.ops.aten.convolution_backward.default(mul_1158, constant_pad_nd_3, view_62, [768], [2, 2], [0, 0], [1, 1], False, [0, 0], 6, [True, True, True]);  mul_1158 = constant_pad_nd_3 = view_62 = None
    getitem_276: "f32[8, 768, 25, 25]" = convolution_backward_54[0]
    getitem_277: "f32[768, 128, 3, 3]" = convolution_backward_54[1]
    getitem_278: "f32[768]" = convolution_backward_54[2];  convolution_backward_54 = None
    ...
    sum_92: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_282, [0, 2])
    ...
    sum_93: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1159, [0, 2]);  mul_1159 = None
    mul_1160: "f32[768]" = torch.ops.aten.mul.Tensor(sum_92, 0.0008680555555555555);  sum_92 = None
    ...
    mul_1161: "f32[768]" = torch.ops.aten.mul.Tensor(sum_93, 0.0008680555555555555)
    ...
    mul_1167: "f32[768]" = torch.ops.aten.mul.Tensor(sum_93, squeeze_41);  sum_93 = squeeze_41 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_6: "f32[8, 768, 24, 24]" = torch.ops.aten.constant_pad_nd.default(getitem_276, [0, -1, 0, -1]);  getitem_276 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1169: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(constant_pad_nd_6, 1.7015043497085571);  constant_pad_nd_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1170: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_25, 0.7071067811865476)
    erf_87: "f32[8, 768, 24, 24]" = torch.ops.aten.erf.default(mul_1170);  mul_1170 = None
    add_208: "f32[8, 768, 24, 24]" = torch.ops.aten.add.Tensor(erf_87, 1);  erf_87 = None
    mul_1171: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(add_208, 0.5);  add_208 = None
    mul_1172: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_25, convolution_25)
    mul_1173: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1172, -0.5);  mul_1172 = None
    exp_35: "f32[8, 768, 24, 24]" = torch.ops.aten.exp.default(mul_1173);  mul_1173 = None
    mul_1174: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(exp_35, 0.3989422804014327);  exp_35 = None
    mul_1175: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_25, mul_1174);  convolution_25 = mul_1174 = None
    add_209: "f32[8, 768, 24, 24]" = torch.ops.aten.add.Tensor(mul_1171, mul_1175);  mul_1171 = mul_1175 = None
    mul_1176: "f32[8, 768, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1169, add_209);  mul_1169 = add_209 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_55 = torch.ops.aten.convolution_backward.default(mul_1176, mul_133, view_59, [768], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1176 = view_59 = None
    getitem_279: "f32[8, 512, 24, 24]" = convolution_backward_55[0]
    getitem_280: "f32[768, 512, 1, 1]" = convolution_backward_55[1]
    getitem_281: "f32[768]" = convolution_backward_55[2];  convolution_backward_55 = None
    ...
    sum_94: "f32[768]" = torch.ops.aten.sum.dim_IntList(view_285, [0, 2])
    ...
    sum_95: "f32[768]" = torch.ops.aten.sum.dim_IntList(mul_1177, [0, 2]);  mul_1177 = None
    mul_1178: "f32[768]" = torch.ops.aten.mul.Tensor(sum_94, 0.001953125);  sum_94 = None
    ...
    mul_1179: "f32[768]" = torch.ops.aten.mul.Tensor(sum_95, 0.001953125)
    ...
    mul_1185: "f32[768]" = torch.ops.aten.mul.Tensor(sum_95, squeeze_39);  sum_95 = squeeze_39 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_56 = torch.ops.aten.convolution_backward.default(add_202, avg_pool2d_1, view_56, [1536], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_202 = avg_pool2d_1 = view_56 = None
    getitem_282: "f32[8, 512, 12, 12]" = convolution_backward_56[0]
    getitem_283: "f32[1536, 512, 1, 1]" = convolution_backward_56[1]
    getitem_284: "f32[1536]" = convolution_backward_56[2];  convolution_backward_56 = None
    ...
    sum_96: "f32[1536]" = torch.ops.aten.sum.dim_IntList(view_288, [0, 2])
    ...
    sum_97: "f32[1536]" = torch.ops.aten.sum.dim_IntList(mul_1187, [0, 2]);  mul_1187 = None
    mul_1188: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_96, 0.001953125);  sum_96 = None
    ...
    mul_1189: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_97, 0.001953125)
    ...
    mul_1195: "f32[1536]" = torch.ops.aten.mul.Tensor(sum_97, squeeze_37);  sum_97 = squeeze_37 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    avg_pool2d_backward_1: "f32[8, 512, 24, 24]" = torch.ops.aten.avg_pool2d_backward.default(getitem_282, mul_133, [2, 2], [2, 2], [0, 0], True, False, None);  getitem_282 = mul_133 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    add_210: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(getitem_279, avg_pool2d_backward_1);  getitem_279 = avg_pool2d_backward_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1197: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_210, 0.9622504486493761);  add_210 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1198: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1197, 1.7015043497085571);  mul_1197 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1199: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_35, 0.7071067811865476)
    erf_88: "f32[8, 512, 24, 24]" = torch.ops.aten.erf.default(mul_1199);  mul_1199 = None
    add_211: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(erf_88, 1);  erf_88 = None
    mul_1200: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_211, 0.5);  add_211 = None
    mul_1201: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_35, add_35)
    mul_1202: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1201, -0.5);  mul_1201 = None
    exp_36: "f32[8, 512, 24, 24]" = torch.ops.aten.exp.default(mul_1202);  mul_1202 = None
    mul_1203: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(exp_36, 0.3989422804014327);  exp_36 = None
    mul_1204: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_35, mul_1203);  add_35 = mul_1203 = None
    add_212: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_1200, mul_1204);  mul_1200 = mul_1204 = None
    mul_1205: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1198, add_212);  mul_1198 = add_212 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_1206: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1205, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_1207: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1206, clone_2);  clone_2 = None
    mul_1208: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1206, primals_57);  mul_1206 = primals_57 = None
    sum_98: "f32[]" = torch.ops.aten.sum.default(mul_1207);  mul_1207 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_1209: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1208, 2.0);  mul_1208 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_1210: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1209, convolution_21);  convolution_21 = None
    mul_1211: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1209, sigmoid_2);  mul_1209 = sigmoid_2 = None
    sum_99: "f32[8, 512, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1210, [2, 3], True);  mul_1210 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_60: "f32[8, 512, 1, 1]" = torch.ops.aten.alias.default(alias_5);  alias_5 = None
    sub_222: "f32[8, 512, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_60)
    mul_1212: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(alias_60, sub_222);  alias_60 = sub_222 = None
    mul_1213: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(sum_99, mul_1212);  sum_99 = mul_1212 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_57 = torch.ops.aten.convolution_backward.default(mul_1213, relu_2, primals_194, [512], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1213 = primals_194 = None
    getitem_285: "f32[8, 256, 1, 1]" = convolution_backward_57[0]
    getitem_286: "f32[512, 256, 1, 1]" = convolution_backward_57[1]
    getitem_287: "f32[512]" = convolution_backward_57[2];  convolution_backward_57 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_62: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(relu_2);  relu_2 = None
    alias_63: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(alias_62);  alias_62 = None
    le_9: "b8[8, 256, 1, 1]" = torch.ops.aten.le.Scalar(alias_63, 0);  alias_63 = None
    ...
    where_9: "f32[8, 256, 1, 1]" = torch.ops.aten.where.self(le_9, scalar_tensor_9, getitem_285);  le_9 = scalar_tensor_9 = getitem_285 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_58 = torch.ops.aten.convolution_backward.default(where_9, mean_2, primals_192, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_9 = mean_2 = primals_192 = None
    getitem_288: "f32[8, 512, 1, 1]" = convolution_backward_58[0]
    getitem_289: "f32[256, 512, 1, 1]" = convolution_backward_58[1]
    getitem_290: "f32[256]" = convolution_backward_58[2];  convolution_backward_58 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_10: "f32[8, 512, 24, 24]" = torch.ops.aten.expand.default(getitem_288, [8, 512, 24, 24]);  getitem_288 = None
    div_10: "f32[8, 512, 24, 24]" = torch.ops.aten.div.Scalar(expand_10, 576);  expand_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_213: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_1211, div_10);  mul_1211 = div_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_59 = torch.ops.aten.convolution_backward.default(add_213, mul_121, view_53, [512], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_213 = mul_121 = view_53 = None
    getitem_291: "f32[8, 256, 24, 24]" = convolution_backward_59[0]
    getitem_292: "f32[512, 256, 1, 1]" = convolution_backward_59[1]
    getitem_293: "f32[512]" = convolution_backward_59[2];  convolution_backward_59 = None
    ...
    sum_100: "f32[512]" = torch.ops.aten.sum.dim_IntList(view_291, [0, 2])
    ...
    sum_101: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_1214, [0, 2]);  mul_1214 = None
    mul_1215: "f32[512]" = torch.ops.aten.mul.Tensor(sum_100, 0.00390625);  sum_100 = None
    ...
    mul_1216: "f32[512]" = torch.ops.aten.mul.Tensor(sum_101, 0.00390625)
    ...
    mul_1222: "f32[512]" = torch.ops.aten.mul.Tensor(sum_101, squeeze_35);  sum_101 = squeeze_35 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1224: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_291, 1.7015043497085571);  getitem_291 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1225: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_20, 0.7071067811865476)
    erf_89: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_1225);  mul_1225 = None
    add_214: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_89, 1);  erf_89 = None
    mul_1226: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(add_214, 0.5);  add_214 = None
    mul_1227: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_20, convolution_20)
    mul_1228: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1227, -0.5);  mul_1227 = None
    exp_37: "f32[8, 256, 24, 24]" = torch.ops.aten.exp.default(mul_1228);  mul_1228 = None
    mul_1229: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(exp_37, 0.3989422804014327);  exp_37 = None
    mul_1230: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_20, mul_1229);  convolution_20 = mul_1229 = None
    add_215: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(mul_1226, mul_1230);  mul_1226 = mul_1230 = None
    mul_1231: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1224, add_215);  mul_1224 = add_215 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_60 = torch.ops.aten.convolution_backward.default(mul_1231, mul_114, view_50, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 2, [True, True, True]);  mul_1231 = mul_114 = view_50 = None
    getitem_294: "f32[8, 256, 24, 24]" = convolution_backward_60[0]
    getitem_295: "f32[256, 128, 3, 3]" = convolution_backward_60[1]
    getitem_296: "f32[256]" = convolution_backward_60[2];  convolution_backward_60 = None
    ...
    sum_102: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_294, [0, 2])
    ...
    sum_103: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1232, [0, 2]);  mul_1232 = None
    mul_1233: "f32[256]" = torch.ops.aten.mul.Tensor(sum_102, 0.0008680555555555555);  sum_102 = None
    ...
    mul_1234: "f32[256]" = torch.ops.aten.mul.Tensor(sum_103, 0.0008680555555555555)
    ...
    mul_1240: "f32[256]" = torch.ops.aten.mul.Tensor(sum_103, squeeze_33);  sum_103 = squeeze_33 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1242: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_294, 1.7015043497085571);  getitem_294 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1243: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_19, 0.7071067811865476)
    erf_90: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_1243);  mul_1243 = None
    add_216: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_90, 1);  erf_90 = None
    mul_1244: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(add_216, 0.5);  add_216 = None
    mul_1245: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_19, convolution_19)
    mul_1246: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1245, -0.5);  mul_1245 = None
    exp_38: "f32[8, 256, 24, 24]" = torch.ops.aten.exp.default(mul_1246);  mul_1246 = None
    mul_1247: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(exp_38, 0.3989422804014327);  exp_38 = None
    mul_1248: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_19, mul_1247);  convolution_19 = mul_1247 = None
    add_217: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(mul_1244, mul_1248);  mul_1244 = mul_1248 = None
    mul_1249: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1242, add_217);  mul_1242 = add_217 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_61 = torch.ops.aten.convolution_backward.default(mul_1249, mul_107, view_47, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 2, [True, True, True]);  mul_1249 = mul_107 = view_47 = None
    getitem_297: "f32[8, 256, 24, 24]" = convolution_backward_61[0]
    getitem_298: "f32[256, 128, 3, 3]" = convolution_backward_61[1]
    getitem_299: "f32[256]" = convolution_backward_61[2];  convolution_backward_61 = None
    ...
    sum_104: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_297, [0, 2])
    ...
    sum_105: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1250, [0, 2]);  mul_1250 = None
    mul_1251: "f32[256]" = torch.ops.aten.mul.Tensor(sum_104, 0.0008680555555555555);  sum_104 = None
    ...
    mul_1252: "f32[256]" = torch.ops.aten.mul.Tensor(sum_105, 0.0008680555555555555)
    ...
    mul_1258: "f32[256]" = torch.ops.aten.mul.Tensor(sum_105, squeeze_31);  sum_105 = squeeze_31 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1260: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_297, 1.7015043497085571);  getitem_297 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1261: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_18, 0.7071067811865476)
    erf_91: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_1261);  mul_1261 = None
    add_218: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_91, 1);  erf_91 = None
    mul_1262: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(add_218, 0.5);  add_218 = None
    mul_1263: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_18, convolution_18)
    mul_1264: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1263, -0.5);  mul_1263 = None
    exp_39: "f32[8, 256, 24, 24]" = torch.ops.aten.exp.default(mul_1264);  mul_1264 = None
    mul_1265: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(exp_39, 0.3989422804014327);  exp_39 = None
    mul_1266: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_18, mul_1265);  convolution_18 = mul_1265 = None
    add_219: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(mul_1262, mul_1266);  mul_1262 = mul_1266 = None
    mul_1267: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1260, add_219);  mul_1260 = add_219 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_62 = torch.ops.aten.convolution_backward.default(mul_1267, mul_100, view_44, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1267 = mul_100 = view_44 = None
    getitem_300: "f32[8, 512, 24, 24]" = convolution_backward_62[0]
    getitem_301: "f32[256, 512, 1, 1]" = convolution_backward_62[1]
    getitem_302: "f32[256]" = convolution_backward_62[2];  convolution_backward_62 = None
    ...
    sum_106: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_300, [0, 2])
    ...
    sum_107: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1268, [0, 2]);  mul_1268 = None
    mul_1269: "f32[256]" = torch.ops.aten.mul.Tensor(sum_106, 0.001953125);  sum_106 = None
    ...
    mul_1270: "f32[256]" = torch.ops.aten.mul.Tensor(sum_107, 0.001953125)
    ...
    mul_1276: "f32[256]" = torch.ops.aten.mul.Tensor(sum_107, squeeze_29);  sum_107 = squeeze_29 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1278: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_300, 0.9805806756909201);  getitem_300 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1279: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1278, 1.7015043497085571);  mul_1278 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1280: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_26, 0.7071067811865476)
    erf_92: "f32[8, 512, 24, 24]" = torch.ops.aten.erf.default(mul_1280);  mul_1280 = None
    add_220: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(erf_92, 1);  erf_92 = None
    mul_1281: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_220, 0.5);  add_220 = None
    mul_1282: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_26, add_26)
    mul_1283: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1282, -0.5);  mul_1282 = None
    exp_40: "f32[8, 512, 24, 24]" = torch.ops.aten.exp.default(mul_1283);  mul_1283 = None
    mul_1284: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(exp_40, 0.3989422804014327);  exp_40 = None
    mul_1285: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_26, mul_1284);  add_26 = mul_1284 = None
    add_221: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_1281, mul_1285);  mul_1281 = mul_1285 = None
    mul_1286: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1279, add_221);  mul_1279 = add_221 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    add_222: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_1205, mul_1286);  mul_1205 = mul_1286 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_1287: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(add_222, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_1288: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1287, clone_1);  clone_1 = None
    mul_1289: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1287, primals_44);  mul_1287 = primals_44 = None
    sum_108: "f32[]" = torch.ops.aten.sum.default(mul_1288);  mul_1288 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_1290: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1289, 2.0);  mul_1289 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_1291: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1290, convolution_15);  convolution_15 = None
    mul_1292: "f32[8, 512, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1290, sigmoid_1);  mul_1290 = sigmoid_1 = None
    sum_109: "f32[8, 512, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1291, [2, 3], True);  mul_1291 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_64: "f32[8, 512, 1, 1]" = torch.ops.aten.alias.default(alias_3);  alias_3 = None
    sub_239: "f32[8, 512, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_64)
    mul_1293: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(alias_64, sub_239);  alias_64 = sub_239 = None
    mul_1294: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(sum_109, mul_1293);  sum_109 = mul_1293 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_63 = torch.ops.aten.convolution_backward.default(mul_1294, relu_1, primals_190, [512], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1294 = primals_190 = None
    getitem_303: "f32[8, 256, 1, 1]" = convolution_backward_63[0]
    getitem_304: "f32[512, 256, 1, 1]" = convolution_backward_63[1]
    getitem_305: "f32[512]" = convolution_backward_63[2];  convolution_backward_63 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_66: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(relu_1);  relu_1 = None
    alias_67: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(alias_66);  alias_66 = None
    le_10: "b8[8, 256, 1, 1]" = torch.ops.aten.le.Scalar(alias_67, 0);  alias_67 = None
    ...
    where_10: "f32[8, 256, 1, 1]" = torch.ops.aten.where.self(le_10, scalar_tensor_10, getitem_303);  le_10 = scalar_tensor_10 = getitem_303 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_64 = torch.ops.aten.convolution_backward.default(where_10, mean_1, primals_188, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_10 = mean_1 = primals_188 = None
    getitem_306: "f32[8, 512, 1, 1]" = convolution_backward_64[0]
    getitem_307: "f32[256, 512, 1, 1]" = convolution_backward_64[1]
    getitem_308: "f32[256]" = convolution_backward_64[2];  convolution_backward_64 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_11: "f32[8, 512, 24, 24]" = torch.ops.aten.expand.default(getitem_306, [8, 512, 24, 24]);  getitem_306 = None
    div_11: "f32[8, 512, 24, 24]" = torch.ops.aten.div.Scalar(expand_11, 576);  expand_11 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_223: "f32[8, 512, 24, 24]" = torch.ops.aten.add.Tensor(mul_1292, div_11);  mul_1292 = div_11 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_65 = torch.ops.aten.convolution_backward.default(add_223, mul_88, view_41, [512], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_223 = mul_88 = view_41 = None
    getitem_309: "f32[8, 256, 24, 24]" = convolution_backward_65[0]
    getitem_310: "f32[512, 256, 1, 1]" = convolution_backward_65[1]
    getitem_311: "f32[512]" = convolution_backward_65[2];  convolution_backward_65 = None
    ...
    sum_110: "f32[512]" = torch.ops.aten.sum.dim_IntList(view_303, [0, 2])
    ...
    sum_111: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_1295, [0, 2]);  mul_1295 = None
    mul_1296: "f32[512]" = torch.ops.aten.mul.Tensor(sum_110, 0.00390625);  sum_110 = None
    ...
    mul_1297: "f32[512]" = torch.ops.aten.mul.Tensor(sum_111, 0.00390625)
    ...
    mul_1303: "f32[512]" = torch.ops.aten.mul.Tensor(sum_111, squeeze_27);  sum_111 = squeeze_27 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1305: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_309, 1.7015043497085571);  getitem_309 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1306: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_14, 0.7071067811865476)
    erf_93: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_1306);  mul_1306 = None
    add_224: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_93, 1);  erf_93 = None
    mul_1307: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(add_224, 0.5);  add_224 = None
    mul_1308: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_14, convolution_14)
    mul_1309: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1308, -0.5);  mul_1308 = None
    exp_41: "f32[8, 256, 24, 24]" = torch.ops.aten.exp.default(mul_1309);  mul_1309 = None
    mul_1310: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(exp_41, 0.3989422804014327);  exp_41 = None
    mul_1311: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_14, mul_1310);  convolution_14 = mul_1310 = None
    add_225: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(mul_1307, mul_1311);  mul_1307 = mul_1311 = None
    mul_1312: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1305, add_225);  mul_1305 = add_225 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_66 = torch.ops.aten.convolution_backward.default(mul_1312, mul_81, view_38, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 2, [True, True, True]);  mul_1312 = mul_81 = view_38 = None
    getitem_312: "f32[8, 256, 24, 24]" = convolution_backward_66[0]
    getitem_313: "f32[256, 128, 3, 3]" = convolution_backward_66[1]
    getitem_314: "f32[256]" = convolution_backward_66[2];  convolution_backward_66 = None
    ...
    sum_112: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_306, [0, 2])
    ...
    sum_113: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1313, [0, 2]);  mul_1313 = None
    mul_1314: "f32[256]" = torch.ops.aten.mul.Tensor(sum_112, 0.0008680555555555555);  sum_112 = None
    ...
    mul_1315: "f32[256]" = torch.ops.aten.mul.Tensor(sum_113, 0.0008680555555555555)
    ...
    mul_1321: "f32[256]" = torch.ops.aten.mul.Tensor(sum_113, squeeze_25);  sum_113 = squeeze_25 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1323: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(getitem_312, 1.7015043497085571);  getitem_312 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1324: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_13, 0.7071067811865476)
    erf_94: "f32[8, 256, 24, 24]" = torch.ops.aten.erf.default(mul_1324);  mul_1324 = None
    add_226: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(erf_94, 1);  erf_94 = None
    mul_1325: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(add_226, 0.5);  add_226 = None
    mul_1326: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_13, convolution_13)
    mul_1327: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1326, -0.5);  mul_1326 = None
    exp_42: "f32[8, 256, 24, 24]" = torch.ops.aten.exp.default(mul_1327);  mul_1327 = None
    mul_1328: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(exp_42, 0.3989422804014327);  exp_42 = None
    mul_1329: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(convolution_13, mul_1328);  convolution_13 = mul_1328 = None
    add_227: "f32[8, 256, 24, 24]" = torch.ops.aten.add.Tensor(mul_1325, mul_1329);  mul_1325 = mul_1329 = None
    mul_1330: "f32[8, 256, 24, 24]" = torch.ops.aten.mul.Tensor(mul_1323, add_227);  mul_1323 = add_227 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_67 = torch.ops.aten.convolution_backward.default(mul_1330, constant_pad_nd_2, view_35, [256], [2, 2], [0, 0], [1, 1], False, [0, 0], 2, [True, True, True]);  mul_1330 = constant_pad_nd_2 = view_35 = None
    getitem_315: "f32[8, 256, 49, 49]" = convolution_backward_67[0]
    getitem_316: "f32[256, 128, 3, 3]" = convolution_backward_67[1]
    getitem_317: "f32[256]" = convolution_backward_67[2];  convolution_backward_67 = None
    ...
    sum_114: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_309, [0, 2])
    ...
    sum_115: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1331, [0, 2]);  mul_1331 = None
    mul_1332: "f32[256]" = torch.ops.aten.mul.Tensor(sum_114, 0.0008680555555555555);  sum_114 = None
    ...
    mul_1333: "f32[256]" = torch.ops.aten.mul.Tensor(sum_115, 0.0008680555555555555)
    ...
    mul_1339: "f32[256]" = torch.ops.aten.mul.Tensor(sum_115, squeeze_23);  sum_115 = squeeze_23 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_7: "f32[8, 256, 48, 48]" = torch.ops.aten.constant_pad_nd.default(getitem_315, [0, -1, 0, -1]);  getitem_315 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1341: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(constant_pad_nd_7, 1.7015043497085571);  constant_pad_nd_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1342: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_12, 0.7071067811865476)
    erf_95: "f32[8, 256, 48, 48]" = torch.ops.aten.erf.default(mul_1342);  mul_1342 = None
    add_228: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(erf_95, 1);  erf_95 = None
    mul_1343: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_228, 0.5);  add_228 = None
    mul_1344: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_12, convolution_12)
    mul_1345: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1344, -0.5);  mul_1344 = None
    exp_43: "f32[8, 256, 48, 48]" = torch.ops.aten.exp.default(mul_1345);  mul_1345 = None
    mul_1346: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(exp_43, 0.3989422804014327);  exp_43 = None
    mul_1347: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_12, mul_1346);  convolution_12 = mul_1346 = None
    add_229: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(mul_1343, mul_1347);  mul_1343 = mul_1347 = None
    mul_1348: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1341, add_229);  mul_1341 = add_229 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_68 = torch.ops.aten.convolution_backward.default(mul_1348, mul_64, view_32, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1348 = view_32 = None
    getitem_318: "f32[8, 256, 48, 48]" = convolution_backward_68[0]
    getitem_319: "f32[256, 256, 1, 1]" = convolution_backward_68[1]
    getitem_320: "f32[256]" = convolution_backward_68[2];  convolution_backward_68 = None
    ...
    sum_116: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_312, [0, 2])
    ...
    sum_117: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1349, [0, 2]);  mul_1349 = None
    mul_1350: "f32[256]" = torch.ops.aten.mul.Tensor(sum_116, 0.00390625);  sum_116 = None
    ...
    mul_1351: "f32[256]" = torch.ops.aten.mul.Tensor(sum_117, 0.00390625)
    ...
    mul_1357: "f32[256]" = torch.ops.aten.mul.Tensor(sum_117, squeeze_21);  sum_117 = squeeze_21 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_69 = torch.ops.aten.convolution_backward.default(add_222, avg_pool2d, view_29, [512], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_222 = avg_pool2d = view_29 = None
    getitem_321: "f32[8, 256, 24, 24]" = convolution_backward_69[0]
    getitem_322: "f32[512, 256, 1, 1]" = convolution_backward_69[1]
    getitem_323: "f32[512]" = convolution_backward_69[2];  convolution_backward_69 = None
    ...
    sum_118: "f32[512]" = torch.ops.aten.sum.dim_IntList(view_315, [0, 2])
    ...
    sum_119: "f32[512]" = torch.ops.aten.sum.dim_IntList(mul_1359, [0, 2]);  mul_1359 = None
    mul_1360: "f32[512]" = torch.ops.aten.mul.Tensor(sum_118, 0.00390625);  sum_118 = None
    ...
    mul_1361: "f32[512]" = torch.ops.aten.mul.Tensor(sum_119, 0.00390625)
    ...
    mul_1367: "f32[512]" = torch.ops.aten.mul.Tensor(sum_119, squeeze_19);  sum_119 = squeeze_19 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    avg_pool2d_backward_2: "f32[8, 256, 48, 48]" = torch.ops.aten.avg_pool2d_backward.default(getitem_321, mul_64, [2, 2], [2, 2], [0, 0], True, False, None);  getitem_321 = mul_64 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:101, code: return self.conv(self.pool(x))
    add_230: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(getitem_318, avg_pool2d_backward_2);  getitem_318 = avg_pool2d_backward_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1369: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_230, 0.9805806756909201);  add_230 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1370: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1369, 1.7015043497085571);  mul_1369 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1371: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_16, 0.7071067811865476)
    erf_96: "f32[8, 256, 48, 48]" = torch.ops.aten.erf.default(mul_1371);  mul_1371 = None
    add_231: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(erf_96, 1);  erf_96 = None
    mul_1372: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_231, 0.5);  add_231 = None
    mul_1373: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_16, add_16)
    mul_1374: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1373, -0.5);  mul_1373 = None
    exp_44: "f32[8, 256, 48, 48]" = torch.ops.aten.exp.default(mul_1374);  mul_1374 = None
    mul_1375: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(exp_44, 0.3989422804014327);  exp_44 = None
    mul_1376: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(add_16, mul_1375);  add_16 = mul_1375 = None
    add_232: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(mul_1372, mul_1376);  mul_1372 = mul_1376 = None
    mul_1377: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1370, add_232);  mul_1370 = add_232 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:199, code: out = out * self.alpha + shortcut
    mul_1378: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1377, 0.2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:198, code: out.mul_(self.skipinit_gain)
    mul_1379: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1378, clone);  clone = None
    mul_1380: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1378, primals_28);  mul_1378 = primals_28 = None
    sum_120: "f32[]" = torch.ops.aten.sum.default(mul_1379);  mul_1379 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:194, code: out = self.attn_gain * self.attn_last(out)
    mul_1381: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1380, 2.0);  mul_1380 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:49, code: return x * self.gate(x_se)
    mul_1382: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1381, convolution_8);  convolution_8 = None
    mul_1383: "f32[8, 256, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1381, sigmoid);  mul_1381 = sigmoid = None
    sum_121: "f32[8, 256, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1382, [2, 3], True);  mul_1382 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:57, code: return x.sigmoid_() if self.inplace else x.sigmoid()
    alias_68: "f32[8, 256, 1, 1]" = torch.ops.aten.alias.default(alias_1);  alias_1 = None
    sub_260: "f32[8, 256, 1, 1]" = torch.ops.aten.sub.Tensor(1, alias_68)
    mul_1384: "f32[8, 256, 1, 1]" = torch.ops.aten.mul.Tensor(alias_68, sub_260);  alias_68 = sub_260 = None
    mul_1385: "f32[8, 256, 1, 1]" = torch.ops.aten.mul.Tensor(sum_121, mul_1384);  sum_121 = mul_1384 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:48, code: x_se = self.fc2(x_se)
    convolution_backward_70 = torch.ops.aten.convolution_backward.default(mul_1385, relu, primals_186, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1385 = primals_186 = None
    getitem_324: "f32[8, 128, 1, 1]" = convolution_backward_70[0]
    getitem_325: "f32[256, 128, 1, 1]" = convolution_backward_70[1]
    getitem_326: "f32[256]" = convolution_backward_70[2];  convolution_backward_70 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:47, code: x_se = self.act(self.bn(x_se))
    alias_70: "f32[8, 128, 1, 1]" = torch.ops.aten.alias.default(relu);  relu = None
    alias_71: "f32[8, 128, 1, 1]" = torch.ops.aten.alias.default(alias_70);  alias_70 = None
    le_11: "b8[8, 128, 1, 1]" = torch.ops.aten.le.Scalar(alias_71, 0);  alias_71 = None
    ...
    where_11: "f32[8, 128, 1, 1]" = torch.ops.aten.where.self(le_11, scalar_tensor_11, getitem_324);  le_11 = scalar_tensor_11 = getitem_324 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:46, code: x_se = self.fc1(x_se)
    convolution_backward_71 = torch.ops.aten.convolution_backward.default(where_11, mean, primals_184, [128], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  where_11 = mean = primals_184 = None
    getitem_327: "f32[8, 256, 1, 1]" = convolution_backward_71[0]
    getitem_328: "f32[128, 256, 1, 1]" = convolution_backward_71[1]
    getitem_329: "f32[128]" = convolution_backward_71[2];  convolution_backward_71 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    expand_12: "f32[8, 256, 48, 48]" = torch.ops.aten.expand.default(getitem_327, [8, 256, 48, 48]);  getitem_327 = None
    div_12: "f32[8, 256, 48, 48]" = torch.ops.aten.div.Scalar(expand_12, 2304);  expand_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/squeeze_excite.py:42, code: x_se = x.mean((2, 3), keepdim=True)
    add_233: "f32[8, 256, 48, 48]" = torch.ops.aten.add.Tensor(mul_1383, div_12);  mul_1383 = div_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_72 = torch.ops.aten.convolution_backward.default(add_233, mul_52, view_26, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  add_233 = mul_52 = view_26 = None
    getitem_330: "f32[8, 128, 48, 48]" = convolution_backward_72[0]
    getitem_331: "f32[256, 128, 1, 1]" = convolution_backward_72[1]
    getitem_332: "f32[256]" = convolution_backward_72[2];  convolution_backward_72 = None
    ...
    sum_122: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_318, [0, 2])
    ...
    sum_123: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1386, [0, 2]);  mul_1386 = None
    mul_1387: "f32[256]" = torch.ops.aten.mul.Tensor(sum_122, 0.0078125);  sum_122 = None
    ...
    mul_1388: "f32[256]" = torch.ops.aten.mul.Tensor(sum_123, 0.0078125)
    ...
    mul_1394: "f32[256]" = torch.ops.aten.mul.Tensor(sum_123, squeeze_17);  sum_123 = squeeze_17 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1396: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(getitem_330, 1.7015043497085571);  getitem_330 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1397: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_7, 0.7071067811865476)
    erf_97: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_1397);  mul_1397 = None
    add_234: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_97, 1);  erf_97 = None
    mul_1398: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(add_234, 0.5);  add_234 = None
    mul_1399: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_7, convolution_7)
    mul_1400: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1399, -0.5);  mul_1399 = None
    exp_45: "f32[8, 128, 48, 48]" = torch.ops.aten.exp.default(mul_1400);  mul_1400 = None
    mul_1401: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(exp_45, 0.3989422804014327);  exp_45 = None
    mul_1402: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_7, mul_1401);  convolution_7 = mul_1401 = None
    add_235: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(mul_1398, mul_1402);  mul_1398 = mul_1402 = None
    mul_1403: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1396, add_235);  mul_1396 = add_235 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_73 = torch.ops.aten.convolution_backward.default(mul_1403, mul_45, view_23, [128], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1403 = mul_45 = view_23 = None
    getitem_333: "f32[8, 128, 48, 48]" = convolution_backward_73[0]
    getitem_334: "f32[128, 128, 3, 3]" = convolution_backward_73[1]
    getitem_335: "f32[128]" = convolution_backward_73[2];  convolution_backward_73 = None
    ...
    sum_124: "f32[128]" = torch.ops.aten.sum.dim_IntList(view_321, [0, 2])
    ...
    sum_125: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_1404, [0, 2]);  mul_1404 = None
    mul_1405: "f32[128]" = torch.ops.aten.mul.Tensor(sum_124, 0.0008680555555555555);  sum_124 = None
    ...
    mul_1406: "f32[128]" = torch.ops.aten.mul.Tensor(sum_125, 0.0008680555555555555)
    ...
    mul_1412: "f32[128]" = torch.ops.aten.mul.Tensor(sum_125, squeeze_15);  sum_125 = squeeze_15 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1414: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(getitem_333, 1.7015043497085571);  getitem_333 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1415: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_6, 0.7071067811865476)
    erf_98: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_1415);  mul_1415 = None
    add_236: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_98, 1);  erf_98 = None
    mul_1416: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(add_236, 0.5);  add_236 = None
    mul_1417: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_6, convolution_6)
    mul_1418: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1417, -0.5);  mul_1417 = None
    exp_46: "f32[8, 128, 48, 48]" = torch.ops.aten.exp.default(mul_1418);  mul_1418 = None
    mul_1419: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(exp_46, 0.3989422804014327);  exp_46 = None
    mul_1420: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_6, mul_1419);  convolution_6 = mul_1419 = None
    add_237: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(mul_1416, mul_1420);  mul_1416 = mul_1420 = None
    mul_1421: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1414, add_237);  mul_1414 = add_237 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_74 = torch.ops.aten.convolution_backward.default(mul_1421, mul_38, view_20, [128], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1421 = mul_38 = view_20 = None
    getitem_336: "f32[8, 128, 48, 48]" = convolution_backward_74[0]
    getitem_337: "f32[128, 128, 3, 3]" = convolution_backward_74[1]
    getitem_338: "f32[128]" = convolution_backward_74[2];  convolution_backward_74 = None
    ...
    sum_126: "f32[128]" = torch.ops.aten.sum.dim_IntList(view_324, [0, 2])
    ...
    sum_127: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_1422, [0, 2]);  mul_1422 = None
    mul_1423: "f32[128]" = torch.ops.aten.mul.Tensor(sum_126, 0.0008680555555555555);  sum_126 = None
    ...
    mul_1424: "f32[128]" = torch.ops.aten.mul.Tensor(sum_127, 0.0008680555555555555)
    ...
    mul_1430: "f32[128]" = torch.ops.aten.mul.Tensor(sum_127, squeeze_13);  sum_127 = squeeze_13 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1432: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(getitem_336, 1.7015043497085571);  getitem_336 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1433: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_5, 0.7071067811865476)
    erf_99: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_1433);  mul_1433 = None
    add_238: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_99, 1);  erf_99 = None
    mul_1434: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(add_238, 0.5);  add_238 = None
    mul_1435: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_5, convolution_5)
    mul_1436: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1435, -0.5);  mul_1435 = None
    exp_47: "f32[8, 128, 48, 48]" = torch.ops.aten.exp.default(mul_1436);  mul_1436 = None
    mul_1437: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(exp_47, 0.3989422804014327);  exp_47 = None
    mul_1438: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_5, mul_1437);  convolution_5 = mul_1437 = None
    add_239: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(mul_1434, mul_1438);  mul_1434 = mul_1438 = None
    mul_1439: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1432, add_239);  mul_1432 = add_239 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_75 = torch.ops.aten.convolution_backward.default(mul_1439, mul_28, view_17, [128], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1439 = view_17 = None
    getitem_339: "f32[8, 128, 48, 48]" = convolution_backward_75[0]
    getitem_340: "f32[128, 128, 1, 1]" = convolution_backward_75[1]
    getitem_341: "f32[128]" = convolution_backward_75[2];  convolution_backward_75 = None
    ...
    sum_128: "f32[128]" = torch.ops.aten.sum.dim_IntList(view_327, [0, 2])
    ...
    sum_129: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_1440, [0, 2]);  mul_1440 = None
    mul_1441: "f32[128]" = torch.ops.aten.mul.Tensor(sum_128, 0.0078125);  sum_128 = None
    ...
    mul_1442: "f32[128]" = torch.ops.aten.mul.Tensor(sum_129, 0.0078125)
    ...
    mul_1448: "f32[128]" = torch.ops.aten.mul.Tensor(sum_129, squeeze_11);  sum_129 = squeeze_11 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_76 = torch.ops.aten.convolution_backward.default(mul_1377, mul_28, view_14, [256], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1377 = mul_28 = view_14 = None
    getitem_342: "f32[8, 128, 48, 48]" = convolution_backward_76[0]
    getitem_343: "f32[256, 128, 1, 1]" = convolution_backward_76[1]
    getitem_344: "f32[256]" = convolution_backward_76[2];  convolution_backward_76 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    add_240: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(getitem_339, getitem_342);  getitem_339 = getitem_342 = None
    ...
    sum_130: "f32[256]" = torch.ops.aten.sum.dim_IntList(view_330, [0, 2])
    ...
    sum_131: "f32[256]" = torch.ops.aten.sum.dim_IntList(mul_1450, [0, 2]);  mul_1450 = None
    mul_1451: "f32[256]" = torch.ops.aten.mul.Tensor(sum_130, 0.0078125);  sum_130 = None
    ...
    mul_1452: "f32[256]" = torch.ops.aten.mul.Tensor(sum_131, 0.0078125)
    ...
    mul_1458: "f32[256]" = torch.ops.aten.mul.Tensor(sum_131, squeeze_9);  sum_131 = squeeze_9 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:178, code: out = self.act1(x) * self.beta
    mul_1460: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(add_240, 1.0);  add_240 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1461: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1460, 1.7015043497085571);  mul_1460 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1462: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_3, 0.7071067811865476)
    erf_100: "f32[8, 128, 48, 48]" = torch.ops.aten.erf.default(mul_1462);  mul_1462 = None
    add_241: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(erf_100, 1);  erf_100 = None
    mul_1463: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(add_241, 0.5);  add_241 = None
    mul_1464: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_3, convolution_3)
    mul_1465: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1464, -0.5);  mul_1464 = None
    exp_48: "f32[8, 128, 48, 48]" = torch.ops.aten.exp.default(mul_1465);  mul_1465 = None
    mul_1466: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(exp_48, 0.3989422804014327);  exp_48 = None
    mul_1467: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(convolution_3, mul_1466);  convolution_3 = mul_1466 = None
    add_242: "f32[8, 128, 48, 48]" = torch.ops.aten.add.Tensor(mul_1463, mul_1467);  mul_1463 = mul_1467 = None
    mul_1468: "f32[8, 128, 48, 48]" = torch.ops.aten.mul.Tensor(mul_1461, add_242);  mul_1461 = add_242 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_77 = torch.ops.aten.convolution_backward.default(mul_1468, constant_pad_nd_1, view_11, [128], [2, 2], [0, 0], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1468 = constant_pad_nd_1 = view_11 = None
    getitem_345: "f32[8, 64, 97, 97]" = convolution_backward_77[0]
    getitem_346: "f32[128, 64, 3, 3]" = convolution_backward_77[1]
    getitem_347: "f32[128]" = convolution_backward_77[2];  convolution_backward_77 = None
    ...
    sum_132: "f32[128]" = torch.ops.aten.sum.dim_IntList(view_333, [0, 2])
    ...
    sum_133: "f32[128]" = torch.ops.aten.sum.dim_IntList(mul_1469, [0, 2]);  mul_1469 = None
    mul_1470: "f32[128]" = torch.ops.aten.mul.Tensor(sum_132, 0.001736111111111111);  sum_132 = None
    ...
    mul_1471: "f32[128]" = torch.ops.aten.mul.Tensor(sum_133, 0.001736111111111111)
    ...
    mul_1477: "f32[128]" = torch.ops.aten.mul.Tensor(sum_133, squeeze_7);  sum_133 = squeeze_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/padding.py:55, code: x = F.pad(x, (pad_w // 2, pad_w - pad_w // 2, pad_h // 2, pad_h - pad_h // 2), value=value)
    constant_pad_nd_8: "f32[8, 64, 96, 96]" = torch.ops.aten.constant_pad_nd.default(getitem_345, [0, -1, 0, -1]);  getitem_345 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1479: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(constant_pad_nd_8, 1.7015043497085571);  constant_pad_nd_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1480: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_2, 0.7071067811865476)
    erf_101: "f32[8, 64, 96, 96]" = torch.ops.aten.erf.default(mul_1480);  mul_1480 = None
    add_243: "f32[8, 64, 96, 96]" = torch.ops.aten.add.Tensor(erf_101, 1);  erf_101 = None
    mul_1481: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(add_243, 0.5);  add_243 = None
    mul_1482: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_2, convolution_2)
    mul_1483: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1482, -0.5);  mul_1482 = None
    exp_49: "f32[8, 64, 96, 96]" = torch.ops.aten.exp.default(mul_1483);  mul_1483 = None
    mul_1484: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(exp_49, 0.3989422804014327);  exp_49 = None
    mul_1485: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_2, mul_1484);  convolution_2 = mul_1484 = None
    add_244: "f32[8, 64, 96, 96]" = torch.ops.aten.add.Tensor(mul_1481, mul_1485);  mul_1481 = mul_1485 = None
    mul_1486: "f32[8, 64, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1479, add_244);  mul_1479 = add_244 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_78 = torch.ops.aten.convolution_backward.default(mul_1486, mul_13, view_8, [64], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1486 = mul_13 = view_8 = None
    getitem_348: "f32[8, 32, 96, 96]" = convolution_backward_78[0]
    getitem_349: "f32[64, 32, 3, 3]" = convolution_backward_78[1]
    getitem_350: "f32[64]" = convolution_backward_78[2];  convolution_backward_78 = None
    ...
    sum_134: "f32[64]" = torch.ops.aten.sum.dim_IntList(view_336, [0, 2])
    ...
    sum_135: "f32[64]" = torch.ops.aten.sum.dim_IntList(mul_1487, [0, 2]);  mul_1487 = None
    mul_1488: "f32[64]" = torch.ops.aten.mul.Tensor(sum_134, 0.003472222222222222);  sum_134 = None
    ...
    mul_1489: "f32[64]" = torch.ops.aten.mul.Tensor(sum_135, 0.003472222222222222)
    ...
    mul_1495: "f32[64]" = torch.ops.aten.mul.Tensor(sum_135, squeeze_5);  sum_135 = squeeze_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1497: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(getitem_348, 1.7015043497085571);  getitem_348 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1498: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_1, 0.7071067811865476)
    erf_102: "f32[8, 32, 96, 96]" = torch.ops.aten.erf.default(mul_1498);  mul_1498 = None
    add_245: "f32[8, 32, 96, 96]" = torch.ops.aten.add.Tensor(erf_102, 1);  erf_102 = None
    mul_1499: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(add_245, 0.5);  add_245 = None
    mul_1500: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_1, convolution_1)
    mul_1501: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1500, -0.5);  mul_1500 = None
    exp_50: "f32[8, 32, 96, 96]" = torch.ops.aten.exp.default(mul_1501);  mul_1501 = None
    mul_1502: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(exp_50, 0.3989422804014327);  exp_50 = None
    mul_1503: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(convolution_1, mul_1502);  convolution_1 = mul_1502 = None
    add_246: "f32[8, 32, 96, 96]" = torch.ops.aten.add.Tensor(mul_1499, mul_1503);  mul_1499 = mul_1503 = None
    mul_1504: "f32[8, 32, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1497, add_246);  mul_1497 = add_246 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_79 = torch.ops.aten.convolution_backward.default(mul_1504, mul_6, view_5, [32], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  mul_1504 = mul_6 = view_5 = None
    getitem_351: "f32[8, 16, 96, 96]" = convolution_backward_79[0]
    getitem_352: "f32[32, 16, 3, 3]" = convolution_backward_79[1]
    getitem_353: "f32[32]" = convolution_backward_79[2];  convolution_backward_79 = None
    ...
    sum_136: "f32[32]" = torch.ops.aten.sum.dim_IntList(view_339, [0, 2])
    ...
    sum_137: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_1505, [0, 2]);  mul_1505 = None
    mul_1506: "f32[32]" = torch.ops.aten.mul.Tensor(sum_136, 0.006944444444444444);  sum_136 = None
    ...
    mul_1507: "f32[32]" = torch.ops.aten.mul.Tensor(sum_137, 0.006944444444444444)
    ...
    mul_1513: "f32[32]" = torch.ops.aten.mul.Tensor(sum_137, squeeze_3);  sum_137 = squeeze_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/nfnet.py:71, code: return self.act_fn(x, inplace=self.inplace).mul_(self.gamma)
    mul_1515: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(getitem_351, 1.7015043497085571);  getitem_351 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/activations.py:135, code: return F.gelu(x)
    mul_1516: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(convolution, 0.7071067811865476)
    erf_103: "f32[8, 16, 96, 96]" = torch.ops.aten.erf.default(mul_1516);  mul_1516 = None
    add_247: "f32[8, 16, 96, 96]" = torch.ops.aten.add.Tensor(erf_103, 1);  erf_103 = None
    mul_1517: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(add_247, 0.5);  add_247 = None
    mul_1518: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(convolution, convolution)
    mul_1519: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1518, -0.5);  mul_1518 = None
    exp_51: "f32[8, 16, 96, 96]" = torch.ops.aten.exp.default(mul_1519);  mul_1519 = None
    mul_1520: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(exp_51, 0.3989422804014327);  exp_51 = None
    mul_1521: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(convolution, mul_1520);  convolution = mul_1520 = None
    add_248: "f32[8, 16, 96, 96]" = torch.ops.aten.add.Tensor(mul_1517, mul_1521);  mul_1517 = mul_1521 = None
    mul_1522: "f32[8, 16, 96, 96]" = torch.ops.aten.mul.Tensor(mul_1515, add_248);  mul_1515 = add_248 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/std_conv.py:133, code: return F.conv2d(x, weight, self.bias, self.stride, self.padding, self.dilation, self.groups)
    convolution_backward_80 = torch.ops.aten.convolution_backward.default(mul_1522, constant_pad_nd, view_2, [16], [2, 2], [0, 0], [1, 1], False, [0, 0], 1, [False, True, True]);  mul_1522 = constant_pad_nd = view_2 = None
    getitem_355: "f32[16, 3, 3, 3]" = convolution_backward_80[1]
    getitem_356: "f32[16]" = convolution_backward_80[2];  convolution_backward_80 = None
    ...
    sum_138: "f32[16]" = torch.ops.aten.sum.dim_IntList(view_342, [0, 2])
    ...
    sum_139: "f32[16]" = torch.ops.aten.sum.dim_IntList(mul_1523, [0, 2]);  mul_1523 = None
    mul_1524: "f32[16]" = torch.ops.aten.mul.Tensor(sum_138, 0.037037037037037035);  sum_138 = None
    ...
    mul_1525: "f32[16]" = torch.ops.aten.mul.Tensor(sum_139, 0.037037037037037035)
    ...
    mul_1531: "f32[16]" = torch.ops.aten.mul.Tensor(sum_139, squeeze_1);  sum_139 = squeeze_1 = None
    ...
    return pytree.tree_unflatten([addmm, view_344, mul_1532, getitem_356, view_341, mul_1514, getitem_353, view_338, mul_1496, getitem_350, view_335, mul_1478, getitem_347, view_332, mul_1459, getitem_344, view_329, mul_1449, getitem_341, view_326, mul_1431, getitem_338, view_323, mul_1413, getitem_335, view_320, mul_1395, getitem_332, sum_120, view_317, mul_1368, getitem_323, view_314, mul_1358, getitem_320, view_311, mul_1340, getitem_317, view_308, mul_1322, getitem_314, view_305, mul_1304, getitem_311, sum_108, view_302, mul_1277, getitem_302, view_299, mul_1259, getitem_299, view_296, mul_1241, getitem_296, view_293, mul_1223, getitem_293, sum_98, view_290, mul_1196, getitem_284, view_287, mul_1186, getitem_281, view_284, mul_1168, getitem_278, view_281, mul_1150, getitem_275, view_278, mul_1132, getitem_272, sum_86, view_275, mul_1105, getitem_263, view_272, mul_1087, getitem_260, view_269, mul_1069, getitem_257, view_266, mul_1051, getitem_254, sum_76, view_263, mul_1024, getitem_245, view_260, mul_1006, getitem_242, view_257, mul_988, getitem_239, view_254, mul_970, getitem_236, sum_66, view_251, mul_943, getitem_227, view_248, mul_925, getitem_224, view_245, mul_907, getitem_221, view_242, mul_889, getitem_218, sum_56, view_239, mul_862, getitem_209, view_236, mul_844, getitem_206, view_233, mul_826, getitem_203, view_230, mul_808, getitem_200, sum_46, view_227, mul_781, getitem_191, view_224, mul_763, getitem_188, view_221, mul_745, getitem_185, view_218, mul_727, getitem_182, sum_36, view_215, mul_700, getitem_173, view_212, mul_690, getitem_170, view_209, mul_672, getitem_167, view_206, mul_654, getitem_164, view_203, mul_636, getitem_161, sum_24, view_200, mul_609, getitem_152, view_197, mul_591, getitem_149, view_194, mul_573, getitem_146, view_191, mul_555, getitem_143, sum_14, view_188, mul_528, getitem_134, view_185, mul_510, getitem_131, view_182, mul_492, getitem_128, view_179, mul_474, getitem_125, sum_4, view_176, mul_456, getitem_116, getitem_328, getitem_329, getitem_325, getitem_326, getitem_307, getitem_308, getitem_304, getitem_305, getitem_289, getitem_290, getitem_286, getitem_287, getitem_268, getitem_269, getitem_265, getitem_266, getitem_250, getitem_251, getitem_247, getitem_248, getitem_232, getitem_233, getitem_229, getitem_230, getitem_214, getitem_215, getitem_211, getitem_212, getitem_196, getitem_197, getitem_193, getitem_194, getitem_178, getitem_179, getitem_175, getitem_176, getitem_157, getitem_158, getitem_154, getitem_155, getitem_139, getitem_140, getitem_136, getitem_137, getitem_121, getitem_122, getitem_118, getitem_119, permute_4, view_172, None], self._out_spec)
