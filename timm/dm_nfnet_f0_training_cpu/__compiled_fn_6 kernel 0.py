...
cpp_fused_convolution_backward_div_gelu_gelu_backward_mul_sum_1 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(const float* in_ptr0,
                       const float* in_ptr1,
                       const float* in_ptr2,
...
def call(args):
    ...
    assert_size_stride(constant_pad_nd, (8, 3, 193, 193), (111747, 1, 579, 3))
    assert_size_stride(squeeze_1, (16, ), (1, ))
    assert_size_stride(view_2, (16, 3, 3, 3), (27, 1, 9, 3))
    assert_size_stride(convolution, (8, 16, 96, 96), (147456, 1, 1536, 16))
    assert_size_stride(mul_6, (8, 16, 96, 96), (147456, 1, 1536, 16))
    ...
    assert_size_stride(mul_13, (8, 32, 96, 96), (294912, 1, 3072, 32))
    assert_size_stride(squeeze_5, (64, ), (1, ))
    assert_size_stride(view_8, (64, 32, 3, 3), (288, 1, 96, 32))
    assert_size_stride(convolution_2, (8, 64, 96, 96), (589824, 1, 6144, 64))
    assert_size_stride(constant_pad_nd_1, (8, 64, 97, 97), (602176, 1, 6208, 64))
    assert_size_stride(squeeze_7, (128, ), (1, ))
    assert_size_stride(view_11, (128, 64, 3, 3), (576, 1, 192, 64))
    assert_size_stride(convolution_3, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(mul_28, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(squeeze_9, (256, ), (1, ))
    assert_size_stride(view_14, (256, 128, 1, 1), (128, 1, 128, 128))
    assert_size_stride(convolution_4, (8, 256, 48, 48), (589824, 1, 12288, 256))
    assert_size_stride(squeeze_11, (128, ), (1, ))
    assert_size_stride(view_17, (128, 128, 1, 1), (128, 1, 128, 128))
    assert_size_stride(convolution_5, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(mul_38, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(squeeze_13, (128, ), (1, ))
    assert_size_stride(view_20, (128, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_6, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(mul_45, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(squeeze_15, (128, ), (1, ))
    assert_size_stride(view_23, (128, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_7, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(mul_52, (8, 128, 48, 48), (294912, 1, 6144, 128))
    assert_size_stride(squeeze_17, (256, ), (1, ))
    assert_size_stride(view_26, (256, 128, 1, 1), (128, 1, 128, 128))
    assert_size_stride(convolution_8, (8, 256, 48, 48), (589824, 1, 12288, 256))
    assert_size_stride(mean, (8, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(relu, (8, 128, 1, 1), (128, 1, 128, 128))
    assert_size_stride(convolution_10, (8, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(mul_64, (8, 256, 48, 48), (589824, 1, 12288, 256))
    assert_size_stride(avg_pool2d, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_19, (512, ), (1, ))
    assert_size_stride(view_29, (512, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_11, (8, 512, 24, 24), (294912, 1, 12288, 512))
    assert_size_stride(squeeze_21, (256, ), (1, ))
    assert_size_stride(view_32, (256, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_12, (8, 256, 48, 48), (589824, 1, 12288, 256))
    assert_size_stride(constant_pad_nd_2, (8, 256, 49, 49), (614656, 1, 12544, 256))
    assert_size_stride(squeeze_23, (256, ), (1, ))
    assert_size_stride(view_35, (256, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_13, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(mul_81, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_25, (256, ), (1, ))
    assert_size_stride(view_38, (256, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_14, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(mul_88, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_27, (512, ), (1, ))
    assert_size_stride(view_41, (512, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_15, (8, 512, 24, 24), (294912, 1, 12288, 512))
    assert_size_stride(mean_1, (8, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(relu_1, (8, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_17, (8, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(mul_100, (8, 512, 24, 24), (294912, 1, 12288, 512))
    assert_size_stride(squeeze_29, (256, ), (1, ))
    assert_size_stride(view_44, (256, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(convolution_18, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(mul_107, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_31, (256, ), (1, ))
    assert_size_stride(view_47, (256, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_19, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(mul_114, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_33, (256, ), (1, ))
    assert_size_stride(view_50, (256, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_20, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(mul_121, (8, 256, 24, 24), (147456, 1, 6144, 256))
    assert_size_stride(squeeze_35, (512, ), (1, ))
    assert_size_stride(view_53, (512, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_21, (8, 512, 24, 24), (294912, 1, 12288, 512))
    assert_size_stride(mean_2, (8, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(relu_2, (8, 256, 1, 1), (256, 1, 256, 256))
    assert_size_stride(convolution_23, (8, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(mul_133, (8, 512, 24, 24), (294912, 1, 12288, 512))
    assert_size_stride(avg_pool2d_1, (8, 512, 12, 12), (73728, 1, 6144, 512))
    assert_size_stride(squeeze_37, (1536, ), (1, ))
    assert_size_stride(view_56, (1536, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(convolution_24, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_39, (768, ), (1, ))
    assert_size_stride(view_59, (768, 512, 1, 1), (512, 1, 512, 512))
    assert_size_stride(convolution_25, (8, 768, 24, 24), (442368, 1, 18432, 768))
    assert_size_stride(constant_pad_nd_3, (8, 768, 25, 25), (480000, 1, 19200, 768))
    assert_size_stride(squeeze_41, (768, ), (1, ))
    assert_size_stride(view_62, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_26, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_150, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_43, (768, ), (1, ))
    assert_size_stride(view_65, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_27, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_157, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_45, (1536, ), (1, ))
    assert_size_stride(view_68, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_28, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_3, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_3, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_30, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_169, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_47, (768, ), (1, ))
    assert_size_stride(view_71, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_31, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_176, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_49, (768, ), (1, ))
    assert_size_stride(view_74, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_32, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_183, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_51, (768, ), (1, ))
    assert_size_stride(view_77, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_33, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_190, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_53, (1536, ), (1, ))
    assert_size_stride(view_80, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_34, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_4, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_4, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_36, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_202, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_55, (768, ), (1, ))
    assert_size_stride(view_83, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_37, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_209, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_57, (768, ), (1, ))
    assert_size_stride(view_86, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_38, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_216, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_59, (768, ), (1, ))
    assert_size_stride(view_89, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_39, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_223, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_61, (1536, ), (1, ))
    assert_size_stride(view_92, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_40, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_5, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_5, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_42, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_235, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_63, (768, ), (1, ))
    assert_size_stride(view_95, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_43, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_242, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_65, (768, ), (1, ))
    assert_size_stride(view_98, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_44, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_249, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_67, (768, ), (1, ))
    assert_size_stride(view_101, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_45, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_256, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_69, (1536, ), (1, ))
    assert_size_stride(view_104, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_46, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_6, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_6, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_48, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_268, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_71, (768, ), (1, ))
    assert_size_stride(view_107, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_49, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_275, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_73, (768, ), (1, ))
    assert_size_stride(view_110, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_50, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_282, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_75, (768, ), (1, ))
    assert_size_stride(view_113, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_51, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_289, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_77, (1536, ), (1, ))
    assert_size_stride(view_116, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_52, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_7, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_7, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_54, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_301, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(squeeze_79, (768, ), (1, ))
    assert_size_stride(view_119, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_55, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_308, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_81, (768, ), (1, ))
    assert_size_stride(view_122, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_56, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_315, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_83, (768, ), (1, ))
    assert_size_stride(view_125, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_57, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(mul_322, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(squeeze_85, (1536, ), (1, ))
    assert_size_stride(view_128, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_58, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(mean_8, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_8, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_60, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_334, (8, 1536, 12, 12), (221184, 1, 18432, 1536))
    assert_size_stride(avg_pool2d_2, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(squeeze_87, (1536, ), (1, ))
    assert_size_stride(view_131, (1536, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_61, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(squeeze_89, (768, ), (1, ))
    assert_size_stride(view_134, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_62, (8, 768, 12, 12), (110592, 1, 9216, 768))
    assert_size_stride(constant_pad_nd_4, (8, 768, 13, 13), (129792, 1, 9984, 768))
    assert_size_stride(squeeze_91, (768, ), (1, ))
    assert_size_stride(view_137, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_63, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_351, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_93, (768, ), (1, ))
    assert_size_stride(view_140, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_64, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_358, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_95, (1536, ), (1, ))
    assert_size_stride(view_143, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_65, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(mean_9, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_9, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_67, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_370, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(squeeze_97, (768, ), (1, ))
    assert_size_stride(view_146, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_68, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_377, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_99, (768, ), (1, ))
    assert_size_stride(view_149, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_69, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_384, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_101, (768, ), (1, ))
    assert_size_stride(view_152, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_70, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_391, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_103, (1536, ), (1, ))
    assert_size_stride(view_155, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_71, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(mean_10, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_10, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_73, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(mul_403, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(squeeze_105, (768, ), (1, ))
    assert_size_stride(view_158, (768, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_74, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_410, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_107, (768, ), (1, ))
    assert_size_stride(view_161, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_75, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_417, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_109, (768, ), (1, ))
    assert_size_stride(view_164, (768, 128, 3, 3), (1152, 1, 384, 128))
    assert_size_stride(convolution_76, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(mul_424, (8, 768, 6, 6), (27648, 1, 4608, 768))
    assert_size_stride(squeeze_111, (1536, ), (1, ))
    assert_size_stride(view_167, (1536, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_77, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(mean_11, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(relu_11, (8, 768, 1, 1), (768, 1, 768, 768))
    assert_size_stride(convolution_79, (8, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(add_118, (8, 1536, 6, 6), (55296, 1, 9216, 1536))
    assert_size_stride(squeeze_113, (3072, ), (1, ))
    assert_size_stride(view_170, (3072, 1536, 1, 1), (1536, 1, 1536, 1536))
    assert_size_stride(convolution_80, (8, 3072, 6, 6), (110592, 1, 18432, 3072))
    ...
    buf0 = empty_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    buf1 = empty_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf2 = empty_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf3 = empty_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf221 = empty_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf319 = empty_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf4 = empty_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    buf5 = empty((8, 3072), device='cpu', dtype=torch.float32)
    ...
    buf8 = empty((8, 3072, 6, 6), device='cpu', dtype=torch.float32)
    cpp_fused_convolution_backward_div_gelu_gelu_backward_mul_sum_1(c_void_p(tangents_1.data_ptr()), c_void_p(buf5.data_ptr()), c_void_p(convolution_80.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf8.data_ptr()))
    del buf5
    del convolution_80
    del tangents_1
    ...
    buf18 = empty_strided((8, 1536, 1, 1), (1536, 1, 12288, 12288), device='cpu', dtype=torch.float32)
    buf19 = reinterpret_tensor(buf18, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf18  # reuse
    ...
    buf28 = buf25[2]
    del buf25
    buf29 = empty_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    buf46 = reinterpret_tensor(buf8, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf8  # reuse
    ...
    buf67 = reinterpret_tensor(buf26, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf26  # reuse
    buf68 = reinterpret_tensor(buf67, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf67  # reuse
    ...
    buf117 = reinterpret_tensor(buf75, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf75  # reuse
    buf118 = reinterpret_tensor(buf117, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf117  # reuse
    ...
    buf155 = empty_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    buf174 = reinterpret_tensor(buf125, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf125  # reuse
    buf175 = reinterpret_tensor(buf174, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf174  # reuse
    ...
    buf202 = reinterpret_tensor(buf212, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf212  # reuse
    ...
    buf223 = reinterpret_tensor(buf182, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf182  # reuse
    buf224 = reinterpret_tensor(buf223, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf223  # reuse
    ...
    buf233 = buf230[2]
    del buf230
    buf234 = buf185; del buf185  # reuse
    ...
    buf251 = reinterpret_tensor(buf243, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf243  # reuse
    ...
    buf260 = reinterpret_tensor(buf252, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf252  # reuse
    ...
    buf272 = reinterpret_tensor(buf231, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf231  # reuse
    buf273 = reinterpret_tensor(buf272, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf272  # reuse
    ...
    buf300 = reinterpret_tensor(buf310, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf310  # reuse
    ...
    buf321 = reinterpret_tensor(buf280, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf280  # reuse
    buf322 = reinterpret_tensor(buf321, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf321  # reuse
    ...
    buf331 = buf328[2]
    del buf328
    buf332 = buf283; del buf283  # reuse
    ...
    buf349 = reinterpret_tensor(buf341, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf341  # reuse
    ...
    buf358 = reinterpret_tensor(buf350, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf350  # reuse
    ...
    buf370 = reinterpret_tensor(buf329, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf329  # reuse
    buf371 = reinterpret_tensor(buf370, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf370  # reuse
    ...
    buf398 = reinterpret_tensor(buf390, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf390  # reuse
    ...
    buf407 = reinterpret_tensor(buf399, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf399  # reuse
    ...
    buf420 = reinterpret_tensor(buf378, (8, 1536, 1, 1), (1536, 1, 12288, 12288), 0); del buf378  # reuse
    buf421 = reinterpret_tensor(buf420, (8, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf420  # reuse
    ...
    buf448 = reinterpret_tensor(buf440, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf440  # reuse
    ...
    buf457 = reinterpret_tensor(buf449, (768, 128, 3, 3), (1152, 9, 3, 1), 0); del buf449  # reuse
    buf458 = empty_strided((8, 768, 24, 24), (442368, 1, 18432, 768), device='cpu', dtype=torch.float32)
    ...
    buf477 = empty_strided((8, 512, 1, 1), (512, 1, 4096, 4096), device='cpu', dtype=torch.float32)
    buf478 = reinterpret_tensor(buf477, (8, 512, 1, 1), (512, 1, 1, 1), 0); del buf477  # reuse
    ...
    buf505 = empty((256, 128, 3, 3), device='cpu', dtype=torch.float32)
    ...
    buf527 = reinterpret_tensor(buf485, (8, 512, 1, 1), (512, 1, 4096, 4096), 0); del buf485  # reuse
    buf528 = reinterpret_tensor(buf527, (8, 512, 1, 1), (512, 1, 1, 1), 0); del buf527  # reuse
    ...
    buf565 = empty_strided((8, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    ...
    buf585 = reinterpret_tensor(buf533, (8, 256, 1, 1), (256, 1, 2048, 2048), 0); del buf533  # reuse
    buf586 = reinterpret_tensor(buf585, (8, 256, 1, 1), (256, 1, 1, 1), 0); del buf585  # reuse
    ...
    buf649 = reinterpret_tensor(buf583, (8, 64, 96, 96), (589824, 1, 6144, 64), 0); del buf583  # reuse
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    constant_pad_nd = rand_strided((8, 3, 193, 193), (111747, 1, 579, 3), device='cpu', dtype=torch.float32)
    ...
    convolution = rand_strided((8, 16, 96, 96), (147456, 1, 1536, 16), device='cpu', dtype=torch.float32)
    mul_6 = rand_strided((8, 16, 96, 96), (147456, 1, 1536, 16), device='cpu', dtype=torch.float32)
    ...
    mul_13 = rand_strided((8, 32, 96, 96), (294912, 1, 3072, 32), device='cpu', dtype=torch.float32)
    ...
    convolution_2 = rand_strided((8, 64, 96, 96), (589824, 1, 6144, 64), device='cpu', dtype=torch.float32)
    constant_pad_nd_1 = rand_strided((8, 64, 97, 97), (602176, 1, 6208, 64), device='cpu', dtype=torch.float32)
    ...
    convolution_3 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    mul_28 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    convolution_4 = rand_strided((8, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_5 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    mul_38 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    convolution_6 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    mul_45 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    convolution_7 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    mul_52 = rand_strided((8, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    convolution_8 = rand_strided((8, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    mean = rand_strided((8, 256, 1, 1), (256, 1, 256, 256), device='cpu', dtype=torch.float32)
    relu = rand_strided((8, 128, 1, 1), (128, 1, 128, 128), device='cpu', dtype=torch.float32)
    convolution_10 = rand_strided((8, 256, 1, 1), (256, 1, 256, 256), device='cpu', dtype=torch.float32)
    mul_64 = rand_strided((8, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    avg_pool2d = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_11 = rand_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    ...
    convolution_12 = rand_strided((8, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    constant_pad_nd_2 = rand_strided((8, 256, 49, 49), (614656, 1, 12544, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_13 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    mul_81 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_14 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    mul_88 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_15 = rand_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    mean_1 = rand_strided((8, 512, 1, 1), (512, 1, 512, 512), device='cpu', dtype=torch.float32)
    relu_1 = rand_strided((8, 256, 1, 1), (256, 1, 256, 256), device='cpu', dtype=torch.float32)
    convolution_17 = rand_strided((8, 512, 1, 1), (512, 1, 512, 512), device='cpu', dtype=torch.float32)
    mul_100 = rand_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    ...
    convolution_18 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    mul_107 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_19 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    mul_114 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_20 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    mul_121 = rand_strided((8, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    convolution_21 = rand_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    mean_2 = rand_strided((8, 512, 1, 1), (512, 1, 512, 512), device='cpu', dtype=torch.float32)
    relu_2 = rand_strided((8, 256, 1, 1), (256, 1, 256, 256), device='cpu', dtype=torch.float32)
    convolution_23 = rand_strided((8, 512, 1, 1), (512, 1, 512, 512), device='cpu', dtype=torch.float32)
    mul_133 = rand_strided((8, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    avg_pool2d_1 = rand_strided((8, 512, 12, 12), (73728, 1, 6144, 512), device='cpu', dtype=torch.float32)
    ...
    convolution_24 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_25 = rand_strided((8, 768, 24, 24), (442368, 1, 18432, 768), device='cpu', dtype=torch.float32)
    constant_pad_nd_3 = rand_strided((8, 768, 25, 25), (480000, 1, 19200, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_26 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_150 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_27 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_157 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_28 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_3 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_3 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_30 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_169 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_31 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_176 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_32 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_183 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_33 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_190 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_34 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_4 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_4 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_36 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_202 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_37 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_209 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_38 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_216 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_39 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_223 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_40 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_5 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_5 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_42 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_235 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_43 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_242 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_44 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_249 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_45 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_256 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_46 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_6 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_6 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_48 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_268 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_49 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_275 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_50 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_282 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_51 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_289 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_52 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_7 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_7 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_54 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_301 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_55 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_308 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_56 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_315 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_57 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    mul_322 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_58 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    mean_8 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_8 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_60 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_334 = rand_strided((8, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    avg_pool2d_2 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_61 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_62 = rand_strided((8, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    constant_pad_nd_4 = rand_strided((8, 768, 13, 13), (129792, 1, 9984, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_63 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_351 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_64 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_358 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_65 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    mean_9 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_9 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_67 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_370 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_68 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_377 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_69 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_384 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_70 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_391 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_71 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    mean_10 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_10 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_73 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    mul_403 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_74 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_410 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_75 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_417 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_76 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    mul_424 = rand_strided((8, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    convolution_77 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    mean_11 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    relu_11 = rand_strided((8, 768, 1, 1), (768, 1, 768, 768), device='cpu', dtype=torch.float32)
    convolution_79 = rand_strided((8, 1536, 1, 1), (1536, 1, 1536, 1536), device='cpu', dtype=torch.float32)
    add_118 = rand_strided((8, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    convolution_80 = rand_strided((8, 3072, 6, 6), (110592, 1, 18432, 3072), device='cpu', dtype=torch.float32)
    clone_12 = rand_strided((8, 3072), (3072, 1), device='cpu', dtype=torch.float32)
