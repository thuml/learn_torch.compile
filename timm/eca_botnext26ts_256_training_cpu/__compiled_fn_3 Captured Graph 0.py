...
def forward(self, L_cloned_inputs_0_ : torch.Tensor):
    ...
    split = torch.functional.split(x_153, [64, 64, 256], dim = 1);  x_153 = None
    q = split[0]
    k = split[1]
    ...
    reshape = q.reshape(32, 16, -1);  q = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/norm_act.py:118, code: x = F.batch_norm(
    x_168 = torch.nn.functional.batch_norm(x_167, getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_running_mean, getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_running_var, getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_weight, getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_bias, True, 0.1, 1e-05);  x_167 = getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_running_mean = getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_running_var = getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_weight = getattr_getattr_l__mod___stages___2_____1___conv3_1x1_bn_bias = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:144, code: q, k, v = torch.split(x, [self.dim_out_qk, self.dim_out_qk, self.dim_out_v], dim=1)
    split_1 = torch.functional.split(x_182, [64, 64, 512], dim = 1);  x_182 = None
    q_4 = split_1[0]
    k_2 = split_1[1]
    v_2 = split_1[2];  split_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:145, code: q = q.reshape(B * self.num_heads, self.dim_head_qk, -1).transpose(-1, -2)
    reshape_12 = q_4.reshape(32, 16, -1);  q_4 = None
    q_5 = reshape_12.transpose(-1, -2);  reshape_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:146, code: k = k.reshape(B * self.num_heads, self.dim_head_qk, -1)  # no transpose, for q @ k
    k_3 = k_2.reshape(32, 16, -1);  k_2 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:144, code: q, k, v = torch.split(x, [self.dim_out_qk, self.dim_out_qk, self.dim_out_v], dim=1)
    split_2 = torch.functional.split(x_216, [64, 64, 512], dim = 1);  x_216 = None
    q_8 = split_2[0]
    k_4 = split_2[1]
    v_4 = split_2[2];  split_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:145, code: q = q.reshape(B * self.num_heads, self.dim_head_qk, -1).transpose(-1, -2)
    reshape_24 = q_8.reshape(32, 16, -1);  q_8 = None
    q_9 = reshape_24.transpose(-1, -2);  reshape_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/bottleneck_attn.py:146, code: k = k.reshape(B * self.num_heads, self.dim_head_qk, -1)  # no transpose, for q @ k
    k_5 = k_4.reshape(32, 16, -1);  k_4 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/norm_act.py:118, code: x = F.batch_norm(
    x_226 = torch.nn.functional.batch_norm(x_225, getattr_getattr_l__mod___stages___3_____1___post_attn_running_mean, getattr_getattr_l__mod___stages___3_____1___post_attn_running_var, getattr_getattr_l__mod___stages___3_____1___post_attn_weight, getattr_getattr_l__mod___stages___3_____1___post_attn_bias, True, 0.1, 1e-05);  x_225 = getattr_getattr_l__mod___stages___3_____1___post_attn_running_mean = getattr_getattr_l__mod___stages___3_____1___post_attn_running_var = getattr_getattr_l__mod___stages___3_____1___post_attn_weight = getattr_getattr_l__mod___stages___3_____1___post_attn_bias = None
    ...
    pred = self.L__mod___head_flatten(x_245);  x_245 = None
    return (pred,)
