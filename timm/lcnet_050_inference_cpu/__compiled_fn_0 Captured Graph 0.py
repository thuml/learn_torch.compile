...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    x_156 = torch._C._nn.linear(x_155, l__mod___classifier_weight, l__mod___classifier_bias);  x_155 = l__mod___classifier_weight = l__mod___classifier_bias = None
    return (x_156,)
