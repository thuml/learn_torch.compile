...
def forward(self, primals, tangents):
    ...
    sum_6: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_461, [2, 3], True);  mul_461 = None
    ...
    mul_464: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_6, mul_463);  sum_6 = mul_463 = None
    ...
    sum_22: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_542, [2, 3], True);  mul_542 = None
    ...
    mul_545: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_22, mul_544);  sum_22 = mul_544 = None
    ...
    sum_38: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_623, [2, 3], True);  mul_623 = None
    ...
    mul_626: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_38, mul_625);  sum_38 = mul_625 = None
    ...
    sum_57: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_714, [2, 3], True);  mul_714 = None
    ...
    mul_717: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_57, mul_716);  sum_57 = mul_716 = None
    ...
    sum_73: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_795, [2, 3], True);  mul_795 = None
    ...
    mul_798: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_73, mul_797);  sum_73 = mul_797 = None
    ...
    sum_89: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_876, [2, 3], True);  mul_876 = None
    ...
    mul_879: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_89, mul_878);  sum_89 = mul_878 = None
    ...
    sum_105: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_957, [2, 3], True);  mul_957 = None
    ...
    mul_960: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_105, mul_959);  sum_105 = mul_959 = None
    ...
    sum_121: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1038, [2, 3], True);  mul_1038 = None
    ...
    mul_1041: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_121, mul_1040);  sum_121 = mul_1040 = None
    ...
    sum_137: "f32[8, 1536, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1119, [2, 3], True);  mul_1119 = None
    ...
    mul_1122: "f32[8, 1536, 1, 1]" = torch.ops.aten.mul.Tensor(sum_137, mul_1121);  sum_137 = mul_1121 = None
    ...
    sum_156: "f32[8, 512, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1210, [2, 3], True);  mul_1210 = None
    ...
    mul_1213: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(sum_156, mul_1212);  sum_156 = mul_1212 = None
    ...
    sum_172: "f32[8, 512, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1291, [2, 3], True);  mul_1291 = None
    ...
    mul_1294: "f32[8, 512, 1, 1]" = torch.ops.aten.mul.Tensor(sum_172, mul_1293);  sum_172 = mul_1293 = None
    ...
    sum_191: "f32[8, 256, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_1382, [2, 3], True);  mul_1382 = None
    ...
    mul_1385: "f32[8, 256, 1, 1]" = torch.ops.aten.mul.Tensor(sum_191, mul_1384);  sum_191 = mul_1384 = None
