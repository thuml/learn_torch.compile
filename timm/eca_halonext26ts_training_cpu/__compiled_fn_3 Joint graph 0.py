...
def forward(self, primals, tangents):
    ...
    full: "f32[8, 2048, 8, 8]" = torch.ops.aten.full.default([8, 2048, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_1: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_2: "f32[512, 8, 23]" = torch.ops.aten.full.default([512, 8, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_3: "f32[512, 9, 23]" = torch.ops.aten.full.default([512, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    slice_scatter_1: "f32[512, 9, 23]" = torch.ops.aten.slice_scatter.default(full_3, slice_scatter, 1, 0, 8);  full_3 = slice_scatter = None
    full_4: "f32[512, 9, 23]" = torch.ops.aten.full.default([512, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_5: "f32[512, 8, 23]" = torch.ops.aten.full.default([512, 8, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_6: "f32[512, 9, 23]" = torch.ops.aten.full.default([512, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_7: "f32[512, 9, 23]" = torch.ops.aten.full.default([512, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_8: "f32[8, 640, 1, 12, 12]" = torch.ops.aten.full.default([8, 640, 1, 12, 12], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    iota_1: "i32[12]" = torch.ops.prims.iota.default(12, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
    ...
    full_9: "f32[8, 640, 12, 12]" = torch.ops.aten.full.default([8, 640, 12, 12], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_10: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_11: "f32[8, 2048, 8, 8]" = torch.ops.aten.full.default([8, 2048, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_12: "f32[8, 512, 8, 8]" = torch.ops.aten.full.default([8, 512, 8, 8], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_13: "f32[1024, 4, 23]" = torch.ops.aten.full.default([1024, 4, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_14: "f32[1024, 5, 23]" = torch.ops.aten.full.default([1024, 5, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_15: "f32[1024, 5, 23]" = torch.ops.aten.full.default([1024, 5, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_16: "f32[1024, 4, 23]" = torch.ops.aten.full.default([1024, 4, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_17: "f32[1024, 5, 23]" = torch.ops.aten.full.default([1024, 5, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_18: "f32[1024, 5, 23]" = torch.ops.aten.full.default([1024, 5, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_19: "f32[8, 640, 2, 20, 12]" = torch.ops.aten.full.default([8, 640, 2, 20, 12], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    iota_3: "i32[20]" = torch.ops.prims.iota.default(20, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
    ...
    full_20: "f32[8, 640, 20, 20]" = torch.ops.aten.full.default([8, 640, 20, 20], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_21: "f32[8, 512, 16, 16]" = torch.ops.aten.full.default([8, 512, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_22: "f32[8, 1024, 16, 16]" = torch.ops.aten.full.default([8, 1024, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_23: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_24: "f32[2048, 8, 23]" = torch.ops.aten.full.default([2048, 8, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_25: "f32[2048, 9, 23]" = torch.ops.aten.full.default([2048, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_26: "f32[2048, 9, 23]" = torch.ops.aten.full.default([2048, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/layers/halo_attn.py:54, code: x = x_pad[:, :W, win_size - 1:]
    full_27: "f32[2048, 8, 23]" = torch.ops.aten.full.default([2048, 8, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_28: "f32[2048, 9, 23]" = torch.ops.aten.full.default([2048, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_29: "f32[2048, 9, 23]" = torch.ops.aten.full.default([2048, 9, 23], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    iota_4: "i32[20]" = torch.ops.prims.iota.default(20, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
    ...
    full_30: "f32[8, 384, 2, 20, 12]" = torch.ops.aten.full.default([8, 384, 2, 20, 12], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    iota_5: "i32[20]" = torch.ops.prims.iota.default(20, start = 0, step = 1, dtype = torch.int32, device = device(type='cpu'), requires_grad = False)
    ...
    full_31: "f32[8, 384, 20, 20]" = torch.ops.aten.full.default([8, 384, 20, 20], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_33: "f32[8, 1024, 16, 16]" = torch.ops.aten.full.default([8, 1024, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_34: "f32[8, 256, 16, 16]" = torch.ops.aten.full.default([8, 256, 16, 16], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_35: "f32[8, 256, 32, 32]" = torch.ops.aten.full.default([8, 256, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_36: "f32[8, 512, 32, 32]" = torch.ops.aten.full.default([8, 512, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_37: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_38: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_39: "f32[8, 512, 32, 32]" = torch.ops.aten.full.default([8, 512, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_40: "f32[8, 128, 32, 32]" = torch.ops.aten.full.default([8, 128, 32, 32], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_41: "f32[8, 128, 64, 64]" = torch.ops.aten.full.default([8, 128, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_42: "f32[8, 256, 64, 64]" = torch.ops.aten.full.default([8, 256, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_43: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_44: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_45: "f32[8, 256, 64, 64]" = torch.ops.aten.full.default([8, 256, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_46: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_47: "f32[8, 64, 64, 64]" = torch.ops.aten.full.default([8, 64, 64, 64], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_48: "f32[8, 64, 128, 128]" = torch.ops.aten.full.default([8, 64, 128, 128], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_49: "f32[8, 32, 128, 128]" = torch.ops.aten.full.default([8, 32, 128, 128], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_50: "f32[8, 24, 128, 128]" = torch.ops.aten.full.default([8, 24, 128, 128], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
