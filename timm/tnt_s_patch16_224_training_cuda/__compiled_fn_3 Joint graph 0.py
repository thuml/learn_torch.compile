...
def forward(self, primals, tangents):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:328, code: x = x[:, 1:].mean(dim=1) if self.global_pool == 'avg' else x[:, 0]
    full: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    select_scatter: "f32[8, 197, 384]" = torch.ops.aten.select_scatter.default(full, mm_48, 1, 0);  full = mm_48 = None
    full_1: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_2: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_3: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_4: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_11: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_18: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_23: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_24: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_23: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_24, slice_62, 1, 0, 1);  full_24 = slice_62 = None
    full_25: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_26: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_27: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_28: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_27: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_28, slice_64, 1, 0, 1);  full_28 = slice_64 = None
    full_29: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_30: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_31: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_32: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_31: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_32, slice_66, 1, 0, 1);  full_32 = slice_66 = None
    full_33: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_34: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_35: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_36: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_35: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_36, slice_68, 1, 0, 1);  full_36 = slice_68 = None
    full_37: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_38: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_39: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_40: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_39: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_40, slice_70, 1, 0, 1);  full_40 = slice_70 = None
    full_41: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_42: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_43: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_44: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_43: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_44, slice_72, 1, 0, 1);  full_44 = slice_72 = None
    full_45: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/tnt.py:149, code: [patch_embed[:, 0:1], patch_embed[:, 1:] + self.proj(self.norm1_proj(pixel_embed).reshape(B, N - 1, -1))],
    full_46: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_47: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_48: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_47: "f32[8, 197, 384]" = torch.ops.aten.slice_scatter.default(full_48, slice_74, 1, 0, 1);  full_48 = slice_74 = None
    full_49: "f32[8, 197, 384]" = torch.ops.aten.full.default([8, 197, 384], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_50: "f32[8, 24, 56, 56]" = torch.ops.aten.full.default([8, 24, 56, 56], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
