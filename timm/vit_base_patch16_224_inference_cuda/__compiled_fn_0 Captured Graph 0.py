...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    reshape = getattr_l__mod___blocks___0___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___0___attn_qkv = None
    ...
    x_10 = transpose_1.reshape(8, 197, 768);  transpose_1 = None
    ...
    reshape_2 = getattr_l__mod___blocks___1___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___1___attn_qkv = None
    ...
    x_22 = transpose_2.reshape(8, 197, 768);  transpose_2 = None
    ...
    reshape_4 = getattr_l__mod___blocks___2___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___2___attn_qkv = None
    ...
    x_34 = transpose_3.reshape(8, 197, 768);  transpose_3 = None
    ...
    reshape_6 = getattr_l__mod___blocks___3___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___3___attn_qkv = None
    ...
    x_46 = transpose_4.reshape(8, 197, 768);  transpose_4 = None
    ...
    reshape_8 = getattr_l__mod___blocks___4___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___4___attn_qkv = None
    ...
    x_58 = transpose_5.reshape(8, 197, 768);  transpose_5 = None
    ...
    reshape_10 = getattr_l__mod___blocks___5___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___5___attn_qkv = None
    ...
    x_70 = transpose_6.reshape(8, 197, 768);  transpose_6 = None
    ...
    reshape_12 = getattr_l__mod___blocks___6___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___6___attn_qkv = None
    ...
    x_82 = transpose_7.reshape(8, 197, 768);  transpose_7 = None
    ...
    reshape_14 = getattr_l__mod___blocks___7___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___7___attn_qkv = None
    ...
    x_94 = transpose_8.reshape(8, 197, 768);  transpose_8 = None
    ...
    reshape_16 = getattr_l__mod___blocks___8___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___8___attn_qkv = None
    ...
    x_106 = transpose_9.reshape(8, 197, 768);  transpose_9 = None
    ...
    reshape_18 = getattr_l__mod___blocks___9___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___9___attn_qkv = None
    ...
    x_118 = transpose_10.reshape(8, 197, 768);  transpose_10 = None
    ...
    reshape_20 = getattr_l__mod___blocks___10___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___10___attn_qkv = None
    ...
    x_130 = transpose_11.reshape(8, 197, 768);  transpose_11 = None
    ...
    reshape_22 = getattr_l__mod___blocks___11___attn_qkv.reshape(8, 197, 3, 12, 64);  getattr_l__mod___blocks___11___attn_qkv = None
    ...
    x_142 = transpose_12.reshape(8, 197, 768);  transpose_12 = None
