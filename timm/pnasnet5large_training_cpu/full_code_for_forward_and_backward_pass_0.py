...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 26984176)) \
        and (___check_obj_id(L['___stack0'], 26057664)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 142668704)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(139966357666496))) \
        and (___compile_config_hash() == 'bec9fa8a64bc73f6fa1b3b4164f837fa') \
