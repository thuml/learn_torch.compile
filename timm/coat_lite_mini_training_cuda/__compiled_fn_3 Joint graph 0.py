...
def forward(self, primals, tangents):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:660, code: x = x_feat[:, 1:].mean(dim=1) if self.global_pool == 'avg' else x_feat[:, 0]
    full: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    select_scatter: "f32[8, 50, 512]" = torch.ops.aten.select_scatter.default(full, mm, 1, 0);  full = mm = None
    full_1: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_2: "f32[8, 8, 49, 64]" = torch.ops.aten.full.default([8, 8, 49, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_3: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_4: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_5: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_6: "f32[8, 8, 49, 64]" = torch.ops.aten.full.default([8, 8, 49, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_7: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_8: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_9: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_190: "f32[1536]" = torch.ops.aten.view.default(sum_25, [1536]);  sum_25 = None
    ...
    mul_112: "f32[8, 50, 512]" = torch.ops.aten.mul.Tensor(mul_108, sum_27);  sum_27 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_10: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_11: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_12: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_11: "f32[8, 50, 512]" = torch.ops.aten.slice_scatter.default(full_12, slice_113, 1, 0, 1);  full_12 = slice_113 = None
    full_13: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_195: "f32[512]" = torch.ops.aten.view.default(sum_31, [512]);  sum_31 = None
    ...
    view_198: "f32[2048]" = torch.ops.aten.view.default(sum_32, [2048]);  sum_32 = None
    ...
    mul_126: "f32[8, 50, 512]" = torch.ops.aten.mul.Tensor(mul_122, sum_34);  sum_34 = None
    ...
    view_201: "f32[512]" = torch.ops.aten.view.default(sum_37, [512]);  sum_37 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_14: "f32[8, 8, 49, 64]" = torch.ops.aten.full.default([8, 8, 49, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_15: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_16: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_17: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_18: "f32[8, 8, 49, 64]" = torch.ops.aten.full.default([8, 8, 49, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_19: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_20: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_21: "f32[8, 8, 50, 64]" = torch.ops.aten.full.default([8, 8, 50, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_215: "f32[1536]" = torch.ops.aten.view.default(sum_42, [1536]);  sum_42 = None
    ...
    mul_138: "f32[8, 50, 512]" = torch.ops.aten.mul.Tensor(mul_134, sum_44);  sum_44 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_22: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_23: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_24: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_23: "f32[8, 50, 512]" = torch.ops.aten.slice_scatter.default(full_24, slice_118, 1, 0, 1);  full_24 = slice_118 = None
    full_25: "f32[8, 50, 512]" = torch.ops.aten.full.default([8, 50, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    mul_145: "f32[8, 49, 512]" = torch.ops.aten.mul.Tensor(mul_141, sum_50);  sum_50 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:684, code: return x[:, 1:, :]
    full_26: "f32[8, 196, 320]" = torch.ops.aten.full.default([8, 196, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_27: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_28: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_222: "f32[320]" = torch.ops.aten.view.default(sum_54, [320]);  sum_54 = None
    ...
    view_225: "f32[1280]" = torch.ops.aten.view.default(sum_55, [1280]);  sum_55 = None
    ...
    mul_159: "f32[8, 197, 320]" = torch.ops.aten.mul.Tensor(mul_155, sum_57);  sum_57 = None
    ...
    view_228: "f32[320]" = torch.ops.aten.view.default(sum_60, [320]);  sum_60 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_29: "f32[8, 8, 196, 40]" = torch.ops.aten.full.default([8, 8, 196, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_30: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_31: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_32: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_33: "f32[8, 8, 196, 40]" = torch.ops.aten.full.default([8, 8, 196, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_34: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_35: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_36: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_242: "f32[960]" = torch.ops.aten.view.default(sum_65, [960]);  sum_65 = None
    ...
    mul_171: "f32[8, 197, 320]" = torch.ops.aten.mul.Tensor(mul_167, sum_67);  sum_67 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_37: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_38: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_39: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_38: "f32[8, 197, 320]" = torch.ops.aten.slice_scatter.default(full_39, slice_125, 1, 0, 1);  full_39 = slice_125 = None
    full_40: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_247: "f32[320]" = torch.ops.aten.view.default(sum_71, [320]);  sum_71 = None
    ...
    view_250: "f32[1280]" = torch.ops.aten.view.default(sum_72, [1280]);  sum_72 = None
    ...
    mul_185: "f32[8, 197, 320]" = torch.ops.aten.mul.Tensor(mul_181, sum_74);  sum_74 = None
    ...
    view_253: "f32[320]" = torch.ops.aten.view.default(sum_77, [320]);  sum_77 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_41: "f32[8, 8, 196, 40]" = torch.ops.aten.full.default([8, 8, 196, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_42: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_43: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_44: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_45: "f32[8, 8, 196, 40]" = torch.ops.aten.full.default([8, 8, 196, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_46: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_47: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_48: "f32[8, 8, 197, 40]" = torch.ops.aten.full.default([8, 8, 197, 40], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_267: "f32[960]" = torch.ops.aten.view.default(sum_82, [960]);  sum_82 = None
    ...
    mul_197: "f32[8, 197, 320]" = torch.ops.aten.mul.Tensor(mul_193, sum_84);  sum_84 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_49: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_50: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_51: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_50: "f32[8, 197, 320]" = torch.ops.aten.slice_scatter.default(full_51, slice_130, 1, 0, 1);  full_51 = slice_130 = None
    full_52: "f32[8, 197, 320]" = torch.ops.aten.full.default([8, 197, 320], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    mul_204: "f32[8, 196, 320]" = torch.ops.aten.mul.Tensor(mul_200, sum_90);  sum_90 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:684, code: return x[:, 1:, :]
    full_53: "f32[8, 784, 128]" = torch.ops.aten.full.default([8, 784, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_54: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_55: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_274: "f32[128]" = torch.ops.aten.view.default(sum_94, [128]);  sum_94 = None
    ...
    view_277: "f32[1024]" = torch.ops.aten.view.default(sum_95, [1024]);  sum_95 = None
    ...
    mul_218: "f32[8, 785, 128]" = torch.ops.aten.mul.Tensor(mul_214, sum_97);  sum_97 = None
    ...
    view_280: "f32[128]" = torch.ops.aten.view.default(sum_100, [128]);  sum_100 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_56: "f32[8, 8, 784, 16]" = torch.ops.aten.full.default([8, 8, 784, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_57: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_58: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_59: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_60: "f32[8, 8, 784, 16]" = torch.ops.aten.full.default([8, 8, 784, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_61: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_62: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_63: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_294: "f32[384]" = torch.ops.aten.view.default(sum_105, [384]);  sum_105 = None
    ...
    mul_230: "f32[8, 785, 128]" = torch.ops.aten.mul.Tensor(mul_226, sum_107);  sum_107 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_64: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_65: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_66: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_65: "f32[8, 785, 128]" = torch.ops.aten.slice_scatter.default(full_66, slice_137, 1, 0, 1);  full_66 = slice_137 = None
    full_67: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_299: "f32[128]" = torch.ops.aten.view.default(sum_111, [128]);  sum_111 = None
    ...
    view_302: "f32[1024]" = torch.ops.aten.view.default(sum_112, [1024]);  sum_112 = None
    ...
    mul_244: "f32[8, 785, 128]" = torch.ops.aten.mul.Tensor(mul_240, sum_114);  sum_114 = None
    ...
    view_305: "f32[128]" = torch.ops.aten.view.default(sum_117, [128]);  sum_117 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_68: "f32[8, 8, 784, 16]" = torch.ops.aten.full.default([8, 8, 784, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_69: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_70: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_71: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_72: "f32[8, 8, 784, 16]" = torch.ops.aten.full.default([8, 8, 784, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_73: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_74: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_75: "f32[8, 8, 785, 16]" = torch.ops.aten.full.default([8, 8, 785, 16], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_319: "f32[384]" = torch.ops.aten.view.default(sum_122, [384]);  sum_122 = None
    ...
    mul_256: "f32[8, 785, 128]" = torch.ops.aten.mul.Tensor(mul_252, sum_124);  sum_124 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_76: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_77: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_78: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_77: "f32[8, 785, 128]" = torch.ops.aten.slice_scatter.default(full_78, slice_142, 1, 0, 1);  full_78 = slice_142 = None
    full_79: "f32[8, 785, 128]" = torch.ops.aten.full.default([8, 785, 128], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    mul_263: "f32[8, 784, 128]" = torch.ops.aten.mul.Tensor(mul_259, sum_130);  sum_130 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:684, code: return x[:, 1:, :]
    full_80: "f32[8, 3136, 64]" = torch.ops.aten.full.default([8, 3136, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_81: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_82: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_326: "f32[64]" = torch.ops.aten.view.default(sum_134, [64]);  sum_134 = None
    ...
    view_329: "f32[512]" = torch.ops.aten.view.default(sum_135, [512]);  sum_135 = None
    ...
    mul_277: "f32[8, 3137, 64]" = torch.ops.aten.mul.Tensor(mul_273, sum_137);  sum_137 = None
    ...
    view_332: "f32[64]" = torch.ops.aten.view.default(sum_140, [64]);  sum_140 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_83: "f32[8, 8, 3136, 8]" = torch.ops.aten.full.default([8, 8, 3136, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_84: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_85: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_86: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_87: "f32[8, 8, 3136, 8]" = torch.ops.aten.full.default([8, 8, 3136, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_88: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_89: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_90: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_346: "f32[192]" = torch.ops.aten.view.default(sum_145, [192]);  sum_145 = None
    ...
    mul_289: "f32[8, 3137, 64]" = torch.ops.aten.mul.Tensor(mul_285, sum_147);  sum_147 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_91: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_92: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_93: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_92: "f32[8, 3137, 64]" = torch.ops.aten.slice_scatter.default(full_93, slice_149, 1, 0, 1);  full_93 = slice_149 = None
    full_94: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_351: "f32[64]" = torch.ops.aten.view.default(sum_151, [64]);  sum_151 = None
    ...
    view_354: "f32[512]" = torch.ops.aten.view.default(sum_152, [512]);  sum_152 = None
    ...
    mul_303: "f32[8, 3137, 64]" = torch.ops.aten.mul.Tensor(mul_299, sum_154);  sum_154 = None
    ...
    view_357: "f32[64]" = torch.ops.aten.view.default(sum_157, [64]);  sum_157 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:76, code: v_img = v[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_95: "f32[8, 8, 3136, 8]" = torch.ops.aten.full.default([8, 8, 3136, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_96: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_97: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_98: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:75, code: q_img = q[:, :, 1:, :]  # [B, h, H*W, Ch]
    full_99: "f32[8, 8, 3136, 8]" = torch.ops.aten.full.default([8, 8, 3136, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_100: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_101: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_102: "f32[8, 8, 3137, 8]" = torch.ops.aten.full.default([8, 8, 3137, 8], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    view_371: "f32[192]" = torch.ops.aten.view.default(sum_162, [192]);  sum_162 = None
    ...
    mul_315: "f32[8, 3137, 64]" = torch.ops.aten.mul.Tensor(mul_311, sum_164);  sum_164 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/coat.py:155, code: cls_token, img_tokens = x[:, :1], x[:, 1:]  # [B, 1, C], [B, H*W, C]
    full_103: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_104: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_105: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    slice_scatter_104: "f32[8, 3137, 64]" = torch.ops.aten.slice_scatter.default(full_105, slice_154, 1, 0, 1);  full_105 = slice_154 = None
    full_106: "f32[8, 3137, 64]" = torch.ops.aten.full.default([8, 3137, 64], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    mul_322: "f32[8, 3136, 64]" = torch.ops.aten.mul.Tensor(mul_318, sum_170);  sum_170 = None
