...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 10145520)) \
        and (___check_obj_id(L['___stack0'], 9219008)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 125825536)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140036679219904))) \
        and (___compile_config_hash() == 'fca486ec9e76c4b7cb8dbf30e95607d7') \
