...
def forward(self, primals, tangents):
    ...
    sum_58: "f32[368]" = torch.ops.aten.sum.dim_IntList(where_24, [0, 2, 3])
    ...
    mul_517: "f32[368]" = torch.ops.aten.mul.Tensor(sum_58, 0.002551020408163265)
    ...
    sum_96: "f32[152]" = torch.ops.aten.sum.dim_IntList(where_40, [0, 2, 3])
    ...
    mul_650: "f32[152]" = torch.ops.aten.mul.Tensor(sum_96, 0.0006377551020408163)
    ...
    sum_107: "f32[56]" = torch.ops.aten.sum.dim_IntList(where_44, [0, 2, 3])
    ...
    mul_690: "f32[56]" = torch.ops.aten.mul.Tensor(sum_107, 0.00015943877551020407)
    ...
    sum_118: "f32[24]" = torch.ops.aten.sum.dim_IntList(where_48, [0, 2, 3])
    ...
    mul_730: "f32[24]" = torch.ops.aten.mul.Tensor(sum_118, 3.985969387755102e-05)
