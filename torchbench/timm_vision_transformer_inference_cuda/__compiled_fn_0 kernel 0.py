...
# kernel path: /tmp/torchinductor_youkaichao/75/c75hthwccyukvy6r2p66tfchsydf2lekkqfds2srxlode3tgbj6r.py
# Source Nodes: [cat_1, getattr_l__mod___blocks___0___norm1, x_5], Original ATen: [aten.add, aten.cat, aten.native_layer_norm]
# cat_1 => cat
# getattr_l__mod___blocks___0___norm1 => var_mean
# x_5 => add
...
# kernel path: /tmp/torchinductor_youkaichao/wo/cwoz3xopqg5e4ikzrhii5xzjay5ruq52p2yxknizir2ics35mdum.py
# Source Nodes: [cat_1, getattr_l__mod___blocks___0___norm1, x_5], Original ATen: [aten.add, aten.cat, aten.native_layer_norm]
# cat_1 => cat
...
# kernel path: /tmp/torchinductor_youkaichao/b5/cb5aynmuovvjjc4fu7cfsh26h3buwlanc4wdlm5bwmjhpb4oo35l.py
...
# kernel path: /tmp/torchinductor_youkaichao/hy/chy7wrbhvp7oio6r5v3oqsbu4h73vvw4zo5b3y2frjws3eflgrat.py
...
# kernel path: /tmp/torchinductor_youkaichao/jg/cjggolpzw322kqxleaddp44sq7ut7mmjmk46yikmam66g6zqgruc.py
...
# kernel path: /tmp/torchinductor_youkaichao/fg/cfg3g7fy7c6qtcts45nc2obmljuk5g7xxk3zoefbxrn6r5vftx4y.py
...
# kernel path: /tmp/torchinductor_youkaichao/yb/cybso3ra6dxjo7qrf2krmjk5z4iztx6iferp56csql5rkplv2ks6.py
...
# kernel path: /tmp/torchinductor_youkaichao/a4/ca4ibwc6cyzbbrogwe6tp7prml5i3xnz6clcyui32m5qla7tkwqx.py
...
def triton_(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp1 = tl.load(in_ptr1 + (x0 + (75648*x1)), xmask)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_add_cat_native_layer_norm_0.run(arg1_1, buf0, arg3_1, arg0_1, buf1, buf2, buf3, 2364, 128, grid=grid(2364), stream=stream0)
        ...
        # Source Nodes: [cat_1, getattr_l__mod___blocks___0___norm1, x_5], Original ATen: [aten.add, aten.cat, aten.native_layer_norm]
        triton_per_fused_add_cat_native_layer_norm_1.run(buf1, buf2, buf3, buf4, buf5, 788, 3, grid=grid(788), stream=stream0)
        del buf1
        del buf2
        del buf3
        buf7 = empty((4, 197, 384), device='cuda', dtype=torch.float32)
        # Source Nodes: [cat_1, getattr_l__mod___blocks___0___norm1, x_5], Original ATen: [aten.add, aten.cat, aten.native_layer_norm]
        triton_poi_fused_add_cat_native_layer_norm_2.run(arg1_1, buf0, arg3_1, arg0_1, buf4, buf5, arg4_1, arg5_1, buf7, 302592, grid=grid(302592), stream=stream0)
        del arg4_1
        del arg5_1
        buf8 = empty((788, 1152), device='cuda', dtype=torch.float32)
        # Source Nodes: [getattr_l__mod___blocks___0___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg7_1, reinterpret_tensor(buf7, (788, 384), (384, 1), 0), reinterpret_tensor(arg6_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf8)
        del arg6_1
        del arg7_1
        # Source Nodes: [x_9], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf9 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf8, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf8, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf8, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf10 = buf9[0]
        del buf9
        buf14 = reinterpret_tensor(buf7, (788, 384), (384, 1), 0); del buf7  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf10, (788, 384), (384, 1), 0), reinterpret_tensor(arg8_1, (384, 384), (1, 384), 0), out=buf14)
        del arg8_1
        buf15 = reinterpret_tensor(buf14, (4, 197, 384), (75648, 384, 1), 0); del buf14  # reuse
        buf19 = reinterpret_tensor(buf10, (4, 197, 384), (75648, 384, 1), 0); del buf10  # reuse
        # Source Nodes: [cat_1, getattr_l__mod___blocks___0___norm2, x_13, x_5], Original ATen: [aten.add, aten.cat, aten.native_layer_norm]
        triton_per_fused_add_cat_native_layer_norm_3.run(buf15, arg1_1, buf0, arg3_1, arg0_1, arg9_1, arg10_1, arg11_1, buf19, 788, 384, grid=grid(788), stream=stream0)
        del arg0_1
        del arg10_1
        del arg11_1
        del arg1_1
        ...
        del arg9_1
        del buf0
        buf20 = empty((788, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf19, (788, 384), (384, 1), 0), reinterpret_tensor(arg12_1, (384, 1536), (1, 384), 0), out=buf20)
        del arg12_1
        buf21 = reinterpret_tensor(buf20, (4, 197, 1536), (302592, 1536, 1), 0); del buf20  # reuse
        # Source Nodes: [x_15], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf21, arg13_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg13_1
        buf22 = reinterpret_tensor(buf19, (788, 384), (384, 1), 0); del buf19  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf21, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg14_1, (1536, 384), (1, 1536), 0), out=buf22)
        del arg14_1
        buf26 = empty((4, 197, 384), device='cuda', dtype=torch.float32)
        # Source Nodes: [getattr_l__mod___blocks___1___norm1, x_20], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf15, buf22, arg15_1, arg16_1, arg17_1, buf26, 788, 384, grid=grid(788), stream=stream0)
        del arg16_1
        del arg17_1
        buf27 = buf8; del buf8  # reuse
        # Source Nodes: [getattr_l__mod___blocks___1___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg19_1, reinterpret_tensor(buf26, (788, 384), (384, 1), 0), reinterpret_tensor(arg18_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf27)
        del arg18_1
        del arg19_1
        # Source Nodes: [x_21], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf28 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf27, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf27, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf27, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf29 = buf28[0]
        del buf28
        buf33 = reinterpret_tensor(buf26, (788, 384), (384, 1), 0); del buf26  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf29, (788, 384), (384, 1), 0), reinterpret_tensor(arg20_1, (384, 384), (1, 384), 0), out=buf33)
        del arg20_1
        buf34 = reinterpret_tensor(buf33, (4, 197, 384), (75648, 384, 1), 0); del buf33  # reuse
        buf38 = reinterpret_tensor(buf29, (4, 197, 384), (75648, 384, 1), 0); del buf29  # reuse
        # Source Nodes: [getattr_l__mod___blocks___1___norm2, x_20, x_25], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf34, buf15, buf22, arg15_1, arg21_1, arg22_1, arg23_1, buf38, 788, 384, grid=grid(788), stream=stream0)
        del arg15_1
        del arg21_1
        del arg22_1
        del arg23_1
        del buf15
        buf39 = reinterpret_tensor(buf21, (788, 1536), (1536, 1), 0); del buf21  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf38, (788, 384), (384, 1), 0), reinterpret_tensor(arg24_1, (384, 1536), (1, 384), 0), out=buf39)
        del arg24_1
        buf40 = reinterpret_tensor(buf39, (4, 197, 1536), (302592, 1536, 1), 0); del buf39  # reuse
        # Source Nodes: [x_27], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf40, arg25_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg25_1
        buf41 = reinterpret_tensor(buf38, (788, 384), (384, 1), 0); del buf38  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf40, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg26_1, (1536, 384), (1, 1536), 0), out=buf41)
        del arg26_1
        buf45 = reinterpret_tensor(buf22, (4, 197, 384), (75648, 384, 1), 0); del buf22  # reuse
        # Source Nodes: [getattr_l__mod___blocks___2___norm1, x_32], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf34, buf41, arg27_1, arg28_1, arg29_1, buf45, 788, 384, grid=grid(788), stream=stream0)
        del arg28_1
        del arg29_1
        buf46 = buf27; del buf27  # reuse
        # Source Nodes: [getattr_l__mod___blocks___2___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg31_1, reinterpret_tensor(buf45, (788, 384), (384, 1), 0), reinterpret_tensor(arg30_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf46)
        del arg30_1
        del arg31_1
        # Source Nodes: [x_33], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf47 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf46, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf46, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf46, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf48 = buf47[0]
        del buf47
        buf52 = reinterpret_tensor(buf45, (788, 384), (384, 1), 0); del buf45  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf48, (788, 384), (384, 1), 0), reinterpret_tensor(arg32_1, (384, 384), (1, 384), 0), out=buf52)
        del arg32_1
        buf53 = reinterpret_tensor(buf52, (4, 197, 384), (75648, 384, 1), 0); del buf52  # reuse
        buf57 = reinterpret_tensor(buf48, (4, 197, 384), (75648, 384, 1), 0); del buf48  # reuse
        # Source Nodes: [getattr_l__mod___blocks___2___norm2, x_32, x_37], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf53, buf34, buf41, arg27_1, arg33_1, arg34_1, arg35_1, buf57, 788, 384, grid=grid(788), stream=stream0)
        del arg27_1
        del arg33_1
        del arg34_1
        del arg35_1
        del buf34
        buf58 = reinterpret_tensor(buf40, (788, 1536), (1536, 1), 0); del buf40  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf57, (788, 384), (384, 1), 0), reinterpret_tensor(arg36_1, (384, 1536), (1, 384), 0), out=buf58)
        del arg36_1
        buf59 = reinterpret_tensor(buf58, (4, 197, 1536), (302592, 1536, 1), 0); del buf58  # reuse
        # Source Nodes: [x_39], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf59, arg37_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg37_1
        buf60 = reinterpret_tensor(buf57, (788, 384), (384, 1), 0); del buf57  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf59, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg38_1, (1536, 384), (1, 1536), 0), out=buf60)
        del arg38_1
        buf64 = reinterpret_tensor(buf41, (4, 197, 384), (75648, 384, 1), 0); del buf41  # reuse
        # Source Nodes: [getattr_l__mod___blocks___3___norm1, x_44], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf53, buf60, arg39_1, arg40_1, arg41_1, buf64, 788, 384, grid=grid(788), stream=stream0)
        del arg40_1
        del arg41_1
        buf65 = buf46; del buf46  # reuse
        # Source Nodes: [getattr_l__mod___blocks___3___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg43_1, reinterpret_tensor(buf64, (788, 384), (384, 1), 0), reinterpret_tensor(arg42_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf65)
        del arg42_1
        del arg43_1
        # Source Nodes: [x_45], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf66 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf65, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf65, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf65, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf67 = buf66[0]
        del buf66
        buf71 = reinterpret_tensor(buf64, (788, 384), (384, 1), 0); del buf64  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf67, (788, 384), (384, 1), 0), reinterpret_tensor(arg44_1, (384, 384), (1, 384), 0), out=buf71)
        del arg44_1
        buf72 = reinterpret_tensor(buf71, (4, 197, 384), (75648, 384, 1), 0); del buf71  # reuse
        buf76 = reinterpret_tensor(buf67, (4, 197, 384), (75648, 384, 1), 0); del buf67  # reuse
        # Source Nodes: [getattr_l__mod___blocks___3___norm2, x_44, x_49], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf72, buf53, buf60, arg39_1, arg45_1, arg46_1, arg47_1, buf76, 788, 384, grid=grid(788), stream=stream0)
        del arg39_1
        del arg45_1
        del arg46_1
        del arg47_1
        del buf53
        buf77 = reinterpret_tensor(buf59, (788, 1536), (1536, 1), 0); del buf59  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf76, (788, 384), (384, 1), 0), reinterpret_tensor(arg48_1, (384, 1536), (1, 384), 0), out=buf77)
        del arg48_1
        buf78 = reinterpret_tensor(buf77, (4, 197, 1536), (302592, 1536, 1), 0); del buf77  # reuse
        # Source Nodes: [x_51], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf78, arg49_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg49_1
        buf79 = reinterpret_tensor(buf76, (788, 384), (384, 1), 0); del buf76  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf78, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg50_1, (1536, 384), (1, 1536), 0), out=buf79)
        del arg50_1
        buf83 = reinterpret_tensor(buf60, (4, 197, 384), (75648, 384, 1), 0); del buf60  # reuse
        # Source Nodes: [getattr_l__mod___blocks___4___norm1, x_56], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf72, buf79, arg51_1, arg52_1, arg53_1, buf83, 788, 384, grid=grid(788), stream=stream0)
        del arg52_1
        del arg53_1
        buf84 = buf65; del buf65  # reuse
        # Source Nodes: [getattr_l__mod___blocks___4___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg55_1, reinterpret_tensor(buf83, (788, 384), (384, 1), 0), reinterpret_tensor(arg54_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf84)
        del arg54_1
        del arg55_1
        # Source Nodes: [x_57], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf85 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf84, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf84, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf84, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf86 = buf85[0]
        del buf85
        buf90 = reinterpret_tensor(buf83, (788, 384), (384, 1), 0); del buf83  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf86, (788, 384), (384, 1), 0), reinterpret_tensor(arg56_1, (384, 384), (1, 384), 0), out=buf90)
        del arg56_1
        buf91 = reinterpret_tensor(buf90, (4, 197, 384), (75648, 384, 1), 0); del buf90  # reuse
        buf95 = reinterpret_tensor(buf86, (4, 197, 384), (75648, 384, 1), 0); del buf86  # reuse
        # Source Nodes: [getattr_l__mod___blocks___4___norm2, x_56, x_61], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf91, buf72, buf79, arg51_1, arg57_1, arg58_1, arg59_1, buf95, 788, 384, grid=grid(788), stream=stream0)
        del arg51_1
        del arg57_1
        del arg58_1
        del arg59_1
        del buf72
        buf96 = reinterpret_tensor(buf78, (788, 1536), (1536, 1), 0); del buf78  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf95, (788, 384), (384, 1), 0), reinterpret_tensor(arg60_1, (384, 1536), (1, 384), 0), out=buf96)
        del arg60_1
        buf97 = reinterpret_tensor(buf96, (4, 197, 1536), (302592, 1536, 1), 0); del buf96  # reuse
        # Source Nodes: [x_63], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf97, arg61_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg61_1
        buf98 = reinterpret_tensor(buf95, (788, 384), (384, 1), 0); del buf95  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf97, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg62_1, (1536, 384), (1, 1536), 0), out=buf98)
        del arg62_1
        buf102 = reinterpret_tensor(buf79, (4, 197, 384), (75648, 384, 1), 0); del buf79  # reuse
        # Source Nodes: [getattr_l__mod___blocks___5___norm1, x_68], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf91, buf98, arg63_1, arg64_1, arg65_1, buf102, 788, 384, grid=grid(788), stream=stream0)
        del arg64_1
        del arg65_1
        buf103 = buf84; del buf84  # reuse
        # Source Nodes: [getattr_l__mod___blocks___5___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg67_1, reinterpret_tensor(buf102, (788, 384), (384, 1), 0), reinterpret_tensor(arg66_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf103)
        del arg66_1
        del arg67_1
        # Source Nodes: [x_69], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf104 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf103, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf103, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf103, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf105 = buf104[0]
        del buf104
        buf109 = reinterpret_tensor(buf102, (788, 384), (384, 1), 0); del buf102  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf105, (788, 384), (384, 1), 0), reinterpret_tensor(arg68_1, (384, 384), (1, 384), 0), out=buf109)
        del arg68_1
        buf110 = reinterpret_tensor(buf109, (4, 197, 384), (75648, 384, 1), 0); del buf109  # reuse
        buf114 = reinterpret_tensor(buf105, (4, 197, 384), (75648, 384, 1), 0); del buf105  # reuse
        # Source Nodes: [getattr_l__mod___blocks___5___norm2, x_68, x_73], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf110, buf91, buf98, arg63_1, arg69_1, arg70_1, arg71_1, buf114, 788, 384, grid=grid(788), stream=stream0)
        del arg63_1
        del arg69_1
        del arg70_1
        del arg71_1
        del buf91
        buf115 = reinterpret_tensor(buf97, (788, 1536), (1536, 1), 0); del buf97  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (788, 384), (384, 1), 0), reinterpret_tensor(arg72_1, (384, 1536), (1, 384), 0), out=buf115)
        del arg72_1
        buf116 = reinterpret_tensor(buf115, (4, 197, 1536), (302592, 1536, 1), 0); del buf115  # reuse
        # Source Nodes: [x_75], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf116, arg73_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg73_1
        buf117 = reinterpret_tensor(buf114, (788, 384), (384, 1), 0); del buf114  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg74_1, (1536, 384), (1, 1536), 0), out=buf117)
        del arg74_1
        buf121 = reinterpret_tensor(buf98, (4, 197, 384), (75648, 384, 1), 0); del buf98  # reuse
        # Source Nodes: [getattr_l__mod___blocks___6___norm1, x_80], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf110, buf117, arg75_1, arg76_1, arg77_1, buf121, 788, 384, grid=grid(788), stream=stream0)
        del arg76_1
        del arg77_1
        buf122 = buf103; del buf103  # reuse
        # Source Nodes: [getattr_l__mod___blocks___6___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg79_1, reinterpret_tensor(buf121, (788, 384), (384, 1), 0), reinterpret_tensor(arg78_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf122)
        del arg78_1
        del arg79_1
        # Source Nodes: [x_81], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf123 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf122, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf122, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf122, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf124 = buf123[0]
        del buf123
        buf128 = reinterpret_tensor(buf121, (788, 384), (384, 1), 0); del buf121  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf124, (788, 384), (384, 1), 0), reinterpret_tensor(arg80_1, (384, 384), (1, 384), 0), out=buf128)
        del arg80_1
        buf129 = reinterpret_tensor(buf128, (4, 197, 384), (75648, 384, 1), 0); del buf128  # reuse
        buf133 = reinterpret_tensor(buf124, (4, 197, 384), (75648, 384, 1), 0); del buf124  # reuse
        # Source Nodes: [getattr_l__mod___blocks___6___norm2, x_80, x_85], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf129, buf110, buf117, arg75_1, arg81_1, arg82_1, arg83_1, buf133, 788, 384, grid=grid(788), stream=stream0)
        del arg75_1
        del arg81_1
        del arg82_1
        del arg83_1
        del buf110
        buf134 = reinterpret_tensor(buf116, (788, 1536), (1536, 1), 0); del buf116  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf133, (788, 384), (384, 1), 0), reinterpret_tensor(arg84_1, (384, 1536), (1, 384), 0), out=buf134)
        del arg84_1
        buf135 = reinterpret_tensor(buf134, (4, 197, 1536), (302592, 1536, 1), 0); del buf134  # reuse
        # Source Nodes: [x_87], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf135, arg85_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg85_1
        buf136 = reinterpret_tensor(buf133, (788, 384), (384, 1), 0); del buf133  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg86_1, (1536, 384), (1, 1536), 0), out=buf136)
        del arg86_1
        buf140 = reinterpret_tensor(buf117, (4, 197, 384), (75648, 384, 1), 0); del buf117  # reuse
        # Source Nodes: [getattr_l__mod___blocks___7___norm1, x_92], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf129, buf136, arg87_1, arg88_1, arg89_1, buf140, 788, 384, grid=grid(788), stream=stream0)
        del arg88_1
        del arg89_1
        buf141 = buf122; del buf122  # reuse
        # Source Nodes: [getattr_l__mod___blocks___7___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg91_1, reinterpret_tensor(buf140, (788, 384), (384, 1), 0), reinterpret_tensor(arg90_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf141)
        del arg90_1
        del arg91_1
        # Source Nodes: [x_93], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf142 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf141, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf141, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf141, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf143 = buf142[0]
        del buf142
        buf147 = reinterpret_tensor(buf140, (788, 384), (384, 1), 0); del buf140  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf143, (788, 384), (384, 1), 0), reinterpret_tensor(arg92_1, (384, 384), (1, 384), 0), out=buf147)
        del arg92_1
        buf148 = reinterpret_tensor(buf147, (4, 197, 384), (75648, 384, 1), 0); del buf147  # reuse
        buf152 = reinterpret_tensor(buf143, (4, 197, 384), (75648, 384, 1), 0); del buf143  # reuse
        # Source Nodes: [getattr_l__mod___blocks___7___norm2, x_92, x_97], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf148, buf129, buf136, arg87_1, arg93_1, arg94_1, arg95_1, buf152, 788, 384, grid=grid(788), stream=stream0)
        del arg87_1
        del arg93_1
        del arg94_1
        del arg95_1
        del buf129
        buf153 = reinterpret_tensor(buf135, (788, 1536), (1536, 1), 0); del buf135  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf152, (788, 384), (384, 1), 0), reinterpret_tensor(arg96_1, (384, 1536), (1, 384), 0), out=buf153)
        del arg96_1
        buf154 = reinterpret_tensor(buf153, (4, 197, 1536), (302592, 1536, 1), 0); del buf153  # reuse
        # Source Nodes: [x_99], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf154, arg97_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg97_1
        buf155 = reinterpret_tensor(buf152, (788, 384), (384, 1), 0); del buf152  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf154, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg98_1, (1536, 384), (1, 1536), 0), out=buf155)
        del arg98_1
        buf159 = reinterpret_tensor(buf136, (4, 197, 384), (75648, 384, 1), 0); del buf136  # reuse
        # Source Nodes: [getattr_l__mod___blocks___8___norm1, x_104], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf148, buf155, arg99_1, arg100_1, arg101_1, buf159, 788, 384, grid=grid(788), stream=stream0)
        del arg100_1
        del arg101_1
        buf160 = buf141; del buf141  # reuse
        # Source Nodes: [getattr_l__mod___blocks___8___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg103_1, reinterpret_tensor(buf159, (788, 384), (384, 1), 0), reinterpret_tensor(arg102_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf160)
        del arg102_1
        del arg103_1
        # Source Nodes: [x_105], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf161 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf160, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf160, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf160, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf162 = buf161[0]
        del buf161
        buf166 = reinterpret_tensor(buf159, (788, 384), (384, 1), 0); del buf159  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf162, (788, 384), (384, 1), 0), reinterpret_tensor(arg104_1, (384, 384), (1, 384), 0), out=buf166)
        del arg104_1
        buf167 = reinterpret_tensor(buf166, (4, 197, 384), (75648, 384, 1), 0); del buf166  # reuse
        buf171 = reinterpret_tensor(buf162, (4, 197, 384), (75648, 384, 1), 0); del buf162  # reuse
        # Source Nodes: [getattr_l__mod___blocks___8___norm2, x_104, x_109], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf167, buf148, buf155, arg99_1, arg105_1, arg106_1, arg107_1, buf171, 788, 384, grid=grid(788), stream=stream0)
        del arg105_1
        del arg106_1
        del arg107_1
        del arg99_1
        del buf148
        buf172 = reinterpret_tensor(buf154, (788, 1536), (1536, 1), 0); del buf154  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (788, 384), (384, 1), 0), reinterpret_tensor(arg108_1, (384, 1536), (1, 384), 0), out=buf172)
        del arg108_1
        buf173 = reinterpret_tensor(buf172, (4, 197, 1536), (302592, 1536, 1), 0); del buf172  # reuse
        # Source Nodes: [x_111], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf173, arg109_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg109_1
        buf174 = reinterpret_tensor(buf171, (788, 384), (384, 1), 0); del buf171  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg110_1, (1536, 384), (1, 1536), 0), out=buf174)
        del arg110_1
        buf178 = reinterpret_tensor(buf155, (4, 197, 384), (75648, 384, 1), 0); del buf155  # reuse
        # Source Nodes: [getattr_l__mod___blocks___9___norm1, x_116], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf167, buf174, arg111_1, arg112_1, arg113_1, buf178, 788, 384, grid=grid(788), stream=stream0)
        del arg112_1
        del arg113_1
        buf179 = buf160; del buf160  # reuse
        # Source Nodes: [getattr_l__mod___blocks___9___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg115_1, reinterpret_tensor(buf178, (788, 384), (384, 1), 0), reinterpret_tensor(arg114_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf179)
        del arg114_1
        del arg115_1
        # Source Nodes: [x_117], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf180 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf179, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf179, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf179, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf181 = buf180[0]
        del buf180
        buf185 = reinterpret_tensor(buf178, (788, 384), (384, 1), 0); del buf178  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf181, (788, 384), (384, 1), 0), reinterpret_tensor(arg116_1, (384, 384), (1, 384), 0), out=buf185)
        del arg116_1
        buf186 = reinterpret_tensor(buf185, (4, 197, 384), (75648, 384, 1), 0); del buf185  # reuse
        buf190 = reinterpret_tensor(buf181, (4, 197, 384), (75648, 384, 1), 0); del buf181  # reuse
        # Source Nodes: [getattr_l__mod___blocks___9___norm2, x_116, x_121], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf186, buf167, buf174, arg111_1, arg117_1, arg118_1, arg119_1, buf190, 788, 384, grid=grid(788), stream=stream0)
        del arg111_1
        del arg117_1
        del arg118_1
        del arg119_1
        del buf167
        buf191 = reinterpret_tensor(buf173, (788, 1536), (1536, 1), 0); del buf173  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (788, 384), (384, 1), 0), reinterpret_tensor(arg120_1, (384, 1536), (1, 384), 0), out=buf191)
        del arg120_1
        buf192 = reinterpret_tensor(buf191, (4, 197, 1536), (302592, 1536, 1), 0); del buf191  # reuse
        # Source Nodes: [x_123], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf192, arg121_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg121_1
        buf193 = reinterpret_tensor(buf190, (788, 384), (384, 1), 0); del buf190  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf192, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg122_1, (1536, 384), (1, 1536), 0), out=buf193)
        del arg122_1
        buf197 = reinterpret_tensor(buf174, (4, 197, 384), (75648, 384, 1), 0); del buf174  # reuse
        # Source Nodes: [getattr_l__mod___blocks___10___norm1, x_128], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf186, buf193, arg123_1, arg124_1, arg125_1, buf197, 788, 384, grid=grid(788), stream=stream0)
        del arg124_1
        del arg125_1
        buf198 = buf179; del buf179  # reuse
        # Source Nodes: [getattr_l__mod___blocks___10___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg127_1, reinterpret_tensor(buf197, (788, 384), (384, 1), 0), reinterpret_tensor(arg126_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf198)
        del arg126_1
        del arg127_1
        # Source Nodes: [x_129], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf199 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf198, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf198, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf198, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        buf200 = buf199[0]
        del buf199
        buf204 = reinterpret_tensor(buf197, (788, 384), (384, 1), 0); del buf197  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf200, (788, 384), (384, 1), 0), reinterpret_tensor(arg128_1, (384, 384), (1, 384), 0), out=buf204)
        del arg128_1
        buf205 = reinterpret_tensor(buf204, (4, 197, 384), (75648, 384, 1), 0); del buf204  # reuse
        buf209 = reinterpret_tensor(buf200, (4, 197, 384), (75648, 384, 1), 0); del buf200  # reuse
        # Source Nodes: [getattr_l__mod___blocks___10___norm2, x_128, x_133], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf205, buf186, buf193, arg123_1, arg129_1, arg130_1, arg131_1, buf209, 788, 384, grid=grid(788), stream=stream0)
        del arg123_1
        del arg129_1
        del arg130_1
        del arg131_1
        del buf186
        buf210 = reinterpret_tensor(buf192, (788, 1536), (1536, 1), 0); del buf192  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf209, (788, 384), (384, 1), 0), reinterpret_tensor(arg132_1, (384, 1536), (1, 384), 0), out=buf210)
        del arg132_1
        buf211 = reinterpret_tensor(buf210, (4, 197, 1536), (302592, 1536, 1), 0); del buf210  # reuse
        # Source Nodes: [x_135], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf211, arg133_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg133_1
        buf212 = reinterpret_tensor(buf209, (788, 384), (384, 1), 0); del buf209  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf211, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg134_1, (1536, 384), (1, 1536), 0), out=buf212)
        del arg134_1
        buf216 = reinterpret_tensor(buf193, (4, 197, 384), (75648, 384, 1), 0); del buf193  # reuse
        # Source Nodes: [getattr_l__mod___blocks___11___norm1, x_140], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf205, buf212, arg135_1, arg136_1, arg137_1, buf216, 788, 384, grid=grid(788), stream=stream0)
        del arg136_1
        del arg137_1
        buf217 = buf198; del buf198  # reuse
        # Source Nodes: [getattr_l__mod___blocks___11___attn_qkv], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg139_1, reinterpret_tensor(buf216, (788, 384), (384, 1), 0), reinterpret_tensor(arg138_1, (384, 1152), (1, 384), 0), alpha=1, beta=1, out=buf217)
        del arg138_1
        del arg139_1
        # Source Nodes: [x_141], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf218 = aten._scaled_dot_product_efficient_attention(reinterpret_tensor(buf217, (4, 6, 197, 64), (226944, 64, 1152, 1), 0), reinterpret_tensor(buf217, (4, 6, 197, 64), (226944, 64, 1152, 1), 384), reinterpret_tensor(buf217, (4, 6, 197, 64), (226944, 64, 1152, 1), 768), None, False)
        del buf217
        buf219 = buf218[0]
        del buf218
        buf223 = reinterpret_tensor(buf216, (788, 384), (384, 1), 0); del buf216  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (788, 384), (384, 1), 0), reinterpret_tensor(arg140_1, (384, 384), (1, 384), 0), out=buf223)
        del arg140_1
        buf224 = reinterpret_tensor(buf223, (4, 197, 384), (75648, 384, 1), 0); del buf223  # reuse
        buf228 = reinterpret_tensor(buf219, (4, 197, 384), (75648, 384, 1), 0); del buf219  # reuse
        # Source Nodes: [getattr_l__mod___blocks___11___norm2, x_140, x_145], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_6.run(buf224, buf205, buf212, arg135_1, arg141_1, arg142_1, arg143_1, buf228, 788, 384, grid=grid(788), stream=stream0)
        del arg135_1
        del arg141_1
        del arg142_1
        del arg143_1
        del buf205
        del buf212
        buf229 = reinterpret_tensor(buf211, (788, 1536), (1536, 1), 0); del buf211  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf228, (788, 384), (384, 1), 0), reinterpret_tensor(arg144_1, (384, 1536), (1, 384), 0), out=buf229)
        del arg144_1
        buf230 = reinterpret_tensor(buf229, (4, 197, 1536), (302592, 1536, 1), 0); del buf229  # reuse
        # Source Nodes: [x_147], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_4.run(buf230, arg145_1, 1210368, grid=grid(1210368), stream=stream0)
        del arg145_1
        buf231 = reinterpret_tensor(buf228, (788, 384), (384, 1), 0); del buf228  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf230, (788, 1536), (1536, 1), 0), reinterpret_tensor(arg146_1, (1536, 384), (1, 1536), 0), out=buf231)
        del arg146_1
        del buf230
        buf232 = buf5; del buf5  # reuse
        buf233 = buf4; del buf4  # reuse
        # Source Nodes: [x_153, x_155], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_7.run(buf224, buf231, arg147_1, buf232, buf233, 788, 384, grid=grid(788), stream=stream0)
        buf235 = empty((4, 384), device='cuda', dtype=torch.float32)
        # Source Nodes: [x_158], Original ATen: [aten.clone]
        triton_poi_fused_clone_8.run(buf224, buf231, arg147_1, buf232, buf233, arg148_1, arg149_1, buf235, 1536, grid=grid(1536), stream=stream0)
        del arg147_1
        del arg148_1
        del arg149_1
        del buf224
        ...
        del buf232
        del buf233
        buf236 = empty((4, 1000), device='cuda', dtype=torch.float32)
        # Source Nodes: [x_158, x_159], Original ATen: [aten.addmm, aten.clone]
        extern_kernels.addmm(arg151_1, buf235, reinterpret_tensor(arg150_1, (384, 1000), (1, 384), 0), alpha=1, beta=1, out=buf236)
        del arg150_1
        del arg151_1
        return (buf236, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1, 197, 384), (75648, 384, 1), device='cuda:0', dtype=torch.float32)
    arg1_1 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:0', dtype=torch.float32)
    arg2_1 = rand_strided((384, 3, 16, 16), (768, 256, 16, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg6_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg7_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg8_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg12_1 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg13_1 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg14_1 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg18_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg19_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg20_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg24_1 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg25_1 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg26_1 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg30_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg31_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    ...
    arg42_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg43_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg44_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg48_1 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg49_1 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg50_1 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg54_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg55_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg56_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg60_1 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg61_1 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg62_1 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg66_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg67_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg68_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg72_1 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg73_1 = rand_strided((1536, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg74_1 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg78_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg79_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg80_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg90_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg104_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg114_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg126_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg127_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg128_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg138_1 = rand_strided((1152, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg139_1 = rand_strided((1152, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg140_1 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg150_1 = rand_strided((1000, 384), (384, 1), device='cuda:0', dtype=torch.float32)
    arg151_1 = rand_strided((1000, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg152_1 = rand_strided((4, 3, 224, 224), (150528, 50176, 224, 1), device='cuda:0', dtype=torch.float32)
