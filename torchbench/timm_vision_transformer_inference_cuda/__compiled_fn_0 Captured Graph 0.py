...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/vision_transformer.py:568, code: pos_embed = self.pos_embed
    pos_embed = self.L__mod___pos_embed
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/vision_transformer.py:578, code: if self.cls_token is not None:
    ...
    expand = l__mod___cls_token.expand(4, -1, -1);  l__mod___cls_token = None
    ...
    reshape = getattr_l__mod___blocks___0___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___0___attn_qkv = None
    ...
    x_10 = transpose_1.reshape(4, 197, 384);  transpose_1 = None
    ...
    reshape_2 = getattr_l__mod___blocks___1___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___1___attn_qkv = None
    ...
    x_22 = transpose_2.reshape(4, 197, 384);  transpose_2 = None
    ...
    reshape_4 = getattr_l__mod___blocks___2___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___2___attn_qkv = None
    ...
    x_34 = transpose_3.reshape(4, 197, 384);  transpose_3 = None
    ...
    reshape_6 = getattr_l__mod___blocks___3___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___3___attn_qkv = None
    ...
    x_46 = transpose_4.reshape(4, 197, 384);  transpose_4 = None
    ...
    reshape_8 = getattr_l__mod___blocks___4___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___4___attn_qkv = None
    ...
    x_58 = transpose_5.reshape(4, 197, 384);  transpose_5 = None
    ...
    reshape_10 = getattr_l__mod___blocks___5___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___5___attn_qkv = None
    ...
    x_70 = transpose_6.reshape(4, 197, 384);  transpose_6 = None
    ...
    reshape_12 = getattr_l__mod___blocks___6___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___6___attn_qkv = None
    ...
    x_82 = transpose_7.reshape(4, 197, 384);  transpose_7 = None
    ...
    reshape_14 = getattr_l__mod___blocks___7___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___7___attn_qkv = None
    ...
    x_94 = transpose_8.reshape(4, 197, 384);  transpose_8 = None
    ...
    reshape_16 = getattr_l__mod___blocks___8___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___8___attn_qkv = None
    ...
    x_106 = transpose_9.reshape(4, 197, 384);  transpose_9 = None
    ...
    reshape_18 = getattr_l__mod___blocks___9___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___9___attn_qkv = None
    ...
    x_118 = transpose_10.reshape(4, 197, 384);  transpose_10 = None
    ...
    reshape_20 = getattr_l__mod___blocks___10___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___10___attn_qkv = None
    ...
    x_130 = transpose_11.reshape(4, 197, 384);  transpose_11 = None
    ...
    reshape_22 = getattr_l__mod___blocks___11___attn_qkv.reshape(4, 197, 3, 6, 64);  getattr_l__mod___blocks___11___attn_qkv = None
    ...
    x_142 = transpose_12.reshape(4, 197, 384);  transpose_12 = None
    ...
    x_156 = x_155[(slice(None, None, None), 0)];  x_155 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/vision_transformer.py:647, code: x = self.fc_norm(x)
    x_157 = self.L__mod___fc_norm(x_156);  x_156 = None
    ...
    x_158 = self.L__mod___head_drop(x_157);  x_157 = None
    ...
    x_159 = self.L__mod___head(x_158);  x_158 = None
    return (x_159,)
