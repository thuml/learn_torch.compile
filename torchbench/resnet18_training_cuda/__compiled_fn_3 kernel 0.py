...
# kernel path: /tmp/torchinductor_youkaichao/ww/cwwld62uneriniqbolxxe7gzt4xrfavncb566jziiewhgvwd6bp4.py
...
# kernel path: /tmp/torchinductor_youkaichao/k3/ck3u4abcgvdaxbywne7up2fikcmwb2lqda6vqrbgya3ogue7kyzl.py
...
# kernel path: /tmp/torchinductor_youkaichao/pa/cpaqxvft7zkjcogu7kvuwplv2khdzs5vzdj7pvyruovk52awctdc.py
...
# kernel path: /tmp/torchinductor_youkaichao/iy/ciyipshmqvj45klmwk6uzd7m5oh3jpfacyjzebhafmu6msa2odl7.py
...
# kernel path: /tmp/torchinductor_youkaichao/nt/cnt2col43cumyyapbzxmvfu5ryk56br52h6ihpyxdqczzv7r4rgt.py
...
# kernel path: /tmp/torchinductor_youkaichao/o3/co3c3ribbi4ptjatpikaqodzrup6gl3cqtwc5jxzkeluiw2wiws6.py
...
# kernel path: /tmp/torchinductor_youkaichao/yr/cyrlnumxsfhnxumh2xf3aveem5z47k4ysomb6353jr5rvbk72w7d.py
...
# kernel path: /tmp/torchinductor_youkaichao/2w/c2w73kwi4umcq6yw34igbyizaqybwulavlwve667dfddmk66eft3.py
...
# kernel path: /tmp/torchinductor_youkaichao/hy/chy7qjlgm5jwnxyi3iwigumpvurxtw43ukm66koxb5q6q7a63qnm.py
...
# kernel path: /tmp/torchinductor_youkaichao/sa/csap53iicbrcidzdlpjfqlygytuza7jvxz5qvuyozr2ltubyj5ll.py
...
# kernel path: /tmp/torchinductor_youkaichao/37/c37kjcgjusttixtkixsbo7y2bilsfzc6i5jlh5ei5mmgxcwwppf4.py
...
# kernel path: /tmp/torchinductor_youkaichao/tr/ctrw42vecq5zh27dd36xvuhzv7apu7z3g4do276alvalwk6f6icl.py
...
# kernel path: /tmp/torchinductor_youkaichao/4i/c4ibxztqp4l7vq4hy7qiza5bcum4v3eld4vgstzs3rbmokp2k2qk.py
...
# kernel path: /tmp/torchinductor_youkaichao/yu/cyu6k4kf4adomjfb5pobiutexdephfnxyrwlfmfgxebgf745lqpw.py
...
# kernel path: /tmp/torchinductor_youkaichao/pi/cpiobmabkyiabon6ykzcbpxlhwqnsui4qi7wv6lnyklgpafk5jtb.py
...
# kernel path: /tmp/torchinductor_youkaichao/tj/ctjfal336iq63hfkuhlebyhymiejavt277o5lkpbwij5djkbyz57.py
...
# kernel path: /tmp/torchinductor_youkaichao/tv/ctv4diruzgf6s22wwgnqgrvtcnnph5gz7tl4vyejtfzw46wamqpr.py
...
# kernel path: /tmp/torchinductor_youkaichao/oa/coa56ofqtwfe3j3t7da3g6gr6cpv24m6yevwemxjb2xdrs32ojra.py
# Source Nodes: [out_53, out_54, x_7], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu, aten.threshold_backward]
# out_53 => add_46, mul_58, mul_59, sub_19
# out_54 => add_47
# x_7 => relu_16
triton_poi_fused__native_batch_norm_legit_no_training_add_relu_threshold_backward_26 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
# kernel path: /tmp/torchinductor_youkaichao/dq/cdqkmrze6pz6ah3tx76avd2sv552ccbpvwfsuxodk3bpp7k3tchj.py
# Source Nodes: [x_8, x_9], Original ATen: [aten.mean, aten.view]
# x_8 => mean
# x_9 => view
triton_per_fused_mean_view_27 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_8.run(primals_123, buf17, 12, 50176, grid=grid(12, 50176), stream=stream0)
        del primals_123
        # Source Nodes: [x], Original ATen: [aten.convolution]
        ...
        # Source Nodes: [x], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_9.run(buf18, buf19, 256, 12544, grid=grid(256, 12544), stream=stream0)
        buf20 = reinterpret_tensor(buf18, (4, 64, 112, 112), (802816, 1, 7168, 64), 0); del buf18  # reuse
        # Source Nodes: [x_1, x_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_10.run(buf19, primals_63, primals_64, primals_2, primals_3, buf20, 3211264, grid=grid(3211264), stream=stream0)
        del primals_3
        ...
        # Source Nodes: [identity], Original ATen: [aten.max_pool2d_with_indices]
        triton_poi_fused_max_pool2d_with_indices_11.run(buf20, buf21, buf22, 802816, grid=grid(802816), stream=stream0)
        # Source Nodes: [out], Original ATen: [aten.convolution]
        buf23 = extern_kernels.convolution(buf21, buf1, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        ...
        # Source Nodes: [out], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_12.run(buf23, buf24, 256, 3136, grid=grid(256, 3136), stream=stream0)
        buf25 = reinterpret_tensor(buf23, (4, 64, 56, 56), (200704, 1, 3584, 64), 0); del buf23  # reuse
        # Source Nodes: [out_1, out_2], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_13.run(buf24, primals_66, primals_67, primals_5, primals_6, buf25, 802816, grid=grid(802816), stream=stream0)
        del primals_6
        ...
        # Source Nodes: [out_3], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_12.run(buf26, buf27, 256, 3136, grid=grid(256, 3136), stream=stream0)
        buf28 = reinterpret_tensor(buf26, (4, 64, 56, 56), (200704, 1, 3584, 64), 0); del buf26  # reuse
        # Source Nodes: [identity_1, out_4, out_5], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_14.run(buf27, primals_69, primals_70, primals_8, primals_9, buf21, buf28, 802816, grid=grid(802816), stream=stream0)
        del primals_9
        ...
        assert_size_stride(buf29, (4, 64, 56, 56), (200704, 3136, 56, 1))
        buf30 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_7], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_12.run(buf29, buf30, 256, 3136, grid=grid(256, 3136), stream=stream0)
        buf31 = reinterpret_tensor(buf29, (4, 64, 56, 56), (200704, 1, 3584, 64), 0); del buf29  # reuse
        # Source Nodes: [out_8, out_9], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_13.run(buf30, primals_72, primals_73, primals_11, primals_12, buf31, 802816, grid=grid(802816), stream=stream0)
        del primals_12
        # Source Nodes: [out_10], Original ATen: [aten.convolution]
        buf32 = extern_kernels.convolution(buf31, buf4, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf32, (4, 64, 56, 56), (200704, 3136, 56, 1))
        buf33 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_10], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_12.run(buf32, buf33, 256, 3136, grid=grid(256, 3136), stream=stream0)
        buf34 = reinterpret_tensor(buf32, (4, 64, 56, 56), (200704, 1, 3584, 64), 0); del buf32  # reuse
        # Source Nodes: [identity_2, out_11, out_12], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_14.run(buf33, primals_75, primals_76, primals_14, primals_15, buf28, buf34, 802816, grid=grid(802816), stream=stream0)
        del primals_15
        # Source Nodes: [out_14], Original ATen: [aten.convolution]
        buf35 = extern_kernels.convolution(buf34, buf5, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf35, (4, 128, 28, 28), (100352, 784, 28, 1))
        buf36 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_14], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_15.run(buf35, buf36, 512, 784, grid=grid(512, 784), stream=stream0)
        buf37 = reinterpret_tensor(buf35, (4, 128, 28, 28), (100352, 1, 3584, 128), 0); del buf35  # reuse
        # Source Nodes: [out_15, out_16], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_16.run(buf36, primals_78, primals_79, primals_17, primals_18, buf37, 401408, grid=grid(401408), stream=stream0)
        del primals_18
        ...
        assert_size_stride(buf38, (4, 128, 28, 28), (100352, 784, 28, 1))
        buf39 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_17], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_15.run(buf38, buf39, 512, 784, grid=grid(512, 784), stream=stream0)
        # Source Nodes: [getattr_l__mod___layer2___0___downsample_0], Original ATen: [aten.convolution]
        buf40 = extern_kernels.convolution(buf34, primals_22, stride=(2, 2), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf40, (4, 128, 28, 28), (100352, 784, 28, 1))
        buf41 = reinterpret_tensor(buf38, (4, 128, 28, 28), (100352, 1, 3584, 128), 0); del buf38  # reuse
        # Source Nodes: [getattr_l__mod___layer2___0___downsample_0], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_15.run(buf40, buf41, 512, 784, grid=grid(512, 784), stream=stream0)
        buf42 = reinterpret_tensor(buf40, (4, 128, 28, 28), (100352, 1, 3584, 128), 0); del buf40  # reuse
        buf43 = buf42; del buf42  # reuse
        # Source Nodes: [identity_3, identity_4, out_18, out_19], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_17.run(buf43, buf39, primals_81, primals_82, primals_20, primals_21, buf41, primals_84, primals_85, primals_23, primals_24, 401408, grid=grid(401408), stream=stream0)
        del primals_21
        del primals_24
        ...
        buf45 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_21], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_15.run(buf44, buf45, 512, 784, grid=grid(512, 784), stream=stream0)
        buf46 = reinterpret_tensor(buf44, (4, 128, 28, 28), (100352, 1, 3584, 128), 0); del buf44  # reuse
        # Source Nodes: [out_22, out_23], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_16.run(buf45, primals_87, primals_88, primals_26, primals_27, buf46, 401408, grid=grid(401408), stream=stream0)
        del primals_27
        ...
        buf48 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_24], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_15.run(buf47, buf48, 512, 784, grid=grid(512, 784), stream=stream0)
        buf49 = reinterpret_tensor(buf47, (4, 128, 28, 28), (100352, 1, 3584, 128), 0); del buf47  # reuse
        # Source Nodes: [identity_5, out_25, out_26], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_18.run(buf48, primals_90, primals_91, primals_29, primals_30, buf43, buf49, 401408, grid=grid(401408), stream=stream0)
        del primals_30
        # Source Nodes: [out_28], Original ATen: [aten.convolution]
        buf50 = extern_kernels.convolution(buf49, buf9, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf50, (4, 256, 14, 14), (50176, 196, 14, 1))
        buf51 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_28], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_19.run(buf50, buf51, 1024, 196, grid=grid(1024, 196), stream=stream0)
        buf52 = reinterpret_tensor(buf50, (4, 256, 14, 14), (50176, 1, 3584, 256), 0); del buf50  # reuse
        # Source Nodes: [out_29, out_30], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_20.run(buf51, primals_93, primals_94, primals_32, primals_33, buf52, 200704, grid=grid(200704), stream=stream0)
        del primals_33
        # Source Nodes: [out_31], Original ATen: [aten.convolution]
        buf53 = extern_kernels.convolution(buf52, buf10, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf53, (4, 256, 14, 14), (50176, 196, 14, 1))
        buf54 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_31], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_19.run(buf53, buf54, 1024, 196, grid=grid(1024, 196), stream=stream0)
        # Source Nodes: [getattr_l__mod___layer3___0___downsample_0], Original ATen: [aten.convolution]
        buf55 = extern_kernels.convolution(buf49, primals_37, stride=(2, 2), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf55, (4, 256, 14, 14), (50176, 196, 14, 1))
        buf56 = reinterpret_tensor(buf53, (4, 256, 14, 14), (50176, 1, 3584, 256), 0); del buf53  # reuse
        # Source Nodes: [getattr_l__mod___layer3___0___downsample_0], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_19.run(buf55, buf56, 1024, 196, grid=grid(1024, 196), stream=stream0)
        buf57 = reinterpret_tensor(buf55, (4, 256, 14, 14), (50176, 1, 3584, 256), 0); del buf55  # reuse
        buf58 = buf57; del buf57  # reuse
        # Source Nodes: [identity_6, identity_7, out_32, out_33], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_21.run(buf58, buf54, primals_96, primals_97, primals_35, primals_36, buf56, primals_99, primals_100, primals_38, primals_39, 200704, grid=grid(200704), stream=stream0)
        del primals_36
        del primals_39
        ...
        assert_size_stride(buf59, (4, 256, 14, 14), (50176, 196, 14, 1))
        buf60 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_35], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_19.run(buf59, buf60, 1024, 196, grid=grid(1024, 196), stream=stream0)
        buf61 = reinterpret_tensor(buf59, (4, 256, 14, 14), (50176, 1, 3584, 256), 0); del buf59  # reuse
        # Source Nodes: [out_36, out_37], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_20.run(buf60, primals_102, primals_103, primals_41, primals_42, buf61, 200704, grid=grid(200704), stream=stream0)
        del primals_42
        ...
        assert_size_stride(buf62, (4, 256, 14, 14), (50176, 196, 14, 1))
        buf63 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_38], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_19.run(buf62, buf63, 1024, 196, grid=grid(1024, 196), stream=stream0)
        buf64 = reinterpret_tensor(buf62, (4, 256, 14, 14), (50176, 1, 3584, 256), 0); del buf62  # reuse
        # Source Nodes: [identity_8, out_39, out_40], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_22.run(buf63, primals_105, primals_106, primals_44, primals_45, buf58, buf64, 200704, grid=grid(200704), stream=stream0)
        del primals_45
        # Source Nodes: [out_42], Original ATen: [aten.convolution]
        buf65 = extern_kernels.convolution(buf64, buf13, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf65, (4, 512, 7, 7), (25088, 49, 7, 1))
        buf66 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_42], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_23.run(buf65, buf66, 2048, 49, grid=grid(2048, 49), stream=stream0)
        buf67 = reinterpret_tensor(buf65, (4, 512, 7, 7), (25088, 1, 3584, 512), 0); del buf65  # reuse
        # Source Nodes: [out_43, out_44], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_24.run(buf66, primals_108, primals_109, primals_47, primals_48, buf67, 100352, grid=grid(100352), stream=stream0)
        del primals_48
        ...
        assert_size_stride(buf68, (4, 512, 7, 7), (25088, 49, 7, 1))
        buf69 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_45], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_23.run(buf68, buf69, 2048, 49, grid=grid(2048, 49), stream=stream0)
        # Source Nodes: [getattr_l__mod___layer4___0___downsample_0], Original ATen: [aten.convolution]
        buf70 = extern_kernels.convolution(buf64, primals_52, stride=(2, 2), padding=(0, 0), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf70, (4, 512, 7, 7), (25088, 49, 7, 1))
        buf71 = reinterpret_tensor(buf68, (4, 512, 7, 7), (25088, 1, 3584, 512), 0); del buf68  # reuse
        # Source Nodes: [getattr_l__mod___layer4___0___downsample_0], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_23.run(buf70, buf71, 2048, 49, grid=grid(2048, 49), stream=stream0)
        buf72 = reinterpret_tensor(buf70, (4, 512, 7, 7), (25088, 1, 3584, 512), 0); del buf70  # reuse
        buf73 = buf72; del buf72  # reuse
        # Source Nodes: [identity_10, identity_9, out_46, out_47], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_25.run(buf73, buf69, primals_111, primals_112, primals_50, primals_51, buf71, primals_114, primals_115, primals_53, primals_54, 100352, grid=grid(100352), stream=stream0)
        del primals_51
        del primals_54
        # Source Nodes: [out_49], Original ATen: [aten.convolution]
        buf74 = extern_kernels.convolution(buf73, buf15, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf74, (4, 512, 7, 7), (25088, 49, 7, 1))
        buf75 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_49], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_23.run(buf74, buf75, 2048, 49, grid=grid(2048, 49), stream=stream0)
        buf76 = reinterpret_tensor(buf74, (4, 512, 7, 7), (25088, 1, 3584, 512), 0); del buf74  # reuse
        # Source Nodes: [out_50, out_51], Original ATen: [aten._native_batch_norm_legit_no_training, aten.relu]
        triton_poi_fused__native_batch_norm_legit_no_training_relu_24.run(buf75, primals_117, primals_118, primals_56, primals_57, buf76, 100352, grid=grid(100352), stream=stream0)
        del primals_57
        # Source Nodes: [out_52], Original ATen: [aten.convolution]
        buf77 = extern_kernels.convolution(buf76, buf16, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
        assert_size_stride(buf77, (4, 512, 7, 7), (25088, 49, 7, 1))
        buf78 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [out_52], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_23.run(buf77, buf78, 2048, 49, grid=grid(2048, 49), stream=stream0)
        buf79 = reinterpret_tensor(buf77, (4, 512, 7, 7), (25088, 1, 3584, 512), 0); del buf77  # reuse
        buf83 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cuda', dtype=torch.bool)
        # Source Nodes: [out_53, out_54, x_7], Original ATen: [aten._native_batch_norm_legit_no_training, aten.add, aten.relu, aten.threshold_backward]
        triton_poi_fused__native_batch_norm_legit_no_training_add_relu_threshold_backward_26.run(buf78, primals_120, primals_121, primals_59, primals_60, buf73, buf79, buf83, 100352, grid=grid(100352), stream=stream0)
        del primals_60
        buf80 = empty_strided((4, 512, 1, 1), (512, 1, 2048, 2048), device='cuda', dtype=torch.float32)
        buf81 = reinterpret_tensor(buf80, (4, 512), (512, 1), 0); del buf80  # reuse
        # Source Nodes: [x_8, x_9], Original ATen: [aten.mean, aten.view]
        triton_per_fused_mean_view_27.run(buf81, buf79, 2048, 49, grid=grid(2048), stream=stream0)
        del buf79
        buf82 = empty((4, 1000), device='cuda', dtype=torch.float32)
        # Source Nodes: [pred], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_62, buf81, reinterpret_tensor(primals_61, (512, 1000), (1, 512), 0), alpha=1, beta=1, out=buf82)
        del primals_62
        return (buf82, buf0, primals_2, buf1, primals_5, buf2, primals_8, buf3, primals_11, buf4, primals_14, buf5, primals_17, buf6, primals_20, primals_22, primals_23, buf7, primals_26, buf8, primals_29, buf9, primals_32, buf10, primals_35, primals_37, primals_38, buf11, primals_41, buf12, primals_44, buf13, primals_47, buf14, primals_50, primals_52, primals_53, buf15, primals_56, buf16, primals_59, primals_63, primals_64, primals_66, primals_67, primals_69, primals_70, primals_72, primals_73, primals_75, primals_76, primals_78, primals_79, primals_81, primals_82, primals_84, primals_85, primals_87, primals_88, primals_90, primals_91, primals_93, primals_94, primals_96, primals_97, primals_99, primals_100, primals_102, primals_103, primals_105, primals_106, primals_108, primals_109, primals_111, primals_112, primals_114, primals_115, primals_117, primals_118, primals_120, primals_121, buf17, buf19, buf20, buf21, buf22, buf24, buf25, buf27, buf28, buf30, buf31, buf33, buf34, buf36, buf37, buf39, buf41, buf43, buf45, buf46, buf48, buf49, buf51, buf52, buf54, buf56, buf58, buf60, buf61, buf63, buf64, buf66, buf67, buf69, buf71, buf73, buf75, buf76, buf78, buf81, reinterpret_tensor(primals_61, (1000, 512), (512, 1), 0), buf83, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_123 = rand_strided((4, 3, 224, 224), (150528, 50176, 224, 1), device='cuda:0', dtype=torch.float32)
