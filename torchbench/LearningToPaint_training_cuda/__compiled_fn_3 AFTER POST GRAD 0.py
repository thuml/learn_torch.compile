...
def forward(self, primals_1: "f32[64, 9, 3, 3]", primals_2: "f32[64]", primals_3: "f32[64]", primals_4: "f32[64, 64, 3, 3]", primals_5: "f32[64]", primals_6: "f32[64]", primals_7: "f32[64, 64, 3, 3]", primals_8: "f32[64]", primals_9: "f32[64]", primals_10: "f32[64, 64, 1, 1]", primals_11: "f32[64]", primals_12: "f32[64]", primals_13: "f32[64, 64, 3, 3]", primals_14: "f32[64]", primals_15: "f32[64]", primals_16: "f32[64, 64, 3, 3]", primals_17: "f32[64]", primals_18: "f32[64]", primals_19: "f32[128, 64, 3, 3]", primals_20: "f32[128]", primals_21: "f32[128]", primals_22: "f32[128, 128, 3, 3]", primals_23: "f32[128]", primals_24: "f32[128]", primals_25: "f32[128, 64, 1, 1]", primals_26: "f32[128]", primals_27: "f32[128]", primals_28: "f32[128, 128, 3, 3]", primals_29: "f32[128]", primals_30: "f32[128]", primals_31: "f32[128, 128, 3, 3]", primals_32: "f32[128]", primals_33: "f32[128]", primals_34: "f32[256, 128, 3, 3]", primals_35: "f32[256]", primals_36: "f32[256]", primals_37: "f32[256, 256, 3, 3]", primals_38: "f32[256]", primals_39: "f32[256]", primals_40: "f32[256, 128, 1, 1]", primals_41: "f32[256]", primals_42: "f32[256]", primals_43: "f32[256, 256, 3, 3]", primals_44: "f32[256]", primals_45: "f32[256]", primals_46: "f32[256, 256, 3, 3]", primals_47: "f32[256]", primals_48: "f32[256]", primals_49: "f32[512, 256, 3, 3]", primals_50: "f32[512]", primals_51: "f32[512]", primals_52: "f32[512, 512, 3, 3]", primals_53: "f32[512]", primals_54: "f32[512]", primals_55: "f32[512, 256, 1, 1]", primals_56: "f32[512]", primals_57: "f32[512]", primals_58: "f32[512, 512, 3, 3]", primals_59: "f32[512]", primals_60: "f32[512]", primals_61: "f32[512, 512, 3, 3]", primals_62: "f32[512]", primals_63: "f32[512]", primals_64: "f32[65, 512]", primals_65: "f32[65]", primals_66: "f32[64]", primals_67: "f32[64]", primals_68: "i64[]", primals_69: "f32[64]", primals_70: "f32[64]", primals_71: "i64[]", primals_72: "f32[64]", primals_73: "f32[64]", primals_74: "i64[]", primals_75: "f32[64]", primals_76: "f32[64]", primals_77: "i64[]", primals_78: "f32[64]", primals_79: "f32[64]", primals_80: "i64[]", primals_81: "f32[64]", primals_82: "f32[64]", primals_83: "i64[]", primals_84: "f32[128]", primals_85: "f32[128]", primals_86: "i64[]", primals_87: "f32[128]", primals_88: "f32[128]", primals_89: "i64[]", primals_90: "f32[128]", primals_91: "f32[128]", primals_92: "i64[]", primals_93: "f32[128]", primals_94: "f32[128]", primals_95: "i64[]", primals_96: "f32[128]", primals_97: "f32[128]", primals_98: "i64[]", primals_99: "f32[256]", primals_100: "f32[256]", primals_101: "i64[]", primals_102: "f32[256]", primals_103: "f32[256]", primals_104: "i64[]", primals_105: "f32[256]", primals_106: "f32[256]", primals_107: "i64[]", primals_108: "f32[256]", primals_109: "f32[256]", primals_110: "i64[]", primals_111: "f32[256]", primals_112: "f32[256]", primals_113: "i64[]", primals_114: "f32[512]", primals_115: "f32[512]", primals_116: "i64[]", primals_117: "f32[512]", primals_118: "f32[512]", primals_119: "i64[]", primals_120: "f32[512]", primals_121: "f32[512]", primals_122: "i64[]", primals_123: "f32[512]", primals_124: "f32[512]", primals_125: "i64[]", primals_126: "f32[512]", primals_127: "f32[512]", primals_128: "i64[]", primals_129: "f32[4, 9, 128, 128]"):
    ...
    add: "f32[64]" = torch.ops.aten.add.Tensor(primals_67, 1e-05)
    ...
    unsqueeze: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_66, -1)
    ...
    add_2: "f32[64]" = torch.ops.aten.add.Tensor(primals_70, 1e-05)
    ...
    unsqueeze_8: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_69, -1)
    ...
    add_4: "f32[64]" = torch.ops.aten.add.Tensor(primals_73, 1e-05)
    ...
    unsqueeze_16: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_72, -1)
    ...
    add_6: "f32[64]" = torch.ops.aten.add.Tensor(primals_76, 1e-05)
    ...
    unsqueeze_24: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_75, -1)
    ...
    add_9: "f32[64]" = torch.ops.aten.add.Tensor(primals_79, 1e-05)
    ...
    unsqueeze_32: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_78, -1)
    ...
    add_11: "f32[64]" = torch.ops.aten.add.Tensor(primals_82, 1e-05)
    ...
    unsqueeze_40: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_81, -1)
    ...
    add_14: "f32[128]" = torch.ops.aten.add.Tensor(primals_85, 1e-05)
    ...
    unsqueeze_48: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_84, -1)
    ...
    add_16: "f32[128]" = torch.ops.aten.add.Tensor(primals_88, 1e-05)
    ...
    unsqueeze_56: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_87, -1)
    ...
    add_18: "f32[128]" = torch.ops.aten.add.Tensor(primals_91, 1e-05)
    ...
    unsqueeze_64: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_90, -1)
    ...
    add_21: "f32[128]" = torch.ops.aten.add.Tensor(primals_94, 1e-05)
    ...
    unsqueeze_72: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_93, -1)
    ...
    add_23: "f32[128]" = torch.ops.aten.add.Tensor(primals_97, 1e-05)
    ...
    unsqueeze_80: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_96, -1)
    ...
    add_26: "f32[256]" = torch.ops.aten.add.Tensor(primals_100, 1e-05)
    ...
    unsqueeze_88: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_99, -1)
    ...
    add_28: "f32[256]" = torch.ops.aten.add.Tensor(primals_103, 1e-05)
    ...
    unsqueeze_96: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_102, -1)
    ...
    add_30: "f32[256]" = torch.ops.aten.add.Tensor(primals_106, 1e-05)
    ...
    unsqueeze_104: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_105, -1)
    ...
    add_33: "f32[256]" = torch.ops.aten.add.Tensor(primals_109, 1e-05)
    ...
    unsqueeze_112: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_108, -1)
    ...
    add_35: "f32[256]" = torch.ops.aten.add.Tensor(primals_112, 1e-05)
    ...
    unsqueeze_120: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_111, -1)
    ...
    add_38: "f32[512]" = torch.ops.aten.add.Tensor(primals_115, 1e-05)
    ...
    unsqueeze_128: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_114, -1)
    ...
    add_40: "f32[512]" = torch.ops.aten.add.Tensor(primals_118, 1e-05)
    ...
    unsqueeze_136: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_117, -1)
    ...
    add_42: "f32[512]" = torch.ops.aten.add.Tensor(primals_121, 1e-05)
    ...
    unsqueeze_144: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_120, -1)
    ...
    add_45: "f32[512]" = torch.ops.aten.add.Tensor(primals_124, 1e-05)
    ...
    unsqueeze_152: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_123, -1)
    ...
    add_47: "f32[512]" = torch.ops.aten.add.Tensor(primals_127, 1e-05)
    ...
    unsqueeze_160: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_126, -1)
    ...
    mm_default: "f32[4, 65]" = torch.ops.aten.mm.default(view, permute)
    add_tensor: "f32[4, 65]" = torch.ops.aten.add.Tensor(mm_default, primals_65);  mm_default = primals_65 = None
