...
cpp_fused_native_layer_norm_backward_select_backward_sum_view_0 = async_compile.cpp('''
            ...
            {
                {
                    ...
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(788L); x1+=static_cast<long>(1L))
                    {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(3L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(4L); x1+=static_cast<long>(1L))
                {
                    ...
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(197L); x2+=static_cast<long>(1L))
                    {
                        ...
                        {
                            auto tmp0 = c10::convert<int>(x1 + (4L*x0));
                            auto tmp1 = static_cast<int>(0);
                            auto tmp2 = tmp0 >= tmp1;
                            auto tmp3 = static_cast<int>(4);
                            auto tmp4 = tmp0 < tmp3;
                            auto tmp5 = [&]
                            {
                                auto tmp6 = masked_load(in_ptr0 + static_cast<long>(x3 + (384L*x2) + (75648L*x1) + (302592L*x0)), to_float_mask(tmp4));
                                return tmp6;
                            }
                            ;
                            auto tmp7 = decltype(tmp5())::blendv(at::vec::Vectorized<float>(static_cast<float>(0.0)), tmp5(), to_float_mask(tmp4));
                            auto tmp8 = tmp0 >= tmp3;
                            auto tmp9 = static_cast<int>(8);
                            auto tmp10 = tmp0 < tmp9;
                            auto tmp11 = tmp8 & tmp10;
                            auto tmp12 = [&]
                            {
                                auto tmp13 = masked_load(in_ptr1 + static_cast<long>((-302592L) + x3 + (384L*x2) + (75648L*x1) + (302592L*x0)), to_float_mask(tmp11));
                                return tmp13;
                            }
                            ;
                            ...
                            auto tmp16 = static_cast<int>(12);
                            auto tmp17 = tmp0 < tmp16;
                            auto tmp18 = [&]
                            {
                                auto tmp19 = masked_load(in_ptr2 + static_cast<long>((-605184L) + x3 + (384L*x2) + (75648L*x1) + (302592L*x0)), to_float_mask(tmp15));
                                return tmp19;
                            }
                            ;
                            ...
                            tmp24.store(out_ptr0 + static_cast<long>(x3 + (384L*x0) + (1152L*x2) + (226944L*x1)));
                        }
                    }
                }
            }
                       ...
                       float* out_ptr6)
{
    #pragma omp parallel num_threads(28)
    {
        ...
        {
            {
                for(long x0=static_cast<long>(0L); x0<static_cast<long>(75648L); x0+=static_cast<long>(8L))
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(in_out_ptr0 + static_cast<long>(x0));
                    auto tmp1 = at::vec::Vectorized<float>::loadu(in_out_ptr0 + static_cast<long>(75648L + x0));
                    auto tmp3 = at::vec::Vectorized<float>::loadu(in_out_ptr0 + static_cast<long>(151296L + x0));
                    auto tmp5 = at::vec::Vectorized<float>::loadu(in_out_ptr0 + static_cast<long>(226944L + x0));
                    auto tmp2 = tmp0 + tmp1;
                    auto tmp4 = tmp2 + tmp3;
                    auto tmp6 = tmp4 + tmp5;
                    tmp6.store(out_ptr5 + static_cast<long>(x0));
                }
            }
        }
        #pragma omp single
        {
            {
                for(long x0=static_cast<long>(0L); x0<static_cast<long>(384L); x0+=static_cast<long>(8L))
                {
                    ...
                    auto tmp4 = tmp2 + tmp3;
                    auto tmp6 = tmp4 + tmp5;
                    tmp6.store(out_ptr6 + static_cast<long>(x0));
                }
            }
        }
    }
...
def call(args):
    ...
    args.clear()
    assert_size_stride(primals_3, (384, 3, 16, 16), (768, 1, 48, 3))
    ...
    assert_size_stride(getitem_6, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_18, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_19, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_20, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_22, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_50, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_51, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_52, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_54, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_66, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_67, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_68, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_70, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_82, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_83, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_84, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_86, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_98, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_99, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_100, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_102, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_115, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_116, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_118, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_130, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_131, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_132, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_134, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_146, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_147, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_148, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_150, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_162, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_163, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_164, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_166, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(getitem_178, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_179, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_180, (4, 6, 197, 64), (226944, 64, 1152, 1))
    assert_size_stride(getitem_182, (4, 6, 197), (1182, 1, 6))
    ...
    assert_size_stride(alias_12, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_13, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_14, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_15, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_16, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_17, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_18, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_19, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_20, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_21, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_22, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    assert_size_stride(alias_23, (4, 6, 197, 64), (75648, 1, 384, 6))
    ...
    buf0 = empty((4, 384), device='cpu', dtype=torch.float32)
    ...
    del addmm_46
    buf12 = empty((788, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf11, (788, 1536), (1536, 1), 0), permute_82, out=buf12)
    del permute_82
    buf13 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf11, (1536, 788), (1, 1536), 0), view_117, out=buf13)
    del view_117
    buf14 = reinterpret_tensor(buf0, (1, 1536), (1536, 1), 0); del buf0  # reuse
    ...
    buf19 = reinterpret_tensor(buf12, (4, 197, 384), (75648, 384, 1), 0); del buf12  # reuse
    ...
    del mul_79
    del primals_143
    buf20 = reinterpret_tensor(buf5, (788, 384), (384, 1), 0); del buf5  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf19, (788, 384), (384, 1), 0), permute_86, out=buf20)
    del permute_86
    buf21 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf19, (384, 788), (1, 384), 0), view_115, out=buf21)
    del view_115
    ...
    buf23 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf20, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_178, getitem_179, getitem_180, alias_12, getitem_182, getitem_183, getitem_184, 0, 0, 0.0, False, getitem_187, getitem_188)
    del alias_12
    del buf20
    del getitem_178
    del getitem_179
    ...
    buf26 = buf23[2]
    del buf23
    buf27 = empty((4, 197, 3, 6, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_4(c_void_p(buf24.data_ptr()), c_void_p(buf25.data_ptr()), c_void_p(buf26.data_ptr()), c_void_p(buf27.data_ptr()))
    del buf24
    del buf25
    buf28 = reinterpret_tensor(buf26, (788, 384), (384, 1), 0); del buf26  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (788, 1152), (1152, 1), 0), permute_92, out=buf28)
    del permute_92
    buf29 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (1152, 788), (1, 1152), 0), view_111, out=buf29)
    del view_111
    buf30 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf31 = buf16; del buf16  # reuse
    buf32 = buf15; del buf15  # reuse
    buf33 = empty((384, ), device='cpu', dtype=torch.float32)
    buf34 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_77
    del primals_137
    buf36 = reinterpret_tensor(buf11, (788, 1536), (1536, 1), 0); del buf11  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf35, (788, 384), (384, 1), 0), permute_96, out=buf36)
    del permute_96
    buf37 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf35, (384, 788), (1, 384), 0), view_109, out=buf37)
    del view_109
    buf38 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf39 = reinterpret_tensor(buf36, (4, 197, 1536), (302592, 1536, 1), 0); del buf36  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf39, (788, 1536), (1536, 1), 0), permute_100, out=buf40)
    del permute_100
    buf41 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf39, (1536, 788), (1, 1536), 0), view_107, out=buf41)
    del view_107
    buf42 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf43 = buf32; del buf32  # reuse
    buf44 = buf31; del buf31  # reuse
    buf45 = empty((384, ), device='cpu', dtype=torch.float32)
    buf46 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf47, (788, 384), (384, 1), 0), permute_104, out=buf48)
    del permute_104
    buf49 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf47, (384, 788), (1, 384), 0), view_105, out=buf49)
    del view_105
    buf50 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_8(c_void_p(buf47.data_ptr()), c_void_p(buf50.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf51 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf48, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_162, getitem_163, getitem_164, alias_13, getitem_166, getitem_167, getitem_168, 0, 0, 0.0, False, getitem_171, getitem_172)
    del alias_13
    del buf48
    del getitem_162
    del getitem_163
    ...
    del buf52
    del buf53
    buf56 = reinterpret_tensor(buf54, (788, 384), (384, 1), 0); del buf54  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf55, (788, 1152), (1152, 1), 0), permute_110, out=buf56)
    del permute_110
    buf57 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf55, (1152, 788), (1, 1152), 0), view_101, out=buf57)
    del view_101
    buf58 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf59 = buf44; del buf44  # reuse
    buf60 = buf43; del buf43  # reuse
    buf61 = empty((384, ), device='cpu', dtype=torch.float32)
    buf62 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_70
    del primals_125
    buf64 = reinterpret_tensor(buf39, (788, 1536), (1536, 1), 0); del buf39  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf63, (788, 384), (384, 1), 0), permute_114, out=buf64)
    del permute_114
    buf65 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf63, (384, 788), (1, 384), 0), view_99, out=buf65)
    del view_99
    buf66 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf67 = reinterpret_tensor(buf64, (4, 197, 1536), (302592, 1536, 1), 0); del buf64  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf67, (788, 1536), (1536, 1), 0), permute_118, out=buf68)
    del permute_118
    buf69 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf67, (1536, 788), (1, 1536), 0), view_97, out=buf69)
    del view_97
    buf70 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf71 = buf60; del buf60  # reuse
    buf72 = buf59; del buf59  # reuse
    buf73 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf75, (788, 384), (384, 1), 0), permute_122, out=buf76)
    del permute_122
    buf77 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf75, (384, 788), (1, 384), 0), view_95, out=buf77)
    del view_95
    buf78 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_13(c_void_p(buf75.data_ptr()), c_void_p(buf78.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf79 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf76, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_146, getitem_147, getitem_148, alias_14, getitem_150, getitem_151, getitem_152, 0, 0, 0.0, False, getitem_155, getitem_156)
    del alias_14
    del buf76
    del getitem_146
    del getitem_147
    ...
    del buf80
    del buf81
    buf84 = reinterpret_tensor(buf82, (788, 384), (384, 1), 0); del buf82  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf83, (788, 1152), (1152, 1), 0), permute_128, out=buf84)
    del permute_128
    buf85 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf83, (1152, 788), (1, 1152), 0), view_91, out=buf85)
    del view_91
    buf86 = empty((1, 1152), device='cpu', dtype=torch.float32)
    ...
    del mul_63
    del primals_113
    buf92 = reinterpret_tensor(buf67, (788, 1536), (1536, 1), 0); del buf67  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf91, (788, 384), (384, 1), 0), permute_132, out=buf92)
    del permute_132
    buf93 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf91, (384, 788), (1, 384), 0), view_89, out=buf93)
    del view_89
    buf94 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf95 = reinterpret_tensor(buf92, (4, 197, 1536), (302592, 1536, 1), 0); del buf92  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf95, (788, 1536), (1536, 1), 0), permute_136, out=buf96)
    del permute_136
    buf97 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf95, (1536, 788), (1, 1536), 0), view_87, out=buf97)
    del view_87
    buf98 = empty((1, 1536), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf103, (788, 384), (384, 1), 0), permute_140, out=buf104)
    del permute_140
    buf105 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf103, (384, 788), (1, 384), 0), view_85, out=buf105)
    del view_85
    buf106 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_18(c_void_p(buf103.data_ptr()), c_void_p(buf106.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf107 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf104, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_130, getitem_131, getitem_132, alias_15, getitem_134, getitem_135, getitem_136, 0, 0, 0.0, False, getitem_139, getitem_140)
    del alias_15
    del buf104
    del getitem_130
    del getitem_131
    ...
    del buf108
    del buf109
    buf112 = reinterpret_tensor(buf110, (788, 384), (384, 1), 0); del buf110  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf111, (788, 1152), (1152, 1), 0), permute_146, out=buf112)
    del permute_146
    buf113 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf111, (1152, 788), (1, 1152), 0), view_81, out=buf113)
    del view_81
    buf114 = empty((1, 1152), device='cpu', dtype=torch.float32)
    ...
    del mul_56
    del primals_101
    buf120 = reinterpret_tensor(buf95, (788, 1536), (1536, 1), 0); del buf95  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf119, (788, 384), (384, 1), 0), permute_150, out=buf120)
    del permute_150
    buf121 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf119, (384, 788), (1, 384), 0), view_79, out=buf121)
    del view_79
    buf122 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf123 = reinterpret_tensor(buf120, (4, 197, 1536), (302592, 1536, 1), 0); del buf120  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf123, (788, 1536), (1536, 1), 0), permute_154, out=buf124)
    del permute_154
    buf125 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf123, (1536, 788), (1, 1536), 0), view_77, out=buf125)
    del view_77
    buf126 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf127 = buf116; del buf116  # reuse
    buf128 = buf115; del buf115  # reuse
    buf129 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf131, (788, 384), (384, 1), 0), permute_158, out=buf132)
    del permute_158
    buf133 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf131, (384, 788), (1, 384), 0), view_75, out=buf133)
    del view_75
    buf134 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_23(c_void_p(buf131.data_ptr()), c_void_p(buf134.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf135 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf132, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_114, getitem_115, getitem_116, alias_16, getitem_118, getitem_119, getitem_120, 0, 0, 0.0, False, getitem_123, getitem_124)
    del alias_16
    del buf132
    del getitem_114
    del getitem_115
    ...
    del buf136
    del buf137
    buf140 = reinterpret_tensor(buf138, (788, 384), (384, 1), 0); del buf138  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf139, (788, 1152), (1152, 1), 0), permute_164, out=buf140)
    del permute_164
    buf141 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf139, (1152, 788), (1, 1152), 0), view_71, out=buf141)
    del view_71
    buf142 = empty((1, 1152), device='cpu', dtype=torch.float32)
    ...
    del mul_49
    del primals_89
    buf148 = reinterpret_tensor(buf123, (788, 1536), (1536, 1), 0); del buf123  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf147, (788, 384), (384, 1), 0), permute_168, out=buf148)
    del permute_168
    buf149 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf147, (384, 788), (1, 384), 0), view_69, out=buf149)
    del view_69
    buf150 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf151 = reinterpret_tensor(buf148, (4, 197, 1536), (302592, 1536, 1), 0); del buf148  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf151, (788, 1536), (1536, 1), 0), permute_172, out=buf152)
    del permute_172
    buf153 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf151, (1536, 788), (1, 1536), 0), view_67, out=buf153)
    del view_67
    buf154 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf155 = buf144; del buf144  # reuse
    buf156 = buf143; del buf143  # reuse
    buf157 = empty((384, ), device='cpu', dtype=torch.float32)
    buf158 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf159, (788, 384), (384, 1), 0), permute_176, out=buf160)
    del permute_176
    buf161 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf159, (384, 788), (1, 384), 0), view_65, out=buf161)
    del view_65
    buf162 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_28(c_void_p(buf159.data_ptr()), c_void_p(buf162.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf163 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf160, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_98, getitem_99, getitem_100, alias_17, getitem_102, getitem_103, getitem_104, 0, 0, 0.0, False, getitem_107, getitem_108)
    del alias_17
    del buf160
    del getitem_100
    del getitem_102
    ...
    del buf164
    del buf165
    buf168 = reinterpret_tensor(buf166, (788, 384), (384, 1), 0); del buf166  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf167, (788, 1152), (1152, 1), 0), permute_182, out=buf168)
    del permute_182
    buf169 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf167, (1152, 788), (1, 1152), 0), view_61, out=buf169)
    del view_61
    buf170 = empty((1, 1152), device='cpu', dtype=torch.float32)
    ...
    del mul_42
    del primals_77
    buf176 = reinterpret_tensor(buf151, (788, 1536), (1536, 1), 0); del buf151  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf175, (788, 384), (384, 1), 0), permute_186, out=buf176)
    del permute_186
    buf177 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf175, (384, 788), (1, 384), 0), view_59, out=buf177)
    del view_59
    buf178 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf179 = reinterpret_tensor(buf176, (4, 197, 1536), (302592, 1536, 1), 0); del buf176  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf179, (788, 1536), (1536, 1), 0), permute_190, out=buf180)
    del permute_190
    buf181 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf179, (1536, 788), (1, 1536), 0), view_57, out=buf181)
    del view_57
    buf182 = empty((1, 1536), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf187, (788, 384), (384, 1), 0), permute_194, out=buf188)
    del permute_194
    buf189 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf187, (384, 788), (1, 384), 0), view_55, out=buf189)
    del view_55
    buf190 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_33(c_void_p(buf187.data_ptr()), c_void_p(buf190.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf191 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf188, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_82, getitem_83, getitem_84, alias_18, getitem_86, getitem_87, getitem_88, 0, 0, 0.0, False, getitem_91, getitem_92)
    del alias_18
    del buf188
    del getitem_82
    del getitem_83
    ...
    del buf192
    del buf193
    buf196 = reinterpret_tensor(buf194, (788, 384), (384, 1), 0); del buf194  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf195, (788, 1152), (1152, 1), 0), permute_200, out=buf196)
    del permute_200
    buf197 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf195, (1152, 788), (1, 1152), 0), view_51, out=buf197)
    del view_51
    buf198 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf199 = buf184; del buf184  # reuse
    buf200 = buf183; del buf183  # reuse
    buf201 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_35
    del primals_65
    buf204 = reinterpret_tensor(buf179, (788, 1536), (1536, 1), 0); del buf179  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf203, (788, 384), (384, 1), 0), permute_204, out=buf204)
    del permute_204
    buf205 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf203, (384, 788), (1, 384), 0), view_49, out=buf205)
    del view_49
    buf206 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf207 = reinterpret_tensor(buf204, (4, 197, 1536), (302592, 1536, 1), 0); del buf204  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf207, (788, 1536), (1536, 1), 0), permute_208, out=buf208)
    del permute_208
    buf209 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf207, (1536, 788), (1, 1536), 0), view_47, out=buf209)
    del view_47
    buf210 = empty((1, 1536), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf215, (788, 384), (384, 1), 0), permute_212, out=buf216)
    del permute_212
    buf217 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf215, (384, 788), (1, 384), 0), view_45, out=buf217)
    del view_45
    buf218 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_38(c_void_p(buf215.data_ptr()), c_void_p(buf218.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf219 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf216, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_66, getitem_67, getitem_68, alias_19, getitem_70, getitem_71, getitem_72, 0, 0, 0.0, False, getitem_75, getitem_76)
    del alias_19
    del buf216
    del getitem_66
    del getitem_67
    ...
    del buf220
    del buf221
    buf224 = reinterpret_tensor(buf222, (788, 384), (384, 1), 0); del buf222  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf223, (788, 1152), (1152, 1), 0), permute_218, out=buf224)
    del permute_218
    buf225 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf223, (1152, 788), (1, 1152), 0), view_41, out=buf225)
    del view_41
    buf226 = empty((1, 1152), device='cpu', dtype=torch.float32)
    ...
    del mul_28
    del primals_53
    buf232 = reinterpret_tensor(buf207, (788, 1536), (1536, 1), 0); del buf207  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf231, (788, 384), (384, 1), 0), permute_222, out=buf232)
    del permute_222
    buf233 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf231, (384, 788), (1, 384), 0), view_39, out=buf233)
    del view_39
    buf234 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf235 = reinterpret_tensor(buf232, (4, 197, 1536), (302592, 1536, 1), 0); del buf232  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf235, (788, 1536), (1536, 1), 0), permute_226, out=buf236)
    del permute_226
    buf237 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf235, (1536, 788), (1, 1536), 0), view_37, out=buf237)
    del view_37
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf243, (788, 384), (384, 1), 0), permute_230, out=buf244)
    del permute_230
    buf245 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf243, (384, 788), (1, 384), 0), view_35, out=buf245)
    del view_35
    buf246 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_43(c_void_p(buf243.data_ptr()), c_void_p(buf246.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf247 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf244, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_50, getitem_51, getitem_52, alias_20, getitem_54, getitem_55, getitem_56, 0, 0, 0.0, False, getitem_59, getitem_60)
    del alias_20
    del buf244
    del getitem_50
    del getitem_51
    ...
    del buf248
    del buf249
    buf252 = reinterpret_tensor(buf250, (788, 384), (384, 1), 0); del buf250  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf251, (788, 1152), (1152, 1), 0), permute_236, out=buf252)
    del permute_236
    buf253 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf251, (1152, 788), (1, 1152), 0), view_31, out=buf253)
    del view_31
    buf254 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf255 = buf240; del buf240  # reuse
    buf256 = buf239; del buf239  # reuse
    buf257 = empty((384, ), device='cpu', dtype=torch.float32)
    buf258 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_21
    del primals_41
    buf260 = reinterpret_tensor(buf235, (788, 1536), (1536, 1), 0); del buf235  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf259, (788, 384), (384, 1), 0), permute_240, out=buf260)
    del permute_240
    buf261 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf259, (384, 788), (1, 384), 0), view_29, out=buf261)
    del view_29
    buf262 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf263 = reinterpret_tensor(buf260, (4, 197, 1536), (302592, 1536, 1), 0); del buf260  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf263, (788, 1536), (1536, 1), 0), permute_244, out=buf264)
    del permute_244
    buf265 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf263, (1536, 788), (1, 1536), 0), view_27, out=buf265)
    del view_27
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf271, (788, 384), (384, 1), 0), permute_248, out=buf272)
    del permute_248
    buf273 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf271, (384, 788), (1, 384), 0), view_25, out=buf273)
    del view_25
    buf274 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_48(c_void_p(buf271.data_ptr()), c_void_p(buf274.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf275 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf272, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_34, getitem_35, getitem_36, alias_21, getitem_38, getitem_39, getitem_40, 0, 0, 0.0, False, getitem_43, getitem_44)
    del alias_21
    del buf272
    del getitem_34
    del getitem_35
    ...
    del buf276
    del buf277
    buf280 = reinterpret_tensor(buf278, (788, 384), (384, 1), 0); del buf278  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf279, (788, 1152), (1152, 1), 0), permute_254, out=buf280)
    del permute_254
    buf281 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf279, (1152, 788), (1, 1152), 0), view_21, out=buf281)
    del view_21
    buf282 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf283 = buf268; del buf268  # reuse
    buf284 = buf267; del buf267  # reuse
    buf285 = empty((384, ), device='cpu', dtype=torch.float32)
    buf286 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_14
    del primals_29
    buf288 = reinterpret_tensor(buf263, (788, 1536), (1536, 1), 0); del buf263  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf287, (788, 384), (384, 1), 0), permute_258, out=buf288)
    del permute_258
    buf289 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf287, (384, 788), (1, 384), 0), view_19, out=buf289)
    del view_19
    buf290 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf291 = reinterpret_tensor(buf288, (4, 197, 1536), (302592, 1536, 1), 0); del buf288  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf291, (788, 1536), (1536, 1), 0), permute_262, out=buf292)
    del permute_262
    buf293 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf291, (1536, 788), (1, 1536), 0), view_17, out=buf293)
    del view_17
    buf294 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf295 = buf284; del buf284  # reuse
    buf296 = buf283; del buf283  # reuse
    buf297 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf299, (788, 384), (384, 1), 0), permute_266, out=buf300)
    del permute_266
    buf301 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf299, (384, 788), (1, 384), 0), view_15, out=buf301)
    del view_15
    buf302 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_53(c_void_p(buf299.data_ptr()), c_void_p(buf302.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf303 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf300, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_18, getitem_19, getitem_20, alias_22, getitem_22, getitem_23, getitem_24, 0, 0, 0.0, False, getitem_27, getitem_28)
    del alias_22
    del buf300
    del getitem_18
    del getitem_19
    ...
    del buf304
    del buf305
    buf308 = reinterpret_tensor(buf306, (788, 384), (384, 1), 0); del buf306  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf307, (788, 1152), (1152, 1), 0), permute_272, out=buf308)
    del permute_272
    buf309 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf307, (1152, 788), (1, 1152), 0), view_11, out=buf309)
    del view_11
    buf310 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf311 = buf296; del buf296  # reuse
    buf312 = buf295; del buf295  # reuse
    buf313 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    del mul_7
    del primals_17
    buf316 = reinterpret_tensor(buf291, (788, 1536), (1536, 1), 0); del buf291  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf315, (788, 384), (384, 1), 0), permute_276, out=buf316)
    del permute_276
    buf317 = empty((384, 1536), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf315, (384, 788), (1, 384), 0), view_9, out=buf317)
    del view_9
    buf318 = empty((1, 384), device='cpu', dtype=torch.float32)
    buf319 = reinterpret_tensor(buf316, (4, 197, 1536), (302592, 1536, 1), 0); del buf316  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf319, (788, 1536), (1536, 1), 0), permute_280, out=buf320)
    del permute_280
    buf321 = empty((1536, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf319, (1536, 788), (1, 1536), 0), view_7, out=buf321)
    del view_7
    buf322 = empty((1, 1536), device='cpu', dtype=torch.float32)
    buf323 = buf312; del buf312  # reuse
    buf324 = buf311; del buf311  # reuse
    buf325 = empty((384, ), device='cpu', dtype=torch.float32)
    buf326 = empty((384, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf327, (788, 384), (384, 1), 0), permute_284, out=buf328)
    del permute_284
    buf329 = empty((384, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf327, (384, 788), (1, 384), 0), view_5, out=buf329)
    del view_5
    buf330 = empty((1, 384), device='cpu', dtype=torch.float32)
    cpp_fused_sum_58(c_void_p(buf327.data_ptr()), c_void_p(buf330.data_ptr()))
    # Source Nodes: [], Original ATen: [aten._scaled_dot_product_flash_attention_backward]
    buf331 = aten._scaled_dot_product_flash_attention_backward(reinterpret_tensor(buf328, (4, 6, 197, 64), (75648, 64, 384, 1), 0), getitem_2, getitem_3, getitem_4, alias_23, getitem_6, getitem_7, getitem_8, 0, 0, 0.0, False, getitem_11, getitem_12)
    del alias_23
    del buf328
    del getitem_11
    del getitem_12
    ...
    del buf332
    del buf333
    buf336 = reinterpret_tensor(buf334, (788, 384), (384, 1), 0); del buf334  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf335, (788, 1152), (1152, 1), 0), permute_290, out=buf336)
    del permute_290
    buf337 = empty((1152, 384), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf335, (1152, 788), (1, 1152), 0), view_1, out=buf337)
    del view_1
    buf338 = empty((1, 1152), device='cpu', dtype=torch.float32)
    buf339 = buf324; del buf324  # reuse
    buf340 = buf323; del buf323  # reuse
    buf341 = empty((384, ), device='cpu', dtype=torch.float32)
    buf342 = empty((384, ), device='cpu', dtype=torch.float32)
    buf343 = buf327; del buf327  # reuse
    buf344 = empty((1, 197, 384), device='cpu', dtype=torch.float32)
    buf345 = empty((1, 1, 384), device='cpu', dtype=torch.float32)
    ...
    buf346 = aten.convolution_backward(reinterpret_tensor(buf343, (4, 384, 14, 14), (75648, 1, 5376, 384), 384), primals_153, primals_3, [384], [16, 16], [0, 0], [1, 1], False, [0, 0], 1, [False, True, True])
    del buf343
    del primals_153
    del primals_3
    buf347 = buf346[1]
    buf348 = buf346[2]
    return (buf344, buf345, buf347, buf348, buf341, buf342, reinterpret_tensor(buf337, (1152, 384), (384, 1), 0), reinterpret_tensor(buf338, (1152, ), (1, ), 0), reinterpret_tensor(buf329, (384, 384), (384, 1), 0), reinterpret_tensor(buf330, (384, ), (1, ), 0), buf325, buf326, reinterpret_tensor(buf321, (1536, 384), (384, 1), 0), reinterpret_tensor(buf322, (1536, ), (1, ), 0), reinterpret_tensor(buf317, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf318, (384, ), (1, ), 0), buf313, buf314, reinterpret_tensor(buf309, (1152, 384), (384, 1), 0), reinterpret_tensor(buf310, (1152, ), (1, ), 0), reinterpret_tensor(buf301, (384, 384), (384, 1), 0), reinterpret_tensor(buf302, (384, ), (1, ), 0), buf297, buf298, reinterpret_tensor(buf293, (1536, 384), (384, 1), 0), reinterpret_tensor(buf294, (1536, ), (1, ), 0), reinterpret_tensor(buf289, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf290, (384, ), (1, ), 0), buf285, buf286, reinterpret_tensor(buf281, (1152, 384), (384, 1), 0), reinterpret_tensor(buf282, (1152, ), (1, ), 0), reinterpret_tensor(buf273, (384, 384), (384, 1), 0), reinterpret_tensor(buf274, (384, ), (1, ), 0), buf269, buf270, reinterpret_tensor(buf265, (1536, 384), (384, 1), 0), reinterpret_tensor(buf266, (1536, ), (1, ), 0), reinterpret_tensor(buf261, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf262, (384, ), (1, ), 0), buf257, buf258, reinterpret_tensor(buf253, (1152, 384), (384, 1), 0), reinterpret_tensor(buf254, (1152, ), (1, ), 0), reinterpret_tensor(buf245, (384, 384), (384, 1), 0), reinterpret_tensor(buf246, (384, ), (1, ), 0), buf241, buf242, reinterpret_tensor(buf237, (1536, 384), (384, 1), 0), reinterpret_tensor(buf238, (1536, ), (1, ), 0), reinterpret_tensor(buf233, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf234, (384, ), (1, ), 0), buf229, buf230, reinterpret_tensor(buf225, (1152, 384), (384, 1), 0), reinterpret_tensor(buf226, (1152, ), (1, ), 0), reinterpret_tensor(buf217, (384, 384), (384, 1), 0), reinterpret_tensor(buf218, (384, ), (1, ), 0), buf213, buf214, reinterpret_tensor(buf209, (1536, 384), (384, 1), 0), reinterpret_tensor(buf210, (1536, ), (1, ), 0), reinterpret_tensor(buf205, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf206, (384, ), (1, ), 0), buf201, buf202, reinterpret_tensor(buf197, (1152, 384), (384, 1), 0), reinterpret_tensor(buf198, (1152, ), (1, ), 0), reinterpret_tensor(buf189, (384, 384), (384, 1), 0), reinterpret_tensor(buf190, (384, ), (1, ), 0), buf185, buf186, reinterpret_tensor(buf181, (1536, 384), (384, 1), 0), reinterpret_tensor(buf182, (1536, ), (1, ), 0), reinterpret_tensor(buf177, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf178, (384, ), (1, ), 0), buf173, buf174, reinterpret_tensor(buf169, (1152, 384), (384, 1), 0), reinterpret_tensor(buf170, (1152, ), (1, ), 0), reinterpret_tensor(buf161, (384, 384), (384, 1), 0), reinterpret_tensor(buf162, (384, ), (1, ), 0), buf157, buf158, reinterpret_tensor(buf153, (1536, 384), (384, 1), 0), reinterpret_tensor(buf154, (1536, ), (1, ), 0), reinterpret_tensor(buf149, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf150, (384, ), (1, ), 0), buf145, buf146, reinterpret_tensor(buf141, (1152, 384), (384, 1), 0), reinterpret_tensor(buf142, (1152, ), (1, ), 0), reinterpret_tensor(buf133, (384, 384), (384, 1), 0), reinterpret_tensor(buf134, (384, ), (1, ), 0), buf129, buf130, reinterpret_tensor(buf125, (1536, 384), (384, 1), 0), reinterpret_tensor(buf126, (1536, ), (1, ), 0), reinterpret_tensor(buf121, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf122, (384, ), (1, ), 0), buf117, buf118, reinterpret_tensor(buf113, (1152, 384), (384, 1), 0), reinterpret_tensor(buf114, (1152, ), (1, ), 0), reinterpret_tensor(buf105, (384, 384), (384, 1), 0), reinterpret_tensor(buf106, (384, ), (1, ), 0), buf101, buf102, reinterpret_tensor(buf97, (1536, 384), (384, 1), 0), reinterpret_tensor(buf98, (1536, ), (1, ), 0), reinterpret_tensor(buf93, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf94, (384, ), (1, ), 0), buf89, buf90, reinterpret_tensor(buf85, (1152, 384), (384, 1), 0), reinterpret_tensor(buf86, (1152, ), (1, ), 0), reinterpret_tensor(buf77, (384, 384), (384, 1), 0), reinterpret_tensor(buf78, (384, ), (1, ), 0), buf73, buf74, reinterpret_tensor(buf69, (1536, 384), (384, 1), 0), reinterpret_tensor(buf70, (1536, ), (1, ), 0), reinterpret_tensor(buf65, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf66, (384, ), (1, ), 0), buf61, buf62, reinterpret_tensor(buf57, (1152, 384), (384, 1), 0), reinterpret_tensor(buf58, (1152, ), (1, ), 0), reinterpret_tensor(buf49, (384, 384), (384, 1), 0), reinterpret_tensor(buf50, (384, ), (1, ), 0), buf45, buf46, reinterpret_tensor(buf41, (1536, 384), (384, 1), 0), reinterpret_tensor(buf42, (1536, ), (1, ), 0), reinterpret_tensor(buf37, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf38, (384, ), (1, ), 0), buf33, buf34, reinterpret_tensor(buf29, (1152, 384), (384, 1), 0), reinterpret_tensor(buf30, (1152, ), (1, ), 0), reinterpret_tensor(buf21, (384, 384), (384, 1), 0), reinterpret_tensor(buf22, (384, ), (1, ), 0), buf17, buf18, reinterpret_tensor(buf13, (1536, 384), (384, 1), 0), reinterpret_tensor(buf14, (1536, ), (1, ), 0), reinterpret_tensor(buf9, (384, 1536), (1536, 1), 0), reinterpret_tensor(buf10, (384, ), (1, ), 0), buf6, buf7, reinterpret_tensor(buf1, (1000, 384), (384, 1), 0), buf2, None, )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_3 = rand_strided((384, 3, 16, 16), (768, 1, 48, 3), device='cpu', dtype=torch.float32)
    primals_5 = rand_strided((384, ), (1, ), device='cpu', dtype=torch.float32)
    primals_11 = rand_strided((384, ), (1, ), device='cpu', dtype=torch.float32)
    primals_17 = rand_strided((384, ), (1, ), device='cpu', dtype=torch.float32)
    ...
    mul = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_1 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_2 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_3 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_4 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_6 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_5 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_2 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_7 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_2 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_9 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_7 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_11 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_18 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_19 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_20 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_22 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_15 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_9 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_17 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_6 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_19 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_14 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_21 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_34 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_35 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_36 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_38 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_25 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_16 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_27 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_10 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_29 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_21 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_31 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_50 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_51 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_52 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_54 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_35 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_23 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_37 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_14 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_39 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_28 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_41 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_66 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_67 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_68 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_70 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_45 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_30 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_47 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_18 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_49 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_35 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_51 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_82 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_83 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_84 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_86 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_55 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_37 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_57 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_22 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_59 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_42 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_61 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_98 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_99 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_100 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_102 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_65 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_44 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_67 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_26 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_69 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_49 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_71 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_114 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_115 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_116 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_118 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_75 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_51 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_77 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_30 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_79 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_56 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_81 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_130 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_131 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_132 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_134 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_85 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_58 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_87 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_34 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_89 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_63 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_91 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_146 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_147 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_148 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_150 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_95 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_65 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_97 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_38 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_99 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_70 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_101 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_162 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_163 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_164 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_166 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_105 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_72 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_107 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_42 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_109 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_77 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_111 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    getitem_178 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_179 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_180 = rand_strided((4, 6, 197, 64), (226944, 64, 1152, 1), device='cpu', dtype=torch.float32)
    getitem_182 = rand_strided((4, 6, 197), (1182, 1, 6), device='cpu', dtype=torch.float32)
    ...
    view_115 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    mul_79 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    view_117 = rand_strided((788, 384), (384, 1), device='cpu', dtype=torch.float32)
    addmm_46 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    view_119 = rand_strided((788, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    mul_84 = rand_strided((4, 197, 384), (75648, 384, 1), device='cpu', dtype=torch.float32)
    clone_37 = rand_strided((4, 384), (384, 1), device='cpu', dtype=torch.float32)
    permute_74 = rand_strided((1000, 384), (384, 1), device='cpu', dtype=torch.float32)
    div = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_78 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_82 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_1 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_86 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_12 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_92 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_2 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_96 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_100 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_3 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_104 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_13 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_110 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_4 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_114 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_118 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_5 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_122 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_14 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_128 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_6 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_132 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_136 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_7 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_140 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_15 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_146 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_8 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_150 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_154 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_9 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_158 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_16 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_164 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_10 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_168 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_172 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_11 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_176 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_17 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_182 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_12 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_186 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_190 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_13 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_194 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_18 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_200 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_14 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_204 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_208 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_15 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_212 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_19 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_218 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_16 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_222 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_226 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_17 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_230 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_20 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_236 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_18 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_240 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_244 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_19 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_248 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_21 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_254 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_20 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_258 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_262 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_21 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_266 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_22 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_272 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_22 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_276 = rand_strided((384, 1536), (1536, 1), device='cpu', dtype=torch.float32)
    permute_280 = rand_strided((1536, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_23 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
    permute_284 = rand_strided((384, 384), (384, 1), device='cpu', dtype=torch.float32)
    alias_23 = rand_strided((4, 6, 197, 64), (75648, 1, 384, 6), device='cpu', dtype=torch.float32)
    permute_290 = rand_strided((1152, 384), (384, 1), device='cpu', dtype=torch.float32)
    div_24 = rand_strided((4, 197, 1), (197, 1, 1), device='cpu', dtype=torch.float32)
