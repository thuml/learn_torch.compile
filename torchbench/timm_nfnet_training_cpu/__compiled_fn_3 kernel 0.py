...
def call(args):
    ...
    buf28 = empty_strided((4, 3, 193, 193), (111747, 1, 579, 3), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf34, (4, 16, 96, 96), (147456, 1, 1536, 16))
    del primals_3
    buf35 = empty_strided((4, 16, 96, 96), (147456, 1, 1536, 16), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf41, (4, 32, 96, 96), (294912, 1, 3072, 32))
    del primals_6
    buf42 = empty_strided((4, 32, 96, 96), (294912, 1, 3072, 32), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf48, (4, 64, 96, 96), (589824, 1, 6144, 64))
    del primals_9
    buf49 = empty_strided((4, 64, 97, 97), (602176, 1, 6208, 64), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf55, (4, 128, 48, 48), (294912, 1, 6144, 128))
    del primals_12
    buf56 = empty_strided((4, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf62, (4, 256, 48, 48), (589824, 1, 12288, 256))
    del primals_15
    ...
    assert_size_stride(buf68, (4, 128, 48, 48), (294912, 1, 6144, 128))
    del primals_18
    buf69 = empty_strided((4, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf75, (4, 128, 48, 48), (294912, 1, 6144, 128))
    del primals_21
    buf76 = empty_strided((4, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf82, (4, 128, 48, 48), (294912, 1, 6144, 128))
    del primals_24
    buf83 = empty_strided((4, 128, 48, 48), (294912, 1, 6144, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf89, (4, 256, 48, 48), (589824, 1, 12288, 256))
    del primals_27
    buf90 = empty_strided((4, 256, 1, 1), (256, 1, 1024, 1024), device='cpu', dtype=torch.float32)
    buf91 = reinterpret_tensor(buf90, (4, 256, 1, 1), (256, 1, 256, 256), 0); del buf90  # reuse
    ...
    assert_size_stride(buf92, (4, 128, 1, 1), (128, 1, 128, 128))
    del primals_185
    ...
    assert_size_stride(buf94, (4, 256, 1, 1), (256, 1, 256, 256))
    del primals_187
    buf95 = empty_strided((4, 256, 48, 48), (589824, 1, 12288, 256), device='cpu', dtype=torch.float32)
    buf96 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf102, (4, 512, 24, 24), (294912, 1, 12288, 512))
    del primals_31
    ...
    assert_size_stride(buf108, (4, 256, 48, 48), (589824, 1, 12288, 256))
    del primals_34
    buf109 = empty_strided((4, 256, 49, 49), (614656, 1, 12544, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf115, (4, 256, 24, 24), (147456, 1, 6144, 256))
    del primals_37
    buf116 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf122, (4, 256, 24, 24), (147456, 1, 6144, 256))
    del primals_40
    buf123 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf129, (4, 512, 24, 24), (294912, 1, 12288, 512))
    del primals_43
    buf130 = empty_strided((4, 512, 1, 1), (512, 1, 2048, 2048), device='cpu', dtype=torch.float32)
    buf131 = reinterpret_tensor(buf130, (4, 512, 1, 1), (512, 1, 512, 512), 0); del buf130  # reuse
    ...
    assert_size_stride(buf132, (4, 256, 1, 1), (256, 1, 256, 256))
    del primals_189
    ...
    del primals_191
    buf135 = empty_strided((4, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf141, (4, 256, 24, 24), (147456, 1, 6144, 256))
    del primals_47
    buf142 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf148, (4, 256, 24, 24), (147456, 1, 6144, 256))
    del primals_50
    buf149 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf155, (4, 256, 24, 24), (147456, 1, 6144, 256))
    del primals_53
    buf156 = empty_strided((4, 256, 24, 24), (147456, 1, 6144, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf162, (4, 512, 24, 24), (294912, 1, 12288, 512))
    del primals_56
    buf163 = empty_strided((4, 512, 1, 1), (512, 1, 2048, 2048), device='cpu', dtype=torch.float32)
    buf164 = reinterpret_tensor(buf163, (4, 512, 1, 1), (512, 1, 512, 512), 0); del buf163  # reuse
    ...
    assert_size_stride(buf167, (4, 512, 1, 1), (512, 1, 512, 512))
    del primals_195
    buf168 = empty_strided((4, 512, 24, 24), (294912, 1, 12288, 512), device='cpu', dtype=torch.float32)
    buf169 = buf168; del buf168  # reuse
    buf170 = empty_strided((4, 512, 12, 12), (73728, 1, 6144, 512), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf176, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_60
    ...
    assert_size_stride(buf182, (4, 768, 24, 24), (442368, 1, 18432, 768))
    del primals_63
    buf183 = empty_strided((4, 768, 25, 25), (480000, 1, 19200, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf189, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_66
    buf190 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf196, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_69
    buf197 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf203, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_72
    buf204 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf205 = reinterpret_tensor(buf204, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf204  # reuse
    ...
    assert_size_stride(buf206, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_197
    ...
    assert_size_stride(buf208, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_199
    buf209 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf215, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_76
    buf216 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf222, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_79
    buf223 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf229, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_82
    buf230 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf236, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_85
    buf237 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf238 = reinterpret_tensor(buf237, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf237  # reuse
    ...
    assert_size_stride(buf239, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_201
    ...
    assert_size_stride(buf241, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_203
    buf242 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    buf243 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf249, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_89
    buf250 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf256, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_92
    buf257 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf263, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_95
    buf264 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf270, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_98
    buf271 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf272 = reinterpret_tensor(buf271, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf271  # reuse
    ...
    assert_size_stride(buf273, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_205
    ...
    assert_size_stride(buf275, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_207
    buf276 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf282, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_102
    buf283 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf289, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_105
    buf290 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf296, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_108
    buf297 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf303, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_111
    buf304 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf305 = reinterpret_tensor(buf304, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf304  # reuse
    ...
    assert_size_stride(buf306, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_209
    ...
    buf310 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf316, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_115
    buf317 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf323, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_118
    buf324 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf330, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_121
    buf331 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf337, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_124
    buf338 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf339 = reinterpret_tensor(buf338, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf338  # reuse
    ...
    assert_size_stride(buf340, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_213
    ...
    assert_size_stride(buf342, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_215
    buf343 = empty_strided((4, 1536, 12, 12), (221184, 1, 18432, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf349, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_128
    buf350 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf356, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_131
    buf357 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf363, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_134
    buf364 = empty_strided((4, 768, 12, 12), (110592, 1, 9216, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf370, (4, 1536, 12, 12), (221184, 1, 18432, 1536))
    del primals_137
    buf371 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf372 = reinterpret_tensor(buf371, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf371  # reuse
    ...
    assert_size_stride(buf373, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_217
    ...
    assert_size_stride(buf375, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_219
    buf376 = buf309; del buf309  # reuse
    buf377 = buf376; del buf376  # reuse
    buf378 = empty_strided((4, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf384, (4, 1536, 6, 6), (55296, 1, 9216, 1536))
    del primals_141
    ...
    assert_size_stride(buf390, (4, 768, 12, 12), (110592, 1, 9216, 768))
    del primals_144
    buf391 = empty_strided((4, 768, 13, 13), (129792, 1, 9984, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf397, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_147
    buf398 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf404, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_150
    buf405 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf411, (4, 1536, 6, 6), (55296, 1, 9216, 1536))
    del primals_153
    buf412 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf414, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_221
    ...
    assert_size_stride(buf416, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_223
    buf417 = empty_strided((4, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf423, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_157
    buf424 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf430, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_160
    buf431 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf437, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_163
    buf438 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf444, (4, 1536, 6, 6), (55296, 1, 9216, 1536))
    del primals_166
    buf445 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf446 = reinterpret_tensor(buf445, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf445  # reuse
    ...
    assert_size_stride(buf447, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_225
    ...
    assert_size_stride(buf449, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_227
    buf450 = empty_strided((4, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    buf451 = empty_strided((4, 1536, 6, 6), (55296, 1, 9216, 1536), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf457, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_170
    buf458 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf464, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_173
    buf465 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf471, (4, 768, 6, 6), (27648, 1, 4608, 768))
    del primals_176
    buf472 = empty_strided((4, 768, 6, 6), (27648, 1, 4608, 768), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf478, (4, 1536, 6, 6), (55296, 1, 9216, 1536))
    del primals_179
    buf479 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cpu', dtype=torch.float32)
    buf480 = reinterpret_tensor(buf479, (4, 1536, 1, 1), (1536, 1, 1536, 1536), 0); del buf479  # reuse
    ...
    assert_size_stride(buf481, (4, 768, 1, 1), (768, 1, 768, 768))
    del primals_229
    ...
    assert_size_stride(buf483, (4, 1536, 1, 1), (1536, 1, 1536, 1536))
    del primals_231
    ...
    assert_size_stride(buf490, (4, 3072, 6, 6), (110592, 1, 18432, 3072))
    del primals_183
    buf491 = empty_strided((4, 3072, 1, 1), (3072, 1, 12288, 12288), device='cpu', dtype=torch.float32)
    buf492 = reinterpret_tensor(buf491, (4, 3072), (3072, 1), 0); del buf491  # reuse
    cpp_fused_gelu_mean_mul_view_81(c_void_p(buf492.data_ptr()), c_void_p(buf490.data_ptr()))
    buf493 = empty((4, 1000), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_234 = rand_strided((4, 3, 192, 192), (110592, 36864, 192, 1), device='cpu', dtype=torch.float32)
