...
def __guard_0_for_sgd(L):
    return (___guarded_code.valid) \
        ...
        and (len(L['momentum_buffer_list']) == 52) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140420512686304))) \
        and (___compile_config_hash() == '8363b663b487e6f95cb822a3898d1b3f') \
        and (not ___needs_nopython()) \
        and (___check_tensors(L['params'][0], L['params'][1], L['params'][2], L['params'][3], L['params'][4], L['params'][5], L['params'][6], L['params'][7], L['params'][8], L['params'][9], L['params'][10], L['params'][11], L['params'][12], L['params'][13], L['params'][14], L['params'][15], L['params'][16], L['params'][17], L['params'][18], L['params'][19], L['params'][20], L['params'][21], L['params'][22], L['params'][23], L['params'][24], L['params'][25], L['params'][26], L['params'][27], L['params'][28], L['params'][29], L['params'][30], L['params'][31], L['params'][32], L['params'][33], L['params'][34], L['params'][35], L['params'][36], L['params'][37], L['params'][38], L['params'][39], L['params'][40], L['params'][41], L['params'][42], L['params'][43], L['params'][44], L['params'][45], L['params'][46], L['params'][47], L['params'][48], L['params'][49], L['params'][50], L['params'][51], L['d_p_list'][0], L['d_p_list'][1], L['d_p_list'][2], L['d_p_list'][3], L['d_p_list'][4], L['d_p_list'][5], L['d_p_list'][6], L['d_p_list'][7], L['d_p_list'][8], L['d_p_list'][9], L['d_p_list'][10], L['d_p_list'][11], L['d_p_list'][12], L['d_p_list'][13], L['d_p_list'][14], L['d_p_list'][15], L['d_p_list'][16], L['d_p_list'][17], L['d_p_list'][18], L['d_p_list'][19], L['d_p_list'][20], L['d_p_list'][21], L['d_p_list'][22], L['d_p_list'][23], L['d_p_list'][24], L['d_p_list'][25], L['d_p_list'][26], L['d_p_list'][27], L['d_p_list'][28], L['d_p_list'][29], L['d_p_list'][30], L['d_p_list'][31], L['d_p_list'][32], L['d_p_list'][33], L['d_p_list'][34], L['d_p_list'][35], L['d_p_list'][36], L['d_p_list'][37], L['d_p_list'][38], L['d_p_list'][39], L['d_p_list'][40], L['d_p_list'][41], L['d_p_list'][42], L['d_p_list'][43], L['d_p_list'][44], L['d_p_list'][45], L['d_p_list'][46], L['d_p_list'][47], L['d_p_list'][48], L['d_p_list'][49], L['d_p_list'][50], L['d_p_list'][51], tensor_check_names=tensor_check_names))
