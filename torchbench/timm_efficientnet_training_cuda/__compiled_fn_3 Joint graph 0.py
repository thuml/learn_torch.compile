...
def forward(self, primals, tangents):
    ...
    full: "f32[4, 1280, 7, 7]" = torch.ops.aten.full.default([4, 1280, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_49: "f32[4, 1280, 7, 7]" = torch.ops.aten.sub.Tensor(full, sigmoid_65);  full = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_7: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_234, [0, 2, 3])
    convolution_backward_2 = torch.ops.aten.convolution_backward.default(mul_234, mul_203, primals_208, [1152], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_234 = mul_203 = primals_208 = None
    getitem_6: "f32[4, 48, 1, 1]" = convolution_backward_2[0]
    getitem_7: "f32[1152, 48, 1, 1]" = convolution_backward_2[1];  convolution_backward_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_66: "f32[4, 48, 1, 1]" = torch.ops.aten.sigmoid.default(clone_47)
    full_1: "f32[4, 48, 1, 1]" = torch.ops.aten.full.default([4, 48, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_53: "f32[4, 48, 1, 1]" = torch.ops.aten.sub.Tensor(full_1, sigmoid_66);  full_1 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_8: "f32[48]" = torch.ops.aten.sum.dim_IntList(mul_237, [0, 2, 3])
    convolution_backward_3 = torch.ops.aten.convolution_backward.default(mul_237, mean_15, primals_206, [48], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_237 = mean_15 = primals_206 = None
    getitem_9: "f32[4, 1152, 1, 1]" = convolution_backward_3[0]
    getitem_10: "f32[48, 1152, 1, 1]" = convolution_backward_3[1];  convolution_backward_3 = None
    ...
    full_2: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_54: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_2, sigmoid_67);  full_2 = None
    ...
    sum_9: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_240, [0, 2, 3])
    ...
    sum_10: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_241, [0, 2, 3]);  mul_241 = None
    ...
    mul_248: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_10, rsqrt_2);  sum_10 = rsqrt_2 = None
    ...
    full_3: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_56: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_3, sigmoid_68);  full_3 = None
    ...
    sum_11: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_251, [0, 2, 3])
    ...
    sum_12: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_252, [0, 2, 3]);  mul_252 = None
    ...
    mul_259: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_12, rsqrt_3);  sum_12 = rsqrt_3 = None
    ...
    sum_13: "f32[192]" = torch.ops.aten.sum.dim_IntList(getitem_15, [0, 2, 3])
    ...
    sum_14: "f32[192]" = torch.ops.aten.sum.dim_IntList(mul_260, [0, 2, 3]);  mul_260 = None
    ...
    mul_267: "f32[192]" = torch.ops.aten.mul.Tensor(sum_14, rsqrt_4);  sum_14 = rsqrt_4 = None
    ...
    sum_15: "f32[4, 1152, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_268, [2, 3], True);  mul_268 = None
    ...
    mul_271: "f32[4, 1152, 1, 1]" = torch.ops.aten.mul.Tensor(sum_15, mul_270);  sum_15 = mul_270 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_16: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_271, [0, 2, 3])
    convolution_backward_7 = torch.ops.aten.convolution_backward.default(mul_271, mul_190, primals_201, [1152], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_271 = mul_190 = primals_201 = None
    getitem_21: "f32[4, 48, 1, 1]" = convolution_backward_7[0]
    getitem_22: "f32[1152, 48, 1, 1]" = convolution_backward_7[1];  convolution_backward_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_69: "f32[4, 48, 1, 1]" = torch.ops.aten.sigmoid.default(clone_44)
    full_4: "f32[4, 48, 1, 1]" = torch.ops.aten.full.default([4, 48, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_60: "f32[4, 48, 1, 1]" = torch.ops.aten.sub.Tensor(full_4, sigmoid_69);  full_4 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_17: "f32[48]" = torch.ops.aten.sum.dim_IntList(mul_274, [0, 2, 3])
    convolution_backward_8 = torch.ops.aten.convolution_backward.default(mul_274, mean_14, primals_199, [48], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_274 = mean_14 = primals_199 = None
    getitem_24: "f32[4, 1152, 1, 1]" = convolution_backward_8[0]
    getitem_25: "f32[48, 1152, 1, 1]" = convolution_backward_8[1];  convolution_backward_8 = None
    ...
    full_5: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_61: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_5, sigmoid_70);  full_5 = None
    ...
    sum_18: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_277, [0, 2, 3])
    ...
    sum_19: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_278, [0, 2, 3]);  mul_278 = None
    ...
    mul_285: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_19, rsqrt_5);  sum_19 = rsqrt_5 = None
    ...
    full_6: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_63: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_6, sigmoid_71);  full_6 = None
    ...
    sum_20: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_288, [0, 2, 3])
    ...
    sum_21: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_289, [0, 2, 3]);  mul_289 = None
    ...
    mul_296: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_21, rsqrt_6);  sum_21 = rsqrt_6 = None
    ...
    sum_22: "f32[192]" = torch.ops.aten.sum.dim_IntList(add_123, [0, 2, 3])
    ...
    sum_23: "f32[192]" = torch.ops.aten.sum.dim_IntList(mul_297, [0, 2, 3]);  mul_297 = None
    ...
    mul_304: "f32[192]" = torch.ops.aten.mul.Tensor(sum_23, rsqrt_7);  sum_23 = rsqrt_7 = None
    ...
    sum_24: "f32[4, 1152, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_305, [2, 3], True);  mul_305 = None
    ...
    mul_308: "f32[4, 1152, 1, 1]" = torch.ops.aten.mul.Tensor(sum_24, mul_307);  sum_24 = mul_307 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_25: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_308, [0, 2, 3])
    convolution_backward_12 = torch.ops.aten.convolution_backward.default(mul_308, mul_177, primals_194, [1152], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_308 = mul_177 = primals_194 = None
    getitem_36: "f32[4, 48, 1, 1]" = convolution_backward_12[0]
    getitem_37: "f32[1152, 48, 1, 1]" = convolution_backward_12[1];  convolution_backward_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_72: "f32[4, 48, 1, 1]" = torch.ops.aten.sigmoid.default(clone_41)
    full_7: "f32[4, 48, 1, 1]" = torch.ops.aten.full.default([4, 48, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_67: "f32[4, 48, 1, 1]" = torch.ops.aten.sub.Tensor(full_7, sigmoid_72);  full_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_26: "f32[48]" = torch.ops.aten.sum.dim_IntList(mul_311, [0, 2, 3])
    convolution_backward_13 = torch.ops.aten.convolution_backward.default(mul_311, mean_13, primals_192, [48], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_311 = mean_13 = primals_192 = None
    getitem_39: "f32[4, 1152, 1, 1]" = convolution_backward_13[0]
    getitem_40: "f32[48, 1152, 1, 1]" = convolution_backward_13[1];  convolution_backward_13 = None
    ...
    full_8: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_68: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_8, sigmoid_73);  full_8 = None
    ...
    sum_27: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_314, [0, 2, 3])
    ...
    sum_28: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_315, [0, 2, 3]);  mul_315 = None
    ...
    mul_322: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_28, rsqrt_8);  sum_28 = rsqrt_8 = None
    ...
    full_9: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_70: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_9, sigmoid_74);  full_9 = None
    ...
    sum_29: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_325, [0, 2, 3])
    ...
    sum_30: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_326, [0, 2, 3]);  mul_326 = None
    ...
    mul_333: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_30, rsqrt_9);  sum_30 = rsqrt_9 = None
    ...
    sum_31: "f32[192]" = torch.ops.aten.sum.dim_IntList(add_131, [0, 2, 3])
    ...
    sum_32: "f32[192]" = torch.ops.aten.sum.dim_IntList(mul_334, [0, 2, 3]);  mul_334 = None
    ...
    mul_341: "f32[192]" = torch.ops.aten.mul.Tensor(sum_32, rsqrt_10);  sum_32 = rsqrt_10 = None
    ...
    sum_33: "f32[4, 1152, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_342, [2, 3], True);  mul_342 = None
    ...
    mul_345: "f32[4, 1152, 1, 1]" = torch.ops.aten.mul.Tensor(sum_33, mul_344);  sum_33 = mul_344 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_34: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_345, [0, 2, 3])
    convolution_backward_17 = torch.ops.aten.convolution_backward.default(mul_345, mul_164, primals_187, [1152], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_345 = mul_164 = primals_187 = None
    getitem_51: "f32[4, 48, 1, 1]" = convolution_backward_17[0]
    getitem_52: "f32[1152, 48, 1, 1]" = convolution_backward_17[1];  convolution_backward_17 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_75: "f32[4, 48, 1, 1]" = torch.ops.aten.sigmoid.default(clone_38)
    full_10: "f32[4, 48, 1, 1]" = torch.ops.aten.full.default([4, 48, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_74: "f32[4, 48, 1, 1]" = torch.ops.aten.sub.Tensor(full_10, sigmoid_75);  full_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_35: "f32[48]" = torch.ops.aten.sum.dim_IntList(mul_348, [0, 2, 3])
    convolution_backward_18 = torch.ops.aten.convolution_backward.default(mul_348, mean_12, primals_185, [48], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_348 = mean_12 = primals_185 = None
    getitem_54: "f32[4, 1152, 1, 1]" = convolution_backward_18[0]
    getitem_55: "f32[48, 1152, 1, 1]" = convolution_backward_18[1];  convolution_backward_18 = None
    ...
    full_11: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_75: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_11, sigmoid_76);  full_11 = None
    ...
    sum_36: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_351, [0, 2, 3])
    ...
    sum_37: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_352, [0, 2, 3]);  mul_352 = None
    ...
    mul_359: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_37, rsqrt_11);  sum_37 = rsqrt_11 = None
    ...
    full_12: "f32[4, 1152, 7, 7]" = torch.ops.aten.full.default([4, 1152, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_77: "f32[4, 1152, 7, 7]" = torch.ops.aten.sub.Tensor(full_12, sigmoid_77);  full_12 = None
    ...
    sum_38: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_362, [0, 2, 3])
    ...
    sum_39: "f32[1152]" = torch.ops.aten.sum.dim_IntList(mul_363, [0, 2, 3]);  mul_363 = None
    ...
    mul_370: "f32[1152]" = torch.ops.aten.mul.Tensor(sum_39, rsqrt_12);  sum_39 = rsqrt_12 = None
    ...
    sum_40: "f32[192]" = torch.ops.aten.sum.dim_IntList(add_139, [0, 2, 3])
    ...
    sum_41: "f32[192]" = torch.ops.aten.sum.dim_IntList(mul_371, [0, 2, 3]);  mul_371 = None
    ...
    mul_378: "f32[192]" = torch.ops.aten.mul.Tensor(sum_41, rsqrt_13);  sum_41 = rsqrt_13 = None
    ...
    sum_42: "f32[4, 672, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_379, [2, 3], True);  mul_379 = None
    ...
    mul_382: "f32[4, 672, 1, 1]" = torch.ops.aten.mul.Tensor(sum_42, mul_381);  sum_42 = mul_381 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_43: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_382, [0, 2, 3])
    convolution_backward_22 = torch.ops.aten.convolution_backward.default(mul_382, mul_151, primals_180, [672], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_382 = mul_151 = primals_180 = None
    getitem_66: "f32[4, 28, 1, 1]" = convolution_backward_22[0]
    getitem_67: "f32[672, 28, 1, 1]" = convolution_backward_22[1];  convolution_backward_22 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_78: "f32[4, 28, 1, 1]" = torch.ops.aten.sigmoid.default(clone_35)
    full_13: "f32[4, 28, 1, 1]" = torch.ops.aten.full.default([4, 28, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_81: "f32[4, 28, 1, 1]" = torch.ops.aten.sub.Tensor(full_13, sigmoid_78);  full_13 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_44: "f32[28]" = torch.ops.aten.sum.dim_IntList(mul_385, [0, 2, 3])
    convolution_backward_23 = torch.ops.aten.convolution_backward.default(mul_385, mean_11, primals_178, [28], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_385 = mean_11 = primals_178 = None
    getitem_69: "f32[4, 672, 1, 1]" = convolution_backward_23[0]
    getitem_70: "f32[28, 672, 1, 1]" = convolution_backward_23[1];  convolution_backward_23 = None
    ...
    full_14: "f32[4, 672, 7, 7]" = torch.ops.aten.full.default([4, 672, 7, 7], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_82: "f32[4, 672, 7, 7]" = torch.ops.aten.sub.Tensor(full_14, sigmoid_79);  full_14 = None
    ...
    sum_45: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_388, [0, 2, 3])
    ...
    sum_46: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_389, [0, 2, 3]);  mul_389 = None
    ...
    mul_396: "f32[672]" = torch.ops.aten.mul.Tensor(sum_46, rsqrt_14);  sum_46 = rsqrt_14 = None
    ...
    full_15: "f32[4, 672, 14, 14]" = torch.ops.aten.full.default([4, 672, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_84: "f32[4, 672, 14, 14]" = torch.ops.aten.sub.Tensor(full_15, sigmoid_80);  full_15 = None
    ...
    sum_47: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_399, [0, 2, 3])
    ...
    sum_48: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_400, [0, 2, 3]);  mul_400 = None
    ...
    mul_407: "f32[672]" = torch.ops.aten.mul.Tensor(sum_48, rsqrt_15);  sum_48 = rsqrt_15 = None
    ...
    sum_49: "f32[112]" = torch.ops.aten.sum.dim_IntList(getitem_75, [0, 2, 3])
    ...
    sum_50: "f32[112]" = torch.ops.aten.sum.dim_IntList(mul_408, [0, 2, 3]);  mul_408 = None
    ...
    mul_415: "f32[112]" = torch.ops.aten.mul.Tensor(sum_50, rsqrt_16);  sum_50 = rsqrt_16 = None
    ...
    sum_51: "f32[4, 672, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_416, [2, 3], True);  mul_416 = None
    ...
    mul_419: "f32[4, 672, 1, 1]" = torch.ops.aten.mul.Tensor(sum_51, mul_418);  sum_51 = mul_418 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_52: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_419, [0, 2, 3])
    convolution_backward_27 = torch.ops.aten.convolution_backward.default(mul_419, mul_138, primals_173, [672], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_419 = mul_138 = primals_173 = None
    getitem_81: "f32[4, 28, 1, 1]" = convolution_backward_27[0]
    getitem_82: "f32[672, 28, 1, 1]" = convolution_backward_27[1];  convolution_backward_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_81: "f32[4, 28, 1, 1]" = torch.ops.aten.sigmoid.default(clone_32)
    full_16: "f32[4, 28, 1, 1]" = torch.ops.aten.full.default([4, 28, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_88: "f32[4, 28, 1, 1]" = torch.ops.aten.sub.Tensor(full_16, sigmoid_81);  full_16 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_53: "f32[28]" = torch.ops.aten.sum.dim_IntList(mul_422, [0, 2, 3])
    convolution_backward_28 = torch.ops.aten.convolution_backward.default(mul_422, mean_10, primals_171, [28], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_422 = mean_10 = primals_171 = None
    getitem_84: "f32[4, 672, 1, 1]" = convolution_backward_28[0]
    getitem_85: "f32[28, 672, 1, 1]" = convolution_backward_28[1];  convolution_backward_28 = None
    ...
    full_17: "f32[4, 672, 14, 14]" = torch.ops.aten.full.default([4, 672, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_89: "f32[4, 672, 14, 14]" = torch.ops.aten.sub.Tensor(full_17, sigmoid_82);  full_17 = None
    ...
    sum_54: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_425, [0, 2, 3])
    ...
    sum_55: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_426, [0, 2, 3]);  mul_426 = None
    ...
    mul_433: "f32[672]" = torch.ops.aten.mul.Tensor(sum_55, rsqrt_17);  sum_55 = rsqrt_17 = None
    ...
    full_18: "f32[4, 672, 14, 14]" = torch.ops.aten.full.default([4, 672, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_91: "f32[4, 672, 14, 14]" = torch.ops.aten.sub.Tensor(full_18, sigmoid_83);  full_18 = None
    ...
    sum_56: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_436, [0, 2, 3])
    ...
    sum_57: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_437, [0, 2, 3]);  mul_437 = None
    ...
    mul_444: "f32[672]" = torch.ops.aten.mul.Tensor(sum_57, rsqrt_18);  sum_57 = rsqrt_18 = None
    ...
    sum_58: "f32[112]" = torch.ops.aten.sum.dim_IntList(add_154, [0, 2, 3])
    ...
    sum_59: "f32[112]" = torch.ops.aten.sum.dim_IntList(mul_445, [0, 2, 3]);  mul_445 = None
    ...
    mul_452: "f32[112]" = torch.ops.aten.mul.Tensor(sum_59, rsqrt_19);  sum_59 = rsqrt_19 = None
    ...
    sum_60: "f32[4, 672, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_453, [2, 3], True);  mul_453 = None
    ...
    mul_456: "f32[4, 672, 1, 1]" = torch.ops.aten.mul.Tensor(sum_60, mul_455);  sum_60 = mul_455 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_61: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_456, [0, 2, 3])
    convolution_backward_32 = torch.ops.aten.convolution_backward.default(mul_456, mul_125, primals_166, [672], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_456 = mul_125 = primals_166 = None
    getitem_96: "f32[4, 28, 1, 1]" = convolution_backward_32[0]
    getitem_97: "f32[672, 28, 1, 1]" = convolution_backward_32[1];  convolution_backward_32 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_84: "f32[4, 28, 1, 1]" = torch.ops.aten.sigmoid.default(clone_29)
    full_19: "f32[4, 28, 1, 1]" = torch.ops.aten.full.default([4, 28, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_95: "f32[4, 28, 1, 1]" = torch.ops.aten.sub.Tensor(full_19, sigmoid_84);  full_19 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_62: "f32[28]" = torch.ops.aten.sum.dim_IntList(mul_459, [0, 2, 3])
    convolution_backward_33 = torch.ops.aten.convolution_backward.default(mul_459, mean_9, primals_164, [28], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_459 = mean_9 = primals_164 = None
    getitem_99: "f32[4, 672, 1, 1]" = convolution_backward_33[0]
    getitem_100: "f32[28, 672, 1, 1]" = convolution_backward_33[1];  convolution_backward_33 = None
    ...
    full_20: "f32[4, 672, 14, 14]" = torch.ops.aten.full.default([4, 672, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_96: "f32[4, 672, 14, 14]" = torch.ops.aten.sub.Tensor(full_20, sigmoid_85);  full_20 = None
    ...
    sum_63: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_462, [0, 2, 3])
    ...
    sum_64: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_463, [0, 2, 3]);  mul_463 = None
    ...
    mul_470: "f32[672]" = torch.ops.aten.mul.Tensor(sum_64, rsqrt_20);  sum_64 = rsqrt_20 = None
    ...
    full_21: "f32[4, 672, 14, 14]" = torch.ops.aten.full.default([4, 672, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_98: "f32[4, 672, 14, 14]" = torch.ops.aten.sub.Tensor(full_21, sigmoid_86);  full_21 = None
    ...
    sum_65: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_473, [0, 2, 3])
    ...
    sum_66: "f32[672]" = torch.ops.aten.sum.dim_IntList(mul_474, [0, 2, 3]);  mul_474 = None
    ...
    mul_481: "f32[672]" = torch.ops.aten.mul.Tensor(sum_66, rsqrt_21);  sum_66 = rsqrt_21 = None
    ...
    sum_67: "f32[112]" = torch.ops.aten.sum.dim_IntList(add_162, [0, 2, 3])
    ...
    sum_68: "f32[112]" = torch.ops.aten.sum.dim_IntList(mul_482, [0, 2, 3]);  mul_482 = None
    ...
    mul_489: "f32[112]" = torch.ops.aten.mul.Tensor(sum_68, rsqrt_22);  sum_68 = rsqrt_22 = None
    ...
    sum_69: "f32[4, 480, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_490, [2, 3], True);  mul_490 = None
    ...
    mul_493: "f32[4, 480, 1, 1]" = torch.ops.aten.mul.Tensor(sum_69, mul_492);  sum_69 = mul_492 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_70: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_493, [0, 2, 3])
    convolution_backward_37 = torch.ops.aten.convolution_backward.default(mul_493, mul_112, primals_159, [480], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_493 = mul_112 = primals_159 = None
    getitem_111: "f32[4, 20, 1, 1]" = convolution_backward_37[0]
    getitem_112: "f32[480, 20, 1, 1]" = convolution_backward_37[1];  convolution_backward_37 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_87: "f32[4, 20, 1, 1]" = torch.ops.aten.sigmoid.default(clone_26)
    full_22: "f32[4, 20, 1, 1]" = torch.ops.aten.full.default([4, 20, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_102: "f32[4, 20, 1, 1]" = torch.ops.aten.sub.Tensor(full_22, sigmoid_87);  full_22 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_71: "f32[20]" = torch.ops.aten.sum.dim_IntList(mul_496, [0, 2, 3])
    convolution_backward_38 = torch.ops.aten.convolution_backward.default(mul_496, mean_8, primals_157, [20], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_496 = mean_8 = primals_157 = None
    getitem_114: "f32[4, 480, 1, 1]" = convolution_backward_38[0]
    getitem_115: "f32[20, 480, 1, 1]" = convolution_backward_38[1];  convolution_backward_38 = None
    ...
    full_23: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_103: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_23, sigmoid_88);  full_23 = None
    ...
    sum_72: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_499, [0, 2, 3])
    ...
    sum_73: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_500, [0, 2, 3]);  mul_500 = None
    ...
    mul_507: "f32[480]" = torch.ops.aten.mul.Tensor(sum_73, rsqrt_23);  sum_73 = rsqrt_23 = None
    ...
    full_24: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_105: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_24, sigmoid_89);  full_24 = None
    ...
    sum_74: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_510, [0, 2, 3])
    ...
    sum_75: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_511, [0, 2, 3]);  mul_511 = None
    ...
    mul_518: "f32[480]" = torch.ops.aten.mul.Tensor(sum_75, rsqrt_24);  sum_75 = rsqrt_24 = None
    ...
    sum_76: "f32[80]" = torch.ops.aten.sum.dim_IntList(getitem_120, [0, 2, 3])
    ...
    sum_77: "f32[80]" = torch.ops.aten.sum.dim_IntList(mul_519, [0, 2, 3]);  mul_519 = None
    ...
    mul_526: "f32[80]" = torch.ops.aten.mul.Tensor(sum_77, rsqrt_25);  sum_77 = rsqrt_25 = None
    ...
    sum_78: "f32[4, 480, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_527, [2, 3], True);  mul_527 = None
    ...
    mul_530: "f32[4, 480, 1, 1]" = torch.ops.aten.mul.Tensor(sum_78, mul_529);  sum_78 = mul_529 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_79: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_530, [0, 2, 3])
    convolution_backward_42 = torch.ops.aten.convolution_backward.default(mul_530, mul_99, primals_152, [480], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_530 = mul_99 = primals_152 = None
    getitem_126: "f32[4, 20, 1, 1]" = convolution_backward_42[0]
    getitem_127: "f32[480, 20, 1, 1]" = convolution_backward_42[1];  convolution_backward_42 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_90: "f32[4, 20, 1, 1]" = torch.ops.aten.sigmoid.default(clone_23)
    full_25: "f32[4, 20, 1, 1]" = torch.ops.aten.full.default([4, 20, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_109: "f32[4, 20, 1, 1]" = torch.ops.aten.sub.Tensor(full_25, sigmoid_90);  full_25 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_80: "f32[20]" = torch.ops.aten.sum.dim_IntList(mul_533, [0, 2, 3])
    convolution_backward_43 = torch.ops.aten.convolution_backward.default(mul_533, mean_7, primals_150, [20], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_533 = mean_7 = primals_150 = None
    getitem_129: "f32[4, 480, 1, 1]" = convolution_backward_43[0]
    getitem_130: "f32[20, 480, 1, 1]" = convolution_backward_43[1];  convolution_backward_43 = None
    ...
    full_26: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_110: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_26, sigmoid_91);  full_26 = None
    ...
    sum_81: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_536, [0, 2, 3])
    ...
    sum_82: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_537, [0, 2, 3]);  mul_537 = None
    ...
    mul_544: "f32[480]" = torch.ops.aten.mul.Tensor(sum_82, rsqrt_26);  sum_82 = rsqrt_26 = None
    ...
    full_27: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_112: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_27, sigmoid_92);  full_27 = None
    ...
    sum_83: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_547, [0, 2, 3])
    ...
    sum_84: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_548, [0, 2, 3]);  mul_548 = None
    ...
    mul_555: "f32[480]" = torch.ops.aten.mul.Tensor(sum_84, rsqrt_27);  sum_84 = rsqrt_27 = None
    ...
    sum_85: "f32[80]" = torch.ops.aten.sum.dim_IntList(add_177, [0, 2, 3])
    ...
    sum_86: "f32[80]" = torch.ops.aten.sum.dim_IntList(mul_556, [0, 2, 3]);  mul_556 = None
    ...
    mul_563: "f32[80]" = torch.ops.aten.mul.Tensor(sum_86, rsqrt_28);  sum_86 = rsqrt_28 = None
    ...
    sum_87: "f32[4, 480, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_564, [2, 3], True);  mul_564 = None
    ...
    mul_567: "f32[4, 480, 1, 1]" = torch.ops.aten.mul.Tensor(sum_87, mul_566);  sum_87 = mul_566 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_88: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_567, [0, 2, 3])
    convolution_backward_47 = torch.ops.aten.convolution_backward.default(mul_567, mul_86, primals_145, [480], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_567 = mul_86 = primals_145 = None
    getitem_141: "f32[4, 20, 1, 1]" = convolution_backward_47[0]
    getitem_142: "f32[480, 20, 1, 1]" = convolution_backward_47[1];  convolution_backward_47 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_93: "f32[4, 20, 1, 1]" = torch.ops.aten.sigmoid.default(clone_20)
    full_28: "f32[4, 20, 1, 1]" = torch.ops.aten.full.default([4, 20, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_116: "f32[4, 20, 1, 1]" = torch.ops.aten.sub.Tensor(full_28, sigmoid_93);  full_28 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_89: "f32[20]" = torch.ops.aten.sum.dim_IntList(mul_570, [0, 2, 3])
    convolution_backward_48 = torch.ops.aten.convolution_backward.default(mul_570, mean_6, primals_143, [20], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_570 = mean_6 = primals_143 = None
    getitem_144: "f32[4, 480, 1, 1]" = convolution_backward_48[0]
    getitem_145: "f32[20, 480, 1, 1]" = convolution_backward_48[1];  convolution_backward_48 = None
    ...
    full_29: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_117: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_29, sigmoid_94);  full_29 = None
    ...
    sum_90: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_573, [0, 2, 3])
    ...
    sum_91: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_574, [0, 2, 3]);  mul_574 = None
    ...
    mul_581: "f32[480]" = torch.ops.aten.mul.Tensor(sum_91, rsqrt_29);  sum_91 = rsqrt_29 = None
    ...
    full_30: "f32[4, 480, 14, 14]" = torch.ops.aten.full.default([4, 480, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_119: "f32[4, 480, 14, 14]" = torch.ops.aten.sub.Tensor(full_30, sigmoid_95);  full_30 = None
    ...
    sum_92: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_584, [0, 2, 3])
    ...
    sum_93: "f32[480]" = torch.ops.aten.sum.dim_IntList(mul_585, [0, 2, 3]);  mul_585 = None
    ...
    mul_592: "f32[480]" = torch.ops.aten.mul.Tensor(sum_93, rsqrt_30);  sum_93 = rsqrt_30 = None
    ...
    sum_94: "f32[80]" = torch.ops.aten.sum.dim_IntList(add_185, [0, 2, 3])
    ...
    sum_95: "f32[80]" = torch.ops.aten.sum.dim_IntList(mul_593, [0, 2, 3]);  mul_593 = None
    ...
    mul_600: "f32[80]" = torch.ops.aten.mul.Tensor(sum_95, rsqrt_31);  sum_95 = rsqrt_31 = None
    ...
    sum_96: "f32[4, 240, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_601, [2, 3], True);  mul_601 = None
    ...
    mul_604: "f32[4, 240, 1, 1]" = torch.ops.aten.mul.Tensor(sum_96, mul_603);  sum_96 = mul_603 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_97: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_604, [0, 2, 3])
    convolution_backward_52 = torch.ops.aten.convolution_backward.default(mul_604, mul_73, primals_138, [240], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_604 = mul_73 = primals_138 = None
    getitem_156: "f32[4, 10, 1, 1]" = convolution_backward_52[0]
    getitem_157: "f32[240, 10, 1, 1]" = convolution_backward_52[1];  convolution_backward_52 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_96: "f32[4, 10, 1, 1]" = torch.ops.aten.sigmoid.default(clone_17)
    full_31: "f32[4, 10, 1, 1]" = torch.ops.aten.full.default([4, 10, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_123: "f32[4, 10, 1, 1]" = torch.ops.aten.sub.Tensor(full_31, sigmoid_96);  full_31 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_98: "f32[10]" = torch.ops.aten.sum.dim_IntList(mul_607, [0, 2, 3])
    convolution_backward_53 = torch.ops.aten.convolution_backward.default(mul_607, mean_5, primals_136, [10], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_607 = mean_5 = primals_136 = None
    getitem_159: "f32[4, 240, 1, 1]" = convolution_backward_53[0]
    getitem_160: "f32[10, 240, 1, 1]" = convolution_backward_53[1];  convolution_backward_53 = None
    ...
    full_32: "f32[4, 240, 14, 14]" = torch.ops.aten.full.default([4, 240, 14, 14], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_124: "f32[4, 240, 14, 14]" = torch.ops.aten.sub.Tensor(full_32, sigmoid_97);  full_32 = None
    ...
    sum_99: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_610, [0, 2, 3])
    ...
    sum_100: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_611, [0, 2, 3]);  mul_611 = None
    ...
    mul_618: "f32[240]" = torch.ops.aten.mul.Tensor(sum_100, rsqrt_32);  sum_100 = rsqrt_32 = None
    ...
    full_33: "f32[4, 240, 28, 28]" = torch.ops.aten.full.default([4, 240, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_126: "f32[4, 240, 28, 28]" = torch.ops.aten.sub.Tensor(full_33, sigmoid_98);  full_33 = None
    ...
    sum_101: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_621, [0, 2, 3])
    ...
    sum_102: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_622, [0, 2, 3]);  mul_622 = None
    ...
    mul_629: "f32[240]" = torch.ops.aten.mul.Tensor(sum_102, rsqrt_33);  sum_102 = rsqrt_33 = None
    ...
    sum_103: "f32[40]" = torch.ops.aten.sum.dim_IntList(getitem_165, [0, 2, 3])
    ...
    sum_104: "f32[40]" = torch.ops.aten.sum.dim_IntList(mul_630, [0, 2, 3]);  mul_630 = None
    ...
    mul_637: "f32[40]" = torch.ops.aten.mul.Tensor(sum_104, rsqrt_34);  sum_104 = rsqrt_34 = None
    ...
    sum_105: "f32[4, 240, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_638, [2, 3], True);  mul_638 = None
    ...
    mul_641: "f32[4, 240, 1, 1]" = torch.ops.aten.mul.Tensor(sum_105, mul_640);  sum_105 = mul_640 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_106: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_641, [0, 2, 3])
    convolution_backward_57 = torch.ops.aten.convolution_backward.default(mul_641, mul_60, primals_131, [240], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_641 = mul_60 = primals_131 = None
    getitem_171: "f32[4, 10, 1, 1]" = convolution_backward_57[0]
    getitem_172: "f32[240, 10, 1, 1]" = convolution_backward_57[1];  convolution_backward_57 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_99: "f32[4, 10, 1, 1]" = torch.ops.aten.sigmoid.default(clone_14)
    full_34: "f32[4, 10, 1, 1]" = torch.ops.aten.full.default([4, 10, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_130: "f32[4, 10, 1, 1]" = torch.ops.aten.sub.Tensor(full_34, sigmoid_99);  full_34 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_107: "f32[10]" = torch.ops.aten.sum.dim_IntList(mul_644, [0, 2, 3])
    convolution_backward_58 = torch.ops.aten.convolution_backward.default(mul_644, mean_4, primals_129, [10], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_644 = mean_4 = primals_129 = None
    getitem_174: "f32[4, 240, 1, 1]" = convolution_backward_58[0]
    getitem_175: "f32[10, 240, 1, 1]" = convolution_backward_58[1];  convolution_backward_58 = None
    ...
    full_35: "f32[4, 240, 28, 28]" = torch.ops.aten.full.default([4, 240, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_131: "f32[4, 240, 28, 28]" = torch.ops.aten.sub.Tensor(full_35, sigmoid_100);  full_35 = None
    ...
    sum_108: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_647, [0, 2, 3])
    ...
    sum_109: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_648, [0, 2, 3]);  mul_648 = None
    ...
    mul_655: "f32[240]" = torch.ops.aten.mul.Tensor(sum_109, rsqrt_35);  sum_109 = rsqrt_35 = None
    ...
    full_36: "f32[4, 240, 28, 28]" = torch.ops.aten.full.default([4, 240, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_133: "f32[4, 240, 28, 28]" = torch.ops.aten.sub.Tensor(full_36, sigmoid_101);  full_36 = None
    ...
    sum_110: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_658, [0, 2, 3])
    ...
    sum_111: "f32[240]" = torch.ops.aten.sum.dim_IntList(mul_659, [0, 2, 3]);  mul_659 = None
    ...
    mul_666: "f32[240]" = torch.ops.aten.mul.Tensor(sum_111, rsqrt_36);  sum_111 = rsqrt_36 = None
    ...
    sum_112: "f32[40]" = torch.ops.aten.sum.dim_IntList(add_200, [0, 2, 3])
    ...
    sum_113: "f32[40]" = torch.ops.aten.sum.dim_IntList(mul_667, [0, 2, 3]);  mul_667 = None
    ...
    mul_674: "f32[40]" = torch.ops.aten.mul.Tensor(sum_113, rsqrt_37);  sum_113 = rsqrt_37 = None
    ...
    sum_114: "f32[4, 144, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_675, [2, 3], True);  mul_675 = None
    ...
    mul_678: "f32[4, 144, 1, 1]" = torch.ops.aten.mul.Tensor(sum_114, mul_677);  sum_114 = mul_677 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_115: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_678, [0, 2, 3])
    convolution_backward_62 = torch.ops.aten.convolution_backward.default(mul_678, mul_47, primals_124, [144], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_678 = mul_47 = primals_124 = None
    getitem_186: "f32[4, 6, 1, 1]" = convolution_backward_62[0]
    getitem_187: "f32[144, 6, 1, 1]" = convolution_backward_62[1];  convolution_backward_62 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_102: "f32[4, 6, 1, 1]" = torch.ops.aten.sigmoid.default(clone_11)
    full_37: "f32[4, 6, 1, 1]" = torch.ops.aten.full.default([4, 6, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_137: "f32[4, 6, 1, 1]" = torch.ops.aten.sub.Tensor(full_37, sigmoid_102);  full_37 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_116: "f32[6]" = torch.ops.aten.sum.dim_IntList(mul_681, [0, 2, 3])
    convolution_backward_63 = torch.ops.aten.convolution_backward.default(mul_681, mean_3, primals_122, [6], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_681 = mean_3 = primals_122 = None
    getitem_189: "f32[4, 144, 1, 1]" = convolution_backward_63[0]
    getitem_190: "f32[6, 144, 1, 1]" = convolution_backward_63[1];  convolution_backward_63 = None
    ...
    full_38: "f32[4, 144, 28, 28]" = torch.ops.aten.full.default([4, 144, 28, 28], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_138: "f32[4, 144, 28, 28]" = torch.ops.aten.sub.Tensor(full_38, sigmoid_103);  full_38 = None
    ...
    sum_117: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_684, [0, 2, 3])
    ...
    sum_118: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_685, [0, 2, 3]);  mul_685 = None
    ...
    mul_692: "f32[144]" = torch.ops.aten.mul.Tensor(sum_118, rsqrt_38);  sum_118 = rsqrt_38 = None
    ...
    full_39: "f32[4, 144, 56, 56]" = torch.ops.aten.full.default([4, 144, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_140: "f32[4, 144, 56, 56]" = torch.ops.aten.sub.Tensor(full_39, sigmoid_104);  full_39 = None
    ...
    sum_119: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_695, [0, 2, 3])
    ...
    sum_120: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_696, [0, 2, 3]);  mul_696 = None
    ...
    mul_703: "f32[144]" = torch.ops.aten.mul.Tensor(sum_120, rsqrt_39);  sum_120 = rsqrt_39 = None
    ...
    sum_121: "f32[24]" = torch.ops.aten.sum.dim_IntList(getitem_195, [0, 2, 3])
    ...
    sum_122: "f32[24]" = torch.ops.aten.sum.dim_IntList(mul_704, [0, 2, 3]);  mul_704 = None
    ...
    mul_711: "f32[24]" = torch.ops.aten.mul.Tensor(sum_122, rsqrt_40);  sum_122 = rsqrt_40 = None
    ...
    sum_123: "f32[4, 144, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_712, [2, 3], True);  mul_712 = None
    ...
    mul_715: "f32[4, 144, 1, 1]" = torch.ops.aten.mul.Tensor(sum_123, mul_714);  sum_123 = mul_714 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_124: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_715, [0, 2, 3])
    convolution_backward_67 = torch.ops.aten.convolution_backward.default(mul_715, mul_34, primals_117, [144], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_715 = mul_34 = primals_117 = None
    getitem_201: "f32[4, 6, 1, 1]" = convolution_backward_67[0]
    getitem_202: "f32[144, 6, 1, 1]" = convolution_backward_67[1];  convolution_backward_67 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_105: "f32[4, 6, 1, 1]" = torch.ops.aten.sigmoid.default(clone_8)
    full_40: "f32[4, 6, 1, 1]" = torch.ops.aten.full.default([4, 6, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_144: "f32[4, 6, 1, 1]" = torch.ops.aten.sub.Tensor(full_40, sigmoid_105);  full_40 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_125: "f32[6]" = torch.ops.aten.sum.dim_IntList(mul_718, [0, 2, 3])
    convolution_backward_68 = torch.ops.aten.convolution_backward.default(mul_718, mean_2, primals_115, [6], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_718 = mean_2 = primals_115 = None
    getitem_204: "f32[4, 144, 1, 1]" = convolution_backward_68[0]
    getitem_205: "f32[6, 144, 1, 1]" = convolution_backward_68[1];  convolution_backward_68 = None
    ...
    full_41: "f32[4, 144, 56, 56]" = torch.ops.aten.full.default([4, 144, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_145: "f32[4, 144, 56, 56]" = torch.ops.aten.sub.Tensor(full_41, sigmoid_106);  full_41 = None
    ...
    sum_126: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_721, [0, 2, 3])
    ...
    sum_127: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_722, [0, 2, 3]);  mul_722 = None
    ...
    mul_729: "f32[144]" = torch.ops.aten.mul.Tensor(sum_127, rsqrt_41);  sum_127 = rsqrt_41 = None
    ...
    full_42: "f32[4, 144, 56, 56]" = torch.ops.aten.full.default([4, 144, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_147: "f32[4, 144, 56, 56]" = torch.ops.aten.sub.Tensor(full_42, sigmoid_107);  full_42 = None
    ...
    sum_128: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_732, [0, 2, 3])
    ...
    sum_129: "f32[144]" = torch.ops.aten.sum.dim_IntList(mul_733, [0, 2, 3]);  mul_733 = None
    ...
    mul_740: "f32[144]" = torch.ops.aten.mul.Tensor(sum_129, rsqrt_42);  sum_129 = rsqrt_42 = None
    ...
    sum_130: "f32[24]" = torch.ops.aten.sum.dim_IntList(add_215, [0, 2, 3])
    ...
    sum_131: "f32[24]" = torch.ops.aten.sum.dim_IntList(mul_741, [0, 2, 3]);  mul_741 = None
    ...
    mul_748: "f32[24]" = torch.ops.aten.mul.Tensor(sum_131, rsqrt_43);  sum_131 = rsqrt_43 = None
    ...
    sum_132: "f32[4, 96, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_749, [2, 3], True);  mul_749 = None
    ...
    mul_752: "f32[4, 96, 1, 1]" = torch.ops.aten.mul.Tensor(sum_132, mul_751);  sum_132 = mul_751 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_133: "f32[96]" = torch.ops.aten.sum.dim_IntList(mul_752, [0, 2, 3])
    convolution_backward_72 = torch.ops.aten.convolution_backward.default(mul_752, mul_21, primals_110, [96], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_752 = mul_21 = primals_110 = None
    getitem_216: "f32[4, 4, 1, 1]" = convolution_backward_72[0]
    getitem_217: "f32[96, 4, 1, 1]" = convolution_backward_72[1];  convolution_backward_72 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_108: "f32[4, 4, 1, 1]" = torch.ops.aten.sigmoid.default(clone_5)
    full_43: "f32[4, 4, 1, 1]" = torch.ops.aten.full.default([4, 4, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_151: "f32[4, 4, 1, 1]" = torch.ops.aten.sub.Tensor(full_43, sigmoid_108);  full_43 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_134: "f32[4]" = torch.ops.aten.sum.dim_IntList(mul_755, [0, 2, 3])
    convolution_backward_73 = torch.ops.aten.convolution_backward.default(mul_755, mean_1, primals_108, [4], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_755 = mean_1 = primals_108 = None
    getitem_219: "f32[4, 96, 1, 1]" = convolution_backward_73[0]
    getitem_220: "f32[4, 96, 1, 1]" = convolution_backward_73[1];  convolution_backward_73 = None
    ...
    full_44: "f32[4, 96, 56, 56]" = torch.ops.aten.full.default([4, 96, 56, 56], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_152: "f32[4, 96, 56, 56]" = torch.ops.aten.sub.Tensor(full_44, sigmoid_109);  full_44 = None
    ...
    sum_135: "f32[96]" = torch.ops.aten.sum.dim_IntList(mul_758, [0, 2, 3])
    ...
    sum_136: "f32[96]" = torch.ops.aten.sum.dim_IntList(mul_759, [0, 2, 3]);  mul_759 = None
    ...
    mul_766: "f32[96]" = torch.ops.aten.mul.Tensor(sum_136, rsqrt_44);  sum_136 = rsqrt_44 = None
    ...
    full_45: "f32[4, 96, 112, 112]" = torch.ops.aten.full.default([4, 96, 112, 112], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_154: "f32[4, 96, 112, 112]" = torch.ops.aten.sub.Tensor(full_45, sigmoid_110);  full_45 = None
    ...
    sum_137: "f32[96]" = torch.ops.aten.sum.dim_IntList(mul_769, [0, 2, 3])
    ...
    sum_138: "f32[96]" = torch.ops.aten.sum.dim_IntList(mul_770, [0, 2, 3]);  mul_770 = None
    ...
    mul_777: "f32[96]" = torch.ops.aten.mul.Tensor(sum_138, rsqrt_45);  sum_138 = rsqrt_45 = None
    ...
    sum_139: "f32[16]" = torch.ops.aten.sum.dim_IntList(getitem_225, [0, 2, 3])
    ...
    sum_140: "f32[16]" = torch.ops.aten.sum.dim_IntList(mul_778, [0, 2, 3]);  mul_778 = None
    ...
    mul_785: "f32[16]" = torch.ops.aten.mul.Tensor(sum_140, rsqrt_46);  sum_140 = rsqrt_46 = None
    ...
    sum_141: "f32[4, 32, 1, 1]" = torch.ops.aten.sum.dim_IntList(mul_786, [2, 3], True);  mul_786 = None
    ...
    mul_789: "f32[4, 32, 1, 1]" = torch.ops.aten.mul.Tensor(sum_141, mul_788);  sum_141 = mul_788 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:54, code: x_se = self.conv_expand(x_se)
    sum_142: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_789, [0, 2, 3])
    convolution_backward_77 = torch.ops.aten.convolution_backward.default(mul_789, mul_8, primals_103, [32], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_789 = mul_8 = primals_103 = None
    getitem_231: "f32[4, 8, 1, 1]" = convolution_backward_77[0]
    getitem_232: "f32[32, 8, 1, 1]" = convolution_backward_77[1];  convolution_backward_77 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:53, code: x_se = self.act1(x_se)
    sigmoid_111: "f32[4, 8, 1, 1]" = torch.ops.aten.sigmoid.default(clone_2)
    full_46: "f32[4, 8, 1, 1]" = torch.ops.aten.full.default([4, 8, 1, 1], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_158: "f32[4, 8, 1, 1]" = torch.ops.aten.sub.Tensor(full_46, sigmoid_111);  full_46 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/timm/models/_efficientnet_blocks.py:52, code: x_se = self.conv_reduce(x_se)
    sum_143: "f32[8]" = torch.ops.aten.sum.dim_IntList(mul_792, [0, 2, 3])
    convolution_backward_78 = torch.ops.aten.convolution_backward.default(mul_792, mean, primals_101, [8], [1, 1], [0, 0], [1, 1], False, [0, 0], 1, [True, True, False]);  mul_792 = mean = primals_101 = None
    getitem_234: "f32[4, 32, 1, 1]" = convolution_backward_78[0]
    getitem_235: "f32[8, 32, 1, 1]" = convolution_backward_78[1];  convolution_backward_78 = None
    ...
    full_47: "f32[4, 32, 112, 112]" = torch.ops.aten.full.default([4, 32, 112, 112], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_159: "f32[4, 32, 112, 112]" = torch.ops.aten.sub.Tensor(full_47, sigmoid_112);  full_47 = None
    ...
    sum_144: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_795, [0, 2, 3])
    ...
    sum_145: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_796, [0, 2, 3]);  mul_796 = None
    ...
    mul_803: "f32[32]" = torch.ops.aten.mul.Tensor(sum_145, rsqrt_47);  sum_145 = rsqrt_47 = None
    ...
    full_48: "f32[4, 32, 112, 112]" = torch.ops.aten.full.default([4, 32, 112, 112], 1, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    sub_161: "f32[4, 32, 112, 112]" = torch.ops.aten.sub.Tensor(full_48, sigmoid_113);  full_48 = None
    ...
    sum_146: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_806, [0, 2, 3])
    ...
    sum_147: "f32[32]" = torch.ops.aten.sum.dim_IntList(mul_807, [0, 2, 3]);  mul_807 = None
    ...
    mul_814: "f32[32]" = torch.ops.aten.mul.Tensor(sum_147, rsqrt_48);  sum_147 = rsqrt_48 = None
    ...
    return pytree.tree_unflatten([addmm, mul_814, sum_146, mul_803, sum_144, mul_785, sum_139, mul_777, sum_137, mul_766, sum_135, mul_748, sum_130, mul_740, sum_128, mul_729, sum_126, mul_711, sum_121, mul_703, sum_119, mul_692, sum_117, mul_674, sum_112, mul_666, sum_110, mul_655, sum_108, mul_637, sum_103, mul_629, sum_101, mul_618, sum_99, mul_600, sum_94, mul_592, sum_92, mul_581, sum_90, mul_563, sum_85, mul_555, sum_83, mul_544, sum_81, mul_526, sum_76, mul_518, sum_74, mul_507, sum_72, mul_489, sum_67, mul_481, sum_65, mul_470, sum_63, mul_452, sum_58, mul_444, sum_56, mul_433, sum_54, mul_415, sum_49, mul_407, sum_47, mul_396, sum_45, mul_378, sum_40, mul_370, sum_38, mul_359, sum_36, mul_341, sum_31, mul_333, sum_29, mul_322, sum_27, mul_304, sum_22, mul_296, sum_20, mul_285, sum_18, mul_267, sum_13, mul_259, sum_11, mul_248, sum_9, mul_230, sum_4, mul_222, sum_2, getitem_241, getitem_238, getitem_235, sum_143, getitem_232, sum_142, getitem_229, getitem_226, getitem_223, getitem_220, sum_134, getitem_217, sum_133, getitem_214, getitem_211, getitem_208, getitem_205, sum_125, getitem_202, sum_124, getitem_199, getitem_196, getitem_193, getitem_190, sum_116, getitem_187, sum_115, getitem_184, getitem_181, getitem_178, getitem_175, sum_107, getitem_172, sum_106, getitem_169, getitem_166, getitem_163, getitem_160, sum_98, getitem_157, sum_97, getitem_154, getitem_151, getitem_148, getitem_145, sum_89, getitem_142, sum_88, getitem_139, getitem_136, getitem_133, getitem_130, sum_80, getitem_127, sum_79, getitem_124, getitem_121, getitem_118, getitem_115, sum_71, getitem_112, sum_70, getitem_109, getitem_106, getitem_103, getitem_100, sum_62, getitem_97, sum_61, getitem_94, getitem_91, getitem_88, getitem_85, sum_53, getitem_82, sum_52, getitem_79, getitem_76, getitem_73, getitem_70, sum_44, getitem_67, sum_43, getitem_64, getitem_61, getitem_58, getitem_55, sum_35, getitem_52, sum_34, getitem_49, getitem_46, getitem_43, getitem_40, sum_26, getitem_37, sum_25, getitem_34, getitem_31, getitem_28, getitem_25, sum_17, getitem_22, sum_16, getitem_19, getitem_16, getitem_13, getitem_10, sum_8, getitem_7, sum_7, getitem_4, getitem_1, permute_4, view_1, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None, None], self._out_spec)
