            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(256L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(8L))
                {
                    ...
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(8L); x2+=static_cast<long>(8L))
                    {
                        ...
                        at::vec::transpose_mxn<float,8,8>(tmp1, 8, out_ptr9 + static_cast<long>(x1 + (256L*x2) + (2304L*x0)), static_cast<long>(256L));
                    }
                    #pragma GCC ivdep
                    for(long x2=static_cast<long>(8L); x2<static_cast<long>(9L); x2+=static_cast<long>(1L))
                    {
                        ...
                        tmp0.store(out_ptr9 + static_cast<long>(x1 + (256L*x2) + (2304L*x0)));
                    }
                }
            }
        }
...
def call(args):
    ...
    assert_size_stride(buf30, (4, 64, 56, 56), (200704, 1, 3584, 64))
    buf31 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf32, (4, 64, 56, 56), (200704, 1, 3584, 64))
    buf33 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf36, (4, 64, 56, 56), (200704, 1, 3584, 64))
    buf37 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf38, (4, 64, 56, 56), (200704, 1, 3584, 64))
    buf39 = empty_strided((4, 64, 56, 56), (200704, 1, 3584, 64), device='cpu', dtype=torch.float32)
    ...
    buf44 = extern_kernels.convolution(buf43, buf4, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf44, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf45 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf50, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf51 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf52, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf53 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf56, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf57 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    buf59 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf62, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf63 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    buf64 = extern_kernels.convolution(buf63, buf7, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf64, (4, 128, 28, 28), (100352, 1, 3584, 128))
    buf65 = empty_strided((4, 128, 28, 28), (100352, 1, 3584, 128), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf68, (4, 256, 28, 28), (200704, 1, 7168, 256))
    buf69 = empty_strided((4, 256, 28, 28), (200704, 1, 7168, 256), device='cpu', dtype=torch.float32)
    ...
    buf70 = extern_kernels.convolution(buf69, buf8, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf70, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf71 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf76, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf77 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    buf78 = extern_kernels.convolution(buf77, buf9, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf78, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf79 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf82, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf83 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    buf85 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    buf89 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    buf90 = extern_kernels.convolution(buf89, buf11, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf90, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf91 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf94, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf95 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf96, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf97 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf100, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf101 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf102, (4, 256, 14, 14), (50176, 1, 3584, 256))
    buf103 = empty_strided((4, 256, 14, 14), (50176, 1, 3584, 256), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf106, (4, 512, 14, 14), (100352, 1, 7168, 512))
    buf107 = empty_strided((4, 512, 14, 14), (100352, 1, 7168, 512), device='cpu', dtype=torch.float32)
    ...
    buf108 = extern_kernels.convolution(buf107, buf14, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf108, (4, 512, 7, 7), (25088, 1, 3584, 512))
    buf109 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cpu', dtype=torch.float32)
    ...
    buf115 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cpu', dtype=torch.float32)
    ...
    buf116 = extern_kernels.convolution(buf115, buf15, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf116, (4, 512, 7, 7), (25088, 1, 3584, 512))
    buf117 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf120, (4, 512, 7, 7), (25088, 1, 3584, 512))
    buf121 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cpu', dtype=torch.float32)
    ...
    buf122 = extern_kernels.convolution(buf121, buf16, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=1, bias=None)
    assert_size_stride(buf122, (4, 512, 7, 7), (25088, 1, 3584, 512))
    buf123 = empty_strided((4, 512, 7, 7), (25088, 1, 3584, 512), device='cpu', dtype=torch.float32)
