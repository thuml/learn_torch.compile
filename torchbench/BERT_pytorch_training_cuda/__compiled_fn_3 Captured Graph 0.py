...
def forward(self, L_cloned_inputs_0_ : torch.Tensor, L_cloned_inputs_1_ : torch.Tensor):
    ...
    forward = l__mod___embedding_token.forward(l_cloned_inputs_0_);  l__mod___embedding_token = l_cloned_inputs_0_ = None
    ...
    forward_1 = l__mod___embedding_segment.forward(l_cloned_inputs_1_);  l__mod___embedding_segment = l_cloned_inputs_1_ = None
    ...
    # File: /workspace/youkaichao/code/torchbenchmark/torchbenchmark/models/BERT_pytorch/bert_pytorch/model/transformer.py:49, code: return self.dropout(x)
    pred = self.L__mod___transformer_blocks_11_dropout(x_96);  x_96 = None
    return (pred, mask)
