...
def forward(self, primals_1: "f32[30000, 128]", primals_2: "f32[2, 128]", primals_3: "f32[512, 128]", primals_4: "f32[128]", primals_5: "f32[128]", primals_6: "f32[768, 128]", primals_7: "f32[768]", primals_8: "f32[768, 768]", primals_9: "f32[768]", primals_10: "f32[768, 768]", primals_11: "f32[768]", primals_12: "f32[768, 768]", primals_13: "f32[768]", primals_14: "f32[768, 768]", primals_15: "f32[768]", primals_16: "f32[768]", primals_17: "f32[768]", primals_18: "f32[3072, 768]", primals_19: "f32[3072]", primals_20: "f32[768, 3072]", primals_21: "f32[768]", primals_22: "f32[768]", primals_23: "f32[768]", primals_24: "f32[128, 768]", primals_25: "f32[128]", primals_26: "f32[128]", primals_27: "f32[128]", primals_28: "f32[30000, 128]", primals_29: "f32[30000]", primals_30: "i64[1, 512]", primals_31: "i64[1, 512]", primals_32: "i64[4, 512]"):
    ...
    view_19: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_4, [4, 512, 768]);  addmm_4 = None
    ...
    view_41: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_10, [4, 512, 768]);  addmm_10 = None
    ...
    view_63: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_16, [4, 512, 768]);  addmm_16 = None
    ...
    view_85: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_22, [4, 512, 768]);  addmm_22 = None
    ...
    view_107: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_28, [4, 512, 768]);  addmm_28 = None
    ...
    view_129: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_34, [4, 512, 768]);  addmm_34 = None
    ...
    view_151: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_40, [4, 512, 768]);  addmm_40 = None
    ...
    view_173: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_46, [4, 512, 768]);  addmm_46 = None
    ...
    view_195: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_52, [4, 512, 768]);  addmm_52 = None
    ...
    view_217: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_58, [4, 512, 768]);  addmm_58 = None
    ...
    view_239: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_64, [4, 512, 768]);  addmm_64 = None
    ...
    view_261: "f32[4, 512, 768]" = torch.ops.aten.reshape.default(addmm_70, [4, 512, 768]);  addmm_70 = None
