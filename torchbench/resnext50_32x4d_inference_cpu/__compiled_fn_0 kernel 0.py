...
def call(args):
    ...
    assert_size_stride(buf5, (4, 128, 56, 56), (401408, 1, 7168, 128))
    del arg3_1
    buf6 = buf5; del buf5  # reuse
    buf7 = empty_strided((128, 4, 3, 3), (36, 1, 12, 4), device='cpu', dtype=torch.float32)
    ...
    buf30 = empty_strided((256, 8, 3, 3), (72, 1, 24, 8), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf31, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del buf29
    ...
    assert_size_stride(buf37, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del arg45_1
    ...
    assert_size_stride(buf40, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del buf38
    ...
    assert_size_stride(buf47, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del buf45
    ...
    assert_size_stride(buf51, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del arg63_1
    ...
    assert_size_stride(buf54, (4, 256, 28, 28), (200704, 1, 7168, 256))
    del buf52
    del buf53
    ...
    assert_size_stride(buf58, (4, 512, 28, 28), (401408, 1, 14336, 512))
    del arg72_1
    buf59 = buf58; del buf58  # reuse
    buf60 = empty_strided((512, 16, 3, 3), (144, 1, 48, 16), device='cpu', dtype=torch.float32)
    ...
    assert_size_stride(buf61, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del buf59
    ...
    assert_size_stride(buf67, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del arg84_1
    ...
    assert_size_stride(buf74, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del arg93_1
    ...
    assert_size_stride(buf77, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del buf75
    ...
    assert_size_stride(buf81, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del arg102_1
    ...
    assert_size_stride(buf91, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del buf89
    ...
    assert_size_stride(buf95, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del arg120_1
    ...
    assert_size_stride(buf98, (4, 512, 14, 14), (100352, 1, 7168, 512))
    del buf96
    del buf97
    ...
    assert_size_stride(buf102, (4, 1024, 14, 14), (200704, 1, 14336, 1024))
    del arg129_1
    buf103 = buf102; del buf102  # reuse
    buf104 = empty_strided((1024, 32, 3, 3), (288, 1, 96, 32), device='cpu', dtype=torch.float32)
    ...
    buf105 = extern_kernels.convolution(buf103, buf104, stride=(2, 2), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=32, bias=None)
    assert_size_stride(buf105, (4, 1024, 7, 7), (50176, 1, 7168, 1024))
    del buf103
    ...
    assert_size_stride(buf111, (4, 1024, 7, 7), (50176, 1, 7168, 1024))
    del arg141_1
    ...
    buf114 = extern_kernels.convolution(buf112, buf113, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=32, bias=None)
    ...
    assert_size_stride(buf118, (4, 1024, 7, 7), (50176, 1, 7168, 1024))
    del arg150_1
    ...
    buf121 = extern_kernels.convolution(buf119, buf120, stride=(1, 1), padding=(1, 1), dilation=(1, 1), transposed=False, output_padding=(0, 0), groups=32, bias=None)
    assert_size_stride(buf121, (4, 1024, 7, 7), (50176, 1, 7168, 1024))
    del buf119
    del buf120
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg6_1 = rand_strided((128, 4, 3, 3), (36, 9, 3, 1), device='cpu', dtype=torch.float32)
    arg7_1 = rand_strided((128, ), (1, ), device='cpu', dtype=torch.float32)
    arg8_1 = rand_strided((128, ), (1, ), device='cpu', dtype=torch.float32)
    arg9_1 = rand_strided((256, 128, 1, 1), (128, 1, 1, 1), device='cpu', dtype=torch.float32)
    ...
    arg48_1 = rand_strided((256, 8, 3, 3), (72, 9, 3, 1), device='cpu', dtype=torch.float32)
    arg49_1 = rand_strided((256, ), (1, ), device='cpu', dtype=torch.float32)
    arg50_1 = rand_strided((256, ), (1, ), device='cpu', dtype=torch.float32)
    arg51_1 = rand_strided((512, 256, 1, 1), (256, 1, 1, 1), device='cpu', dtype=torch.float32)
    ...
    arg141_1 = rand_strided((1024, 2048, 1, 1), (2048, 1, 1, 1), device='cpu', dtype=torch.float32)
    arg142_1 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
    arg143_1 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
    arg144_1 = rand_strided((1024, 32, 3, 3), (288, 9, 3, 1), device='cpu', dtype=torch.float32)
    ...
    arg150_1 = rand_strided((1024, 2048, 1, 1), (2048, 1, 1, 1), device='cpu', dtype=torch.float32)
    arg151_1 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
    arg152_1 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
    arg153_1 = rand_strided((1024, 32, 3, 3), (288, 9, 3, 1), device='cpu', dtype=torch.float32)
    ...
    arg216_1 = rand_strided((256, ), (1, ), device='cpu', dtype=torch.float32)
