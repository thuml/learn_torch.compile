...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 100608112)) \
        and (___check_obj_id(L['___stack0'], 17849568)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 134553936)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140423961534688))) \
        and (___compile_config_hash() == '46f2c5bfe6fd2bae00fcd57c7cbbb188') \
