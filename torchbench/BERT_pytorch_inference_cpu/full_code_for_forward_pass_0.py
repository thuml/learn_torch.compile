...
def __guard_0_for_forward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['mod'], 140130057616736)) \
        and (L['mod'].training == False) \
        and (___check_type_id(L['self'], 100789008)) \
        ...
        and (___check_obj_id(L['self'].autocast, 18029792)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140127005810912))) \
        and (___compile_config_hash() == '0a7aa23a7f7941c07e507cf21aad54c8') \
        ...
        and (___check_type_id(G['__import_torchbenchmark_dot_models_dot_BERT_pytorch_dot_bert_pytorch_dot_model_dot_attention_dot_single'].torch.float16, 140132168910592)) \
