...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    l__mod___features_0 = self.L__mod___features_0(l_inputs_0_);  l_inputs_0_ = None
    ...
    x_3 = self.L__mod___classifier_6(l__mod___classifier_5);  l__mod___classifier_5 = None
    return (x_3,)
