...
def forward(self, L_inputs_0_ : torch.Tensor):
    ...
    linear = torch._C._nn.linear(input = l_inputs_0_, weight = w, bias = l__mod___encode_b_0);  l_inputs_0_ = w = l__mod___encode_b_0 = None
    ...
    # File: /workspace/youkaichao/code/torchbenchmark/torchbenchmark/models/nvidia_deeprecommender/reco_encoder/model/model.py:11, code: return F.selu(input)
    z_2 = torch.nn.functional.selu(linear_5);  linear_5 = None
    return (z_2,)
