...
# kernel path: /tmp/torchinductor_youkaichao/pg/cpgimn7maq65cpn7oqvxswae7334lg6lonmhtcbumm77qnsb3wox.py
...
# kernel path: /tmp/torchinductor_youkaichao/jq/cjqtbfsfbmj5fjxkn7nrhvzg27hs34gbgro5m4yixpl5pexxceot.py
...
# kernel path: /tmp/torchinductor_youkaichao/nx/cnxe4p6v76dnmri2wuquqmcc3ru5ewu4bxxz4kvntrgg4e4mnpen.py
...
# kernel path: /tmp/torchinductor_youkaichao/a7/ca733e3rwjaf5uzbkwvev2hspwvijolcoh53bxnkyfheodr3vq37.py
...
# kernel path: /tmp/torchinductor_youkaichao/ei/cei6lk355xy474kg3wakjx6y7i2r47bo3x2sirj4np2et66ewh3a.py
...
# kernel path: /tmp/torchinductor_youkaichao/tr/ctrqyebri6btlh7dri5trog3zmkabv7iecw3uyeouocf6zzquzm5.py
...
# kernel path: /tmp/torchinductor_youkaichao/7t/c7tjnvpiszqftbobcq52yczgbxgcc3xpekanoylsyia3xjpdhjoe.py
...
# kernel path: /tmp/torchinductor_youkaichao/oq/coqqosj243la4325cnqstwju3cexfuxtwp6oxb275vicgbdm6l3p.py
...
def triton_(in_out_ptr0, in_out_ptr1, in_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        tl.store(in_out_ptr0 + (r2 + (2304*x3)), tmp2, rmask & xmask)
...
# kernel path: /tmp/torchinductor_youkaichao/yu/cyuyu7nezka4c7ya6fkgi46sgpjqmsmem3vbjpwzwwtyol2vj4cu.py
...
# kernel path: /tmp/torchinductor_youkaichao/b3/cb3sftmqxantpqahhporhy2whwopx3qmaownubmtn5bu45v2qcid.py
...
# kernel path: /tmp/torchinductor_youkaichao/md/cmdsmnpzjzqio5m6xdmogmvl747iqh5ttkyw3dtqa5fzuyrl3l5s.py
...
# kernel path: /tmp/torchinductor_youkaichao/ax/cax77g2gxceg3bos7travxabukwt2srw4n72guckccktki4cwa34.py
...
# kernel path: /tmp/torchinductor_youkaichao/kj/ckjgkertxdqrzar2w5ujgkc25gg55koutc5qpc6f67h46r34dqgy.py
...
# kernel path: /tmp/torchinductor_youkaichao/el/cel5mw4xunr2mmwcmnhh67luwx5oyhubyzm3gka2gdfcfz7iqmdw.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp3 < tmp1
    tmp5 = tmp2 & tmp4
    tmp6 = tl.load(in_ptr0 + (x0 + (48*x1) + (2304*x2)), tmp5 & xmask, other=0.0)
    tmp7 = 0.5
    tmp8 = tmp6 * tmp7
    tmp9 = 0.7071067811865476
    tmp10 = tmp6 * tmp9
...
# kernel path: /tmp/torchinductor_youkaichao/ru/crug4qmaxm37ahn3iv4dypxkhnbafyor3ovio5cr5rt3i6hhuo45.py
...
# kernel path: /tmp/torchinductor_youkaichao/r3/cr3kzmsfcvlth2ba5mc7hlqngdlgqfjmyxyb7ecplhzyo3zob6lv.py
...
# kernel path: /tmp/torchinductor_youkaichao/q3/cq3w5lamnljt3unct7cjn7r7ynixazjtbh2mil5wly3z3vsp6itp.py
...
# kernel path: /tmp/torchinductor_youkaichao/up/cupq76m5wufpysoieizf5wwler5lzhrmxl6z5gt726bqkhbmgpqf.py
...
# kernel path: /tmp/torchinductor_youkaichao/r4/cr4oulfntuuezztef7bskqttstobhesz3g6euomrf2kubrapncmv.py
...
# kernel path: /tmp/torchinductor_youkaichao/7w/c7wva2gjesb3vf3fempfociqakftj2drt5nmgv3ebz3yiz23u5qm.py
...
# kernel path: /tmp/torchinductor_youkaichao/mn/cmn5374l2tzwamksybyzafodv3zk2edtbnura7tcr5lkubksojvg.py
...
# kernel path: /tmp/torchinductor_youkaichao/cd/ccdzgfwru3zmjmvkqhsaihflwbo2gtqmccagye2nrvhmu6mj5cya.py
...
# kernel path: /tmp/torchinductor_youkaichao/i5/ci5ddqndz2hqi2r3tmjjcwrucfpegsnu2ke6gc4nezkmkzkotqz7.py
...
# kernel path: /tmp/torchinductor_youkaichao/2t/c2tnn4iwvuj2nsuwadhnkxqwk5qwtjsyjjbop5y4w6hvgzl3valr.py
...
# kernel path: /tmp/torchinductor_youkaichao/7z/c7z6tagnicyz2hfhghxl3xbi5riunxsu3lcv2v6jmw6gt57nfev2.py
...
# kernel path: /tmp/torchinductor_youkaichao/zd/czdm32sjygvountahc62pdocfsvpmmvadwptia2dhf477tsgz35i.py
...
# kernel path: /tmp/torchinductor_youkaichao/w2/cw2q2joezipq2rvyz4tgsa66kgw5uxg5fi24rkp6l3snhprxmlm4.py
...
# kernel path: /tmp/torchinductor_youkaichao/mu/cmuetymdtitqhmgwbpeh4ix324dv4cs4qpqljeeqisdxbwvkd3dt.py
...
# kernel path: /tmp/torchinductor_youkaichao/ew/cewsrvi5dgcy4qfvkc67yihcncqgjgqy4v6wmf5uza2ml7b3b7bz.py
...
# kernel path: /tmp/torchinductor_youkaichao/aj/caj36zoixac3fpwulw5jn7sqn6vpa52pzo37jmhojj3iynqrrkfr.py
...
# kernel path: /tmp/torchinductor_youkaichao/q4/cq4ik6oryh2xyfzwfwid2bvrgka5smf4ectt3cxbekxq4ljqzpgi.py
...
# kernel path: /tmp/torchinductor_youkaichao/wp/cwp36bt34nqmlh22s3ln6hzyw5ixeayjsgezv3pfok725gpfmzw4.py
...
# kernel path: /tmp/torchinductor_youkaichao/bo/cborcp54ullntgoacujruozjasldet6zv3tooipft3xx4bmcywdq.py
...
# kernel path: /tmp/torchinductor_youkaichao/ab/cabd4zvadmkvujmefowebiiy3adf5fs4p6fjmlpjwzqhebzkslsr.py
...
# kernel path: /tmp/torchinductor_youkaichao/hl/chld3qrwd7saqkotrm3y62ixaojdazuutvzmyl3pnk5dv76elblz.py
...
# kernel path: /tmp/torchinductor_youkaichao/y5/cy5el45nfht676nojpni6xwfhm22ypqidmwcggv7ffbb4fyv6k47.py
...
# kernel path: /tmp/torchinductor_youkaichao/2x/c2xehq5mcm6yse6o4rxuwnuq2s53kxq2hf7o6widyei44sdbuppd.py
...
# kernel path: /tmp/torchinductor_youkaichao/5x/c5xe3m5pgg6qy5btd5hns4hrvtunhdue4uvtkqja52hv43niy46e.py
...
# kernel path: /tmp/torchinductor_youkaichao/43/c43ukjmms3it53zdyy3ij66a6za2vk7ksj2csek46aeanwraynqs.py
...
# kernel path: /tmp/torchinductor_youkaichao/wk/cwk5nlr3fwg7ropglylsoch4yxl3apq3e3wpc7e3fbhaaxaw3bpf.py
...
# kernel path: /tmp/torchinductor_youkaichao/bi/cbinq64z6jqnxirjckmyi5wtb6arfgtaqf2kvgtcoe65xmsyriar.py
...
# kernel path: /tmp/torchinductor_youkaichao/7v/c7vxgip63blqpx7cwqeupn2xqdrqb5xveighaa73znq4idowlkmt.py
...
def call(args):
    ...
    assert_size_stride(primals_234, (4, 3, 192, 192), (110592, 36864, 192, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0) # no-op to ensure context
        buf0 = empty((4, 3, 193, 193), device='cuda', dtype=torch.float32)
        # Source Nodes: [x], Original ATen: [aten.constant_pad_nd]
        stream0 = get_cuda_stream(0)
        triton_poi_fused_constant_pad_nd_0.run(primals_234, buf0, 446988, grid=grid(446988), stream=stream0)
        del primals_234
        ...
        assert_size_stride(buf6, (4, 16, 96, 96), (147456, 9216, 96, 1))
        buf7 = buf6; del buf6  # reuse
        buf8 = empty((4, 16, 96, 96), device='cuda', dtype=torch.float32)
        # Source Nodes: [conv2d, gelu, mul_], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_2.run(buf7, primals_3, buf8, 589824, grid=grid(589824), stream=stream0)
        del primals_3
        ...
        assert_size_stride(buf14, (4, 32, 96, 96), (294912, 9216, 96, 1))
        buf15 = buf14; del buf14  # reuse
        buf16 = empty((4, 32, 96, 96), device='cuda', dtype=torch.float32)
        # Source Nodes: [conv2d_1, gelu_1, mul__1], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_4.run(buf15, primals_6, buf16, 1179648, grid=grid(1179648), stream=stream0)
        del primals_6
        ...
        assert_size_stride(buf22, (4, 64, 96, 96), (589824, 9216, 96, 1))
        buf23 = buf22; del buf22  # reuse
        # Source Nodes: [conv2d_2], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_6.run(buf23, primals_9, 2359296, grid=grid(2359296), stream=stream0)
        del primals_9
        buf24 = empty((4, 64, 97, 97), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_2, mul__2, x_2], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
        triton_poi_fused_constant_pad_nd_gelu_mul_7.run(buf23, buf24, 2408704, grid=grid(2408704), stream=stream0)
        ...
        assert_size_stride(buf30, (4, 128, 48, 48), (294912, 2304, 48, 1))
        buf31 = buf30; del buf30  # reuse
        buf32 = empty((4, 128, 48, 48), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_3, mul__3, out, shortcut], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_9.run(buf31, primals_12, buf32, 1179648, grid=grid(1179648), stream=stream0)
        del primals_12
        ...
        assert_size_stride(buf38, (4, 256, 48, 48), (589824, 2304, 48, 1))
        ...
        assert_size_stride(buf45, (4, 128, 48, 48), (294912, 2304, 48, 1))
        buf46 = buf45; del buf45  # reuse
        buf47 = empty((4, 128, 48, 48), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_4, mul__4, out_1], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_12.run(buf46, primals_18, buf47, 1179648, grid=grid(1179648), stream=stream0)
        del primals_18
        ...
        assert_size_stride(buf53, (4, 128, 48, 48), (294912, 2304, 48, 1))
        buf54 = buf53; del buf53  # reuse
        buf55 = empty((4, 128, 48, 48), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_5, mul__5, out_2], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_12.run(buf54, primals_21, buf55, 1179648, grid=grid(1179648), stream=stream0)
        del primals_21
        ...
        assert_size_stride(buf61, (4, 128, 48, 48), (294912, 2304, 48, 1))
        buf62 = buf61; del buf61  # reuse
        buf63 = empty((4, 128, 48, 48), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_6, mul__6, out_3], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_12.run(buf62, primals_24, buf63, 1179648, grid=grid(1179648), stream=stream0)
        del primals_24
        ...
        assert_size_stride(buf69, (4, 256, 48, 48), (589824, 2304, 48, 1))
        buf70 = buf69; del buf69  # reuse
        buf71 = empty_strided((4, 256, 1, 1), (256, 1, 1024, 1024), device='cuda', dtype=torch.float32)
        buf72 = reinterpret_tensor(buf71, (4, 256, 1, 1), (256, 1, 1, 1), 0); del buf71  # reuse
        # Source Nodes: [out_4, x_se], Original ATen: [aten.convolution, aten.mean]
        triton_red_fused_convolution_mean_14.run(buf70, buf72, primals_27, 1024, 2304, grid=grid(1024), stream=stream0)
        del primals_27
        ...
        assert_size_stride(buf73, (4, 128, 1, 1), (128, 1, 1, 1))
        buf74 = buf73; del buf73  # reuse
        # Source Nodes: [x_se_1, x_se_2], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_15.run(buf74, primals_185, 512, grid=grid(512), stream=stream0)
        del primals_185
        # Source Nodes: [x_se_3], Original ATen: [aten.convolution]
        ...
        assert_size_stride(buf75, (4, 256, 1, 1), (256, 1, 1, 1))
        buf76 = buf75; del buf75  # reuse
        # Source Nodes: [x_se_3], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_16.run(buf76, primals_187, 1024, grid=grid(1024), stream=stream0)
        del primals_187
        buf39 = buf38; del buf38  # reuse
        buf77 = empty((4, 256, 48, 48), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_7, mul_10, mul_12, mul__7, mul__8, out_5, out_8, shortcut_1, shortcut_2, sigmoid], Original ATen: [aten.add, aten.convolution, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_convolution_gelu_mul_sigmoid_17.run(buf39, primals_15, buf70, buf76, primals_28, buf77, 2359296, grid=grid(2359296), stream=stream0)
        del primals_15
        buf78 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [getattr_getattr_l__mod___stages___1_____0___downsample_pool], Original ATen: [aten.avg_pool2d]
        triton_poi_fused_avg_pool2d_18.run(buf77, buf78, 589824, grid=grid(589824), stream=stream0)
        ...
        assert_size_stride(buf84, (4, 512, 24, 24), (294912, 576, 24, 1))
        ...
        assert_size_stride(buf91, (4, 256, 48, 48), (589824, 2304, 48, 1))
        buf92 = buf91; del buf91  # reuse
        # Source Nodes: [out_9], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_21.run(buf92, primals_34, 2359296, grid=grid(2359296), stream=stream0)
        del primals_34
        buf93 = empty((4, 256, 49, 49), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_8, mul__9, x_5], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
        triton_poi_fused_constant_pad_nd_gelu_mul_22.run(buf92, buf93, 2458624, grid=grid(2458624), stream=stream0)
        ...
        assert_size_stride(buf99, (4, 256, 24, 24), (147456, 576, 24, 1))
        buf100 = buf99; del buf99  # reuse
        buf101 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_9, mul__10, out_10], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_24.run(buf100, primals_37, buf101, 589824, grid=grid(589824), stream=stream0)
        del primals_37
        ...
        assert_size_stride(buf107, (4, 256, 24, 24), (147456, 576, 24, 1))
        buf108 = buf107; del buf107  # reuse
        buf109 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_10, mul__11, out_11], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_24.run(buf108, primals_40, buf109, 589824, grid=grid(589824), stream=stream0)
        del primals_40
        ...
        assert_size_stride(buf115, (4, 512, 24, 24), (294912, 576, 24, 1))
        buf116 = buf115; del buf115  # reuse
        buf117 = empty_strided((4, 512, 1, 1), (512, 1, 2048, 2048), device='cuda', dtype=torch.float32)
        buf118 = reinterpret_tensor(buf117, (4, 512, 1, 1), (512, 1, 1, 1), 0); del buf117  # reuse
        # Source Nodes: [out_12, x_se_4], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_25.run(buf116, buf118, primals_43, 2048, 576, grid=grid(2048), stream=stream0)
        del primals_43
        ...
        # Source Nodes: [x_se_5, x_se_6], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_26.run(buf120, primals_189, 1024, grid=grid(1024), stream=stream0)
        del primals_189
        # Source Nodes: [x_se_7], Original ATen: [aten.convolution]
        ...
        assert_size_stride(buf121, (4, 512, 1, 1), (512, 1, 1, 1))
        buf122 = buf121; del buf121  # reuse
        # Source Nodes: [x_se_7], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_27.run(buf122, primals_191, 2048, grid=grid(2048), stream=stream0)
        del primals_191
        buf85 = buf84; del buf84  # reuse
        buf123 = empty((4, 512, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_11, mul_19, mul_21, mul__12, mul__13, out_13, out_16, shortcut_3, shortcut_4, sigmoid_1], Original ATen: [aten.add, aten.convolution, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_convolution_gelu_mul_sigmoid_28.run(buf85, primals_31, buf116, buf122, primals_44, buf123, 1179648, grid=grid(1179648), stream=stream0)
        del primals_31
        ...
        assert_size_stride(buf129, (4, 256, 24, 24), (147456, 576, 24, 1))
        buf130 = buf129; del buf129  # reuse
        buf131 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_12, mul__14, out_17], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_24.run(buf130, primals_47, buf131, 589824, grid=grid(589824), stream=stream0)
        del primals_47
        ...
        assert_size_stride(buf137, (4, 256, 24, 24), (147456, 576, 24, 1))
        buf138 = buf137; del buf137  # reuse
        buf139 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_13, mul__15, out_18], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_24.run(buf138, primals_50, buf139, 589824, grid=grid(589824), stream=stream0)
        del primals_50
        ...
        assert_size_stride(buf145, (4, 256, 24, 24), (147456, 576, 24, 1))
        buf146 = buf145; del buf145  # reuse
        buf147 = empty((4, 256, 24, 24), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_14, mul__16, out_19], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_24.run(buf146, primals_53, buf147, 589824, grid=grid(589824), stream=stream0)
        del primals_53
        ...
        assert_size_stride(buf153, (4, 512, 24, 24), (294912, 576, 24, 1))
        buf154 = buf153; del buf153  # reuse
        buf155 = empty_strided((4, 512, 1, 1), (512, 1, 2048, 2048), device='cuda', dtype=torch.float32)
        buf156 = reinterpret_tensor(buf155, (4, 512, 1, 1), (512, 1, 1, 1), 0); del buf155  # reuse
        # Source Nodes: [out_20, x_se_8], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_25.run(buf154, buf156, primals_56, 2048, 576, grid=grid(2048), stream=stream0)
        del primals_56
        ...
        assert_size_stride(buf157, (4, 256, 1, 1), (256, 1, 1, 1))
        buf158 = buf157; del buf157  # reuse
        # Source Nodes: [x_se_10, x_se_9], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_26.run(buf158, primals_193, 1024, grid=grid(1024), stream=stream0)
        del primals_193
        ...
        assert_size_stride(buf159, (4, 512, 1, 1), (512, 1, 1, 1))
        buf160 = buf159; del buf159  # reuse
        # Source Nodes: [x_se_11], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_27.run(buf160, primals_195, 2048, grid=grid(2048), stream=stream0)
        del primals_195
        buf161 = empty((4, 512, 24, 24), device='cuda', dtype=torch.float32)
        buf162 = buf161; del buf161  # reuse
        # Source Nodes: [gelu_15, mul_19, mul_21, mul_27, mul_29, mul__12, mul__17, mul__18, out_13, out_21, out_24, shortcut_4, shortcut_5, sigmoid_1, sigmoid_2], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_30.run(buf162, buf154, buf160, primals_57, buf116, buf122, primals_44, buf85, 1179648, grid=grid(1179648), stream=stream0)
        buf163 = empty((4, 512, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [getattr_getattr_l__mod___stages___2_____0___downsample_pool], Original ATen: [aten.avg_pool2d]
        triton_poi_fused_avg_pool2d_31.run(buf162, buf163, 294912, grid=grid(294912), stream=stream0)
        ...
        assert_size_stride(buf169, (4, 1536, 12, 12), (221184, 144, 12, 1))
        ...
        assert_size_stride(buf176, (4, 768, 24, 24), (442368, 576, 24, 1))
        buf177 = buf176; del buf176  # reuse
        # Source Nodes: [out_25], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_34.run(buf177, primals_63, 1769472, grid=grid(1769472), stream=stream0)
        del primals_63
        buf178 = empty((4, 768, 25, 25), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_16, mul__19, x_7], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
        triton_poi_fused_constant_pad_nd_gelu_mul_35.run(buf177, buf178, 1920000, grid=grid(1920000), stream=stream0)
        ...
        assert_size_stride(buf184, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf185 = buf184; del buf184  # reuse
        buf186 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_17, mul__20, out_26], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf185, primals_66, buf186, 442368, grid=grid(442368), stream=stream0)
        del primals_66
        ...
        assert_size_stride(buf192, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf193 = buf192; del buf192  # reuse
        buf194 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_18, mul__21, out_27], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf193, primals_69, buf194, 442368, grid=grid(442368), stream=stream0)
        del primals_69
        ...
        assert_size_stride(buf200, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf201 = buf200; del buf200  # reuse
        buf202 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf203 = reinterpret_tensor(buf202, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf202  # reuse
        # Source Nodes: [out_28, x_se_12], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf201, buf203, primals_72, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_72
        ...
        assert_size_stride(buf204, (4, 768, 1, 1), (768, 1, 1, 1))
        buf205 = buf204; del buf204  # reuse
        # Source Nodes: [x_se_13, x_se_14], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf205, primals_197, 3072, grid=grid(3072), stream=stream0)
        del primals_197
        # Source Nodes: [x_se_15], Original ATen: [aten.convolution]
        ...
        assert_size_stride(buf206, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf207 = buf206; del buf206  # reuse
        # Source Nodes: [x_se_15], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf207, primals_199, 6144, grid=grid(6144), stream=stream0)
        del primals_199
        buf170 = buf169; del buf169  # reuse
        buf208 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_19, mul_36, mul_38, mul__22, mul__23, out_29, out_32, shortcut_6, shortcut_7, sigmoid_3], Original ATen: [aten.add, aten.convolution, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_convolution_gelu_mul_sigmoid_42.run(buf170, primals_60, buf201, buf207, primals_73, buf208, 884736, grid=grid(884736), stream=stream0)
        del primals_60
        ...
        assert_size_stride(buf214, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf215 = buf214; del buf214  # reuse
        buf216 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_20, mul__24, out_33], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf215, primals_76, buf216, 442368, grid=grid(442368), stream=stream0)
        del primals_76
        ...
        assert_size_stride(buf222, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf223 = buf222; del buf222  # reuse
        buf224 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_21, mul__25, out_34], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf223, primals_79, buf224, 442368, grid=grid(442368), stream=stream0)
        del primals_79
        ...
        assert_size_stride(buf230, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf231 = buf230; del buf230  # reuse
        buf232 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_22, mul__26, out_35], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf231, primals_82, buf232, 442368, grid=grid(442368), stream=stream0)
        del primals_82
        ...
        assert_size_stride(buf238, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf239 = buf238; del buf238  # reuse
        buf240 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf241 = reinterpret_tensor(buf240, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf240  # reuse
        # Source Nodes: [out_36, x_se_16], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf239, buf241, primals_85, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_85
        ...
        assert_size_stride(buf242, (4, 768, 1, 1), (768, 1, 1, 1))
        buf243 = buf242; del buf242  # reuse
        # Source Nodes: [x_se_17, x_se_18], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf243, primals_201, 3072, grid=grid(3072), stream=stream0)
        del primals_201
        ...
        assert_size_stride(buf244, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf245 = buf244; del buf244  # reuse
        # Source Nodes: [x_se_19], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf245, primals_203, 6144, grid=grid(6144), stream=stream0)
        del primals_203
        buf246 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        buf247 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_23, mul_36, mul_38, mul_44, mul_46, mul__22, mul__27, mul__28, out_29, out_37, out_40, shortcut_7, shortcut_8, sigmoid_3, sigmoid_4], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_44.run(buf239, buf245, primals_86, buf201, buf207, primals_73, buf170, buf246, buf247, 884736, grid=grid(884736), stream=stream0)
        ...
        assert_size_stride(buf253, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf254 = buf253; del buf253  # reuse
        buf255 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_24, mul__29, out_41], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf254, primals_89, buf255, 442368, grid=grid(442368), stream=stream0)
        del primals_89
        ...
        assert_size_stride(buf261, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf262 = buf261; del buf261  # reuse
        buf263 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_25, mul__30, out_42], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf262, primals_92, buf263, 442368, grid=grid(442368), stream=stream0)
        del primals_92
        ...
        assert_size_stride(buf269, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf270 = buf269; del buf269  # reuse
        buf271 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_26, mul__31, out_43], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf270, primals_95, buf271, 442368, grid=grid(442368), stream=stream0)
        del primals_95
        ...
        assert_size_stride(buf277, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf278 = buf277; del buf277  # reuse
        buf279 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf280 = reinterpret_tensor(buf279, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf279  # reuse
        # Source Nodes: [out_44, x_se_20], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf278, buf280, primals_98, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_98
        ...
        assert_size_stride(buf281, (4, 768, 1, 1), (768, 1, 1, 1))
        buf282 = buf281; del buf281  # reuse
        # Source Nodes: [x_se_21, x_se_22], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf282, primals_205, 3072, grid=grid(3072), stream=stream0)
        del primals_205
        ...
        assert_size_stride(buf283, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf284 = buf283; del buf283  # reuse
        # Source Nodes: [x_se_23], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf284, primals_207, 6144, grid=grid(6144), stream=stream0)
        del primals_207
        buf285 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_27, mul_52, mul_54, mul__32, mul__33, out_45, out_48, shortcut_9, sigmoid_5], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_45.run(buf278, buf284, primals_99, buf246, buf285, 884736, grid=grid(884736), stream=stream0)
        ...
        assert_size_stride(buf291, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf292 = buf291; del buf291  # reuse
        buf293 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_28, mul__34, out_49], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf292, primals_102, buf293, 442368, grid=grid(442368), stream=stream0)
        del primals_102
        ...
        assert_size_stride(buf299, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf300 = buf299; del buf299  # reuse
        buf301 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_29, mul__35, out_50], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf300, primals_105, buf301, 442368, grid=grid(442368), stream=stream0)
        del primals_105
        ...
        assert_size_stride(buf307, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf308 = buf307; del buf307  # reuse
        buf309 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_30, mul__36, out_51], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf308, primals_108, buf309, 442368, grid=grid(442368), stream=stream0)
        del primals_108
        ...
        assert_size_stride(buf315, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf316 = buf315; del buf315  # reuse
        buf317 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf318 = reinterpret_tensor(buf317, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf317  # reuse
        # Source Nodes: [out_52, x_se_24], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf316, buf318, primals_111, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_111
        ...
        assert_size_stride(buf319, (4, 768, 1, 1), (768, 1, 1, 1))
        buf320 = buf319; del buf319  # reuse
        # Source Nodes: [x_se_25, x_se_26], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf320, primals_209, 3072, grid=grid(3072), stream=stream0)
        del primals_209
        ...
        assert_size_stride(buf321, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf322 = buf321; del buf321  # reuse
        # Source Nodes: [x_se_27], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf322, primals_211, 6144, grid=grid(6144), stream=stream0)
        del primals_211
        buf323 = buf246; del buf246  # reuse
        buf324 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_31, mul_52, mul_54, mul_60, mul_62, mul__32, mul__37, mul__38, out_45, out_53, out_56, shortcut_10, shortcut_9, sigmoid_5, sigmoid_6], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_46.run(buf323, buf316, buf322, primals_112, buf278, buf284, primals_99, buf324, 884736, grid=grid(884736), stream=stream0)
        ...
        assert_size_stride(buf330, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf331 = buf330; del buf330  # reuse
        buf332 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_32, mul__39, out_57], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf331, primals_115, buf332, 442368, grid=grid(442368), stream=stream0)
        del primals_115
        ...
        assert_size_stride(buf338, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf339 = buf338; del buf338  # reuse
        buf340 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_33, mul__40, out_58], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf339, primals_118, buf340, 442368, grid=grid(442368), stream=stream0)
        del primals_118
        ...
        assert_size_stride(buf346, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf347 = buf346; del buf346  # reuse
        buf348 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_34, mul__41, out_59], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf347, primals_121, buf348, 442368, grid=grid(442368), stream=stream0)
        del primals_121
        ...
        assert_size_stride(buf354, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf355 = buf354; del buf354  # reuse
        buf356 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf357 = reinterpret_tensor(buf356, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf356  # reuse
        # Source Nodes: [out_60, x_se_28], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf355, buf357, primals_124, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_124
        ...
        assert_size_stride(buf358, (4, 768, 1, 1), (768, 1, 1, 1))
        buf359 = buf358; del buf358  # reuse
        # Source Nodes: [x_se_29, x_se_30], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf359, primals_213, 3072, grid=grid(3072), stream=stream0)
        del primals_213
        ...
        assert_size_stride(buf360, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf361 = buf360; del buf360  # reuse
        # Source Nodes: [x_se_31], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf361, primals_215, 6144, grid=grid(6144), stream=stream0)
        del primals_215
        buf362 = empty((4, 1536, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_35, mul_68, mul_70, mul__42, mul__43, out_61, out_64, shortcut_11, sigmoid_7], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_47.run(buf355, buf361, primals_125, buf323, buf362, 884736, grid=grid(884736), stream=stream0)
        ...
        assert_size_stride(buf368, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf369 = buf368; del buf368  # reuse
        buf370 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_36, mul__44, out_65], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf369, primals_128, buf370, 442368, grid=grid(442368), stream=stream0)
        del primals_128
        ...
        assert_size_stride(buf376, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf377 = buf376; del buf376  # reuse
        buf378 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_37, mul__45, out_66], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf377, primals_131, buf378, 442368, grid=grid(442368), stream=stream0)
        del primals_131
        ...
        assert_size_stride(buf384, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf385 = buf384; del buf384  # reuse
        buf386 = empty((4, 768, 12, 12), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_38, mul__46, out_67], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_37.run(buf385, primals_134, buf386, 442368, grid=grid(442368), stream=stream0)
        del primals_134
        ...
        assert_size_stride(buf392, (4, 1536, 12, 12), (221184, 144, 12, 1))
        buf393 = buf392; del buf392  # reuse
        buf394 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf395 = reinterpret_tensor(buf394, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf394  # reuse
        # Source Nodes: [out_68, x_se_32], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_39.run(buf393, buf395, primals_137, 6144, 144, grid=grid(6144), stream=stream0)
        del primals_137
        ...
        assert_size_stride(buf396, (4, 768, 1, 1), (768, 1, 1, 1))
        buf397 = buf396; del buf396  # reuse
        # Source Nodes: [x_se_33, x_se_34], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf397, primals_217, 3072, grid=grid(3072), stream=stream0)
        del primals_217
        ...
        assert_size_stride(buf398, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf399 = buf398; del buf398  # reuse
        # Source Nodes: [x_se_35], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf399, primals_219, 6144, grid=grid(6144), stream=stream0)
        del primals_219
        buf400 = buf323; del buf323  # reuse
        buf401 = buf400; del buf400  # reuse
        # Source Nodes: [gelu_39, mul_68, mul_70, mul_76, mul_78, mul__42, mul__47, mul__48, out_61, out_69, out_72, shortcut_11, shortcut_12, sigmoid_7, sigmoid_8], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_48.run(buf401, buf393, buf399, primals_138, buf355, buf361, primals_125, 884736, grid=grid(884736), stream=stream0)
        buf402 = empty((4, 1536, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [getattr_getattr_l__mod___stages___3_____0___downsample_pool], Original ATen: [aten.avg_pool2d]
        triton_poi_fused_avg_pool2d_49.run(buf401, buf402, 221184, grid=grid(221184), stream=stream0)
        ...
        assert_size_stride(buf408, (4, 1536, 6, 6), (55296, 36, 6, 1))
        ...
        assert_size_stride(buf415, (4, 768, 12, 12), (110592, 144, 12, 1))
        buf416 = buf415; del buf415  # reuse
        # Source Nodes: [out_73], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_51.run(buf416, primals_144, 442368, grid=grid(442368), stream=stream0)
        del primals_144
        buf417 = empty((4, 768, 13, 13), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_40, mul__49, x_9], Original ATen: [aten.constant_pad_nd, aten.gelu, aten.mul]
        triton_poi_fused_constant_pad_nd_gelu_mul_52.run(buf416, buf417, 519168, grid=grid(519168), stream=stream0)
        ...
        assert_size_stride(buf423, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf424 = buf423; del buf423  # reuse
        buf425 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_41, mul__50, out_74], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf424, primals_147, buf425, 110592, grid=grid(110592), stream=stream0)
        del primals_147
        ...
        assert_size_stride(buf431, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf432 = buf431; del buf431  # reuse
        buf433 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_42, mul__51, out_75], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf432, primals_150, buf433, 110592, grid=grid(110592), stream=stream0)
        del primals_150
        ...
        assert_size_stride(buf439, (4, 1536, 6, 6), (55296, 36, 6, 1))
        buf440 = buf439; del buf439  # reuse
        buf441 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf442 = reinterpret_tensor(buf441, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf441  # reuse
        # Source Nodes: [out_76, x_se_36], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_54.run(buf440, buf442, primals_153, 6144, 36, grid=grid(6144), stream=stream0)
        del primals_153
        ...
        assert_size_stride(buf443, (4, 768, 1, 1), (768, 1, 1, 1))
        buf444 = buf443; del buf443  # reuse
        # Source Nodes: [x_se_37, x_se_38], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf444, primals_221, 3072, grid=grid(3072), stream=stream0)
        del primals_221
        ...
        assert_size_stride(buf445, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf446 = buf445; del buf445  # reuse
        # Source Nodes: [x_se_39], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf446, primals_223, 6144, grid=grid(6144), stream=stream0)
        del primals_223
        buf409 = buf408; del buf408  # reuse
        buf447 = empty((4, 1536, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_43, mul_85, mul_87, mul__52, mul__53, out_77, out_80, shortcut_13, shortcut_14, sigmoid_9], Original ATen: [aten.add, aten.convolution, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_convolution_gelu_mul_sigmoid_55.run(buf409, primals_141, buf440, buf446, primals_154, buf447, 221184, grid=grid(221184), stream=stream0)
        del primals_141
        ...
        assert_size_stride(buf453, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf454 = buf453; del buf453  # reuse
        buf455 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_44, mul__54, out_81], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf454, primals_157, buf455, 110592, grid=grid(110592), stream=stream0)
        del primals_157
        ...
        assert_size_stride(buf461, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf462 = buf461; del buf461  # reuse
        buf463 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_45, mul__55, out_82], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf462, primals_160, buf463, 110592, grid=grid(110592), stream=stream0)
        del primals_160
        ...
        assert_size_stride(buf469, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf470 = buf469; del buf469  # reuse
        buf471 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_46, mul__56, out_83], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf470, primals_163, buf471, 110592, grid=grid(110592), stream=stream0)
        del primals_163
        ...
        assert_size_stride(buf477, (4, 1536, 6, 6), (55296, 36, 6, 1))
        buf478 = buf477; del buf477  # reuse
        buf479 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf480 = reinterpret_tensor(buf479, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf479  # reuse
        # Source Nodes: [out_84, x_se_40], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_54.run(buf478, buf480, primals_166, 6144, 36, grid=grid(6144), stream=stream0)
        del primals_166
        ...
        assert_size_stride(buf481, (4, 768, 1, 1), (768, 1, 1, 1))
        buf482 = buf481; del buf481  # reuse
        # Source Nodes: [x_se_41, x_se_42], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf482, primals_225, 3072, grid=grid(3072), stream=stream0)
        del primals_225
        ...
        assert_size_stride(buf483, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf484 = buf483; del buf483  # reuse
        # Source Nodes: [x_se_43], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf484, primals_227, 6144, grid=grid(6144), stream=stream0)
        del primals_227
        buf485 = empty((4, 1536, 6, 6), device='cuda', dtype=torch.float32)
        buf486 = empty((4, 1536, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_47, mul_85, mul_87, mul_93, mul_95, mul__52, mul__57, mul__58, out_77, out_85, out_88, shortcut_14, shortcut_15, sigmoid_10, sigmoid_9], Original ATen: [aten.add, aten.gelu, aten.mul, aten.sigmoid]
        triton_poi_fused_add_gelu_mul_sigmoid_56.run(buf478, buf484, primals_167, buf440, buf446, primals_154, buf409, buf485, buf486, 221184, grid=grid(221184), stream=stream0)
        ...
        assert_size_stride(buf492, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf493 = buf492; del buf492  # reuse
        buf494 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_48, mul__59, out_89], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf493, primals_170, buf494, 110592, grid=grid(110592), stream=stream0)
        del primals_170
        ...
        assert_size_stride(buf500, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf501 = buf500; del buf500  # reuse
        buf502 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_49, mul__60, out_90], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf501, primals_173, buf502, 110592, grid=grid(110592), stream=stream0)
        del primals_173
        ...
        assert_size_stride(buf508, (4, 768, 6, 6), (27648, 36, 6, 1))
        buf509 = buf508; del buf508  # reuse
        buf510 = empty((4, 768, 6, 6), device='cuda', dtype=torch.float32)
        # Source Nodes: [gelu_50, mul__61, out_91], Original ATen: [aten.convolution, aten.gelu, aten.mul]
        triton_poi_fused_convolution_gelu_mul_53.run(buf509, primals_176, buf510, 110592, grid=grid(110592), stream=stream0)
        del primals_176
        ...
        assert_size_stride(buf516, (4, 1536, 6, 6), (55296, 36, 6, 1))
        buf517 = buf516; del buf516  # reuse
        buf518 = empty_strided((4, 1536, 1, 1), (1536, 1, 6144, 6144), device='cuda', dtype=torch.float32)
        buf519 = reinterpret_tensor(buf518, (4, 1536, 1, 1), (1536, 1, 1, 1), 0); del buf518  # reuse
        # Source Nodes: [out_92, x_se_44], Original ATen: [aten.convolution, aten.mean]
        triton_per_fused_convolution_mean_54.run(buf517, buf519, primals_179, 6144, 36, grid=grid(6144), stream=stream0)
        del primals_179
        ...
        assert_size_stride(buf520, (4, 768, 1, 1), (768, 1, 1, 1))
        buf521 = buf520; del buf520  # reuse
        # Source Nodes: [x_se_45, x_se_46], Original ATen: [aten.convolution, aten.relu]
        triton_poi_fused_convolution_relu_40.run(buf521, primals_229, 3072, grid=grid(3072), stream=stream0)
        del primals_229
        ...
        assert_size_stride(buf522, (4, 1536, 1, 1), (1536, 1, 1, 1))
        buf523 = buf522; del buf522  # reuse
        # Source Nodes: [x_se_47], Original ATen: [aten.convolution]
        triton_poi_fused_convolution_41.run(buf523, primals_231, 6144, grid=grid(6144), stream=stream0)
        del primals_231
        buf524 = buf485; del buf485  # reuse
        # Source Nodes: [mul_101, mul_103, mul__62, out_93, sigmoid_11, x_10], Original ATen: [aten.add, aten.mul, aten.sigmoid]
        triton_poi_fused_add_mul_sigmoid_57.run(buf524, buf517, buf523, primals_180, 221184, grid=grid(221184), stream=stream0)
        ...
        assert_size_stride(buf530, (4, 3072, 6, 6), (110592, 36, 6, 1))
        buf531 = buf530; del buf530  # reuse
        buf532 = empty_strided((4, 3072, 1, 1), (3072, 1, 12288, 12288), device='cuda', dtype=torch.float32)
        buf533 = reinterpret_tensor(buf532, (4, 3072), (3072, 1), 0); del buf532  # reuse
        # Source Nodes: [gelu_51, x_11, x_13, x_14, x_16], Original ATen: [aten.convolution, aten.gelu, aten.mean, aten.mul, aten.view]
        triton_per_fused_convolution_gelu_mean_mul_view_59.run(buf531, buf533, primals_183, 12288, 36, grid=grid(12288), stream=stream0)
        del primals_183
        buf534 = empty((4, 1000), device='cuda', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_234 = rand_strided((4, 3, 192, 192), (110592, 36864, 192, 1), device='cuda:0', dtype=torch.float32)
