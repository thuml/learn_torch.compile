...
def forward(self, primals_1: "f32[64, 3, 7, 7]", primals_2: "f32[64]", primals_3: "f32[64]", primals_4: "f32[64, 64, 3, 3]", primals_5: "f32[64]", primals_6: "f32[64]", primals_7: "f32[64, 64, 3, 3]", primals_8: "f32[64]", primals_9: "f32[64]", primals_10: "f32[64, 64, 3, 3]", primals_11: "f32[64]", primals_12: "f32[64]", primals_13: "f32[64, 64, 3, 3]", primals_14: "f32[64]", primals_15: "f32[64]", primals_16: "f32[128, 64, 3, 3]", primals_17: "f32[128]", primals_18: "f32[128]", primals_19: "f32[128, 128, 3, 3]", primals_20: "f32[128]", primals_21: "f32[128]", primals_22: "f32[128, 64, 1, 1]", primals_23: "f32[128]", primals_24: "f32[128]", primals_25: "f32[128, 128, 3, 3]", primals_26: "f32[128]", primals_27: "f32[128]", primals_28: "f32[128, 128, 3, 3]", primals_29: "f32[128]", primals_30: "f32[128]", primals_31: "f32[256, 128, 3, 3]", primals_32: "f32[256]", primals_33: "f32[256]", primals_34: "f32[256, 256, 3, 3]", primals_35: "f32[256]", primals_36: "f32[256]", primals_37: "f32[256, 128, 1, 1]", primals_38: "f32[256]", primals_39: "f32[256]", primals_40: "f32[256, 256, 3, 3]", primals_41: "f32[256]", primals_42: "f32[256]", primals_43: "f32[256, 256, 3, 3]", primals_44: "f32[256]", primals_45: "f32[256]", primals_46: "f32[512, 256, 3, 3]", primals_47: "f32[512]", primals_48: "f32[512]", primals_49: "f32[512, 512, 3, 3]", primals_50: "f32[512]", primals_51: "f32[512]", primals_52: "f32[512, 256, 1, 1]", primals_53: "f32[512]", primals_54: "f32[512]", primals_55: "f32[512, 512, 3, 3]", primals_56: "f32[512]", primals_57: "f32[512]", primals_58: "f32[512, 512, 3, 3]", primals_59: "f32[512]", primals_60: "f32[512]", primals_61: "f32[1000, 512]", primals_62: "f32[1000]", primals_63: "f32[64]", primals_64: "f32[64]", primals_65: "i64[]", primals_66: "f32[64]", primals_67: "f32[64]", primals_68: "i64[]", primals_69: "f32[64]", primals_70: "f32[64]", primals_71: "i64[]", primals_72: "f32[64]", primals_73: "f32[64]", primals_74: "i64[]", primals_75: "f32[64]", primals_76: "f32[64]", primals_77: "i64[]", primals_78: "f32[128]", primals_79: "f32[128]", primals_80: "i64[]", primals_81: "f32[128]", primals_82: "f32[128]", primals_83: "i64[]", primals_84: "f32[128]", primals_85: "f32[128]", primals_86: "i64[]", primals_87: "f32[128]", primals_88: "f32[128]", primals_89: "i64[]", primals_90: "f32[128]", primals_91: "f32[128]", primals_92: "i64[]", primals_93: "f32[256]", primals_94: "f32[256]", primals_95: "i64[]", primals_96: "f32[256]", primals_97: "f32[256]", primals_98: "i64[]", primals_99: "f32[256]", primals_100: "f32[256]", primals_101: "i64[]", primals_102: "f32[256]", primals_103: "f32[256]", primals_104: "i64[]", primals_105: "f32[256]", primals_106: "f32[256]", primals_107: "i64[]", primals_108: "f32[512]", primals_109: "f32[512]", primals_110: "i64[]", primals_111: "f32[512]", primals_112: "f32[512]", primals_113: "i64[]", primals_114: "f32[512]", primals_115: "f32[512]", primals_116: "i64[]", primals_117: "f32[512]", primals_118: "f32[512]", primals_119: "i64[]", primals_120: "f32[512]", primals_121: "f32[512]", primals_122: "i64[]", primals_123: "f32[4, 3, 224, 224]"):
    ...
    add: "f32[64]" = torch.ops.aten.add.Tensor(primals_64, 1e-05)
    ...
    unsqueeze: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_63, -1)
    ...
    add_2: "f32[64]" = torch.ops.aten.add.Tensor(primals_67, 1e-05)
    ...
    unsqueeze_8: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_66, -1)
    ...
    add_4: "f32[64]" = torch.ops.aten.add.Tensor(primals_70, 1e-05)
    ...
    unsqueeze_16: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_69, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_7: "f32[64]" = torch.ops.aten.add.Tensor(primals_73, 1e-05)
    ...
    unsqueeze_24: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_72, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_9: "f32[64]" = torch.ops.aten.add.Tensor(primals_76, 1e-05)
    ...
    unsqueeze_32: "f32[64, 1]" = torch.ops.aten.unsqueeze.default(primals_75, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_12: "f32[128]" = torch.ops.aten.add.Tensor(primals_79, 1e-05)
    ...
    unsqueeze_40: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_78, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_14: "f32[128]" = torch.ops.aten.add.Tensor(primals_82, 1e-05)
    ...
    unsqueeze_48: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_81, -1)
    ...
    add_16: "f32[128]" = torch.ops.aten.add.Tensor(primals_85, 1e-05)
    ...
    unsqueeze_56: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_84, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_19: "f32[128]" = torch.ops.aten.add.Tensor(primals_88, 1e-05)
    ...
    unsqueeze_64: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_87, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_21: "f32[128]" = torch.ops.aten.add.Tensor(primals_91, 1e-05)
    ...
    unsqueeze_72: "f32[128, 1]" = torch.ops.aten.unsqueeze.default(primals_90, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_24: "f32[256]" = torch.ops.aten.add.Tensor(primals_94, 1e-05)
    ...
    unsqueeze_80: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_93, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_26: "f32[256]" = torch.ops.aten.add.Tensor(primals_97, 1e-05)
    ...
    unsqueeze_88: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_96, -1)
    ...
    add_28: "f32[256]" = torch.ops.aten.add.Tensor(primals_100, 1e-05)
    ...
    unsqueeze_96: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_99, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_31: "f32[256]" = torch.ops.aten.add.Tensor(primals_103, 1e-05)
    ...
    unsqueeze_104: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_102, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_33: "f32[256]" = torch.ops.aten.add.Tensor(primals_106, 1e-05)
    ...
    unsqueeze_112: "f32[256, 1]" = torch.ops.aten.unsqueeze.default(primals_105, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_36: "f32[512]" = torch.ops.aten.add.Tensor(primals_109, 1e-05)
    ...
    unsqueeze_120: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_108, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_38: "f32[512]" = torch.ops.aten.add.Tensor(primals_112, 1e-05)
    ...
    unsqueeze_128: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_111, -1)
    ...
    add_40: "f32[512]" = torch.ops.aten.add.Tensor(primals_115, 1e-05)
    ...
    unsqueeze_136: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_114, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:93, code: out = self.bn1(out)
    add_43: "f32[512]" = torch.ops.aten.add.Tensor(primals_118, 1e-05)
    ...
    unsqueeze_144: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_117, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:97, code: out = self.bn2(out)
    add_45: "f32[512]" = torch.ops.aten.add.Tensor(primals_121, 1e-05)
    ...
    unsqueeze_152: "f32[512, 1]" = torch.ops.aten.unsqueeze.default(primals_120, -1)
    ...
    # File: /workspace/youkaichao/code/torchvision/torchvision/models/resnet.py:103, code: out = self.relu(out)
    le: "b8[4, 512, 7, 7]" = torch.ops.aten.le.Scalar(relu_16, 0);  relu_16 = None
