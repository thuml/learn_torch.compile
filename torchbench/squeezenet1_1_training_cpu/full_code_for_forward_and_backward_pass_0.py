...
def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 118487648)) \
        and (___check_obj_id(L['___stack0'], 35728608)) \
        and (hasattr(L['___stack1'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 152389232)) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(139675877794016))) \
        and (___compile_config_hash() == '2cb9b0f4e59b704f1b649d8c77192b4e') \
