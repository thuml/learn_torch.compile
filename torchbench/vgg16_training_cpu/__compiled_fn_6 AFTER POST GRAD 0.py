...
def forward(self, primals_1: "f32[64, 3, 3, 3]", primals_3: "f32[64, 64, 3, 3]", primals_5: "f32[128, 64, 3, 3]", primals_7: "f32[128, 128, 3, 3]", primals_9: "f32[256, 128, 3, 3]", primals_11: "f32[256, 256, 3, 3]", primals_13: "f32[256, 256, 3, 3]", primals_15: "f32[512, 256, 3, 3]", primals_17: "f32[512, 512, 3, 3]", primals_19: "f32[512, 512, 3, 3]", primals_21: "f32[512, 512, 3, 3]", primals_23: "f32[512, 512, 3, 3]", primals_25: "f32[512, 512, 3, 3]", primals_33: "f32[4, 3, 224, 224]", relu: "f32[4, 64, 224, 224]", relu_1: "f32[4, 64, 224, 224]", getitem: "f32[4, 64, 112, 112]", getitem_1: "i64[4, 64, 112, 112]", relu_2: "f32[4, 128, 112, 112]", relu_3: "f32[4, 128, 112, 112]", getitem_2: "f32[4, 128, 56, 56]", getitem_3: "i64[4, 128, 56, 56]", relu_4: "f32[4, 256, 56, 56]", relu_5: "f32[4, 256, 56, 56]", relu_6: "f32[4, 256, 56, 56]", getitem_4: "f32[4, 256, 28, 28]", getitem_5: "i64[4, 256, 28, 28]", relu_7: "f32[4, 512, 28, 28]", relu_8: "f32[4, 512, 28, 28]", relu_9: "f32[4, 512, 28, 28]", getitem_6: "f32[4, 512, 14, 14]", getitem_7: "i64[4, 512, 14, 14]", relu_10: "f32[4, 512, 14, 14]", relu_11: "f32[4, 512, 14, 14]", relu_12: "f32[4, 512, 14, 14]", getitem_8: "f32[4, 512, 7, 7]", getitem_9: "i64[4, 512, 7, 7]", view: "f32[4, 25088]", clone: "f32[4, 4096]", clone_1: "f32[4, 4096]", permute_3: "f32[1000, 4096]", le: "b8[4, 4096]", permute_7: "f32[4096, 4096]", le_1: "b8[4, 4096]", permute_11: "f32[4096, 25088]", tangents_1: "f32[4, 1000]"):
    ...
    view_4: "f32[4, 512, 7, 7]" = torch.ops.aten.reshape.default(mm_4, [4, 512, 7, 7]);  mm_4 = None
    ...
    le_2: "b8[4, 512, 14, 14]" = torch.ops.aten.le.Scalar(relu_12, 0);  relu_12 = None
    ...
    convolution_backward = torch.ops.aten.convolution_backward.default(where_2, relu_11, primals_25, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_2 = primals_25 = None
    getitem_10: "f32[4, 512, 14, 14]" = convolution_backward[0]
    getitem_11: "f32[512, 512, 3, 3]" = convolution_backward[1]
    getitem_12: "f32[512]" = convolution_backward[2];  convolution_backward = None
    le_3: "b8[4, 512, 14, 14]" = torch.ops.aten.le.Scalar(relu_11, 0);  relu_11 = None
    where_3: "f32[4, 512, 14, 14]" = torch.ops.aten.where.self(le_3, full_default, getitem_10);  le_3 = getitem_10 = None
    convolution_backward_1 = torch.ops.aten.convolution_backward.default(where_3, relu_10, primals_23, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_3 = primals_23 = None
    getitem_13: "f32[4, 512, 14, 14]" = convolution_backward_1[0]
    getitem_14: "f32[512, 512, 3, 3]" = convolution_backward_1[1]
    getitem_15: "f32[512]" = convolution_backward_1[2];  convolution_backward_1 = None
    le_4: "b8[4, 512, 14, 14]" = torch.ops.aten.le.Scalar(relu_10, 0);  relu_10 = None
    where_4: "f32[4, 512, 14, 14]" = torch.ops.aten.where.self(le_4, full_default, getitem_13);  le_4 = getitem_13 = None
    convolution_backward_2 = torch.ops.aten.convolution_backward.default(where_4, getitem_6, primals_21, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_4 = getitem_6 = primals_21 = None
    getitem_16: "f32[4, 512, 14, 14]" = convolution_backward_2[0]
    getitem_17: "f32[512, 512, 3, 3]" = convolution_backward_2[1]
    getitem_18: "f32[512]" = convolution_backward_2[2];  convolution_backward_2 = None
    ...
    le_5: "b8[4, 512, 28, 28]" = torch.ops.aten.le.Scalar(relu_9, 0);  relu_9 = None
    ...
    convolution_backward_3 = torch.ops.aten.convolution_backward.default(where_5, relu_8, primals_19, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_5 = primals_19 = None
    getitem_19: "f32[4, 512, 28, 28]" = convolution_backward_3[0]
    getitem_20: "f32[512, 512, 3, 3]" = convolution_backward_3[1]
    getitem_21: "f32[512]" = convolution_backward_3[2];  convolution_backward_3 = None
    le_6: "b8[4, 512, 28, 28]" = torch.ops.aten.le.Scalar(relu_8, 0);  relu_8 = None
    where_6: "f32[4, 512, 28, 28]" = torch.ops.aten.where.self(le_6, full_default, getitem_19);  le_6 = getitem_19 = None
    convolution_backward_4 = torch.ops.aten.convolution_backward.default(where_6, relu_7, primals_17, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_6 = primals_17 = None
    getitem_22: "f32[4, 512, 28, 28]" = convolution_backward_4[0]
    getitem_23: "f32[512, 512, 3, 3]" = convolution_backward_4[1]
    getitem_24: "f32[512]" = convolution_backward_4[2];  convolution_backward_4 = None
    le_7: "b8[4, 512, 28, 28]" = torch.ops.aten.le.Scalar(relu_7, 0);  relu_7 = None
    where_7: "f32[4, 512, 28, 28]" = torch.ops.aten.where.self(le_7, full_default, getitem_22);  le_7 = getitem_22 = None
    convolution_backward_5 = torch.ops.aten.convolution_backward.default(where_7, getitem_4, primals_15, [512], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_7 = getitem_4 = primals_15 = None
    getitem_25: "f32[4, 256, 28, 28]" = convolution_backward_5[0]
    getitem_26: "f32[512, 256, 3, 3]" = convolution_backward_5[1]
    getitem_27: "f32[512]" = convolution_backward_5[2];  convolution_backward_5 = None
    ...
    le_8: "b8[4, 256, 56, 56]" = torch.ops.aten.le.Scalar(relu_6, 0);  relu_6 = None
    ...
    convolution_backward_6 = torch.ops.aten.convolution_backward.default(where_8, relu_5, primals_13, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_8 = primals_13 = None
    getitem_28: "f32[4, 256, 56, 56]" = convolution_backward_6[0]
    getitem_29: "f32[256, 256, 3, 3]" = convolution_backward_6[1]
    getitem_30: "f32[256]" = convolution_backward_6[2];  convolution_backward_6 = None
    le_9: "b8[4, 256, 56, 56]" = torch.ops.aten.le.Scalar(relu_5, 0);  relu_5 = None
    where_9: "f32[4, 256, 56, 56]" = torch.ops.aten.where.self(le_9, full_default, getitem_28);  le_9 = getitem_28 = None
    convolution_backward_7 = torch.ops.aten.convolution_backward.default(where_9, relu_4, primals_11, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_9 = primals_11 = None
    getitem_31: "f32[4, 256, 56, 56]" = convolution_backward_7[0]
    getitem_32: "f32[256, 256, 3, 3]" = convolution_backward_7[1]
    getitem_33: "f32[256]" = convolution_backward_7[2];  convolution_backward_7 = None
    le_10: "b8[4, 256, 56, 56]" = torch.ops.aten.le.Scalar(relu_4, 0);  relu_4 = None
    where_10: "f32[4, 256, 56, 56]" = torch.ops.aten.where.self(le_10, full_default, getitem_31);  le_10 = getitem_31 = None
    convolution_backward_8 = torch.ops.aten.convolution_backward.default(where_10, getitem_2, primals_9, [256], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_10 = getitem_2 = primals_9 = None
    getitem_34: "f32[4, 128, 56, 56]" = convolution_backward_8[0]
    getitem_35: "f32[256, 128, 3, 3]" = convolution_backward_8[1]
    getitem_36: "f32[256]" = convolution_backward_8[2];  convolution_backward_8 = None
    ...
    le_11: "b8[4, 128, 112, 112]" = torch.ops.aten.le.Scalar(relu_3, 0);  relu_3 = None
    ...
    convolution_backward_9 = torch.ops.aten.convolution_backward.default(where_11, relu_2, primals_7, [128], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_11 = primals_7 = None
    getitem_37: "f32[4, 128, 112, 112]" = convolution_backward_9[0]
    getitem_38: "f32[128, 128, 3, 3]" = convolution_backward_9[1]
    getitem_39: "f32[128]" = convolution_backward_9[2];  convolution_backward_9 = None
    le_12: "b8[4, 128, 112, 112]" = torch.ops.aten.le.Scalar(relu_2, 0);  relu_2 = None
    where_12: "f32[4, 128, 112, 112]" = torch.ops.aten.where.self(le_12, full_default, getitem_37);  le_12 = getitem_37 = None
    convolution_backward_10 = torch.ops.aten.convolution_backward.default(where_12, getitem, primals_5, [128], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_12 = getitem = primals_5 = None
    getitem_40: "f32[4, 64, 112, 112]" = convolution_backward_10[0]
    getitem_41: "f32[128, 64, 3, 3]" = convolution_backward_10[1]
    getitem_42: "f32[128]" = convolution_backward_10[2];  convolution_backward_10 = None
    ...
    le_13: "b8[4, 64, 224, 224]" = torch.ops.aten.le.Scalar(relu_1, 0);  relu_1 = None
    ...
    convolution_backward_11 = torch.ops.aten.convolution_backward.default(where_13, relu, primals_3, [64], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [True, True, True]);  where_13 = primals_3 = None
    getitem_43: "f32[4, 64, 224, 224]" = convolution_backward_11[0]
    getitem_44: "f32[64, 64, 3, 3]" = convolution_backward_11[1]
    getitem_45: "f32[64]" = convolution_backward_11[2];  convolution_backward_11 = None
    le_14: "b8[4, 64, 224, 224]" = torch.ops.aten.le.Scalar(relu, 0);  relu = None
    where_14: "f32[4, 64, 224, 224]" = torch.ops.aten.where.self(le_14, full_default, getitem_43);  le_14 = full_default = getitem_43 = None
    convolution_backward_12 = torch.ops.aten.convolution_backward.default(where_14, primals_33, primals_1, [64], [1, 1], [1, 1], [1, 1], False, [0, 0], 1, [False, True, True]);  where_14 = primals_33 = primals_1 = None
    getitem_47: "f32[64, 3, 3, 3]" = convolution_backward_12[1]
    getitem_48: "f32[64]" = convolution_backward_12[2];  convolution_backward_12 = None
    return [getitem_47, getitem_48, getitem_44, getitem_45, getitem_41, getitem_42, getitem_38, getitem_39, getitem_35, getitem_36, getitem_32, getitem_33, getitem_29, getitem_30, getitem_26, getitem_27, getitem_23, getitem_24, getitem_20, getitem_21, getitem_17, getitem_18, getitem_14, getitem_15, getitem_11, getitem_12, permute_14, view_3, permute_10, view_2, permute_6, view_1, None]
