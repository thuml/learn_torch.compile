...
# kernel path: /tmp/torchinductor_youkaichao/be/cbevcu6xhqs2ifigkk2oqkccvjrsfaqkpdinewx2jq4lwpcusryj.py
...
# tanh_12 => tanh_12
triton_per_fused_add_mul_native_layer_norm_pow_tanh_view_7 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_mul_native_layer_norm_pow_tanh_view_7', 'mutated_arg_names': ['in_out_ptr0']}
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp38 = tmp36 * tmp37
    tmp40 = tmp38 + tmp39
    tl.store(out_ptr0 + (r1 + (128*x0)), tmp8, rmask & xmask)
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x0), tmp34, xmask)
    tl.store(out_ptr2 + (r1 + (128*x0)), tmp40, rmask & xmask)
    tl.store(out_ptr1 + (x0), tmp23, xmask)
''')


# kernel path: /tmp/torchinductor_youkaichao/rj/crjwplklmaiz7pziixlfhrdbqwn7djn5yhbrod3w3y7a4nvjhavs.py
...
def triton_(in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp4 = tl.load(in_ptr0 + (r1 + (30000*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp5 = tmp4 - tmp2
        tmp6 = tl.exp(tmp5)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp10 = tl.load(in_ptr0 + (r1 + (30000*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp11 = tmp10 - tmp2
        tmp12 = tl.log(tmp8)
        tmp13 = tmp11 - tmp12
        tl.store(out_ptr2 + (r1 + (30000*x0)), tmp13, rmask & xmask)
''')


# kernel path: /tmp/torchinductor_youkaichao/z2/cz2fymgnozj5uicdm6etsba7gskykdye2fqn3tunc3zkacgbvybn.py
# Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
# loss => convert_element_type, div_24, full_default_2, ne, neg, sum_14, sum_15, where_1
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, out_ptr1, xnumel, rnumel):
    ...
    tl.device_assert((0 <= tmp12) & (tmp12 < 30000), "index out of bounds: 0 <= tmp12 < 30000")
    tmp13 = tl.load(in_ptr1 + (tmp12 + (30000*r0)), rmask, eviction_policy='evict_last', other=0.0)
    tmp14 = -tmp13
    tmp15 = 0.0
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf368 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [embeddings, embeddings_1, embeddings_2, hidden_states, inputs_embeds, position_embeddings, token_type_embeddings], Original ATen: [aten.add, aten.embedding, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        stream0 = get_cuda_stream(0)
        triton_per_fused_add_embedding_native_layer_norm_native_layer_norm_backward_view_0.run(primals_32, primals_1, primals_30, primals_2, primals_31, primals_3, primals_4, primals_5, buf0, buf4, buf5, buf368, 512, 128, grid=grid(512), stream=stream0)
        del primals_1
        del primals_2
        del primals_3
        del primals_5
        ...
        buf367 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [attention_probs, attention_probs_1, attention_scores_2], Original ATen: [aten._softmax, aten.add, aten.clone, aten.detach]
        triton_per_fused__softmax_add_clone_detach_1.run(buf10, buf13, buf367, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        # Source Nodes: [add_2, ffn_output, layernormed_context_layer], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_3.run(buf6, buf16, primals_15, primals_16, primals_17, buf20, buf21, buf366, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf365 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_5, hidden_states_3, layernormed_context_layer, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf26, primals_21, buf20, primals_16, primals_17, primals_22, primals_23, buf30, buf31, buf365, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf364 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf35, buf38, buf364, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        # Source Nodes: [add_7, ffn_output_4, hidden_states_3, layernormed_context_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf42, buf30, primals_22, primals_23, primals_15, primals_16, primals_17, buf46, buf47, buf363, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf362 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf52, primals_21, buf46, primals_16, primals_17, primals_22, primals_23, buf56, buf57, buf362, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf361 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf61, buf64, buf361, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf68, buf56, primals_22, primals_23, primals_15, primals_16, primals_17, buf72, buf73, buf360, 512, 4096, grid=grid(512), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf78, primals_21, buf72, primals_16, primals_17, primals_22, primals_23, buf82, buf83, buf359, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf358 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf87, buf90, buf358, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf94, buf82, primals_22, primals_23, primals_15, primals_16, primals_17, buf98, buf99, buf357, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf356 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf104, primals_21, buf98, primals_16, primals_17, primals_22, primals_23, buf108, buf109, buf356, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf355 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf113, buf116, buf355, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf120, buf108, primals_22, primals_23, primals_15, primals_16, primals_17, buf124, buf125, buf354, 512, 4096, grid=grid(512), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf130, primals_21, buf124, primals_16, primals_17, primals_22, primals_23, buf134, buf135, buf353, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf352 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf139, buf142, buf352, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf146, buf134, primals_22, primals_23, primals_15, primals_16, primals_17, buf150, buf151, buf351, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf350 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf156, primals_21, buf150, primals_16, primals_17, primals_22, primals_23, buf160, buf161, buf350, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf349 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf165, buf168, buf349, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf172, buf160, primals_22, primals_23, primals_15, primals_16, primals_17, buf176, buf177, buf348, 512, 4096, grid=grid(512), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf182, primals_21, buf176, primals_16, primals_17, primals_22, primals_23, buf186, buf187, buf347, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf346 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf191, buf194, buf346, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf198, buf186, primals_22, primals_23, primals_15, primals_16, primals_17, buf202, buf203, buf345, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf344 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf208, primals_21, buf202, primals_16, primals_17, primals_22, primals_23, buf212, buf213, buf344, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf343 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf217, buf220, buf343, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf224, buf212, primals_22, primals_23, primals_15, primals_16, primals_17, buf228, buf229, buf342, 512, 4096, grid=grid(512), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf234, primals_21, buf228, primals_16, primals_17, primals_22, primals_23, buf238, buf239, buf341, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf340 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf243, buf246, buf340, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf250, buf238, primals_22, primals_23, primals_15, primals_16, primals_17, buf254, buf255, buf339, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf338 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf260, primals_21, buf254, primals_16, primals_17, primals_22, primals_23, buf264, buf265, buf338, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf337 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf269, buf272, buf337, 32768, 512, grid=grid(32768), stream=stream0)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf276, buf264, primals_22, primals_23, primals_15, primals_16, primals_17, buf280, buf281, buf336, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf335 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf286, primals_21, buf280, primals_16, primals_17, primals_22, primals_23, buf290, buf291, buf335, 512, 4096, grid=grid(512), stream=stream0)
        ...
        buf334 = empty((1, 64, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax_add_clone_detach_1.run(buf295, buf298, buf334, 32768, 512, grid=grid(32768), stream=stream0)
        del buf295
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf302, buf290, primals_22, primals_23, primals_15, primals_16, primals_17, buf306, buf307, buf333, 512, 4096, grid=grid(512), stream=stream0)
        del primals_15
        ...
        buf332 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_red_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf312, primals_21, buf306, primals_16, primals_17, primals_22, primals_23, buf316, buf317, buf332, 512, 4096, grid=grid(512), stream=stream0)
        del buf312
        del primals_17
        del primals_21
        del primals_23
        buf318 = reinterpret_tensor(buf0, (512, 128), (128, 1), 0); del buf0  # reuse
        # Source Nodes: [hidden_states_37], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_25, buf317, reinterpret_tensor(primals_24, (4096, 128), (1, 4096), 0), alpha=1, beta=1, out=buf318)
        del primals_25
        buf319 = empty((1, 512, 128), device='cuda', dtype=torch.float32)
        buf320 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        buf321 = empty_strided((1, 512, 1), (512, 1, 512), device='cuda', dtype=torch.float32)
        buf323 = reinterpret_tensor(buf321, (1, 512, 1), (512, 1, 1), 0); del buf321  # reuse
        buf324 = empty((512, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_61, add_62, hidden_states_38, hidden_states_39, mul_49, mul_50, mul_51, pow_13, prediction_scores, tanh_12], Original ATen: [aten.add, aten.mul, aten.native_layer_norm, aten.pow, aten.tanh, aten.view]
        triton_per_fused_add_mul_native_layer_norm_pow_tanh_view_7.run(buf323, buf318, primals_26, primals_27, buf319, buf320, buf324, 512, 128, grid=grid(512), stream=stream0)
        del primals_27
        buf325 = empty((512, 30000), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_29, buf324, reinterpret_tensor(primals_28, (128, 30000), (1, 128), 0), alpha=1, beta=1, out=buf325)
        del primals_29
        buf328 = empty((512, 30000), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_8.run(buf325, buf328, 512, 30000, grid=grid(512), stream=stream0)
        buf331 = empty((), device='cuda', dtype=torch.float32)
        buf330 = empty((), device='cuda', dtype=torch.float32)
        buf369 = buf331; del buf331  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_9.run(buf369, primals_33, buf328, buf330, 1, 512, grid=grid(1), stream=stream0)
        return (buf369, reinterpret_tensor(buf325, (1, 512, 30000), (15360000, 30000, 1), 0), primals_4, primals_16, primals_22, primals_26, primals_32, primals_33, primals_30, primals_31, buf4, buf5, reinterpret_tensor(buf6, (512, 4096), (4096, 1), 0), buf15, buf20, buf21, buf22, buf23, buf24, buf30, buf31, buf40, buf46, buf47, buf48, buf49, buf50, buf56, buf57, buf66, buf72, buf73, buf74, buf75, buf76, buf82, buf83, buf92, buf98, buf99, buf100, buf101, buf102, buf108, buf109, buf118, buf124, buf125, buf126, buf127, buf128, buf134, buf135, buf144, buf150, buf151, buf152, buf153, buf154, buf160, buf161, buf170, buf176, buf177, buf178, buf179, buf180, buf186, buf187, buf196, buf202, buf203, buf204, buf205, buf206, buf212, buf213, buf222, buf228, buf229, buf230, buf231, buf232, buf238, buf239, buf248, buf254, buf255, buf256, buf257, buf258, buf264, buf265, buf274, buf280, buf281, buf282, buf283, buf284, buf290, buf291, buf300, buf306, buf307, buf308, buf309, buf310, buf316, buf317, buf318, buf319, buf320, buf323, buf324, buf328, buf330, reinterpret_tensor(primals_28, (30000, 128), (128, 1), 0), reinterpret_tensor(primals_24, (128, 4096), (4096, 1), 0), buf332, reinterpret_tensor(primals_20, (4096, 16384), (16384, 1), 0), reinterpret_tensor(primals_18, (16384, 4096), (4096, 1), 0), buf333, reinterpret_tensor(primals_14, (4096, 4096), (4096, 1), 0), reinterpret_tensor(buf298, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf294, (64, 64, 512), (64, 1, 4096), 0), buf334, reinterpret_tensor(buf292, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf293, (64, 512, 64), (64, 4096, 1), 0), reinterpret_tensor(primals_12, (4096, 4096), (4096, 1), 0), reinterpret_tensor(primals_10, (4096, 4096), (4096, 1), 0), reinterpret_tensor(primals_8, (4096, 4096), (4096, 1), 0), buf335, buf336, reinterpret_tensor(buf272, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf268, (64, 64, 512), (64, 1, 4096), 0), buf337, reinterpret_tensor(buf266, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf267, (64, 512, 64), (64, 4096, 1), 0), buf338, buf339, reinterpret_tensor(buf246, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf242, (64, 64, 512), (64, 1, 4096), 0), buf340, reinterpret_tensor(buf240, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf241, (64, 512, 64), (64, 4096, 1), 0), buf341, buf342, reinterpret_tensor(buf220, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf216, (64, 64, 512), (64, 1, 4096), 0), buf343, reinterpret_tensor(buf214, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf215, (64, 512, 64), (64, 4096, 1), 0), buf344, buf345, reinterpret_tensor(buf194, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf190, (64, 64, 512), (64, 1, 4096), 0), buf346, reinterpret_tensor(buf188, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf189, (64, 512, 64), (64, 4096, 1), 0), buf347, buf348, reinterpret_tensor(buf168, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf164, (64, 64, 512), (64, 1, 4096), 0), buf349, reinterpret_tensor(buf162, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf163, (64, 512, 64), (64, 4096, 1), 0), buf350, buf351, reinterpret_tensor(buf142, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf138, (64, 64, 512), (64, 1, 4096), 0), buf352, reinterpret_tensor(buf136, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf137, (64, 512, 64), (64, 4096, 1), 0), buf353, buf354, reinterpret_tensor(buf116, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf112, (64, 64, 512), (64, 1, 4096), 0), buf355, reinterpret_tensor(buf110, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf111, (64, 512, 64), (64, 4096, 1), 0), buf356, buf357, reinterpret_tensor(buf90, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf86, (64, 64, 512), (64, 1, 4096), 0), buf358, reinterpret_tensor(buf84, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf85, (64, 512, 64), (64, 4096, 1), 0), buf359, buf360, reinterpret_tensor(buf64, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf60, (64, 64, 512), (64, 1, 4096), 0), buf361, reinterpret_tensor(buf58, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf59, (64, 512, 64), (64, 4096, 1), 0), buf362, buf363, reinterpret_tensor(buf38, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf34, (64, 64, 512), (64, 1, 4096), 0), buf364, reinterpret_tensor(buf32, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf33, (64, 512, 64), (64, 4096, 1), 0), buf365, buf366, reinterpret_tensor(buf13, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf9, (64, 64, 512), (64, 1, 4096), 0), buf367, reinterpret_tensor(buf7, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf8, (64, 512, 64), (64, 4096, 1), 0), reinterpret_tensor(primals_6, (4096, 128), (128, 1), 0), buf368, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_24 = rand_strided((128, 4096), (4096, 1), device='cuda:0', dtype=torch.float32)
