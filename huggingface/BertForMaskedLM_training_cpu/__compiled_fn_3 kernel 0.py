...
cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_86 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    del primals_191
    del primals_197
    buf453 = reinterpret_tensor(buf446, (512, 768), (768, 1), 0); del buf446  # reuse
    # Source Nodes: [hidden_states_108], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_199, buf452, reinterpret_tensor(primals_198, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf453)
    del primals_199
    buf454 = buf448; del buf448  # reuse
    buf455 = empty_strided((1, 512, 1), (512, 1, 512), device='cpu', dtype=torch.float32)
    buf457 = empty((1, 512, 768), device='cpu', dtype=torch.float32)
    buf458 = empty((512, 768), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_native_layer_norm_view_85(c_void_p(buf453.data_ptr()), c_void_p(primals_200.data_ptr()), c_void_p(primals_201.data_ptr()), c_void_p(buf454.data_ptr()), c_void_p(buf455.data_ptr()), c_void_p(buf457.data_ptr()), c_void_p(buf458.data_ptr()))
    del primals_201
    buf459 = empty((512, 30522), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_203, buf458, reinterpret_tensor(primals_202, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf459)
    del primals_203
    buf460 = reinterpret_tensor(buf454, (512, 1), (1, 512), 0); del buf454  # reuse
    buf461 = empty_strided((512, 1), (1, 512), device='cpu', dtype=torch.float32)
    buf462 = empty((512, 30522), device='cpu', dtype=torch.float32)
    buf463 = empty((), device='cpu', dtype=torch.int64)
    buf465 = empty((), device='cpu', dtype=torch.float32)
    buf464 = empty((), device='cpu', dtype=torch.float32)
    buf492 = buf465; del buf465  # reuse
    buf466 = reinterpret_tensor(buf455, (1, 512, 1), (512, 1, 1), 0); del buf455  # reuse
    buf467 = reinterpret_tensor(buf449, (1, 512, 1), (512, 1, 1), 0); del buf449  # reuse
    buf468 = reinterpret_tensor(buf438, (1, 512, 1), (512, 1, 1), 0); del buf438  # reuse
    buf469 = reinterpret_tensor(buf412, (1, 512, 1), (512, 1, 1), 0); del buf412  # reuse
    buf470 = reinterpret_tensor(buf401, (1, 512, 1), (512, 1, 1), 0); del buf401  # reuse
    buf471 = reinterpret_tensor(buf375, (1, 512, 1), (512, 1, 1), 0); del buf375  # reuse
    buf472 = reinterpret_tensor(buf364, (1, 512, 1), (512, 1, 1), 0); del buf364  # reuse
    buf473 = reinterpret_tensor(buf338, (1, 512, 1), (512, 1, 1), 0); del buf338  # reuse
    buf474 = reinterpret_tensor(buf327, (1, 512, 1), (512, 1, 1), 0); del buf327  # reuse
    buf475 = reinterpret_tensor(buf301, (1, 512, 1), (512, 1, 1), 0); del buf301  # reuse
    buf476 = reinterpret_tensor(buf290, (1, 512, 1), (512, 1, 1), 0); del buf290  # reuse
    buf477 = reinterpret_tensor(buf264, (1, 512, 1), (512, 1, 1), 0); del buf264  # reuse
    buf478 = reinterpret_tensor(buf253, (1, 512, 1), (512, 1, 1), 0); del buf253  # reuse
    buf479 = reinterpret_tensor(buf227, (1, 512, 1), (512, 1, 1), 0); del buf227  # reuse
    buf480 = reinterpret_tensor(buf216, (1, 512, 1), (512, 1, 1), 0); del buf216  # reuse
    buf481 = reinterpret_tensor(buf190, (1, 512, 1), (512, 1, 1), 0); del buf190  # reuse
    buf482 = reinterpret_tensor(buf179, (1, 512, 1), (512, 1, 1), 0); del buf179  # reuse
    buf483 = reinterpret_tensor(buf153, (1, 512, 1), (512, 1, 1), 0); del buf153  # reuse
    buf484 = reinterpret_tensor(buf142, (1, 512, 1), (512, 1, 1), 0); del buf142  # reuse
    buf485 = reinterpret_tensor(buf116, (1, 512, 1), (512, 1, 1), 0); del buf116  # reuse
    buf486 = reinterpret_tensor(buf105, (1, 512, 1), (512, 1, 1), 0); del buf105  # reuse
    buf487 = reinterpret_tensor(buf79, (1, 512, 1), (512, 1, 1), 0); del buf79  # reuse
    buf488 = reinterpret_tensor(buf68, (1, 512, 1), (512, 1, 1), 0); del buf68  # reuse
    buf489 = reinterpret_tensor(buf42, (1, 512, 1), (512, 1, 1), 0); del buf42  # reuse
    buf490 = reinterpret_tensor(buf31, (1, 512, 1), (512, 1, 1), 0); del buf31  # reuse
    buf491 = reinterpret_tensor(buf2, (1, 512, 1), (512, 1, 1), 0); del buf2  # reuse
    cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_86(c_void_p(buf492.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf468.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()), c_void_p(buf486.data_ptr()), c_void_p(buf487.data_ptr()), c_void_p(buf488.data_ptr()), c_void_p(buf489.data_ptr()), c_void_p(buf490.data_ptr()), c_void_p(buf491.data_ptr()), c_void_p(buf459.data_ptr()), c_void_p(primals_207.data_ptr()), c_void_p(buf460.data_ptr()), c_void_p(buf461.data_ptr()), c_void_p(buf462.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf464.data_ptr()))
    return (buf492, reinterpret_tensor(buf459, (1, 512, 30522), (15627264, 30522, 1), 0), primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_200, primals_206, primals_207, primals_204, primals_205, buf4, buf8, reinterpret_tensor(buf7, (512, 768), (768, 1), 0), buf21, reinterpret_tensor(buf20, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf22, (12, 64, 512), (32768, 1, 64), 0), buf18, reinterpret_tensor(buf12, (12, 64, 512), (32768, 1, 64), 0), buf24, buf25, buf29, buf33, buf34, buf35, buf36, buf40, buf44, buf45, buf58, reinterpret_tensor(buf57, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf59, (12, 64, 512), (32768, 1, 64), 0), buf55, reinterpret_tensor(buf49, (12, 64, 512), (32768, 1, 64), 0), buf61, buf62, buf66, buf70, buf71, buf72, buf73, buf77, buf81, buf82, buf95, reinterpret_tensor(buf94, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf96, (12, 64, 512), (32768, 1, 64), 0), buf92, reinterpret_tensor(buf86, (12, 64, 512), (32768, 1, 64), 0), buf98, buf99, buf103, buf107, buf108, buf109, buf110, buf114, buf118, buf119, buf132, reinterpret_tensor(buf131, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf133, (12, 64, 512), (32768, 1, 64), 0), buf129, reinterpret_tensor(buf123, (12, 64, 512), (32768, 1, 64), 0), buf135, buf136, buf140, buf144, buf145, buf146, buf147, buf151, buf155, buf156, buf169, reinterpret_tensor(buf168, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf170, (12, 64, 512), (32768, 1, 64), 0), buf166, reinterpret_tensor(buf160, (12, 64, 512), (32768, 1, 64), 0), buf172, buf173, buf177, buf181, buf182, buf183, buf184, buf188, buf192, buf193, buf206, reinterpret_tensor(buf205, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf207, (12, 64, 512), (32768, 1, 64), 0), buf203, reinterpret_tensor(buf197, (12, 64, 512), (32768, 1, 64), 0), buf209, buf210, buf214, buf218, buf219, buf220, buf221, buf225, buf229, buf230, buf243, reinterpret_tensor(buf242, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf244, (12, 64, 512), (32768, 1, 64), 0), buf240, reinterpret_tensor(buf234, (12, 64, 512), (32768, 1, 64), 0), buf246, buf247, buf251, buf255, buf256, buf257, buf258, buf262, buf266, buf267, buf280, reinterpret_tensor(buf279, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf281, (12, 64, 512), (32768, 1, 64), 0), buf277, reinterpret_tensor(buf271, (12, 64, 512), (32768, 1, 64), 0), buf283, buf284, buf288, buf292, buf293, buf294, buf295, buf299, buf303, buf304, buf317, reinterpret_tensor(buf316, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf318, (12, 64, 512), (32768, 1, 64), 0), buf314, reinterpret_tensor(buf308, (12, 64, 512), (32768, 1, 64), 0), buf320, buf321, buf325, buf329, buf330, buf331, buf332, buf336, buf340, buf341, buf354, reinterpret_tensor(buf353, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf355, (12, 64, 512), (32768, 1, 64), 0), buf351, reinterpret_tensor(buf345, (12, 64, 512), (32768, 1, 64), 0), buf357, buf358, buf362, buf366, buf367, buf368, buf369, buf373, buf377, buf378, buf391, reinterpret_tensor(buf390, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf392, (12, 64, 512), (32768, 1, 64), 0), buf388, reinterpret_tensor(buf382, (12, 64, 512), (32768, 1, 64), 0), buf394, buf395, buf399, buf403, buf404, buf405, buf406, buf410, buf414, buf415, buf428, reinterpret_tensor(buf427, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf429, (12, 64, 512), (32768, 1, 64), 0), buf425, reinterpret_tensor(buf419, (12, 64, 512), (32768, 1, 64), 0), buf431, buf432, buf436, buf440, buf441, buf442, buf443, buf447, buf451, buf452, buf453, buf457, buf458, buf462, buf464, reinterpret_tensor(primals_202, (30522, 768), (768, 1), 0), buf466, reinterpret_tensor(primals_198, (768, 768), (768, 1), 0), buf467, reinterpret_tensor(primals_194, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_192, (3072, 768), (768, 1), 0), buf468, reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), reinterpret_tensor(primals_184, (768, 768), (768, 1), 0), reinterpret_tensor(primals_182, (768, 768), (768, 1), 0), buf469, reinterpret_tensor(primals_178, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_176, (3072, 768), (768, 1), 0), buf470, reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), reinterpret_tensor(primals_168, (768, 768), (768, 1), 0), reinterpret_tensor(primals_166, (768, 768), (768, 1), 0), buf471, reinterpret_tensor(primals_162, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_160, (3072, 768), (768, 1), 0), buf472, reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), reinterpret_tensor(primals_152, (768, 768), (768, 1), 0), reinterpret_tensor(primals_150, (768, 768), (768, 1), 0), buf473, reinterpret_tensor(primals_146, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_144, (3072, 768), (768, 1), 0), buf474, reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), reinterpret_tensor(primals_136, (768, 768), (768, 1), 0), reinterpret_tensor(primals_134, (768, 768), (768, 1), 0), buf475, reinterpret_tensor(primals_130, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_128, (3072, 768), (768, 1), 0), buf476, reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), reinterpret_tensor(primals_120, (768, 768), (768, 1), 0), reinterpret_tensor(primals_118, (768, 768), (768, 1), 0), buf477, reinterpret_tensor(primals_114, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_112, (3072, 768), (768, 1), 0), buf478, reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), reinterpret_tensor(primals_104, (768, 768), (768, 1), 0), reinterpret_tensor(primals_102, (768, 768), (768, 1), 0), buf479, reinterpret_tensor(primals_98, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_96, (3072, 768), (768, 1), 0), buf480, reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), reinterpret_tensor(primals_88, (768, 768), (768, 1), 0), reinterpret_tensor(primals_86, (768, 768), (768, 1), 0), buf481, reinterpret_tensor(primals_82, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_80, (3072, 768), (768, 1), 0), buf482, reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), reinterpret_tensor(primals_72, (768, 768), (768, 1), 0), reinterpret_tensor(primals_70, (768, 768), (768, 1), 0), buf483, reinterpret_tensor(primals_66, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_64, (3072, 768), (768, 1), 0), buf484, reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), reinterpret_tensor(primals_56, (768, 768), (768, 1), 0), reinterpret_tensor(primals_54, (768, 768), (768, 1), 0), buf485, reinterpret_tensor(primals_50, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_48, (3072, 768), (768, 1), 0), buf486, reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), reinterpret_tensor(primals_40, (768, 768), (768, 1), 0), reinterpret_tensor(primals_38, (768, 768), (768, 1), 0), buf487, reinterpret_tensor(primals_34, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_32, (3072, 768), (768, 1), 0), buf488, reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), reinterpret_tensor(primals_24, (768, 768), (768, 1), 0), reinterpret_tensor(primals_22, (768, 768), (768, 1), 0), buf489, reinterpret_tensor(primals_18, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_16, (3072, 768), (768, 1), 0), buf490, reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), reinterpret_tensor(primals_8, (768, 768), (768, 1), 0), reinterpret_tensor(primals_6, (768, 768), (768, 1), 0), buf491, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_202 = rand_strided((30522, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_203 = rand_strided((30522, ), (1, ), device='cpu', dtype=torch.float32)
