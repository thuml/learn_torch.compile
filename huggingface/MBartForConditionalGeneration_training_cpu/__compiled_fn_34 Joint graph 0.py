...
def forward(self, primals, tangents):
    ...
    sub: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(primals_27, getitem_1)
    ...
    view: "f32[1024, 1024]" = torch.ops.aten.view.default(add_1, [1024, 1024])
    ...
    view_2: "f32[1024, 1024]" = torch.ops.aten.view.default(add_1, [1024, 1024])
    permute_1: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_5, [1, 0]);  primals_5 = None
    addmm_1: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_6, view_2, permute_1);  primals_6 = None
    ...
    view_5: "f32[1024, 1024]" = torch.ops.aten.view.default(add_1, [1024, 1024]);  add_1 = None
    permute_3: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_7, [1, 0]);  primals_7 = None
    addmm_2: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_8, view_5, permute_3);  primals_8 = None
    ...
    add_2: "f32[1, 16, 1024, 1024]" = torch.ops.aten.add.Tensor(view_12, primals_28);  view_12 = primals_28 = None
    ...
    view_13: "f32[16, 1024, 1024]" = torch.ops.aten.view.default(add_2, [16, 1024, 1024]);  add_2 = None
    ...
    add_3: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(primals_27, getitem_2);  getitem_2 = None
    ...
    sub_2: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_5)
    mul_3: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_2, rsqrt_1);  sub_2 = None
    mul_4: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_3, primals_11);  mul_3 = None
    add_5: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(mul_4, primals_12);  mul_4 = primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:189, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_18: "f32[1024, 1024]" = torch.ops.aten.view.default(add_5, [1024, 1024]);  add_5 = None
    permute_9: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_13, [1, 0]);  primals_13 = None
    addmm_4: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_14, view_18, permute_9);  primals_14 = None
    view_19: "f32[1, 1024, 1024]" = torch.ops.aten.view.default(addmm_4, [1, 1024, 1024]);  addmm_4 = None
    mul_5: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_19, 0.125);  view_19 = None
    ...
    view_20: "f32[1024, 1024]" = torch.ops.aten.view.default(primals_29, [1024, 1024])
    ...
    view_23: "f32[1024, 1024]" = torch.ops.aten.view.default(primals_29, [1024, 1024]);  primals_29 = None
    permute_12: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_17, [1, 0]);  primals_17 = None
    addmm_6: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_18, view_23, permute_12);  primals_18 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:169, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 1024, 16, 64]" = torch.ops.aten.view.default(mul_5, [1, 1024, 16, 64]);  mul_5 = None
    ...
    alias_1: "f32[16, 1024, 1024]" = torch.ops.aten.alias.default(div_1)
    ...
    addmm_7: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_20, view_32, permute_17);  primals_20 = None
    ...
    add_6: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_3, getitem_6);  getitem_6 = None
    ...
    getitem_8: "f32[1, 1024, 1]" = var_mean_2[0]
    getitem_9: "f32[1, 1024, 1]" = var_mean_2[1];  var_mean_2 = None
    add_7: "f32[1, 1024, 1]" = torch.ops.aten.add.Tensor(getitem_8, 1e-05);  getitem_8 = None
    rsqrt_2: "f32[1, 1024, 1]" = torch.ops.aten.rsqrt.default(add_7);  add_7 = None
    sub_4: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_6, getitem_9)
    mul_6: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_4, rsqrt_2);  sub_4 = None
    mul_7: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_6, primals_21);  mul_6 = None
    add_8: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(mul_7, primals_22);  mul_7 = primals_22 = None
    ...
    view_34: "f32[1024, 1024]" = torch.ops.aten.view.default(add_8, [1024, 1024]);  add_8 = None
    permute_18: "f32[1024, 4096]" = torch.ops.aten.permute.default(primals_23, [1, 0]);  primals_23 = None
    addmm_8: "f32[1024, 4096]" = torch.ops.aten.addmm.default(primals_24, view_34, permute_18);  primals_24 = None
    view_35: "f32[1, 1024, 4096]" = torch.ops.aten.view.default(addmm_8, [1, 1024, 4096]);  addmm_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_8: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_35, 0.5)
    ...
    clone_10: "f32[1, 1024, 4096]" = torch.ops.aten.clone.default(mul_10);  mul_10 = None
    ...
    addmm_9: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_26, view_36, permute_19);  primals_26 = None
    ...
    getitem_10: "f32[1, 1024, 1024]" = native_dropout_2[0]
    getitem_11: "b8[1, 1024, 1024]" = native_dropout_2[1];  native_dropout_2 = None
    ...
    add_10: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_6, getitem_10);  getitem_10 = None
    ...
    clone_11: "f32[1, 1024, 1024]" = torch.ops.aten.clone.default(mul_12, memory_format = torch.contiguous_format);  mul_12 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_13: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_35, 0.7071067811865476)
    erf_1: "f32[1, 1024, 4096]" = torch.ops.aten.erf.default(mul_13);  mul_13 = None
    add_11: "f32[1, 1024, 4096]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_14: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_11, 0.5);  add_11 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:460, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_41: "f32[1024, 4096]" = torch.ops.aten.view.default(mul_19, [1024, 4096]);  mul_19 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:459, code: hidden_states = self.final_layer_norm(hidden_states)
    sub_5: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_6, getitem_9);  add_6 = getitem_9 = None
    mul_20: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_5, rsqrt_2);  sub_5 = None
    ...
    mul_23: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_21, mul_20);  mul_21 = None
    sum_6: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_23, [2], True);  mul_23 = None
    mul_24: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_20, sum_6);  sum_6 = None
    ...
    mul_26: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_43, mul_20);  mul_20 = None
    ...
    clone_12: "f32[1, 1024, 1024]" = torch.ops.aten.clone.default(mul_28, memory_format = torch.contiguous_format);  mul_28 = None
    ...
    mul_29: "f32[16, 1024, 1024]" = torch.ops.aten.mul.Tensor(bmm_5, alias_2);  bmm_5 = None
    sum_10: "f32[16, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_29, [-1], True)
    mul_30: "f32[16, 1024, 1024]" = torch.ops.aten.mul.Tensor(alias_2, sum_10);  alias_2 = sum_10 = None
    ...
    view_61: "f32[1024, 1024]" = torch.ops.aten.view.default(mul_31, [1024, 1024]);  mul_31 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:439, code: hidden_states = self.encoder_attn_layer_norm(hidden_states)
    sub_9: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_5);  add_3 = getitem_5 = None
    mul_32: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_9, rsqrt_1);  sub_9 = None
    ...
    mul_35: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_33, mul_32);  mul_33 = None
    sum_15: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_35, [2], True);  mul_35 = None
    mul_36: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_32, sum_15);  sum_15 = None
    ...
    mul_38: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_63, mul_32);  mul_32 = None
    ...
    clone_15: "f32[1, 1024, 1024]" = torch.ops.aten.clone.default(mul_40, memory_format = torch.contiguous_format);  mul_40 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:247, code: attn_weights = attn_weights.view(bsz * self.num_heads, tgt_len, src_len)
    view_69: "f32[1, 16, 1024, 1024]" = torch.ops.aten.view.default(sub_12, [1, 16, 1024, 1024]);  sub_12 = None
    ...
    view_83: "f32[1024, 1024]" = torch.ops.aten.view.default(mul_43, [1024, 1024]);  mul_43 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:418, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_13: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(primals_27, getitem_1);  primals_27 = getitem_1 = None
    mul_44: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_13, rsqrt);  sub_13 = None
    ...
    mul_47: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_45, mul_44);  mul_45 = None
    sum_24: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_47, [2], True);  mul_47 = None
    mul_48: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_44, sum_24);  sum_24 = None
    ...
    mul_50: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_17, mul_44);  mul_44 = None
