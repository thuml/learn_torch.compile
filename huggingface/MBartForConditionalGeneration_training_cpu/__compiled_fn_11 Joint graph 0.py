...
def forward(self, primals, tangents):
    ...
    sub_2: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_2, getitem_5)
    ...
    add_6: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_2, getitem_6);  getitem_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_10: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476)
    ...
    mul_11: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_7, 0.5);  add_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:340, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[1024, 4096]" = torch.ops.aten.view.default(mul_16, [1024, 4096]);  mul_16 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:339, code: hidden_states = self.final_layer_norm(hidden_states)
    sub_3: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_2, getitem_5);  add_2 = getitem_5 = None
    ...
    mul_23: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_25, mul_17);  mul_17 = None
    ...
    view_43: "f32[1024, 1024]" = torch.ops.aten.view.default(mul_28, [1024, 1024]);  mul_28 = None
    ...
    mul_35: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_11, mul_29);  mul_29 = None
