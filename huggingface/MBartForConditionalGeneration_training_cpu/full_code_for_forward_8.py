...
def __guard_14_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139889976817360)) \
        ...
        and (___check_type_id(G['torch'].float16, 139891964954368)) \
...
def __guard_13_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976816832)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_12_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976816304)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_11_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976815776)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_10_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976815248)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_9_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976814720)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_8_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976814192)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_7_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976813664)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_6_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976819616)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_5_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976813280)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_4_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976812704)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_3_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976812320)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def forward(self, hidden_states, attention_mask, layer_head_mask, output_attentions):
    ...
    __temp_513 = self.self_attn(hidden_states=hidden_states, attention_mask=
        attention_mask, layer_head_mask=layer_head_mask, output_attentions=
        output_attentions)
    hidden_states = __temp_513[0]
    attn_weights = __temp_513[1]
    _ = __temp_513[2]
