...
def __guard_15_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139889976818608)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 156667952)) \
        and (___check_type_id(L['input_ids'], 86722064)) \
        ...
        and (___check_type_id(G['torch'].long, 139891964954368)) \
...
def __guard_2_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889976819184)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 156667952)) \
        and (___check_type_id(L['input_ids'], 86722064)) \
        and (hasattr(L['input_ids'], '_dynamo_dynamic_indices') == False) \
