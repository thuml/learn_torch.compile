...
def call(args):
    ...
    buf11 = empty((16, 1024, 1), device='cpu', dtype=torch.float32)
    buf12 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    buf13 = empty((16, 1024, 1), device='cpu', dtype=torch.float32)
