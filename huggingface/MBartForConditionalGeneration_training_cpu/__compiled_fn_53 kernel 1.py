...
def call(args):
    ...
    extern_kernels.mm(reinterpret_tensor(buf1, (1024, 1024), (1024, 1), 0), permute_20, out=buf2)
    del permute_20
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (1024, 1024), (1024, 1), 0), permute_28, out=buf15)
    del permute_28
    buf19 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf15, (16, 1024, 64), (64, 1024, 1), 0), permute_34, out=buf19)
    del permute_34
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf1, (1024, 1024), (1, 1024), 0), view_36, out=buf3)
    del view_36
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (1024, 1024), (1, 1024), 0), view_32, out=buf16)
    del view_32
    ...
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_33, reinterpret_tensor(buf15, (16, 1024, 64), (64, 1024, 1), 0), out=buf18)
    del permute_33
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf24, (1024, 1024), (1, 1024), 0), view_20, out=buf26)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (1024, 1024), (1, 1024), 0), permute_45, out=buf28)
    del permute_45
    buf29 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (1024, 1024), (1024, 1), 0), view_20, out=buf29)
    del view_20
    buf30 = empty((1, 1024), device='cpu', dtype=torch.float32)
    buf31 = reinterpret_tensor(buf25, (1, 1024, 1024), (1048576, 1024, 1), 0); del buf25  # reuse
    ...
    del permute_49
    buf34 = reinterpret_tensor(buf23, (1024, 1024), (1024, 1), 0); del buf23  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (1024, 1024), (1, 1024), 0), view_18, out=buf34)
    del view_18
    buf35 = empty((1, 1024), device='cpu', dtype=torch.float32)
    buf36 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf37 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    ...
    buf41 = reinterpret_tensor(buf22, (1, 1024, 1024), (1048576, 1024, 1), 0); del buf22  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf41, (1024, 1024), (1024, 1), 0), permute_53, out=buf42)
    del permute_53
    buf43 = buf32; del buf32  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf41, (1024, 1024), (1, 1024), 0), view_16, out=buf43)
    del view_16
    buf44 = reinterpret_tensor(buf37, (1, 1024), (1024, 1), 0); del buf37  # reuse
    cpp_fused_sum_12(c_void_p(buf41.data_ptr()), c_void_p(buf44.data_ptr()))
    buf45 = reinterpret_tensor(buf41, (16, 1024, 64), (65536, 64, 1), 0); del buf41  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_58, reinterpret_tensor(buf42, (16, 1024, 64), (64, 1024, 1), 0), out=buf45)
    del permute_58
    buf46 = buf21; del buf21  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf42, (16, 1024, 64), (64, 1024, 1), 0), permute_59, out=buf46)
    del permute_59
    ...
    del alias_3
    del buf47
    buf49 = reinterpret_tensor(buf42, (16, 64, 1024), (65536, 1024, 1), 0); del buf42  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_60, reinterpret_tensor(buf48, (16, 1024, 1024), (1048576, 1024, 1), 0), out=buf49)
    del permute_60
    buf50 = empty((16, 1024, 64), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf48, (16, 1024, 1024), (1048576, 1024, 1), 0), permute_61, out=buf50)
    del buf48
    del permute_61
    buf51 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    cpp_fused_view_14(c_void_p(buf45.data_ptr()), c_void_p(buf51.data_ptr()))
    buf52 = reinterpret_tensor(buf45, (1024, 1024), (1024, 1), 0); del buf45  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf51, permute_65, out=buf52)
    del permute_65
    buf53 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf51, (1024, 1024), (1, 1024), 0), view, out=buf53)
    buf54 = reinterpret_tensor(buf36, (1, 1024), (1024, 1), 0); del buf36  # reuse
    cpp_fused_sum_15(c_void_p(buf51.data_ptr()), c_void_p(buf54.data_ptr()))
    buf55 = buf51; del buf51  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf49, (1024, 1024), (1, 1024), 0), permute_70, out=buf55)
    del permute_70
    buf56 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf49, (1024, 1024), (1024, 1), 0), view, out=buf56)
    ...
    del permute_74
    buf60 = reinterpret_tensor(buf49, (1024, 1024), (1024, 1), 0); del buf49  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf58, (1024, 1024), (1, 1024), 0), view, out=buf60)
    del view
    buf61 = empty((1, 1024), device='cpu', dtype=torch.float32)
    buf62 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf63 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    getitem_11 = rand_strided((1, 1024, 1024), (1048576, 1024, 1), device='cpu', dtype=torch.bool)
