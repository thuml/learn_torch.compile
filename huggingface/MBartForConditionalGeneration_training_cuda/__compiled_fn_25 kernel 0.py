...
# kernel path: /tmp/torchinductor_youkaichao/ey/ceyc4kaqohr6xlvs4mox7aw3iqphv7flwd5tyg3gudgxwseb7xz3.py
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty((1, 1, 1024, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        stream0 = get_cuda_stream(0)
        triton_poi_fused_0.run(buf0, 1048576, grid=grid(1048576), stream=stream0)
        return (buf0, )
