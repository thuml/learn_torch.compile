...
# kernel path: /tmp/torchinductor_youkaichao/e7/ce7g45t3myrrp5r4eh2jvsv2fi5y5f5ilxgyxg5jp5b3bwiqgkx4.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf12 = empty((16, 1024, 1), device='cuda', dtype=torch.float32)
        buf13 = empty((16, 1024, 1), device='cuda', dtype=torch.float32)
        buf14 = empty((16, 1024, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_weights_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf11, buf12, buf13, buf14, 16384, 1024, grid=grid(16384), stream=stream0)
