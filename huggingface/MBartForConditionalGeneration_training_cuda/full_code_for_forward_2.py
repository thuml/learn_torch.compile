...
def __guard_15_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139812508268336)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 151139248)) \
        and (___check_type_id(L['input_ids'], 81274928)) \
        ...
        and (___check_type_id(G['torch'].long, 139814499780352)) \
...
def __guard_2_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508263152)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 151139248)) \
        and (___check_type_id(L['input_ids'], 81274928)) \
        and (hasattr(L['input_ids'], '_dynamo_dynamic_indices') == False) \
