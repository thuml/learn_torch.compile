...
def forward(self, primals_1: "f32[1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024, 1024]", primals_10: "f32[1024]", primals_11: "f32[1024]", primals_12: "f32[1024]", primals_13: "f32[4096, 1024]", primals_14: "f32[4096]", primals_15: "f32[1024, 4096]", primals_16: "f32[1024]", primals_17: "f32[1, 1024, 1024]"):
    ...
    add_tensor_2: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_4);  mm_default_2 = primals_4 = None
    ...
    add_tensor_1: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_6);  mm_default_1 = primals_6 = None
    ...
    add_tensor: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_8);  mm_default = primals_8 = None
    ...
    view_16: "f32[1024, 1024]" = torch.ops.aten.reshape.default(add_4, [1024, 1024]);  add_4 = None
    ...
    view_18: "f32[1024, 4096]" = torch.ops.aten.reshape.default(mul_7, [1024, 4096]);  mul_7 = None
