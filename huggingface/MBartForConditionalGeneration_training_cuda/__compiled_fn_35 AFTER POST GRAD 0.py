...
def forward(self, primals_1: "f32[1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024, 1024]", primals_10: "f32[1024]", primals_11: "f32[1024]", primals_12: "f32[1024]", primals_13: "f32[1024, 1024]", primals_14: "f32[1024]", primals_15: "f32[1024, 1024]", primals_16: "f32[1024]", primals_17: "f32[1024, 1024]", primals_18: "f32[1024]", primals_19: "f32[1024, 1024]", primals_20: "f32[1024]", primals_21: "f32[1024]", primals_22: "f32[1024]", primals_23: "f32[4096, 1024]", primals_24: "f32[4096]", primals_25: "f32[1024, 4096]", primals_26: "f32[1024]", primals_27: "f32[1, 1024, 1024]", primals_28: "f32[1, 1, 1024, 1024]", primals_29: "f32[1, 1024, 1024]"):
    ...
    mm_default_5: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_5: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_5, primals_4);  mm_default_5 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:189, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 1024, 1024]);  add_tensor_5 = None
    ...
    # No stacktrace found for following nodes
    mm_default_4: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_4: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_4, primals_6);  mm_default_4 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:214, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 1024, 1024]);  add_tensor_4 = None
    ...
    # No stacktrace found for following nodes
    mm_default_3: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor_3: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_3, primals_8);  mm_default_3 = primals_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:215, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 1024, 1024]);  add_tensor_3 = None
    ...
    view_10: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(clone, [16, -1, 64]);  clone = None
    ...
    view_11: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(clone_1, [16, -1, 64]);  clone_1 = None
    ...
    # No stacktrace found for following nodes
    mm_default_2: "f32[1024, 1024]" = torch.ops.aten.mm.default(view_18, permute_9)
    add_tensor_2: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_14);  mm_default_2 = primals_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:189, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_19: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 1024, 1024]);  add_tensor_2 = None
    ...
    view_20: "f32[1024, 1024]" = torch.ops.aten.reshape.default(primals_29, [1024, 1024]);  primals_29 = None
    permute_10: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_15, [1, 0]);  primals_15 = None
    
    # No stacktrace found for following nodes
    mm_default_1: "f32[1024, 1024]" = torch.ops.aten.mm.default(view_20, permute_10)
    add_tensor_1: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_16);  mm_default_1 = primals_16 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:204, code: key_states = self._shape(self.k_proj(key_value_states), -1, bsz)
    view_21: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 1024, 1024]);  add_tensor_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:169, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_22: "f32[1, 1024, 16, 64]" = torch.ops.aten.reshape.default(view_21, [1, -1, 16, 64]);  view_21 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[1024, 1024]" = torch.ops.aten.mm.default(view_20, permute_12)
    add_tensor: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_18);  mm_default = primals_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:205, code: value_states = self._shape(self.v_proj(key_value_states), -1, bsz)
    view_24: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor, [1, 1024, 1024]);  add_tensor = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:169, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 1024, 16, 64]" = torch.ops.aten.reshape.default(mul_5, [1, 1024, 16, 64]);  mul_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:228, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_27: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(clone_7, [16, -1, 64]);  clone_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:229, code: key_states = key_states.reshape(*proj_shape)
    view_28: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(clone_5, [16, -1, 64]);  clone_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:230, code: value_states = value_states.reshape(*proj_shape)
    view_29: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(clone_6, [16, -1, 64]);  clone_6 = None
    ...
    sub_3: "f32[16, 1024, 1024]" = torch.ops.aten.sub.Tensor(bmm_2, amax_1)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:272, code: attn_output = torch.bmm(attn_probs, value_states)
    bmm_3: "f32[16, 1024, 64]" = torch.ops.aten.bmm.default(div_1, view_29)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:280, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[1, 16, 1024, 64]" = torch.ops.aten.reshape.default(bmm_3, [1, 16, 1024, 64]);  bmm_3 = None
    ...
    view_31: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 1024, 1024]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:287, code: attn_output = self.out_proj(attn_output)
    view_32: "f32[1024, 1024]" = torch.ops.aten.reshape.default(view_31, [1024, 1024]);  view_31 = None
    ...
    view_33: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(addmm_7, [1, 1024, 1024]);  addmm_7 = None
    ...
    add_6: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_3, getitem_6);  add_3 = getitem_6 = None
    ...
    sub_4: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_6, getitem_9);  getitem_9 = None
    mul_6: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_4, rsqrt_2);  sub_4 = None
    mul_7: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_6, primals_21)
    ...
    view_34: "f32[1024, 1024]" = torch.ops.aten.reshape.default(add_8, [1024, 1024]);  add_8 = None
    ...
    view_35: "f32[1, 1024, 4096]" = torch.ops.aten.reshape.default(addmm_8, [1, 1024, 4096])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_8: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_35, 0.5)
    mul_9: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_35, 0.7071067811865476);  view_35 = None
    ...
    view_36: "f32[1024, 4096]" = torch.ops.aten.reshape.default(mul_10, [1024, 4096]);  mul_10 = None
    ...
    view_37: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(addmm_9, [1, 1024, 1024]);  addmm_9 = None
    ...
    add_10: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_6, getitem_10);  add_6 = getitem_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:272, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_33: "f32[16, 1024, 1024]" = torch.ops.aten.permute.default(div_1, [0, 2, 1]);  div_1 = None
