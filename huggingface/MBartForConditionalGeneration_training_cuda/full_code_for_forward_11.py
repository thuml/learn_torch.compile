...
def __guard_14_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139812508266752)) \
        ...
        and (___check_type_id(G['torch'].float16, 139814499780352)) \
...
def __guard_13_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508266224)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_12_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508265696)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_11_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508265168)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_10_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508264640)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_9_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508264112)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_8_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508264064)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_7_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508264256)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_6_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508269920)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_5_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508265072)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_4_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508265504)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
...
def __guard_3_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139812508264592)) \
        and (L['self'].training == True) \
        and (hasattr(L['hidden_states'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['attention_mask'], 7628576)) \
        and (___check_obj_id(L['layer_head_mask'], 7628576)) \
