...
def forward(self, L_inputs_labels_ : torch.Tensor, L_inputs_input_ids_ : torch.Tensor):
    ...
    getitem_3 = l_inputs_labels_[(slice(None, None, None), slice(1, None, None))];  l_inputs_labels_ = None
    ...
    lm_loss = torch.nn.functional.cross_entropy(view_96, view_97, None, None, -100, None, 'mean', 0.0);  view_96 = view_97 = None
