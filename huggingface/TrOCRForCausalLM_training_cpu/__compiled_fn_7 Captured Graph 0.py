...
def forward(self):
    ...
    mask = torch.full((256, 256), -3.4028234663852886e+38, device = device(type='cpu'))
    ...
    mask_cond = torch.arange(256, device = device(type='cpu'))
    ...
    combined_attention_mask = getitem.expand(1, 1, 256, 256);  getitem = None
