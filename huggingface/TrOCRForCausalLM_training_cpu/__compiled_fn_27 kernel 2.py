                       ...
                       float* out_ptr1)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(526336L); x0+=static_cast<long>(8L))
            {
...
def call(args):
    ...
    buf0 = empty((514, 1024), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    add = rand_strided((1, 256), (256, 1), device='cpu', dtype=torch.int64)
