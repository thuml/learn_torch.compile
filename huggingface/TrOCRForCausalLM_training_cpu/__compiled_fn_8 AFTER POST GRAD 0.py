...
def forward(self, primals_1: "f32[1024, 1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024]", primals_10: "f32[1024]", primals_11: "f32[4096, 1024]", primals_12: "f32[4096]", primals_13: "f32[1024, 4096]", primals_14: "f32[1024]", primals_15: "f32[1024]", primals_16: "f32[1024]", primals_17: "f32[1, 256, 1024]", primals_18: "f32[1, 1, 256, 256]"):
    ...
    view_1: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(addmm, [1, 256, 1024]);  addmm = None
    ...
    addmm_1: "f32[256, 1024]" = torch.ops.aten.addmm.default(primals_4, view, permute_1);  primals_4 = None
    view_3: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(addmm_1, [1, 256, 1024]);  addmm_1 = None
    ...
    addmm_2: "f32[256, 1024]" = torch.ops.aten.addmm.default(primals_6, view, permute_3);  primals_6 = None
    view_6: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(addmm_2, [1, 256, 1024]);  addmm_2 = None
