...
def call(args):
    ...
    buf1 = empty_strided((256, 1), (1, 256), device='cpu', dtype=torch.float32)
    buf2 = empty_strided((256, 1), (1, 256), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_2 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.float32)
