                       ...
                       long* out_ptr1)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(12867840L); x0+=static_cast<long>(8L))
            {
...
def call(args):
    ...
    buf0 = empty((256, 50265), device='cpu', dtype=torch.float32)
    buf1 = empty_strided((256, 1), (1, 256), device='cpu', dtype=torch.int64)
    ...
    del buf1
    buf4 = empty_strided((256, 1), (1, 256), device='cpu', dtype=torch.float32)
    buf3 = empty((256, 50265), device='cpu', dtype=torch.float32)
    buf5 = reinterpret_tensor(buf3, (1, 256, 50265), (12867840, 50265, 1), 0); del buf3  # reuse
    ...
    del tangents_1
    del tangents_2
    buf6 = empty((50265, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (50265, 256), (1, 50265), 0), view, out=buf6)
    del view
    buf7 = empty((256, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((1, 256), (256, 1), device='cpu', dtype=torch.int64)
    view = rand_strided((256, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    sub_1 = rand_strided((256, 50265), (50265, 1), device='cpu', dtype=torch.float32)
    ...
    tangents_2 = rand_strided((1, 256, 50265), (12867840, 50265, 1), device='cpu', dtype=torch.float32)
