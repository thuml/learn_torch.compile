                ...
                {
                    {
                        ...
                        for(long x2=static_cast<long>(0L); x2<static_cast<long>(256L); x2+=static_cast<long>(8L))
                        {
                            ...
                            auto tmp1 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x2 + (256L*x1)));
                            auto tmp2 = tmp0 + tmp1;
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(1L))
                {
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(256L); x2+=static_cast<long>(8L))
                    {
                        ...
                        auto tmp5 = tmp2 - tmp4;
                        auto tmp6 = tmp5.exp();
                        tmp6.store(in_out_ptr0 + static_cast<long>(x2 + (256L*x1) + (65536L*x0)));
                    }
                }
            }
        }
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(4096L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(8L))
                {
                    ...
                    auto tmp2 = at::vec::Vectorized<float>(tmp1);
                    auto tmp3 = tmp0 / tmp2;
                    tmp3.store(out_ptr2 + static_cast<long>(x1 + (256L*x0)));
                    tmp3.store(out_ptr3 + static_cast<long>(x1 + (256L*x0)));
                }
            }
        }
    }
    ...
    {
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(256L); x0+=static_cast<long>(1L))
            {
                ...
                {
                    auto tmp0 = ([&]() { __at_align__ float tmpbuf[8]; for (long x1_inner = 0; x1_inner < 8; x1_inner++) tmpbuf[x1_inner] = in_ptr0[static_cast<long>((64L*x0) + (16384L*(c10::div_floor_integer((x1 + x1_inner), 64L))) + (static_cast<long>((x1 + x1_inner)) % static_cast<long>(64L)))]; return at::vec::Vectorized<float>::loadu(tmpbuf); })();
...
def call(args):
    ...
    buf0 = empty((256, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_q_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_2, reinterpret_tensor(primals_17, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_1, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf0)
    del primals_2
    buf1 = empty((256, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_4, reinterpret_tensor(primals_17, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_3, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf1)
    del primals_4
    buf2 = empty((1, 16, 256, 64), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_17, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf3)
    del primals_6
    buf4 = empty((1, 16, 256, 64), device='cpu', dtype=torch.float32)
    buf5 = empty((1, 16, 256, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_1(c_void_p(buf3.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf5.data_ptr()))
    buf6 = empty((16, 256, 256), device='cpu', dtype=torch.float32)
    ...
    buf7 = empty_strided((16, 256, 1), (256, 1, 4096), device='cpu', dtype=torch.float32)
    buf8 = buf6; del buf6  # reuse
    buf9 = empty_strided((16, 256, 1), (256, 1, 4096), device='cpu', dtype=torch.float32)
    buf10 = empty((16, 256, 256), device='cpu', dtype=torch.float32)
    buf35 = empty((16, 256, 256), device='cpu', dtype=torch.float32)
    cpp_fused__softmax_clone_detach_2(c_void_p(buf8.data_ptr()), c_void_p(primals_18.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(buf10.data_ptr()), c_void_p(buf35.data_ptr()))
    del buf7
    del buf9
    del primals_18
    buf11 = reinterpret_tensor(buf3, (16, 256, 64), (16384, 64, 1), 0); del buf3  # reuse
    # Source Nodes: [attn_output], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf10, reinterpret_tensor(buf4, (16, 256, 64), (16384, 64, 1), 0), out=buf11)
    buf12 = buf0; del buf0  # reuse
    cpp_fused_view_3(c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()))
    buf13 = reinterpret_tensor(buf11, (256, 1024), (1024, 1), 0); del buf11  # reuse
    ...
    buf14 = aten.native_dropout(reinterpret_tensor(buf13, (1, 256, 1024), (262144, 1024, 1), 0), 0.1, True)
    buf15 = buf14[0]
    buf16 = buf14[1]
    del buf14
    buf17 = empty_strided((1, 256, 1), (256, 1, 256), device='cpu', dtype=torch.float32)
    buf18 = empty_strided((1, 256, 1), (256, 1, 256), device='cpu', dtype=torch.float32)
    buf20 = reinterpret_tensor(buf13, (1, 256, 1024), (262144, 1024, 1), 0); del buf13  # reuse
    buf21 = empty((256, 1024), device='cpu', dtype=torch.float32)
    ...
    buf22 = reinterpret_tensor(buf8, (256, 4096), (4096, 1), 0); del buf8  # reuse
    ...
    del primals_12
    buf23 = empty((256, 4096), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_view_5(c_void_p(buf22.data_ptr()), c_void_p(buf23.data_ptr()))
    buf24 = reinterpret_tensor(buf15, (256, 1024), (1024, 1), 0); del buf15  # reuse
    ...
    buf25 = aten.native_dropout(reinterpret_tensor(buf24, (1, 256, 1024), (262144, 1024, 1), 0), 0.1, True)
    buf26 = buf25[0]
    buf27 = buf25[1]
    del buf25
    buf28 = buf17; del buf17  # reuse
    buf29 = empty_strided((1, 256, 1), (256, 1, 256), device='cpu', dtype=torch.float32)
    buf31 = reinterpret_tensor(buf24, (1, 256, 1024), (262144, 1024, 1), 0); del buf24  # reuse
    buf32 = empty((1, 256, 1024), device='cpu', dtype=torch.float32)
    buf33 = reinterpret_tensor(buf29, (1, 256, 1), (256, 1, 1), 0); del buf29  # reuse
    buf34 = reinterpret_tensor(buf18, (1, 256, 1), (256, 1, 1), 0); del buf18  # reuse
    cpp_fused_add_native_layer_norm_native_layer_norm_backward_6(c_void_p(buf33.data_ptr()), c_void_p(buf34.data_ptr()), c_void_p(buf20.data_ptr()), c_void_p(primals_9.data_ptr()), c_void_p(primals_10.data_ptr()), c_void_p(buf26.data_ptr()), c_void_p(primals_15.data_ptr()), c_void_p(primals_16.data_ptr()), c_void_p(buf28.data_ptr()), c_void_p(buf31.data_ptr()), c_void_p(buf32.data_ptr()))
    del buf26
    del buf28
    del primals_10
    del primals_16
    return (buf32, buf2, buf4, primals_9, primals_15, reinterpret_tensor(primals_17, (256, 1024), (1024, 1), 0), buf12, buf16, buf20, buf21, buf22, buf23, buf27, buf31, buf33, reinterpret_tensor(primals_13, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_11, (4096, 1024), (1024, 1), 0), buf34, reinterpret_tensor(primals_7, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf10, (16, 256, 256), (65536, 1, 256), 0), reinterpret_tensor(buf4, (16, 64, 256), (16384, 1, 64), 0), buf35, reinterpret_tensor(buf5, (16, 64, 256), (16384, 1, 64), 0), reinterpret_tensor(buf2, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_3, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_1, (1024, 1024), (1024, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_17 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.float32)
    primals_18 = rand_strided((1, 1, 256, 256), (65536, 65536, 256, 1), device='cpu', dtype=torch.float32)
