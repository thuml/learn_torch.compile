        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(4096L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(8L))
                {
                    ...
                    auto tmp5 = tmp1 * tmp4;
                    auto tmp6 = tmp2 - tmp5;
                    tmp6.store(in_out_ptr0 + static_cast<long>(x1 + (256L*x0)));
                }
            }
        }
    }
    ...
    {
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(1L))
                {
                    ...
                    {
                        auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x2 + (64L*x1) + (16384L*x0)));
                        auto tmp1 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x2 + (64L*x1) + (16384L*x0)));
                        auto tmp2 = tmp0 + tmp1;
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(256L); x1+=static_cast<long>(8L))
                {
                    ...
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(64L); x2+=static_cast<long>(8L))
                    {
                        ...
                        at::vec::transpose_mxn<float,8,8>(in_ptr2 + static_cast<long>(x1 + (256L*x2) + (16384L*x0)), static_cast<long>(256L), tmp1, 8);
                        for (long x1_inner = 0; x1_inner < 8; x1_inner++)
                        {
                            auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x2 + (64L*x1) + (64L*x1_inner) + (16384L*x0)));
    ...
    #pragma omp parallel num_threads(28)
    {
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(256L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(1024L); x1+=static_cast<long>(8L))
                {
                    auto tmp0 = ([&]() { __at_align__ float tmpbuf[8]; for (long x1_inner = 0; x1_inner < 8; x1_inner++) tmpbuf[x1_inner] = in_ptr1[static_cast<long>((64L*x0) + (16384L*(c10::div_floor_integer((x1 + x1_inner), 64L))) + (static_cast<long>((x1 + x1_inner)) % static_cast<long>(64L)))]; return at::vec::Vectorized<float>::loadu(tmpbuf); })();
...
def call(args):
    ...
    buf9 = reinterpret_tensor(buf6, (1, 256, 4096), (1048576, 4096, 1), 0); del buf6  # reuse
    ...
    del addmm_4
    buf10 = reinterpret_tensor(buf5, (256, 1024), (1024, 1), 0); del buf5  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf9, (256, 4096), (4096, 1), 0), permute_15, out=buf10)
    del permute_15
    buf11 = empty((4096, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf9, (4096, 256), (1, 4096), 0), view_18, out=buf11)
    del view_18
    buf12 = empty((1, 4096), device='cpu', dtype=torch.float32)
    buf13 = buf1; del buf1  # reuse
    buf14 = buf0; del buf0  # reuse
    buf15 = empty((1, 256, 1024), device='cpu', dtype=torch.float32)
    buf16 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf17 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf18 = empty((1, 256, 1024), device='cpu', dtype=torch.float32)
    ...
    del mul_1
    del primals_9
    buf19 = reinterpret_tensor(buf2, (256, 1024), (1024, 1), 0); del buf2  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf18, (256, 1024), (1024, 1), 0), permute_19, out=buf19)
    del permute_19
    buf20 = reinterpret_tensor(buf9, (1024, 1024), (1024, 1), 0); del buf9  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf18, (1024, 256), (1, 1024), 0), view_16, out=buf20)
    del view_16
    buf21 = empty((1, 1024), device='cpu', dtype=torch.float32)
    cpp_fused_sum_3(c_void_p(buf18.data_ptr()), c_void_p(buf21.data_ptr()))
    buf22 = reinterpret_tensor(buf18, (16, 256, 64), (16384, 64, 1), 0); del buf18  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_24, reinterpret_tensor(buf19, (16, 256, 64), (64, 1024, 1), 0), out=buf22)
    del permute_24
    buf23 = empty((16, 256, 256), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf19, (16, 256, 64), (64, 1024, 1), 0), permute_25, out=buf23)
    del permute_25
    buf24 = empty_strided((16, 256, 1), (256, 1, 4096), device='cpu', dtype=torch.float32)
    buf25 = buf23; del buf23  # reuse
    cpp_fused__softmax_backward_data_4(c_void_p(buf25.data_ptr()), c_void_p(alias_1.data_ptr()), c_void_p(buf24.data_ptr()))
    del alias_1
    del buf24
    buf26 = reinterpret_tensor(buf19, (16, 64, 256), (16384, 256, 1), 0); del buf19  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_26, reinterpret_tensor(buf25, (16, 256, 256), (65536, 256, 1), 0), out=buf26)
    del permute_26
    buf27 = reinterpret_tensor(buf10, (16, 256, 64), (16384, 64, 1), 0); del buf10  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf25, (16, 256, 256), (65536, 256, 1), 0), permute_27, out=buf27)
    del permute_27
    buf28 = empty((1, 256, 16, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_5(c_void_p(tangents_3.data_ptr()), c_void_p(buf22.data_ptr()), c_void_p(buf28.data_ptr()))
    del tangents_3
    buf29 = reinterpret_tensor(buf22, (256, 1024), (1024, 1), 0); del buf22  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf28, (256, 1024), (1024, 1), 0), permute_31, out=buf29)
    del permute_31
    buf30 = reinterpret_tensor(buf25, (1024, 1024), (1024, 1), 0); del buf25  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf28, (1024, 256), (1, 1024), 0), view, out=buf30)
    buf31 = empty((1, 1024), device='cpu', dtype=torch.float32)
    buf32 = empty((1, 256, 16, 64), device='cpu', dtype=torch.float32)
    ...
    del tangents_2
    buf33 = reinterpret_tensor(buf28, (256, 1024), (1024, 1), 0); del buf28  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (256, 1024), (1024, 1), 0), permute_36, out=buf33)
    del permute_36
    buf34 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (1024, 256), (1, 1024), 0), view, out=buf34)
    buf35 = empty((1, 1024), device='cpu', dtype=torch.float32)
    buf36 = reinterpret_tensor(buf26, (256, 1024), (1024, 1), 0); del buf26  # reuse
    ...
    del permute_40
    buf38 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    ...
    return (reinterpret_tensor(buf38, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf39, (1024, ), (1, ), 0), reinterpret_tensor(buf34, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf35, (1024, ), (1, ), 0), reinterpret_tensor(buf30, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf31, (1024, ), (1, ), 0), reinterpret_tensor(buf20, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf21, (1024, ), (1, ), 0), buf16, buf17, reinterpret_tensor(buf11, (4096, 1024), (1024, 1), 0), reinterpret_tensor(buf12, (4096, ), (1, ), 0), reinterpret_tensor(buf7, (1024, 4096), (4096, 1), 0), reinterpret_tensor(buf8, (1024, ), (1, ), 0), buf3, buf4, buf40, None, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    view = rand_strided((256, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    view_16 = rand_strided((256, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    getitem_1 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.bool)
    mul_1 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.float32)
    view_18 = rand_strided((256, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    addmm_4 = rand_strided((256, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    view_20 = rand_strided((256, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    getitem_5 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.bool)
    mul_6 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.float32)
    div_1 = rand_strided((1, 256, 1), (256, 1, 1), device='cpu', dtype=torch.float32)
    ...
    div_2 = rand_strided((1, 256, 1), (256, 1, 1), device='cpu', dtype=torch.float32)
    permute_19 = rand_strided((1024, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    permute_24 = rand_strided((16, 256, 256), (65536, 1, 256), device='cpu', dtype=torch.float32)
    permute_25 = rand_strided((16, 64, 256), (16384, 1, 64), device='cpu', dtype=torch.float32)
    alias_1 = rand_strided((16, 256, 256), (65536, 256, 1), device='cpu', dtype=torch.float32)
    permute_26 = rand_strided((16, 64, 256), (16384, 1, 64), device='cpu', dtype=torch.float32)
    permute_27 = rand_strided((16, 256, 64), (16384, 64, 1), device='cpu', dtype=torch.float32)
    ...
    tangents_1 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cpu', dtype=torch.float32)
    tangents_2 = rand_strided((1, 16, 256, 64), (262144, 16384, 64, 1), device='cpu', dtype=torch.float32)
    tangents_3 = rand_strided((1, 16, 256, 64), (262144, 16384, 64, 1), device='cpu', dtype=torch.float32)
