...
def forward(self, primals_9: "f32[1024]", primals_15: "f32[1024]", view: "f32[256, 1024]", view_16: "f32[256, 1024]", getitem_1: "b8[1, 256, 1024]", mul_1: "f32[1, 256, 1024]", view_18: "f32[256, 1024]", addmm_4: "f32[256, 4096]", view_20: "f32[256, 4096]", getitem_5: "b8[1, 256, 1024]", mul_6: "f32[1, 256, 1024]", div_1: "f32[1, 256, 1]", permute_11: "f32[1024, 4096]", permute_15: "f32[4096, 1024]", div_2: "f32[1, 256, 1]", permute_19: "f32[1024, 1024]", permute_24: "f32[16, 256, 256]", permute_25: "f32[16, 64, 256]", alias_1: "f32[16, 256, 256]", permute_26: "f32[16, 64, 256]", permute_27: "f32[16, 256, 64]", permute_31: "f32[1024, 1024]", permute_36: "f32[1024, 1024]", permute_40: "f32[1024, 1024]", tangents_1: "f32[1, 256, 1024]", tangents_2: "f32[1, 16, 256, 64]", tangents_3: "f32[1, 16, 256, 64]"):
    ...
    view_19: "f32[1, 256, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 256, 4096]);  addmm_4 = None
    ...
    mul_11: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_9, mul_6);  mul_9 = None
    sum_3: "f32[1, 256, 1]" = torch.ops.aten.sum.dim_IntList(mul_11, [2], True);  mul_11 = None
    mul_12: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_6, sum_3);  sum_3 = None
    ...
    mul_14: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(tangents_1, mul_6);  mul_6 = None
    ...
    view_22: "f32[256, 1024]" = torch.ops.aten.reshape.default(mul_16, [256, 1024]);  mul_16 = None
    ...
    view_23: "f32[1024]" = torch.ops.aten.reshape.default(sum_6, [1024]);  sum_6 = None
    permute_14: "f32[1024, 4096]" = torch.ops.aten.permute.default(permute_13, [1, 0]);  permute_13 = None
    view_24: "f32[1, 256, 4096]" = torch.ops.aten.reshape.default(mm, [1, 256, 4096]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_18: "f32[1, 256, 4096]" = torch.ops.aten.mul.Tensor(add_4, 0.5);  add_4 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:422, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_25: "f32[256, 4096]" = torch.ops.aten.reshape.default(mul_23, [256, 4096]);  mul_23 = None
    ...
    view_26: "f32[4096]" = torch.ops.aten.reshape.default(sum_7, [4096]);  sum_7 = None
    permute_18: "f32[4096, 1024]" = torch.ops.aten.permute.default(permute_17, [1, 0]);  permute_17 = None
    view_27: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(mm_2, [1, 256, 1024]);  mm_2 = None
    ...
    mul_27: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_25, mul_1);  mul_25 = None
    sum_9: "f32[1, 256, 1]" = torch.ops.aten.sum.dim_IntList(mul_27, [2], True);  mul_27 = None
    mul_28: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_1, sum_9);  sum_9 = None
    ...
    mul_30: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(add_10, mul_1);  mul_1 = None
    ...
    view_28: "f32[256, 1024]" = torch.ops.aten.reshape.default(mul_32, [256, 1024]);  mul_32 = None
    ...
    view_30: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(mm_4, [1, 256, 1024]);  mm_4 = None
    ...
    view_31: "f32[1, 256, 16, 64]" = torch.ops.aten.reshape.default(view_30, [1, 256, 16, 64]);  view_30 = None
    ...
    view_32: "f32[16, 256, 64]" = torch.ops.aten.reshape.default(permute_23, [16, 256, 64]);  permute_23 = None
    ...
    view_33: "f32[1, 16, 256, 256]" = torch.ops.aten.reshape.default(sub_9, [1, 16, 256, 256]);  sub_9 = None
    ...
    view_34: "f32[16, 256, 256]" = torch.ops.aten.reshape.default(view_33, [16, 256, 256]);  view_33 = None
    ...
    view_35: "f32[1, 16, 256, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 16, 256, 64]);  bmm_2 = None
    ...
    view_36: "f32[1, 16, 256, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 16, 256, 64]);  permute_28 = None
    ...
    view_37: "f32[1, 16, 256, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 16, 256, 64]);  bmm_5 = None
    ...
    view_38: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(clone_8, [1, 256, 1024]);  clone_8 = None
    ...
    view_39: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 256, 1024]);  clone_9 = None
    ...
    view_41: "f32[1024]" = torch.ops.aten.reshape.default(sum_14, [1024]);  sum_14 = None
    permute_34: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_42: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(mm_6, [1, 256, 1024]);  mm_6 = None
    ...
    view_43: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(clone_10, [1, 256, 1024]);  clone_10 = None
    ...
    view_44: "f32[256, 1024]" = torch.ops.aten.reshape.default(view_43, [256, 1024]);  view_43 = None
    ...
    view_45: "f32[1024]" = torch.ops.aten.reshape.default(sum_15, [1024]);  sum_15 = None
    permute_39: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_46: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(mm_8, [1, 256, 1024]);  mm_8 = None
    ...
    view_47: "f32[256, 1024]" = torch.ops.aten.reshape.default(mul_35, [256, 1024]);  mul_35 = None
    ...
    view_48: "f32[1024]" = torch.ops.aten.reshape.default(sum_16, [1024]);  sum_16 = None
    permute_43: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_49: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(mm_10, [1, 256, 1024]);  mm_10 = None
