...
# kernel path: /tmp/torchinductor_youkaichao/ma/cmah4p6phrhj7nqg47zuwnetickbyfjzfe3dpvbzz4oja7gx3h4j.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(primals_17, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1, 1024), 0), out=buf2)
        ...
        buf7 = empty((16, 1024, 1), device='cuda', dtype=torch.float32)
        buf8 = empty((16, 1024, 1), device='cuda', dtype=torch.float32)
        buf9 = empty((16, 1024, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_weights_1], Original ATen: [aten._softmax]
        triton_per_fused__softmax_2.run(buf6, buf7, buf8, buf9, 16384, 1024, grid=grid(16384), stream=stream0)
