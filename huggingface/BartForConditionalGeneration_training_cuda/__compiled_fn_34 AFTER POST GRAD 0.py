...
def forward(self, primals_1: "f32[1024, 1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024]", primals_10: "f32[1024]", primals_11: "f32[1024, 1024]", primals_12: "f32[1024]", primals_13: "f32[1024, 1024]", primals_14: "f32[1024]", primals_15: "f32[1024, 1024]", primals_16: "f32[1024]", primals_17: "f32[1024, 1024]", primals_18: "f32[1024]", primals_19: "f32[1024]", primals_20: "f32[1024]", primals_21: "f32[4096, 1024]", primals_22: "f32[4096]", primals_23: "f32[1024, 4096]", primals_24: "f32[1024]", primals_25: "f32[1024]", primals_26: "f32[1024]", primals_27: "f32[1, 1024, 1024]", primals_28: "f32[1, 1, 1024, 1024]", primals_29: "f32[1, 1024, 1024]"):
    ...
    view: "f32[1024, 1024]" = torch.ops.aten.reshape.default(primals_27, [1024, 1024])
    ...
    add_tensor_5: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_5, primals_2);  mm_default_5 = primals_2 = None
    ...
    add_tensor_4: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_4, primals_4);  mm_default_4 = primals_4 = None
    ...
    add_tensor_3: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_3, primals_6);  mm_default_3 = primals_6 = None
    ...
    add_tensor_2: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_12);  mm_default_2 = primals_12 = None
    ...
    add_tensor_1: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_14);  mm_default_1 = primals_14 = None
    ...
    add_tensor: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_16);  mm_default = primals_16 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:173, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 1024, 16, 64]" = torch.ops.aten.reshape.default(mul_3, [1, 1024, 16, 64]);  mul_3 = None
    ...
    view_34: "f32[1024, 1024]" = torch.ops.aten.reshape.default(add_6, [1024, 1024])
    ...
    view_36: "f32[1024, 4096]" = torch.ops.aten.reshape.default(mul_8, [1024, 4096]);  mul_8 = None
