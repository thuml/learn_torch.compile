...
def forward(self, primals_1: "f32[1024, 1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024]", primals_10: "f32[1024]", primals_11: "f32[4096, 1024]", primals_12: "f32[4096]", primals_13: "f32[1024, 4096]", primals_14: "f32[1024]", primals_15: "f32[1024]", primals_16: "f32[1024]", primals_17: "f32[1, 1024, 1024]"):
    ...
    mm_default_2: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_2: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_2);  mm_default_2 = primals_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:193, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 1024, 1024]);  add_tensor_2 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_1: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_4);  mm_default_1 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:218, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 1024, 1024]);  add_tensor_1 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[1024, 1024]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor: "f32[1024, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_6);  mm_default = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:219, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(add_tensor, [1, 1024, 1024]);  add_tensor = None
    ...
    sub: "f32[16, 1024, 1024]" = torch.ops.aten.sub.Tensor(bmm, amax)
    ...
    bmm_1: "f32[16, 1024, 64]" = torch.ops.aten.bmm.default(div, view_11)
    ...
    view_12: "f32[1, 16, 1024, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 16, 1024, 64]);  bmm_1 = None
    ...
    view_13: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(clone_4, [1, 1024, 1024]);  clone_4 = None
    ...
    view_14: "f32[1024, 1024]" = torch.ops.aten.reshape.default(view_13, [1024, 1024]);  view_13 = None
    ...
    view_15: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(addmm_3, [1, 1024, 1024]);  addmm_3 = None
    ...
    sub_1: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add, getitem_3);  add = getitem_3 = None
    ...
    view_16: "f32[1024, 1024]" = torch.ops.aten.reshape.default(add_2, [1024, 1024])
    ...
    view_17: "f32[1, 1024, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 1024, 4096])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_3: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.5)
    mul_4: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476);  view_17 = None
    ...
    view_18: "f32[1024, 4096]" = torch.ops.aten.reshape.default(mul_5, [1024, 4096]);  mul_5 = None
    ...
    view_19: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(addmm_5, [1, 1024, 1024]);  addmm_5 = None
    ...
    sub_2: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_4, getitem_7);  add_4 = getitem_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:276, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_24: "f32[16, 1024, 1024]" = torch.ops.aten.permute.default(div, [0, 2, 1]);  div = None
