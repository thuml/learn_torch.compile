...
def __guard_15_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139906517424912)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 150171312)) \
        and (___check_type_id(L['input_ids'], 80223264)) \
        ...
        and (___check_type_id(G['torch'].long, 139908508395264)) \
...
def __guard_2_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139906517433024)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 150171312)) \
        and (___check_type_id(L['input_ids'], 80223264)) \
        and (hasattr(L['input_ids'], '_dynamo_dynamic_indices') == False) \
