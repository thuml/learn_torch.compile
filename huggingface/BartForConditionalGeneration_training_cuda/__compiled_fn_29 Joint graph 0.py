...
def forward(self, primals, tangents):
    ...
    view_2: "f32[1024, 1024]" = torch.ops.aten.view.default(primals_27, [1024, 1024])
    ...
    view_5: "f32[1024, 1024]" = torch.ops.aten.view.default(primals_27, [1024, 1024])
    ...
    sub_1: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_1, getitem_3)
    ...
    addmm_6: "f32[1024, 1024]" = torch.ops.aten.addmm.default(primals_16, view_23, permute_12);  primals_16 = None
    ...
    sub_3: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_4, getitem_7)
    mul_4: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    mul_5: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_4, primals_19);  mul_4 = None
    ...
    sub_4: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_8, getitem_11)
    mul_9: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_4, rsqrt_2);  sub_4 = None
    mul_10: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_9, primals_25);  mul_9 = None
    add_10: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(mul_10, primals_26);  mul_10 = primals_26 = None
    sub_5: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_8, getitem_11);  add_8 = getitem_11 = None
    mul_11: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_5, rsqrt_2);  sub_5 = None
    ...
    mul_14: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_12, mul_11);  mul_12 = None
    sum_4: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_14, [2], True);  mul_14 = None
    mul_15: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_11, sum_4);  sum_4 = None
    ...
    mul_17: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(tangents_1, mul_11);  mul_11 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_20: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_35, 0.7071067811865476)
    erf_1: "f32[1, 1024, 4096]" = torch.ops.aten.erf.default(mul_20);  mul_20 = None
    add_11: "f32[1, 1024, 4096]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_21: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_11, 0.5);  add_11 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:456, code: hidden_states = self.encoder_attn_layer_norm(hidden_states)
    sub_8: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_4, getitem_7);  add_4 = getitem_7 = None
    mul_27: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_8, rsqrt_1);  sub_8 = None
    ...
    mul_30: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_28, mul_27);  mul_28 = None
    sum_10: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_30, [2], True);  mul_30 = None
    mul_31: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_27, sum_10);  sum_10 = None
    ...
    mul_33: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_13, mul_27);  mul_27 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:436, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_12: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_1, getitem_3);  add_1 = getitem_3 = None
    mul_39: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_12, rsqrt);  sub_12 = None
    ...
    mul_42: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_40, mul_39);  mul_40 = None
    sum_19: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_42, [2], True);  mul_42 = None
    mul_43: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_39, sum_19);  sum_19 = None
    ...
    mul_45: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_15, mul_39);  mul_39 = None
