...
def __guard_0_for_resume_in_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139624459402880)) \
        ...
        and (___check_type_id(L['transformer_outputs'], 158295696)) \
...
def __transformed_code_0_for_resume_in_forward(self, labels, return_dict, transformer_outputs, pooled_logits, loss):
    ...
    graph_out_0 = __compiled_fn_7(pooled_logits, labels)
    import importlib
...
def __resume_at_344_6(self, labels, return_dict, transformer_outputs, pooled_logits, loss):
...
def transformed___resume_at_344_6(self, labels, return_dict, transformer_outputs, pooled_logits, loss):
    ...
    return __resume_at_344_6(self, labels, return_dict, transformer_outputs, pooled_logits, loss)

#============ end of __resume_at_344_6 ============#
...
def __guard_0_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139624459402880)) \
        and (L['self'].training == True) \
        and (___check_type_id(L['labels'], 102290960)) \
        and (hasattr(L['labels'], '_dynamo_dynamic_indices') == False) \
        and (___check_obj_id(L['head_mask'], 7628576)) \
        and (___check_type_id(L['input_ids'], 102290960)) \
        ...
        and (___check_type_id(G['torch'].long, 139626445920000)) \
