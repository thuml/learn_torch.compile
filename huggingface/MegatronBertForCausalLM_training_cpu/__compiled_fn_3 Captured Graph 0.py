...
def forward(self, L_cloned_inputs_labels_ : torch.Tensor, L_cloned_inputs_input_ids_ : torch.Tensor):
    ...
    hidden_states_169 = self.L__mod___cls_predictions_transform_dense(sequence_output);  sequence_output = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    hidden_states_170 = torch._C._nn.gelu(hidden_states_169);  hidden_states_169 = None
    ...
    hidden_states_172 = self.L__mod___cls_predictions_transform_LayerNorm(hidden_states_170);  hidden_states_170 = None
    ...
    prediction_scores = self.L__mod___cls_predictions_decoder(hidden_states_172);  hidden_states_172 = None
    ...
    getitem_3 = l_cloned_inputs_labels_[(slice(None, None, None), slice(1, None, None))];  l_cloned_inputs_labels_ = None
    labels = getitem_3.contiguous();  getitem_3 = None
    ...
    view_96 = shifted_prediction_scores.view(-1, 29056);  shifted_prediction_scores = None
    view_97 = labels.view(-1);  labels = None
