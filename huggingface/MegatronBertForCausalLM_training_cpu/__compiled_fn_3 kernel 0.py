...
cpp_fused_gelu_native_layer_norm_view_170 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(const float* in_ptr0,
                       const float* in_ptr1,
                       const float* in_ptr2,
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(1024L); x1+=static_cast<long>(8L))
                {
                    ...
                    tmp26.store(out_ptr3 + static_cast<long>(x1 + (1024L*x0)));
                }
            }
        }
    }
...
cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_171 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(511L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(29056L); x1+=static_cast<long>(8L))
                {
                    ...
                    auto tmp6 = at::vec::Vectorized<float>(tmp5);
                    auto tmp7 = tmp3 - tmp6;
                    tmp7.store(out_ptr2 + static_cast<long>(x1 + (29056L*x0)));
                }
            }
        }
        #pragma omp single
            ...
            {
                {
                    ...
                    for(long x0=static_cast<long>(0L); x0<static_cast<long>(511L); x0+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp6 = decltype(tmp5)(tmp5 + 29056);
                        auto tmp7 = tmp5 < 0;
                        auto tmp8 = tmp7 ? tmp6 : tmp5;
                        TORCH_CHECK((0 <= tmp8) & (tmp8 < 29056L), "index out of bounds: 0 <= tmp8 < 29056L")
                        auto tmp9 = out_ptr2[static_cast<long>(tmp8 + (29056L*x0))];
...
def call(args):
    ...
    cpp_fused_add_embedding_zeros_0(c_void_p(primals_398.data_ptr()), c_void_p(primals_1.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(primals_396.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()))
    del primals_1
    del primals_2
    del primals_3
    ...
    del buf854
    del primals_389
    buf910 = reinterpret_tensor(buf904, (512, 1024), (1024, 1), 0); del buf904  # reuse
    # Source Nodes: [hidden_states_169], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_391, buf909, reinterpret_tensor(primals_390, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf910)
    del primals_391
    buf911 = buf905; del buf905  # reuse
    buf912 = empty_strided((1, 512, 1), (512, 1, 512), device='cpu', dtype=torch.float32)
    buf914 = buf891; del buf891  # reuse
    buf915 = reinterpret_tensor(buf865, (512, 1024), (1024, 1), 0); del buf865  # reuse
    cpp_fused_gelu_native_layer_norm_view_170(c_void_p(buf910.data_ptr()), c_void_p(primals_392.data_ptr()), c_void_p(primals_393.data_ptr()), c_void_p(buf911.data_ptr()), c_void_p(buf912.data_ptr()), c_void_p(buf914.data_ptr()), c_void_p(buf915.data_ptr()))
    del buf911
    del primals_393
    buf916 = empty((512, 29056), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_395, buf915, reinterpret_tensor(primals_394, (1024, 29056), (1, 1024), 0), alpha=1, beta=1, out=buf916)
    del primals_395
    buf917 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf918 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf919 = empty((511, 29056), device='cpu', dtype=torch.float32)
    buf920 = empty((), device='cpu', dtype=torch.int64)
    buf922 = empty((), device='cpu', dtype=torch.float32)
    buf921 = empty((), device='cpu', dtype=torch.float32)
    buf975 = buf922; del buf922  # reuse
    buf923 = empty((511, 1), device='cpu', dtype=torch.bool)
    buf924 = empty((511, 1), device='cpu', dtype=torch.int64)
    buf925 = reinterpret_tensor(buf912, (1, 512, 1), (512, 1, 1), 0); del buf912  # reuse
    buf926 = reinterpret_tensor(buf906, (1, 512, 1), (512, 1, 1), 0); del buf906  # reuse
    buf927 = reinterpret_tensor(buf894, (1, 512, 1), (512, 1, 1), 0); del buf894  # reuse
    buf928 = reinterpret_tensor(buf868, (1, 512, 1), (512, 1, 1), 0); del buf868  # reuse
    buf929 = reinterpret_tensor(buf857, (1, 512, 1), (512, 1, 1), 0); del buf857  # reuse
    buf930 = reinterpret_tensor(buf831, (1, 512, 1), (512, 1, 1), 0); del buf831  # reuse
    buf931 = reinterpret_tensor(buf819, (1, 512, 1), (512, 1, 1), 0); del buf819  # reuse
    buf932 = reinterpret_tensor(buf793, (1, 512, 1), (512, 1, 1), 0); del buf793  # reuse
    buf933 = reinterpret_tensor(buf782, (1, 512, 1), (512, 1, 1), 0); del buf782  # reuse
    buf934 = reinterpret_tensor(buf756, (1, 512, 1), (512, 1, 1), 0); del buf756  # reuse
    buf935 = reinterpret_tensor(buf744, (1, 512, 1), (512, 1, 1), 0); del buf744  # reuse
    buf936 = reinterpret_tensor(buf718, (1, 512, 1), (512, 1, 1), 0); del buf718  # reuse
    buf937 = reinterpret_tensor(buf707, (1, 512, 1), (512, 1, 1), 0); del buf707  # reuse
    buf938 = reinterpret_tensor(buf681, (1, 512, 1), (512, 1, 1), 0); del buf681  # reuse
    buf939 = reinterpret_tensor(buf669, (1, 512, 1), (512, 1, 1), 0); del buf669  # reuse
    buf940 = reinterpret_tensor(buf643, (1, 512, 1), (512, 1, 1), 0); del buf643  # reuse
    buf941 = reinterpret_tensor(buf632, (1, 512, 1), (512, 1, 1), 0); del buf632  # reuse
    buf942 = reinterpret_tensor(buf606, (1, 512, 1), (512, 1, 1), 0); del buf606  # reuse
    buf943 = reinterpret_tensor(buf594, (1, 512, 1), (512, 1, 1), 0); del buf594  # reuse
    buf944 = reinterpret_tensor(buf568, (1, 512, 1), (512, 1, 1), 0); del buf568  # reuse
    buf945 = reinterpret_tensor(buf557, (1, 512, 1), (512, 1, 1), 0); del buf557  # reuse
    buf946 = reinterpret_tensor(buf531, (1, 512, 1), (512, 1, 1), 0); del buf531  # reuse
    buf947 = reinterpret_tensor(buf519, (1, 512, 1), (512, 1, 1), 0); del buf519  # reuse
    buf948 = reinterpret_tensor(buf493, (1, 512, 1), (512, 1, 1), 0); del buf493  # reuse
    buf949 = reinterpret_tensor(buf482, (1, 512, 1), (512, 1, 1), 0); del buf482  # reuse
    buf950 = reinterpret_tensor(buf456, (1, 512, 1), (512, 1, 1), 0); del buf456  # reuse
    buf951 = reinterpret_tensor(buf444, (1, 512, 1), (512, 1, 1), 0); del buf444  # reuse
    buf952 = reinterpret_tensor(buf418, (1, 512, 1), (512, 1, 1), 0); del buf418  # reuse
    buf953 = reinterpret_tensor(buf407, (1, 512, 1), (512, 1, 1), 0); del buf407  # reuse
    buf954 = reinterpret_tensor(buf381, (1, 512, 1), (512, 1, 1), 0); del buf381  # reuse
    buf955 = reinterpret_tensor(buf369, (1, 512, 1), (512, 1, 1), 0); del buf369  # reuse
    buf956 = reinterpret_tensor(buf343, (1, 512, 1), (512, 1, 1), 0); del buf343  # reuse
    buf957 = reinterpret_tensor(buf332, (1, 512, 1), (512, 1, 1), 0); del buf332  # reuse
    buf958 = reinterpret_tensor(buf306, (1, 512, 1), (512, 1, 1), 0); del buf306  # reuse
    buf959 = reinterpret_tensor(buf294, (1, 512, 1), (512, 1, 1), 0); del buf294  # reuse
    buf960 = reinterpret_tensor(buf268, (1, 512, 1), (512, 1, 1), 0); del buf268  # reuse
    buf961 = reinterpret_tensor(buf257, (1, 512, 1), (512, 1, 1), 0); del buf257  # reuse
    buf962 = reinterpret_tensor(buf231, (1, 512, 1), (512, 1, 1), 0); del buf231  # reuse
    buf963 = reinterpret_tensor(buf219, (1, 512, 1), (512, 1, 1), 0); del buf219  # reuse
    buf964 = reinterpret_tensor(buf193, (1, 512, 1), (512, 1, 1), 0); del buf193  # reuse
    buf965 = reinterpret_tensor(buf182, (1, 512, 1), (512, 1, 1), 0); del buf182  # reuse
    buf966 = reinterpret_tensor(buf156, (1, 512, 1), (512, 1, 1), 0); del buf156  # reuse
    buf967 = reinterpret_tensor(buf144, (1, 512, 1), (512, 1, 1), 0); del buf144  # reuse
    buf968 = reinterpret_tensor(buf118, (1, 512, 1), (512, 1, 1), 0); del buf118  # reuse
    buf969 = reinterpret_tensor(buf107, (1, 512, 1), (512, 1, 1), 0); del buf107  # reuse
    buf970 = reinterpret_tensor(buf81, (1, 512, 1), (512, 1, 1), 0); del buf81  # reuse
    buf971 = reinterpret_tensor(buf69, (1, 512, 1), (512, 1, 1), 0); del buf69  # reuse
    buf972 = reinterpret_tensor(buf43, (1, 512, 1), (512, 1, 1), 0); del buf43  # reuse
    buf973 = reinterpret_tensor(buf32, (1, 512, 1), (512, 1, 1), 0); del buf32  # reuse
    buf974 = reinterpret_tensor(buf6, (1, 512, 1), (512, 1, 1), 0); del buf6  # reuse
    cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_171(c_void_p(buf975.data_ptr()), c_void_p(buf925.data_ptr()), c_void_p(buf926.data_ptr()), c_void_p(buf927.data_ptr()), c_void_p(buf928.data_ptr()), c_void_p(buf929.data_ptr()), c_void_p(buf930.data_ptr()), c_void_p(buf931.data_ptr()), c_void_p(buf932.data_ptr()), c_void_p(buf933.data_ptr()), c_void_p(buf934.data_ptr()), c_void_p(buf935.data_ptr()), c_void_p(buf936.data_ptr()), c_void_p(buf937.data_ptr()), c_void_p(buf938.data_ptr()), c_void_p(buf939.data_ptr()), c_void_p(buf940.data_ptr()), c_void_p(buf941.data_ptr()), c_void_p(buf942.data_ptr()), c_void_p(buf943.data_ptr()), c_void_p(buf944.data_ptr()), c_void_p(buf945.data_ptr()), c_void_p(buf946.data_ptr()), c_void_p(buf947.data_ptr()), c_void_p(buf948.data_ptr()), c_void_p(buf949.data_ptr()), c_void_p(buf950.data_ptr()), c_void_p(buf951.data_ptr()), c_void_p(buf952.data_ptr()), c_void_p(buf953.data_ptr()), c_void_p(buf954.data_ptr()), c_void_p(buf955.data_ptr()), c_void_p(buf956.data_ptr()), c_void_p(buf957.data_ptr()), c_void_p(buf958.data_ptr()), c_void_p(buf959.data_ptr()), c_void_p(buf960.data_ptr()), c_void_p(buf961.data_ptr()), c_void_p(buf962.data_ptr()), c_void_p(buf963.data_ptr()), c_void_p(buf964.data_ptr()), c_void_p(buf965.data_ptr()), c_void_p(buf966.data_ptr()), c_void_p(buf967.data_ptr()), c_void_p(buf968.data_ptr()), c_void_p(buf969.data_ptr()), c_void_p(buf970.data_ptr()), c_void_p(buf971.data_ptr()), c_void_p(buf972.data_ptr()), c_void_p(buf973.data_ptr()), c_void_p(buf974.data_ptr()), c_void_p(buf916.data_ptr()), c_void_p(primals_397.data_ptr()), c_void_p(buf917.data_ptr()), c_void_p(buf918.data_ptr()), c_void_p(buf919.data_ptr()), c_void_p(buf920.data_ptr()), c_void_p(buf921.data_ptr()), c_void_p(buf923.data_ptr()), c_void_p(buf924.data_ptr()))
    del buf917
    del buf918
    del buf920
    del primals_397
    return (buf975, reinterpret_tensor(buf916, (1, 512, 29056), (14876672, 29056, 1), 0), primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_206, primals_212, primals_222, primals_228, primals_238, primals_244, primals_254, primals_260, primals_270, primals_276, primals_286, primals_292, primals_302, primals_308, primals_318, primals_324, primals_334, primals_340, primals_350, primals_356, primals_366, primals_372, primals_382, primals_388, primals_392, primals_398, buf0, primals_396, buf4, buf8, buf9, buf22, reinterpret_tensor(buf21, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf23, (16, 64, 512), (32768, 1, 64), 0), buf19, reinterpret_tensor(buf13, (16, 64, 512), (32768, 1, 64), 0), buf25, buf26, buf30, buf34, buf35, buf36, buf37, buf41, buf45, buf46, buf59, reinterpret_tensor(buf58, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf60, (16, 64, 512), (32768, 1, 64), 0), buf56, reinterpret_tensor(buf50, (16, 64, 512), (32768, 1, 64), 0), buf62, buf63, buf67, buf71, buf72, buf73, buf74, buf78, buf83, buf84, buf97, reinterpret_tensor(buf96, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf98, (16, 64, 512), (32768, 1, 64), 0), buf94, reinterpret_tensor(buf88, (16, 64, 512), (32768, 1, 64), 0), buf100, buf101, buf105, buf109, buf110, buf111, buf112, buf116, buf120, buf121, buf134, reinterpret_tensor(buf133, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf135, (16, 64, 512), (32768, 1, 64), 0), buf131, reinterpret_tensor(buf125, (16, 64, 512), (32768, 1, 64), 0), buf137, buf138, buf142, buf146, buf147, buf148, buf149, buf153, buf158, buf159, buf172, reinterpret_tensor(buf171, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf173, (16, 64, 512), (32768, 1, 64), 0), buf169, reinterpret_tensor(buf163, (16, 64, 512), (32768, 1, 64), 0), buf175, buf176, buf180, buf184, buf185, buf186, buf187, buf191, buf195, buf196, buf209, reinterpret_tensor(buf208, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf210, (16, 64, 512), (32768, 1, 64), 0), buf206, reinterpret_tensor(buf200, (16, 64, 512), (32768, 1, 64), 0), buf212, buf213, buf217, buf221, buf222, buf223, buf224, buf228, buf233, buf234, buf247, reinterpret_tensor(buf246, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf248, (16, 64, 512), (32768, 1, 64), 0), buf244, reinterpret_tensor(buf238, (16, 64, 512), (32768, 1, 64), 0), buf250, buf251, buf255, buf259, buf260, buf261, buf262, buf266, buf270, buf271, buf284, reinterpret_tensor(buf283, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf285, (16, 64, 512), (32768, 1, 64), 0), buf281, reinterpret_tensor(buf275, (16, 64, 512), (32768, 1, 64), 0), buf287, buf288, buf292, buf296, buf297, buf298, buf299, buf303, buf308, buf309, buf322, reinterpret_tensor(buf321, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf323, (16, 64, 512), (32768, 1, 64), 0), buf319, reinterpret_tensor(buf313, (16, 64, 512), (32768, 1, 64), 0), buf325, buf326, buf330, buf334, buf335, buf336, buf337, buf341, buf345, buf346, buf359, reinterpret_tensor(buf358, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf360, (16, 64, 512), (32768, 1, 64), 0), buf356, reinterpret_tensor(buf350, (16, 64, 512), (32768, 1, 64), 0), buf362, buf363, buf367, buf371, buf372, buf373, buf374, buf378, buf383, buf384, buf397, reinterpret_tensor(buf396, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf398, (16, 64, 512), (32768, 1, 64), 0), buf394, reinterpret_tensor(buf388, (16, 64, 512), (32768, 1, 64), 0), buf400, buf401, buf405, buf409, buf410, buf411, buf412, buf416, buf420, buf421, buf434, reinterpret_tensor(buf433, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf435, (16, 64, 512), (32768, 1, 64), 0), buf431, reinterpret_tensor(buf425, (16, 64, 512), (32768, 1, 64), 0), buf437, buf438, buf442, buf446, buf447, buf448, buf449, buf453, buf458, buf459, buf472, reinterpret_tensor(buf471, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf473, (16, 64, 512), (32768, 1, 64), 0), buf469, reinterpret_tensor(buf463, (16, 64, 512), (32768, 1, 64), 0), buf475, buf476, buf480, buf484, buf485, buf486, buf487, buf491, buf495, buf496, buf509, reinterpret_tensor(buf508, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf510, (16, 64, 512), (32768, 1, 64), 0), buf506, reinterpret_tensor(buf500, (16, 64, 512), (32768, 1, 64), 0), buf512, buf513, buf517, buf521, buf522, buf523, buf524, buf528, buf533, buf534, buf547, reinterpret_tensor(buf546, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf548, (16, 64, 512), (32768, 1, 64), 0), buf544, reinterpret_tensor(buf538, (16, 64, 512), (32768, 1, 64), 0), buf550, buf551, buf555, buf559, buf560, buf561, buf562, buf566, buf570, buf571, buf584, reinterpret_tensor(buf583, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf585, (16, 64, 512), (32768, 1, 64), 0), buf581, reinterpret_tensor(buf575, (16, 64, 512), (32768, 1, 64), 0), buf587, buf588, buf592, buf596, buf597, buf598, buf599, buf603, buf608, buf609, buf622, reinterpret_tensor(buf621, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf623, (16, 64, 512), (32768, 1, 64), 0), buf619, reinterpret_tensor(buf613, (16, 64, 512), (32768, 1, 64), 0), buf625, buf626, buf630, buf634, buf635, buf636, buf637, buf641, buf645, buf646, buf659, reinterpret_tensor(buf658, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf660, (16, 64, 512), (32768, 1, 64), 0), buf656, reinterpret_tensor(buf650, (16, 64, 512), (32768, 1, 64), 0), buf662, buf663, buf667, buf671, buf672, buf673, buf674, buf678, buf683, buf684, buf697, reinterpret_tensor(buf696, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf698, (16, 64, 512), (32768, 1, 64), 0), buf694, reinterpret_tensor(buf688, (16, 64, 512), (32768, 1, 64), 0), buf700, buf701, buf705, buf709, buf710, buf711, buf712, buf716, buf720, buf721, buf734, reinterpret_tensor(buf733, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf735, (16, 64, 512), (32768, 1, 64), 0), buf731, reinterpret_tensor(buf725, (16, 64, 512), (32768, 1, 64), 0), buf737, buf738, buf742, buf746, buf747, buf748, buf749, buf753, buf758, buf759, buf772, reinterpret_tensor(buf771, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf773, (16, 64, 512), (32768, 1, 64), 0), buf769, reinterpret_tensor(buf763, (16, 64, 512), (32768, 1, 64), 0), buf775, buf776, buf780, buf784, buf785, buf786, buf787, buf791, buf795, buf796, buf809, reinterpret_tensor(buf808, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf810, (16, 64, 512), (32768, 1, 64), 0), buf806, reinterpret_tensor(buf800, (16, 64, 512), (32768, 1, 64), 0), buf812, buf813, buf817, buf821, buf822, buf823, buf824, buf828, buf833, buf834, buf847, reinterpret_tensor(buf846, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf848, (16, 64, 512), (32768, 1, 64), 0), buf844, reinterpret_tensor(buf838, (16, 64, 512), (32768, 1, 64), 0), buf850, buf851, buf855, buf859, buf860, buf861, buf862, buf866, buf870, buf871, buf884, reinterpret_tensor(buf883, (16, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf885, (16, 64, 512), (32768, 1, 64), 0), buf881, reinterpret_tensor(buf875, (16, 64, 512), (32768, 1, 64), 0), buf887, buf888, buf892, buf896, buf897, buf898, buf899, buf903, buf908, buf909, buf910, buf914, buf915, buf919, buf921, buf923, buf924, reinterpret_tensor(primals_394, (29056, 1024), (1024, 1), 0), buf925, reinterpret_tensor(primals_390, (1024, 1024), (1024, 1), 0), buf926, reinterpret_tensor(primals_386, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_384, (4096, 1024), (1024, 1), 0), buf927, reinterpret_tensor(primals_380, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_378, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_376, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_374, (1024, 1024), (1024, 1), 0), buf928, reinterpret_tensor(primals_370, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_368, (4096, 1024), (1024, 1), 0), buf929, reinterpret_tensor(primals_364, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_362, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_360, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_358, (1024, 1024), (1024, 1), 0), buf930, reinterpret_tensor(primals_354, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_352, (4096, 1024), (1024, 1), 0), buf931, reinterpret_tensor(primals_348, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_346, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_344, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_342, (1024, 1024), (1024, 1), 0), buf932, reinterpret_tensor(primals_338, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_336, (4096, 1024), (1024, 1), 0), buf933, reinterpret_tensor(primals_332, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_330, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_328, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_326, (1024, 1024), (1024, 1), 0), buf934, reinterpret_tensor(primals_322, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_320, (4096, 1024), (1024, 1), 0), buf935, reinterpret_tensor(primals_316, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_314, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_312, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_310, (1024, 1024), (1024, 1), 0), buf936, reinterpret_tensor(primals_306, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_304, (4096, 1024), (1024, 1), 0), buf937, reinterpret_tensor(primals_300, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_298, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_296, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_294, (1024, 1024), (1024, 1), 0), buf938, reinterpret_tensor(primals_290, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_288, (4096, 1024), (1024, 1), 0), buf939, reinterpret_tensor(primals_284, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_282, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_280, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_278, (1024, 1024), (1024, 1), 0), buf940, reinterpret_tensor(primals_274, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_272, (4096, 1024), (1024, 1), 0), buf941, reinterpret_tensor(primals_268, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_266, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_264, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_262, (1024, 1024), (1024, 1), 0), buf942, reinterpret_tensor(primals_258, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_256, (4096, 1024), (1024, 1), 0), buf943, reinterpret_tensor(primals_252, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_250, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_248, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_246, (1024, 1024), (1024, 1), 0), buf944, reinterpret_tensor(primals_242, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_240, (4096, 1024), (1024, 1), 0), buf945, reinterpret_tensor(primals_236, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_234, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_232, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_230, (1024, 1024), (1024, 1), 0), buf946, reinterpret_tensor(primals_226, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_224, (4096, 1024), (1024, 1), 0), buf947, reinterpret_tensor(primals_220, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_218, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_216, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_214, (1024, 1024), (1024, 1), 0), buf948, reinterpret_tensor(primals_210, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_208, (4096, 1024), (1024, 1), 0), buf949, reinterpret_tensor(primals_204, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_202, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_200, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_198, (1024, 1024), (1024, 1), 0), buf950, reinterpret_tensor(primals_194, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_192, (4096, 1024), (1024, 1), 0), buf951, reinterpret_tensor(primals_188, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_186, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_184, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_182, (1024, 1024), (1024, 1), 0), buf952, reinterpret_tensor(primals_178, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_176, (4096, 1024), (1024, 1), 0), buf953, reinterpret_tensor(primals_172, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_170, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_168, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_166, (1024, 1024), (1024, 1), 0), buf954, reinterpret_tensor(primals_162, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_160, (4096, 1024), (1024, 1), 0), buf955, reinterpret_tensor(primals_156, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_154, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_152, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_150, (1024, 1024), (1024, 1), 0), buf956, reinterpret_tensor(primals_146, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_144, (4096, 1024), (1024, 1), 0), buf957, reinterpret_tensor(primals_140, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_138, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_136, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_134, (1024, 1024), (1024, 1), 0), buf958, reinterpret_tensor(primals_130, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_128, (4096, 1024), (1024, 1), 0), buf959, reinterpret_tensor(primals_124, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_122, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_120, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_118, (1024, 1024), (1024, 1), 0), buf960, reinterpret_tensor(primals_114, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_112, (4096, 1024), (1024, 1), 0), buf961, reinterpret_tensor(primals_108, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_106, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_104, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_102, (1024, 1024), (1024, 1), 0), buf962, reinterpret_tensor(primals_98, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_96, (4096, 1024), (1024, 1), 0), buf963, reinterpret_tensor(primals_92, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_90, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_88, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_86, (1024, 1024), (1024, 1), 0), buf964, reinterpret_tensor(primals_82, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_80, (4096, 1024), (1024, 1), 0), buf965, reinterpret_tensor(primals_76, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_74, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_72, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_70, (1024, 1024), (1024, 1), 0), buf966, reinterpret_tensor(primals_66, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_64, (4096, 1024), (1024, 1), 0), buf967, reinterpret_tensor(primals_60, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_58, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_56, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_54, (1024, 1024), (1024, 1), 0), buf968, reinterpret_tensor(primals_50, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_48, (4096, 1024), (1024, 1), 0), buf969, reinterpret_tensor(primals_44, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_42, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_40, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_38, (1024, 1024), (1024, 1), 0), buf970, reinterpret_tensor(primals_34, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_32, (4096, 1024), (1024, 1), 0), buf971, reinterpret_tensor(primals_28, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_26, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_24, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_22, (1024, 1024), (1024, 1), 0), buf972, reinterpret_tensor(primals_18, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_16, (4096, 1024), (1024, 1), 0), buf973, reinterpret_tensor(primals_12, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_10, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_8, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_6, (1024, 1024), (1024, 1), 0), buf974, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_390 = rand_strided((1024, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    primals_391 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
    ...
    primals_394 = rand_strided((29056, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    primals_395 = rand_strided((29056, ), (1, ), device='cpu', dtype=torch.float32)
    primals_396 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_397 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
