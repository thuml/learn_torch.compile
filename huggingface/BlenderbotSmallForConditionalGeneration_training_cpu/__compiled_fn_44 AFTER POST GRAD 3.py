...
def forward(self, primals_9: "f32[512]", primals_15: "f32[512]", view: "f32[128, 512]", bmm: "f32[16, 128, 128]", amax: "f32[16, 128, 1]", sum_1: "f32[16, 128, 1]", view_14: "f32[128, 512]", getitem_1: "b8[1, 128, 512]", mul_1: "f32[1, 128, 512]", view_16: "f32[128, 512]", addmm_4: "f32[128, 2048]", view_18: "f32[128, 2048]", getitem_5: "b8[1, 128, 512]", mul_6: "f32[1, 128, 512]", div_1: "f32[1, 128, 1]", permute_11: "f32[512, 2048]", permute_15: "f32[2048, 512]", div_2: "f32[1, 128, 1]", permute_19: "f32[512, 512]", permute_24: "f32[16, 128, 128]", permute_25: "f32[16, 32, 128]", permute_26: "f32[16, 32, 128]", permute_27: "f32[16, 128, 32]", permute_31: "f32[512, 512]", permute_36: "f32[512, 512]", permute_40: "f32[512, 512]", tangents_1: "f32[1, 128, 512]"):
    ...
    view_17: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 2048]);  addmm_4 = None
    ...
    view_20: "f32[128, 512]" = torch.ops.aten.reshape.default(mul_16, [128, 512]);  mul_16 = None
    ...
    view_21: "f32[512]" = torch.ops.aten.reshape.default(sum_6, [512]);  sum_6 = None
    permute_14: "f32[512, 2048]" = torch.ops.aten.permute.default(permute_13, [1, 0]);  permute_13 = None
    view_22: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(mm, [1, 128, 2048]);  mm = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:328, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[128, 2048]" = torch.ops.aten.reshape.default(mul_23, [128, 2048]);  mul_23 = None
    ...
    view_24: "f32[2048]" = torch.ops.aten.reshape.default(sum_7, [2048]);  sum_7 = None
    permute_18: "f32[2048, 512]" = torch.ops.aten.permute.default(permute_17, [1, 0]);  permute_17 = None
    view_25: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 512]);  mm_2 = None
    ...
    view_26: "f32[128, 512]" = torch.ops.aten.reshape.default(mul_32, [128, 512]);  mul_32 = None
    ...
    view_27: "f32[512]" = torch.ops.aten.reshape.default(sum_12, [512]);  sum_12 = None
    permute_22: "f32[512, 512]" = torch.ops.aten.permute.default(permute_21, [1, 0]);  permute_21 = None
    view_28: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_4, [1, 128, 512]);  mm_4 = None
    ...
    view_29: "f32[1, 128, 16, 32]" = torch.ops.aten.reshape.default(view_28, [1, 128, 16, 32]);  view_28 = None
    ...
    view_30: "f32[16, 128, 32]" = torch.ops.aten.reshape.default(permute_23, [16, 128, 32]);  permute_23 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:237, code: attn_weights = nn.functional.softmax(attn_weights, dim=-1)
    mul_33: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(bmm_3, div);  bmm_3 = None
    sum_13: "f32[16, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_33, [-1], True)
    mul_34: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(div, sum_13);  div = sum_13 = None
    ...
    view_31: "f32[1, 16, 128, 32]" = torch.ops.aten.reshape.default(bmm_2, [1, 16, 128, 32]);  bmm_2 = None
    ...
    view_32: "f32[1, 16, 128, 32]" = torch.ops.aten.reshape.default(permute_28, [1, 16, 128, 32]);  permute_28 = None
    ...
    view_33: "f32[1, 16, 128, 32]" = torch.ops.aten.reshape.default(bmm_5, [1, 16, 128, 32]);  bmm_5 = None
    ...
    view_34: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(clone_8, [1, 128, 512]);  clone_8 = None
    ...
    view_35: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 512]);  clone_9 = None
    ...
    view_36: "f32[128, 512]" = torch.ops.aten.reshape.default(view_35, [128, 512]);  view_35 = None
    ...
    view_37: "f32[512]" = torch.ops.aten.reshape.default(sum_14, [512]);  sum_14 = None
    permute_34: "f32[512, 512]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_38: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 512]);  mm_6 = None
    ...
    view_39: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(permute_35, [1, 128, 512]);  permute_35 = None
    ...
    view_41: "f32[512]" = torch.ops.aten.reshape.default(sum_15, [512]);  sum_15 = None
    permute_39: "f32[512, 512]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_42: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 512]);  mm_8 = None
    ...
    view_43: "f32[128, 512]" = torch.ops.aten.reshape.default(mul_35, [128, 512]);  mul_35 = None
    ...
    view_44: "f32[512]" = torch.ops.aten.reshape.default(sum_16, [512]);  sum_16 = None
    permute_43: "f32[512, 512]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_45: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 512]);  mm_10 = None
