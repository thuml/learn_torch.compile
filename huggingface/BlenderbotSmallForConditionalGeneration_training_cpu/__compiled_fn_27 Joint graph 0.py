...
def forward(self, primals, tangents):
    primals_1: "f32[512, 512]"; primals_2: "f32[512]"; primals_3: "f32[512, 512]"; primals_4: "f32[512]"; primals_5: "f32[512, 512]"; primals_6: "f32[512]"; primals_7: "f32[512, 512]"; primals_8: "f32[512]"; primals_9: "f32[512]"; primals_10: "f32[512]"; primals_11: "f32[512, 512]"; primals_12: "f32[512]"; primals_13: "f32[512, 512]"; primals_14: "f32[512]"; primals_15: "f32[512, 512]"; primals_16: "f32[512]"; primals_17: "f32[512, 512]"; primals_18: "f32[512]"; primals_19: "f32[512]"; primals_20: "f32[512]"; primals_21: "f32[2048, 512]"; primals_22: "f32[2048]"; primals_23: "f32[512, 2048]"; primals_24: "f32[512]"; primals_25: "f32[512]"; primals_26: "f32[512]"; primals_27: "f32[1, 128, 512]"; primals_28: "f32[1, 1, 128, 128]"; primals_29: "f32[1, 128, 512]"; tangents_1: "f32[1, 128, 512]"; 
    ...
    view: "f32[128, 512]" = torch.ops.aten.view.default(primals_27, [128, 512])
    permute: "f32[512, 512]" = torch.ops.aten.permute.default(primals_1, [1, 0]);  primals_1 = None
    addmm: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_2, view, permute);  primals_2 = None
    ...
    view_2: "f32[128, 512]" = torch.ops.aten.view.default(primals_27, [128, 512])
    permute_1: "f32[512, 512]" = torch.ops.aten.permute.default(primals_3, [1, 0]);  primals_3 = None
    addmm_1: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_4, view_2, permute_1);  primals_4 = None
    view_3: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_1, [1, 128, 512]);  addmm_1 = None
    ...
    view_4: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(view_3, [1, -1, 16, 32]);  view_3 = None
    ...
    view_5: "f32[128, 512]" = torch.ops.aten.view.default(primals_27, [128, 512])
    permute_3: "f32[512, 512]" = torch.ops.aten.permute.default(primals_5, [1, 0]);  primals_5 = None
    addmm_2: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_6, view_5, permute_3);  primals_6 = None
    view_6: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_2, [1, 128, 512]);  addmm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:157, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_7: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(view_6, [1, -1, 16, 32]);  view_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:157, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_8: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(mul, [1, 128, 16, 32]);  mul = None
    ...
    view_9: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone_2, [16, -1, 32]);  clone_2 = None
    ...
    view_10: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone, [16, -1, 32]);  clone = None
    ...
    view_13: "f32[16, 128, 128]" = torch.ops.aten.view.default(add, [16, 128, 128]);  add = None
    ...
    view_14: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_1, [1, 16, 128, 32]);  bmm_1 = None
    ...
    view_15: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_4, [1, 128, 512]);  clone_4 = None
    ...
    view_16: "f32[128, 512]" = torch.ops.aten.view.default(view_15, [128, 512]);  view_15 = None
    ...
    view_17: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_3, [1, 128, 512]);  addmm_3 = None
    ...
    sub_1: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_1, getitem_3)
    mul_1: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_1, rsqrt);  sub_1 = None
    mul_2: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_1, primals_9);  mul_1 = None
    add_3: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(mul_2, primals_10);  mul_2 = primals_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:177, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_18: "f32[128, 512]" = torch.ops.aten.view.default(add_3, [128, 512])
    permute_9: "f32[512, 512]" = torch.ops.aten.permute.default(primals_11, [1, 0]);  primals_11 = None
    addmm_4: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_12, view_18, permute_9);  primals_12 = None
    view_19: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_4, [1, 128, 512]);  addmm_4 = None
    ...
    view_20: "f32[128, 512]" = torch.ops.aten.view.default(primals_29, [128, 512])
    permute_10: "f32[512, 512]" = torch.ops.aten.permute.default(primals_13, [1, 0]);  primals_13 = None
    addmm_5: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_14, view_20, permute_10);  primals_14 = None
    view_21: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_5, [1, 128, 512]);  addmm_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:157, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_22: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(view_21, [1, -1, 16, 32]);  view_21 = None
    ...
    view_23: "f32[128, 512]" = torch.ops.aten.view.default(primals_29, [128, 512]);  primals_29 = None
    permute_12: "f32[512, 512]" = torch.ops.aten.permute.default(primals_15, [1, 0]);  primals_15 = None
    addmm_6: "f32[128, 512]" = torch.ops.aten.addmm.default(primals_16, view_23, permute_12);  primals_16 = None
    view_24: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_6, [1, 128, 512]);  addmm_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:157, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(mul_3, [1, 128, 16, 32]);  mul_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:216, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_27: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone_7, [16, -1, 32]);  clone_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:217, code: key_states = key_states.reshape(*proj_shape)
    view_28: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone_5, [16, -1, 32]);  clone_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:218, code: value_states = value_states.reshape(*proj_shape)
    view_29: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone_6, [16, -1, 32]);  clone_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:260, code: attn_output = torch.bmm(attn_probs, value_states)
    bmm_3: "f32[16, 128, 32]" = torch.ops.aten.bmm.default(clone_8, view_29)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:268, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_3, [1, 16, 128, 32]);  bmm_3 = None
    ...
    view_31: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_9, [1, 128, 512]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:275, code: attn_output = self.out_proj(attn_output)
    view_32: "f32[128, 512]" = torch.ops.aten.view.default(view_31, [128, 512]);  view_31 = None
    ...
    view_33: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_7, [1, 128, 512]);  addmm_7 = None
    ...
    sub_3: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_4, getitem_7)
    mul_4: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    mul_5: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_4, primals_19);  mul_4 = None
    ...
    view_34: "f32[128, 512]" = torch.ops.aten.view.default(add_6, [128, 512])
    ...
    view_35: "f32[1, 128, 2048]" = torch.ops.aten.view.default(addmm_8, [1, 128, 2048]);  addmm_8 = None
    ...
    clone_10: "f32[1, 128, 2048]" = torch.ops.aten.clone.default(mul_8);  mul_8 = None
    ...
    view_36: "f32[128, 2048]" = torch.ops.aten.view.default(clone_10, [128, 2048]);  clone_10 = None
    ...
    view_37: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_9, [1, 128, 512]);  addmm_9 = None
    ...
    sub_4: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_8, getitem_11)
    mul_9: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_4, rsqrt_2);  sub_4 = None
    mul_10: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_9, primals_25);  mul_9 = None
    add_10: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(mul_10, primals_26);  mul_10 = primals_26 = None
    sub_5: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_8, getitem_11);  add_8 = getitem_11 = None
    mul_11: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_5, rsqrt_2);  sub_5 = None
    ...
    mul_14: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_12, mul_11);  mul_12 = None
    sum_4: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_14, [2], True);  mul_14 = None
    mul_15: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_11, sum_4);  sum_4 = None
    ...
    mul_17: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(tangents_1, mul_11);  mul_11 = None
    ...
    clone_11: "f32[1, 128, 512]" = torch.ops.aten.clone.default(mul_19, memory_format = torch.contiguous_format);  mul_19 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:451, code: hidden_states = self.fc2(hidden_states)
    view_38: "f32[128, 512]" = torch.ops.aten.view.default(clone_11, [128, 512]);  clone_11 = None
    ...
    view_39: "f32[512]" = torch.ops.aten.view.default(sum_7, [512]);  sum_7 = None
    permute_23: "f32[512, 2048]" = torch.ops.aten.permute.default(permute_22, [1, 0]);  permute_22 = None
    view_40: "f32[1, 128, 2048]" = torch.ops.aten.view.default(mm, [1, 128, 2048]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_20: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_35, 0.7071067811865476)
    erf_1: "f32[1, 128, 2048]" = torch.ops.aten.erf.default(mul_20);  mul_20 = None
    add_11: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_21: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(add_11, 0.5);  add_11 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:449, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_41: "f32[128, 2048]" = torch.ops.aten.view.default(mul_26, [128, 2048]);  mul_26 = None
    ...
    view_42: "f32[2048]" = torch.ops.aten.view.default(sum_8, [2048]);  sum_8 = None
    permute_27: "f32[2048, 512]" = torch.ops.aten.permute.default(permute_26, [1, 0]);  permute_26 = None
    view_43: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_2, [1, 128, 512]);  mm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:449, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    add_13: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(mul_16, view_43);  mul_16 = view_43 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:442, code: hidden_states = self.encoder_attn_layer_norm(hidden_states)
    sub_8: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_4, getitem_7);  add_4 = getitem_7 = None
    mul_27: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_8, rsqrt_1);  sub_8 = None
    ...
    mul_30: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_28, mul_27);  mul_28 = None
    sum_10: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_30, [2], True);  mul_30 = None
    mul_31: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_27, sum_10);  sum_10 = None
    ...
    mul_33: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(add_13, mul_27);  mul_27 = None
    ...
    clone_12: "f32[1, 128, 512]" = torch.ops.aten.clone.default(mul_35, memory_format = torch.contiguous_format);  mul_35 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:275, code: attn_output = self.out_proj(attn_output)
    view_44: "f32[128, 512]" = torch.ops.aten.view.default(clone_12, [128, 512]);  clone_12 = None
    ...
    view_45: "f32[512]" = torch.ops.aten.view.default(sum_13, [512]);  sum_13 = None
    permute_31: "f32[512, 512]" = torch.ops.aten.permute.default(permute_30, [1, 0]);  permute_30 = None
    view_46: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_4, [1, 128, 512]);  mm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:273, code: attn_output = attn_output.reshape(bsz, tgt_len, self.embed_dim)
    view_47: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(view_46, [1, 128, 16, 32]);  view_46 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:269, code: attn_output = attn_output.transpose(1, 2)
    permute_32: "f32[1, 16, 128, 32]" = torch.ops.aten.permute.default(view_47, [0, 2, 1, 3]);  view_47 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:268, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_48: "f32[16, 128, 32]" = torch.ops.aten.view.default(permute_32, [16, 128, 32]);  permute_32 = None
    ...
    mul_36: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(bmm_5, alias_2);  bmm_5 = None
    sum_14: "f32[16, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_36, [-1], True)
    mul_37: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(alias_2, sum_14);  alias_2 = sum_14 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:218, code: value_states = value_states.reshape(*proj_shape)
    view_49: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_4, [1, 16, 128, 32]);  bmm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:217, code: key_states = key_states.reshape(*proj_shape)
    view_50: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(permute_37, [1, 16, 128, 32]);  permute_37 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:216, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_51: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_7, [1, 16, 128, 32]);  bmm_7 = None
    ...
    view_52: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_13, [1, 128, 512]);  clone_13 = None
    ...
    view_53: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_14, [1, 128, 512]);  clone_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:193, code: value_states = self._shape(self.v_proj(key_value_states), -1, bsz)
    view_54: "f32[128, 512]" = torch.ops.aten.view.default(view_53, [128, 512]);  view_53 = None
    ...
    mm_7: "f32[512, 512]" = torch.ops.aten.mm.default(permute_41, view_23);  permute_41 = view_23 = None
    ...
    view_55: "f32[512]" = torch.ops.aten.view.default(sum_15, [512]);  sum_15 = None
    permute_43: "f32[512, 512]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_56: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_6, [1, 128, 512]);  mm_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:157, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_44: "f32[1, 128, 16, 32]" = torch.ops.aten.permute.default(view_50, [0, 2, 1, 3]);  view_50 = None
    view_57: "f32[1, 128, 512]" = torch.ops.aten.view.default(permute_44, [1, 128, 512]);  permute_44 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:192, code: key_states = self._shape(self.k_proj(key_value_states), -1, bsz)
    view_58: "f32[128, 512]" = torch.ops.aten.view.default(view_57, [128, 512]);  view_57 = None
    ...
    view_59: "f32[512]" = torch.ops.aten.view.default(sum_16, [512]);  sum_16 = None
    permute_48: "f32[512, 512]" = torch.ops.aten.permute.default(permute_47, [1, 0]);  permute_47 = None
    view_60: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_8, [1, 128, 512]);  mm_8 = None
    ...
    view_61: "f32[128, 512]" = torch.ops.aten.view.default(mul_38, [128, 512]);  mul_38 = None
    ...
    view_62: "f32[512]" = torch.ops.aten.view.default(sum_17, [512]);  sum_17 = None
    permute_52: "f32[512, 512]" = torch.ops.aten.permute.default(permute_51, [1, 0]);  permute_51 = None
    view_63: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_10, [1, 128, 512]);  mm_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:177, code: query_states = self.q_proj(hidden_states) * self.scaling
    add_15: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(mul_32, view_63);  mul_32 = view_63 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:422, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_12: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_1, getitem_3);  add_1 = getitem_3 = None
    mul_39: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_12, rsqrt);  sub_12 = None
    ...
    mul_42: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_40, mul_39);  mul_40 = None
    sum_19: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_42, [2], True);  mul_42 = None
    mul_43: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_39, sum_19);  sum_19 = None
    ...
    mul_45: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(add_15, mul_39);  mul_39 = None
    ...
    clone_15: "f32[1, 128, 512]" = torch.ops.aten.clone.default(mul_47, memory_format = torch.contiguous_format);  mul_47 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:275, code: attn_output = self.out_proj(attn_output)
    view_64: "f32[128, 512]" = torch.ops.aten.view.default(clone_15, [128, 512]);  clone_15 = None
    ...
    view_65: "f32[512]" = torch.ops.aten.view.default(sum_22, [512]);  sum_22 = None
    permute_56: "f32[512, 512]" = torch.ops.aten.permute.default(permute_55, [1, 0]);  permute_55 = None
    view_66: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_12, [1, 128, 512]);  mm_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:273, code: attn_output = attn_output.reshape(bsz, tgt_len, self.embed_dim)
    view_67: "f32[1, 128, 16, 32]" = torch.ops.aten.view.default(view_66, [1, 128, 16, 32]);  view_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:269, code: attn_output = attn_output.transpose(1, 2)
    permute_57: "f32[1, 16, 128, 32]" = torch.ops.aten.permute.default(view_67, [0, 2, 1, 3]);  view_67 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:268, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_68: "f32[16, 128, 32]" = torch.ops.aten.view.default(permute_57, [16, 128, 32]);  permute_57 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:235, code: attn_weights = attn_weights.view(bsz * self.num_heads, tgt_len, src_len)
    view_69: "f32[1, 16, 128, 128]" = torch.ops.aten.view.default(sub_15, [1, 16, 128, 128]);  sub_15 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:218, code: value_states = value_states.reshape(*proj_shape)
    view_71: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_8, [1, 16, 128, 32]);  bmm_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:217, code: key_states = key_states.reshape(*proj_shape)
    view_72: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(permute_62, [1, 16, 128, 32]);  permute_62 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:216, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_73: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_11, [1, 16, 128, 32]);  bmm_11 = None
    ...
    view_74: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_16, [1, 128, 512]);  clone_16 = None
    ...
    view_75: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_17, [1, 128, 512]);  clone_17 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:203, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_76: "f32[128, 512]" = torch.ops.aten.view.default(view_75, [128, 512]);  view_75 = None
    ...
    mm_15: "f32[512, 512]" = torch.ops.aten.mm.default(permute_66, view_5);  permute_66 = view_5 = None
    ...
    view_77: "f32[512]" = torch.ops.aten.view.default(sum_24, [512]);  sum_24 = None
    permute_68: "f32[512, 512]" = torch.ops.aten.permute.default(permute_67, [1, 0]);  permute_67 = None
    view_78: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_14, [1, 128, 512]);  mm_14 = None
    ...
    view_79: "f32[1, 128, 512]" = torch.ops.aten.view.default(permute_69, [1, 128, 512]);  permute_69 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:202, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_80: "f32[128, 512]" = torch.ops.aten.view.default(view_79, [128, 512]);  view_79 = None
    ...
    mm_17: "f32[512, 512]" = torch.ops.aten.mm.default(permute_71, view_2);  permute_71 = view_2 = None
    ...
    view_81: "f32[512]" = torch.ops.aten.view.default(sum_25, [512]);  sum_25 = None
    permute_73: "f32[512, 512]" = torch.ops.aten.permute.default(permute_72, [1, 0]);  permute_72 = None
    view_82: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_16, [1, 128, 512]);  mm_16 = None
    ...
    view_83: "f32[128, 512]" = torch.ops.aten.view.default(mul_50, [128, 512]);  mul_50 = None
    ...
    view_84: "f32[512]" = torch.ops.aten.view.default(sum_26, [512]);  sum_26 = None
    permute_77: "f32[512, 512]" = torch.ops.aten.permute.default(permute_76, [1, 0]);  permute_76 = None
    view_85: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_18, [1, 128, 512]);  mm_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:177, code: query_states = self.q_proj(hidden_states) * self.scaling
    add_18: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(add_17, view_85);  add_17 = view_85 = None
    return pytree.tree_unflatten([add_10, permute_77, view_84, permute_73, view_81, permute_68, view_77, permute_56, view_65, sum_20, sum_21, permute_52, view_62, permute_48, view_59, permute_43, view_55, permute_31, view_45, sum_11, sum_12, permute_27, view_42, permute_23, view_39, sum_5, sum_6, add_18, None, add_14], self._out_spec)
