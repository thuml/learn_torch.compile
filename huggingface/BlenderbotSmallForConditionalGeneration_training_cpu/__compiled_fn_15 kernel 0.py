...
def call(args):
    ...
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_17, (128, 512), (512, 1), 0), reinterpret_tensor(primals_5, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf2)
    del primals_6
    ...
    buf6 = empty((16, 128, 1), device='cpu', dtype=torch.float32)
    buf7 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    buf8 = empty((16, 128, 1), device='cpu', dtype=torch.float32)
