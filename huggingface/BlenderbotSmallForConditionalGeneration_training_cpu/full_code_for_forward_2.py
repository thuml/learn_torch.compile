...
def __guard_11_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139889433983632)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 143625280)) \
        and (___check_type_id(L['input_ids_shape'], 139891430452960)) \
        ...
        and (___check_type_id(G['torch'].long, 139891430446848)) \
...
def __guard_2_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139889434005360)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 143625280)) \
        and (___check_type_id(L['input_ids_shape'], 139891430452960)) \
        and (len(L['input_ids_shape']) == 2) \
