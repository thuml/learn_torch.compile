...
def call(args):
    ...
    extern_kernels.mm(reinterpret_tensor(primals_3, (128, 512), (512, 1), 0), reinterpret_tensor(primals_1, (512, 50265), (1, 512), 0), out=buf0)
    ...
    buf4 = empty((128, 50265), device='cpu', dtype=torch.float32)
    ...
    del buf5
    del primals_2
    return (buf8, buf1, primals_4, reinterpret_tensor(primals_3, (128, 512), (512, 1), 0), buf4, buf6, reinterpret_tensor(primals_1, (50265, 512), (512, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.float32)
