                       ...
                       float* out_ptr1)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(128L); x0+=static_cast<long>(1L))
        {
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(512L); x1+=static_cast<long>(8L))
            {
                auto tmp0 = ([&]() { __at_align__ float tmpbuf[8]; for (long x1_inner = 0; x1_inner < 8; x1_inner++) tmpbuf[x1_inner] = in_ptr2[static_cast<long>((32L*x0) + (4096L*(c10::div_floor_integer((x1 + x1_inner), 32L))) + (static_cast<long>((x1 + x1_inner)) % static_cast<long>(32L)))]; return at::vec::Vectorized<float>::loadu(tmpbuf); })();
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(128L); x0+=static_cast<long>(1L))
        {
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(512L); x1+=static_cast<long>(8L))
            {
                ...
                auto tmp12 = at::vec::Vectorized<float>::loadu(in_ptr4 + static_cast<long>(x1 + (512L*x0)));
...
def call(args):
    ...
    extern_kernels.mm(reinterpret_tensor(buf6, (128, 512), (512, 1), 0), permute_20, out=buf7)
    del permute_20
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf10, (128, 2048), (2048, 1), 0), permute_24, out=buf11)
    del permute_24
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf19, (128, 512), (512, 1), 0), permute_28, out=buf20)
    del permute_28
    buf24 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf20, (16, 128, 32), (32, 512, 1), 0), permute_34, out=buf24)
    del permute_34
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf6, (512, 128), (1, 512), 0), view_36, out=buf8)
    del view_36
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf10, (2048, 128), (1, 2048), 0), view_34, out=buf12)
    del view_34
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf19, (512, 128), (1, 512), 0), view_32, out=buf21)
    del view_32
    ...
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_33, reinterpret_tensor(buf20, (16, 128, 32), (32, 512, 1), 0), out=buf23)
    del permute_33
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf29, (512, 128), (1, 512), 0), view_20, out=buf31)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (128, 512), (1, 128), 0), permute_45, out=buf33)
    del permute_45
    buf34 = reinterpret_tensor(buf24, (512, 512), (512, 1), 0); del buf24  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (512, 128), (128, 1), 0), view_20, out=buf34)
    del view_20
    buf35 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf36 = reinterpret_tensor(buf30, (1, 128, 512), (65536, 512, 1), 0); del buf30  # reuse
    buf37 = reinterpret_tensor(buf6, (128, 512), (512, 1), 0); del buf6  # reuse
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf37, (512, 128), (1, 512), 0), view_18, out=buf39)
    del view_18
    buf40 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf41 = buf15; del buf15  # reuse
    buf42 = buf14; del buf14  # reuse
    buf43 = reinterpret_tensor(buf28, (1, 128, 512), (65536, 512, 1), 0); del buf28  # reuse
    buf44 = empty((512, ), device='cpu', dtype=torch.float32)
    buf45 = empty((512, ), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf46, (128, 512), (512, 1), 0), permute_53, out=buf47)
    del permute_53
    buf48 = empty((512, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf46, (512, 128), (1, 512), 0), view_16, out=buf48)
    del view_16
    buf49 = empty((1, 512), device='cpu', dtype=torch.float32)
    cpp_fused_sum_12(c_void_p(buf46.data_ptr()), c_void_p(buf49.data_ptr()))
    buf50 = reinterpret_tensor(buf46, (16, 128, 32), (4096, 32, 1), 0); del buf46  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_58, reinterpret_tensor(buf47, (16, 128, 32), (32, 512, 1), 0), out=buf50)
    del permute_58
    buf51 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf47, (16, 128, 32), (32, 512, 1), 0), permute_59, out=buf51)
    del permute_59
    ...
    del alias_3
    del buf52
    buf54 = reinterpret_tensor(buf47, (16, 32, 128), (4096, 128, 1), 0); del buf47  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_60, reinterpret_tensor(buf53, (16, 128, 128), (16384, 128, 1), 0), out=buf54)
    del permute_60
    buf55 = reinterpret_tensor(buf37, (16, 128, 32), (4096, 32, 1), 0); del buf37  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf53, (16, 128, 128), (16384, 128, 1), 0), permute_61, out=buf55)
    del permute_61
    buf56 = reinterpret_tensor(buf16, (128, 512), (512, 1), 0); del buf16  # reuse
    cpp_fused_view_14(c_void_p(buf50.data_ptr()), c_void_p(buf56.data_ptr()))
    buf57 = reinterpret_tensor(buf50, (128, 512), (512, 1), 0); del buf50  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf56, permute_65, out=buf57)
    del permute_65
    buf58 = reinterpret_tensor(buf53, (512, 512), (512, 1), 0); del buf53  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf56, (512, 128), (1, 512), 0), view, out=buf58)
    buf59 = empty((1, 512), device='cpu', dtype=torch.float32)
    cpp_fused_sum_15(c_void_p(buf56.data_ptr()), c_void_p(buf59.data_ptr()))
    buf60 = buf56; del buf56  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf54, (128, 512), (1, 128), 0), permute_70, out=buf60)
    del permute_70
    buf61 = empty((512, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf54, (512, 128), (128, 1), 0), view, out=buf61)
    buf62 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf63 = empty((128, 512), device='cpu', dtype=torch.float32)
    ...
    del buf54
    buf64 = reinterpret_tensor(buf55, (128, 512), (512, 1), 0); del buf55  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf63, permute_74, out=buf64)
    del permute_74
    buf65 = empty((512, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf63, (512, 128), (1, 512), 0), view, out=buf65)
    del view
    buf66 = empty((1, 512), device='cpu', dtype=torch.float32)
    ...
    return (reinterpret_tensor(buf65, (512, 512), (512, 1), 0), reinterpret_tensor(buf66, (512, ), (1, ), 0), reinterpret_tensor(buf61, (512, 512), (512, 1), 0), reinterpret_tensor(buf62, (512, ), (1, ), 0), reinterpret_tensor(buf58, (512, 512), (512, 1), 0), reinterpret_tensor(buf59, (512, ), (1, ), 0), reinterpret_tensor(buf48, (512, 512), (512, 1), 0), reinterpret_tensor(buf49, (512, ), (1, ), 0), buf44, buf45, reinterpret_tensor(buf39, (512, 512), (512, 1), 0), reinterpret_tensor(buf40, (512, ), (1, ), 0), reinterpret_tensor(buf34, (512, 512), (512, 1), 0), reinterpret_tensor(buf35, (512, ), (1, ), 0), reinterpret_tensor(buf31, (512, 512), (512, 1), 0), reinterpret_tensor(buf32, (512, ), (1, ), 0), reinterpret_tensor(buf21, (512, 512), (512, 1), 0), reinterpret_tensor(buf22, (512, ), (1, ), 0), buf17, buf18, reinterpret_tensor(buf12, (2048, 512), (512, 1), 0), reinterpret_tensor(buf13, (2048, ), (1, ), 0), reinterpret_tensor(buf8, (512, 2048), (2048, 1), 0), reinterpret_tensor(buf9, (512, ), (1, ), 0), buf4, buf5, buf67, None, buf36, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    view_18 = rand_strided((128, 512), (512, 1), device='cpu', dtype=torch.float32)
    view_20 = rand_strided((128, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    view_32 = rand_strided((128, 512), (512, 1), device='cpu', dtype=torch.float32)
    getitem_5 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.bool)
    mul_4 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.float32)
    view_34 = rand_strided((128, 512), (512, 1), device='cpu', dtype=torch.float32)
    addmm_8 = rand_strided((128, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    view_36 = rand_strided((128, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    getitem_9 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.bool)
    mul_9 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.float32)
    div_2 = rand_strided((1, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    permute_20 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    permute_24 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    div_3 = rand_strided((1, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    permute_28 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_33 = rand_strided((16, 128, 128), (16384, 1, 128), device='cpu', dtype=torch.float32)
    permute_34 = rand_strided((16, 32, 128), (4096, 1, 32), device='cpu', dtype=torch.float32)
    permute_35 = rand_strided((16, 32, 128), (4096, 1, 32), device='cpu', dtype=torch.float32)
    permute_36 = rand_strided((16, 128, 32), (4096, 32, 1), device='cpu', dtype=torch.float32)
    permute_40 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_45 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_49 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    div_4 = rand_strided((1, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    permute_53 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_58 = rand_strided((16, 128, 128), (16384, 1, 128), device='cpu', dtype=torch.float32)
    permute_59 = rand_strided((16, 32, 128), (4096, 1, 32), device='cpu', dtype=torch.float32)
    alias_3 = rand_strided((16, 128, 128), (16384, 128, 1), device='cpu', dtype=torch.float32)
    permute_60 = rand_strided((16, 32, 128), (4096, 1, 32), device='cpu', dtype=torch.float32)
    permute_61 = rand_strided((16, 128, 32), (4096, 32, 1), device='cpu', dtype=torch.float32)
    permute_65 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_70 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    permute_74 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
