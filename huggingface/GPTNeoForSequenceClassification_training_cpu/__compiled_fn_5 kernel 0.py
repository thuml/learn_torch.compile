...
cpp_fused__softmax__to_copy_add_arange_argmax_detach_embedding_eq_index_native_layer_norm_native_layer_norm_backward_sub_121 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
                       ...
                       float* out_ptr2)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(2L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp1 = decltype(tmp0)(tmp0 + 128);
            auto tmp2 = tmp0 < 0;
            auto tmp3 = tmp2 ? tmp1 : tmp0;
            TORCH_CHECK((0 <= tmp3) & (tmp3 < 128L), "index out of bounds: 0 <= tmp3 < 128L")
...
def call(args):
    ...
    assert_size_stride(primals_317, (2, 2048), (2048, 1))
    ...
    buf628 = empty((1, 16, 128, 128), device='cpu', dtype=torch.float32)
    cpp_fused__softmax_clone_detach_lift_fresh_where_111(c_void_p(buf572.data_ptr()), c_void_p(primals_340.data_ptr()), c_void_p(buf571.data_ptr()), c_void_p(buf573.data_ptr()), c_void_p(buf574.data_ptr()), c_void_p(buf628.data_ptr()))
    ...
    buf625 = empty((1, 16, 128, 128), device='cpu', dtype=torch.float32)
    cpp_fused__softmax_clone_detach_lift_fresh_where_116(c_void_p(buf598.data_ptr()), c_void_p(primals_341.data_ptr()), c_void_p(buf597.data_ptr()), c_void_p(buf599.data_ptr()), c_void_p(buf600.data_ptr()), c_void_p(buf625.data_ptr()))
    del buf597
    del buf599
    ...
    buf617 = empty((1, 128, 2048), device='cpu', dtype=torch.float32)
    ...
    del buf613
    del primals_316
    buf618 = empty((128, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf617, (128, 2048), (2048, 1), 0), reinterpret_tensor(primals_317, (2048, 2), (1, 2048), 0), out=buf618)
    buf619 = empty((1, ), device='cpu', dtype=torch.int64)
    buf620 = buf619; del buf619  # reuse
    buf621 = empty((1, ), device='cpu', dtype=torch.int64)
    buf622 = empty((1, 2), device='cpu', dtype=torch.float32)
    buf623 = reinterpret_tensor(buf614, (1, 128, 1), (128, 1, 1), 0); del buf614  # reuse
    buf624 = reinterpret_tensor(buf605, (1, 128, 1), (128, 1, 1), 0); del buf605  # reuse
    buf626 = reinterpret_tensor(buf589, (1, 128, 1), (128, 1, 1), 0); del buf589  # reuse
    buf627 = reinterpret_tensor(buf579, (1, 128, 1), (128, 1, 1), 0); del buf579  # reuse
    buf629 = reinterpret_tensor(buf563, (1, 128, 1), (128, 1, 1), 0); del buf563  # reuse
    buf630 = reinterpret_tensor(buf554, (1, 128, 1), (128, 1, 1), 0); del buf554  # reuse
    buf631 = buf547; del buf547  # reuse
    buf632 = reinterpret_tensor(buf538, (1, 128, 1), (128, 1, 1), 0); del buf538  # reuse
    buf633 = reinterpret_tensor(buf528, (1, 128, 1), (128, 1, 1), 0); del buf528  # reuse
    buf634 = buf521; del buf521  # reuse
    buf635 = reinterpret_tensor(buf512, (1, 128, 1), (128, 1, 1), 0); del buf512  # reuse
    buf636 = reinterpret_tensor(buf503, (1, 128, 1), (128, 1, 1), 0); del buf503  # reuse
    buf637 = buf496; del buf496  # reuse
    buf638 = reinterpret_tensor(buf487, (1, 128, 1), (128, 1, 1), 0); del buf487  # reuse
    buf639 = reinterpret_tensor(buf477, (1, 128, 1), (128, 1, 1), 0); del buf477  # reuse
    buf640 = buf470; del buf470  # reuse
    buf641 = reinterpret_tensor(buf461, (1, 128, 1), (128, 1, 1), 0); del buf461  # reuse
    buf642 = reinterpret_tensor(buf452, (1, 128, 1), (128, 1, 1), 0); del buf452  # reuse
    buf643 = buf445; del buf445  # reuse
    buf644 = reinterpret_tensor(buf436, (1, 128, 1), (128, 1, 1), 0); del buf436  # reuse
    buf645 = reinterpret_tensor(buf426, (1, 128, 1), (128, 1, 1), 0); del buf426  # reuse
    buf646 = buf419; del buf419  # reuse
    buf647 = reinterpret_tensor(buf410, (1, 128, 1), (128, 1, 1), 0); del buf410  # reuse
    buf648 = reinterpret_tensor(buf401, (1, 128, 1), (128, 1, 1), 0); del buf401  # reuse
    buf649 = buf394; del buf394  # reuse
    buf650 = reinterpret_tensor(buf385, (1, 128, 1), (128, 1, 1), 0); del buf385  # reuse
    buf651 = reinterpret_tensor(buf375, (1, 128, 1), (128, 1, 1), 0); del buf375  # reuse
    buf652 = buf368; del buf368  # reuse
    buf653 = reinterpret_tensor(buf359, (1, 128, 1), (128, 1, 1), 0); del buf359  # reuse
    buf654 = reinterpret_tensor(buf350, (1, 128, 1), (128, 1, 1), 0); del buf350  # reuse
    buf655 = buf343; del buf343  # reuse
    buf656 = reinterpret_tensor(buf334, (1, 128, 1), (128, 1, 1), 0); del buf334  # reuse
    buf657 = reinterpret_tensor(buf324, (1, 128, 1), (128, 1, 1), 0); del buf324  # reuse
    buf658 = buf317; del buf317  # reuse
    buf659 = reinterpret_tensor(buf308, (1, 128, 1), (128, 1, 1), 0); del buf308  # reuse
    buf660 = reinterpret_tensor(buf299, (1, 128, 1), (128, 1, 1), 0); del buf299  # reuse
    buf661 = buf292; del buf292  # reuse
    buf662 = reinterpret_tensor(buf283, (1, 128, 1), (128, 1, 1), 0); del buf283  # reuse
    buf663 = reinterpret_tensor(buf273, (1, 128, 1), (128, 1, 1), 0); del buf273  # reuse
    buf664 = buf266; del buf266  # reuse
    buf665 = reinterpret_tensor(buf257, (1, 128, 1), (128, 1, 1), 0); del buf257  # reuse
    buf666 = reinterpret_tensor(buf248, (1, 128, 1), (128, 1, 1), 0); del buf248  # reuse
    buf667 = buf241; del buf241  # reuse
    buf668 = reinterpret_tensor(buf232, (1, 128, 1), (128, 1, 1), 0); del buf232  # reuse
    buf669 = reinterpret_tensor(buf222, (1, 128, 1), (128, 1, 1), 0); del buf222  # reuse
    buf670 = buf215; del buf215  # reuse
    buf671 = reinterpret_tensor(buf206, (1, 128, 1), (128, 1, 1), 0); del buf206  # reuse
    buf672 = reinterpret_tensor(buf197, (1, 128, 1), (128, 1, 1), 0); del buf197  # reuse
    buf673 = buf190; del buf190  # reuse
    buf674 = reinterpret_tensor(buf181, (1, 128, 1), (128, 1, 1), 0); del buf181  # reuse
    buf675 = reinterpret_tensor(buf171, (1, 128, 1), (128, 1, 1), 0); del buf171  # reuse
    buf676 = buf164; del buf164  # reuse
    buf677 = reinterpret_tensor(buf155, (1, 128, 1), (128, 1, 1), 0); del buf155  # reuse
    buf678 = reinterpret_tensor(buf146, (1, 128, 1), (128, 1, 1), 0); del buf146  # reuse
    buf679 = buf139; del buf139  # reuse
    buf680 = reinterpret_tensor(buf130, (1, 128, 1), (128, 1, 1), 0); del buf130  # reuse
    buf681 = reinterpret_tensor(buf120, (1, 128, 1), (128, 1, 1), 0); del buf120  # reuse
    buf682 = buf113; del buf113  # reuse
    buf683 = reinterpret_tensor(buf104, (1, 128, 1), (128, 1, 1), 0); del buf104  # reuse
    buf684 = reinterpret_tensor(buf95, (1, 128, 1), (128, 1, 1), 0); del buf95  # reuse
    buf685 = buf88; del buf88  # reuse
    buf686 = reinterpret_tensor(buf79, (1, 128, 1), (128, 1, 1), 0); del buf79  # reuse
    buf687 = reinterpret_tensor(buf69, (1, 128, 1), (128, 1, 1), 0); del buf69  # reuse
    buf688 = buf62; del buf62  # reuse
    buf689 = reinterpret_tensor(buf53, (1, 128, 1), (128, 1, 1), 0); del buf53  # reuse
    buf690 = reinterpret_tensor(buf44, (1, 128, 1), (128, 1, 1), 0); del buf44  # reuse
    buf691 = buf37; del buf37  # reuse
    buf692 = reinterpret_tensor(buf28, (1, 128, 1), (128, 1, 1), 0); del buf28  # reuse
    buf693 = reinterpret_tensor(buf18, (1, 128, 1), (128, 1, 1), 0); del buf18  # reuse
    buf694 = buf11; del buf11  # reuse
    buf695 = reinterpret_tensor(buf2, (1, 128, 1), (128, 1, 1), 0); del buf2  # reuse
    cpp_fused__softmax__to_copy_add_arange_argmax_detach_embedding_eq_index_native_layer_norm_native_layer_norm_backward_sub_121(c_void_p(buf620.data_ptr()), c_void_p(buf623.data_ptr()), c_void_p(buf624.data_ptr()), c_void_p(buf626.data_ptr()), c_void_p(buf627.data_ptr()), c_void_p(buf629.data_ptr()), c_void_p(buf630.data_ptr()), c_void_p(buf631.data_ptr()), c_void_p(buf632.data_ptr()), c_void_p(buf633.data_ptr()), c_void_p(buf634.data_ptr()), c_void_p(buf635.data_ptr()), c_void_p(buf636.data_ptr()), c_void_p(buf637.data_ptr()), c_void_p(buf638.data_ptr()), c_void_p(buf639.data_ptr()), c_void_p(buf640.data_ptr()), c_void_p(buf641.data_ptr()), c_void_p(buf642.data_ptr()), c_void_p(buf643.data_ptr()), c_void_p(buf644.data_ptr()), c_void_p(buf645.data_ptr()), c_void_p(buf646.data_ptr()), c_void_p(buf647.data_ptr()), c_void_p(buf648.data_ptr()), c_void_p(buf649.data_ptr()), c_void_p(buf650.data_ptr()), c_void_p(buf651.data_ptr()), c_void_p(buf652.data_ptr()), c_void_p(buf653.data_ptr()), c_void_p(buf654.data_ptr()), c_void_p(buf655.data_ptr()), c_void_p(buf656.data_ptr()), c_void_p(buf657.data_ptr()), c_void_p(buf658.data_ptr()), c_void_p(buf659.data_ptr()), c_void_p(buf660.data_ptr()), c_void_p(buf661.data_ptr()), c_void_p(buf662.data_ptr()), c_void_p(buf663.data_ptr()), c_void_p(buf664.data_ptr()), c_void_p(buf665.data_ptr()), c_void_p(buf666.data_ptr()), c_void_p(buf667.data_ptr()), c_void_p(buf668.data_ptr()), c_void_p(buf669.data_ptr()), c_void_p(buf670.data_ptr()), c_void_p(buf671.data_ptr()), c_void_p(buf672.data_ptr()), c_void_p(buf673.data_ptr()), c_void_p(buf674.data_ptr()), c_void_p(buf675.data_ptr()), c_void_p(buf676.data_ptr()), c_void_p(buf677.data_ptr()), c_void_p(buf678.data_ptr()), c_void_p(buf679.data_ptr()), c_void_p(buf680.data_ptr()), c_void_p(buf681.data_ptr()), c_void_p(buf682.data_ptr()), c_void_p(buf683.data_ptr()), c_void_p(buf684.data_ptr()), c_void_p(buf685.data_ptr()), c_void_p(buf686.data_ptr()), c_void_p(buf687.data_ptr()), c_void_p(buf688.data_ptr()), c_void_p(buf689.data_ptr()), c_void_p(buf690.data_ptr()), c_void_p(buf691.data_ptr()), c_void_p(buf692.data_ptr()), c_void_p(buf693.data_ptr()), c_void_p(buf694.data_ptr()), c_void_p(buf695.data_ptr()), c_void_p(primals_342.data_ptr()), c_void_p(buf618.data_ptr()), c_void_p(buf548.data_ptr()), c_void_p(buf522.data_ptr()), c_void_p(buf497.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf446.data_ptr()), c_void_p(buf420.data_ptr()), c_void_p(buf395.data_ptr()), c_void_p(buf369.data_ptr()), c_void_p(buf344.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(buf293.data_ptr()), c_void_p(buf267.data_ptr()), c_void_p(buf242.data_ptr()), c_void_p(buf216.data_ptr()), c_void_p(buf191.data_ptr()), c_void_p(buf165.data_ptr()), c_void_p(buf140.data_ptr()), c_void_p(buf114.data_ptr()), c_void_p(buf89.data_ptr()), c_void_p(buf63.data_ptr()), c_void_p(buf38.data_ptr()), c_void_p(buf12.data_ptr()), c_void_p(buf621.data_ptr()), c_void_p(buf622.data_ptr()))
    return (buf617, reinterpret_tensor(buf7, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf8, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf33, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf34, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf58, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf59, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf84, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf85, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf109, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf110, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf135, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf136, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf160, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf161, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf186, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf187, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf211, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf212, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf237, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf238, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf262, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf263, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf288, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf289, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf313, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf314, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf339, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf340, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf364, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf365, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf390, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf391, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf415, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf416, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf441, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf442, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf466, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf467, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf492, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf493, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf517, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf518, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf543, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf544, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf568, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf569, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf594, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), reinterpret_tensor(buf595, (1, 16, 128, 128), (262144, 128, 2048, 1), 0), buf622, primals_3, primals_10, primals_16, primals_23, primals_29, primals_36, primals_42, primals_49, primals_55, primals_62, primals_68, primals_75, primals_81, primals_88, primals_94, primals_101, primals_107, primals_114, primals_120, primals_127, primals_133, primals_140, primals_146, primals_153, primals_159, primals_166, primals_172, primals_179, primals_185, primals_192, primals_198, primals_205, primals_211, primals_218, primals_224, primals_231, primals_237, primals_244, primals_250, primals_257, primals_263, primals_270, primals_276, primals_283, primals_289, primals_296, primals_302, primals_309, primals_315, primals_342, buf0, buf4, buf5, reinterpret_tensor(primals_318, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf15, buf20, buf21, buf22, buf23, buf24, buf30, buf31, reinterpret_tensor(primals_319, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf41, buf46, buf47, buf48, buf49, buf50, buf55, buf56, reinterpret_tensor(primals_320, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf66, buf71, buf72, buf73, buf74, buf75, buf81, buf82, reinterpret_tensor(primals_321, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf92, buf97, buf98, buf99, buf100, buf101, buf106, buf107, reinterpret_tensor(primals_322, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf117, buf122, buf123, buf124, buf125, buf126, buf132, buf133, reinterpret_tensor(primals_323, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf143, buf148, buf149, buf150, buf151, buf152, buf157, buf158, reinterpret_tensor(primals_324, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf168, buf173, buf174, buf175, buf176, buf177, buf183, buf184, reinterpret_tensor(primals_325, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf194, buf199, buf200, buf201, buf202, buf203, buf208, buf209, reinterpret_tensor(primals_326, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf219, buf224, buf225, buf226, buf227, buf228, buf234, buf235, reinterpret_tensor(primals_327, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf245, buf250, buf251, buf252, buf253, buf254, buf259, buf260, reinterpret_tensor(primals_328, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf270, buf275, buf276, buf277, buf278, buf279, buf285, buf286, reinterpret_tensor(primals_329, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf296, buf301, buf302, buf303, buf304, buf305, buf310, buf311, reinterpret_tensor(primals_330, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf321, buf326, buf327, buf328, buf329, buf330, buf336, buf337, reinterpret_tensor(primals_331, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf347, buf352, buf353, buf354, buf355, buf356, buf361, buf362, reinterpret_tensor(primals_332, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf372, buf377, buf378, buf379, buf380, buf381, buf387, buf388, reinterpret_tensor(primals_333, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf398, buf403, buf404, buf405, buf406, buf407, buf412, buf413, reinterpret_tensor(primals_334, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf423, buf428, buf429, buf430, buf431, buf432, buf438, buf439, reinterpret_tensor(primals_335, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf449, buf454, buf455, buf456, buf457, buf458, buf463, buf464, reinterpret_tensor(primals_336, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf474, buf479, buf480, buf481, buf482, buf483, buf489, buf490, reinterpret_tensor(primals_337, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf500, buf505, buf506, buf507, buf508, buf509, buf514, buf515, reinterpret_tensor(primals_338, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf525, buf530, buf531, buf532, buf533, buf534, buf540, buf541, reinterpret_tensor(primals_339, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf551, buf556, buf557, buf558, buf559, buf560, buf565, buf566, reinterpret_tensor(primals_340, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf576, buf581, buf582, buf583, buf584, buf585, buf591, buf592, reinterpret_tensor(primals_341, (1, 1, 128, 128), (4194304, 4194304, 2048, 1), 0), buf602, buf607, buf608, buf609, buf610, buf611, buf616, reinterpret_tensor(buf617, (128, 2048), (2048, 1), 0), buf620, buf621, reinterpret_tensor(primals_317, (2, 2048), (2048, 1), 0), buf623, reinterpret_tensor(primals_313, (2048, 8192), (8192, 1), 0), reinterpret_tensor(primals_311, (8192, 2048), (2048, 1), 0), buf624, reinterpret_tensor(primals_307, (2048, 2048), (2048, 1), 0), reinterpret_tensor(buf600, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf595, (16, 128, 128), (128, 1, 2048), 0), buf625, reinterpret_tensor(buf593, (16, 128, 128), (128, 1, 2048), 0), reinterpret_tensor(buf594, (16, 128, 128), (128, 2048, 1), 0), reinterpret_tensor(primals_306, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_305, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_304, (2048, 2048), (2048, 1), 0), buf626, reinterpret_tensor(primals_300, (2048, 8192), (8192, 1), 0), reinterpret_tensor(primals_298, (8192, 2048), (2048, 1), 0), buf627, reinterpret_tensor(primals_294, (2048, 2048), (2048, 1), 0), reinterpret_tensor(buf574, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf569, (16, 128, 128), (128, 1, 2048), 0), buf628, reinterpret_tensor(buf567, (16, 128, 128), (128, 1, 2048), 0), reinterpret_tensor(buf568, (16, 128, 128), (128, 2048, 1), 0), reinterpret_tensor(primals_293, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_292, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_291, (2048, 2048), (2048, 1), 0), buf629, reinterpret_tensor(primals_287, (2048, 8192), (8192, 1), 0), reinterpret_tensor(primals_285, (8192, 2048), (2048, 1), 0), buf630, reinterpret_tensor(primals_281, (2048, 2048), (2048, 1), 0), reinterpret_tensor(buf549, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf544, (16, 128, 128), (128, 1, 2048), 0), buf631, reinterpret_tensor(buf542, (16, 128, 128), (128, 1, 2048), 0), reinterpret_tensor(buf543, (16, 128, 128), (128, 2048, 1), 0), reinterpret_tensor(primals_280, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_279, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_278, (2048, 2048), (2048, 1), 0), buf632, reinterpret_tensor(primals_274, (2048, 8192), (8192, 1), 0), reinterpret_tensor(primals_272, (8192, 2048), (2048, 1), 0), buf633, reinterpret_tensor(primals_268, (2048, 2048), (2048, 1), 0), reinterpret_tensor(buf523, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf518, (16, 128, 128), (128, 1, 2048), 0), buf634, reinterpret_tensor(buf516, (16, 128, 128), (128, 1, 2048), 0), reinterpret_tensor(buf517, (16, 128, 128), (128, 2048, 1), 0), reinterpret_tensor(primals_267, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals_266, (2048, 2048), (2048, 1), 0), reinterpret_tensor(primals
als_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207, primals_208, primals_209, primals_210, primals_211, primals_212, primals_213, primals_214, primals_215, primals_216, primals_217, primals_218, primals_219, primals_220, primals_221, primals_222, primals_223, primals_224, primals_225, primals_226, primals_227, primals_228, primals_229, primals_230, primals_231, primals_232, primals_233, primals_234, primals_235, primals_236, primals_237, primals_238, primals_239, primals_240, primals_241, primals_242, primals_243, primals_244, primals_245, primals_246, primals_247, primals_248, primals_249, primals_250, primals_251, primals_252, primals_253, primals_254, primals_255, primals_256, primals_257, primals_258, primals_259, primals_260, primals_261, primals_262, primals_263, primals_264, primals_265, primals_266, primals_267, primals_268, primals_269, primals_270, primals_271, primals_272, primals_273, primals_274, primals_275, primals_276, primals_277, primals_278, primals_279, primals_280, primals_281, primals_282, primals_283, primals_284, primals_285, primals_286, primals_287, primals_288, primals_289, primals_290, primals_291, primals_292, primals_293, primals_294, primals_295, primals_296, primals_297, primals_298, primals_299, primals_300, primals_301, primals_302, primals_303, primals_304, primals_305, primals_306, primals_307, primals_308, primals_309, primals_310, primals_311, primals_312, primals_313, primals_314, primals_315, primals_316, primals_317, primals_318, primals_319, primals_320, primals_321, primals_322, primals_323, primals_324, primals_325, primals_326, primals_327, primals_328, primals_329, primals_330, primals_331, primals_332, primals_333, primals_334, primals_335, primals_336, primals_337, primals_338, primals_339, primals_340, primals_341, primals_342]), times=times, repeat=repeat)
