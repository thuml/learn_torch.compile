...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140602468907376)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 159115840)) \
        and (___check_type_id(L['input_ids'], 89162976)) \
        ...
        and (___check_type_id(G['torch'].long, 140604459841280)) \
