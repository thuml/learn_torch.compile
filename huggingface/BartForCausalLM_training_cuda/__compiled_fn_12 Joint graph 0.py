...
def forward(self, primals, tangents):
    primals_1: "f32[1024, 1024]"; primals_2: "f32[1024]"; primals_3: "f32[1024, 1024]"; primals_4: "f32[1024]"; primals_5: "f32[1024, 1024]"; primals_6: "f32[1024]"; primals_7: "f32[1024, 1024]"; primals_8: "f32[1024]"; primals_9: "f32[1024]"; primals_10: "f32[1024]"; primals_11: "f32[4096, 1024]"; primals_12: "f32[4096]"; primals_13: "f32[1024, 4096]"; primals_14: "f32[1024]"; primals_15: "f32[1024]"; primals_16: "f32[1024]"; primals_17: "f32[1, 1024, 1024]"; primals_18: "f32[1, 1, 1024, 1024]"; tangents_1: "f32[1, 1024, 1024]"; tangents_2: "f32[1, 16, 1024, 64]"; tangents_3: "f32[1, 16, 1024, 64]"; 
    ...
    sub_2: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_5, getitem_7)
    ...
    sub_3: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_5, getitem_7);  add_5 = getitem_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_17: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476)
    ...
    mul_18: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_8, 0.5);  add_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/bart/modeling_bart.py:436, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_6: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_1, getitem_3);  add_1 = getitem_3 = None
    ...
    mul_30: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_10, mul_24);  mul_24 = None
