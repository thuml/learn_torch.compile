...
# kernel path: /tmp/torchinductor_youkaichao/iw/ciwr5fju43o3ekrbvfntdmsgxhtgvs2ybidjwfkyi2a7hmyxpeeb.py
...
# kernel path: /tmp/torchinductor_youkaichao/54/c54giqarz7ikcnsk3lpir6orp6kxo27mifgrcbtjzvuow446usge.py
...
# kernel path: /tmp/torchinductor_youkaichao/vh/cvhvcfd5iu24ewepy74howfwahxyweaglcvptmaujsqvhfz7jxnf.py
# Source Nodes: [], Original ATen: [aten.clone]
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf10, (4096, 1024), (1, 4096), 0), view_18, out=buf12)
        del view_18
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf20, (1024, 1024), (1, 1024), 0), view_16, out=buf22)
        del view_16
        ...
        # Source Nodes: [], Original ATen: [aten._softmax_backward_data]
        triton_per_fused__softmax_backward_data_9.run(buf26, alias_1, buf28, 16384, 1024, grid=grid(16384), stream=stream0)
        del alias_1
        del buf26
        buf29 = reinterpret_tensor(buf21, (16, 64, 1024), (65536, 1024, 1), 0); del buf21  # reuse
        # Source Nodes: [], Original ATen: [aten.bmm]
        extern_kernels.bmm(permute_26, reinterpret_tensor(buf28, (16, 1024, 1024), (1048576, 1024, 1), 0), out=buf29)
        del permute_26
        buf30 = empty((16, 1024, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf28, (16, 1024, 1024), (1048576, 1024, 1), 0), permute_27, out=buf30)
        del buf28
        del permute_27
        buf31 = empty((1, 1024, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.clone]
        triton_poi_fused_clone_10.run(tangents_3, buf25, buf31, 1048576, grid=grid(1048576), stream=stream0)
        del tangents_3
        buf32 = reinterpret_tensor(buf25, (1024, 1024), (1024, 1), 0); del buf25  # reuse
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf31, (1024, 1024), (1024, 1), 0), permute_31, out=buf32)
        del permute_31
        ...
        # Source Nodes: [], Original ATen: [aten.clone]
        triton_poi_fused_clone_11.run(tangents_2, buf29, buf36, 16384, 64, grid=grid(16384, 64), stream=stream0)
        del tangents_2
        buf37 = reinterpret_tensor(buf29, (1024, 1024), (1024, 1), 0); del buf29  # reuse
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf36, (1024, 1024), (1024, 1), 0), permute_36, out=buf37)
        del permute_36
        ...
        # Source Nodes: [], Original ATen: [aten.sum]
        triton_red_fused_sum_2.run(buf36, buf39, 8192, 128, grid=grid(8192), stream=stream0)
        buf40 = empty((1, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.sum]
        triton_per_fused_sum_3.run(buf39, buf40, 1024, 8, grid=grid(1024), stream=stream0)
        buf41 = reinterpret_tensor(buf36, (1024, 1024), (1024, 1), 0); del buf36  # reuse
        # Source Nodes: [], Original ATen: [aten.mul, aten.view]
        triton_poi_fused_mul_view_12.run(buf30, buf41, 1048576, grid=grid(1048576), stream=stream0)
        buf42 = reinterpret_tensor(buf30, (1024, 1024), (1024, 1), 0); del buf30  # reuse
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(buf41, permute_40, out=buf42)
        del permute_40
        buf43 = empty((1024, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf41, (1024, 1024), (1, 1024), 0), view, out=buf43)
        del view
        buf44 = buf39; del buf39  # reuse
        # Source Nodes: [], Original ATen: [aten.sum]
        triton_red_fused_sum_2.run(buf41, buf44, 8192, 128, grid=grid(8192), stream=stream0)
        del buf41
        buf45 = empty((1, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.sum]
        triton_per_fused_sum_3.run(buf44, buf45, 1024, 8, grid=grid(1024), stream=stream0)
        del buf44
        buf46 = buf17; del buf17  # reuse
        # Source Nodes: [], Original ATen: [aten.add]
        triton_poi_fused_add_13.run(buf46, buf32, buf37, buf42, 1048576, grid=grid(1048576), stream=stream0)
