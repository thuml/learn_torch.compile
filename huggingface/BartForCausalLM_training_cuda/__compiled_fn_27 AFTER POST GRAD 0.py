...
def forward(self, primals_3: "i64[1, 1024]", view: "f32[1024, 1024]", sub_1: "f32[1024, 50265]", convert_element_type: "f32[]", permute_3: "f32[50265, 1024]", tangents_1: "f32[]", tangents_2: "f32[1, 1024, 50265]"):
    ...
    view_3: "i64[1024]" = torch.ops.aten.reshape.default(primals_3, [-1]);  primals_3 = None
    ...
    view_5: "f32[1024, 50265]" = torch.ops.aten.reshape.default(add, [1024, 50265]);  add = None
