...
def call(args):
    ...
    extern_kernels.mm(reinterpret_tensor(buf1, (128, 1024), (1024, 1), 0), permute_11, out=buf2)
    del permute_11
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (128, 4096), (4096, 1), 0), permute_15, out=buf6)
    del permute_15
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (128, 1024), (1024, 1), 0), permute_19, out=buf15)
    del permute_19
    buf19 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf15, (16, 128, 64), (64, 1024, 1), 0), permute_25, out=buf19)
    del permute_25
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf1, (1024, 128), (1, 1024), 0), view_18, out=buf3)
    del view_18
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (4096, 128), (1, 4096), 0), view_16, out=buf7)
    del view_16
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (1024, 128), (1, 1024), 0), view_14, out=buf16)
    del view_14
    ...
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_24, reinterpret_tensor(buf15, (16, 128, 64), (64, 1024, 1), 0), out=buf18)
    del permute_24
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf24, (1024, 128), (1, 1024), 0), view, out=buf26)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (128, 1024), (1, 128), 0), permute_36, out=buf28)
    del permute_36
    buf29 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (1024, 128), (128, 1), 0), view, out=buf29)
    ...
    del buf22
    buf32 = reinterpret_tensor(buf23, (128, 1024), (1024, 1), 0); del buf23  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    view_14 = rand_strided((128, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    ...
    view_18 = rand_strided((128, 4096), (4096, 1), device='cpu', dtype=torch.float32)
