...
def call(args):
    ...
    del buf5
    del primals_2
    return (buf8, buf1, primals_4, reinterpret_tensor(primals_3, (128, 1024), (1024, 1), 0), buf4, buf6, reinterpret_tensor(primals_1, (50265, 1024), (1024, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cpu', dtype=torch.float32)
