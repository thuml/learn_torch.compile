...
def call(args):
    ...
    buf11 = empty((16, 128, 1), device='cpu', dtype=torch.float32)
    buf12 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    buf13 = empty((16, 128, 1), device='cpu', dtype=torch.float32)
