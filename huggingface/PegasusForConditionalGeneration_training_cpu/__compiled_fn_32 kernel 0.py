            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(1L))
                {
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(64L); x2+=static_cast<long>(8L))
                    {
                        ...
                        tmp0.store(out_ptr4 + static_cast<long>(x2 + (64L*x1) + (8192L*x0)));
                    }
                }
            }
        }
...
def call(args):
    ...
    buf10 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    # Source Nodes: [attn_weights], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf8, (16, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf9, (16, 64, 128), (8192, 1, 64), 0), out=buf10)
    buf11 = empty_strided((16, 128, 1), (128, 1, 2048), device='cpu', dtype=torch.float32)
    buf12 = buf10; del buf10  # reuse
    buf13 = empty_strided((16, 128, 1), (128, 1, 2048), device='cpu', dtype=torch.float32)
    buf14 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    buf58 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    buf15 = reinterpret_tensor(buf6, (1, 16, 128, 64), (131072, 8192, 64, 1), 0); del buf6  # reuse
    ...
    del primals_28
    buf16 = reinterpret_tensor(buf7, (16, 128, 64), (8192, 64, 1), 0); del buf7  # reuse
    # Source Nodes: [attn_output], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf14, reinterpret_tensor(buf15, (16, 128, 64), (8192, 64, 1), 0), out=buf16)
    buf17 = buf5; del buf5  # reuse
    cpp_fused_view_3(c_void_p(buf16.data_ptr()), c_void_p(buf17.data_ptr()))
    buf18 = reinterpret_tensor(buf16, (128, 1024), (1024, 1), 0); del buf16  # reuse
    ...
    buf19 = aten.native_dropout(reinterpret_tensor(buf18, (1, 128, 1024), (131072, 1024, 1), 0), 0.1, True)
    buf20 = buf19[0]
    buf21 = buf19[1]
    del buf19
    ...
    buf25 = reinterpret_tensor(buf18, (1, 128, 1024), (131072, 1024, 1), 0); del buf18  # reuse
    buf26 = empty((128, 1024), device='cpu', dtype=torch.float32)
    ...
    del primals_14
    buf28 = empty((128, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_16, reinterpret_tensor(primals_29, (128, 1024), (1024, 1), 0), reinterpret_tensor(primals_15, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf28)
    del primals_16
    buf29 = empty((128, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_18, reinterpret_tensor(primals_29, (128, 1024), (1024, 1), 0), reinterpret_tensor(primals_17, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf29)
    del primals_18
    buf30 = empty((1, 16, 128, 64), device='cpu', dtype=torch.float32)
    buf31 = empty((1, 16, 128, 64), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(buf30, (16, 128, 64), (8192, 64, 1), 0), reinterpret_tensor(buf31, (16, 64, 128), (8192, 1, 64), 0), out=buf32)
    buf33 = reinterpret_tensor(buf13, (16, 128, 1), (128, 1, 1), 0); del buf13  # reuse
    buf34 = empty((16, 128, 128), device='cpu', dtype=torch.float32)
    buf35 = reinterpret_tensor(buf11, (16, 128, 1), (128, 1, 1), 0); del buf11  # reuse
    ...
    buf38 = reinterpret_tensor(buf29, (16, 128, 64), (8192, 64, 1), 0); del buf29  # reuse
    # Source Nodes: [attn_output_5], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf36, reinterpret_tensor(buf37, (16, 128, 64), (8192, 64, 1), 0), out=buf38)
    buf39 = buf27; del buf27  # reuse
    cpp_fused_view_7(c_void_p(buf38.data_ptr()), c_void_p(buf39.data_ptr()))
    buf40 = reinterpret_tensor(buf38, (128, 1024), (1024, 1), 0); del buf38  # reuse
    ...
    buf41 = aten.native_dropout(reinterpret_tensor(buf40, (1, 128, 1024), (131072, 1024, 1), 0), 0.1, True)
    buf42 = buf41[0]
    buf43 = buf41[1]
    del buf41
    buf44 = buf22; del buf22  # reuse
    buf45 = empty_strided((1, 128, 1), (128, 1, 128), device='cpu', dtype=torch.float32)
    buf47 = reinterpret_tensor(buf40, (1, 128, 1024), (131072, 1024, 1), 0); del buf40  # reuse
    buf48 = empty((128, 1024), device='cpu', dtype=torch.float32)
    ...
    del buf44
    del primals_22
    buf49 = empty((128, 4096), device='cpu', dtype=torch.float32)
    ...
    buf51 = empty((128, 1024), device='cpu', dtype=torch.float32)
    ...
    buf52 = aten.native_dropout(reinterpret_tensor(buf51, (1, 128, 1024), (131072, 1024, 1), 0), 0.1, True)
    del buf51
    buf53 = buf52[0]
    buf54 = buf52[1]
    del buf52
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_29 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cpu', dtype=torch.float32)
