...
def __guard_15_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139715844909392)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 158662448)) \
        and (___check_type_id(L['input_ids_shape'], 139718085177056)) \
        ...
        and (___check_type_id(G['torch'].long, 139718085170944)) \
...
def __guard_2_for_forward(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_obj_id(L['self'], 139715844914240)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 158662448)) \
        and (___check_type_id(L['input_ids_shape'], 139718085177056)) \
        and (len(L['input_ids_shape']) == 2) \
