    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(128L); x0+=static_cast<long>(1L))
        {
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(512L); x1+=static_cast<long>(8L))
            {
                ...
                auto tmp19 = at::vec::Vectorized<float>::loadu(in_ptr2 + static_cast<long>(x1));
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(1L))
            {
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(32L); x2+=static_cast<long>(8L))
                {
                    ...
                    auto tmp3 = tmp0 * tmp2;
                    tmp3.store(out_ptr1 + static_cast<long>(x2 + (32L*x1) + (4096L*x0)));
                }
            }
        }
    }
...
cpp_fused__log_softmax_nll_loss_forward_57 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const long* in_ptr1,
...
def call(args):
    ...
    cpp_fused_add_arange_embedding_mul_native_layer_norm_0(c_void_p(arg133_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()))
    del arg0_1
    del arg133_1
    del arg1_1
    del arg2_1
    ...
    extern_kernels.addmm(arg5_1, reinterpret_tensor(buf3, (128, 512), (512, 1), 0), reinterpret_tensor(arg4_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf4)
    del arg4_1
    del arg5_1
    ...
    extern_kernels.addmm(arg7_1, reinterpret_tensor(buf3, (128, 512), (512, 1), 0), reinterpret_tensor(arg6_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf5)
    del arg6_1
    del arg7_1
    buf6 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    ...
    buf12 = reinterpret_tensor(buf7, (128, 512), (512, 1), 0); del buf7  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_0_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg9_1, reinterpret_tensor(buf3, (128, 512), (512, 1), 0), reinterpret_tensor(arg8_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf12)
    del arg8_1
    del arg9_1
    buf13 = reinterpret_tensor(buf5, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf5  # reuse
    ...
    buf15 = reinterpret_tensor(buf12, (16, 128, 32), (4096, 32, 1), 0); del buf12  # reuse
    # Source Nodes: [attn_output, attn_weights_3], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf14, reinterpret_tensor(buf13, (16, 128, 32), (4096, 32, 1), 0), out=buf15)
    buf16 = reinterpret_tensor(buf4, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf4  # reuse
    cpp_fused_clone_4(c_void_p(buf15.data_ptr()), c_void_p(buf16.data_ptr()))
    buf17 = reinterpret_tensor(buf15, (128, 512), (512, 1), 0); del buf15  # reuse
    # Source Nodes: [hidden_states_2], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg11_1, reinterpret_tensor(buf16, (128, 512), (512, 1), 0), reinterpret_tensor(arg10_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf17)
    del arg10_1
    del arg11_1
    buf18 = buf1; del buf1  # reuse
    buf19 = buf0; del buf0  # reuse
    buf21 = reinterpret_tensor(buf16, (1, 128, 512), (65536, 512, 1), 0); del buf16  # reuse
    ...
    del arg12_1
    del arg13_1
    buf22 = reinterpret_tensor(buf14, (128, 2048), (2048, 1), 0); del buf14  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_0_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg15_1, reinterpret_tensor(buf21, (128, 512), (512, 1), 0), reinterpret_tensor(arg14_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf22)
    del arg14_1
    del arg15_1
    buf23 = reinterpret_tensor(buf22, (1, 128, 2048), (262144, 2048, 1), 0); del buf22  # reuse
    cpp_fused_gelu_6(c_void_p(buf23.data_ptr()))
    buf24 = reinterpret_tensor(buf3, (128, 512), (512, 1), 0); del buf3  # reuse
    # Source Nodes: [hidden_states_8], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg17_1, reinterpret_tensor(buf23, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg16_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf24)
    del arg16_1
    del arg17_1
    buf25 = buf19; del buf19  # reuse
    buf26 = buf18; del buf18  # reuse
    buf28 = reinterpret_tensor(buf17, (1, 128, 512), (65536, 512, 1), 0); del buf17  # reuse
    ...
    extern_kernels.addmm(arg21_1, reinterpret_tensor(buf28, (128, 512), (512, 1), 0), reinterpret_tensor(arg20_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf29)
    del arg20_1
    del arg21_1
    buf30 = reinterpret_tensor(buf21, (128, 512), (512, 1), 0); del buf21  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_1_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg23_1, reinterpret_tensor(buf28, (128, 512), (512, 1), 0), reinterpret_tensor(arg22_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf30)
    del arg22_1
    del arg23_1
    buf31 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf32 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_8(c_void_p(buf30.data_ptr()), c_void_p(buf29.data_ptr()), c_void_p(buf31.data_ptr()), c_void_p(buf32.data_ptr()))
    buf33 = reinterpret_tensor(buf23, (16, 128, 128), (16384, 128, 1), 0); del buf23  # reuse
    # Source Nodes: [attn_weights_4], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf32, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf31, (16, 32, 128), (4096, 1, 32), 0), out=buf33)
    ...
    buf37 = reinterpret_tensor(buf32, (128, 512), (512, 1), 0); del buf32  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_1_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg25_1, reinterpret_tensor(buf28, (128, 512), (512, 1), 0), reinterpret_tensor(arg24_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf37)
    del arg24_1
    del arg25_1
    buf38 = reinterpret_tensor(buf30, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf30  # reuse
    ...
    buf40 = reinterpret_tensor(buf37, (16, 128, 32), (4096, 32, 1), 0); del buf37  # reuse
    # Source Nodes: [attn_output_5, attn_weights_7], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf39, reinterpret_tensor(buf38, (16, 128, 32), (4096, 32, 1), 0), out=buf40)
    buf41 = reinterpret_tensor(buf29, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf29  # reuse
    cpp_fused_clone_11(c_void_p(buf40.data_ptr()), c_void_p(buf41.data_ptr()))
    buf42 = reinterpret_tensor(buf40, (128, 512), (512, 1), 0); del buf40  # reuse
    # Source Nodes: [hidden_states_13], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg27_1, reinterpret_tensor(buf41, (128, 512), (512, 1), 0), reinterpret_tensor(arg26_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf42)
    del arg26_1
    del arg27_1
    buf43 = buf26; del buf26  # reuse
    buf44 = buf25; del buf25  # reuse
    buf46 = reinterpret_tensor(buf41, (1, 128, 512), (65536, 512, 1), 0); del buf41  # reuse
    ...
    del arg28_1
    del arg29_1
    buf47 = reinterpret_tensor(buf39, (128, 2048), (2048, 1), 0); del buf39  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_1_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg31_1, reinterpret_tensor(buf46, (128, 512), (512, 1), 0), reinterpret_tensor(arg30_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf47)
    del arg30_1
    del arg31_1
    ...
    extern_kernels.addmm(arg33_1, reinterpret_tensor(buf48, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg32_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf49)
    del arg32_1
    del arg33_1
    ...
    extern_kernels.addmm(arg37_1, reinterpret_tensor(buf53, (128, 512), (512, 1), 0), reinterpret_tensor(arg36_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf54)
    del arg36_1
    del arg37_1
    buf55 = reinterpret_tensor(buf46, (128, 512), (512, 1), 0); del buf46  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_2_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg39_1, reinterpret_tensor(buf53, (128, 512), (512, 1), 0), reinterpret_tensor(arg38_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf55)
    del arg38_1
    del arg39_1
    buf56 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf57 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_15(c_void_p(buf55.data_ptr()), c_void_p(buf54.data_ptr()), c_void_p(buf56.data_ptr()), c_void_p(buf57.data_ptr()))
    buf58 = reinterpret_tensor(buf48, (16, 128, 128), (16384, 128, 1), 0); del buf48  # reuse
    # Source Nodes: [attn_weights_8], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf57, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf56, (16, 32, 128), (4096, 1, 32), 0), out=buf58)
    ...
    buf62 = reinterpret_tensor(buf57, (128, 512), (512, 1), 0); del buf57  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_2_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg41_1, reinterpret_tensor(buf53, (128, 512), (512, 1), 0), reinterpret_tensor(arg40_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf62)
    del arg40_1
    del arg41_1
    buf63 = reinterpret_tensor(buf55, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf55  # reuse
    ...
    buf65 = reinterpret_tensor(buf62, (16, 128, 32), (4096, 32, 1), 0); del buf62  # reuse
    # Source Nodes: [attn_output_10, attn_weights_11], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf64, reinterpret_tensor(buf63, (16, 128, 32), (4096, 32, 1), 0), out=buf65)
    buf66 = reinterpret_tensor(buf54, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf54  # reuse
    cpp_fused_clone_18(c_void_p(buf65.data_ptr()), c_void_p(buf66.data_ptr()))
    buf67 = reinterpret_tensor(buf65, (128, 512), (512, 1), 0); del buf65  # reuse
    # Source Nodes: [hidden_states_24], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg43_1, reinterpret_tensor(buf66, (128, 512), (512, 1), 0), reinterpret_tensor(arg42_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf67)
    del arg42_1
    del arg43_1
    buf68 = buf51; del buf51  # reuse
    buf69 = buf50; del buf50  # reuse
    buf71 = reinterpret_tensor(buf66, (1, 128, 512), (65536, 512, 1), 0); del buf66  # reuse
    ...
    del arg44_1
    del arg45_1
    buf72 = reinterpret_tensor(buf64, (128, 2048), (2048, 1), 0); del buf64  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_2_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg47_1, reinterpret_tensor(buf71, (128, 512), (512, 1), 0), reinterpret_tensor(arg46_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf72)
    del arg46_1
    del arg47_1
    ...
    extern_kernels.addmm(arg49_1, reinterpret_tensor(buf73, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg48_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf74)
    del arg48_1
    del arg49_1
    ...
    extern_kernels.addmm(arg53_1, reinterpret_tensor(buf78, (128, 512), (512, 1), 0), reinterpret_tensor(arg52_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf79)
    del arg52_1
    del arg53_1
    buf80 = reinterpret_tensor(buf71, (128, 512), (512, 1), 0); del buf71  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_3_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg55_1, reinterpret_tensor(buf78, (128, 512), (512, 1), 0), reinterpret_tensor(arg54_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf80)
    del arg54_1
    del arg55_1
    buf81 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf82 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_22(c_void_p(buf80.data_ptr()), c_void_p(buf79.data_ptr()), c_void_p(buf81.data_ptr()), c_void_p(buf82.data_ptr()))
    buf83 = reinterpret_tensor(buf73, (16, 128, 128), (16384, 128, 1), 0); del buf73  # reuse
    # Source Nodes: [attn_weights_12], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf82, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf81, (16, 32, 128), (4096, 1, 32), 0), out=buf83)
    ...
    buf87 = reinterpret_tensor(buf82, (128, 512), (512, 1), 0); del buf82  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_3_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg57_1, reinterpret_tensor(buf78, (128, 512), (512, 1), 0), reinterpret_tensor(arg56_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf87)
    del arg56_1
    del arg57_1
    buf88 = reinterpret_tensor(buf80, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf80  # reuse
    ...
    buf90 = reinterpret_tensor(buf87, (16, 128, 32), (4096, 32, 1), 0); del buf87  # reuse
    # Source Nodes: [attn_output_15, attn_weights_15], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf89, reinterpret_tensor(buf88, (16, 128, 32), (4096, 32, 1), 0), out=buf90)
    buf91 = reinterpret_tensor(buf79, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf79  # reuse
    cpp_fused_clone_25(c_void_p(buf90.data_ptr()), c_void_p(buf91.data_ptr()))
    buf92 = reinterpret_tensor(buf90, (128, 512), (512, 1), 0); del buf90  # reuse
    # Source Nodes: [hidden_states_35], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg59_1, reinterpret_tensor(buf91, (128, 512), (512, 1), 0), reinterpret_tensor(arg58_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf92)
    del arg58_1
    del arg59_1
    buf93 = buf76; del buf76  # reuse
    buf94 = buf75; del buf75  # reuse
    buf96 = reinterpret_tensor(buf91, (1, 128, 512), (65536, 512, 1), 0); del buf91  # reuse
    ...
    del arg60_1
    del arg61_1
    buf97 = reinterpret_tensor(buf89, (128, 2048), (2048, 1), 0); del buf89  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_3_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg63_1, reinterpret_tensor(buf96, (128, 512), (512, 1), 0), reinterpret_tensor(arg62_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf97)
    del arg62_1
    del arg63_1
    ...
    extern_kernels.addmm(arg65_1, reinterpret_tensor(buf98, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg64_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf99)
    del arg64_1
    del arg65_1
    ...
    extern_kernels.addmm(arg69_1, reinterpret_tensor(buf103, (128, 512), (512, 1), 0), reinterpret_tensor(arg68_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf104)
    del arg68_1
    del arg69_1
    buf105 = reinterpret_tensor(buf96, (128, 512), (512, 1), 0); del buf96  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_4_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg71_1, reinterpret_tensor(buf103, (128, 512), (512, 1), 0), reinterpret_tensor(arg70_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf105)
    del arg70_1
    del arg71_1
    buf106 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf107 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_29(c_void_p(buf105.data_ptr()), c_void_p(buf104.data_ptr()), c_void_p(buf106.data_ptr()), c_void_p(buf107.data_ptr()))
    buf108 = reinterpret_tensor(buf98, (16, 128, 128), (16384, 128, 1), 0); del buf98  # reuse
    # Source Nodes: [attn_weights_16], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf107, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf106, (16, 32, 128), (4096, 1, 32), 0), out=buf108)
    ...
    buf112 = reinterpret_tensor(buf107, (128, 512), (512, 1), 0); del buf107  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_4_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg73_1, reinterpret_tensor(buf103, (128, 512), (512, 1), 0), reinterpret_tensor(arg72_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf112)
    del arg72_1
    del arg73_1
    buf113 = reinterpret_tensor(buf105, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf105  # reuse
    ...
    buf115 = reinterpret_tensor(buf112, (16, 128, 32), (4096, 32, 1), 0); del buf112  # reuse
    # Source Nodes: [attn_output_20, attn_weights_19], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf114, reinterpret_tensor(buf113, (16, 128, 32), (4096, 32, 1), 0), out=buf115)
    buf116 = reinterpret_tensor(buf104, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf104  # reuse
    cpp_fused_clone_32(c_void_p(buf115.data_ptr()), c_void_p(buf116.data_ptr()))
    buf117 = reinterpret_tensor(buf115, (128, 512), (512, 1), 0); del buf115  # reuse
    # Source Nodes: [hidden_states_46], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg75_1, reinterpret_tensor(buf116, (128, 512), (512, 1), 0), reinterpret_tensor(arg74_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf117)
    del arg74_1
    del arg75_1
    buf118 = buf101; del buf101  # reuse
    buf119 = buf100; del buf100  # reuse
    buf121 = reinterpret_tensor(buf116, (1, 128, 512), (65536, 512, 1), 0); del buf116  # reuse
    ...
    del arg76_1
    del arg77_1
    buf122 = reinterpret_tensor(buf114, (128, 2048), (2048, 1), 0); del buf114  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_4_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg79_1, reinterpret_tensor(buf121, (128, 512), (512, 1), 0), reinterpret_tensor(arg78_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf122)
    del arg78_1
    del arg79_1
    ...
    extern_kernels.addmm(arg81_1, reinterpret_tensor(buf123, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg80_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf124)
    del arg80_1
    del arg81_1
    ...
    extern_kernels.addmm(arg85_1, reinterpret_tensor(buf128, (128, 512), (512, 1), 0), reinterpret_tensor(arg84_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf129)
    del arg84_1
    del arg85_1
    buf130 = reinterpret_tensor(buf121, (128, 512), (512, 1), 0); del buf121  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_5_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg87_1, reinterpret_tensor(buf128, (128, 512), (512, 1), 0), reinterpret_tensor(arg86_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf130)
    del arg86_1
    del arg87_1
    buf131 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf132 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_36(c_void_p(buf130.data_ptr()), c_void_p(buf129.data_ptr()), c_void_p(buf131.data_ptr()), c_void_p(buf132.data_ptr()))
    buf133 = reinterpret_tensor(buf123, (16, 128, 128), (16384, 128, 1), 0); del buf123  # reuse
    # Source Nodes: [attn_weights_20], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf132, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf131, (16, 32, 128), (4096, 1, 32), 0), out=buf133)
    ...
    buf137 = reinterpret_tensor(buf132, (128, 512), (512, 1), 0); del buf132  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_5_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg89_1, reinterpret_tensor(buf128, (128, 512), (512, 1), 0), reinterpret_tensor(arg88_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf137)
    del arg88_1
    del arg89_1
    buf138 = reinterpret_tensor(buf130, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf130  # reuse
    ...
    buf140 = reinterpret_tensor(buf137, (16, 128, 32), (4096, 32, 1), 0); del buf137  # reuse
    # Source Nodes: [attn_output_25, attn_weights_23], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf139, reinterpret_tensor(buf138, (16, 128, 32), (4096, 32, 1), 0), out=buf140)
    buf141 = reinterpret_tensor(buf129, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf129  # reuse
    cpp_fused_clone_39(c_void_p(buf140.data_ptr()), c_void_p(buf141.data_ptr()))
    buf142 = reinterpret_tensor(buf140, (128, 512), (512, 1), 0); del buf140  # reuse
    # Source Nodes: [hidden_states_57], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg91_1, reinterpret_tensor(buf141, (128, 512), (512, 1), 0), reinterpret_tensor(arg90_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf142)
    del arg90_1
    del arg91_1
    buf143 = buf126; del buf126  # reuse
    buf144 = buf125; del buf125  # reuse
    buf146 = reinterpret_tensor(buf141, (1, 128, 512), (65536, 512, 1), 0); del buf141  # reuse
    ...
    del arg92_1
    del arg93_1
    buf147 = reinterpret_tensor(buf139, (128, 2048), (2048, 1), 0); del buf139  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_5_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg95_1, reinterpret_tensor(buf146, (128, 512), (512, 1), 0), reinterpret_tensor(arg94_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf147)
    del arg94_1
    del arg95_1
    ...
    extern_kernels.addmm(arg97_1, reinterpret_tensor(buf148, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg96_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf149)
    del arg96_1
    del arg97_1
    ...
    extern_kernels.addmm(arg101_1, reinterpret_tensor(buf153, (128, 512), (512, 1), 0), reinterpret_tensor(arg100_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf154)
    del arg100_1
    del arg101_1
    buf155 = reinterpret_tensor(buf146, (128, 512), (512, 1), 0); del buf146  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_6_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg103_1, reinterpret_tensor(buf153, (128, 512), (512, 1), 0), reinterpret_tensor(arg102_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf155)
    del arg102_1
    del arg103_1
    buf156 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf157 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_43(c_void_p(buf155.data_ptr()), c_void_p(buf154.data_ptr()), c_void_p(buf156.data_ptr()), c_void_p(buf157.data_ptr()))
    buf158 = reinterpret_tensor(buf148, (16, 128, 128), (16384, 128, 1), 0); del buf148  # reuse
    # Source Nodes: [attn_weights_24], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf157, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf156, (16, 32, 128), (4096, 1, 32), 0), out=buf158)
    ...
    buf162 = reinterpret_tensor(buf157, (128, 512), (512, 1), 0); del buf157  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_6_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg105_1, reinterpret_tensor(buf153, (128, 512), (512, 1), 0), reinterpret_tensor(arg104_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf162)
    del arg104_1
    del arg105_1
    buf163 = reinterpret_tensor(buf155, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf155  # reuse
    ...
    buf165 = reinterpret_tensor(buf162, (16, 128, 32), (4096, 32, 1), 0); del buf162  # reuse
    # Source Nodes: [attn_output_30, attn_weights_27], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf164, reinterpret_tensor(buf163, (16, 128, 32), (4096, 32, 1), 0), out=buf165)
    buf166 = reinterpret_tensor(buf154, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf154  # reuse
    cpp_fused_clone_46(c_void_p(buf165.data_ptr()), c_void_p(buf166.data_ptr()))
    buf167 = reinterpret_tensor(buf165, (128, 512), (512, 1), 0); del buf165  # reuse
    # Source Nodes: [hidden_states_68], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg107_1, reinterpret_tensor(buf166, (128, 512), (512, 1), 0), reinterpret_tensor(arg106_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf167)
    del arg106_1
    del arg107_1
    buf168 = buf151; del buf151  # reuse
    buf169 = buf150; del buf150  # reuse
    buf171 = reinterpret_tensor(buf166, (1, 128, 512), (65536, 512, 1), 0); del buf166  # reuse
    ...
    del arg108_1
    del arg109_1
    buf172 = reinterpret_tensor(buf164, (128, 2048), (2048, 1), 0); del buf164  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_6_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg111_1, reinterpret_tensor(buf171, (128, 512), (512, 1), 0), reinterpret_tensor(arg110_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf172)
    del arg110_1
    del arg111_1
    buf173 = reinterpret_tensor(buf172, (1, 128, 2048), (262144, 2048, 1), 0); del buf172  # reuse
    ...
    extern_kernels.addmm(arg113_1, reinterpret_tensor(buf173, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg112_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf174)
    del arg112_1
    del arg113_1
    ...
    extern_kernels.addmm(arg117_1, reinterpret_tensor(buf178, (128, 512), (512, 1), 0), reinterpret_tensor(arg116_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf179)
    del arg116_1
    del arg117_1
    buf180 = reinterpret_tensor(buf171, (128, 512), (512, 1), 0); del buf171  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_7_self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg119_1, reinterpret_tensor(buf178, (128, 512), (512, 1), 0), reinterpret_tensor(arg118_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf180)
    del arg118_1
    del arg119_1
    buf181 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf182 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    cpp_fused_clone_50(c_void_p(buf180.data_ptr()), c_void_p(buf179.data_ptr()), c_void_p(buf181.data_ptr()), c_void_p(buf182.data_ptr()))
    buf183 = reinterpret_tensor(buf173, (16, 128, 128), (16384, 128, 1), 0); del buf173  # reuse
    # Source Nodes: [attn_weights_28], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf182, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf181, (16, 32, 128), (4096, 1, 32), 0), out=buf183)
    ...
    del buf184
    buf187 = reinterpret_tensor(buf182, (128, 512), (512, 1), 0); del buf182  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_7_self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg121_1, reinterpret_tensor(buf178, (128, 512), (512, 1), 0), reinterpret_tensor(arg120_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf187)
    del arg120_1
    del arg121_1
    buf188 = reinterpret_tensor(buf180, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf180  # reuse
    ...
    del buf186
    buf190 = reinterpret_tensor(buf187, (16, 128, 32), (4096, 32, 1), 0); del buf187  # reuse
    # Source Nodes: [attn_output_35, attn_weights_31], Original ATen: [aten._softmax, aten.bmm]
    extern_kernels.bmm(buf189, reinterpret_tensor(buf188, (16, 128, 32), (4096, 32, 1), 0), out=buf190)
    buf191 = reinterpret_tensor(buf179, (1, 128, 16, 32), (65536, 512, 32, 1), 0); del buf179  # reuse
    cpp_fused_clone_53(c_void_p(buf190.data_ptr()), c_void_p(buf191.data_ptr()))
    buf192 = reinterpret_tensor(buf190, (128, 512), (512, 1), 0); del buf190  # reuse
    # Source Nodes: [hidden_states_79], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg123_1, reinterpret_tensor(buf191, (128, 512), (512, 1), 0), reinterpret_tensor(arg122_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf192)
    del arg122_1
    del arg123_1
    buf193 = buf176; del buf176  # reuse
    buf194 = buf175; del buf175  # reuse
    buf196 = reinterpret_tensor(buf191, (1, 128, 512), (65536, 512, 1), 0); del buf191  # reuse
    ...
    del arg124_1
    del arg125_1
    buf197 = reinterpret_tensor(buf189, (128, 2048), (2048, 1), 0); del buf189  # reuse
    # Source Nodes: [l__mod___model_decoder_layers_7_fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg127_1, reinterpret_tensor(buf196, (128, 512), (512, 1), 0), reinterpret_tensor(arg126_1, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf197)
    del arg126_1
    del arg127_1
    buf198 = reinterpret_tensor(buf197, (1, 128, 2048), (262144, 2048, 1), 0); del buf197  # reuse
    ...
    extern_kernels.addmm(arg129_1, reinterpret_tensor(buf198, (128, 2048), (2048, 1), 0), reinterpret_tensor(arg128_1, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf199)
    del arg128_1
    del arg129_1
    del buf198
    ...
    del buf196
    del buf199
    buf204 = empty((128, 50265), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf203, (128, 512), (512, 1), 0), reinterpret_tensor(arg132_1, (512, 50265), (1, 512), 0), out=buf204)
    del arg132_1
    del buf203
    buf205 = reinterpret_tensor(buf201, (128, 1), (1, 128), 0); del buf201  # reuse
    buf206 = reinterpret_tensor(buf200, (128, 1), (1, 128), 0); del buf200  # reuse
    buf207 = empty((), device='cpu', dtype=torch.float32)
    buf208 = empty((), device='cpu', dtype=torch.int64)
    buf209 = buf207; del buf207  # reuse
    cpp_fused__log_softmax_nll_loss_forward_57(c_void_p(buf209.data_ptr()), c_void_p(buf204.data_ptr()), c_void_p(arg134_1.data_ptr()), c_void_p(buf205.data_ptr()), c_void_p(buf206.data_ptr()), c_void_p(buf208.data_ptr()))
    del arg134_1
    return (buf209, reinterpret_tensor(buf204, (1, 128, 50265), (6433920, 50265, 1), 0), buf6, buf13, buf31, buf38, buf56, buf63, buf81, buf88, buf106, buf113, buf131, buf138, buf156, buf163, buf181, buf188, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((50265, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg10_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg14_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg20_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg26_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg30_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    arg31_1 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    arg32_1 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    arg36_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg46_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    arg47_1 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    arg48_1 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    arg56_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg63_1 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    arg64_1 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    arg68_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg78_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg90_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg94_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    arg95_1 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    arg96_1 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    arg100_1 = rand_strided((512, 512), (512, 1), device='cpu', dtype=torch.float32)
    ...
    arg110_1 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    arg111_1 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    arg112_1 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    arg132_1 = rand_strided((50265, 512), (512, 1), device='cpu', dtype=torch.float32)
    arg133_1 = rand_strided((1, 128), (128, 1), device='cpu', dtype=torch.int64)
    arg134_1 = rand_strided((1, 128), (128, 1), device='cpu', dtype=torch.int64)
