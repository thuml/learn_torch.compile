...
def forward(self, L_cloned_inputs_input_ids_ : torch.Tensor, L_cloned_inputs_start_positions_ : torch.Tensor, L_cloned_inputs_end_positions_ : torch.Tensor):
    ...
    inputs_embeds = self.L__mod___albert_embeddings_word_embeddings(l_cloned_inputs_input_ids_);  l_cloned_inputs_input_ids_ = None
    ...
    sequence_output = self.L__mod___albert_encoder_albert_layer_groups_0_albert_layers_0_full_layer_layer_norm(add_60);  add_60 = None
    ...
    add_61 = start_loss + end_loss;  start_loss = end_loss = None
    loss = add_61 / 2;  add_61 = None
