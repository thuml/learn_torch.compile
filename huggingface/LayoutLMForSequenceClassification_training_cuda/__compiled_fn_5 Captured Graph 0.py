...
def forward(self, L_input_ids_ : torch.Tensor):
    ...
    bbox = torch.zeros((1, 512, 4), dtype = torch.int64, device = device(type='cuda', index=0))
    ...
    l__self___layoutlm_embeddings_position_ids = self.L__self___layoutlm_embeddings_position_ids
    position_ids = l__self___layoutlm_embeddings_position_ids[(slice(None, None, None), slice(None, 512, None))];  l__self___layoutlm_embeddings_position_ids = None
    ...
    words_embeddings = self.L__self___layoutlm_embeddings_word_embeddings(l_input_ids_);  l_input_ids_ = None
    ...
    position_embeddings = self.L__self___layoutlm_embeddings_position_embeddings(position_ids);  position_ids = None
    ...
    left_position_embeddings = self.L__self___layoutlm_embeddings_x_position_embeddings(getitem_1);  getitem_1 = None
    ...
    upper_position_embeddings = self.L__self___layoutlm_embeddings_y_position_embeddings(getitem_2);  getitem_2 = None
    ...
    right_position_embeddings = self.L__self___layoutlm_embeddings_x_position_embeddings(getitem_3);  getitem_3 = None
    ...
    lower_position_embeddings = self.L__self___layoutlm_embeddings_y_position_embeddings(getitem_4);  getitem_4 = None
    ...
    h_position_embeddings = self.L__self___layoutlm_embeddings_h_position_embeddings(sub_1);  sub_1 = None
    ...
    w_position_embeddings = self.L__self___layoutlm_embeddings_w_position_embeddings(sub_2);  sub_2 = None
    ...
    token_type_embeddings = self.L__self___layoutlm_embeddings_token_type_embeddings(token_type_ids);  token_type_ids = None
    ...
    embeddings_1 = self.L__self___layoutlm_embeddings_LayerNorm(embeddings);  embeddings = None
    ...
    embedding_output = self.L__self___layoutlm_embeddings_dropout(embeddings_1);  embeddings_1 = None
    ...
    mixed_query_layer = self.L__self___layoutlm_encoder_layer_0_attention_self_query(embedding_output)
    ...
    l__self___layoutlm_encoder_layer_0_attention_self_key = self.L__self___layoutlm_encoder_layer_0_attention_self_key(embedding_output)
    ...
    x = l__self___layoutlm_encoder_layer_0_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_0_attention_self_key = None
    ...
    l__self___layoutlm_encoder_layer_0_attention_self_value = self.L__self___layoutlm_encoder_layer_0_attention_self_value(embedding_output)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_1 = l__self___layoutlm_encoder_layer_0_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_0_attention_self_value = None
    ...
    attention_probs_1 = self.L__self___layoutlm_encoder_layer_0_attention_self_dropout(attention_probs);  attention_probs = None
    ...
    hidden_states = self.L__self___layoutlm_encoder_layer_0_attention_output_dense(context_layer_2);  context_layer_2 = None
    ...
    hidden_states_1 = self.L__self___layoutlm_encoder_layer_0_attention_output_dropout(hidden_states);  hidden_states = None
    ...
    attention_output = self.L__self___layoutlm_encoder_layer_0_attention_output_LayerNorm(add_9);  add_9 = None
    ...
    hidden_states_3 = self.L__self___layoutlm_encoder_layer_0_intermediate_dense(attention_output)
    ...
    hidden_states_5 = self.L__self___layoutlm_encoder_layer_0_output_dense(intermediate_output);  intermediate_output = None
    ...
    hidden_states_6 = self.L__self___layoutlm_encoder_layer_0_output_dropout(hidden_states_5);  hidden_states_5 = None
    ...
    hidden_states_8 = self.L__self___layoutlm_encoder_layer_0_output_LayerNorm(add_10);  add_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_1 = self.L__self___layoutlm_encoder_layer_1_attention_self_query(hidden_states_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_1_attention_self_key = self.L__self___layoutlm_encoder_layer_1_attention_self_key(hidden_states_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_3 = l__self___layoutlm_encoder_layer_1_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_1_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_1 = x_3.permute(0, 2, 1, 3);  x_3 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_1_attention_self_value = self.L__self___layoutlm_encoder_layer_1_attention_self_value(hidden_states_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_4 = l__self___layoutlm_encoder_layer_1_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_1_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_3 = self.L__self___layoutlm_encoder_layer_1_attention_self_dropout(attention_probs_2);  attention_probs_2 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_9 = self.L__self___layoutlm_encoder_layer_1_attention_output_dense(context_layer_5);  context_layer_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_10 = self.L__self___layoutlm_encoder_layer_1_attention_output_dropout(hidden_states_9);  hidden_states_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_12 = hidden_states_10 + hidden_states_8;  hidden_states_10 = hidden_states_8 = None
    attention_output_2 = self.L__self___layoutlm_encoder_layer_1_attention_output_LayerNorm(add_12);  add_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_12 = self.L__self___layoutlm_encoder_layer_1_intermediate_dense(attention_output_2)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_1 = torch._C._nn.gelu(hidden_states_12);  hidden_states_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_14 = self.L__self___layoutlm_encoder_layer_1_output_dense(intermediate_output_1);  intermediate_output_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_15 = self.L__self___layoutlm_encoder_layer_1_output_dropout(hidden_states_14);  hidden_states_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_13 = hidden_states_15 + attention_output_2;  hidden_states_15 = attention_output_2 = None
    hidden_states_17 = self.L__self___layoutlm_encoder_layer_1_output_LayerNorm(add_13);  add_13 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_2 = self.L__self___layoutlm_encoder_layer_2_attention_self_query(hidden_states_17)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_2_attention_self_key = self.L__self___layoutlm_encoder_layer_2_attention_self_key(hidden_states_17)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_6 = l__self___layoutlm_encoder_layer_2_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_2_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_2 = x_6.permute(0, 2, 1, 3);  x_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_2_attention_self_value = self.L__self___layoutlm_encoder_layer_2_attention_self_value(hidden_states_17)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_7 = l__self___layoutlm_encoder_layer_2_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_2_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_5 = self.L__self___layoutlm_encoder_layer_2_attention_self_dropout(attention_probs_4);  attention_probs_4 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_18 = self.L__self___layoutlm_encoder_layer_2_attention_output_dense(context_layer_8);  context_layer_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_19 = self.L__self___layoutlm_encoder_layer_2_attention_output_dropout(hidden_states_18);  hidden_states_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_15 = hidden_states_19 + hidden_states_17;  hidden_states_19 = hidden_states_17 = None
    attention_output_4 = self.L__self___layoutlm_encoder_layer_2_attention_output_LayerNorm(add_15);  add_15 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_21 = self.L__self___layoutlm_encoder_layer_2_intermediate_dense(attention_output_4)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_2 = torch._C._nn.gelu(hidden_states_21);  hidden_states_21 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_23 = self.L__self___layoutlm_encoder_layer_2_output_dense(intermediate_output_2);  intermediate_output_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_24 = self.L__self___layoutlm_encoder_layer_2_output_dropout(hidden_states_23);  hidden_states_23 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_16 = hidden_states_24 + attention_output_4;  hidden_states_24 = attention_output_4 = None
    hidden_states_26 = self.L__self___layoutlm_encoder_layer_2_output_LayerNorm(add_16);  add_16 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_3 = self.L__self___layoutlm_encoder_layer_3_attention_self_query(hidden_states_26)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_3_attention_self_key = self.L__self___layoutlm_encoder_layer_3_attention_self_key(hidden_states_26)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_9 = l__self___layoutlm_encoder_layer_3_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_3_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_3 = x_9.permute(0, 2, 1, 3);  x_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_3_attention_self_value = self.L__self___layoutlm_encoder_layer_3_attention_self_value(hidden_states_26)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_10 = l__self___layoutlm_encoder_layer_3_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_3_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_7 = self.L__self___layoutlm_encoder_layer_3_attention_self_dropout(attention_probs_6);  attention_probs_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_27 = self.L__self___layoutlm_encoder_layer_3_attention_output_dense(context_layer_11);  context_layer_11 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_28 = self.L__self___layoutlm_encoder_layer_3_attention_output_dropout(hidden_states_27);  hidden_states_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_18 = hidden_states_28 + hidden_states_26;  hidden_states_28 = hidden_states_26 = None
    attention_output_6 = self.L__self___layoutlm_encoder_layer_3_attention_output_LayerNorm(add_18);  add_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_30 = self.L__self___layoutlm_encoder_layer_3_intermediate_dense(attention_output_6)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_3 = torch._C._nn.gelu(hidden_states_30);  hidden_states_30 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_32 = self.L__self___layoutlm_encoder_layer_3_output_dense(intermediate_output_3);  intermediate_output_3 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_33 = self.L__self___layoutlm_encoder_layer_3_output_dropout(hidden_states_32);  hidden_states_32 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_19 = hidden_states_33 + attention_output_6;  hidden_states_33 = attention_output_6 = None
    hidden_states_35 = self.L__self___layoutlm_encoder_layer_3_output_LayerNorm(add_19);  add_19 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_4 = self.L__self___layoutlm_encoder_layer_4_attention_self_query(hidden_states_35)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_4_attention_self_key = self.L__self___layoutlm_encoder_layer_4_attention_self_key(hidden_states_35)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_12 = l__self___layoutlm_encoder_layer_4_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_4_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_4 = x_12.permute(0, 2, 1, 3);  x_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_4_attention_self_value = self.L__self___layoutlm_encoder_layer_4_attention_self_value(hidden_states_35)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_13 = l__self___layoutlm_encoder_layer_4_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_4_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_9 = self.L__self___layoutlm_encoder_layer_4_attention_self_dropout(attention_probs_8);  attention_probs_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_36 = self.L__self___layoutlm_encoder_layer_4_attention_output_dense(context_layer_14);  context_layer_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_37 = self.L__self___layoutlm_encoder_layer_4_attention_output_dropout(hidden_states_36);  hidden_states_36 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_21 = hidden_states_37 + hidden_states_35;  hidden_states_37 = hidden_states_35 = None
    attention_output_8 = self.L__self___layoutlm_encoder_layer_4_attention_output_LayerNorm(add_21);  add_21 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_39 = self.L__self___layoutlm_encoder_layer_4_intermediate_dense(attention_output_8)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_4 = torch._C._nn.gelu(hidden_states_39);  hidden_states_39 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_41 = self.L__self___layoutlm_encoder_layer_4_output_dense(intermediate_output_4);  intermediate_output_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_42 = self.L__self___layoutlm_encoder_layer_4_output_dropout(hidden_states_41);  hidden_states_41 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_22 = hidden_states_42 + attention_output_8;  hidden_states_42 = attention_output_8 = None
    hidden_states_44 = self.L__self___layoutlm_encoder_layer_4_output_LayerNorm(add_22);  add_22 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_5 = self.L__self___layoutlm_encoder_layer_5_attention_self_query(hidden_states_44)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_5_attention_self_key = self.L__self___layoutlm_encoder_layer_5_attention_self_key(hidden_states_44)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_15 = l__self___layoutlm_encoder_layer_5_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_5_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_5 = x_15.permute(0, 2, 1, 3);  x_15 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_5_attention_self_value = self.L__self___layoutlm_encoder_layer_5_attention_self_value(hidden_states_44)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_16 = l__self___layoutlm_encoder_layer_5_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_5_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_11 = self.L__self___layoutlm_encoder_layer_5_attention_self_dropout(attention_probs_10);  attention_probs_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_45 = self.L__self___layoutlm_encoder_layer_5_attention_output_dense(context_layer_17);  context_layer_17 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_46 = self.L__self___layoutlm_encoder_layer_5_attention_output_dropout(hidden_states_45);  hidden_states_45 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_24 = hidden_states_46 + hidden_states_44;  hidden_states_46 = hidden_states_44 = None
    attention_output_10 = self.L__self___layoutlm_encoder_layer_5_attention_output_LayerNorm(add_24);  add_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_48 = self.L__self___layoutlm_encoder_layer_5_intermediate_dense(attention_output_10)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_5 = torch._C._nn.gelu(hidden_states_48);  hidden_states_48 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_50 = self.L__self___layoutlm_encoder_layer_5_output_dense(intermediate_output_5);  intermediate_output_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_51 = self.L__self___layoutlm_encoder_layer_5_output_dropout(hidden_states_50);  hidden_states_50 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_25 = hidden_states_51 + attention_output_10;  hidden_states_51 = attention_output_10 = None
    hidden_states_53 = self.L__self___layoutlm_encoder_layer_5_output_LayerNorm(add_25);  add_25 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_6 = self.L__self___layoutlm_encoder_layer_6_attention_self_query(hidden_states_53)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_6_attention_self_key = self.L__self___layoutlm_encoder_layer_6_attention_self_key(hidden_states_53)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_18 = l__self___layoutlm_encoder_layer_6_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_6_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_6 = x_18.permute(0, 2, 1, 3);  x_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_6_attention_self_value = self.L__self___layoutlm_encoder_layer_6_attention_self_value(hidden_states_53)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_19 = l__self___layoutlm_encoder_layer_6_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_6_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_13 = self.L__self___layoutlm_encoder_layer_6_attention_self_dropout(attention_probs_12);  attention_probs_12 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_54 = self.L__self___layoutlm_encoder_layer_6_attention_output_dense(context_layer_20);  context_layer_20 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_55 = self.L__self___layoutlm_encoder_layer_6_attention_output_dropout(hidden_states_54);  hidden_states_54 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_27 = hidden_states_55 + hidden_states_53;  hidden_states_55 = hidden_states_53 = None
    attention_output_12 = self.L__self___layoutlm_encoder_layer_6_attention_output_LayerNorm(add_27);  add_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_57 = self.L__self___layoutlm_encoder_layer_6_intermediate_dense(attention_output_12)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_6 = torch._C._nn.gelu(hidden_states_57);  hidden_states_57 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_59 = self.L__self___layoutlm_encoder_layer_6_output_dense(intermediate_output_6);  intermediate_output_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_60 = self.L__self___layoutlm_encoder_layer_6_output_dropout(hidden_states_59);  hidden_states_59 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_28 = hidden_states_60 + attention_output_12;  hidden_states_60 = attention_output_12 = None
    hidden_states_62 = self.L__self___layoutlm_encoder_layer_6_output_LayerNorm(add_28);  add_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_7 = self.L__self___layoutlm_encoder_layer_7_attention_self_query(hidden_states_62)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_7_attention_self_key = self.L__self___layoutlm_encoder_layer_7_attention_self_key(hidden_states_62)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_21 = l__self___layoutlm_encoder_layer_7_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_7_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_7 = x_21.permute(0, 2, 1, 3);  x_21 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_7_attention_self_value = self.L__self___layoutlm_encoder_layer_7_attention_self_value(hidden_states_62)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_22 = l__self___layoutlm_encoder_layer_7_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_7_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_15 = self.L__self___layoutlm_encoder_layer_7_attention_self_dropout(attention_probs_14);  attention_probs_14 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_63 = self.L__self___layoutlm_encoder_layer_7_attention_output_dense(context_layer_23);  context_layer_23 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_64 = self.L__self___layoutlm_encoder_layer_7_attention_output_dropout(hidden_states_63);  hidden_states_63 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_30 = hidden_states_64 + hidden_states_62;  hidden_states_64 = hidden_states_62 = None
    attention_output_14 = self.L__self___layoutlm_encoder_layer_7_attention_output_LayerNorm(add_30);  add_30 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_66 = self.L__self___layoutlm_encoder_layer_7_intermediate_dense(attention_output_14)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_7 = torch._C._nn.gelu(hidden_states_66);  hidden_states_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_68 = self.L__self___layoutlm_encoder_layer_7_output_dense(intermediate_output_7);  intermediate_output_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_69 = self.L__self___layoutlm_encoder_layer_7_output_dropout(hidden_states_68);  hidden_states_68 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_31 = hidden_states_69 + attention_output_14;  hidden_states_69 = attention_output_14 = None
    hidden_states_71 = self.L__self___layoutlm_encoder_layer_7_output_LayerNorm(add_31);  add_31 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_8 = self.L__self___layoutlm_encoder_layer_8_attention_self_query(hidden_states_71)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_8_attention_self_key = self.L__self___layoutlm_encoder_layer_8_attention_self_key(hidden_states_71)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_24 = l__self___layoutlm_encoder_layer_8_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_8_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_8 = x_24.permute(0, 2, 1, 3);  x_24 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_8_attention_self_value = self.L__self___layoutlm_encoder_layer_8_attention_self_value(hidden_states_71)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_25 = l__self___layoutlm_encoder_layer_8_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_8_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_17 = self.L__self___layoutlm_encoder_layer_8_attention_self_dropout(attention_probs_16);  attention_probs_16 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_72 = self.L__self___layoutlm_encoder_layer_8_attention_output_dense(context_layer_26);  context_layer_26 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_73 = self.L__self___layoutlm_encoder_layer_8_attention_output_dropout(hidden_states_72);  hidden_states_72 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_33 = hidden_states_73 + hidden_states_71;  hidden_states_73 = hidden_states_71 = None
    attention_output_16 = self.L__self___layoutlm_encoder_layer_8_attention_output_LayerNorm(add_33);  add_33 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_75 = self.L__self___layoutlm_encoder_layer_8_intermediate_dense(attention_output_16)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_8 = torch._C._nn.gelu(hidden_states_75);  hidden_states_75 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_77 = self.L__self___layoutlm_encoder_layer_8_output_dense(intermediate_output_8);  intermediate_output_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_78 = self.L__self___layoutlm_encoder_layer_8_output_dropout(hidden_states_77);  hidden_states_77 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_34 = hidden_states_78 + attention_output_16;  hidden_states_78 = attention_output_16 = None
    hidden_states_80 = self.L__self___layoutlm_encoder_layer_8_output_LayerNorm(add_34);  add_34 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_9 = self.L__self___layoutlm_encoder_layer_9_attention_self_query(hidden_states_80)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_9_attention_self_key = self.L__self___layoutlm_encoder_layer_9_attention_self_key(hidden_states_80)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_27 = l__self___layoutlm_encoder_layer_9_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_9_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_9 = x_27.permute(0, 2, 1, 3);  x_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_9_attention_self_value = self.L__self___layoutlm_encoder_layer_9_attention_self_value(hidden_states_80)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_28 = l__self___layoutlm_encoder_layer_9_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_9_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_19 = self.L__self___layoutlm_encoder_layer_9_attention_self_dropout(attention_probs_18);  attention_probs_18 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_81 = self.L__self___layoutlm_encoder_layer_9_attention_output_dense(context_layer_29);  context_layer_29 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_82 = self.L__self___layoutlm_encoder_layer_9_attention_output_dropout(hidden_states_81);  hidden_states_81 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_36 = hidden_states_82 + hidden_states_80;  hidden_states_82 = hidden_states_80 = None
    attention_output_18 = self.L__self___layoutlm_encoder_layer_9_attention_output_LayerNorm(add_36);  add_36 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_84 = self.L__self___layoutlm_encoder_layer_9_intermediate_dense(attention_output_18)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_9 = torch._C._nn.gelu(hidden_states_84);  hidden_states_84 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_86 = self.L__self___layoutlm_encoder_layer_9_output_dense(intermediate_output_9);  intermediate_output_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_87 = self.L__self___layoutlm_encoder_layer_9_output_dropout(hidden_states_86);  hidden_states_86 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_37 = hidden_states_87 + attention_output_18;  hidden_states_87 = attention_output_18 = None
    hidden_states_89 = self.L__self___layoutlm_encoder_layer_9_output_LayerNorm(add_37);  add_37 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_10 = self.L__self___layoutlm_encoder_layer_10_attention_self_query(hidden_states_89)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_10_attention_self_key = self.L__self___layoutlm_encoder_layer_10_attention_self_key(hidden_states_89)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_30 = l__self___layoutlm_encoder_layer_10_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_10_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_10 = x_30.permute(0, 2, 1, 3);  x_30 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_10_attention_self_value = self.L__self___layoutlm_encoder_layer_10_attention_self_value(hidden_states_89)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_31 = l__self___layoutlm_encoder_layer_10_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_10_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_21 = self.L__self___layoutlm_encoder_layer_10_attention_self_dropout(attention_probs_20);  attention_probs_20 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_90 = self.L__self___layoutlm_encoder_layer_10_attention_output_dense(context_layer_32);  context_layer_32 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_91 = self.L__self___layoutlm_encoder_layer_10_attention_output_dropout(hidden_states_90);  hidden_states_90 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_39 = hidden_states_91 + hidden_states_89;  hidden_states_91 = hidden_states_89 = None
    attention_output_20 = self.L__self___layoutlm_encoder_layer_10_attention_output_LayerNorm(add_39);  add_39 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_93 = self.L__self___layoutlm_encoder_layer_10_intermediate_dense(attention_output_20)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_10 = torch._C._nn.gelu(hidden_states_93);  hidden_states_93 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_95 = self.L__self___layoutlm_encoder_layer_10_output_dense(intermediate_output_10);  intermediate_output_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_96 = self.L__self___layoutlm_encoder_layer_10_output_dropout(hidden_states_95);  hidden_states_95 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_40 = hidden_states_96 + attention_output_20;  hidden_states_96 = attention_output_20 = None
    hidden_states_98 = self.L__self___layoutlm_encoder_layer_10_output_LayerNorm(add_40);  add_40 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:174, code: mixed_query_layer = self.query(hidden_states)
    mixed_query_layer_11 = self.L__self___layoutlm_encoder_layer_11_attention_self_query(hidden_states_98)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:196, code: key_layer = self.transpose_for_scores(self.key(hidden_states))
    l__self___layoutlm_encoder_layer_11_attention_self_key = self.L__self___layoutlm_encoder_layer_11_attention_self_key(hidden_states_98)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_33 = l__self___layoutlm_encoder_layer_11_attention_self_key.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_11_attention_self_key = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:162, code: return x.permute(0, 2, 1, 3)
    key_layer_11 = x_33.permute(0, 2, 1, 3);  x_33 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:197, code: value_layer = self.transpose_for_scores(self.value(hidden_states))
    l__self___layoutlm_encoder_layer_11_attention_self_value = self.L__self___layoutlm_encoder_layer_11_attention_self_value(hidden_states_98)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:161, code: x = x.view(new_x_shape)
    x_34 = l__self___layoutlm_encoder_layer_11_attention_self_value.view((1, 512, 12, 64));  l__self___layoutlm_encoder_layer_11_attention_self_value = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:247, code: attention_probs = self.dropout(attention_probs)
    attention_probs_23 = self.L__self___layoutlm_encoder_layer_11_attention_self_dropout(attention_probs_22);  attention_probs_22 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:275, code: hidden_states = self.dense(hidden_states)
    hidden_states_99 = self.L__self___layoutlm_encoder_layer_11_attention_output_dense(context_layer_35);  context_layer_35 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:276, code: hidden_states = self.dropout(hidden_states)
    hidden_states_100 = self.L__self___layoutlm_encoder_layer_11_attention_output_dropout(hidden_states_99);  hidden_states_99 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:277, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_42 = hidden_states_100 + hidden_states_98;  hidden_states_100 = hidden_states_98 = None
    attention_output_22 = self.L__self___layoutlm_encoder_layer_11_attention_output_LayerNorm(add_42);  add_42 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:342, code: hidden_states = self.dense(hidden_states)
    hidden_states_102 = self.L__self___layoutlm_encoder_layer_11_intermediate_dense(attention_output_22)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    intermediate_output_11 = torch._C._nn.gelu(hidden_states_102);  hidden_states_102 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:356, code: hidden_states = self.dense(hidden_states)
    hidden_states_104 = self.L__self___layoutlm_encoder_layer_11_output_dense(intermediate_output_11);  intermediate_output_11 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:357, code: hidden_states = self.dropout(hidden_states)
    hidden_states_105 = self.L__self___layoutlm_encoder_layer_11_output_dropout(hidden_states_104);  hidden_states_104 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/layoutlm/modeling_layoutlm.py:358, code: hidden_states = self.LayerNorm(hidden_states + input_tensor)
    add_43 = hidden_states_105 + attention_output_22;  hidden_states_105 = attention_output_22 = None
    sequence_output = self.L__self___layoutlm_encoder_layer_11_output_LayerNorm(add_43);  add_43 = None
    ...
    pooled_output = self.L__self___layoutlm_pooler_dense(first_token_tensor);  first_token_tensor = None
    ...
    pooled_output_3 = self.L__self___layoutlm_pooler_activation(pooled_output);  pooled_output = None
    ...
    pooled_output_4 = self.L__self___dropout(pooled_output_3)
    ...
    logits = self.L__self___classifier(pooled_output_4);  pooled_output_4 = None
    return (sequence_output, pooled_output_3, logits)
