...
# kernel path: /tmp/torchinductor_youkaichao/5i/c5iu3qpkg53retiyptni4vdvg7eddd526a7zdzi4xqe7rrjeybvj.py
# Source Nodes: [pooled_output_3], Original ATen: [aten.tanh]
# pooled_output_3 => tanh
triton_poi_fused_tanh_7 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(2,))]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_tanh_7', 'mutated_arg_names': ['in_out_ptr0']},
    min_elem_per_thread=0
)
@triton.jit
...
# kernel path: /tmp/torchinductor_youkaichao/2c/c2cow4qqts36eunto46mcga3mkju2tdb3gecqhbs3m367zwrgfcl.py
# Source Nodes: [bbox], Original ATen: [aten.zeros]
# bbox => full_2
triton_poi_fused_zeros_8 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*i64', 1: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [instance_descriptor(divisible_by_16=(0, 1), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(1,))]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_zeros_8', 'mutated_arg_names': []},
    min_elem_per_thread=0
)
@triton.jit
def triton_(out_ptr0, xnumel, XBLOCK : tl.constexpr):
...
def call(args):
    ...
    assert_size_stride(primals_204, (2, 768), (768, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [add, add_1, add_2, add_3, add_4, add_5, add_6, embeddings, embeddings_1, h_position_embeddings, left_position_embeddings, lower_position_embeddings, position_embeddings, right_position_embeddings, token_type_embeddings, upper_position_embeddings, w_position_embeddings, words_embeddings], Original ATen: [aten.add, aten.embedding, aten.native_layer_norm, aten.native_layer_norm_backward]
        triton_per_fused_add_embedding_native_layer_norm_native_layer_norm_backward_1.run(primals_207, primals_1, primals_206, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, buf1, buf5, buf6, buf424, 512, 768, grid=grid(512), stream=stream0)
        del primals_1
        del primals_2
        del primals_3
        del primals_4
        ...
        # Source Nodes: [add_9, attention_output, hidden_states_3], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_4.run(buf24, buf8, primals_18, primals_19, buf29, buf30, buf423, 512, 768, grid=grid(512), stream=stream0)
        ...
        # Source Nodes: [add_10, attention_output, hidden_states_8, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf35, buf29, primals_18, primals_19, primals_24, primals_25, buf40, buf41, buf422, 512, 768, grid=grid(512), stream=stream0)
        del primals_19
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf56, buf40, primals_24, primals_25, primals_34, primals_35, buf61, buf62, buf421, 512, 768, grid=grid(512), stream=stream0)
        del primals_25
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf67, buf61, primals_34, primals_35, primals_40, primals_41, buf72, buf73, buf420, 512, 768, grid=grid(512), stream=stream0)
        del primals_35
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf88, buf72, primals_40, primals_41, primals_50, primals_51, buf93, buf94, buf419, 512, 768, grid=grid(512), stream=stream0)
        del primals_41
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf99, buf93, primals_50, primals_51, primals_56, primals_57, buf104, buf105, buf418, 512, 768, grid=grid(512), stream=stream0)
        del primals_51
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf120, buf104, primals_56, primals_57, primals_66, primals_67, buf125, buf126, buf417, 512, 768, grid=grid(512), stream=stream0)
        del primals_57
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf131, buf125, primals_66, primals_67, primals_72, primals_73, buf136, buf137, buf416, 512, 768, grid=grid(512), stream=stream0)
        del primals_67
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf152, buf136, primals_72, primals_73, primals_82, primals_83, buf157, buf158, buf415, 512, 768, grid=grid(512), stream=stream0)
        del primals_73
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf163, buf157, primals_82, primals_83, primals_88, primals_89, buf168, buf169, buf414, 512, 768, grid=grid(512), stream=stream0)
        del primals_83
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf184, buf168, primals_88, primals_89, primals_98, primals_99, buf189, buf190, buf413, 512, 768, grid=grid(512), stream=stream0)
        del primals_89
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf195, buf189, primals_98, primals_99, primals_104, primals_105, buf200, buf201, buf412, 512, 768, grid=grid(512), stream=stream0)
        del primals_99
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf216, buf200, primals_104, primals_105, primals_114, primals_115, buf221, buf222, buf411, 512, 768, grid=grid(512), stream=stream0)
        del primals_105
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf227, buf221, primals_114, primals_115, primals_120, primals_121, buf232, buf233, buf410, 512, 768, grid=grid(512), stream=stream0)
        del primals_115
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf248, buf232, primals_120, primals_121, primals_130, primals_131, buf253, buf254, buf409, 512, 768, grid=grid(512), stream=stream0)
        del primals_121
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf259, buf253, primals_130, primals_131, primals_136, primals_137, buf264, buf265, buf408, 512, 768, grid=grid(512), stream=stream0)
        del primals_131
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf280, buf264, primals_136, primals_137, primals_146, primals_147, buf285, buf286, buf407, 512, 768, grid=grid(512), stream=stream0)
        del primals_137
        ...
        buf406 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf291, buf285, primals_146, primals_147, primals_152, primals_153, buf296, buf297, buf406, 512, 768, grid=grid(512), stream=stream0)
        del primals_147
        ...
        buf405 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf312, buf296, primals_152, primals_153, primals_162, primals_163, buf317, buf318, buf405, 512, 768, grid=grid(512), stream=stream0)
        del primals_153
        ...
        buf404 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf323, buf317, primals_162, primals_163, primals_168, primals_169, buf328, buf329, buf404, 512, 768, grid=grid(512), stream=stream0)
        del primals_163
        ...
        buf403 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf344, buf328, primals_168, primals_169, primals_178, primals_179, buf349, buf350, buf403, 512, 768, grid=grid(512), stream=stream0)
        del primals_169
        ...
        buf402 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf355, buf349, primals_178, primals_179, primals_184, primals_185, buf360, buf361, buf402, 512, 768, grid=grid(512), stream=stream0)
        del primals_179
        ...
        buf401 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf376, buf360, primals_184, primals_185, primals_194, primals_195, buf381, buf382, buf401, 512, 768, grid=grid(512), stream=stream0)
        del primals_185
        ...
        buf393 = empty((1, 512, 768), device='cuda', dtype=torch.float32)
        buf400 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_43, attention_output_22, sequence_output], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf387, buf381, primals_194, primals_195, primals_200, primals_201, buf392, buf393, buf400, 512, 768, grid=grid(512), stream=stream0)
        del buf387
        del primals_195
        del primals_201
        buf394 = empty((1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf393, (1, 768), (768, 1), 0), reinterpret_tensor(primals_202, (768, 768), (1, 768), 0), out=buf394)
        buf395 = buf394; del buf394  # reuse
        # Source Nodes: [pooled_output_3], Original ATen: [aten.tanh]
        triton_poi_fused_tanh_7.run(buf395, primals_203, 768, grid=grid(768), stream=stream0)
        del primals_203
        # Source Nodes: [pooled_output_4], Original ATen: [aten.native_dropout]
        buf396 = aten.native_dropout(buf395, 0.1, True)
        buf397 = buf396[0]
        buf398 = buf396[1]
        del buf396
        buf399 = empty((1, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [logits], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_205, buf397, reinterpret_tensor(primals_204, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf399)
        del primals_205
        buf425 = empty((1, 512, 4), device='cuda', dtype=torch.int64)
        # Source Nodes: [bbox], Original ATen: [aten.zeros]
        triton_poi_fused_zeros_8.run(buf425, 2048, grid=grid(2048), stream=stream0)
        return (buf393, buf395, buf399, primals_8, primals_18, primals_24, primals_34, primals_40, primals_50, primals_56, primals_66, primals_72, primals_82, primals_88, primals_98, primals_104, primals_114, primals_120, primals_130, primals_136, primals_146, primals_152, primals_162, primals_168, primals_178, primals_184, primals_194, primals_200, primals_207, buf0, primals_206, reinterpret_tensor(buf425, (1, 512), (0, 4), 0), reinterpret_tensor(buf425, (1, 512), (0, 4), 1), reinterpret_tensor(buf425, (1, 512), (0, 4), 2), reinterpret_tensor(buf425, (1, 512), (0, 4), 3), buf5, buf9, reinterpret_tensor(buf8, (512, 768), (768, 1), 0), buf13, buf14, buf15, buf18, buf19, buf20, buf17, buf21, buf25, buf29, buf30, buf31, buf32, buf36, buf40, buf41, buf45, buf46, buf47, buf50, buf51, buf52, buf49, buf53, buf57, buf61, buf62, buf63, buf64, buf68, buf72, buf73, buf77, buf78, buf79, buf82, buf83, buf84, buf81, buf85, buf89, buf93, buf94, buf95, buf96, buf100, buf104, buf105, buf109, buf110, buf111, buf114, buf115, buf116, buf113, buf117, buf121, buf125, buf126, buf127, buf128, buf132, buf136, buf137, buf141, buf142, buf143, buf146, buf147, buf148, buf145, buf149, buf153, buf157, buf158, buf159, buf160, buf164, buf168, buf169, buf173, buf174, buf175, buf178, buf179, buf180, buf177, buf181, buf185, buf189, buf190, buf191, buf192, buf196, buf200, buf201, buf205, buf206, buf207, buf210, buf211, buf212, buf209, buf213, buf217, buf221, buf222, buf223, buf224, buf228, buf232, buf233, buf237, buf238, buf239, buf242, buf243, buf244, buf241, buf245, buf249, buf253, buf254, buf255, buf256, buf260, buf264, buf265, buf269, buf270, buf271, buf274, buf275, buf276, buf273, buf277, buf281, buf285, buf286, buf287, buf288, buf292, buf296, buf297, buf301, buf302, buf303, buf306, buf307, buf308, buf305, buf309, buf313, buf317, buf318, buf319, buf320, buf324, buf328, buf329, buf333, buf334, buf335, buf338, buf339, buf340, buf337, buf341, buf345, buf349, buf350, buf351, buf352, buf356, buf360, buf361, buf365, buf366, buf367, buf370, buf371, buf372, buf369, buf373, buf377, buf381, buf382, buf383, buf384, buf388, buf392, reinterpret_tensor(buf393, (1, 768), (768, 1), 0), buf395, buf397, buf398, reinterpret_tensor(primals_204, (2, 768), (768, 1), 0), reinterpret_tensor(primals_202, (768, 768), (768, 1), 0), buf400, reinterpret_tensor(primals_198, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_196, (3072, 768), (768, 1), 0), buf401, reinterpret_tensor(primals_192, (768, 768), (768, 1), 0), reinterpret_tensor(primals_190, (768, 768), (768, 1), 0), reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), buf402, reinterpret_tensor(primals_182, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_180, (3072, 768), (768, 1), 0), buf403, reinterpret_tensor(primals_176, (768, 768), (768, 1), 0), reinterpret_tensor(primals_174, (768, 768), (768, 1), 0), reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), buf404, reinterpret_tensor(primals_166, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_164, (3072, 768), (768, 1), 0), buf405, reinterpret_tensor(primals_160, (768, 768), (768, 1), 0), reinterpret_tensor(primals_158, (768, 768), (768, 1), 0), reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), buf406, reinterpret_tensor(primals_150, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_148, (3072, 768), (768, 1), 0), buf407, reinterpret_tensor(primals_144, (768, 768), (768, 1), 0), reinterpret_tensor(primals_142, (768, 768), (768, 1), 0), reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), buf408, reinterpret_tensor(primals_134, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_132, (3072, 768), (768, 1), 0), buf409, reinterpret_tensor(primals_128, (768, 768), (768, 1), 0), reinterpret_tensor(primals_126, (768, 768), (768, 1), 0), reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), buf410, reinterpret_tensor(primals_118, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_116, (3072, 768), (768, 1), 0), buf411, reinterpret_tensor(primals_112, (768, 768), (768, 1), 0), reinterpret_tensor(primals_110, (768, 768), (768, 1), 0), reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), buf412, reinterpret_tensor(primals_102, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_100, (3072, 768), (768, 1), 0), buf413, reinterpret_tensor(primals_96, (768, 768), (768, 1), 0), reinterpret_tensor(primals_94, (768, 768), (768, 1), 0), reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), buf414, reinterpret_tensor(primals_86, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_84, (3072, 768), (768, 1), 0), buf415, reinterpret_tensor(primals_80, (768, 768), (768, 1), 0), reinterpret_tensor(primals_78, (768, 768), (768, 1), 0), reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), buf416, reinterpret_tensor(primals_70, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_68, (3072, 768), (768, 1), 0), buf417, reinterpret_tensor(primals_64, (768, 768), (768, 1), 0), reinterpret_tensor(primals_62, (768, 768), (768, 1), 0), reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), buf418, reinterpret_tensor(primals_54, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_52, (3072, 768), (768, 1), 0), buf419, reinterpret_tensor(primals_48, (768, 768), (768, 1), 0), reinterpret_tensor(primals_46, (768, 768), (768, 1), 0), reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), buf420, reinterpret_tensor(primals_38, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_36, (3072, 768), (768, 1), 0), buf421, reinterpret_tensor(primals_32, (768, 768), (768, 1), 0), reinterpret_tensor(primals_30, (768, 768), (768, 1), 0), reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), buf422, reinterpret_tensor(primals_22, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_20, (3072, 768), (768, 1), 0), buf423, reinterpret_tensor(primals_16, (768, 768), (768, 1), 0), reinterpret_tensor(primals_14, (768, 768), (768, 1), 0), reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), buf424, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_204 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    ...
    return print_performance(lambda: call([primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109, primals_110, primals_111, primals_112, primals_113, primals_114, primals_115, primals_116, primals_117, primals_118, primals_119, primals_120, primals_121, primals_122, primals_123, primals_124, primals_125, primals_126, primals_127, primals_128, primals_129, primals_130, primals_131, primals_132, primals_133, primals_134, primals_135, primals_136, primals_137, primals_138, primals_139, primals_140, primals_141, primals_142, primals_143, primals_144, primals_145, primals_146, primals_147, primals_148, primals_149, primals_150, primals_151, primals_152, primals_153, primals_154, primals_155, primals_156, primals_157, primals_158, primals_159, primals_160, primals_161, primals_162, primals_163, primals_164, primals_165, primals_166, primals_167, primals_168, primals_169, primals_170, primals_171, primals_172, primals_173, primals_174, primals_175, primals_176, primals_177, primals_178, primals_179, primals_180, primals_181, primals_182, primals_183, primals_184, primals_185, primals_186, primals_187, primals_188, primals_189, primals_190, primals_191, primals_192, primals_193, primals_194, primals_195, primals_196, primals_197, primals_198, primals_199, primals_200, primals_201, primals_202, primals_203, primals_204, primals_205, primals_206, primals_207]), times=times, repeat=repeat)
