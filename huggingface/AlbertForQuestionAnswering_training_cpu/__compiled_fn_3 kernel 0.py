...
cpp_fused__log_softmax__softmax_add_clamp_clone_detach_div_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_61 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_view_0(c_void_p(primals_28.data_ptr()), c_void_p(primals_1.data_ptr()), c_void_p(primals_26.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(primals_27.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(primals_5.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf5.data_ptr()))
    del buf0
    del primals_1
    del primals_2
    del primals_3
    ...
    buf327 = empty((1, 64, 512, 512), device='cpu', dtype=torch.float32)
    cpp_fused__softmax_add_clone_detach_51(c_void_p(buf262.data_ptr()), c_void_p(buf261.data_ptr()), c_void_p(buf263.data_ptr()), c_void_p(buf264.data_ptr()), c_void_p(buf327.data_ptr()))
    ...
    buf324 = empty((1, 64, 512, 512), device='cpu', dtype=torch.float32)
    cpp_fused__softmax_add_clone_detach_56(c_void_p(buf287.data_ptr()), c_void_p(buf286.data_ptr()), c_void_p(buf288.data_ptr()), c_void_p(buf289.data_ptr()), c_void_p(buf324.data_ptr()))
    del buf286
    del buf287
    del buf288
    ...
    del primals_17
    del primals_23
    buf307 = empty((512, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_25, buf306, reinterpret_tensor(primals_24, (4096, 2), (1, 4096), 0), alpha=1, beta=1, out=buf307)
    del primals_25
    buf308 = reinterpret_tensor(buf302, (1, 512), (512, 1), 0); del buf302  # reuse
    buf310 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf309 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf314 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf311 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf312 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf315 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf316 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf313 = empty((1, ), device='cpu', dtype=torch.bool)
    buf317 = empty((1, ), device='cpu', dtype=torch.bool)
    buf359 = empty((), device='cpu', dtype=torch.float32)
    buf318 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf319 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf320 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf321 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf322 = reinterpret_tensor(buf303, (1, 512, 1), (512, 1, 1), 0); del buf303  # reuse
    buf323 = reinterpret_tensor(buf294, (1, 512, 1), (512, 1, 1), 0); del buf294  # reuse
    buf325 = reinterpret_tensor(buf278, (1, 512, 1), (512, 1, 1), 0); del buf278  # reuse
    buf326 = reinterpret_tensor(buf269, (1, 512, 1), (512, 1, 1), 0); del buf269  # reuse
    buf328 = reinterpret_tensor(buf253, (1, 512, 1), (512, 1, 1), 0); del buf253  # reuse
    buf329 = reinterpret_tensor(buf244, (1, 512, 1), (512, 1, 1), 0); del buf244  # reuse
    buf330 = buf237; del buf237  # reuse
    buf331 = reinterpret_tensor(buf228, (1, 512, 1), (512, 1, 1), 0); del buf228  # reuse
    buf332 = reinterpret_tensor(buf219, (1, 512, 1), (512, 1, 1), 0); del buf219  # reuse
    buf333 = buf212; del buf212  # reuse
    buf334 = reinterpret_tensor(buf203, (1, 512, 1), (512, 1, 1), 0); del buf203  # reuse
    buf335 = reinterpret_tensor(buf194, (1, 512, 1), (512, 1, 1), 0); del buf194  # reuse
    buf336 = buf187; del buf187  # reuse
    buf337 = reinterpret_tensor(buf178, (1, 512, 1), (512, 1, 1), 0); del buf178  # reuse
    buf338 = reinterpret_tensor(buf169, (1, 512, 1), (512, 1, 1), 0); del buf169  # reuse
    buf339 = buf162; del buf162  # reuse
    buf340 = reinterpret_tensor(buf153, (1, 512, 1), (512, 1, 1), 0); del buf153  # reuse
    buf341 = reinterpret_tensor(buf144, (1, 512, 1), (512, 1, 1), 0); del buf144  # reuse
    buf342 = buf137; del buf137  # reuse
    buf343 = reinterpret_tensor(buf128, (1, 512, 1), (512, 1, 1), 0); del buf128  # reuse
    buf344 = reinterpret_tensor(buf119, (1, 512, 1), (512, 1, 1), 0); del buf119  # reuse
    buf345 = buf112; del buf112  # reuse
    buf346 = reinterpret_tensor(buf103, (1, 512, 1), (512, 1, 1), 0); del buf103  # reuse
    buf347 = reinterpret_tensor(buf94, (1, 512, 1), (512, 1, 1), 0); del buf94  # reuse
    buf348 = buf87; del buf87  # reuse
    buf349 = reinterpret_tensor(buf78, (1, 512, 1), (512, 1, 1), 0); del buf78  # reuse
    buf350 = reinterpret_tensor(buf69, (1, 512, 1), (512, 1, 1), 0); del buf69  # reuse
    buf351 = buf62; del buf62  # reuse
    buf352 = reinterpret_tensor(buf53, (1, 512, 1), (512, 1, 1), 0); del buf53  # reuse
    buf353 = reinterpret_tensor(buf44, (1, 512, 1), (512, 1, 1), 0); del buf44  # reuse
    buf354 = buf37; del buf37  # reuse
    buf355 = reinterpret_tensor(buf28, (1, 512, 1), (512, 1, 1), 0); del buf28  # reuse
    buf356 = reinterpret_tensor(buf19, (1, 512, 1), (512, 1, 1), 0); del buf19  # reuse
    buf357 = buf12; del buf12  # reuse
    buf358 = reinterpret_tensor(buf2, (1, 512, 1), (512, 1, 1), 0); del buf2  # reuse
    cpp_fused__log_softmax__softmax_add_clamp_clone_detach_div_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_61(c_void_p(buf322.data_ptr()), c_void_p(buf323.data_ptr()), c_void_p(buf325.data_ptr()), c_void_p(buf326.data_ptr()), c_void_p(buf328.data_ptr()), c_void_p(buf329.data_ptr()), c_void_p(buf330.data_ptr()), c_void_p(buf331.data_ptr()), c_void_p(buf332.data_ptr()), c_void_p(buf333.data_ptr()), c_void_p(buf334.data_ptr()), c_void_p(buf335.data_ptr()), c_void_p(buf336.data_ptr()), c_void_p(buf337.data_ptr()), c_void_p(buf338.data_ptr()), c_void_p(buf339.data_ptr()), c_void_p(buf340.data_ptr()), c_void_p(buf341.data_ptr()), c_void_p(buf342.data_ptr()), c_void_p(buf343.data_ptr()), c_void_p(buf344.data_ptr()), c_void_p(buf345.data_ptr()), c_void_p(buf346.data_ptr()), c_void_p(buf347.data_ptr()), c_void_p(buf348.data_ptr()), c_void_p(buf349.data_ptr()), c_void_p(buf350.data_ptr()), c_void_p(buf351.data_ptr()), c_void_p(buf352.data_ptr()), c_void_p(buf353.data_ptr()), c_void_p(buf354.data_ptr()), c_void_p(buf355.data_ptr()), c_void_p(buf356.data_ptr()), c_void_p(buf357.data_ptr()), c_void_p(buf358.data_ptr()), c_void_p(buf307.data_ptr()), c_void_p(primals_29.data_ptr()), c_void_p(primals_30.data_ptr()), c_void_p(buf238.data_ptr()), c_void_p(buf213.data_ptr()), c_void_p(buf188.data_ptr()), c_void_p(buf163.data_ptr()), c_void_p(buf138.data_ptr()), c_void_p(buf113.data_ptr()), c_void_p(buf88.data_ptr()), c_void_p(buf63.data_ptr()), c_void_p(buf38.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(buf308.data_ptr()), c_void_p(buf310.data_ptr()), c_void_p(buf309.data_ptr()), c_void_p(buf314.data_ptr()), c_void_p(buf311.data_ptr()), c_void_p(buf312.data_ptr()), c_void_p(buf315.data_ptr()), c_void_p(buf316.data_ptr()), c_void_p(buf313.data_ptr()), c_void_p(buf317.data_ptr()), c_void_p(buf359.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf320.data_ptr()), c_void_p(buf321.data_ptr()))
    del buf113
    del buf13
    del buf138
    del buf163
    ...
    del primals_29
    del primals_30
    return (buf359, buf308, buf309, primals_4, primals_16, primals_22, primals_28, primals_26, primals_27, buf4, buf5, reinterpret_tensor(buf6, (512, 4096), (4096, 1), 0), buf16, buf21, buf22, buf23, buf24, buf25, buf30, buf31, buf41, buf46, buf47, buf48, buf49, buf50, buf55, buf56, buf66, buf71, buf72, buf73, buf74, buf75, buf80, buf81, buf91, buf96, buf97, buf98, buf99, buf100, buf105, buf106, buf116, buf121, buf122, buf123, buf124, buf125, buf130, buf131, buf141, buf146, buf147, buf148, buf149, buf150, buf155, buf156, buf166, buf171, buf172, buf173, buf174, buf175, buf180, buf181, buf191, buf196, buf197, buf198, buf199, buf200, buf205, buf206, buf216, buf221, buf222, buf223, buf224, buf225, buf230, buf231, buf241, buf246, buf247, buf248, buf249, buf250, buf255, buf256, buf266, buf271, buf272, buf273, buf274, buf275, buf280, buf281, buf291, buf296, buf297, buf298, buf299, buf300, buf305, buf306, buf312, buf313, buf316, buf317, buf318, buf319, buf320, buf321, reinterpret_tensor(primals_24, (2, 4096), (4096, 1), 0), buf322, reinterpret_tensor(primals_20, (4096, 16384), (16384, 1), 0), reinterpret_tensor(primals_18, (16384, 4096), (4096, 1), 0), buf323, reinterpret_tensor(primals_14, (4096, 4096), (4096, 1), 0), reinterpret_tensor(buf289, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf284, (64, 64, 512), (64, 1, 4096), 0), buf324, reinterpret_tensor(buf282, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf283, (64, 512, 64), (64, 4096, 1), 0), reinterpret_tensor(primals_12, (4096, 4096), (4096, 1), 0), reinterpret_tensor(primals_10, (4096, 4096), (4096, 1), 0), reinterpret_tensor(primals_8, (4096, 4096), (4096, 1), 0), buf325, buf326, reinterpret_tensor(buf264, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf259, (64, 64, 512), (64, 1, 4096), 0), buf327, reinterpret_tensor(buf257, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf258, (64, 512, 64), (64, 4096, 1), 0), buf328, buf329, reinterpret_tensor(buf239, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf234, (64, 64, 512), (64, 1, 4096), 0), buf330, reinterpret_tensor(buf232, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf233, (64, 512, 64), (64, 4096, 1), 0), buf331, buf332, reinterpret_tensor(buf214, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf209, (64, 64, 512), (64, 1, 4096), 0), buf333, reinterpret_tensor(buf207, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf208, (64, 512, 64), (64, 4096, 1), 0), buf334, buf335, reinterpret_tensor(buf189, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf184, (64, 64, 512), (64, 1, 4096), 0), buf336, reinterpret_tensor(buf182, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf183, (64, 512, 64), (64, 4096, 1), 0), buf337, buf338, reinterpret_tensor(buf164, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf159, (64, 64, 512), (64, 1, 4096), 0), buf339, reinterpret_tensor(buf157, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf158, (64, 512, 64), (64, 4096, 1), 0), buf340, buf341, reinterpret_tensor(buf139, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf134, (64, 64, 512), (64, 1, 4096), 0), buf342, reinterpret_tensor(buf132, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf133, (64, 512, 64), (64, 4096, 1), 0), buf343, buf344, reinterpret_tensor(buf114, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf109, (64, 64, 512), (64, 1, 4096), 0), buf345, reinterpret_tensor(buf107, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf108, (64, 512, 64), (64, 4096, 1), 0), buf346, buf347, reinterpret_tensor(buf89, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf84, (64, 64, 512), (64, 1, 4096), 0), buf348, reinterpret_tensor(buf82, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf83, (64, 512, 64), (64, 4096, 1), 0), buf349, buf350, reinterpret_tensor(buf64, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf59, (64, 64, 512), (64, 1, 4096), 0), buf351, reinterpret_tensor(buf57, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf58, (64, 512, 64), (64, 4096, 1), 0), buf352, buf353, reinterpret_tensor(buf39, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf34, (64, 64, 512), (64, 1, 4096), 0), buf354, reinterpret_tensor(buf32, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf33, (64, 512, 64), (64, 4096, 1), 0), buf355, buf356, reinterpret_tensor(buf14, (64, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf9, (64, 64, 512), (64, 1, 4096), 0), buf357, reinterpret_tensor(buf7, (64, 64, 512), (64, 1, 4096), 0), reinterpret_tensor(buf8, (64, 512, 64), (64, 4096, 1), 0), reinterpret_tensor(primals_6, (4096, 128), (128, 1), 0), buf358, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_24 = rand_strided((2, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    primals_25 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
    primals_26 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_27 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_28 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_29 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
    primals_30 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
