...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_sub_zeros_0(c_void_p(arg210_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg209_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(arg5_1.data_ptr()), c_void_p(arg6_1.data_ptr()), c_void_p(arg7_1.data_ptr()), c_void_p(arg8_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()))
    del arg0_1
    del arg1_1
    del arg209_1
    del arg210_1
    ...
    extern_kernels.addmm(arg204_1, reinterpret_tensor(buf316, (512, 768), (768, 1), 0), reinterpret_tensor(arg203_1, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf317)
    del arg203_1
    del arg204_1
    buf318 = buf314; del buf314  # reuse
    buf319 = buf313; del buf313  # reuse
    buf321 = buf316; del buf316  # reuse
    cpp_fused_gelu_native_layer_norm_49(c_void_p(buf317.data_ptr()), c_void_p(arg205_1.data_ptr()), c_void_p(arg206_1.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf321.data_ptr()))
    del arg205_1
    del arg206_1
    del buf317
    buf322 = empty((512, 30522), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg208_1, reinterpret_tensor(buf321, (512, 768), (768, 1), 0), reinterpret_tensor(arg207_1, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf322)
    del arg207_1
    del arg208_1
    del buf321
    ...
    cpp_fused__log_softmax_nll_loss_forward_50(c_void_p(buf327.data_ptr()), c_void_p(buf322.data_ptr()), c_void_p(arg211_1.data_ptr()), c_void_p(buf323.data_ptr()), c_void_p(buf324.data_ptr()), c_void_p(buf326.data_ptr()))
    del arg211_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg203_1 = rand_strided((768, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    arg207_1 = rand_strided((30522, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg208_1 = rand_strided((30522, ), (1, ), device='cpu', dtype=torch.float32)
    arg209_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg210_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg211_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
