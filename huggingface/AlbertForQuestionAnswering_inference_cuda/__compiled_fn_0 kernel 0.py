...
# kernel path: /tmp/torchinductor_youkaichao/7j/c7jgnmscyjtrk6nwr4crknwmxkjgbyvuzazeasvxhirv22lykpwf.py
...
# kernel path: /tmp/torchinductor_youkaichao/7x/c7xxs4tqle7rvewvkzcfa25zgy7p7cholwx4scnm24fav54okyez.py
...
# kernel path: /tmp/torchinductor_youkaichao/2n/c2nqjrvnx3va2pfi6kphpqfeippmd24o3cjjuaqtdfqbvadyqgdu.py
# Source Nodes: [add_61, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
# add_61 => add_112
...
# total_loss => div_26
triton_poi_fused_add_clamp_div_nll_loss_forward_7 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clamp_div_nll_loss_forward_7', 'mutated_arg_names': ['in_out_ptr0']},
    min_elem_per_thread=0
)
@triton.jit
...
def call(args):
    ...
    assert_size_stride(arg23_1, (2, 4096), (4096, 1))
    assert_size_stride(arg24_1, (2, ), (1, ))
    assert_size_stride(arg25_1, (1, 512), (512, 1))
    assert_size_stride(arg26_1, (1, 512), (512, 1))
    assert_size_stride(arg27_1, (1, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_0.run(arg27_1, arg0_1, arg25_1, arg1_1, arg26_1, arg2_1, arg3_1, arg4_1, buf0, buf4, 512, 128, grid=grid(512), stream=stream0)
        del arg0_1
        del arg1_1
        del arg25_1
        del arg26_1
        ...
        # Source Nodes: [add_60, sequence_output], Original ATen: [aten.add, aten.native_layer_norm]
        ...
        del buf274
        del buf277
        buf282 = empty((512, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf281, (512, 4096), (4096, 1), 0), reinterpret_tensor(arg23_1, (4096, 2), (1, 4096), 0), out=buf282)
        del arg23_1
        del buf281
        buf283 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf284 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf285 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_5.run(buf282, arg24_1, buf283, buf284, buf285, 1, 512, grid=grid(1), stream=stream0)
        buf286 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf287 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf288 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_6.run(buf282, arg24_1, buf286, buf287, buf288, 1, 512, grid=grid(1), stream=stream0)
        del arg24_1
        del buf282
        buf289 = reinterpret_tensor(buf284, (), (), 0); del buf284  # reuse
        buf290 = buf289; del buf289  # reuse
        # Source Nodes: [add_61, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_forward_7.run(buf290, arg28_1, buf283, buf285, arg29_1, buf286, buf287, buf288, 1, grid=grid(1), stream=stream0)
        del arg28_1
        del arg29_1
        return (buf290, buf283, buf286, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg25_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg26_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg27_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg28_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg29_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    return print_performance(lambda: call([arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1]), times=times, repeat=repeat)
