...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_0(c_void_p(arg27_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg25_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg26_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()))
    del arg0_1
    del arg1_1
    del arg25_1
    del arg26_1
    ...
    extern_kernels.addmm(arg24_1, reinterpret_tensor(buf317, (512, 4096), (4096, 1), 0), reinterpret_tensor(arg23_1, (4096, 2), (1, 4096), 0), alpha=1, beta=1, out=buf318)
    del arg23_1
    del arg24_1
    del buf317
    ...
    cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_49(c_void_p(buf326.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(arg28_1.data_ptr()), c_void_p(arg29_1.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf321.data_ptr()), c_void_p(buf322.data_ptr()), c_void_p(buf323.data_ptr()), c_void_p(buf324.data_ptr()))
    del arg28_1
    del arg29_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg23_1 = rand_strided((2, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    arg24_1 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
    arg25_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg26_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg27_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg28_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
    arg29_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
