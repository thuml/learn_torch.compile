...
# kernel path: /tmp/torchinductor_youkaichao/qa/cqa3sm45524n4rbu52iaiz6xbfiwnm6wznbiwn6t3xsjhu4s266q.py
...
# kernel path: /tmp/torchinductor_youkaichao/rf/crfrlb6xiirccqfvr6yun5hssmnudukz2lbgmbkbucn634hgf4bo.py
...
# kernel path: /tmp/torchinductor_youkaichao/cb/ccbrufs6e6kq56wzbga2l225wr5i67f4ribyqilk6h77kae2p7hr.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_native_layer_norm_backward_0.run(primals_206, primals_1, primals_204, primals_2, primals_205, primals_3, primals_4, primals_5, buf0, buf4, buf5, buf431, 512, 768, grid=grid(512), stream=stream0)
        del primals_1
        del primals_2
        del primals_3
        del primals_5
        ...
        # Source Nodes: [add_2, attention_output, hidden_states_3], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_3.run(buf23, buf7, primals_14, primals_15, buf28, buf29, buf430, 512, 768, grid=grid(512), stream=stream0)
        ...
        # Source Nodes: [add_3, attention_output, hidden_states_8, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf34, buf28, primals_14, primals_15, primals_20, primals_21, buf39, buf40, buf429, 512, 768, grid=grid(512), stream=stream0)
        del primals_15
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf55, buf39, primals_20, primals_21, primals_30, primals_31, buf60, buf61, buf428, 512, 768, grid=grid(512), stream=stream0)
        del primals_21
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf66, buf60, primals_30, primals_31, primals_36, primals_37, buf71, buf72, buf427, 512, 768, grid=grid(512), stream=stream0)
        del primals_31
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf87, buf71, primals_36, primals_37, primals_46, primals_47, buf92, buf93, buf426, 512, 768, grid=grid(512), stream=stream0)
        del primals_37
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf98, buf92, primals_46, primals_47, primals_52, primals_53, buf103, buf104, buf425, 512, 768, grid=grid(512), stream=stream0)
        del primals_47
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf119, buf103, primals_52, primals_53, primals_62, primals_63, buf124, buf125, buf424, 512, 768, grid=grid(512), stream=stream0)
        del primals_53
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf130, buf124, primals_62, primals_63, primals_68, primals_69, buf135, buf136, buf423, 512, 768, grid=grid(512), stream=stream0)
        del primals_63
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf151, buf135, primals_68, primals_69, primals_78, primals_79, buf156, buf157, buf422, 512, 768, grid=grid(512), stream=stream0)
        del primals_69
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf162, buf156, primals_78, primals_79, primals_84, primals_85, buf167, buf168, buf421, 512, 768, grid=grid(512), stream=stream0)
        del primals_79
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf183, buf167, primals_84, primals_85, primals_94, primals_95, buf188, buf189, buf420, 512, 768, grid=grid(512), stream=stream0)
        del primals_85
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf194, buf188, primals_94, primals_95, primals_100, primals_101, buf199, buf200, buf419, 512, 768, grid=grid(512), stream=stream0)
        del primals_95
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf215, buf199, primals_100, primals_101, primals_110, primals_111, buf220, buf221, buf418, 512, 768, grid=grid(512), stream=stream0)
        del primals_101
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf226, buf220, primals_110, primals_111, primals_116, primals_117, buf231, buf232, buf417, 512, 768, grid=grid(512), stream=stream0)
        del primals_111
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf247, buf231, primals_116, primals_117, primals_126, primals_127, buf252, buf253, buf416, 512, 768, grid=grid(512), stream=stream0)
        del primals_117
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf258, buf252, primals_126, primals_127, primals_132, primals_133, buf263, buf264, buf415, 512, 768, grid=grid(512), stream=stream0)
        del primals_127
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf279, buf263, primals_132, primals_133, primals_142, primals_143, buf284, buf285, buf414, 512, 768, grid=grid(512), stream=stream0)
        del primals_133
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf290, buf284, primals_142, primals_143, primals_148, primals_149, buf295, buf296, buf413, 512, 768, grid=grid(512), stream=stream0)
        del primals_143
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf311, buf295, primals_148, primals_149, primals_158, primals_159, buf316, buf317, buf412, 512, 768, grid=grid(512), stream=stream0)
        del primals_149
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf322, buf316, primals_158, primals_159, primals_164, primals_165, buf327, buf328, buf411, 512, 768, grid=grid(512), stream=stream0)
        del primals_159
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf343, buf327, primals_164, primals_165, primals_174, primals_175, buf348, buf349, buf410, 512, 768, grid=grid(512), stream=stream0)
        del primals_165
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf354, buf348, primals_174, primals_175, primals_180, primals_181, buf359, buf360, buf409, 512, 768, grid=grid(512), stream=stream0)
        del primals_175
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf375, buf359, primals_180, primals_181, primals_190, primals_191, buf380, buf381, buf408, 512, 768, grid=grid(512), stream=stream0)
        del primals_181
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf386, buf380, primals_190, primals_191, primals_196, primals_197, buf391, buf392, buf407, 512, 768, grid=grid(512), stream=stream0)
        del primals_191
        del primals_197
        buf393 = reinterpret_tensor(buf386, (512, 768), (768, 1), 0); del buf386  # reuse
        # Source Nodes: [hidden_states_108], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_199, buf392, reinterpret_tensor(primals_198, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf393)
        del primals_199
        buf397 = empty((1, 512, 768), device='cuda', dtype=torch.float32)
        buf398 = empty((512, 768), device='cuda', dtype=torch.float32)
        buf406 = empty((1, 512, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_109, hidden_states_111, prediction_scores], Original ATen: [aten.gelu, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_6.run(buf393, primals_200, primals_201, buf397, buf398, buf406, 512, 768, grid=grid(512), stream=stream0)
        del primals_201
        buf399 = empty((512, 30522), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_203, buf398, reinterpret_tensor(primals_202, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf399)
        del primals_203
        buf402 = empty((512, 30522), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_7.run(buf399, buf402, 512, 30522, grid=grid(512), stream=stream0)
        buf405 = empty((), device='cuda', dtype=torch.float32)
        buf404 = empty((), device='cuda', dtype=torch.float32)
        buf432 = buf405; del buf405  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_8.run(buf432, primals_207, buf402, buf404, 1, 512, grid=grid(1), stream=stream0)
        return (buf432, reinterpret_tensor(buf399, (1, 512, 30522), (15627264, 30522, 1), 0), primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_200, primals_206, primals_207, primals_204, primals_205, buf4, buf8, reinterpret_tensor(buf7, (512, 768), (768, 1), 0), buf12, buf13, buf14, buf17, buf18, buf19, buf16, buf20, buf24, buf28, buf29, buf30, buf31, buf35, buf39, buf40, buf44, buf45, buf46, buf49, buf50, buf51, buf48, buf52, buf56, buf60, buf61, buf62, buf63, buf67, buf71, buf72, buf76, buf77, buf78, buf81, buf82, buf83, buf80, buf84, buf88, buf92, buf93, buf94, buf95, buf99, buf103, buf104, buf108, buf109, buf110, buf113, buf114, buf115, buf112, buf116, buf120, buf124, buf125, buf126, buf127, buf131, buf135, buf136, buf140, buf141, buf142, buf145, buf146, buf147, buf144, buf148, buf152, buf156, buf157, buf158, buf159, buf163, buf167, buf168, buf172, buf173, buf174, buf177, buf178, buf179, buf176, buf180, buf184, buf188, buf189, buf190, buf191, buf195, buf199, buf200, buf204, buf205, buf206, buf209, buf210, buf211, buf208, buf212, buf216, buf220, buf221, buf222, buf223, buf227, buf231, buf232, buf236, buf237, buf238, buf241, buf242, buf243, buf240, buf244, buf248, buf252, buf253, buf254, buf255, buf259, buf263, buf264, buf268, buf269, buf270, buf273, buf274, buf275, buf272, buf276, buf280, buf284, buf285, buf286, buf287, buf291, buf295, buf296, buf300, buf301, buf302, buf305, buf306, buf307, buf304, buf308, buf312, buf316, buf317, buf318, buf319, buf323, buf327, buf328, buf332, buf333, buf334, buf337, buf338, buf339, buf336, buf340, buf344, buf348, buf349, buf350, buf351, buf355, buf359, buf360, buf364, buf365, buf366, buf369, buf370, buf371, buf368, buf372, buf376, buf380, buf381, buf382, buf383, buf387, buf391, buf392, buf393, buf397, buf398, buf402, buf404, reinterpret_tensor(primals_202, (30522, 768), (768, 1), 0), buf406, reinterpret_tensor(primals_198, (768, 768), (768, 1), 0), buf407, reinterpret_tensor(primals_194, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_192, (3072, 768), (768, 1), 0), buf408, reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), reinterpret_tensor(primals_184, (768, 768), (768, 1), 0), reinterpret_tensor(primals_182, (768, 768), (768, 1), 0), buf409, reinterpret_tensor(primals_178, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_176, (3072, 768), (768, 1), 0), buf410, reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), reinterpret_tensor(primals_168, (768, 768), (768, 1), 0), reinterpret_tensor(primals_166, (768, 768), (768, 1), 0), buf411, reinterpret_tensor(primals_162, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_160, (3072, 768), (768, 1), 0), buf412, reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), reinterpret_tensor(primals_152, (768, 768), (768, 1), 0), reinterpret_tensor(primals_150, (768, 768), (768, 1), 0), buf413, reinterpret_tensor(primals_146, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_144, (3072, 768), (768, 1), 0), buf414, reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), reinterpret_tensor(primals_136, (768, 768), (768, 1), 0), reinterpret_tensor(primals_134, (768, 768), (768, 1), 0), buf415, reinterpret_tensor(primals_130, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_128, (3072, 768), (768, 1), 0), buf416, reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), reinterpret_tensor(primals_120, (768, 768), (768, 1), 0), reinterpret_tensor(primals_118, (768, 768), (768, 1), 0), buf417, reinterpret_tensor(primals_114, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_112, (3072, 768), (768, 1), 0), buf418, reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), reinterpret_tensor(primals_104, (768, 768), (768, 1), 0), reinterpret_tensor(primals_102, (768, 768), (768, 1), 0), buf419, reinterpret_tensor(primals_98, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_96, (3072, 768), (768, 1), 0), buf420, reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), reinterpret_tensor(primals_88, (768, 768), (768, 1), 0), reinterpret_tensor(primals_86, (768, 768), (768, 1), 0), buf421, reinterpret_tensor(primals_82, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_80, (3072, 768), (768, 1), 0), buf422, reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), reinterpret_tensor(primals_72, (768, 768), (768, 1), 0), reinterpret_tensor(primals_70, (768, 768), (768, 1), 0), buf423, reinterpret_tensor(primals_66, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_64, (3072, 768), (768, 1), 0), buf424, reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), reinterpret_tensor(primals_56, (768, 768), (768, 1), 0), reinterpret_tensor(primals_54, (768, 768), (768, 1), 0), buf425, reinterpret_tensor(primals_50, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_48, (3072, 768), (768, 1), 0), buf426, reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), reinterpret_tensor(primals_40, (768, 768), (768, 1), 0), reinterpret_tensor(primals_38, (768, 768), (768, 1), 0), buf427, reinterpret_tensor(primals_34, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_32, (3072, 768), (768, 1), 0), buf428, reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), reinterpret_tensor(primals_24, (768, 768), (768, 1), 0), reinterpret_tensor(primals_22, (768, 768), (768, 1), 0), buf429, reinterpret_tensor(primals_18, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_16, (3072, 768), (768, 1), 0), buf430, reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), reinterpret_tensor(primals_8, (768, 768), (768, 1), 0), reinterpret_tensor(primals_6, (768, 768), (768, 1), 0), buf431, )
