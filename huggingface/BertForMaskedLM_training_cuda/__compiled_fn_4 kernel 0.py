...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_backward, aten.nll_loss_forward]
        triton_poi_fused_nll_loss_backward_nll_loss_forward_1.run(primals_207, buf1, 512, grid=grid(512), stream=stream0)
        aten.scatter_(buf0,1,buf1,-1.0)
        del buf1
        buf5 = empty((1, 512, 30522), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax_backward_data, aten.add, aten.nll_loss_backward, aten.nll_loss_forward]
        triton_red_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_2.run(buf0, primals_207, tangents_1, convert_element_type, tangents_2, sub_40, buf5, 512, 30522, grid=grid(512), stream=stream0)
        del buf0
        ...
        # Source Nodes: [hidden_states_109], Original ATen: [aten.gelu, aten.gelu_backward, aten.native_layer_norm_backward]
        triton_per_fused_gelu_gelu_backward_native_layer_norm_backward_4.run(buf6, primals_200, mul_90, div_26, addmm_72, buf13, 512, 768, grid=grid(512), stream=stream0)
        del addmm_72
        del div_26
        del primals_200
        ...
        # Source Nodes: [], Original ATen: [aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_native_dropout_backward_native_layer_norm_backward_8.run(buf14, primals_196, mul_85, div_27, getitem_121, buf20, buf23, 512, 768, grid=grid(512), stream=stream0)
        del div_27
        del getitem_121
        del primals_196
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf20, buf29, primals_190, mul_80, div_28, getitem_117, buf35, buf38, 512, 768, grid=grid(512), stream=stream0)
        del div_28
        del getitem_117
        del primals_190
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf35, buf47, buf51, buf55, primals_180, mul_78, div_30, getitem_111, buf62, buf65, 512, 768, grid=grid(512), stream=stream0)
        del div_30
        del getitem_111
        del primals_180
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf62, buf71, primals_174, mul_73, div_31, getitem_107, buf77, buf80, 512, 768, grid=grid(512), stream=stream0)
        del div_31
        del getitem_107
        del primals_174
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf77, buf89, buf93, buf97, primals_164, mul_71, div_33, getitem_101, buf104, buf107, 512, 768, grid=grid(512), stream=stream0)
        del div_33
        del getitem_101
        del primals_164
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf104, buf113, primals_158, mul_66, div_34, getitem_97, buf119, buf122, 512, 768, grid=grid(512), stream=stream0)
        del div_34
        del getitem_97
        del primals_158
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf119, buf131, buf135, buf139, primals_148, mul_64, div_36, getitem_91, buf146, buf149, 512, 768, grid=grid(512), stream=stream0)
        del div_36
        del getitem_91
        del primals_148
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf146, buf155, primals_142, mul_59, div_37, getitem_87, buf161, buf164, 512, 768, grid=grid(512), stream=stream0)
        del div_37
        del getitem_87
        del primals_142
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf161, buf173, buf177, buf181, primals_132, mul_57, div_39, getitem_81, buf188, buf191, 512, 768, grid=grid(512), stream=stream0)
        del div_39
        del getitem_81
        del primals_132
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf188, buf197, primals_126, mul_52, div_40, getitem_77, buf203, buf206, 512, 768, grid=grid(512), stream=stream0)
        del div_40
        del getitem_77
        del primals_126
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf203, buf215, buf219, buf223, primals_116, mul_50, div_42, getitem_71, buf230, buf233, 512, 768, grid=grid(512), stream=stream0)
        del div_42
        del getitem_71
        del primals_116
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf230, buf239, primals_110, mul_45, div_43, getitem_67, buf245, buf248, 512, 768, grid=grid(512), stream=stream0)
        del div_43
        del getitem_67
        del primals_110
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf245, buf257, buf261, buf265, primals_100, mul_43, div_45, getitem_61, buf272, buf275, 512, 768, grid=grid(512), stream=stream0)
        del div_45
        del getitem_61
        del primals_100
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf272, buf281, primals_94, mul_38, div_46, getitem_57, buf287, buf290, 512, 768, grid=grid(512), stream=stream0)
        del div_46
        del getitem_57
        del primals_94
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf287, buf299, buf303, buf307, primals_84, mul_36, div_48, getitem_51, buf314, buf317, 512, 768, grid=grid(512), stream=stream0)
        del div_48
        del getitem_51
        del primals_84
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf314, buf323, primals_78, mul_31, div_49, getitem_47, buf329, buf332, 512, 768, grid=grid(512), stream=stream0)
        del div_49
        del getitem_47
        del primals_78
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf329, buf341, buf345, buf349, primals_68, mul_29, div_51, getitem_41, buf356, buf359, 512, 768, grid=grid(512), stream=stream0)
        del div_51
        del getitem_41
        del primals_68
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf356, buf365, primals_62, mul_24, div_52, getitem_37, buf371, buf374, 512, 768, grid=grid(512), stream=stream0)
        del div_52
        del getitem_37
        del primals_62
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf371, buf383, buf387, buf391, primals_52, mul_22, div_54, getitem_31, buf398, buf401, 512, 768, grid=grid(512), stream=stream0)
        del div_54
        del getitem_31
        del primals_52
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf398, buf407, primals_46, mul_17, div_55, getitem_27, buf413, buf416, 512, 768, grid=grid(512), stream=stream0)
        del div_55
        del getitem_27
        del primals_46
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf413, buf425, buf429, buf433, primals_36, mul_15, div_57, getitem_21, buf440, buf443, 512, 768, grid=grid(512), stream=stream0)
        del div_57
        del getitem_21
        del primals_36
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf440, buf449, primals_30, mul_10, div_58, getitem_17, buf455, buf458, 512, 768, grid=grid(512), stream=stream0)
        del div_58
        del getitem_17
        del primals_30
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf455, buf467, buf471, buf475, primals_20, mul_8, div_60, getitem_11, buf482, buf485, 512, 768, grid=grid(512), stream=stream0)
        del div_60
        del getitem_11
        del primals_20
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf482, buf491, primals_14, mul_3, div_61, getitem_7, buf497, buf500, 512, 768, grid=grid(512), stream=stream0)
        del div_61
        del getitem_7
        del primals_14
        ...
        # Source Nodes: [loss], Original ATen: [aten.add, aten.embedding_dense_backward, aten.native_dropout_backward, aten.native_layer_norm_backward, aten.nll_loss_forward]
        triton_per_fused_add_embedding_dense_backward_native_dropout_backward_native_layer_norm_backward_nll_loss_forward_16.run(buf521, buf509, buf513, buf517, getitem_3, primals_4, mul_1, div_63, slice_4, expand, primals_206, buf528, buf532, buf536, 512, 768, grid=grid(512), stream=stream0)
        del buf509
        del buf513
        del buf517
        del div_63
        ...
        del mul_1
        buf527 = reinterpret_tensor(buf521, (512, 768), (768, 1), 0); del buf521  # reuse
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_17.run(buf527, 393216, grid=grid(393216), stream=stream0)
        aten.index_put_(buf527, [slice_4], buf528, True)
        del buf528
        del slice_4
        buf531 = empty((2, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_18.run(buf531, 1536, grid=grid(1536), stream=stream0)
        aten.index_put_(buf531, [expand], buf532, True)
        del buf532
        del expand
        buf535 = empty((30522, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_19.run(buf535, 23440896, grid=grid(23440896), stream=stream0)
        aten.index_put_(buf535, [primals_206], buf536, True)
        del buf536
        del primals_206
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    sub_40 = rand_strided((512, 30522), (30522, 1), device='cuda:0', dtype=torch.float32)
