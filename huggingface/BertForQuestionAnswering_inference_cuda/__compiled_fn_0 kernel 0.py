...
# kernel path: /tmp/torchinductor_youkaichao/ps/cpsg6px24ixc4k3ymawsalj735kwshwvr4bozrxiyeegcpy3cgik.py
...
# kernel path: /tmp/torchinductor_youkaichao/g5/cg5amuwodgwka3syl5acjgdbc5mk5nrynkg5lkutzdtpm7gwdsou.py
...
triton_per_fused__log_softmax_clone_4 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__log_softmax_clone_4', 'mutated_arg_names': []}
)
@triton.jit
...
# kernel path: /tmp/torchinductor_youkaichao/xd/cxduj6ppfnnpre2garemphmb4y7jm6lycyp5gej6y6njmqjslwwf.py
...
triton_per_fused__log_softmax_clone_5 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: '*fp32', 3: '*fp32', 4: '*fp32', 5: 'i32', 6: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2, 3, 4, 6), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(6,))]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused__log_softmax_clone_5', 'mutated_arg_names': []}
)
@triton.jit
def triton_(in_ptr0, in_ptr1, out_ptr0, out_ptr1, out_ptr2, xnumel, rnumel):
    xnumel = 1
...
# kernel path: /tmp/torchinductor_youkaichao/sk/csktje7yt3uw5aairxkpa6hjiagzpgjruyttjdhcwfnfhcga2ic7.py
# Source Nodes: [add_37, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
# add_37 => add_100
...
# total_loss => div_26
triton_poi_fused_add_clamp_div_nll_loss_forward_6 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clamp_div_nll_loss_forward_6', 'mutated_arg_names': ['in_out_ptr0']},
    min_elem_per_thread=0
)
@triton.jit
...
def call(args):
    ...
    assert_size_stride(arg203_1, (1, ), (1, ))
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_0.run(arg201_1, arg0_1, arg199_1, arg1_1, arg200_1, arg2_1, arg3_1, arg4_1, buf0, buf4, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg199_1
        del arg1_1
        del arg200_1
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf4, (512, 768), (768, 1), 0), reinterpret_tensor(arg7_1, (768, 768), (1, 768), 0), out=buf6)
        del arg7_1
        buf7 = empty((512, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf4, (512, 768), (768, 1), 0), reinterpret_tensor(arg9_1, (768, 768), (1, 768), 0), out=buf7)
        del arg9_1
        buf8 = empty((1, 12, 512, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf5, arg6_1, buf8, 393216, grid=grid(393216), stream=stream0)
        del arg6_1
        buf9 = reinterpret_tensor(buf5, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf5  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf6, arg8_1, buf9, 393216, grid=grid(393216), stream=stream0)
        del arg8_1
        buf10 = reinterpret_tensor(buf6, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf6  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf7, arg10_1, buf10, 393216, grid=grid(393216), stream=stream0)
        del arg10_1
        del buf7
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf12, (512, 768), (768, 1), 0), reinterpret_tensor(arg11_1, (768, 768), (1, 768), 0), out=buf16)
        del arg11_1
        buf20 = reinterpret_tensor(buf12, (1, 512, 768), (393216, 768, 1), 0); del buf12  # reuse
        # Source Nodes: [add_2, attention_output], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf16, arg12_1, buf4, arg13_1, arg14_1, buf20, 512, 768, grid=grid(512), stream=stream0)
        del arg12_1
        del arg13_1
        del arg14_1
        buf21 = empty((512, 3072), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf20, (512, 768), (768, 1), 0), reinterpret_tensor(arg15_1, (768, 3072), (1, 768), 0), out=buf21)
        del arg15_1
        buf22 = reinterpret_tensor(buf21, (1, 512, 3072), (1572864, 3072, 1), 0); del buf21  # reuse
        # Source Nodes: [intermediate_output], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_3.run(buf22, arg16_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg16_1
        buf23 = reinterpret_tensor(buf4, (512, 768), (768, 1), 0); del buf4  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf22, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg17_1, (3072, 768), (1, 3072), 0), out=buf23)
        del arg17_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf23, arg18_1, buf20, arg19_1, arg20_1, buf27, 512, 768, grid=grid(512), stream=stream0)
        del arg18_1
        del arg19_1
        del arg20_1
        buf28 = buf23; del buf23  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (512, 768), (768, 1), 0), reinterpret_tensor(arg21_1, (768, 768), (1, 768), 0), out=buf28)
        del arg21_1
        buf29 = reinterpret_tensor(buf20, (512, 768), (768, 1), 0); del buf20  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (512, 768), (768, 1), 0), reinterpret_tensor(arg23_1, (768, 768), (1, 768), 0), out=buf29)
        del arg23_1
        buf30 = reinterpret_tensor(buf8, (512, 768), (768, 1), 0); del buf8  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (512, 768), (768, 1), 0), reinterpret_tensor(arg25_1, (768, 768), (1, 768), 0), out=buf30)
        del arg25_1
        buf31 = buf10; del buf10  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf28, arg22_1, buf31, 393216, grid=grid(393216), stream=stream0)
        del arg22_1
        buf32 = reinterpret_tensor(buf28, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf28  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf29, arg24_1, buf32, 393216, grid=grid(393216), stream=stream0)
        del arg24_1
        buf33 = reinterpret_tensor(buf29, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf29  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf30, arg26_1, buf33, 393216, grid=grid(393216), stream=stream0)
        del arg26_1
        del buf30
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf35, (512, 768), (768, 1), 0), reinterpret_tensor(arg27_1, (768, 768), (1, 768), 0), out=buf39)
        del arg27_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf39, arg28_1, buf27, arg29_1, arg30_1, buf43, 512, 768, grid=grid(512), stream=stream0)
        del arg28_1
        del arg29_1
        del arg30_1
        buf44 = reinterpret_tensor(buf22, (512, 3072), (3072, 1), 0); del buf22  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf43, (512, 768), (768, 1), 0), reinterpret_tensor(arg31_1, (768, 3072), (1, 768), 0), out=buf44)
        del arg31_1
        ...
        triton_poi_fused_gelu_3.run(buf45, arg32_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg32_1
        buf46 = buf39; del buf39  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf45, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg33_1, (3072, 768), (1, 3072), 0), out=buf46)
        del arg33_1
        buf50 = buf27; del buf27  # reuse
        # Source Nodes: [add_6, hidden_states_17], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf46, arg34_1, buf43, arg35_1, arg36_1, buf50, 512, 768, grid=grid(512), stream=stream0)
        del arg34_1
        del arg35_1
        del arg36_1
        buf51 = buf46; del buf46  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf50, (512, 768), (768, 1), 0), reinterpret_tensor(arg37_1, (768, 768), (1, 768), 0), out=buf51)
        del arg37_1
        buf52 = reinterpret_tensor(buf43, (512, 768), (768, 1), 0); del buf43  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf50, (512, 768), (768, 1), 0), reinterpret_tensor(arg39_1, (768, 768), (1, 768), 0), out=buf52)
        del arg39_1
        buf53 = reinterpret_tensor(buf32, (512, 768), (768, 1), 0); del buf32  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf50, (512, 768), (768, 1), 0), reinterpret_tensor(arg41_1, (768, 768), (1, 768), 0), out=buf53)
        del arg41_1
        buf54 = buf31; del buf31  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf51, arg38_1, buf54, 393216, grid=grid(393216), stream=stream0)
        del arg38_1
        buf55 = reinterpret_tensor(buf51, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf51  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf52, arg40_1, buf55, 393216, grid=grid(393216), stream=stream0)
        del arg40_1
        buf56 = reinterpret_tensor(buf52, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf52  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf53, arg42_1, buf56, 393216, grid=grid(393216), stream=stream0)
        del arg42_1
        del buf53
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf58, (512, 768), (768, 1), 0), reinterpret_tensor(arg43_1, (768, 768), (1, 768), 0), out=buf62)
        del arg43_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf62, arg44_1, buf50, arg45_1, arg46_1, buf66, 512, 768, grid=grid(512), stream=stream0)
        del arg44_1
        del arg45_1
        del arg46_1
        buf67 = reinterpret_tensor(buf45, (512, 3072), (3072, 1), 0); del buf45  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf66, (512, 768), (768, 1), 0), reinterpret_tensor(arg47_1, (768, 3072), (1, 768), 0), out=buf67)
        del arg47_1
        ...
        triton_poi_fused_gelu_3.run(buf68, arg48_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg48_1
        buf69 = buf62; del buf62  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg49_1, (3072, 768), (1, 3072), 0), out=buf69)
        del arg49_1
        buf73 = buf50; del buf50  # reuse
        # Source Nodes: [add_9, hidden_states_26], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf69, arg50_1, buf66, arg51_1, arg52_1, buf73, 512, 768, grid=grid(512), stream=stream0)
        del arg50_1
        del arg51_1
        del arg52_1
        buf74 = buf69; del buf69  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf73, (512, 768), (768, 1), 0), reinterpret_tensor(arg53_1, (768, 768), (1, 768), 0), out=buf74)
        del arg53_1
        buf75 = reinterpret_tensor(buf66, (512, 768), (768, 1), 0); del buf66  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf73, (512, 768), (768, 1), 0), reinterpret_tensor(arg55_1, (768, 768), (1, 768), 0), out=buf75)
        del arg55_1
        buf76 = reinterpret_tensor(buf55, (512, 768), (768, 1), 0); del buf55  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf73, (512, 768), (768, 1), 0), reinterpret_tensor(arg57_1, (768, 768), (1, 768), 0), out=buf76)
        del arg57_1
        buf77 = buf54; del buf54  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf74, arg54_1, buf77, 393216, grid=grid(393216), stream=stream0)
        del arg54_1
        buf78 = reinterpret_tensor(buf74, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf74  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf75, arg56_1, buf78, 393216, grid=grid(393216), stream=stream0)
        del arg56_1
        buf79 = reinterpret_tensor(buf75, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf75  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf76, arg58_1, buf79, 393216, grid=grid(393216), stream=stream0)
        del arg58_1
        del buf76
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf81, (512, 768), (768, 1), 0), reinterpret_tensor(arg59_1, (768, 768), (1, 768), 0), out=buf85)
        del arg59_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf85, arg60_1, buf73, arg61_1, arg62_1, buf89, 512, 768, grid=grid(512), stream=stream0)
        del arg60_1
        del arg61_1
        del arg62_1
        buf90 = reinterpret_tensor(buf68, (512, 3072), (3072, 1), 0); del buf68  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf89, (512, 768), (768, 1), 0), reinterpret_tensor(arg63_1, (768, 3072), (1, 768), 0), out=buf90)
        del arg63_1
        ...
        triton_poi_fused_gelu_3.run(buf91, arg64_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg64_1
        buf92 = buf85; del buf85  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf91, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg65_1, (3072, 768), (1, 3072), 0), out=buf92)
        del arg65_1
        buf96 = buf73; del buf73  # reuse
        # Source Nodes: [add_12, hidden_states_35], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf92, arg66_1, buf89, arg67_1, arg68_1, buf96, 512, 768, grid=grid(512), stream=stream0)
        del arg66_1
        del arg67_1
        del arg68_1
        buf97 = buf92; del buf92  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (512, 768), (768, 1), 0), reinterpret_tensor(arg69_1, (768, 768), (1, 768), 0), out=buf97)
        del arg69_1
        buf98 = reinterpret_tensor(buf89, (512, 768), (768, 1), 0); del buf89  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (512, 768), (768, 1), 0), reinterpret_tensor(arg71_1, (768, 768), (1, 768), 0), out=buf98)
        del arg71_1
        buf99 = reinterpret_tensor(buf78, (512, 768), (768, 1), 0); del buf78  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf96, (512, 768), (768, 1), 0), reinterpret_tensor(arg73_1, (768, 768), (1, 768), 0), out=buf99)
        del arg73_1
        buf100 = buf77; del buf77  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf97, arg70_1, buf100, 393216, grid=grid(393216), stream=stream0)
        del arg70_1
        buf101 = reinterpret_tensor(buf97, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf97  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf98, arg72_1, buf101, 393216, grid=grid(393216), stream=stream0)
        del arg72_1
        buf102 = reinterpret_tensor(buf98, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf98  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf99, arg74_1, buf102, 393216, grid=grid(393216), stream=stream0)
        del arg74_1
        del buf99
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf104, (512, 768), (768, 1), 0), reinterpret_tensor(arg75_1, (768, 768), (1, 768), 0), out=buf108)
        del arg75_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf108, arg76_1, buf96, arg77_1, arg78_1, buf112, 512, 768, grid=grid(512), stream=stream0)
        del arg76_1
        del arg77_1
        del arg78_1
        buf113 = reinterpret_tensor(buf91, (512, 3072), (3072, 1), 0); del buf91  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf112, (512, 768), (768, 1), 0), reinterpret_tensor(arg79_1, (768, 3072), (1, 768), 0), out=buf113)
        del arg79_1
        ...
        triton_poi_fused_gelu_3.run(buf114, arg80_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg80_1
        buf115 = reinterpret_tensor(buf96, (512, 768), (768, 1), 0); del buf96  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf114, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg81_1, (3072, 768), (1, 3072), 0), out=buf115)
        del arg81_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf115, arg82_1, buf112, arg83_1, arg84_1, buf119, 512, 768, grid=grid(512), stream=stream0)
        del arg82_1
        del arg83_1
        del arg84_1
        buf120 = buf115; del buf115  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (512, 768), (768, 1), 0), reinterpret_tensor(arg85_1, (768, 768), (1, 768), 0), out=buf120)
        del arg85_1
        buf121 = reinterpret_tensor(buf112, (512, 768), (768, 1), 0); del buf112  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (512, 768), (768, 1), 0), reinterpret_tensor(arg87_1, (768, 768), (1, 768), 0), out=buf121)
        del arg87_1
        buf122 = reinterpret_tensor(buf101, (512, 768), (768, 1), 0); del buf101  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf119, (512, 768), (768, 1), 0), reinterpret_tensor(arg89_1, (768, 768), (1, 768), 0), out=buf122)
        del arg89_1
        buf123 = buf100; del buf100  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf120, arg86_1, buf123, 393216, grid=grid(393216), stream=stream0)
        del arg86_1
        buf124 = reinterpret_tensor(buf120, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf120  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf121, arg88_1, buf124, 393216, grid=grid(393216), stream=stream0)
        del arg88_1
        buf125 = reinterpret_tensor(buf121, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf121  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf122, arg90_1, buf125, 393216, grid=grid(393216), stream=stream0)
        del arg90_1
        del buf122
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf127, (512, 768), (768, 1), 0), reinterpret_tensor(arg91_1, (768, 768), (1, 768), 0), out=buf131)
        del arg91_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf131, arg92_1, buf119, arg93_1, arg94_1, buf135, 512, 768, grid=grid(512), stream=stream0)
        del arg92_1
        del arg93_1
        del arg94_1
        buf136 = reinterpret_tensor(buf114, (512, 3072), (3072, 1), 0); del buf114  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (512, 768), (768, 1), 0), reinterpret_tensor(arg95_1, (768, 3072), (1, 768), 0), out=buf136)
        del arg95_1
        ...
        triton_poi_fused_gelu_3.run(buf137, arg96_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg96_1
        buf138 = buf131; del buf131  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf137, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg97_1, (3072, 768), (1, 3072), 0), out=buf138)
        del arg97_1
        buf142 = buf119; del buf119  # reuse
        # Source Nodes: [add_18, hidden_states_53], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf138, arg98_1, buf135, arg99_1, arg100_1, buf142, 512, 768, grid=grid(512), stream=stream0)
        del arg100_1
        del arg98_1
        del arg99_1
        buf143 = buf138; del buf138  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (512, 768), (768, 1), 0), reinterpret_tensor(arg101_1, (768, 768), (1, 768), 0), out=buf143)
        del arg101_1
        buf144 = reinterpret_tensor(buf135, (512, 768), (768, 1), 0); del buf135  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (512, 768), (768, 1), 0), reinterpret_tensor(arg103_1, (768, 768), (1, 768), 0), out=buf144)
        del arg103_1
        buf145 = reinterpret_tensor(buf124, (512, 768), (768, 1), 0); del buf124  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (512, 768), (768, 1), 0), reinterpret_tensor(arg105_1, (768, 768), (1, 768), 0), out=buf145)
        del arg105_1
        buf146 = buf123; del buf123  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf143, arg102_1, buf146, 393216, grid=grid(393216), stream=stream0)
        del arg102_1
        buf147 = reinterpret_tensor(buf143, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf143  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf144, arg104_1, buf147, 393216, grid=grid(393216), stream=stream0)
        del arg104_1
        buf148 = reinterpret_tensor(buf144, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf144  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf145, arg106_1, buf148, 393216, grid=grid(393216), stream=stream0)
        del arg106_1
        del buf145
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf150, (512, 768), (768, 1), 0), reinterpret_tensor(arg107_1, (768, 768), (1, 768), 0), out=buf154)
        del arg107_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf154, arg108_1, buf142, arg109_1, arg110_1, buf158, 512, 768, grid=grid(512), stream=stream0)
        del arg108_1
        del arg109_1
        del arg110_1
        buf159 = reinterpret_tensor(buf137, (512, 3072), (3072, 1), 0); del buf137  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf158, (512, 768), (768, 1), 0), reinterpret_tensor(arg111_1, (768, 3072), (1, 768), 0), out=buf159)
        del arg111_1
        ...
        triton_poi_fused_gelu_3.run(buf160, arg112_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg112_1
        buf161 = buf154; del buf154  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf160, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg113_1, (3072, 768), (1, 3072), 0), out=buf161)
        del arg113_1
        buf165 = buf142; del buf142  # reuse
        # Source Nodes: [add_21, hidden_states_62], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf161, arg114_1, buf158, arg115_1, arg116_1, buf165, 512, 768, grid=grid(512), stream=stream0)
        del arg114_1
        del arg115_1
        del arg116_1
        buf166 = buf161; del buf161  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (512, 768), (768, 1), 0), reinterpret_tensor(arg117_1, (768, 768), (1, 768), 0), out=buf166)
        del arg117_1
        buf167 = reinterpret_tensor(buf158, (512, 768), (768, 1), 0); del buf158  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (512, 768), (768, 1), 0), reinterpret_tensor(arg119_1, (768, 768), (1, 768), 0), out=buf167)
        del arg119_1
        buf168 = reinterpret_tensor(buf147, (512, 768), (768, 1), 0); del buf147  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf165, (512, 768), (768, 1), 0), reinterpret_tensor(arg121_1, (768, 768), (1, 768), 0), out=buf168)
        del arg121_1
        buf169 = buf146; del buf146  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf166, arg118_1, buf169, 393216, grid=grid(393216), stream=stream0)
        del arg118_1
        buf170 = reinterpret_tensor(buf166, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf166  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf167, arg120_1, buf170, 393216, grid=grid(393216), stream=stream0)
        del arg120_1
        buf171 = reinterpret_tensor(buf167, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf167  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf168, arg122_1, buf171, 393216, grid=grid(393216), stream=stream0)
        del arg122_1
        del buf168
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf173, (512, 768), (768, 1), 0), reinterpret_tensor(arg123_1, (768, 768), (1, 768), 0), out=buf177)
        del arg123_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf177, arg124_1, buf165, arg125_1, arg126_1, buf181, 512, 768, grid=grid(512), stream=stream0)
        del arg124_1
        del arg125_1
        del arg126_1
        buf182 = reinterpret_tensor(buf160, (512, 3072), (3072, 1), 0); del buf160  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf181, (512, 768), (768, 1), 0), reinterpret_tensor(arg127_1, (768, 3072), (1, 768), 0), out=buf182)
        del arg127_1
        ...
        triton_poi_fused_gelu_3.run(buf183, arg128_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg128_1
        buf184 = buf177; del buf177  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf183, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg129_1, (3072, 768), (1, 3072), 0), out=buf184)
        del arg129_1
        buf188 = buf165; del buf165  # reuse
        # Source Nodes: [add_24, hidden_states_71], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf184, arg130_1, buf181, arg131_1, arg132_1, buf188, 512, 768, grid=grid(512), stream=stream0)
        del arg130_1
        del arg131_1
        del arg132_1
        buf189 = buf184; del buf184  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (512, 768), (768, 1), 0), reinterpret_tensor(arg133_1, (768, 768), (1, 768), 0), out=buf189)
        del arg133_1
        buf190 = reinterpret_tensor(buf181, (512, 768), (768, 1), 0); del buf181  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (512, 768), (768, 1), 0), reinterpret_tensor(arg135_1, (768, 768), (1, 768), 0), out=buf190)
        del arg135_1
        buf191 = reinterpret_tensor(buf170, (512, 768), (768, 1), 0); del buf170  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (512, 768), (768, 1), 0), reinterpret_tensor(arg137_1, (768, 768), (1, 768), 0), out=buf191)
        del arg137_1
        buf192 = buf169; del buf169  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf189, arg134_1, buf192, 393216, grid=grid(393216), stream=stream0)
        del arg134_1
        buf193 = reinterpret_tensor(buf189, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf189  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf190, arg136_1, buf193, 393216, grid=grid(393216), stream=stream0)
        del arg136_1
        buf194 = reinterpret_tensor(buf190, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf190  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf191, arg138_1, buf194, 393216, grid=grid(393216), stream=stream0)
        del arg138_1
        del buf191
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf196, (512, 768), (768, 1), 0), reinterpret_tensor(arg139_1, (768, 768), (1, 768), 0), out=buf200)
        del arg139_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf200, arg140_1, buf188, arg141_1, arg142_1, buf204, 512, 768, grid=grid(512), stream=stream0)
        del arg140_1
        del arg141_1
        del arg142_1
        buf205 = reinterpret_tensor(buf183, (512, 3072), (3072, 1), 0); del buf183  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf204, (512, 768), (768, 1), 0), reinterpret_tensor(arg143_1, (768, 3072), (1, 768), 0), out=buf205)
        del arg143_1
        ...
        triton_poi_fused_gelu_3.run(buf206, arg144_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg144_1
        buf207 = buf200; del buf200  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf206, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg145_1, (3072, 768), (1, 3072), 0), out=buf207)
        del arg145_1
        buf211 = buf188; del buf188  # reuse
        # Source Nodes: [add_27, hidden_states_80], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf207, arg146_1, buf204, arg147_1, arg148_1, buf211, 512, 768, grid=grid(512), stream=stream0)
        del arg146_1
        del arg147_1
        del arg148_1
        buf212 = buf207; del buf207  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf211, (512, 768), (768, 1), 0), reinterpret_tensor(arg149_1, (768, 768), (1, 768), 0), out=buf212)
        del arg149_1
        buf213 = reinterpret_tensor(buf204, (512, 768), (768, 1), 0); del buf204  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf211, (512, 768), (768, 1), 0), reinterpret_tensor(arg151_1, (768, 768), (1, 768), 0), out=buf213)
        del arg151_1
        buf214 = reinterpret_tensor(buf193, (512, 768), (768, 1), 0); del buf193  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf211, (512, 768), (768, 1), 0), reinterpret_tensor(arg153_1, (768, 768), (1, 768), 0), out=buf214)
        del arg153_1
        buf215 = buf192; del buf192  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf212, arg150_1, buf215, 393216, grid=grid(393216), stream=stream0)
        del arg150_1
        buf216 = reinterpret_tensor(buf212, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf212  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf213, arg152_1, buf216, 393216, grid=grid(393216), stream=stream0)
        del arg152_1
        buf217 = reinterpret_tensor(buf213, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf213  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf214, arg154_1, buf217, 393216, grid=grid(393216), stream=stream0)
        del arg154_1
        del buf214
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (512, 768), (768, 1), 0), reinterpret_tensor(arg155_1, (768, 768), (1, 768), 0), out=buf223)
        del arg155_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf223, arg156_1, buf211, arg157_1, arg158_1, buf227, 512, 768, grid=grid(512), stream=stream0)
        del arg156_1
        del arg157_1
        del arg158_1
        buf228 = reinterpret_tensor(buf206, (512, 3072), (3072, 1), 0); del buf206  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf227, (512, 768), (768, 1), 0), reinterpret_tensor(arg159_1, (768, 3072), (1, 768), 0), out=buf228)
        del arg159_1
        ...
        triton_poi_fused_gelu_3.run(buf229, arg160_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg160_1
        buf230 = buf223; del buf223  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf229, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg161_1, (3072, 768), (1, 3072), 0), out=buf230)
        del arg161_1
        buf234 = buf211; del buf211  # reuse
        # Source Nodes: [add_30, hidden_states_89], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf230, arg162_1, buf227, arg163_1, arg164_1, buf234, 512, 768, grid=grid(512), stream=stream0)
        del arg162_1
        del arg163_1
        del arg164_1
        buf235 = buf230; del buf230  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf234, (512, 768), (768, 1), 0), reinterpret_tensor(arg165_1, (768, 768), (1, 768), 0), out=buf235)
        del arg165_1
        buf236 = reinterpret_tensor(buf227, (512, 768), (768, 1), 0); del buf227  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf234, (512, 768), (768, 1), 0), reinterpret_tensor(arg167_1, (768, 768), (1, 768), 0), out=buf236)
        del arg167_1
        buf237 = reinterpret_tensor(buf216, (512, 768), (768, 1), 0); del buf216  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf234, (512, 768), (768, 1), 0), reinterpret_tensor(arg169_1, (768, 768), (1, 768), 0), out=buf237)
        del arg169_1
        buf238 = buf215; del buf215  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf235, arg166_1, buf238, 393216, grid=grid(393216), stream=stream0)
        del arg166_1
        buf239 = reinterpret_tensor(buf235, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf235  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf236, arg168_1, buf239, 393216, grid=grid(393216), stream=stream0)
        del arg168_1
        buf240 = reinterpret_tensor(buf236, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf236  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf237, arg170_1, buf240, 393216, grid=grid(393216), stream=stream0)
        del arg170_1
        del buf237
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf242, (512, 768), (768, 1), 0), reinterpret_tensor(arg171_1, (768, 768), (1, 768), 0), out=buf246)
        del arg171_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf246, arg172_1, buf234, arg173_1, arg174_1, buf250, 512, 768, grid=grid(512), stream=stream0)
        del arg172_1
        del arg173_1
        del arg174_1
        buf251 = reinterpret_tensor(buf229, (512, 3072), (3072, 1), 0); del buf229  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf250, (512, 768), (768, 1), 0), reinterpret_tensor(arg175_1, (768, 3072), (1, 768), 0), out=buf251)
        del arg175_1
        ...
        triton_poi_fused_gelu_3.run(buf252, arg176_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg176_1
        buf253 = buf246; del buf246  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf252, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg177_1, (3072, 768), (1, 3072), 0), out=buf253)
        del arg177_1
        buf257 = buf234; del buf234  # reuse
        # Source Nodes: [add_33, hidden_states_98], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf253, arg178_1, buf250, arg179_1, arg180_1, buf257, 512, 768, grid=grid(512), stream=stream0)
        del arg178_1
        del arg179_1
        del arg180_1
        buf258 = buf253; del buf253  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf257, (512, 768), (768, 1), 0), reinterpret_tensor(arg181_1, (768, 768), (1, 768), 0), out=buf258)
        del arg181_1
        buf259 = reinterpret_tensor(buf250, (512, 768), (768, 1), 0); del buf250  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf257, (512, 768), (768, 1), 0), reinterpret_tensor(arg183_1, (768, 768), (1, 768), 0), out=buf259)
        del arg183_1
        buf260 = reinterpret_tensor(buf239, (512, 768), (768, 1), 0); del buf239  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf257, (512, 768), (768, 1), 0), reinterpret_tensor(arg185_1, (768, 768), (1, 768), 0), out=buf260)
        del arg185_1
        buf261 = buf238; del buf238  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf258, arg182_1, buf261, 393216, grid=grid(393216), stream=stream0)
        del arg182_1
        buf262 = reinterpret_tensor(buf258, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf258  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf259, arg184_1, buf262, 393216, grid=grid(393216), stream=stream0)
        del arg184_1
        buf263 = reinterpret_tensor(buf259, (1, 12, 512, 64), (393216, 32768, 64, 1), 0); del buf259  # reuse
        # Source Nodes: [], Original ATen: []
        triton_poi_fused_1.run(buf260, arg186_1, buf263, 393216, grid=grid(393216), stream=stream0)
        del arg186_1
        del buf260
        # Source Nodes: [], Original ATen: []
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf265, (512, 768), (768, 1), 0), reinterpret_tensor(arg187_1, (768, 768), (1, 768), 0), out=buf269)
        del arg187_1
        ...
        triton_per_fused_add_native_layer_norm_2.run(buf269, arg188_1, buf257, arg189_1, arg190_1, buf273, 512, 768, grid=grid(512), stream=stream0)
        del arg188_1
        del arg189_1
        del arg190_1
        buf274 = reinterpret_tensor(buf252, (512, 3072), (3072, 1), 0); del buf252  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf273, (512, 768), (768, 1), 0), reinterpret_tensor(arg191_1, (768, 3072), (1, 768), 0), out=buf274)
        del arg191_1
        ...
        triton_poi_fused_gelu_3.run(buf275, arg192_1, 1572864, grid=grid(1572864), stream=stream0)
        del arg192_1
        buf276 = buf269; del buf269  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf275, (512, 3072), (3072, 1), 0), reinterpret_tensor(arg193_1, (3072, 768), (1, 3072), 0), out=buf276)
        del arg193_1
        del buf275
        buf280 = buf257; del buf257  # reuse
        # Source Nodes: [add_36, sequence_output], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_2.run(buf276, arg194_1, buf273, arg195_1, arg196_1, buf280, 512, 768, grid=grid(512), stream=stream0)
        del arg194_1
        del arg195_1
        del arg196_1
        del buf273
        del buf276
        buf281 = empty((512, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf280, (512, 768), (768, 1), 0), reinterpret_tensor(arg197_1, (768, 2), (1, 768), 0), out=buf281)
        del arg197_1
        del buf280
        buf282 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf283 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf284 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_4.run(buf281, arg198_1, buf282, buf283, buf284, 1, 512, grid=grid(1), stream=stream0)
        buf285 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf286 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf287 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_5.run(buf281, arg198_1, buf285, buf286, buf287, 1, 512, grid=grid(1), stream=stream0)
        del arg198_1
        del buf281
        buf288 = reinterpret_tensor(buf283, (), (), 0); del buf283  # reuse
        buf289 = buf288; del buf288  # reuse
        # Source Nodes: [add_37, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_forward_6.run(buf289, arg202_1, buf282, buf284, arg203_1, buf285, buf286, buf287, 1, grid=grid(1), stream=stream0)
        del arg202_1
        del arg203_1
        return (buf289, buf282, buf285, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg197_1 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg198_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg199_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg200_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg201_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg202_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg203_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    return print_performance(lambda: call([arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1, arg30_1, arg31_1, arg32_1, arg33_1, arg34_1, arg35_1, arg36_1, arg37_1, arg38_1, arg39_1, arg40_1, arg41_1, arg42_1, arg43_1, arg44_1, arg45_1, arg46_1, arg47_1, arg48_1, arg49_1, arg50_1, arg51_1, arg52_1, arg53_1, arg54_1, arg55_1, arg56_1, arg57_1, arg58_1, arg59_1, arg60_1, arg61_1, arg62_1, arg63_1, arg64_1, arg65_1, arg66_1, arg67_1, arg68_1, arg69_1, arg70_1, arg71_1, arg72_1, arg73_1, arg74_1, arg75_1, arg76_1, arg77_1, arg78_1, arg79_1, arg80_1, arg81_1, arg82_1, arg83_1, arg84_1, arg85_1, arg86_1, arg87_1, arg88_1, arg89_1, arg90_1, arg91_1, arg92_1, arg93_1, arg94_1, arg95_1, arg96_1, arg97_1, arg98_1, arg99_1, arg100_1, arg101_1, arg102_1, arg103_1, arg104_1, arg105_1, arg106_1, arg107_1, arg108_1, arg109_1, arg110_1, arg111_1, arg112_1, arg113_1, arg114_1, arg115_1, arg116_1, arg117_1, arg118_1, arg119_1, arg120_1, arg121_1, arg122_1, arg123_1, arg124_1, arg125_1, arg126_1, arg127_1, arg128_1, arg129_1, arg130_1, arg131_1, arg132_1, arg133_1, arg134_1, arg135_1, arg136_1, arg137_1, arg138_1, arg139_1, arg140_1, arg141_1, arg142_1, arg143_1, arg144_1, arg145_1, arg146_1, arg147_1, arg148_1, arg149_1, arg150_1, arg151_1, arg152_1, arg153_1, arg154_1, arg155_1, arg156_1, arg157_1, arg158_1, arg159_1, arg160_1, arg161_1, arg162_1, arg163_1, arg164_1, arg165_1, arg166_1, arg167_1, arg168_1, arg169_1, arg170_1, arg171_1, arg172_1, arg173_1, arg174_1, arg175_1, arg176_1, arg177_1, arg178_1, arg179_1, arg180_1, arg181_1, arg182_1, arg183_1, arg184_1, arg185_1, arg186_1, arg187_1, arg188_1, arg189_1, arg190_1, arg191_1, arg192_1, arg193_1, arg194_1, arg195_1, arg196_1, arg197_1, arg198_1, arg199_1, arg200_1, arg201_1, arg202_1, arg203_1]), times=times, repeat=repeat)
