...
cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_86 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_0(c_void_p(primals_209.data_ptr()), c_void_p(primals_1.data_ptr()), c_void_p(primals_206.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(primals_207.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(primals_5.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf5.data_ptr()))
    del primals_1
    del primals_2
    del primals_3
    del primals_5
    ...
    del primals_193
    del primals_199
    buf454 = reinterpret_tensor(buf5, (512, 128), (128, 1), 0); del buf5  # reuse
    # Source Nodes: [hidden_states_110], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_201, buf453, reinterpret_tensor(primals_200, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf454)
    del primals_201
    buf455 = buf449; del buf449  # reuse
    buf456 = empty_strided((1, 512, 1), (512, 1, 512), device='cpu', dtype=torch.float32)
    buf458 = buf0; del buf0  # reuse
    buf459 = empty((512, 128), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_native_layer_norm_view_85(c_void_p(buf454.data_ptr()), c_void_p(primals_202.data_ptr()), c_void_p(primals_203.data_ptr()), c_void_p(buf455.data_ptr()), c_void_p(buf456.data_ptr()), c_void_p(buf458.data_ptr()), c_void_p(buf459.data_ptr()))
    del buf455
    del primals_203
    buf460 = empty((512, 30522), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_205, buf459, reinterpret_tensor(primals_204, (128, 30522), (1, 128), 0), alpha=1, beta=1, out=buf460)
    del primals_205
    buf461 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf462 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf463 = empty((511, 30522), device='cpu', dtype=torch.float32)
    ...
    buf467 = empty((511, 1), device='cpu', dtype=torch.bool)
    buf468 = empty((511, 1), device='cpu', dtype=torch.int64)
    buf469 = reinterpret_tensor(buf456, (1, 512, 1), (512, 1, 1), 0); del buf456  # reuse
    buf470 = reinterpret_tensor(buf450, (1, 512, 1), (512, 1, 1), 0); del buf450  # reuse
    buf471 = reinterpret_tensor(buf439, (1, 512, 1), (512, 1, 1), 0); del buf439  # reuse
    buf472 = reinterpret_tensor(buf413, (1, 512, 1), (512, 1, 1), 0); del buf413  # reuse
    buf473 = reinterpret_tensor(buf402, (1, 512, 1), (512, 1, 1), 0); del buf402  # reuse
    buf474 = reinterpret_tensor(buf376, (1, 512, 1), (512, 1, 1), 0); del buf376  # reuse
    buf475 = reinterpret_tensor(buf365, (1, 512, 1), (512, 1, 1), 0); del buf365  # reuse
    buf476 = reinterpret_tensor(buf339, (1, 512, 1), (512, 1, 1), 0); del buf339  # reuse
    buf477 = reinterpret_tensor(buf328, (1, 512, 1), (512, 1, 1), 0); del buf328  # reuse
    buf478 = reinterpret_tensor(buf302, (1, 512, 1), (512, 1, 1), 0); del buf302  # reuse
    buf479 = reinterpret_tensor(buf291, (1, 512, 1), (512, 1, 1), 0); del buf291  # reuse
    buf480 = reinterpret_tensor(buf265, (1, 512, 1), (512, 1, 1), 0); del buf265  # reuse
    buf481 = reinterpret_tensor(buf254, (1, 512, 1), (512, 1, 1), 0); del buf254  # reuse
    buf482 = reinterpret_tensor(buf228, (1, 512, 1), (512, 1, 1), 0); del buf228  # reuse
    buf483 = reinterpret_tensor(buf217, (1, 512, 1), (512, 1, 1), 0); del buf217  # reuse
    buf484 = reinterpret_tensor(buf191, (1, 512, 1), (512, 1, 1), 0); del buf191  # reuse
    buf485 = reinterpret_tensor(buf180, (1, 512, 1), (512, 1, 1), 0); del buf180  # reuse
    buf486 = reinterpret_tensor(buf154, (1, 512, 1), (512, 1, 1), 0); del buf154  # reuse
    buf487 = reinterpret_tensor(buf143, (1, 512, 1), (512, 1, 1), 0); del buf143  # reuse
    buf488 = reinterpret_tensor(buf117, (1, 512, 1), (512, 1, 1), 0); del buf117  # reuse
    buf489 = reinterpret_tensor(buf106, (1, 512, 1), (512, 1, 1), 0); del buf106  # reuse
    buf490 = reinterpret_tensor(buf80, (1, 512, 1), (512, 1, 1), 0); del buf80  # reuse
    buf491 = reinterpret_tensor(buf69, (1, 512, 1), (512, 1, 1), 0); del buf69  # reuse
    buf492 = reinterpret_tensor(buf43, (1, 512, 1), (512, 1, 1), 0); del buf43  # reuse
    buf493 = reinterpret_tensor(buf32, (1, 512, 1), (512, 1, 1), 0); del buf32  # reuse
    buf494 = reinterpret_tensor(buf2, (1, 512, 1), (512, 1, 1), 0); del buf2  # reuse
    cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_86(c_void_p(buf495.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()), c_void_p(buf486.data_ptr()), c_void_p(buf487.data_ptr()), c_void_p(buf488.data_ptr()), c_void_p(buf489.data_ptr()), c_void_p(buf490.data_ptr()), c_void_p(buf491.data_ptr()), c_void_p(buf492.data_ptr()), c_void_p(buf493.data_ptr()), c_void_p(buf494.data_ptr()), c_void_p(buf460.data_ptr()), c_void_p(primals_208.data_ptr()), c_void_p(buf461.data_ptr()), c_void_p(buf462.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(buf465.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf468.data_ptr()))
    del buf461
    del buf462
    del buf464
    del primals_208
    return (buf495, reinterpret_tensor(buf460, (1, 512, 30522), (15627264, 30522, 1), 0), primals_4, primals_16, primals_22, primals_32, primals_38, primals_48, primals_54, primals_64, primals_70, primals_80, primals_86, primals_96, primals_102, primals_112, primals_118, primals_128, primals_134, primals_144, primals_150, primals_160, primals_166, primals_176, primals_182, primals_192, primals_198, primals_202, primals_209, primals_206, primals_207, buf4, buf8, reinterpret_tensor(buf7, (512, 128), (128, 1), 0), reinterpret_tensor(buf9, (512, 256), (256, 1), 0), buf22, reinterpret_tensor(buf21, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf23, (4, 64, 512), (32768, 1, 64), 0), buf19, reinterpret_tensor(buf13, (4, 64, 512), (32768, 1, 64), 0), buf25, buf26, buf30, buf34, buf35, buf36, buf37, buf41, buf45, buf46, buf59, reinterpret_tensor(buf58, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf60, (4, 64, 512), (32768, 1, 64), 0), buf56, reinterpret_tensor(buf50, (4, 64, 512), (32768, 1, 64), 0), buf62, buf63, buf67, buf71, buf72, buf73, buf74, buf78, buf82, buf83, buf96, reinterpret_tensor(buf95, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf97, (4, 64, 512), (32768, 1, 64), 0), buf93, reinterpret_tensor(buf87, (4, 64, 512), (32768, 1, 64), 0), buf99, buf100, buf104, buf108, buf109, buf110, buf111, buf115, buf119, buf120, buf133, reinterpret_tensor(buf132, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf134, (4, 64, 512), (32768, 1, 64), 0), buf130, reinterpret_tensor(buf124, (4, 64, 512), (32768, 1, 64), 0), buf136, buf137, buf141, buf145, buf146, buf147, buf148, buf152, buf156, buf157, buf170, reinterpret_tensor(buf169, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf171, (4, 64, 512), (32768, 1, 64), 0), buf167, reinterpret_tensor(buf161, (4, 64, 512), (32768, 1, 64), 0), buf173, buf174, buf178, buf182, buf183, buf184, buf185, buf189, buf193, buf194, buf207, reinterpret_tensor(buf206, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf208, (4, 64, 512), (32768, 1, 64), 0), buf204, reinterpret_tensor(buf198, (4, 64, 512), (32768, 1, 64), 0), buf210, buf211, buf215, buf219, buf220, buf221, buf222, buf226, buf230, buf231, buf244, reinterpret_tensor(buf243, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf245, (4, 64, 512), (32768, 1, 64), 0), buf241, reinterpret_tensor(buf235, (4, 64, 512), (32768, 1, 64), 0), buf247, buf248, buf252, buf256, buf257, buf258, buf259, buf263, buf267, buf268, buf281, reinterpret_tensor(buf280, (4, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(bu