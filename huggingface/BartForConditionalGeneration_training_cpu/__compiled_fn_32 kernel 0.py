...
def call(args):
    ...
    extern_kernels.addmm(primals_2, reinterpret_tensor(primals_27, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_1, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf0)
    del primals_2
    buf1 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_4, reinterpret_tensor(primals_27, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_3, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf1)
    del primals_4
    buf2 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_27, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf2)
    del primals_6
    ...
    buf6 = empty_strided((16, 1024, 1), (1024, 1, 16384), device='cpu', dtype=torch.float32)
    buf7 = buf5; del buf5  # reuse
    buf8 = empty_strided((16, 1024, 1), (1024, 1, 16384), device='cpu', dtype=torch.float32)
    buf9 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    ...
    buf22 = reinterpret_tensor(buf15, (1024, 1024), (1024, 1), 0); del buf15  # reuse
    # Source Nodes: [l__self___encoder_attn_q_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_12, buf21, reinterpret_tensor(primals_11, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf22)
    del primals_12
    buf23 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_14, reinterpret_tensor(primals_29, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_13, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf23)
    del primals_14
    buf24 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_16, reinterpret_tensor(primals_29, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_15, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf24)
    del primals_16
    buf25 = empty((1, 16, 1024, 64), device='cpu', dtype=torch.float32)
    buf26 = empty((1, 16, 1024, 64), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(buf25, (16, 1024, 64), (65536, 64, 1), 0), reinterpret_tensor(buf26, (16, 64, 1024), (65536, 1, 64), 0), out=buf27)
    buf28 = reinterpret_tensor(buf8, (16, 1024, 1), (1024, 1, 1), 0); del buf8  # reuse
    buf29 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    buf30 = reinterpret_tensor(buf6, (16, 1024, 1), (1024, 1, 1), 0); del buf6  # reuse
    buf31 = buf29; del buf29  # reuse
    buf32 = reinterpret_tensor(buf23, (1, 16, 1024, 64), (1048576, 65536, 64, 1), 0); del buf23  # reuse
    ...
    buf33 = reinterpret_tensor(buf24, (16, 1024, 64), (65536, 64, 1), 0); del buf24  # reuse
    # Source Nodes: [attn_output_5], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf31, reinterpret_tensor(buf32, (16, 1024, 64), (65536, 64, 1), 0), out=buf33)
    buf34 = buf22; del buf22  # reuse
    cpp_fused_view_6(c_void_p(buf33.data_ptr()), c_void_p(buf34.data_ptr()))
    buf35 = reinterpret_tensor(buf33, (1024, 1024), (1024, 1), 0); del buf33  # reuse
    # Source Nodes: [hidden_states_4], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_18, buf34, reinterpret_tensor(primals_17, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf35)
    del primals_18
    # Source Nodes: [hidden_states_5], Original ATen: [aten.native_dropout]
    buf36 = aten.native_dropout(reinterpret_tensor(buf35, (1, 1024, 1024), (1048576, 1024, 1), 0), 0.1, True)
    buf37 = buf36[0]
    buf38 = buf36[1]
    del buf36
    buf39 = buf17; del buf17  # reuse
    buf40 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf42 = reinterpret_tensor(buf35, (1, 1024, 1024), (1048576, 1024, 1), 0); del buf35  # reuse
    ...
    del primals_10
    buf44 = empty((1024, 4096), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_22, buf43, reinterpret_tensor(primals_21, (1024, 4096), (1, 1024), 0), alpha=1, beta=1, out=buf44)
    del primals_22
    buf45 = empty((1024, 4096), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_view_8(c_void_p(buf44.data_ptr()), c_void_p(buf45.data_ptr()))
    buf46 = reinterpret_tensor(buf37, (1024, 1024), (1024, 1), 0); del buf37  # reuse
    # Source Nodes: [hidden_states_10], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_24, buf45, reinterpret_tensor(primals_23, (4096, 1024), (1, 4096), 0), alpha=1, beta=1, out=buf46)
    del primals_24
    # Source Nodes: [hidden_states_11], Original ATen: [aten.native_dropout]
    buf47 = aten.native_dropout(reinterpret_tensor(buf46, (1, 1024, 1024), (1048576, 1024, 1), 0), 0.1, True)
    buf48 = buf47[0]
    buf49 = buf47[1]
    del buf47
    buf50 = buf39; del buf39  # reuse
    buf51 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf53 = reinterpret_tensor(buf46, (1, 1024, 1024), (1048576, 1024, 1), 0); del buf46  # reuse
    buf54 = empty((1, 1024, 1024), device='cpu', dtype=torch.float32)
    buf55 = reinterpret_tensor(buf51, (1, 1024, 1), (1024, 1, 1), 0); del buf51  # reuse
    buf56 = reinterpret_tensor(buf40, (1, 1024, 1), (1024, 1, 1), 0); del buf40  # reuse
    buf57 = reinterpret_tensor(buf18, (1, 1024, 1), (1024, 1, 1), 0); del buf18  # reuse
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_11 = rand_strided((1024, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    ...
    primals_21 = rand_strided((4096, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    primals_22 = rand_strided((4096, ), (1, ), device='cpu', dtype=torch.float32)
    primals_23 = rand_strided((1024, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    primals_24 = rand_strided((1024, ), (1, ), device='cpu', dtype=torch.float32)
