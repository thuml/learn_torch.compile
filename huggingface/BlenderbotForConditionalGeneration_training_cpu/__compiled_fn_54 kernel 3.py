...
def call(args):
    ...
    assert_size_stride(bmm, (32, 128, 128), (16384, 128, 1))
    assert_size_stride(amax, (32, 128, 1), (128, 1, 1))
    assert_size_stride(sum_1, (32, 128, 1), (128, 1, 1))
    assert_size_stride(view_14, (128, 2560), (2560, 1))
    ...
    assert_size_stride(addmm_4, (128, 10240), (10240, 1))
    assert_size_stride(view_18, (128, 10240), (10240, 1))
    assert_size_stride(getitem_7, (1, 128, 2560), (327680, 2560, 1))
    assert_size_stride(permute_11, (2560, 10240), (10240, 1))
    assert_size_stride(permute_15, (10240, 2560), (2560, 1))
    assert_size_stride(div_1, (1, 128, 1), (128, 1, 1))
    assert_size_stride(permute_19, (2560, 2560), (2560, 1))
    assert_size_stride(permute_24, (32, 128, 128), (16384, 1, 128))
    assert_size_stride(permute_25, (32, 80, 128), (10240, 1, 80))
    assert_size_stride(permute_26, (32, 80, 128), (10240, 1, 80))
    assert_size_stride(permute_27, (32, 128, 80), (10240, 80, 1))
    assert_size_stride(permute_31, (2560, 2560), (2560, 1))
    assert_size_stride(permute_36, (2560, 2560), (2560, 1))
    ...
    extern_kernels.mm(reinterpret_tensor(buf1, (128, 2560), (2560, 1), 0), permute_11, out=buf2)
    del permute_11
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (128, 10240), (10240, 1), 0), permute_15, out=buf6)
    del permute_15
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (128, 2560), (2560, 1), 0), permute_19, out=buf15)
    del permute_19
    buf19 = empty((32, 128, 128), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf15, (32, 128, 80), (80, 2560, 1), 0), permute_25, out=buf19)
    del permute_25
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf1, (2560, 128), (1, 2560), 0), view_18, out=buf3)
    del view_18
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (10240, 128), (1, 10240), 0), view_16, out=buf7)
    del view_16
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf14, (2560, 128), (1, 2560), 0), view_14, out=buf16)
    del view_14
    ...
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_24, reinterpret_tensor(buf15, (32, 128, 80), (80, 2560, 1), 0), out=buf18)
    del permute_24
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf24, (2560, 128), (1, 2560), 0), view, out=buf26)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (128, 2560), (1, 128), 0), permute_36, out=buf28)
    del permute_36
    buf29 = empty((2560, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf22, (2560, 128), (128, 1), 0), view, out=buf29)
    buf30 = empty((1, 2560), device='cpu', dtype=torch.float32)
    buf31 = empty((128, 2560), device='cpu', dtype=torch.float32)
    ...
    del buf22
    buf32 = reinterpret_tensor(buf23, (128, 2560), (2560, 1), 0); del buf23  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf31, permute_40, out=buf32)
    del permute_40
    buf33 = empty((2560, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf31, (2560, 128), (1, 2560), 0), view, out=buf33)
    del view
    buf34 = empty((1, 2560), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    bmm = rand_strided((32, 128, 128), (16384, 128, 1), device='cpu', dtype=torch.float32)
    amax = rand_strided((32, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    sum_1 = rand_strided((32, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    view_14 = rand_strided((128, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    ...
    addmm_4 = rand_strided((128, 10240), (10240, 1), device='cpu', dtype=torch.float32)
    view_18 = rand_strided((128, 10240), (10240, 1), device='cpu', dtype=torch.float32)
    getitem_7 = rand_strided((1, 128, 2560), (327680, 2560, 1), device='cpu', dtype=torch.bool)
    permute_11 = rand_strided((2560, 10240), (10240, 1), device='cpu', dtype=torch.float32)
    permute_15 = rand_strided((10240, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    div_1 = rand_strided((1, 128, 1), (128, 1, 1), device='cpu', dtype=torch.float32)
    permute_19 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    permute_24 = rand_strided((32, 128, 128), (16384, 1, 128), device='cpu', dtype=torch.float32)
    permute_25 = rand_strided((32, 80, 128), (10240, 1, 80), device='cpu', dtype=torch.float32)
    permute_26 = rand_strided((32, 80, 128), (10240, 1, 80), device='cpu', dtype=torch.float32)
    permute_27 = rand_strided((32, 128, 80), (10240, 80, 1), device='cpu', dtype=torch.float32)
    permute_31 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    permute_36 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
