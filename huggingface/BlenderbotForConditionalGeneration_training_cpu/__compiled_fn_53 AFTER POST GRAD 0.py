...
def forward(self, primals_1: "f32[8008, 2560]", primals_2: "f32[1, 8008]", primals_3: "f32[1, 128, 2560]", primals_4: "i64[1, 128]"):
    ...
    view: "f32[128, 2560]" = torch.ops.aten.reshape.default(primals_3, [128, 2560]);  primals_3 = None
    mm: "f32[128, 8008]" = torch.ops.aten.mm.default(view, permute)
    view_1: "f32[1, 128, 8008]" = torch.ops.aten.reshape.default(mm, [1, 128, 8008]);  mm = None
    ...
    view_2: "f32[128, 8008]" = torch.ops.aten.reshape.default(add, [-1, 8008])
