...
def __resume_at_38_48(self, encoder_hidden_states, encoder_attentions):
    self.encoder_hidden_states = encoder_hidden_states
    self.encoder_attentions = encoder_attentions
    self.__post_init__()
    return None

def transformed___resume_at_38_48(self, encoder_hidden_states, encoder_attentions):
    L = {"self": self, "encoder_hidden_states": encoder_hidden_states, "encoder_attentions": encoder_attentions}
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_38_48(self, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_38_48 ============#

def __guard_4_for_resume_in___init__(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_type_id(L['self'], 146979616)) \
...
# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_32_47(self, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    self.encoder_last_hidden_state = encoder_last_hidden_state
    self.encoder_hidden_states = encoder_hidden_states
    self.encoder_attentions = encoder_attentions
    self.__post_init__()
...
def transformed___resume_at_32_47(self, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_32_47(self, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_32_47 ============#
...
def __transformed_code_3_for_resume_in___init__(self, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    return __resume_at_32_47(self, encoder_last_hidden_state,
        encoder_hidden_states, encoder_attentions)


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_26_46(self, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    self.cross_attentions = cross_attentions
    self.encoder_last_hidden_state = encoder_last_hidden_state
    self.encoder_hidden_states = encoder_hidden_states
    self.encoder_attentions = encoder_attentions
...
def transformed___resume_at_26_46(self, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_26_46(self, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_26_46 ============#
...
def __transformed_code_2_for_resume_in___init__(self, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    return __resume_at_26_46(self, cross_attentions, encoder_last_hidden_state,
        encoder_hidden_states, encoder_attentions)


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_20_45(self, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    self.decoder_attentions = decoder_attentions
    self.cross_attentions = cross_attentions
    self.encoder_last_hidden_state = encoder_last_hidden_state
    self.encoder_hidden_states = encoder_hidden_states
...
def transformed___resume_at_20_45(self, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_20_45(self, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_20_45 ============#
...
def __transformed_code_1_for_resume_in___init__(self, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    return __resume_at_20_45(self, decoder_attentions, cross_attentions,
        encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_14_44(self, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    self.decoder_hidden_states = decoder_hidden_states
    self.decoder_attentions = decoder_attentions
    self.cross_attentions = cross_attentions
    self.encoder_last_hidden_state = encoder_last_hidden_state
...
def transformed___resume_at_14_44(self, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_14_44(self, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_14_44 ============#
...
def __transformed_code_0_for_resume_in___init__(self, past_key_values, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    return __resume_at_14_44(self, decoder_hidden_states, decoder_attentions,
        cross_attentions, encoder_last_hidden_state, encoder_hidden_states,
        encoder_attentions)


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_6_43(self, past_key_values, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    self.past_key_values = past_key_values
    self.decoder_hidden_states = decoder_hidden_states
    self.decoder_attentions = decoder_attentions
    self.cross_attentions = cross_attentions
...
def transformed___resume_at_6_43(self, past_key_values, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_6_43(self, past_key_values, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions)

#============ end of __resume_at_6_43 ============#
...
def __transformed_code_2_for___init__(self, last_hidden_state, past_key_values, decoder_hidden_states, decoder_attentions, cross_attentions, encoder_last_hidden_state, encoder_hidden_states, encoder_attentions):
    ...
    return __resume_at_6_43(self, past_key_values, decoder_hidden_states,
