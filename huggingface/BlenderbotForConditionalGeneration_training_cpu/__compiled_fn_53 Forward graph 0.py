...
def forward(self, primals_1: "f32[8008, 2560]", primals_2: "f32[1, 8008]", primals_3: "f32[1, 128, 2560]", primals_4: "i64[1, 128]"):
    ...
    view_3: "i64[128]" = torch.ops.aten.view.default(primals_4, [-1])
