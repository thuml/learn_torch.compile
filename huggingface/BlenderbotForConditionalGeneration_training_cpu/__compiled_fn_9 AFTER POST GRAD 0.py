...
def forward(self, primals_1: "f32[2560]", primals_2: "f32[2560]", primals_3: "f32[2560, 2560]", primals_4: "f32[2560]", primals_5: "f32[2560, 2560]", primals_6: "f32[2560]", primals_7: "f32[2560, 2560]", primals_8: "f32[2560]", primals_9: "f32[2560, 2560]", primals_10: "f32[2560]", primals_11: "f32[2560]", primals_12: "f32[2560]", primals_13: "f32[10240, 2560]", primals_14: "f32[10240]", primals_15: "f32[2560, 10240]", primals_16: "f32[2560]", primals_17: "f32[1, 128, 2560]"):
    ...
    sub_1: "f32[32, 128, 128]" = torch.ops.aten.sub.Tensor(bmm, amax)
    ...
    div: "f32[32, 128, 128]" = torch.ops.aten.div.Tensor(exp, sum_1);  exp = None
    ...
    bmm_1: "f32[32, 128, 80]" = torch.ops.aten.bmm.default(div, view_11)
    ...
    view_12: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(bmm_1, [1, 32, 128, 80]);  bmm_1 = None
    ...
    view_13: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(clone_4, [1, 128, 2560]);  clone_4 = None
    ...
    view_14: "f32[128, 2560]" = torch.ops.aten.reshape.default(view_13, [128, 2560]);  view_13 = None
    ...
    view_15: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_3, [1, 128, 2560]);  addmm_3 = None
    ...
    sub_2: "f32[1, 128, 2560]" = torch.ops.aten.sub.Tensor(add_2, getitem_5);  getitem_5 = None
    ...
    view_16: "f32[128, 2560]" = torch.ops.aten.reshape.default(add_4, [128, 2560]);  add_4 = None
    ...
    view_17: "f32[1, 128, 10240]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 10240])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_5: "f32[1, 128, 10240]" = torch.ops.aten.mul.Tensor(view_17, 0.5)
    mul_6: "f32[1, 128, 10240]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476);  view_17 = None
    ...
    view_18: "f32[128, 10240]" = torch.ops.aten.reshape.default(mul_7, [128, 10240]);  mul_7 = None
    ...
    view_19: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_5, [1, 128, 2560]);  addmm_5 = None
    ...
    add_6: "f32[1, 128, 2560]" = torch.ops.aten.add.Tensor(add_2, getitem_6);  add_2 = getitem_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:263, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_24: "f32[32, 128, 128]" = torch.ops.aten.permute.default(div, [0, 2, 1]);  div = None
