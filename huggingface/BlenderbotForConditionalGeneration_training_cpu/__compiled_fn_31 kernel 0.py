            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(32L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(1L))
                {
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(80L); x2+=static_cast<long>(8L))
                    {
                        ...
                        tmp0.store(out_ptr4 + static_cast<long>(x2 + (80L*x1) + (10240L*x0)));
                    }
                }
            }
        }
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(128L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(2560L); x1+=static_cast<long>(8L))
                {
                    ...
                    tmp19.store(out_ptr3 + static_cast<long>(x1 + (2560L*x0)));
                }
            }
        }
    }
...
def call(args):
    ...
    assert_size_stride(primals_13, (2560, 2560), (2560, 1))
    assert_size_stride(primals_14, (2560, ), (1, ))
    assert_size_stride(primals_15, (2560, 2560), (2560, 1))
    assert_size_stride(primals_16, (2560, ), (1, ))
    assert_size_stride(primals_17, (2560, 2560), (2560, 1))
    assert_size_stride(primals_18, (2560, ), (1, ))
    assert_size_stride(primals_19, (2560, 2560), (2560, 1))
    assert_size_stride(primals_20, (2560, ), (1, ))
    assert_size_stride(primals_21, (2560, ), (1, ))
    assert_size_stride(primals_22, (2560, ), (1, ))
    assert_size_stride(primals_23, (10240, 2560), (2560, 1))
    assert_size_stride(primals_24, (10240, ), (1, ))
    assert_size_stride(primals_25, (2560, 10240), (10240, 1))
    assert_size_stride(primals_26, (2560, ), (1, ))
    assert_size_stride(primals_27, (1, 128, 2560), (327680, 2560, 1))
    assert_size_stride(primals_28, (1, 1, 128, 128), (16384, 16384, 128, 1))
    assert_size_stride(primals_29, (1, 128, 2560), (327680, 2560, 1))
    ...
    buf11 = empty_strided((32, 128, 1), (128, 1, 4096), device='cpu', dtype=torch.float32)
    buf12 = buf10; del buf10  # reuse
    buf13 = empty_strided((32, 128, 1), (128, 1, 4096), device='cpu', dtype=torch.float32)
    buf14 = empty((32, 128, 128), device='cpu', dtype=torch.float32)
    buf58 = empty((32, 128, 128), device='cpu', dtype=torch.float32)
    ...
    del primals_12
    buf27 = empty((128, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_q_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_14, buf26, reinterpret_tensor(primals_13, (2560, 2560), (1, 2560), 0), alpha=1, beta=1, out=buf27)
    del primals_14
    buf28 = empty((128, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_16, reinterpret_tensor(primals_29, (128, 2560), (2560, 1), 0), reinterpret_tensor(primals_15, (2560, 2560), (1, 2560), 0), alpha=1, beta=1, out=buf28)
    del primals_16
    buf29 = empty((128, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_18, reinterpret_tensor(primals_29, (128, 2560), (2560, 1), 0), reinterpret_tensor(primals_17, (2560, 2560), (1, 2560), 0), alpha=1, beta=1, out=buf29)
    del primals_18
    buf30 = empty((1, 32, 128, 80), device='cpu', dtype=torch.float32)
    buf31 = empty((1, 32, 128, 80), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(buf30, (32, 128, 80), (10240, 80, 1), 0), reinterpret_tensor(buf31, (32, 80, 128), (10240, 1, 80), 0), out=buf32)
    buf33 = reinterpret_tensor(buf13, (32, 128, 1), (128, 1, 1), 0); del buf13  # reuse
    buf34 = empty((32, 128, 128), device='cpu', dtype=torch.float32)
    buf35 = reinterpret_tensor(buf11, (32, 128, 1), (128, 1, 1), 0); del buf11  # reuse
    buf36 = buf34; del buf34  # reuse
    buf37 = reinterpret_tensor(buf28, (1, 32, 128, 80), (327680, 10240, 80, 1), 0); del buf28  # reuse
    ...
    buf38 = reinterpret_tensor(buf29, (32, 128, 80), (10240, 80, 1), 0); del buf29  # reuse
    # Source Nodes: [attn_output_5], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf36, reinterpret_tensor(buf37, (32, 128, 80), (10240, 80, 1), 0), out=buf38)
    buf39 = buf27; del buf27  # reuse
    cpp_fused_view_7(c_void_p(buf38.data_ptr()), c_void_p(buf39.data_ptr()))
    buf40 = reinterpret_tensor(buf38, (128, 2560), (2560, 1), 0); del buf38  # reuse
    # Source Nodes: [hidden_states_5], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_20, buf39, reinterpret_tensor(primals_19, (2560, 2560), (1, 2560), 0), alpha=1, beta=1, out=buf40)
    del primals_20
    # Source Nodes: [hidden_states_6], Original ATen: [aten.native_dropout]
    buf41 = aten.native_dropout(reinterpret_tensor(buf40, (1, 128, 2560), (327680, 2560, 1), 0), 0.1, True)
    buf42 = buf41[0]
    buf43 = buf41[1]
    del buf41
    buf44 = buf22; del buf22  # reuse
    buf45 = empty_strided((1, 128, 1), (128, 1, 128), device='cpu', dtype=torch.float32)
    buf47 = reinterpret_tensor(buf40, (1, 128, 2560), (327680, 2560, 1), 0); del buf40  # reuse
    buf48 = empty((128, 2560), device='cpu', dtype=torch.float32)
    ...
    del buf44
    del primals_22
    buf49 = empty((128, 10240), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_24, buf48, reinterpret_tensor(primals_23, (2560, 10240), (1, 2560), 0), alpha=1, beta=1, out=buf49)
    del primals_24
    buf50 = empty((128, 10240), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_view_9(c_void_p(buf49.data_ptr()), c_void_p(buf50.data_ptr()))
    buf51 = empty((128, 2560), device='cpu', dtype=torch.float32)
    # Source Nodes: [hidden_states_11], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_26, buf50, reinterpret_tensor(primals_25, (10240, 2560), (1, 10240), 0), alpha=1, beta=1, out=buf51)
    del primals_26
    # Source Nodes: [hidden_states_12], Original ATen: [aten.native_dropout]
    buf52 = aten.native_dropout(reinterpret_tensor(buf51, (1, 128, 2560), (327680, 2560, 1), 0), 0.1, True)
    del buf51
    buf53 = buf52[0]
    buf54 = buf52[1]
    del buf52
    buf55 = buf53; del buf53  # reuse
    buf56 = reinterpret_tensor(buf45, (1, 128, 1), (128, 1, 1), 0); del buf45  # reuse
    buf57 = reinterpret_tensor(buf23, (1, 128, 1), (128, 1, 1), 0); del buf23  # reuse
    ...
    return (buf55, primals_1, primals_11, primals_21, primals_27, buf0, buf3, buf4, buf17, buf21, buf25, buf26, reinterpret_tensor(primals_29, (128, 2560), (2560, 1), 0), buf32, buf33, buf35, buf39, buf43, buf47, buf48, buf49, buf50, buf54, reinterpret_tensor(primals_25, (2560, 10240), (10240, 1), 0), reinterpret_tensor(primals_23, (10240, 2560), (2560, 1), 0), buf56, reinterpret_tensor(primals_19, (2560, 2560), (2560, 1), 0), reinterpret_tensor(buf36, (32, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf37, (32, 80, 128), (10240, 1, 80), 0), reinterpret_tensor(buf30, (32, 80, 128), (10240, 1, 80), 0), reinterpret_tensor(buf31, (32, 128, 80), (10240, 80, 1), 0), reinterpret_tensor(primals_17, (2560, 2560), (2560, 1), 0), reinterpret_tensor(primals_15, (2560, 2560), (2560, 1), 0), reinterpret_tensor(primals_13, (2560, 2560), (2560, 1), 0), buf57, reinterpret_tensor(primals_9, (2560, 2560), (2560, 1), 0), reinterpret_tensor(buf14, (32, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf15, (32, 80, 128), (10240, 1, 80), 0), buf58, reinterpret_tensor(buf8, (32, 80, 128), (10240, 1, 80), 0), reinterpret_tensor(buf9, (32, 128, 80), (10240, 80, 1), 0), reinterpret_tensor(primals_7, (2560, 2560), (2560, 1), 0), reinterpret_tensor(primals_5, (2560, 2560), (2560, 1), 0), reinterpret_tensor(primals_3, (2560, 2560), (2560, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_13 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    primals_14 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_15 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    primals_16 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_17 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    primals_18 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_19 = rand_strided((2560, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    primals_20 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_21 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_22 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    primals_23 = rand_strided((10240, 2560), (2560, 1), device='cpu', dtype=torch.float32)
    primals_24 = rand_strided((10240, ), (1, ), device='cpu', dtype=torch.float32)
    primals_25 = rand_strided((2560, 10240), (10240, 1), device='cpu', dtype=torch.float32)
    primals_26 = rand_strided((2560, ), (1, ), device='cpu', dtype=torch.float32)
    ...
    primals_29 = rand_strided((1, 128, 2560), (327680, 2560, 1), device='cpu', dtype=torch.float32)
