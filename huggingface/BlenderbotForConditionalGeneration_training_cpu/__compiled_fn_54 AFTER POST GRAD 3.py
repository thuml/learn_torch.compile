...
def forward(self, primals_1: "f32[2560]", primals_11: "f32[2560]", primals_17: "f32[1, 128, 2560]", getitem_1: "f32[1, 128, 1]", rsqrt: "f32[1, 128, 1]", view: "f32[128, 2560]", bmm: "f32[32, 128, 128]", amax: "f32[32, 128, 1]", sum_1: "f32[32, 128, 1]", view_14: "f32[128, 2560]", getitem_3: "b8[1, 128, 2560]", mul_3: "f32[1, 128, 2560]", view_16: "f32[128, 2560]", addmm_4: "f32[128, 10240]", view_18: "f32[128, 10240]", getitem_7: "b8[1, 128, 2560]", permute_11: "f32[2560, 10240]", permute_15: "f32[10240, 2560]", div_1: "f32[1, 128, 1]", permute_19: "f32[2560, 2560]", permute_24: "f32[32, 128, 128]", permute_25: "f32[32, 80, 128]", permute_26: "f32[32, 80, 128]", permute_27: "f32[32, 128, 80]", permute_31: "f32[2560, 2560]", permute_36: "f32[2560, 2560]", permute_40: "f32[2560, 2560]", tangents_1: "f32[1, 128, 2560]"):
    ...
    sub: "f32[1, 128, 2560]" = torch.ops.aten.sub.Tensor(primals_17, getitem_1);  primals_17 = getitem_1 = None
    ...
    view_17: "f32[1, 128, 10240]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 10240]);  addmm_4 = None
    ...
    view_20: "f32[128, 2560]" = torch.ops.aten.reshape.default(mul_9, [128, 2560]);  mul_9 = None
    ...
    view_21: "f32[2560]" = torch.ops.aten.reshape.default(sum_2, [2560]);  sum_2 = None
    permute_14: "f32[2560, 10240]" = torch.ops.aten.permute.default(permute_13, [1, 0]);  permute_13 = None
    view_22: "f32[1, 128, 10240]" = torch.ops.aten.reshape.default(mm, [1, 128, 10240]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_11: "f32[1, 128, 10240]" = torch.ops.aten.mul.Tensor(add_5, 0.5);  add_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:332, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[128, 10240]" = torch.ops.aten.reshape.default(mul_16, [128, 10240]);  mul_16 = None
    ...
    view_24: "f32[10240]" = torch.ops.aten.reshape.default(sum_3, [10240]);  sum_3 = None
    permute_18: "f32[10240, 2560]" = torch.ops.aten.permute.default(permute_17, [1, 0]);  permute_17 = None
    view_25: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 2560]);  mm_2 = None
    ...
    mul_20: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul_18, mul_3);  mul_18 = None
    sum_5: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_20, [2], True);  mul_20 = None
    mul_21: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul_3, sum_5);  sum_5 = None
    ...
    mul_23: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(view_25, mul_3);  mul_3 = None
    ...
    view_26: "f32[128, 2560]" = torch.ops.aten.reshape.default(mul_25, [128, 2560]);  mul_25 = None
    ...
    view_27: "f32[2560]" = torch.ops.aten.reshape.default(sum_8, [2560]);  sum_8 = None
    permute_22: "f32[2560, 2560]" = torch.ops.aten.permute.default(permute_21, [1, 0]);  permute_21 = None
    view_28: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_4, [1, 128, 2560]);  mm_4 = None
    ...
    view_29: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(view_28, [1, 128, 32, 80]);  view_28 = None
    ...
    view_30: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(permute_23, [32, 128, 80]);  permute_23 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:240, code: attn_weights = nn.functional.softmax(attn_weights, dim=-1)
    mul_26: "f32[32, 128, 128]" = torch.ops.aten.mul.Tensor(bmm_3, div);  bmm_3 = None
    sum_9: "f32[32, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_26, [-1], True)
    mul_27: "f32[32, 128, 128]" = torch.ops.aten.mul.Tensor(div, sum_9);  div = sum_9 = None
    ...
    view_31: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(bmm_2, [1, 32, 128, 80]);  bmm_2 = None
    ...
    view_32: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(permute_28, [1, 32, 128, 80]);  permute_28 = None
    ...
    view_33: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(bmm_5, [1, 32, 128, 80]);  bmm_5 = None
    ...
    view_34: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(clone_8, [1, 128, 2560]);  clone_8 = None
    ...
    view_35: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 2560]);  clone_9 = None
    ...
    view_36: "f32[128, 2560]" = torch.ops.aten.reshape.default(view_35, [128, 2560]);  view_35 = None
    ...
    view_37: "f32[2560]" = torch.ops.aten.reshape.default(sum_10, [2560]);  sum_10 = None
    permute_34: "f32[2560, 2560]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_38: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 2560]);  mm_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:160, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_35: "f32[1, 128, 32, 80]" = torch.ops.aten.permute.default(view_32, [0, 2, 1, 3]);  view_32 = None
    view_39: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(permute_35, [1, 128, 2560]);  permute_35 = None
    ...
    view_40: "f32[128, 2560]" = torch.ops.aten.reshape.default(view_39, [128, 2560]);  view_39 = None
    ...
    mm_9: "f32[2560, 2560]" = torch.ops.aten.mm.default(permute_37, view);  permute_37 = None
    ...
    view_41: "f32[2560]" = torch.ops.aten.reshape.default(sum_11, [2560]);  sum_11 = None
    permute_39: "f32[2560, 2560]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_42: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 2560]);  mm_8 = None
    ...
    view_43: "f32[128, 2560]" = torch.ops.aten.reshape.default(mul_28, [128, 2560]);  mul_28 = None
    ...
    view_44: "f32[2560]" = torch.ops.aten.reshape.default(sum_12, [2560]);  sum_12 = None
    permute_43: "f32[2560, 2560]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_45: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 2560]);  mm_10 = None
    ...
    mul_32: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul_30, mul);  mul_30 = None
    sum_14: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_32, [2], True);  mul_32 = None
    mul_33: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul, sum_14);  sum_14 = None
    ...
    mul_35: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(add_11, mul);  mul = None
