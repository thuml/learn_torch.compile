...
def forward(self, primals_1: "f32[2560]", primals_2: "f32[2560]", primals_3: "f32[2560, 2560]", primals_4: "f32[2560]", primals_5: "f32[2560, 2560]", primals_6: "f32[2560]", primals_7: "f32[2560, 2560]", primals_8: "f32[2560]", primals_9: "f32[2560, 2560]", primals_10: "f32[2560]", primals_11: "f32[2560]", primals_12: "f32[2560]", primals_13: "f32[2560, 2560]", primals_14: "f32[2560]", primals_15: "f32[2560, 2560]", primals_16: "f32[2560]", primals_17: "f32[2560, 2560]", primals_18: "f32[2560]", primals_19: "f32[2560, 2560]", primals_20: "f32[2560]", primals_21: "f32[2560]", primals_22: "f32[2560]", primals_23: "f32[10240, 2560]", primals_24: "f32[10240]", primals_25: "f32[2560, 10240]", primals_26: "f32[2560]", primals_27: "f32[1, 128, 2560]", primals_28: "f32[1, 1, 128, 128]", primals_29: "f32[1, 128, 2560]"):
    ...
    view: "f32[128, 2560]" = torch.ops.aten.reshape.default(add_1, [128, 2560]);  add_1 = None
    ...
    view_1: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm, [1, 128, 2560]);  addmm = None
    ...
    addmm_1: "f32[128, 2560]" = torch.ops.aten.addmm.default(primals_6, view, permute_1);  primals_6 = None
    view_3: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_1, [1, 128, 2560]);  addmm_1 = None
    ...
    view_4: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(view_3, [1, -1, 32, 80]);  view_3 = None
    ...
    addmm_2: "f32[128, 2560]" = torch.ops.aten.addmm.default(primals_8, view, permute_3);  primals_8 = None
    view_6: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_2, [1, 128, 2560]);  addmm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:160, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_7: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(view_6, [1, -1, 32, 80]);  view_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:160, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_8: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(mul_2, [1, 128, 32, 80]);  mul_2 = None
    ...
    view_9: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(clone_2, [32, -1, 80]);  clone_2 = None
    ...
    view_10: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(clone, [32, -1, 80]);  clone = None
    ...
    view_12: "f32[1, 32, 128, 128]" = torch.ops.aten.reshape.default(bmm, [1, 32, 128, 128]);  bmm = None
    ...
    view_13: "f32[32, 128, 128]" = torch.ops.aten.reshape.default(add_2, [32, 128, 128]);  add_2 = None
    ...
    view_14: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(bmm_1, [1, 32, 128, 80]);  bmm_1 = None
    ...
    view_15: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(clone_4, [1, 128, 2560]);  clone_4 = None
    ...
    view_16: "f32[128, 2560]" = torch.ops.aten.reshape.default(view_15, [128, 2560]);  view_15 = None
    ...
    view_17: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_3, [1, 128, 2560]);  addmm_3 = None
    ...
    sub_2: "f32[1, 128, 2560]" = torch.ops.aten.sub.Tensor(add_3, getitem_5);  getitem_5 = None
    mul_3: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(sub_2, rsqrt_1);  sub_2 = None
    mul_4: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul_3, primals_11)
    add_5: "f32[1, 128, 2560]" = torch.ops.aten.add.Tensor(mul_4, primals_12);  mul_4 = primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:180, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_18: "f32[128, 2560]" = torch.ops.aten.reshape.default(add_5, [128, 2560]);  add_5 = None
    ...
    view_19: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 2560]);  addmm_4 = None
    ...
    view_20: "f32[128, 2560]" = torch.ops.aten.reshape.default(primals_29, [128, 2560]);  primals_29 = None
    ...
    view_21: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_5, [1, 128, 2560]);  addmm_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:160, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_22: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(view_21, [1, -1, 32, 80]);  view_21 = None
    ...
    addmm_6: "f32[128, 2560]" = torch.ops.aten.addmm.default(primals_18, view_20, permute_12);  primals_18 = None
    view_24: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_6, [1, 128, 2560]);  addmm_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:160, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 128, 32, 80]" = torch.ops.aten.reshape.default(mul_5, [1, 128, 32, 80]);  mul_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:219, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_27: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(clone_7, [32, -1, 80]);  clone_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:220, code: key_states = key_states.reshape(*proj_shape)
    view_28: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(clone_5, [32, -1, 80]);  clone_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:221, code: value_states = value_states.reshape(*proj_shape)
    view_29: "f32[32, 128, 80]" = torch.ops.aten.reshape.default(clone_6, [32, -1, 80]);  clone_6 = None
    ...
    sub_3: "f32[32, 128, 128]" = torch.ops.aten.sub.Tensor(bmm_2, amax_1)
    ...
    div_1: "f32[32, 128, 128]" = torch.ops.aten.div.Tensor(exp_1, sum_2);  exp_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:263, code: attn_output = torch.bmm(attn_probs, value_states)
    bmm_3: "f32[32, 128, 80]" = torch.ops.aten.bmm.default(div_1, view_29)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:271, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[1, 32, 128, 80]" = torch.ops.aten.reshape.default(bmm_3, [1, 32, 128, 80]);  bmm_3 = None
    ...
    view_31: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 2560]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:278, code: attn_output = self.out_proj(attn_output)
    view_32: "f32[128, 2560]" = torch.ops.aten.reshape.default(view_31, [128, 2560]);  view_31 = None
    ...
    view_33: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_7, [1, 128, 2560]);  addmm_7 = None
    ...
    add_6: "f32[1, 128, 2560]" = torch.ops.aten.add.Tensor(add_3, getitem_6);  add_3 = getitem_6 = None
    ...
    sub_4: "f32[1, 128, 2560]" = torch.ops.aten.sub.Tensor(add_6, getitem_9);  getitem_9 = None
    mul_6: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(sub_4, rsqrt_2);  sub_4 = None
    mul_7: "f32[1, 128, 2560]" = torch.ops.aten.mul.Tensor(mul_6, primals_21)
    ...
    view_34: "f32[128, 2560]" = torch.ops.aten.reshape.default(add_8, [128, 2560]);  add_8 = None
    ...
    view_35: "f32[1, 128, 10240]" = torch.ops.aten.reshape.default(addmm_8, [1, 128, 10240])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_8: "f32[1, 128, 10240]" = torch.ops.aten.mul.Tensor(view_35, 0.5)
    mul_9: "f32[1, 128, 10240]" = torch.ops.aten.mul.Tensor(view_35, 0.7071067811865476);  view_35 = None
    ...
    view_36: "f32[128, 10240]" = torch.ops.aten.reshape.default(mul_10, [128, 10240]);  mul_10 = None
    ...
    view_37: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(addmm_9, [1, 128, 2560]);  addmm_9 = None
    ...
    add_10: "f32[1, 128, 2560]" = torch.ops.aten.add.Tensor(add_6, getitem_10);  add_6 = getitem_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot/modeling_blenderbot.py:263, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_33: "f32[32, 128, 128]" = torch.ops.aten.permute.default(div_1, [0, 2, 1]);  div_1 = None
