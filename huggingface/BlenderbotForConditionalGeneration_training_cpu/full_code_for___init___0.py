...
def __resume_at_6_10(self, hidden_states, attentions):
    self.hidden_states = hidden_states
    self.attentions = attentions
    self.__post_init__()
    return None

def transformed___resume_at_6_10(self, hidden_states, attentions):
    L = {"self": self, "hidden_states": hidden_states, "attentions": attentions}
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_6_10(self, hidden_states, attentions)

#============ end of __resume_at_6_10 ============#
