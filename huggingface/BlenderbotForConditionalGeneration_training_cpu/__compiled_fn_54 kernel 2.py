...
def call(args):
    ...
    assert_size_stride(tangents_1, (128, 2560), (2560, 1))
    buf0 = empty((128, 2560), device='cpu', dtype=torch.float32)
    buf1 = empty((128, 2560), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    tangents_1 = rand_strided((128, 2560), (2560, 1), device='cpu', dtype=torch.float32)
