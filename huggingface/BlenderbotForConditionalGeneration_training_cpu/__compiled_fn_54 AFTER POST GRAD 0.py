...
def forward(self, primals_4: "i64[1, 128]", view: "f32[128, 2560]", sub_1: "f32[128, 8008]", convert_element_type: "f32[]", permute_3: "f32[8008, 2560]", tangents_1: "f32[]", tangents_2: "f32[1, 128, 8008]"):
    ...
    exp_1: "f32[128, 8008]" = torch.ops.aten.exp.default(sub_1);  sub_1 = None
    ...
    view_4: "f32[1, 128, 8008]" = torch.ops.aten.reshape.default(sub_2, [1, 128, 8008]);  sub_2 = None
    ...
    view_5: "f32[128, 8008]" = torch.ops.aten.reshape.default(add_1, [128, 8008]);  add_1 = None
    ...
    view_6: "f32[1, 128, 2560]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 2560]);  mm_2 = None
