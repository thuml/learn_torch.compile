...
def __resume_at_6_40(self, past_key_values, hidden_states, attentions, cross_attentions):
...
def transformed___resume_at_6_40(self, past_key_values, hidden_states, attentions, cross_attentions):
    ...
    return __resume_at_6_40(self, past_key_values, hidden_states, attentions, cross_attentions)

#============ end of __resume_at_6_40 ============#
...
def __transformed_code_1_for___init__(self, last_hidden_state, past_key_values, hidden_states, attentions, cross_attentions):
    ...
    return __resume_at_6_40(self, past_key_values, hidden_states, attentions,
        cross_attentions)
