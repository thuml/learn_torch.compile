...
def forward(self, L_cloned_inputs_input_ids_ : torch.Tensor, L_cloned_inputs_labels_ : torch.Tensor):
    ...
    view_97 = l_cloned_inputs_labels_.view(-1);  l_cloned_inputs_labels_ = None
    loss = torch.nn.functional.cross_entropy(view_96, view_97, None, None, -100, None, 'mean', 0.0);  view_96 = view_97 = None
