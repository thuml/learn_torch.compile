...
def call(args):
    ...
    cpp_fused_native_dropout_backward_native_layer_norm_backward_sum_3(c_void_p(buf8.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(primals_196.data_ptr()), c_void_p(mul_86.data_ptr()), c_void_p(div_30.data_ptr()), c_void_p(getitem_121.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()), c_void_p(buf13.data_ptr()), c_void_p(buf14.data_ptr()), c_void_p(buf15.data_ptr()), c_void_p(buf16.data_ptr()), c_void_p(buf17.data_ptr()))
    del buf8
    del div_30
    del getitem_121
    del mul_86
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_11(c_void_p(buf55.data_ptr()), c_void_p(buf48.data_ptr()), c_void_p(buf27.data_ptr()), c_void_p(buf41.data_ptr()), c_void_p(buf45.data_ptr()), c_void_p(buf49.data_ptr()), c_void_p(primals_180.data_ptr()), c_void_p(mul_79.data_ptr()), c_void_p(div_33.data_ptr()), c_void_p(getitem_111.data_ptr()), c_void_p(buf51.data_ptr()), c_void_p(buf53.data_ptr()), c_void_p(buf54.data_ptr()), c_void_p(buf56.data_ptr()), c_void_p(buf57.data_ptr()), c_void_p(buf58.data_ptr()))
    del div_33
    del getitem_111
    del mul_79
    del primals_180
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_21(c_void_p(buf103.data_ptr()), c_void_p(buf96.data_ptr()), c_void_p(buf104.data_ptr()), c_void_p(primals_158.data_ptr()), c_void_p(mul_67.data_ptr()), c_void_p(div_37.data_ptr()), c_void_p(getitem_97.data_ptr()), c_void_p(buf106.data_ptr()), c_void_p(buf107.data_ptr()), c_void_p(buf108.data_ptr()), c_void_p(buf109.data_ptr()), c_void_p(buf110.data_ptr()), c_void_p(buf111.data_ptr()), c_void_p(buf112.data_ptr()))
    del div_37
    del getitem_97
    del mul_67
    del primals_158
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_27(c_void_p(buf137.data_ptr()), c_void_p(buf130.data_ptr()), c_void_p(buf109.data_ptr()), c_void_p(buf123.data_ptr()), c_void_p(buf127.data_ptr()), c_void_p(buf131.data_ptr()), c_void_p(primals_148.data_ptr()), c_void_p(mul_65.data_ptr()), c_void_p(div_39.data_ptr()), c_void_p(getitem_91.data_ptr()), c_void_p(buf133.data_ptr()), c_void_p(buf135.data_ptr()), c_void_p(buf136.data_ptr()), c_void_p(buf138.data_ptr()), c_void_p(buf139.data_ptr()), c_void_p(buf140.data_ptr()))
    del div_39
    del getitem_91
    del mul_65
    del primals_148
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_35(c_void_p(buf178.data_ptr()), c_void_p(buf171.data_ptr()), c_void_p(buf150.data_ptr()), c_void_p(buf164.data_ptr()), c_void_p(buf168.data_ptr()), c_void_p(buf172.data_ptr()), c_void_p(primals_132.data_ptr()), c_void_p(mul_58.data_ptr()), c_void_p(div_42.data_ptr()), c_void_p(getitem_81.data_ptr()), c_void_p(buf174.data_ptr()), c_void_p(buf176.data_ptr()), c_void_p(buf177.data_ptr()), c_void_p(buf179.data_ptr()), c_void_p(buf180.data_ptr()), c_void_p(buf181.data_ptr()))
    del div_42
    del getitem_81
    del mul_58
    del primals_132
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_43(c_void_p(buf219.data_ptr()), c_void_p(buf212.data_ptr()), c_void_p(buf191.data_ptr()), c_void_p(buf205.data_ptr()), c_void_p(buf209.data_ptr()), c_void_p(buf213.data_ptr()), c_void_p(primals_116.data_ptr()), c_void_p(mul_51.data_ptr()), c_void_p(div_45.data_ptr()), c_void_p(getitem_71.data_ptr()), c_void_p(buf215.data_ptr()), c_void_p(buf217.data_ptr()), c_void_p(buf218.data_ptr()), c_void_p(buf220.data_ptr()), c_void_p(buf221.data_ptr()), c_void_p(buf222.data_ptr()))
    del div_45
    del getitem_71
    del mul_51
    del primals_116
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_45(c_void_p(buf226.data_ptr()), c_void_p(buf219.data_ptr()), c_void_p(buf227.data_ptr()), c_void_p(primals_110.data_ptr()), c_void_p(mul_46.data_ptr()), c_void_p(div_46.data_ptr()), c_void_p(getitem_67.data_ptr()), c_void_p(buf229.data_ptr()), c_void_p(buf230.data_ptr()), c_void_p(buf231.data_ptr()), c_void_p(buf232.data_ptr()), c_void_p(buf233.data_ptr()), c_void_p(buf234.data_ptr()), c_void_p(buf235.data_ptr()))
    del div_46
    del getitem_67
    del mul_46
    del primals_110
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_51(c_void_p(buf260.data_ptr()), c_void_p(buf253.data_ptr()), c_void_p(buf232.data_ptr()), c_void_p(buf246.data_ptr()), c_void_p(buf250.data_ptr()), c_void_p(buf254.data_ptr()), c_void_p(primals_100.data_ptr()), c_void_p(mul_44.data_ptr()), c_void_p(div_48.data_ptr()), c_void_p(getitem_61.data_ptr()), c_void_p(buf256.data_ptr()), c_void_p(buf258.data_ptr()), c_void_p(buf259.data_ptr()), c_void_p(buf261.data_ptr()), c_void_p(buf262.data_ptr()), c_void_p(buf263.data_ptr()))
    del div_48
    del getitem_61
    del mul_44
    del primals_100
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_53(c_void_p(buf267.data_ptr()), c_void_p(buf260.data_ptr()), c_void_p(buf268.data_ptr()), c_void_p(primals_94.data_ptr()), c_void_p(mul_39.data_ptr()), c_void_p(div_49.data_ptr()), c_void_p(getitem_57.data_ptr()), c_void_p(buf270.data_ptr()), c_void_p(buf271.data_ptr()), c_void_p(buf272.data_ptr()), c_void_p(buf273.data_ptr()), c_void_p(buf274.data_ptr()), c_void_p(buf275.data_ptr()), c_void_p(buf276.data_ptr()))
    del div_49
    del getitem_57
    del mul_39
    del primals_94
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_59(c_void_p(buf301.data_ptr()), c_void_p(buf294.data_ptr()), c_void_p(buf273.data_ptr()), c_void_p(buf287.data_ptr()), c_void_p(buf291.data_ptr()), c_void_p(buf295.data_ptr()), c_void_p(primals_84.data_ptr()), c_void_p(mul_37.data_ptr()), c_void_p(div_51.data_ptr()), c_void_p(getitem_51.data_ptr()), c_void_p(buf297.data_ptr()), c_void_p(buf299.data_ptr()), c_void_p(buf300.data_ptr()), c_void_p(buf302.data_ptr()), c_void_p(buf303.data_ptr()), c_void_p(buf304.data_ptr()))
    del div_51
    del getitem_51
    del mul_37
    del primals_84
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_61(c_void_p(buf308.data_ptr()), c_void_p(buf301.data_ptr()), c_void_p(buf309.data_ptr()), c_void_p(primals_78.data_ptr()), c_void_p(mul_32.data_ptr()), c_void_p(div_52.data_ptr()), c_void_p(getitem_47.data_ptr()), c_void_p(buf311.data_ptr()), c_void_p(buf312.data_ptr()), c_void_p(buf313.data_ptr()), c_void_p(buf314.data_ptr()), c_void_p(buf315.data_ptr()), c_void_p(buf316.data_ptr()), c_void_p(buf317.data_ptr()))
    del div_52
    del getitem_47
    del mul_32
    del primals_78
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_69(c_void_p(buf349.data_ptr()), c_void_p(buf342.data_ptr()), c_void_p(buf350.data_ptr()), c_void_p(primals_62.data_ptr()), c_void_p(mul_25.data_ptr()), c_void_p(div_55.data_ptr()), c_void_p(getitem_37.data_ptr()), c_void_p(buf352.data_ptr()), c_void_p(buf353.data_ptr()), c_void_p(buf354.data_ptr()), c_void_p(buf355.data_ptr()), c_void_p(buf356.data_ptr()), c_void_p(buf357.data_ptr()), c_void_p(buf358.data_ptr()))
    del div_55
    del getitem_37
    del mul_25
    del primals_62
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_77(c_void_p(buf390.data_ptr()), c_void_p(buf383.data_ptr()), c_void_p(buf391.data_ptr()), c_void_p(primals_46.data_ptr()), c_void_p(mul_18.data_ptr()), c_void_p(div_58.data_ptr()), c_void_p(getitem_27.data_ptr()), c_void_p(buf393.data_ptr()), c_void_p(buf394.data_ptr()), c_void_p(buf395.data_ptr()), c_void_p(buf396.data_ptr()), c_void_p(buf397.data_ptr()), c_void_p(buf398.data_ptr()), c_void_p(buf399.data_ptr()))
    del div_58
    del getitem_27
    del mul_18
    del primals_46
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_85(c_void_p(buf431.data_ptr()), c_void_p(buf424.data_ptr()), c_void_p(buf432.data_ptr()), c_void_p(primals_30.data_ptr()), c_void_p(mul_11.data_ptr()), c_void_p(div_61.data_ptr()), c_void_p(getitem_17.data_ptr()), c_void_p(buf434.data_ptr()), c_void_p(buf435.data_ptr()), c_void_p(buf436.data_ptr()), c_void_p(buf437.data_ptr()), c_void_p(buf438.data_ptr()), c_void_p(buf439.data_ptr()), c_void_p(buf440.data_ptr()))
    del div_61
    del getitem_17
    del mul_11
    del primals_30
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_91(c_void_p(buf465.data_ptr()), c_void_p(buf458.data_ptr()), c_void_p(buf437.data_ptr()), c_void_p(buf451.data_ptr()), c_void_p(buf455.data_ptr()), c_void_p(buf459.data_ptr()), c_void_p(primals_20.data_ptr()), c_void_p(mul_9.data_ptr()), c_void_p(div_63.data_ptr()), c_void_p(getitem_11.data_ptr()), c_void_p(buf461.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf468.data_ptr()))
    del div_63
    del getitem_11
    del mul_9
    del primals_20
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_93(c_void_p(buf472.data_ptr()), c_void_p(buf465.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(primals_14.data_ptr()), c_void_p(mul_4.data_ptr()), c_void_p(div_64.data_ptr()), c_void_p(getitem_7.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()))
    del buf472
    del div_64
    del getitem_7
    del mul_4
    ...
    del mul_2
    del primals_4
    aten.index_put_(buf509, [add_1], buf510, True)
    del add_1
    del buf510
    ...
    del buf514
    del expand
    buf517 = empty((50265, 768), device='cpu', dtype=torch.float32)
    cpp_fused_embedding_dense_backward_101(c_void_p(buf517.data_ptr()))
    aten.index_put_(buf517, [primals_201], buf518, True)
    del buf518
    del primals_201
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    ne_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.bool)
    sub_41 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.float32)
    ne_4 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.bool)
    ne_7 = rand_strided((1, 1), (1, 1), device='cpu', dtype=torch.bool)
    where_4 = rand_strided((1, 1), (1, 1), device='cpu', dtype=torch.int64)
    ne_9 = rand_strided((1, 1), (1, 1), device='cpu', dtype=torch.bool)
