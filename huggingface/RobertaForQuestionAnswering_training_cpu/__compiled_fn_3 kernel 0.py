...
cpp_fused__log_softmax_add_clamp_clone_div_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_86 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    cpp_fused__to_copy_cumsum_ne_0(c_void_p(primals_201.data_ptr()), c_void_p(buf0.data_ptr()))
    ...
    cpp_fused__to_copy_add_embedding_mul_native_layer_norm_ne_1(c_void_p(buf3.data_ptr()), c_void_p(primals_201.data_ptr()), c_void_p(primals_1.data_ptr()), c_void_p(primals_200.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(primals_5.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf5.data_ptr()), c_void_p(buf6.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf9.data_ptr()))
    del primals_1
    del primals_2
    del primals_3
    del primals_5
    ...
    del primals_191
    del primals_197
    buf457 = empty((512, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_199, buf456, reinterpret_tensor(primals_198, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf457)
    del primals_199
    buf458 = reinterpret_tensor(buf452, (1, 512), (512, 1), 0); del buf452  # reuse
    buf460 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf459 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf464 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf461 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf462 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf465 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf466 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf463 = empty((1, ), device='cpu', dtype=torch.bool)
    buf467 = empty((1, ), device='cpu', dtype=torch.bool)
    buf497 = empty((), device='cpu', dtype=torch.float32)
    buf468 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf469 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf470 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf471 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf472 = reinterpret_tensor(buf453, (1, 512, 1), (512, 1, 1), 0); del buf453  # reuse
    buf473 = reinterpret_tensor(buf442, (1, 512, 1), (512, 1, 1), 0); del buf442  # reuse
    buf474 = reinterpret_tensor(buf416, (1, 512, 1), (512, 1, 1), 0); del buf416  # reuse
    buf475 = reinterpret_tensor(buf405, (1, 512, 1), (512, 1, 1), 0); del buf405  # reuse
    buf476 = reinterpret_tensor(buf379, (1, 512, 1), (512, 1, 1), 0); del buf379  # reuse
    buf477 = reinterpret_tensor(buf368, (1, 512, 1), (512, 1, 1), 0); del buf368  # reuse
    buf478 = reinterpret_tensor(buf342, (1, 512, 1), (512, 1, 1), 0); del buf342  # reuse
    buf479 = reinterpret_tensor(buf331, (1, 512, 1), (512, 1, 1), 0); del buf331  # reuse
    buf480 = reinterpret_tensor(buf305, (1, 512, 1), (512, 1, 1), 0); del buf305  # reuse
    buf481 = reinterpret_tensor(buf294, (1, 512, 1), (512, 1, 1), 0); del buf294  # reuse
    buf482 = reinterpret_tensor(buf268, (1, 512, 1), (512, 1, 1), 0); del buf268  # reuse
    buf483 = reinterpret_tensor(buf257, (1, 512, 1), (512, 1, 1), 0); del buf257  # reuse
    buf484 = reinterpret_tensor(buf231, (1, 512, 1), (512, 1, 1), 0); del buf231  # reuse
    buf485 = reinterpret_tensor(buf220, (1, 512, 1), (512, 1, 1), 0); del buf220  # reuse
    buf486 = reinterpret_tensor(buf194, (1, 512, 1), (512, 1, 1), 0); del buf194  # reuse
    buf487 = reinterpret_tensor(buf183, (1, 512, 1), (512, 1, 1), 0); del buf183  # reuse
    buf488 = reinterpret_tensor(buf157, (1, 512, 1), (512, 1, 1), 0); del buf157  # reuse
    buf489 = reinterpret_tensor(buf146, (1, 512, 1), (512, 1, 1), 0); del buf146  # reuse
    buf490 = reinterpret_tensor(buf120, (1, 512, 1), (512, 1, 1), 0); del buf120  # reuse
    buf491 = reinterpret_tensor(buf109, (1, 512, 1), (512, 1, 1), 0); del buf109  # reuse
    buf492 = reinterpret_tensor(buf83, (1, 512, 1), (512, 1, 1), 0); del buf83  # reuse
    buf493 = reinterpret_tensor(buf72, (1, 512, 1), (512, 1, 1), 0); del buf72  # reuse
    buf494 = reinterpret_tensor(buf46, (1, 512, 1), (512, 1, 1), 0); del buf46  # reuse
    buf495 = reinterpret_tensor(buf35, (1, 512, 1), (512, 1, 1), 0); del buf35  # reuse
    buf496 = reinterpret_tensor(buf6, (1, 512, 1), (512, 1, 1), 0); del buf6  # reuse
    cpp_fused__log_softmax_add_clamp_clone_div_native_layer_norm_native_layer_norm_backward_nll_loss_backward_nll_loss_forward_86(c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()), c_void_p(buf486.data_ptr()), c_void_p(buf487.data_ptr()), c_void_p(buf488.data_ptr()), c_void_p(buf489.data_ptr()), c_void_p(buf490.data_ptr()), c_void_p(buf491.data_ptr()), c_void_p(buf492.data_ptr()), c_void_p(buf493.data_ptr()), c_void_p(buf494.data_ptr()), c_void_p(buf495.data_ptr()), c_void_p(buf496.data_ptr()), c_void_p(buf457.data_ptr()), c_void_p(primals_202.data_ptr()), c_void_p(primals_203.data_ptr()), c_void_p(buf458.data_ptr()), c_void_p(buf460.data_ptr()), c_void_p(buf459.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(buf461.data_ptr()), c_void_p(buf462.data_ptr()), c_void_p(buf465.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf497.data_ptr()), c_void_p(buf468.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()))
    del buf457
    del buf460
    del buf461
    del buf464
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_202 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
