...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139707508795584)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 143205936)) \
        and (___check_type_id(L['input_ids'], 73254752)) \
        ...
        and (___check_type_id(G['torch'].long, 139709492070144)) \
