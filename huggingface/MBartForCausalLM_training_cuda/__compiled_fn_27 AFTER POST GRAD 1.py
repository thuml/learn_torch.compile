...
def forward(self, primals_1: "f32[1024]", primals_11: "f32[1024]", primals_17: "f32[1, 1024, 1024]", getitem_1: "f32[1, 1024, 1]", rsqrt: "f32[1, 1024, 1]", view: "f32[1024, 1024]", view_16: "f32[1024, 1024]", getitem_3: "b8[1, 1024, 1024]", mul_3: "f32[1, 1024, 1024]", view_18: "f32[1024, 1024]", addmm_4: "f32[1024, 4096]", view_20: "f32[1024, 4096]", getitem_7: "b8[1, 1024, 1024]", permute_11: "f32[1024, 4096]", permute_15: "f32[4096, 1024]", div_1: "f32[1, 1024, 1]", permute_19: "f32[1024, 1024]", permute_24: "f32[16, 1024, 1024]", permute_25: "f32[16, 64, 1024]", alias_1: "f32[16, 1024, 1024]", permute_26: "f32[16, 64, 1024]", permute_27: "f32[16, 1024, 64]", permute_31: "f32[1024, 1024]", permute_36: "f32[1024, 1024]", permute_40: "f32[1024, 1024]", tangents_1: "f32[1, 1024, 1024]", tangents_2: "f32[1, 16, 1024, 64]", tangents_3: "f32[1, 16, 1024, 64]"):
    ...
    view_19: "f32[1, 1024, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 1024, 4096]);  addmm_4 = None
    ...
    view_22: "f32[1024, 1024]" = torch.ops.aten.reshape.default(mul_9, [1024, 1024]);  mul_9 = None
    ...
    view_24: "f32[1, 1024, 4096]" = torch.ops.aten.reshape.default(mm, [1, 1024, 4096]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_11: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_6, 0.5);  add_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:460, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_25: "f32[1024, 4096]" = torch.ops.aten.reshape.default(mul_16, [1024, 4096]);  mul_16 = None
    ...
    view_27: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(mm_2, [1, 1024, 1024]);  mm_2 = None
    ...
    mul_23: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_27, mul_3);  mul_3 = None
    ...
    view_28: "f32[1024, 1024]" = torch.ops.aten.reshape.default(mul_25, [1024, 1024]);  mul_25 = None
    ...
    view_30: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(mm_4, [1, 1024, 1024]);  mm_4 = None
    ...
    view_31: "f32[1, 1024, 16, 64]" = torch.ops.aten.reshape.default(view_30, [1, 1024, 16, 64]);  view_30 = None
    ...
    view_32: "f32[16, 1024, 64]" = torch.ops.aten.reshape.default(permute_23, [16, 1024, 64]);  permute_23 = None
    ...
    view_33: "f32[1, 16, 1024, 1024]" = torch.ops.aten.reshape.default(sub_6, [1, 16, 1024, 1024]);  sub_6 = None
    ...
    view_34: "f32[16, 1024, 1024]" = torch.ops.aten.reshape.default(view_33, [16, 1024, 1024]);  view_33 = None
    ...
    view_35: "f32[1, 16, 1024, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 16, 1024, 64]);  bmm_2 = None
    ...
    view_36: "f32[1, 16, 1024, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 16, 1024, 64]);  permute_28 = None
    ...
    view_37: "f32[1, 16, 1024, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 16, 1024, 64]);  bmm_5 = None
    ...
    view_38: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(clone_8, [1, 1024, 1024]);  clone_8 = None
    ...
    view_39: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 1024, 1024]);  clone_9 = None
    ...
    view_42: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(mm_6, [1, 1024, 1024]);  mm_6 = None
    ...
    view_43: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(clone_10, [1, 1024, 1024]);  clone_10 = None
    ...
    view_44: "f32[1024, 1024]" = torch.ops.aten.reshape.default(view_43, [1024, 1024]);  view_43 = None
    ...
    view_45: "f32[1024]" = torch.ops.aten.reshape.default(sum_11, [1024]);  sum_11 = None
    permute_39: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_46: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(mm_8, [1, 1024, 1024]);  mm_8 = None
    ...
    view_47: "f32[1024, 1024]" = torch.ops.aten.reshape.default(mul_28, [1024, 1024]);  mul_28 = None
    ...
    view_49: "f32[1, 1024, 1024]" = torch.ops.aten.reshape.default(mm_10, [1, 1024, 1024]);  mm_10 = None
    ...
    mul_35: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_14, mul);  mul = None
