...
def forward(self, primals, tangents):
    primals_1: "f32[50265, 1024]"; primals_2: "f32[1, 1024, 1024]"; primals_3: "i64[1, 1024]"; tangents_1: "f32[]"; tangents_2: "f32[1, 1024, 50265]"; 
    ...
    view: "f32[1024, 1024]" = torch.ops.aten.view.default(primals_2, [1024, 1024]);  primals_2 = None
    ...
    view_2: "f32[1024, 50265]" = torch.ops.aten.view.default(view_1, [-1, 50265])
    view_3: "i64[1024]" = torch.ops.aten.view.default(primals_3, [-1]);  primals_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:1871, code: loss = loss_fct(logits.view(-1, self.config.vocab_size), labels.view(-1))
    add: "f32[1, 1024, 50265]" = torch.ops.aten.add.Tensor(tangents_2, view_4);  tangents_2 = view_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:1865, code: logits = self.lm_head(outputs[0])
    view_5: "f32[1024, 50265]" = torch.ops.aten.view.default(add, [1024, 50265]);  add = None
