...
# kernel path: /tmp/torchinductor_youkaichao/ow/cowm2dkzoi6snsmzcw4hdxrjg2aw6ho4djhzjsiz7sxx2wccvacy.py
...
# kernel path: /tmp/torchinductor_youkaichao/pd/cpda7xexr6hveka7onp6hp7c3l64i3wr5juupocblqjkjm6ozitz.py
# Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty((1026, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        stream0 = get_cuda_stream(0)
        triton_poi_fused_embedding_dense_backward_0.run(buf0, 1050624, grid=grid(1050624), stream=stream0)
        buf1 = empty((1, 1024, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_1.run(tangents_1, buf1, 1048576, grid=grid(1048576), stream=stream0)
        del tangents_1
