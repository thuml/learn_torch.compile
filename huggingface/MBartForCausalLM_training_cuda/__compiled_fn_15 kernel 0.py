...
# kernel path: /tmp/torchinductor_youkaichao/wl/cwl3uizsp3kql75byoetuvjmdh53d2ah2wkxci4b2kchlniy34hc.py
...
# kernel path: /tmp/torchinductor_youkaichao/ab/cabdrgmlxrurhtojnk72ottaxy44bdrb4yhbfme3tyyb2cta7h7s.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_native_layer_norm_view_0.run(buf3, primals_17, primals_1, primals_2, buf0, buf4, 1024, 1024, grid=grid(1024), stream=stream0)
        del primals_2
        ...
        # Source Nodes: [key_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf6, primals_6, buf7, 1048576, grid=grid(1048576), stream=stream0)
        del primals_6
        buf8 = buf6; del buf6  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf4, reinterpret_tensor(primals_7, (1024, 1024), (1, 1024), 0), out=buf8)
        buf9 = empty((1, 16, 1024, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf8, primals_8, buf9, 1048576, grid=grid(1048576), stream=stream0)
        del primals_8
        buf10 = reinterpret_tensor(buf8, (1, 16, 1024, 64), (1048576, 65536, 64, 1), 0); del buf8  # reuse
        # Source Nodes: [contiguous_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf5, primals_4, buf10, 1048576, grid=grid(1048576), stream=stream0)
        del primals_4
        ...
        # Source Nodes: [attn_probs, attn_weights_3], Original ATen: [aten._softmax, aten.clone, aten.detach]
        triton_per_fused__softmax_clone_detach_3.run(buf11, primals_18, buf14, buf34, 16384, 1024, grid=grid(16384), stream=stream0)
        del buf11
        del primals_18
        buf15 = reinterpret_tensor(buf5, (16, 1024, 64), (65536, 64, 1), 0); del buf5  # reuse
        ...
        # Source Nodes: [hidden_states_4, l__self___fc1, residual_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(primals_17, buf19, primals_11, primals_12, buf24, buf25, buf33, 1024, 1024, grid=grid(1024), stream=stream0)
        del primals_12
        buf26 = empty((1024, 4096), device='cuda', dtype=torch.float32)
        ...
        del primals_14
        buf27 = empty((1024, 4096), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_5, hidden_states_7], Original ATen: [aten.gelu, aten.view]
        triton_poi_fused_gelu_view_6.run(buf26, buf27, 4194304, grid=grid(4194304), stream=stream0)
        ...
        buf29 = aten.native_dropout(reinterpret_tensor(buf28, (1, 1024, 1024), (1048576, 1024, 1), 0), 0.1, True)
        del buf28
        buf30 = buf29[0]
        buf31 = buf29[1]
        del buf29
        ...
        # Source Nodes: [hidden_states_9, residual_1], Original ATen: [aten.add]
        triton_poi_fused_add_7.run(buf32, primals_17, buf19, 1048576, grid=grid(1048576), stream=stream0)
        return (buf32, buf7, buf9, primals_1, primals_11, primals_17, buf0, buf3, buf4, buf16, buf20, buf24, buf25, buf26, buf27, buf31, reinterpret_tensor(primals_15, (1024, 4096), (4096, 1), 0), reinterpret_tensor(primals_13, (4096, 1024), (1024, 1), 0), buf33, reinterpret_tensor(primals_9, (1024, 1024), (1024, 1), 0), reinterpret_tensor(buf14, (16, 1024, 1024), (1048576, 1, 1024), 0), reinterpret_tensor(buf9, (16, 64, 1024), (65536, 1, 64), 0), buf34, reinterpret_tensor(buf10, (16, 64, 1024), (65536, 1, 64), 0), reinterpret_tensor(buf7, (16, 1024, 64), (65536, 64, 1), 0), reinterpret_tensor(primals_7, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_3, (1024, 1024), (1024, 1), 0), )
