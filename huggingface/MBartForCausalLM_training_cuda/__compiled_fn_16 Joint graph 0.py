...
def forward(self, primals, tangents):
    primals_1: "f32[1024]"; primals_2: "f32[1024]"; primals_3: "f32[1024, 1024]"; primals_4: "f32[1024]"; primals_5: "f32[1024, 1024]"; primals_6: "f32[1024]"; primals_7: "f32[1024, 1024]"; primals_8: "f32[1024]"; primals_9: "f32[1024, 1024]"; primals_10: "f32[1024]"; primals_11: "f32[1024]"; primals_12: "f32[1024]"; primals_13: "f32[4096, 1024]"; primals_14: "f32[4096]"; primals_15: "f32[1024, 4096]"; primals_16: "f32[1024]"; primals_17: "f32[1, 1024, 1024]"; primals_18: "f32[1, 1, 1024, 1024]"; tangents_1: "f32[1, 1024, 1024]"; tangents_2: "f32[1, 16, 1024, 64]"; tangents_3: "f32[1, 16, 1024, 64]"; 
    ...
    view_10: "f32[16, 1024, 64]" = torch.ops.aten.view.default(clone, [16, -1, 64])
    ...
    view_11: "f32[16, 1024, 64]" = torch.ops.aten.view.default(clone_1, [16, -1, 64])
    ...
    mul_6: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476)
    ...
    view_20: "f32[1024, 4096]" = torch.ops.aten.view.default(clone_5, [1024, 4096]);  clone_5 = None
    ...
    add_7: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_3, getitem_6);  getitem_6 = None
    ...
    clone_6: "f32[1, 1024, 1024]" = torch.ops.aten.clone.default(mul_9, memory_format = torch.contiguous_format);  mul_9 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_10: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476)
    erf_1: "f32[1, 1024, 4096]" = torch.ops.aten.erf.default(mul_10);  mul_10 = None
    add_8: "f32[1, 1024, 4096]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_11: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(add_8, 0.5);  add_8 = None
    mul_12: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_19, view_19)
    ...
    mul_15: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_19, mul_14);  view_19 = mul_14 = None
    add_9: "f32[1, 1024, 4096]" = torch.ops.aten.add.Tensor(mul_11, mul_15);  mul_11 = mul_15 = None
    mul_16: "f32[1, 1024, 4096]" = torch.ops.aten.mul.Tensor(view_24, add_9);  view_24 = add_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:460, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_25: "f32[1024, 4096]" = torch.ops.aten.view.default(mul_16, [1024, 4096]);  mul_16 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:459, code: hidden_states = self.final_layer_norm(hidden_states)
    sub_3: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_5);  add_3 = getitem_5 = None
    mul_17: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    mul_18: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_27, primals_11);  primals_11 = None
    ...
    mul_20: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_18, mul_17);  mul_18 = None
    sum_5: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_20, [2], True);  mul_20 = None
    mul_21: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_17, sum_5);  sum_5 = None
    ...
    mul_23: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_27, mul_17);  mul_17 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:459, code: hidden_states = self.final_layer_norm(hidden_states)
    add_10: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(tangents_1, mul_22);  tangents_1 = mul_22 = None
    ...
    mul_25: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_10, mul_24);  mul_24 = None
    clone_7: "f32[1, 1024, 1024]" = torch.ops.aten.clone.default(mul_25, memory_format = torch.contiguous_format);  mul_25 = None
    ...
    mul_26: "f32[16, 1024, 1024]" = torch.ops.aten.mul.Tensor(bmm_3, alias_1);  bmm_3 = None
    sum_9: "f32[16, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_26, [-1], True)
    mul_27: "f32[16, 1024, 1024]" = torch.ops.aten.mul.Tensor(alias_1, sum_9);  alias_1 = sum_9 = None
    sub_6: "f32[16, 1024, 1024]" = torch.ops.aten.sub.Tensor(mul_26, mul_27);  mul_26 = mul_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:247, code: attn_weights = attn_weights.view(bsz * self.num_heads, tgt_len, src_len)
    view_33: "f32[1, 16, 1024, 1024]" = torch.ops.aten.view.default(sub_6, [1, 16, 1024, 1024]);  sub_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:214, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    add_13: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(view_42, view_46);  view_42 = view_46 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:189, code: query_states = self.q_proj(hidden_states) * self.scaling
    mul_28: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(view_38, 0.125);  view_38 = None
    view_47: "f32[1024, 1024]" = torch.ops.aten.view.default(mul_28, [1024, 1024]);  mul_28 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:189, code: query_states = self.q_proj(hidden_states) * self.scaling
    add_14: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_13, view_49);  add_13 = view_49 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:418, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_7: "f32[1, 1024, 1024]" = torch.ops.aten.sub.Tensor(primals_17, getitem_1);  primals_17 = getitem_1 = None
    mul_29: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(sub_7, rsqrt);  sub_7 = None
    mul_30: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_14, primals_1);  primals_1 = None
    ...
    mul_32: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_30, mul_29);  mul_30 = None
    sum_14: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_32, [2], True);  mul_32 = None
    mul_33: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_29, sum_14);  sum_14 = None
    ...
    mul_35: "f32[1, 1024, 1024]" = torch.ops.aten.mul.Tensor(add_14, mul_29);  mul_29 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/mbart/modeling_mbart.py:418, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    add_15: "f32[1, 1024, 1024]" = torch.ops.aten.add.Tensor(add_10, mul_34);  add_10 = mul_34 = None
