            ...
            {
                {
                    ...
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(768L); x1+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp21 = decltype(tmp20)(tmp20 + 514);
                        auto tmp22 = tmp20 < 0;
                        auto tmp23 = tmp22 ? tmp21 : tmp20;
                        TORCH_CHECK((0 <= tmp23) & (tmp23 < 514L), "index out of bounds: 0 <= tmp23 < 514L")
...
cpp_fused_gelu_native_layer_norm_50 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(const float* in_ptr0,
                       const float* in_ptr1,
                       const float* in_ptr2,
...
cpp_fused__log_softmax_nll_loss_forward_51 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const long* in_ptr1,
            ...
            {
                {
                    ...
                    for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp5 = decltype(tmp4)(tmp4 + 32005);
                        auto tmp6 = tmp4 < 0;
                        auto tmp7 = tmp6 ? tmp5 : tmp4;
                        TORCH_CHECK((0 <= tmp7) & (tmp7 < 32005L), "index out of bounds: 0 <= tmp7 < 32005L")
                        auto tmp8 = in_ptr0[static_cast<long>(tmp7 + (32005L*x0))];
                        auto tmp10 = decltype(tmp8)(tmp8 - tmp9);
...
def call(args):
    ...
    cpp_fused__to_copy_cumsum_ne_0(c_void_p(arg204_1.data_ptr()), c_void_p(buf0.data_ptr()))
    ...
    extern_kernels.addmm(arg198_1, reinterpret_tensor(buf319, (512, 768), (768, 1), 0), reinterpret_tensor(arg197_1, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf320)
    del arg197_1
    del arg198_1
    buf321 = buf317; del buf317  # reuse
    buf322 = buf316; del buf316  # reuse
    buf324 = buf319; del buf319  # reuse
    cpp_fused_gelu_native_layer_norm_50(c_void_p(buf320.data_ptr()), c_void_p(arg199_1.data_ptr()), c_void_p(arg200_1.data_ptr()), c_void_p(buf321.data_ptr()), c_void_p(buf322.data_ptr()), c_void_p(buf324.data_ptr()))
    del arg199_1
    del arg200_1
    del buf320
    buf325 = empty((512, 32005), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg202_1, reinterpret_tensor(buf324, (512, 768), (768, 1), 0), reinterpret_tensor(arg201_1, (768, 32005), (1, 768), 0), alpha=1, beta=1, out=buf325)
    del arg201_1
    del arg202_1
    del buf324
    buf326 = reinterpret_tensor(buf322, (512, 1), (1, 512), 0); del buf322  # reuse
    buf327 = reinterpret_tensor(buf321, (512, 1), (1, 512), 0); del buf321  # reuse
    buf328 = empty((), device='cpu', dtype=torch.float32)
    buf329 = empty((), device='cpu', dtype=torch.int64)
    buf330 = buf328; del buf328  # reuse
    cpp_fused__log_softmax_nll_loss_forward_51(c_void_p(buf330.data_ptr()), c_void_p(buf325.data_ptr()), c_void_p(arg205_1.data_ptr()), c_void_p(buf326.data_ptr()), c_void_p(buf327.data_ptr()), c_void_p(buf329.data_ptr()))
    del arg205_1
    return (buf330, reinterpret_tensor(buf325, (1, 512, 32005), (16386560, 32005, 1), 0), )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    arg0_1 = rand_strided((32005, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg1_1 = rand_strided((1, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg2_1 = rand_strided((514, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    arg201_1 = rand_strided((32005, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg202_1 = rand_strided((32005, ), (1, ), device='cpu', dtype=torch.float32)
    arg203_1 = rand_strided((1, 514), (514, 1), device='cpu', dtype=torch.int64)
