...
def forward(self, primals_1: "f32[30522, 768]", primals_2: "f32[512, 768]", primals_3: "f32[768]", primals_4: "f32[768]", primals_5: "f32[768, 768]", primals_6: "f32[768]", primals_7: "f32[768, 768]", primals_8: "f32[768]", primals_9: "f32[768, 768]", primals_10: "f32[768]", primals_11: "f32[768, 768]", primals_12: "f32[768]", primals_13: "f32[768]", primals_14: "f32[768]", primals_15: "f32[3072, 768]", primals_16: "f32[3072]", primals_17: "f32[768, 3072]", primals_18: "f32[768]", primals_19: "f32[768]", primals_20: "f32[768]", primals_21: "f32[768, 768]", primals_22: "f32[768]", primals_23: "f32[768, 768]", primals_24: "f32[768]", primals_25: "f32[768, 768]", primals_26: "f32[768]", primals_27: "f32[768, 768]", primals_28: "f32[768]", primals_29: "f32[768]", primals_30: "f32[768]", primals_31: "f32[3072, 768]", primals_32: "f32[3072]", primals_33: "f32[768, 3072]", primals_34: "f32[768]", primals_35: "f32[768]", primals_36: "f32[768]", primals_37: "f32[768, 768]", primals_38: "f32[768]", primals_39: "f32[768, 768]", primals_40: "f32[768]", primals_41: "f32[768, 768]", primals_42: "f32[768]", primals_43: "f32[768, 768]", primals_44: "f32[768]", primals_45: "f32[768]", primals_46: "f32[768]", primals_47: "f32[3072, 768]", primals_48: "f32[3072]", primals_49: "f32[768, 3072]", primals_50: "f32[768]", primals_51: "f32[768]", primals_52: "f32[768]", primals_53: "f32[768, 768]", primals_54: "f32[768]", primals_55: "f32[768, 768]", primals_56: "f32[768]", primals_57: "f32[768, 768]", primals_58: "f32[768]", primals_59: "f32[768, 768]", primals_60: "f32[768]", primals_61: "f32[768]", primals_62: "f32[768]", primals_63: "f32[3072, 768]", primals_64: "f32[3072]", primals_65: "f32[768, 3072]", primals_66: "f32[768]", primals_67: "f32[768]", primals_68: "f32[768]", primals_69: "f32[768, 768]", primals_70: "f32[768]", primals_71: "f32[768, 768]", primals_72: "f32[768]", primals_73: "f32[768, 768]", primals_74: "f32[768]", primals_75: "f32[768, 768]", primals_76: "f32[768]", primals_77: "f32[768]", primals_78: "f32[768]", primals_79: "f32[3072, 768]", primals_80: "f32[3072]", primals_81: "f32[768, 3072]", primals_82: "f32[768]", primals_83: "f32[768]", primals_84: "f32[768]", primals_85: "f32[768, 768]", primals_86: "f32[768]", primals_87: "f32[768, 768]", primals_88: "f32[768]", primals_89: "f32[768, 768]", primals_90: "f32[768]", primals_91: "f32[768, 768]", primals_92: "f32[768]", primals_93: "f32[768]", primals_94: "f32[768]", primals_95: "f32[3072, 768]", primals_96: "f32[3072]", primals_97: "f32[768, 3072]", primals_98: "f32[768]", primals_99: "f32[768]", primals_100: "f32[768]", primals_101: "f32[768, 768]", primals_102: "f32[768]", primals_103: "f32[768]", primals_104: "f32[768]", primals_105: "f32[30522, 768]", primals_106: "f32[30522]", primals_107: "i64[1, 512]", primals_108: "i64[1, 128]", primals_109: "i64[1, 128]"):
    ...
    mm_default_11: "f32[128, 768]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_11: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_11, primals_6);  mm_default_11 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_1: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_11, [1, 128, 768]);  add_tensor_11 = None
    ...
    # No stacktrace found for following nodes
    mm_default_10: "f32[128, 768]" = torch.ops.aten.mm.default(view_17, permute_8)
    add_tensor_10: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_10, primals_12);  mm_default_10 = primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_18: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_10, [1, 128, 768]);  add_tensor_10 = None
    ...
    # No stacktrace found for following nodes
    mm_default_9: "f32[128, 768]" = torch.ops.aten.mm.default(view_23, permute_11)
    add_tensor_9: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_9, primals_22);  mm_default_9 = primals_22 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_24: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_9, [1, 128, 768]);  add_tensor_9 = None
    ...
    # No stacktrace found for following nodes
    mm_default_8: "f32[128, 768]" = torch.ops.aten.mm.default(view_40, permute_19)
    add_tensor_8: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_8, primals_28);  mm_default_8 = primals_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_41: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_8, [1, 128, 768]);  add_tensor_8 = None
    ...
    # No stacktrace found for following nodes
    mm_default_7: "f32[128, 768]" = torch.ops.aten.mm.default(view_46, permute_22)
    add_tensor_7: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_7, primals_38);  mm_default_7 = primals_38 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_47: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_7, [1, 128, 768]);  add_tensor_7 = None
    ...
    # No stacktrace found for following nodes
    mm_default_6: "f32[128, 768]" = torch.ops.aten.mm.default(view_63, permute_30)
    add_tensor_6: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_6, primals_44);  mm_default_6 = primals_44 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_64: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_6, [1, 128, 768]);  add_tensor_6 = None
    ...
    # No stacktrace found for following nodes
    mm_default_5: "f32[128, 768]" = torch.ops.aten.mm.default(view_69, permute_33)
    add_tensor_5: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_5, primals_54);  mm_default_5 = primals_54 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_70: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 128, 768]);  add_tensor_5 = None
    ...
    # No stacktrace found for following nodes
    mm_default_4: "f32[128, 768]" = torch.ops.aten.mm.default(view_86, permute_41)
    add_tensor_4: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_4, primals_60);  mm_default_4 = primals_60 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_87: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 128, 768]);  add_tensor_4 = None
    ...
    # No stacktrace found for following nodes
    mm_default_3: "f32[128, 768]" = torch.ops.aten.mm.default(view_92, permute_44)
    add_tensor_3: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_3, primals_70);  mm_default_3 = primals_70 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_93: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 768]);  add_tensor_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_2: "f32[128, 768]" = torch.ops.aten.mm.default(view_109, permute_52)
    add_tensor_2: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_2, primals_76);  mm_default_2 = primals_76 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_110: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 768]);  add_tensor_2 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[128, 768]" = torch.ops.aten.mm.default(view_115, permute_55)
    add_tensor_1: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default_1, primals_86);  mm_default_1 = primals_86 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:215, code: q = shape(self.q_lin(query))  # (bs, n_heads, q_length, dim_per_head)
    view_116: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 768]);  add_tensor_1 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[128, 768]" = torch.ops.aten.mm.default(view_132, permute_63)
    add_tensor: "f32[128, 768]" = torch.ops.aten.add.Tensor(mm_default, primals_92);  mm_default = primals_92 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/distilbert/modeling_distilbert.py:235, code: context = self.out_lin(context)  # (bs, q_length, dim)
    view_133: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 768]);  add_tensor = None
    ...
    view_139: "f32[1, 128, 768]" = torch.ops.aten.reshape.default(addmm_36, [1, 128, 768])
    ...
    sub_19: "f32[1, 128, 768]" = torch.ops.aten.sub.Tensor(mul_46, getitem_53);  mul_46 = getitem_53 = None
    mul_47: "f32[1, 128, 768]" = torch.ops.aten.mul.Tensor(sub_19, rsqrt_13);  sub_19 = None
    mul_48: "f32[1, 128, 768]" = torch.ops.aten.mul.Tensor(mul_47, primals_103)
    ...
    view_140: "f32[128, 768]" = torch.ops.aten.reshape.default(add_47, [128, 768]);  add_47 = None
    ...
    view_141: "f32[1, 128, 30522]" = torch.ops.aten.reshape.default(addmm_37, [1, 128, 30522]);  addmm_37 = None
    ...
    view_142: "f32[128, 30522]" = torch.ops.aten.reshape.default(view_141, [-1, 30522])
    view_143: "i64[128]" = torch.ops.aten.reshape.default(primals_109, [-1])
    ...
    where_6: "i64[128]" = torch.ops.aten.where.self(ne, view_143, full_default_6);  view_143 = full_default_6 = None
    unsqueeze: "i64[128, 1]" = torch.ops.aten.unsqueeze.default(where_6, 1);  where_6 = None
    gather: "f32[128, 1]" = torch.ops.aten.gather.default(sub_21, 1, unsqueeze);  unsqueeze = None
    ...
    where_7: "f32[128]" = torch.ops.aten.where.self(ne, neg, full_default_7);  neg = full_default_7 = None
