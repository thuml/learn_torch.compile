...
# kernel path: /tmp/torchinductor_youkaichao/6r/c6r55jekgick46ccgtgem7uwblnplyqmytbg5wd5jftwrvbcf5uc.py
# Source Nodes: [prediction_logits_1, prediction_logits_2, prediction_logits_3], Original ATen: [aten.gelu, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
...
# prediction_logits_3 => view_140
triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_9 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_9', 'mutated_arg_names': []}
)
@triton.jit
...
# kernel path: /tmp/torchinductor_youkaichao/zq/czqbv2mc3pm6gbilaf6dr3fkqmegmsntclng6mbzpcmqzwvaj3ai.py
...
# kernel path: /tmp/torchinductor_youkaichao/om/comnw6qjiojmes52nq5wnqmkl5s5s7zuvadh2obbkfknlykbbzbv.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
# loss => exp_6, sub_20, sum_7
...
# kernel path: /tmp/torchinductor_youkaichao/zj/czj7oujxw7nlejryro7cubptburvxciefi6pxlc26jf4ambfpg6b.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
# loss => log, sub_20, sub_21
...
# kernel path: /tmp/torchinductor_youkaichao/ry/cryw3pvaptd5xbxnltbcuawzxlpry7dzmttjyr5v7bwpxw6mgikk.py
# Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
# loss => convert_element_type, div_12, full_default_7, ne, neg, sum_8, sum_9, where_7
...
def call(args):
    ...
    assert_size_stride(primals_105, (30522, 768), (768, 1))
    assert_size_stride(primals_106, (30522, ), (1, ))
    assert_size_stride(primals_107, (1, 512), (512, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_add_embedding_native_layer_norm_native_layer_norm_backward_0.run(primals_108, primals_1, primals_107, primals_2, primals_3, primals_4, buf3, buf4, buf228, 128, 768, grid=grid(128), stream=stream0)
        del primals_1
        del primals_2
        del primals_4
        ...
        buf227 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_1], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf8, primals_6, buf11, buf227, 98304, grid=grid(98304), stream=stream0)
        del primals_6
        ...
        buf226 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_1, sa_output_1, x], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf22, primals_12, buf6, primals_13, primals_14, buf26, buf27, buf226, 128, 768, grid=grid(128), stream=stream0)
        del primals_12
        ...
        # Source Nodes: [add_2, hidden_state_1, l__mod___distilbert_transformer_layer_1_attention_q_lin, sa_output_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf32, buf26, primals_13, primals_14, primals_19, primals_20, buf37, buf38, buf225, 128, 768, grid=grid(128), stream=stream0)
        del primals_14
        ...
        buf224 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_3], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf39, primals_22, buf42, buf224, 98304, grid=grid(98304), stream=stream0)
        del primals_22
        ...
        buf223 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_3, hidden_state_1, sa_output_3, x_4], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_8.run(buf53, primals_28, buf37, primals_19, primals_20, primals_29, primals_30, buf57, buf58, buf223, 128, 768, grid=grid(128), stream=stream0)
        del primals_20
        del primals_28
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf63, buf57, primals_29, primals_30, primals_35, primals_36, buf68, buf69, buf222, 128, 768, grid=grid(128), stream=stream0)
        del primals_30
        ...
        buf221 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_5], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf70, primals_38, buf73, buf221, 98304, grid=grid(98304), stream=stream0)
        del primals_38
        ...
        buf220 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_8.run(buf84, primals_44, buf68, primals_35, primals_36, primals_45, primals_46, buf88, buf89, buf220, 128, 768, grid=grid(128), stream=stream0)
        del primals_36
        del primals_44
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf94, buf88, primals_45, primals_46, primals_51, primals_52, buf99, buf100, buf219, 128, 768, grid=grid(128), stream=stream0)
        del primals_46
        ...
        buf218 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_7], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf101, primals_54, buf104, buf218, 98304, grid=grid(98304), stream=stream0)
        del primals_54
        ...
        buf217 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_8.run(buf115, primals_60, buf99, primals_51, primals_52, primals_61, primals_62, buf119, buf120, buf217, 128, 768, grid=grid(128), stream=stream0)
        del primals_52
        del primals_60
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf125, buf119, primals_61, primals_62, primals_67, primals_68, buf130, buf131, buf216, 128, 768, grid=grid(128), stream=stream0)
        del primals_62
        ...
        buf215 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_9], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf132, primals_70, buf135, buf215, 98304, grid=grid(98304), stream=stream0)
        del primals_70
        ...
        buf214 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_8.run(buf146, primals_76, buf130, primals_67, primals_68, primals_77, primals_78, buf150, buf151, buf214, 128, 768, grid=grid(128), stream=stream0)
        del primals_68
        del primals_76
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf156, buf150, primals_77, primals_78, primals_83, primals_84, buf161, buf162, buf213, 128, 768, grid=grid(128), stream=stream0)
        del primals_78
        ...
        buf212 = empty_strided((12, 64, 128), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [q_11], Original ATen: [aten.div, aten.transpose]
        triton_poi_fused_div_transpose_1.run(buf163, primals_86, buf166, buf212, 98304, grid=grid(98304), stream=stream0)
        del primals_86
        ...
        buf211 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_8.run(buf177, primals_92, buf161, primals_83, primals_84, primals_93, primals_94, buf181, buf182, buf211, 128, 768, grid=grid(128), stream=stream0)
        del primals_84
        del primals_92
        ...
        buf193 = empty((128, 768), device='cuda', dtype=torch.float32)
        buf210 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [add_12, hidden_states, prediction_logits, sa_output_11], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_7.run(buf187, buf181, primals_93, primals_94, primals_99, primals_100, buf192, buf193, buf210, 128, 768, grid=grid(128), stream=stream0)
        del primals_100
        del primals_94
        buf194 = reinterpret_tensor(buf187, (128, 768), (768, 1), 0); del buf187  # reuse
        # Source Nodes: [prediction_logits], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_102, buf193, reinterpret_tensor(primals_101, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf194)
        del primals_102
        buf198 = empty((1, 128, 768), device='cuda', dtype=torch.float32)
        buf199 = empty((128, 768), device='cuda', dtype=torch.float32)
        buf209 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_logits_1, prediction_logits_2, prediction_logits_3], Original ATen: [aten.gelu, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_9.run(buf194, primals_103, primals_104, buf198, buf199, buf209, 128, 768, grid=grid(128), stream=stream0)
        del primals_104
        buf200 = empty((128, 30522), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_logits_3], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_106, buf199, reinterpret_tensor(primals_105, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf200)
        del primals_106
        buf201 = empty_strided((128, 1, 4), (4, 512, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_10.run(buf200, buf201, 512, 7631, grid=grid(512), stream=stream0)
        buf202 = empty_strided((128, 1), (1, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_per_fused__log_softmax_11.run(buf201, buf202, 128, 4, grid=grid(128), stream=stream0)
        buf203 = buf201; del buf201  # reuse
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_12.run(buf200, buf202, buf203, 512, 7631, grid=grid(512), stream=stream0)
        buf204 = empty_strided((128, 1), (1, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_per_fused__log_softmax_13.run(buf203, buf204, 128, 4, grid=grid(128), stream=stream0)
        del buf203
        buf205 = empty((128, 30522), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_poi_fused__log_softmax_14.run(buf200, buf202, buf204, buf205, 3906816, grid=grid(3906816), stream=stream0)
        del buf202
        del buf204
        buf208 = empty((), device='cuda', dtype=torch.float32)
        buf207 = empty((), device='cuda', dtype=torch.float32)
        buf229 = buf208; del buf208  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_15.run(buf229, primals_109, buf205, buf207, 1, 128, grid=grid(1), stream=stream0)
        return (buf229, reinterpret_tensor(buf200, (1, 128, 30522), (3906816, 30522, 1), 0), primals_3, primals_13, primals_19, primals_29, primals_35, primals_45, primals_51, primals_61, primals_67, primals_77, primals_83, primals_93, primals_99, primals_103, primals_108, primals_109, reinterpret_tensor(primals_107, (1, 128), (512, 1), 0), buf3, buf7, reinterpret_tensor(buf6, (128, 768), (768, 1), 0), buf13, buf19, buf21, buf26, buf27, buf28, buf29, buf33, buf37, buf38, buf49, buf51, buf57, buf58, buf59, buf60, buf64, buf68, buf69, buf80, buf82, buf88, buf89, buf90, buf91, buf95, buf99, buf100, buf111, buf113, buf119, buf120, buf121, buf122, buf126, buf130, buf131, buf142, buf144, buf150, buf151, buf152, buf153, buf157, buf161, buf162, buf173, buf175, buf181, buf182, buf183, buf184, buf188, buf192, buf193, buf194, buf198, buf199, buf205, buf207, reinterpret_tensor(primals_105, (30522, 768), (768, 1), 0), buf209, reinterpret_tensor(primals_101, (768, 768), (768, 1), 0), buf210, reinterpret_tensor(primals_97, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_95, (3072, 768), (768, 1), 0), buf211, reinterpret_tensor(primals_91, (768, 768), (768, 1), 0), reinterpret_tensor(buf172, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf165, (12, 64, 128), (64, 1, 768), 0), buf170, buf212, reinterpret_tensor(buf164, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_89, (768, 768), (768, 1), 0), reinterpret_tensor(primals_87, (768, 768), (768, 1), 0), reinterpret_tensor(primals_85, (768, 768), (768, 1), 0), buf213, reinterpret_tensor(primals_81, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_79, (3072, 768), (768, 1), 0), buf214, reinterpret_tensor(primals_75, (768, 768), (768, 1), 0), reinterpret_tensor(buf141, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf134, (12, 64, 128), (64, 1, 768), 0), buf139, buf215, reinterpret_tensor(buf133, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_73, (768, 768), (768, 1), 0), reinterpret_tensor(primals_71, (768, 768), (768, 1), 0), reinterpret_tensor(primals_69, (768, 768), (768, 1), 0), buf216, reinterpret_tensor(primals_65, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_63, (3072, 768), (768, 1), 0), buf217, reinterpret_tensor(primals_59, (768, 768), (768, 1), 0), reinterpret_tensor(buf110, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf103, (12, 64, 128), (64, 1, 768), 0), buf108, buf218, reinterpret_tensor(buf102, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_57, (768, 768), (768, 1), 0), reinterpret_tensor(primals_55, (768, 768), (768, 1), 0), reinterpret_tensor(primals_53, (768, 768), (768, 1), 0), buf219, reinterpret_tensor(primals_49, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_47, (3072, 768), (768, 1), 0), buf220, reinterpret_tensor(primals_43, (768, 768), (768, 1), 0), reinterpret_tensor(buf79, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf72, (12, 64, 128), (64, 1, 768), 0), buf77, buf221, reinterpret_tensor(buf71, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_41, (768, 768), (768, 1), 0), reinterpret_tensor(primals_39, (768, 768), (768, 1), 0), reinterpret_tensor(primals_37, (768, 768), (768, 1), 0), buf222, reinterpret_tensor(primals_33, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_31, (3072, 768), (768, 1), 0), buf223, reinterpret_tensor(primals_27, (768, 768), (768, 1), 0), reinterpret_tensor(buf48, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf41, (12, 64, 128), (64, 1, 768), 0), buf46, buf224, reinterpret_tensor(buf40, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_25, (768, 768), (768, 1), 0), reinterpret_tensor(primals_23, (768, 768), (768, 1), 0), reinterpret_tensor(primals_21, (768, 768), (768, 1), 0), buf225, reinterpret_tensor(primals_17, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_15, (3072, 768), (768, 1), 0), buf226, reinterpret_tensor(primals_11, (768, 768), (768, 1), 0), reinterpret_tensor(buf18, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf10, (12, 64, 128), (64, 1, 768), 0), buf16, buf227, reinterpret_tensor(buf9, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_9, (768, 768), (768, 1), 0), reinterpret_tensor(primals_7, (768, 768), (768, 1), 0), reinterpret_tensor(primals_5, (768, 768), (768, 1), 0), buf228, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_105 = rand_strided((30522, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_106 = rand_strided((30522, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_107 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    ...
    return print_performance(lambda: call([primals_1, primals_2, primals_3, primals_4, primals_5, primals_6, primals_7, primals_8, primals_9, primals_10, primals_11, primals_12, primals_13, primals_14, primals_15, primals_16, primals_17, primals_18, primals_19, primals_20, primals_21, primals_22, primals_23, primals_24, primals_25, primals_26, primals_27, primals_28, primals_29, primals_30, primals_31, primals_32, primals_33, primals_34, primals_35, primals_36, primals_37, primals_38, primals_39, primals_40, primals_41, primals_42, primals_43, primals_44, primals_45, primals_46, primals_47, primals_48, primals_49, primals_50, primals_51, primals_52, primals_53, primals_54, primals_55, primals_56, primals_57, primals_58, primals_59, primals_60, primals_61, primals_62, primals_63, primals_64, primals_65, primals_66, primals_67, primals_68, primals_69, primals_70, primals_71, primals_72, primals_73, primals_74, primals_75, primals_76, primals_77, primals_78, primals_79, primals_80, primals_81, primals_82, primals_83, primals_84, primals_85, primals_86, primals_87, primals_88, primals_89, primals_90, primals_91, primals_92, primals_93, primals_94, primals_95, primals_96, primals_97, primals_98, primals_99, primals_100, primals_101, primals_102, primals_103, primals_104, primals_105, primals_106, primals_107, primals_108, primals_109]), times=times, repeat=repeat)
