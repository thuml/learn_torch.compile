...
def forward(self, primals, tangents):
    ...
    where: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_2, div, convert_element_type);  div = convert_element_type = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_1: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_4, div_2, convert_element_type_1);  div_2 = convert_element_type_1 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_2: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_6, div_4, convert_element_type_2);  div_4 = convert_element_type_2 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_3: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_8, div_6, convert_element_type_3);  div_6 = convert_element_type_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_4: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_10, div_8, convert_element_type_4);  div_8 = convert_element_type_4 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_5: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_12, div_10, convert_element_type_5);  div_10 = convert_element_type_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_6: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_14, div_12, convert_element_type_6);  div_12 = convert_element_type_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_7: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_16, div_14, convert_element_type_7);  div_14 = convert_element_type_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_8: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_18, div_16, convert_element_type_8);  div_16 = convert_element_type_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_9: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_20, div_18, convert_element_type_9);  div_18 = convert_element_type_9 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_10: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_22, div_20, convert_element_type_10);  div_20 = convert_element_type_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/gpt2/modeling_gpt2.py:202, code: attn_weights = torch.where(causal_mask, attn_weights.to(attn_weights.dtype), mask_value)
    where_11: "f32[1, 12, 1024, 1024]" = torch.ops.aten.where.self(slice_24, div_22, convert_element_type_11);  div_22 = convert_element_type_11 = None
    ...
    full_24: "f32[1, 1024, 2]" = torch.ops.aten.full.default([1, 1024, 2], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_25: "f32[1024, 768]" = torch.ops.aten.full.default([1024, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_26: "f32[50257, 768]" = torch.ops.aten.full.default([50257, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
