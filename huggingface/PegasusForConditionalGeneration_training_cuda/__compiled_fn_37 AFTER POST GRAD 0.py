...
def forward(self, primals_1: "f32[1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024, 1024]", primals_10: "f32[1024]", primals_11: "f32[1024]", primals_12: "f32[1024]", primals_13: "f32[1024, 1024]", primals_14: "f32[1024]", primals_15: "f32[1024, 1024]", primals_16: "f32[1024]", primals_17: "f32[1024, 1024]", primals_18: "f32[1024]", primals_19: "f32[1024, 1024]", primals_20: "f32[1024]", primals_21: "f32[1024]", primals_22: "f32[1024]", primals_23: "f32[4096, 1024]", primals_24: "f32[4096]", primals_25: "f32[1024, 4096]", primals_26: "f32[1024]", primals_27: "f32[1, 128, 1024]", primals_28: "f32[1, 1, 128, 128]", primals_29: "f32[1, 128, 1024]"):
    ...
    mm_default_5: "f32[128, 1024]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_5: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default_5, primals_4);  mm_default_5 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:195, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 128, 1024]);  add_tensor_5 = None
    ...
    # No stacktrace found for following nodes
    mm_default_4: "f32[128, 1024]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_4: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default_4, primals_6);  mm_default_4 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:220, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 128, 1024]);  add_tensor_4 = None
    ...
    # No stacktrace found for following nodes
    mm_default_3: "f32[128, 1024]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor_3: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default_3, primals_8);  mm_default_3 = primals_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:221, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 1024]);  add_tensor_3 = None
    ...
    view_13: "f32[16, 128, 128]" = torch.ops.aten.reshape.default(add_2, [16, 128, 128]);  add_2 = None
    ...
    view_14: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 16, 128, 64]);  bmm_1 = None
    ...
    view_15: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_4, [1, 128, 1024]);  clone_4 = None
    ...
    view_16: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_15, [128, 1024]);  view_15 = None
    ...
    view_17: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_3, [1, 128, 1024]);  addmm_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:195, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_18: "f32[128, 1024]" = torch.ops.aten.reshape.default(add_5, [128, 1024]);  add_5 = None
    permute_9: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_13, [1, 0]);  primals_13 = None
    
    # No stacktrace found for following nodes
    mm_default_2: "f32[128, 1024]" = torch.ops.aten.mm.default(view_18, permute_9)
    add_tensor_2: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_14);  mm_default_2 = primals_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:195, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_19: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 1024]);  add_tensor_2 = None
    ...
    view_20: "f32[128, 1024]" = torch.ops.aten.reshape.default(primals_29, [128, 1024]);  primals_29 = None
    permute_10: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_15, [1, 0]);  primals_15 = None
    
    # No stacktrace found for following nodes
    mm_default_1: "f32[128, 1024]" = torch.ops.aten.mm.default(view_20, permute_10)
    add_tensor_1: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_16);  mm_default_1 = primals_16 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:210, code: key_states = self._shape(self.k_proj(key_value_states), -1, bsz)
    view_21: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 1024]);  add_tensor_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_22: "f32[1, 128, 16, 64]" = torch.ops.aten.reshape.default(view_21, [1, -1, 16, 64]);  view_21 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[128, 1024]" = torch.ops.aten.mm.default(view_20, permute_12)
    add_tensor: "f32[128, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_18);  mm_default = primals_18 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:211, code: value_states = self._shape(self.v_proj(key_value_states), -1, bsz)
    view_24: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 1024]);  add_tensor = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 128, 16, 64]" = torch.ops.aten.reshape.default(mul_5, [1, 128, 16, 64]);  mul_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:234, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_27: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(clone_7, [16, -1, 64]);  clone_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:235, code: key_states = key_states.reshape(*proj_shape)
    view_28: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(clone_5, [16, -1, 64]);  clone_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:236, code: value_states = value_states.reshape(*proj_shape)
    view_29: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(clone_6, [16, -1, 64]);  clone_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:278, code: attn_output = torch.bmm(attn_probs, value_states)
    bmm_3: "f32[16, 128, 64]" = torch.ops.aten.bmm.default(div_1, view_29)
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:286, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_3, [1, 16, 128, 64]);  bmm_3 = None
    ...
    view_31: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 1024]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:293, code: attn_output = self.out_proj(attn_output)
    view_32: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_31, [128, 1024]);  view_31 = None
    ...
    view_33: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_7, [1, 128, 1024]);  addmm_7 = None
    ...
    view_34: "f32[128, 1024]" = torch.ops.aten.reshape.default(add_8, [128, 1024]);  add_8 = None
    ...
    view_35: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(addmm_8, [1, 128, 4096])
    ...
    view_36: "f32[128, 4096]" = torch.ops.aten.reshape.default(mul_10, [128, 4096]);  mul_10 = None
    ...
    view_37: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_9, [1, 128, 1024]);  addmm_9 = None
