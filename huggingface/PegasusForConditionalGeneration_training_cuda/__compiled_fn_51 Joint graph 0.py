...
def forward(self, primals, tangents):
    primals_1: "f32[50265, 1024]"; primals_2: "f32[1, 50265]"; primals_3: "f32[1, 128, 1024]"; primals_4: "i64[1, 128]"; tangents_1: "f32[]"; tangents_2: "f32[1, 128, 50265]"; 
    ...
    view: "f32[128, 1024]" = torch.ops.aten.view.default(primals_3, [128, 1024]);  primals_3 = None
