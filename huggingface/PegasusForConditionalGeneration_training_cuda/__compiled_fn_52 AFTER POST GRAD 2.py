...
def forward(self, primals_1: "f32[1024]", primals_11: "f32[1024]", primals_17: "f32[1, 128, 1024]", getitem_1: "f32[1, 128, 1]", rsqrt: "f32[1, 128, 1]", view: "f32[128, 1024]", bmm: "f32[16, 128, 128]", amax: "f32[16, 128, 1]", sum_1: "f32[16, 128, 1]", view_14: "f32[128, 1024]", getitem_3: "b8[1, 128, 1024]", mul_3: "f32[1, 128, 1024]", view_16: "f32[128, 1024]", addmm_4: "f32[128, 4096]", view_18: "f32[128, 4096]", getitem_7: "b8[1, 128, 1024]", permute_11: "f32[1024, 4096]", permute_15: "f32[4096, 1024]", div_1: "f32[1, 128, 1]", permute_19: "f32[1024, 1024]", permute_24: "f32[16, 128, 128]", permute_25: "f32[16, 64, 128]", permute_26: "f32[16, 64, 128]", permute_27: "f32[16, 128, 64]", permute_31: "f32[1024, 1024]", permute_36: "f32[1024, 1024]", permute_40: "f32[1024, 1024]", tangents_1: "f32[1, 128, 1024]"):
    ...
    view_17: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 4096]);  addmm_4 = None
    ...
    view_20: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_9, [128, 1024]);  mul_9 = None
    ...
    view_22: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(mm, [1, 128, 4096]);  mm = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:347, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[128, 4096]" = torch.ops.aten.reshape.default(mul_16, [128, 4096]);  mul_16 = None
    ...
    view_25: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 1024]);  mm_2 = None
    ...
    view_26: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_25, [128, 1024]);  mul_25 = None
    ...
    view_28: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_4, [1, 128, 1024]);  mm_4 = None
    ...
    view_29: "f32[1, 128, 16, 64]" = torch.ops.aten.reshape.default(view_28, [1, 128, 16, 64]);  view_28 = None
    ...
    view_30: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(permute_23, [16, 128, 64]);  permute_23 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:255, code: attn_weights = nn.functional.softmax(attn_weights, dim=-1)
    mul_26: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(bmm_3, div);  bmm_3 = None
    sum_9: "f32[16, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_26, [-1], True)
    mul_27: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(div, sum_9);  div = sum_9 = None
    ...
    view_31: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 16, 128, 64]);  bmm_2 = None
    ...
    view_32: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 16, 128, 64]);  permute_28 = None
    ...
    view_33: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 16, 128, 64]);  bmm_5 = None
    ...
    view_34: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_8, [1, 128, 1024]);  clone_8 = None
    ...
    view_35: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 1024]);  clone_9 = None
    ...
    view_36: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_35, [128, 1024]);  view_35 = None
    ...
    view_38: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 1024]);  mm_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_35: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_32, [0, 2, 1, 3]);  view_32 = None
    view_39: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(permute_35, [1, 128, 1024]);  permute_35 = None
    ...
    view_42: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 1024]);  mm_8 = None
    ...
    view_43: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_28, [128, 1024]);  mul_28 = None
    ...
    view_45: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 1024]);  mm_10 = None
