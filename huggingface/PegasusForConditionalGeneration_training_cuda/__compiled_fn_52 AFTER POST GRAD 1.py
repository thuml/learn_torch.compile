...
def forward(self, primals_1: "f32[1024]", primals_11: "f32[1024]", primals_21: "f32[1024]", primals_27: "f32[1, 128, 1024]", getitem_1: "f32[1, 128, 1]", rsqrt: "f32[1, 128, 1]", view: "f32[128, 1024]", view_16: "f32[128, 1024]", getitem_3: "b8[1, 128, 1024]", mul_3: "f32[1, 128, 1024]", view_18: "f32[128, 1024]", view_20: "f32[128, 1024]", bmm_2: "f32[16, 128, 128]", amax_1: "f32[16, 128, 1]", sum_2: "f32[16, 128, 1]", view_32: "f32[128, 1024]", getitem_7: "b8[1, 128, 1024]", mul_6: "f32[1, 128, 1024]", view_34: "f32[128, 1024]", addmm_8: "f32[128, 4096]", view_36: "f32[128, 4096]", getitem_11: "b8[1, 128, 1024]", permute_20: "f32[1024, 4096]", permute_24: "f32[4096, 1024]", div_2: "f32[1, 128, 1]", permute_28: "f32[1024, 1024]", permute_33: "f32[16, 128, 128]", permute_34: "f32[16, 64, 128]", permute_35: "f32[16, 64, 128]", permute_36: "f32[16, 128, 64]", permute_40: "f32[1024, 1024]", permute_45: "f32[1024, 1024]", permute_49: "f32[1024, 1024]", div_3: "f32[1, 128, 1]", permute_53: "f32[1024, 1024]", permute_58: "f32[16, 128, 128]", permute_59: "f32[16, 64, 128]", alias_3: "f32[16, 128, 128]", permute_60: "f32[16, 64, 128]", permute_61: "f32[16, 128, 64]", permute_65: "f32[1024, 1024]", permute_70: "f32[1024, 1024]", permute_74: "f32[1024, 1024]", tangents_1: "f32[1, 128, 1024]"):
    ...
    view_35: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(addmm_8, [1, 128, 4096]);  addmm_8 = None
    ...
    view_38: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_12, [128, 1024]);  mul_12 = None
    ...
    view_40: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(mm, [1, 128, 4096]);  mm = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:468, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_41: "f32[128, 4096]" = torch.ops.aten.reshape.default(mul_19, [128, 4096]);  mul_19 = None
    ...
    view_43: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 1024]);  mm_2 = None
    ...
    view_44: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_28, [128, 1024]);  mul_28 = None
    ...
    view_46: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_4, [1, 128, 1024]);  mm_4 = None
    ...
    view_47: "f32[1, 128, 16, 64]" = torch.ops.aten.reshape.default(view_46, [1, 128, 16, 64]);  view_46 = None
    ...
    view_48: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(permute_32, [16, 128, 64]);  permute_32 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:255, code: attn_weights = nn.functional.softmax(attn_weights, dim=-1)
    mul_29: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(bmm_5, div_1);  bmm_5 = None
    sum_10: "f32[16, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_29, [-1], True)
    mul_30: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(div_1, sum_10);  div_1 = sum_10 = None
    ...
    view_49: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_4, [1, 16, 128, 64]);  bmm_4 = None
    ...
    view_50: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(permute_37, [1, 16, 128, 64]);  permute_37 = None
    ...
    view_51: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_7, [1, 16, 128, 64]);  bmm_7 = None
    ...
    view_52: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_13, [1, 128, 1024]);  clone_13 = None
    ...
    view_53: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_14, [1, 128, 1024]);  clone_14 = None
    ...
    view_54: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_53, [128, 1024]);  view_53 = None
    ...
    view_56: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 1024]);  mm_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_44: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_50, [0, 2, 1, 3]);  view_50 = None
    view_57: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(permute_44, [1, 128, 1024]);  permute_44 = None
    ...
    view_58: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_57, [128, 1024]);  view_57 = None
    ...
    view_60: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 1024]);  mm_8 = None
    ...
    view_61: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_31, [128, 1024]);  mul_31 = None
    ...
    view_63: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 1024]);  mm_10 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:293, code: attn_output = self.out_proj(attn_output)
    view_64: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_40, [128, 1024]);  mul_40 = None
    ...
    view_66: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_12, [1, 128, 1024]);  mm_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:291, code: attn_output = attn_output.reshape(bsz, tgt_len, self.embed_dim)
    view_67: "f32[1, 128, 16, 64]" = torch.ops.aten.reshape.default(view_66, [1, 128, 16, 64]);  view_66 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:287, code: attn_output = attn_output.transpose(1, 2)
    permute_57: "f32[1, 16, 128, 64]" = torch.ops.aten.permute.default(view_67, [0, 2, 1, 3]);  view_67 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:286, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_68: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(permute_57, [16, 128, 64]);  permute_57 = None
    ...
    view_69: "f32[1, 16, 128, 128]" = torch.ops.aten.reshape.default(sub_12, [1, 16, 128, 128]);  sub_12 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:236, code: value_states = value_states.reshape(*proj_shape)
    view_71: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_8, [1, 16, 128, 64]);  bmm_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:235, code: key_states = key_states.reshape(*proj_shape)
    view_72: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(permute_62, [1, 16, 128, 64]);  permute_62 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:234, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_73: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_11, [1, 16, 128, 64]);  bmm_11 = None
    ...
    view_74: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_16, [1, 128, 1024]);  clone_16 = None
    ...
    view_75: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_17, [1, 128, 1024]);  clone_17 = None
    ...
    view_76: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_75, [128, 1024]);  view_75 = None
    ...
    view_78: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_14, [1, 128, 1024]);  mm_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_69: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_72, [0, 2, 1, 3]);  view_72 = None
    view_79: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(permute_69, [1, 128, 1024]);  permute_69 = None
    ...
    view_80: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_79, [128, 1024]);  view_79 = None
    ...
    view_82: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_16, [1, 128, 1024]);  mm_16 = None
    ...
    view_83: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_43, [128, 1024]);  mul_43 = None
    ...
    view_85: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_18, [1, 128, 1024]);  mm_18 = None
