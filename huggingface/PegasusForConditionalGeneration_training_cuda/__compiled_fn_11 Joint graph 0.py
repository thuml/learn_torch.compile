...
def forward(self, primals, tangents):
    ...
    view_12: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(bmm_1, [1, 16, 128, 64]);  bmm_1 = None
    ...
    view_13: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_4, [1, 128, 1024]);  clone_4 = None
    ...
    view_14: "f32[128, 1024]" = torch.ops.aten.view.default(view_13, [128, 1024]);  view_13 = None
    ...
    view_15: "f32[1, 128, 1024]" = torch.ops.aten.view.default(addmm_3, [1, 128, 1024]);  addmm_3 = None
    ...
    sub_2: "f32[1, 128, 1024]" = torch.ops.aten.sub.Tensor(add_2, getitem_5)
    ...
    view_16: "f32[128, 1024]" = torch.ops.aten.view.default(add_4, [128, 1024]);  add_4 = None
    ...
    view_17: "f32[1, 128, 4096]" = torch.ops.aten.view.default(addmm_4, [1, 128, 4096]);  addmm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_5: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.5)
    mul_6: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476)
    ...
    view_18: "f32[128, 4096]" = torch.ops.aten.view.default(clone_5, [128, 4096]);  clone_5 = None
    ...
    view_19: "f32[1, 128, 1024]" = torch.ops.aten.view.default(addmm_5, [1, 128, 1024]);  addmm_5 = None
    ...
    add_6: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(add_2, getitem_6);  getitem_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:349, code: hidden_states = self.fc2(hidden_states)
    view_20: "f32[128, 1024]" = torch.ops.aten.view.default(clone_6, [128, 1024]);  clone_6 = None
    permute_11: "f32[1024, 4096]" = torch.ops.aten.permute.default(permute_10, [1, 0]);  permute_10 = None
    mm: "f32[128, 4096]" = torch.ops.aten.mm.default(view_20, permute_11);  permute_11 = None
    permute_12: "f32[1024, 128]" = torch.ops.aten.permute.default(view_20, [1, 0])
    ...
    view_21: "f32[1024]" = torch.ops.aten.view.default(sum_2, [1024]);  sum_2 = None
    permute_14: "f32[1024, 4096]" = torch.ops.aten.permute.default(permute_13, [1, 0]);  permute_13 = None
    view_22: "f32[1, 128, 4096]" = torch.ops.aten.view.default(mm, [1, 128, 4096]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_10: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476)
    erf_1: "f32[1, 128, 4096]" = torch.ops.aten.erf.default(mul_10);  mul_10 = None
    add_7: "f32[1, 128, 4096]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_11: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(add_7, 0.5);  add_7 = None
    mul_12: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_17, view_17)
    ...
    mul_15: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_17, mul_14);  view_17 = mul_14 = None
    add_8: "f32[1, 128, 4096]" = torch.ops.aten.add.Tensor(mul_11, mul_15);  mul_11 = mul_15 = None
    mul_16: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_22, add_8);  view_22 = add_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:347, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[128, 4096]" = torch.ops.aten.view.default(mul_16, [128, 4096]);  mul_16 = None
    permute_15: "f32[4096, 1024]" = torch.ops.aten.permute.default(permute_9, [1, 0]);  permute_9 = None
    mm_2: "f32[128, 1024]" = torch.ops.aten.mm.default(view_23, permute_15);  permute_15 = None
    permute_16: "f32[4096, 128]" = torch.ops.aten.permute.default(view_23, [1, 0])
    ...
    view_24: "f32[4096]" = torch.ops.aten.view.default(sum_3, [4096]);  sum_3 = None
    permute_18: "f32[4096, 1024]" = torch.ops.aten.permute.default(permute_17, [1, 0]);  permute_17 = None
    view_25: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_2, [1, 128, 1024]);  mm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:346, code: hidden_states = self.final_layer_norm(hidden_states)
    sub_3: "f32[1, 128, 1024]" = torch.ops.aten.sub.Tensor(add_2, getitem_5);  add_2 = getitem_5 = None
    mul_17: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    mul_18: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(view_25, primals_11);  primals_11 = None
    ...
    mul_23: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(view_25, mul_17);  mul_17 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:346, code: hidden_states = self.final_layer_norm(hidden_states)
    add_9: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(tangents_1, mul_22);  tangents_1 = mul_22 = None
    ...
    mul_25: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(add_9, mul_24);  mul_24 = None
    clone_7: "f32[1, 128, 1024]" = torch.ops.aten.clone.default(mul_25, memory_format = torch.contiguous_format);  mul_25 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:293, code: attn_output = self.out_proj(attn_output)
    view_26: "f32[128, 1024]" = torch.ops.aten.view.default(clone_7, [128, 1024]);  clone_7 = None
    permute_19: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_8, [1, 0]);  permute_8 = None
    mm_4: "f32[128, 1024]" = torch.ops.aten.mm.default(view_26, permute_19);  permute_19 = None
    permute_20: "f32[1024, 128]" = torch.ops.aten.permute.default(view_26, [1, 0])
    ...
    view_27: "f32[1024]" = torch.ops.aten.view.default(sum_8, [1024]);  sum_8 = None
    permute_22: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_21, [1, 0]);  permute_21 = None
    view_28: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_4, [1, 128, 1024]);  mm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:291, code: attn_output = attn_output.reshape(bsz, tgt_len, self.embed_dim)
    view_29: "f32[1, 128, 16, 64]" = torch.ops.aten.view.default(view_28, [1, 128, 16, 64]);  view_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:287, code: attn_output = attn_output.transpose(1, 2)
    permute_23: "f32[1, 16, 128, 64]" = torch.ops.aten.permute.default(view_29, [0, 2, 1, 3]);  view_29 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:286, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[16, 128, 64]" = torch.ops.aten.view.default(permute_23, [16, 128, 64]);  permute_23 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:278, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_24: "f32[16, 128, 128]" = torch.ops.aten.permute.default(clone_3, [0, 2, 1]);  clone_3 = None
    bmm_2: "f32[16, 128, 64]" = torch.ops.aten.bmm.default(permute_24, view_30);  permute_24 = None
    ...
    bmm_4: "f32[16, 64, 128]" = torch.ops.aten.bmm.default(permute_26, sub_6);  permute_26 = None
    permute_27: "f32[16, 128, 64]" = torch.ops.aten.permute.default(permute_6, [0, 2, 1]);  permute_6 = None
    bmm_5: "f32[16, 128, 64]" = torch.ops.aten.bmm.default(sub_6, permute_27);  sub_6 = permute_27 = None
    permute_28: "f32[16, 128, 64]" = torch.ops.aten.permute.default(bmm_4, [0, 2, 1]);  bmm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:236, code: value_states = value_states.reshape(*proj_shape)
    view_31: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(bmm_2, [1, 16, 128, 64]);  bmm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:235, code: key_states = key_states.reshape(*proj_shape)
    view_32: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(permute_28, [1, 16, 128, 64]);  permute_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:234, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_33: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(bmm_5, [1, 16, 128, 64]);  bmm_5 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_29: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_33, [0, 2, 1, 3]);  view_33 = None
    clone_8: "f32[1, 128, 16, 64]" = torch.ops.aten.clone.default(permute_29, memory_format = torch.contiguous_format);  permute_29 = None
    view_34: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_8, [1, 128, 1024]);  clone_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_30: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_31, [0, 2, 1, 3]);  view_31 = None
    clone_9: "f32[1, 128, 16, 64]" = torch.ops.aten.clone.default(permute_30, memory_format = torch.contiguous_format);  permute_30 = None
    view_35: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_9, [1, 128, 1024]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:221, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_36: "f32[128, 1024]" = torch.ops.aten.view.default(view_35, [128, 1024]);  view_35 = None
    permute_31: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_3, [1, 0]);  permute_3 = None
    mm_6: "f32[128, 1024]" = torch.ops.aten.mm.default(view_36, permute_31);  permute_31 = None
    permute_32: "f32[1024, 128]" = torch.ops.aten.permute.default(view_36, [1, 0])
    ...
    view_37: "f32[1024]" = torch.ops.aten.view.default(sum_10, [1024]);  sum_10 = None
    permute_34: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_38: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_6, [1, 128, 1024]);  mm_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:175, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    permute_35: "f32[1, 128, 16, 64]" = torch.ops.aten.permute.default(view_32, [0, 2, 1, 3]);  view_32 = None
    view_39: "f32[1, 128, 1024]" = torch.ops.aten.view.default(permute_35, [1, 128, 1024]);  permute_35 = None
    ...
    mm_8: "f32[128, 1024]" = torch.ops.aten.mm.default(view_40, permute_36);  permute_36 = None
    permute_37: "f32[1024, 128]" = torch.ops.aten.permute.default(view_40, [1, 0])
    ...
    view_41: "f32[1024]" = torch.ops.aten.view.default(sum_11, [1024]);  sum_11 = None
    permute_39: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_42: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_8, [1, 128, 1024]);  mm_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:220, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    add_10: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(view_38, view_42);  view_38 = view_42 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:195, code: query_states = self.q_proj(hidden_states) * self.scaling
    mul_28: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(view_34, 0.125);  view_34 = None
    view_43: "f32[128, 1024]" = torch.ops.aten.view.default(mul_28, [128, 1024]);  mul_28 = None
    permute_40: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute, [1, 0]);  permute = None
    mm_10: "f32[128, 1024]" = torch.ops.aten.mm.default(view_43, permute_40);  permute_40 = None
    permute_41: "f32[1024, 128]" = torch.ops.aten.permute.default(view_43, [1, 0])
    ...
    view_44: "f32[1024]" = torch.ops.aten.view.default(sum_12, [1024]);  sum_12 = None
    permute_43: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_45: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_10, [1, 128, 1024]);  mm_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:195, code: query_states = self.q_proj(hidden_states) * self.scaling
    add_11: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(add_10, view_45);  add_10 = view_45 = None
    ...
    mul_30: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(add_11, primals_1);  primals_1 = None
    ...
    mul_35: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(add_11, mul_29);  mul_29 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:335, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    add_12: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(add_9, mul_34);  add_9 = mul_34 = None
