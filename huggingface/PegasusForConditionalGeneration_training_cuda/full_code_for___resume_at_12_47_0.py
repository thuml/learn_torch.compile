...
def __guard_0_for___resume_at_12_47(L):
...
def __resume_at_12_47(___stack0, self, key, value):
    nonlocal __class__
    super(__class__, self).__setattr__(key, value)
    return None

def transformed___resume_at_12_47(___stack0, self, key, value):
    L = {"___stack0": ___stack0, "self": self, "key": key, "value": value}
    if __guard_0_for___resume_at_12_47(L):
        return __transformed_code_0_for___resume_at_12_47(___stack0, self, key, value)
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_12_47(___stack0, self, key, value)

#============ end of __resume_at_12_47 ============#
