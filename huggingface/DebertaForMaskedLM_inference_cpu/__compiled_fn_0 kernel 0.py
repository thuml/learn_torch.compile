...
cpp_fused_gelu_native_layer_norm_73 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(const float* in_ptr0,
                       const float* in_ptr1,
                       const float* in_ptr2,
...
cpp_fused__log_softmax_nll_loss_forward_74 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const long* in_ptr1,
...
def call(args):
    ...
    cpp_fused_add_div_embedding_mean_mul_pow_sqrt_sub_0(c_void_p(arg167_1.data_ptr()), c_void_p(arg74_1.data_ptr()), c_void_p(arg166_1.data_ptr()), c_void_p(arg75_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()))
    del arg0_1
    del arg166_1
    del arg167_1
    del arg1_1
    ...
    extern_kernels.addmm(arg161_1, reinterpret_tensor(buf242, (512, 768), (768, 1), 0), reinterpret_tensor(arg160_1, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf243)
    del arg160_1
    del arg161_1
    buf244 = buf241; del buf241  # reuse
    buf245 = buf240; del buf240  # reuse
    buf247 = buf242; del buf242  # reuse
    cpp_fused_gelu_native_layer_norm_73(c_void_p(buf243.data_ptr()), c_void_p(arg162_1.data_ptr()), c_void_p(arg163_1.data_ptr()), c_void_p(buf244.data_ptr()), c_void_p(buf245.data_ptr()), c_void_p(buf247.data_ptr()))
    del arg162_1
    del arg163_1
    del buf243
    buf248 = empty((512, 50265), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg165_1, reinterpret_tensor(buf247, (512, 768), (768, 1), 0), reinterpret_tensor(arg164_1, (768, 50265), (1, 768), 0), alpha=1, beta=1, out=buf248)
    del arg164_1
    del arg165_1
    del buf247
    buf249 = reinterpret_tensor(buf245, (512, 1), (1, 512), 0); del buf245  # reuse
    buf250 = reinterpret_tensor(buf244, (512, 1), (1, 512), 0); del buf244  # reuse
    buf251 = empty((), device='cpu', dtype=torch.float32)
    buf252 = empty((), device='cpu', dtype=torch.int64)
    buf253 = buf251; del buf251  # reuse
    cpp_fused__log_softmax_nll_loss_forward_74(c_void_p(buf253.data_ptr()), c_void_p(buf248.data_ptr()), c_void_p(arg168_1.data_ptr()), c_void_p(buf249.data_ptr()), c_void_p(buf250.data_ptr()), c_void_p(buf252.data_ptr()))
    del arg168_1
    return (buf253, reinterpret_tensor(buf248, (1, 512, 50265), (25735680, 50265, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg164_1 = rand_strided((50265, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg165_1 = rand_strided((50265, ), (1, ), device='cpu', dtype=torch.float32)
    arg166_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg167_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg168_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
