    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
        {
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(8L))
            {
                ...
                tmp26.store(out_ptr2 + static_cast<long>(x1 + (128L*x0)));
            }
        }
    }
}
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_0(c_void_p(arg208_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg205_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg206_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()))
    del arg0_1
    del arg1_1
    del arg205_1
    del arg206_1
    ...
    extern_kernels.addmm(arg200_1, reinterpret_tensor(buf317, (512, 256), (256, 1), 0), reinterpret_tensor(arg199_1, (256, 128), (1, 256), 0), alpha=1, beta=1, out=buf318)
    del arg199_1
    del arg200_1
    del buf317
    ...
    cpp_fused_gelu_native_layer_norm_49(c_void_p(buf318.data_ptr()), c_void_p(arg201_1.data_ptr()), c_void_p(arg202_1.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf320.data_ptr()), c_void_p(buf322.data_ptr()))
    del arg201_1
    del arg202_1
    del buf318
    del buf319
    del buf320
    buf323 = empty((512, 30522), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg204_1, reinterpret_tensor(buf322, (512, 128), (128, 1), 0), reinterpret_tensor(arg203_1, (128, 30522), (1, 128), 0), alpha=1, beta=1, out=buf323)
    del arg203_1
    del arg204_1
    del buf322
    buf324 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf325 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf326 = empty((), device='cpu', dtype=torch.float32)
    buf327 = empty((), device='cpu', dtype=torch.int64)
    buf328 = buf326; del buf326  # reuse
    cpp_fused__log_softmax_nll_loss_forward_50(c_void_p(buf328.data_ptr()), c_void_p(buf323.data_ptr()), c_void_p(arg207_1.data_ptr()), c_void_p(buf324.data_ptr()), c_void_p(buf325.data_ptr()), c_void_p(buf327.data_ptr()))
    del arg207_1
    return (buf328, reinterpret_tensor(buf323, (1, 512, 30522), (15627264, 30522, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg199_1 = rand_strided((128, 256), (256, 1), device='cpu', dtype=torch.float32)
    ...
    arg203_1 = rand_strided((30522, 128), (128, 1), device='cpu', dtype=torch.float32)
    arg204_1 = rand_strided((30522, ), (1, ), device='cpu', dtype=torch.float32)
    ...
    arg207_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg208_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
