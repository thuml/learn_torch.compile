...
def forward(self, L_inputs_labels_ : torch.Tensor, L_inputs_input_ids_ : torch.Tensor):
    ...
    inputs_embeds = self.L__mod___electra_embeddings_word_embeddings(l_inputs_input_ids_);  l_inputs_input_ids_ = None
    ...
    hidden_states_110 = self.L__mod___generator_predictions_dense(sequence_output);  sequence_output = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    hidden_states_111 = torch._C._nn.gelu(hidden_states_110);  hidden_states_110 = None
    ...
    hidden_states_112 = self.L__mod___generator_predictions_LayerNorm(hidden_states_111);  hidden_states_111 = None
    ...
    prediction_scores = self.L__mod___generator_lm_head(hidden_states_112);  hidden_states_112 = None
    ...
    getitem_3 = prediction_scores[(slice(None, None, None), slice(None, -1, None), slice(None, None, None))]
    shifted_prediction_scores = getitem_3.contiguous();  getitem_3 = None
    ...
    getitem_4 = l_inputs_labels_[(slice(None, None, None), slice(1, None, None))];  l_inputs_labels_ = None
    labels = getitem_4.contiguous();  getitem_4 = None
    ...
    view_48 = shifted_prediction_scores.view(-1, 30522);  shifted_prediction_scores = None
    view_49 = labels.view(-1);  labels = None
    lm_loss = torch.nn.functional.cross_entropy(view_48, view_49, None, None, -100, None, 'mean', 0.0);  view_48 = view_49 = None
