...
cpp_fused__softmax_backward_data_div_masked_fill_native_dropout_backward_where_4 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const bool* in_ptr1,
                       const float* in_ptr2,
    ...
    #pragma omp parallel num_threads(28)
    {
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(2048L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(1L))
                {
                    auto tmp0 = in_ptr3[static_cast<long>(x1 + (128L*x0))];
                    auto tmp1 = in_ptr4[static_cast<long>(x1 + (128L*x0))];
                    auto tmp2 = in_out_ptr0[static_cast<long>(x1 + (128L*x0))];
                    auto tmp3 = in_ptr1[static_cast<long>(x1 + (128L*x0))];
                    auto tmp8 = in_ptr2[static_cast<long>(x1 + (128L*x0))];
                    ...
                    auto tmp15 = tmp1 ? tmp14 : tmp12;
                    auto tmp16 = static_cast<float>(0.0);
                    auto tmp17 = tmp0 ? tmp16 : tmp15;
                    in_out_ptr0[static_cast<long>(x1 + (128L*x0))] = tmp17;
                }
            }
        }
    }
...
def call(args):
    primals_1, primals_11, primals_17, getitem_1, rsqrt, view, getitem_3, view_16, getitem_5, mul_3, view_18, addmm_4, view_20, getitem_9, permute_11, permute_15, div_1, permute_19, permute_24, permute_25, alias_1, eq, lt, permute_26, permute_27, permute_31, permute_36, permute_40, tangents_1, tangents_2, tangents_3 = args
    args.clear()
    ...
    assert_size_stride(getitem_3, (16, 128, 128), (16384, 128, 1))
    assert_size_stride(view_16, (128, 1024), (1024, 1))
    assert_size_stride(getitem_5, (1, 128, 1024), (131072, 1024, 1))
    ...
    assert_size_stride(getitem_9, (1, 128, 1024), (131072, 1024, 1))
    ...
    assert_size_stride(eq, (1, 16, 128, 128), (262144, 16384, 128, 1))
    assert_size_stride(lt, (1, 16, 128, 128), (262144, 16384, 128, 1))
    ...
    cpp_fused_native_dropout_backward_0(c_void_p(tangents_1.data_ptr()), c_void_p(getitem_9.data_ptr()), c_void_p(buf0.data_ptr()))
    del getitem_9
    ...
    buf20 = reinterpret_tensor(buf18, (1, 16, 128, 128), (262144, 16384, 128, 1), 0); del buf18  # reuse
    cpp_fused__softmax_backward_data_div_masked_fill_native_dropout_backward_where_4(c_void_p(buf20.data_ptr()), c_void_p(getitem_3.data_ptr()), c_void_p(alias_1.data_ptr()), c_void_p(lt.data_ptr()), c_void_p(eq.data_ptr()), c_void_p(buf19.data_ptr()))
    del alias_1
    del buf19
    del eq
    del getitem_3
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    getitem_3 = rand_strided((16, 128, 128), (16384, 128, 1), device='cpu', dtype=torch.bool)
    view_16 = rand_strided((128, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    getitem_5 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cpu', dtype=torch.bool)
    ...
    getitem_9 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cpu', dtype=torch.bool)
    ...
    eq = rand_strided((1, 16, 128, 128), (262144, 16384, 128, 1), device='cpu', dtype=torch.bool)
    lt = rand_strided((1, 16, 128, 128), (262144, 16384, 128, 1), device='cpu', dtype=torch.bool)
    ...
    return print_performance(lambda: call([primals_1, primals_11, primals_17, getitem_1, rsqrt, view, getitem_3, view_16, getitem_5, mul_3, view_18, addmm_4, view_20, getitem_9, permute_11, permute_15, div_1, permute_19, permute_24, permute_25, alias_1, eq, lt, permute_26, permute_27, permute_31, permute_36, permute_40, tangents_1, tangents_2, tangents_3]), times=times, repeat=repeat)
