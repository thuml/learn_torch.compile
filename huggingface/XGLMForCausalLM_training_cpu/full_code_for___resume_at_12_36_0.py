...
def __guard_0_for___resume_at_12_36(L):
    return (___guarded_code.valid) \
        ...
        and (len(L['value'][5]) == 2) \
        and (___check_type_id(L['value'][6], 7617760)) \
        and (len(L['value'][6]) == 2) \
        and (___check_type_id(L['value'][7], 7617760)) \
        and (len(L['value'][7]) == 2) \
        and (___check_type_id(L['value'][8], 7617760)) \
        and (len(L['value'][8]) == 2) \
        and (___check_type_id(L['value'][9], 7617760)) \
        and (len(L['value'][9]) == 2) \
        and (___check_obj_id(L['__class__'], 125262032)) \
        and (___check_type_id(L['value'][10], 7617760)) \
        and (len(L['value'][10]) == 2) \
        and (___check_type_id(L['value'][11], 7617760)) \
        and (len(L['value'][11]) == 2) \
        and (___check_type_id(L['value'][12], 7617760)) \
        and (len(L['value'][12]) == 2) \
        and (___check_type_id(L['value'][13], 7617760)) \
        and (len(L['value'][13]) == 2) \
        and (___check_type_id(L['value'][14], 7617760)) \
        and (len(L['value'][14]) == 2) \
        and (___check_type_id(L['value'][15], 7617760)) \
        and (len(L['value'][15]) == 2) \
        and (___check_type_id(L['value'][16], 7617760)) \
        and (len(L['value'][16]) == 2) \
        and (___check_type_id(L['value'][17], 7617760)) \
        and (len(L['value'][17]) == 2) \
        and (___check_type_id(L['value'][18], 7617760)) \
        and (len(L['value'][18]) == 2) \
        and (___check_type_id(L['value'][19], 7617760)) \
        and (len(L['value'][19]) == 2) \
        and (___check_type_id(L['value'][20], 7617760)) \
        and (len(L['value'][20]) == 2) \
        and (___check_type_id(L['value'][21], 7617760)) \
        and (len(L['value'][21]) == 2) \
        and (___check_type_id(L['value'][22], 7617760)) \
        and (len(L['value'][22]) == 2) \
        and (___check_type_id(L['value'][23], 7617760)) \
        and (len(L['value'][23]) == 2) \
        ...
        and (L['self'].past_key_values[6][0] is L['value'][6][0]) \
        and (L['self'].past_key_values[6][1] is L['value'][6][1]) \
        and (L['self'].past_key_values[7][0] is L['value'][7][0]) \
        and (L['self'].past_key_values[7][1] is L['value'][7][1]) \
        and (L['self'].past_key_values[8][0] is L['value'][8][0]) \
        and (L['self'].past_key_values[8][1] is L['value'][8][1]) \
        and (L['self'].past_key_values[9][0] is L['value'][9][0]) \
        and (L['self'].past_key_values[9][1] is L['value'][9][1]) \
        and (L['self'].past_key_values[10][0] is L['value'][10][0]) \
        and (L['self'].past_key_values[10][1] is L['value'][10][1]) \
        and (L['self'].past_key_values[11][0] is L['value'][11][0]) \
        and (L['self'].past_key_values[11][1] is L['value'][11][1]) \
        and (L['self'].past_key_values[12][0] is L['value'][12][0]) \
        and (L['self'].past_key_values[12][1] is L['value'][12][1]) \
        and (L['self'].past_key_values[13][0] is L['value'][13][0]) \
        and (L['self'].past_key_values[13][1] is L['value'][13][1]) \
        and (L['self'].past_key_values[14][0] is L['value'][14][0]) \
        and (L['self'].past_key_values[14][1] is L['value'][14][1]) \
        and (L['self'].past_key_values[15][0] is L['value'][15][0]) \
        and (L['self'].past_key_values[15][1] is L['value'][15][1]) \
        and (L['self'].past_key_values[16][0] is L['value'][16][0]) \
        and (L['self'].past_key_values[16][1] is L['value'][16][1]) \
        and (L['self'].past_key_values[17][0] is L['value'][17][0]) \
        and (L['self'].past_key_values[17][1] is L['value'][17][1]) \
        and (L['self'].past_key_values[18][0] is L['value'][18][0]) \
        and (L['self'].past_key_values[18][1] is L['value'][18][1]) \
        and (L['self'].past_key_values[19][0] is L['value'][19][0]) \
        and (L['self'].past_key_values[19][1] is L['value'][19][1]) \
        and (L['self'].past_key_values[20][0] is L['value'][20][0]) \
        and (L['self'].past_key_values[20][1] is L['value'][20][1]) \
        and (L['self'].past_key_values[21][0] is L['value'][21][0]) \
        and (L['self'].past_key_values[21][1] is L['value'][21][1]) \
        and (L['self'].past_key_values[22][0] is L['value'][22][0]) \
        and (L['self'].past_key_values[22][1] is L['value'][22][1]) \
        and (L['self'].past_key_values[23][0] is L['value'][23][0]) \
        and (L['self'].past_key_values[23][1] is L['value'][23][1]) \
...
def __helper_outer_function():
    ...
    __class__ = None
    def __transformed_code_0_for___resume_at_12_36(___stack0, self, key, value):
        nonlocal __class__
        import importlib
        def __resume_at_16_37(___stack0):
            nonlocal __class__
            return None
        return __resume_at_16_37(importlib.import_module('builtins').super(
            __class__, self).__setattr__(key, value))


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_12_36(___stack0, self, key, value):
    nonlocal __class__
    super(__class__, self).__setattr__(key, value)
    return None

def transformed___resume_at_12_36(___stack0, self, key, value):
    L = {"___stack0": ___stack0, "self": self, "key": key, "value": value}
    if __guard_0_for___resume_at_12_36(L):
        return __transformed_code_0_for___resume_at_12_36(___stack0, self, key, value)
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_12_36(___stack0, self, key, value)

#============ end of __resume_at_12_36 ============#
