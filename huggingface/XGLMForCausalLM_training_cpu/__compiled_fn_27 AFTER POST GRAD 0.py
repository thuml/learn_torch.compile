...
def forward(self, primals_1: "f32[1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024, 1024]", primals_10: "f32[1024]", primals_11: "f32[1024]", primals_12: "f32[1024]", primals_13: "f32[4096, 1024]", primals_14: "f32[4096]", primals_15: "f32[1024, 4096]", primals_16: "f32[1024]", primals_17: "f32[1, 128, 1024]", primals_18: "f32[1, 1, 128, 128]"):
    ...
    view_1: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm, [1, 128, 1024]);  addmm = None
    ...
    view_3: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_1, [1, 128, 1024]);  addmm_1 = None
    ...
    view_6: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_2, [1, 128, 1024]);  addmm_2 = None
    ...
    view_10: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(clone, [16, -1, 64])
    ...
    view_11: "f32[16, 128, 64]" = torch.ops.aten.reshape.default(clone_1, [16, -1, 64])
    ...
    maximum: "f32[1, 16, 128, 128]" = torch.ops.aten.maximum.default(add_2, full_default)
    ...
    view_13: "f32[16, 128, 128]" = torch.ops.aten.reshape.default(maximum, [16, 128, 128]);  maximum = None
    ...
    view_15: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_3, [1, 128, 1024]);  clone_3 = None
    ...
    sub_2: "f32[1, 128, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_7);  getitem_7 = None
    ...
    view_19: "f32[1, 128, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 4096])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_5: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.5)
    mul_6: "f32[1, 128, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476);  view_19 = None
    ...
    view_20: "f32[128, 4096]" = torch.ops.aten.reshape.default(mul_7, [128, 4096]);  mul_7 = None
    ...
    view_21: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(addmm_5, [1, 128, 1024]);  addmm_5 = None
    ...
    add_7: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(add_3, getitem_8);  add_3 = getitem_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:317, code: attn_weights = torch.max(
    eq: "b8[1, 16, 128, 128]" = torch.ops.aten.eq.Tensor(add_2, full_default)
    lt: "b8[1, 16, 128, 128]" = torch.ops.aten.lt.Tensor(add_2, full_default);  add_2 = full_default = None
    ...
    return [add_7, clone, clone_1, primals_1, primals_11, primals_17, getitem_1, rsqrt, view, getitem_3, view_16, getitem_5, mul_3, view_18, addmm_4, view_20, getitem_9, permute_11, permute_15, div_1, permute_19, permute_24, permute_25, alias_1, eq, lt, permute_26, permute_27, permute_31, permute_36, permute_40]
