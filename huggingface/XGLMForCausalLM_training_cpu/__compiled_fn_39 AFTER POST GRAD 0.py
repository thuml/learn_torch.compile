...
def forward(self, view: "f32[128, 1024]", slice_scatter_2: "i64[1, 128]", sub_1: "f32[128, 256008]", convert_element_type: "f32[]", permute_3: "f32[256008, 1024]", tangents_1: "f32[]", tangents_2: "f32[1, 128, 256008]"):
    ...
    view_4: "i64[128]" = torch.ops.aten.reshape.default(slice_scatter_2, [-1]);  slice_scatter_2 = None
    ...
    full_default_4: "f32[128, 256008]" = torch.ops.aten.full.default([128, 256008], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    exp_1: "f32[128, 256008]" = torch.ops.aten.exp.default(sub_1);  sub_1 = None
    ...
    view_5: "f32[1, 128, 256008]" = torch.ops.aten.reshape.default(sub_2, [1, 128, 256008]);  sub_2 = None
    ...
    view_6: "f32[128, 256008]" = torch.ops.aten.reshape.default(add, [128, 256008]);  add = None
    ...
    view_7: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 1024]);  mm_2 = None
