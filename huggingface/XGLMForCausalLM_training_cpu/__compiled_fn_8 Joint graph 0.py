...
def forward(self, primals, tangents):
    ...
    maximum: "f32[1, 16, 128, 128]" = torch.ops.aten.maximum.default(add_2, lift_fresh_copy)
    ...
    view_13: "f32[16, 128, 128]" = torch.ops.aten.view.default(maximum, [16, 128, 128]);  maximum = None
    ...
    getitem_2: "f32[16, 128, 128]" = native_dropout[0]
    getitem_3: "b8[16, 128, 128]" = native_dropout[1];  native_dropout = None
    ...
    bmm_1: "f32[16, 128, 64]" = torch.ops.aten.bmm.default(getitem_2, view_11)
    ...
    clone_3: "f32[1, 128, 16, 64]" = torch.ops.aten.clone.default(permute_7, memory_format = torch.contiguous_format);  permute_7 = None
    view_15: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_3, [1, 128, 1024]);  clone_3 = None
    ...
    getitem_4: "f32[1, 128, 1024]" = native_dropout_1[0]
    getitem_5: "b8[1, 128, 1024]" = native_dropout_1[1];  native_dropout_1 = None
    ...
    add_3: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(primals_17, getitem_4);  getitem_4 = None
    ...
    add_4: "f32[1, 128, 1]" = torch.ops.aten.add.Tensor(getitem_6, 1e-05);  getitem_6 = None
    rsqrt_1: "f32[1, 128, 1]" = torch.ops.aten.rsqrt.default(add_4);  add_4 = None
    sub_2: "f32[1, 128, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_7)
    ...
    clone_4: "f32[1, 128, 4096]" = torch.ops.aten.clone.default(mul_7);  mul_7 = None
    ...
    view_20: "f32[128, 4096]" = torch.ops.aten.view.default(clone_4, [128, 4096]);  clone_4 = None
    ...
    getitem_8: "f32[1, 128, 1024]" = native_dropout_2[0]
    getitem_9: "b8[1, 128, 1024]" = native_dropout_2[1];  native_dropout_2 = None
    ...
    add_7: "f32[1, 128, 1024]" = torch.ops.aten.add.Tensor(add_3, getitem_8);  getitem_8 = None
    ...
    clone_5: "f32[1, 128, 1024]" = torch.ops.aten.clone.default(mul_9, memory_format = torch.contiguous_format);  mul_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:474, code: hidden_states = self.fc2(hidden_states)
    view_22: "f32[128, 1024]" = torch.ops.aten.view.default(clone_5, [128, 1024]);  clone_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:471, code: hidden_states = self.final_layer_norm(hidden_states)
    sub_3: "f32[1, 128, 1024]" = torch.ops.aten.sub.Tensor(add_3, getitem_7);  add_3 = getitem_7 = None
    ...
    clone_6: "f32[1, 128, 1024]" = torch.ops.aten.clone.default(mul_25, memory_format = torch.contiguous_format);  mul_25 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:364, code: attn_output = self.out_proj(attn_output)
    view_28: "f32[128, 1024]" = torch.ops.aten.view.default(clone_6, [128, 1024]);  clone_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:349, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_24: "f32[16, 128, 128]" = torch.ops.aten.permute.default(getitem_2, [0, 2, 1]);  getitem_2 = None
    ...
    clone_7: "f32[16, 128, 128]" = torch.ops.aten.clone.default(mul_27, memory_format = torch.contiguous_format);  mul_27 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:326, code: attn_weights = nn.functional.softmax(attn_weights, dim=-1)
    alias_1: "f32[16, 128, 128]" = torch.ops.aten.alias.default(alias);  alias = None
    mul_28: "f32[16, 128, 128]" = torch.ops.aten.mul.Tensor(clone_7, alias_1);  clone_7 = None
    ...
    eq: "b8[1, 16, 128, 128]" = torch.ops.aten.eq.Tensor(add_2, lift_fresh_copy)
    where: "f32[1, 16, 128, 128]" = torch.ops.aten.where.self(eq, div_2, view_33);  eq = div_2 = view_33 = None
    lt: "b8[1, 16, 128, 128]" = torch.ops.aten.lt.Tensor(add_2, lift_fresh_copy);  add_2 = lift_fresh_copy = None
    ...
    where_1: "f32[1, 16, 128, 128]" = torch.ops.aten.where.self(lt, scalar_tensor, where);  lt = scalar_tensor = where = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:303, code: attn_weights = torch.bmm(query_states, key_states.transpose(1, 2))
    permute_26: "f32[16, 64, 128]" = torch.ops.aten.permute.default(view_9, [0, 2, 1]);  view_9 = None
    view_35: "f32[16, 128, 128]" = torch.ops.aten.view.default(where_1, [16, 128, 128]);  where_1 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:300, code: value_states = value_states.view(*proj_shape)
    view_36: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(bmm_2, [1, 16, 128, 64]);  bmm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:300, code: value_states = value_states.view(*proj_shape)
    add_11: "f32[1, 16, 128, 64]" = torch.ops.aten.add.Tensor(tangents_3, view_36);  tangents_3 = view_36 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:299, code: key_states = key_states.view(*proj_shape)
    view_37: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(permute_28, [1, 16, 128, 64]);  permute_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:299, code: key_states = key_states.view(*proj_shape)
    add_12: "f32[1, 16, 128, 64]" = torch.ops.aten.add.Tensor(tangents_2, view_37);  tangents_2 = view_37 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:298, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_38: "f32[1, 16, 128, 64]" = torch.ops.aten.view.default(bmm_5, [1, 16, 128, 64]);  bmm_5 = None
    ...
    view_39: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_8, [1, 128, 1024]);  clone_8 = None
    ...
    view_40: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_9, [1, 128, 1024]);  clone_9 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:285, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_41: "f32[128, 1024]" = torch.ops.aten.view.default(view_40, [128, 1024]);  view_40 = None
    ...
    view_42: "f32[1024]" = torch.ops.aten.view.default(sum_10, [1024]);  sum_10 = None
    permute_34: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_43: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_6, [1, 128, 1024]);  mm_6 = None
    ...
    view_44: "f32[1, 128, 1024]" = torch.ops.aten.view.default(clone_10, [1, 128, 1024]);  clone_10 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/xglm/modeling_xglm.py:284, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_45: "f32[128, 1024]" = torch.ops.aten.view.default(view_44, [128, 1024]);  view_44 = None
    ...
    view_46: "f32[1024]" = torch.ops.aten.view.default(sum_11, [1024]);  sum_11 = None
    permute_39: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_47: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_8, [1, 128, 1024]);  mm_8 = None
    ...
    view_48: "f32[128, 1024]" = torch.ops.aten.view.default(mul_30, [128, 1024]);  mul_30 = None
    ...
    view_49: "f32[1024]" = torch.ops.aten.view.default(sum_12, [1024]);  sum_12 = None
    permute_43: "f32[1024, 1024]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_50: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_10, [1, 128, 1024]);  mm_10 = None
    ...
    mul_31: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(sub_7, rsqrt);  sub_7 = None
    ...
    mul_34: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(mul_32, mul_31);  mul_32 = None
    sum_14: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_34, [2], True);  mul_34 = None
    mul_35: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(mul_31, sum_14);  sum_14 = None
    ...
    mul_37: "f32[1, 128, 1024]" = torch.ops.aten.mul.Tensor(add_14, mul_31);  mul_31 = None
    ...
    return pytree.tree_unflatten([add_7, clone, clone_1, sum_15, sum_16, permute_43, view_49, permute_39, view_46, permute_34, view_42, permute_22, view_29, sum_6, sum_7, permute_18, view_26, permute_14, view_23, add_15, None], self._out_spec)
