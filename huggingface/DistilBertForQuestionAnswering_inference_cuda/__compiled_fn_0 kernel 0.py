...
# kernel path: /tmp/torchinductor_youkaichao/zu/czuqshjed7h7dewkqvwaw2drvu25i4iw7lq7dc3sl2lu4sbfft3o.py
# Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
# start_logits_1 => clone_20
# start_loss => amax_6, exp_6, sub_19, sum_7
...
# kernel path: /tmp/torchinductor_youkaichao/wp/cwpcy2eth6aep4e7mxb3k5j3flwhlssu2jbitj5e4lgmxy564bye.py
# Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
# end_logits_1 => clone_21
# end_loss => amax_7, exp_7, sub_21, sum_10
...
# kernel path: /tmp/torchinductor_youkaichao/kk/ckkfjgnhbgwkmloatfswsf4zoknp6vohowa363hkdnqf3cguj5cm.py
# Source Nodes: [add_13, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
# add_13 => add_45
# end_loss => convert_element_type_1, div_13, full_default_9, ne_4, ne_5, neg_1, sum_11, sum_12, where_9
# end_positions => clamp_max_1, clamp_min_1
# start_loss => convert_element_type, div_12, full_default_7, ne_1, ne_2, neg, sum_8, sum_9, where_7
# start_positions => clamp_max, clamp_min
# total_loss => div_14
triton_poi_fused_add_clamp_div_nll_loss_forward_8 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_add_clamp_div_nll_loss_forward_8', 'mutated_arg_names': ['in_out_ptr0']},
    min_elem_per_thread=0
)
@triton.jit
...
def call(args):
    ...
    assert_size_stride(arg100_1, (2, 768), (768, 1))
    assert_size_stride(arg101_1, (2, ), (1, ))
    assert_size_stride(arg102_1, (1, 512), (512, 1))
    assert_size_stride(arg103_1, (1, 128), (128, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused_add_embedding_native_layer_norm_0.run(arg103_1, arg0_1, arg102_1, arg1_1, arg2_1, arg3_1, buf3, 128, 768, grid=grid(128), stream=stream0)
        del arg0_1
        del arg102_1
        del arg103_1
        del arg1_1
        ...
        del buf128
        del buf131
        buf136 = empty((128, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (128, 768), (768, 1), 0), reinterpret_tensor(arg100_1, (768, 2), (1, 768), 0), out=buf136)
        del arg100_1
        del buf135
        buf137 = empty((1, 128), device='cuda', dtype=torch.float32)
        buf138 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf139 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_6.run(buf136, arg101_1, buf137, buf138, buf139, 1, 128, grid=grid(1), stream=stream0)
        buf140 = empty((1, 128), device='cuda', dtype=torch.float32)
        buf141 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf142 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_7.run(buf136, arg101_1, buf140, buf141, buf142, 1, 128, grid=grid(1), stream=stream0)
        del arg101_1
        del buf136
        buf143 = reinterpret_tensor(buf138, (), (), 0); del buf138  # reuse
        buf144 = buf143; del buf143  # reuse
        # Source Nodes: [add_13, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_forward_8.run(buf144, arg104_1, buf137, buf139, arg105_1, buf140, buf141, buf142, 1, grid=grid(1), stream=stream0)
        del arg104_1
        del arg105_1
        return (buf144, buf137, buf140, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg100_1 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg101_1 = rand_strided((2, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg102_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg103_1 = rand_strided((1, 128), (128, 1), device='cuda:0', dtype=torch.int64)
    arg104_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg105_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    return print_performance(lambda: call([arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, arg9_1, arg10_1, arg11_1, arg12_1, arg13_1, arg14_1, arg15_1, arg16_1, arg17_1, arg18_1, arg19_1, arg20_1, arg21_1, arg22_1, arg23_1, arg24_1, arg25_1, arg26_1, arg27_1, arg28_1, arg29_1, arg30_1, arg31_1, arg32_1, arg33_1, arg34_1, arg35_1, arg36_1, arg37_1, arg38_1, arg39_1, arg40_1, arg41_1, arg42_1, arg43_1, arg44_1, arg45_1, arg46_1, arg47_1, arg48_1, arg49_1, arg50_1, arg51_1, arg52_1, arg53_1, arg54_1, arg55_1, arg56_1, arg57_1, arg58_1, arg59_1, arg60_1, arg61_1, arg62_1, arg63_1, arg64_1, arg65_1, arg66_1, arg67_1, arg68_1, arg69_1, arg70_1, arg71_1, arg72_1, arg73_1, arg74_1, arg75_1, arg76_1, arg77_1, arg78_1, arg79_1, arg80_1, arg81_1, arg82_1, arg83_1, arg84_1, arg85_1, arg86_1, arg87_1, arg88_1, arg89_1, arg90_1, arg91_1, arg92_1, arg93_1, arg94_1, arg95_1, arg96_1, arg97_1, arg98_1, arg99_1, arg100_1, arg101_1, arg102_1, arg103_1, arg104_1, arg105_1]), times=times, repeat=repeat)
