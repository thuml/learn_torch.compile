...
def forward(self, primals, tangents):
    ...
    view_12: "f32[1, 16, 128, 32]" = torch.ops.aten.view.default(bmm_1, [1, 16, 128, 32]);  bmm_1 = None
    ...
    view_13: "f32[1, 128, 512]" = torch.ops.aten.view.default(clone_4, [1, 128, 512]);  clone_4 = None
    ...
    view_14: "f32[128, 512]" = torch.ops.aten.view.default(view_13, [128, 512]);  view_13 = None
    ...
    view_15: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_3, [1, 128, 512]);  addmm_3 = None
    ...
    sub_1: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add, getitem_3)
    ...
    view_16: "f32[128, 512]" = torch.ops.aten.view.default(add_2, [128, 512])
    ...
    view_18: "f32[128, 2048]" = torch.ops.aten.view.default(clone_5, [128, 2048]);  clone_5 = None
    ...
    view_19: "f32[1, 128, 512]" = torch.ops.aten.view.default(addmm_5, [1, 128, 512]);  addmm_5 = None
    ...
    sub_2: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_4, getitem_7)
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_17: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476)
    erf_1: "f32[1, 128, 2048]" = torch.ops.aten.erf.default(mul_17);  mul_17 = None
    add_7: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_18: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(add_7, 0.5);  add_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:325, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_6: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add, getitem_3);  add = getitem_3 = None
    ...
    mul_30: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(add_9, mul_24);  mul_24 = None
