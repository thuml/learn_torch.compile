...
def forward(self, primals, tangents):
    primals_1: "f32[50265, 512]"; primals_2: "f32[1, 50265]"; primals_3: "f32[1, 128, 512]"; primals_4: "i64[1, 128]"; tangents_1: "f32[]"; tangents_2: "f32[1, 128, 50265]"; 
    ...
    view: "f32[128, 512]" = torch.ops.aten.view.default(primals_3, [128, 512]);  primals_3 = None
    ...
    view_2: "f32[128, 50265]" = torch.ops.aten.view.default(add, [-1, 50265])
    ...
    alias: "f32[128, 50265]" = torch.ops.aten.alias.default(sub_1)
    ...
    full: "f32[128, 50265]" = torch.ops.aten.full.default([128, 50265], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    scatter: "f32[128, 50265]" = torch.ops.aten.scatter.value(full, 1, where_2, -1.0);  full = where_2 = None
    ...
    alias_1: "f32[128, 50265]" = torch.ops.aten.alias.default(alias);  alias = None
    exp_1: "f32[128, 50265]" = torch.ops.aten.exp.default(alias_1);  alias_1 = None
    ...
    view_4: "f32[1, 128, 50265]" = torch.ops.aten.view.default(sub_2, [1, 128, 50265]);  sub_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:1330, code: masked_lm_loss = loss_fct(lm_logits.view(-1, self.config.vocab_size), labels.view(-1))
    add_1: "f32[1, 128, 50265]" = torch.ops.aten.add.Tensor(tangents_2, view_4);  tangents_2 = view_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:1325, code: lm_logits = self.lm_head(outputs[0]) + self.final_logits_bias
    view_5: "f32[128, 50265]" = torch.ops.aten.view.default(add_1, [128, 50265]);  add_1 = None
    permute_1: "f32[50265, 128]" = torch.ops.aten.permute.default(view_5, [1, 0])
    mm_1: "f32[50265, 512]" = torch.ops.aten.mm.default(permute_1, view);  permute_1 = view = None
    permute_2: "f32[512, 50265]" = torch.ops.aten.permute.default(mm_1, [1, 0]);  mm_1 = None
    permute_3: "f32[50265, 512]" = torch.ops.aten.permute.default(permute, [1, 0]);  permute = None
    mm_2: "f32[128, 512]" = torch.ops.aten.mm.default(view_5, permute_3);  view_5 = permute_3 = None
    view_6: "f32[1, 128, 512]" = torch.ops.aten.view.default(mm_2, [1, 128, 512]);  mm_2 = None
    permute_4: "f32[50265, 512]" = torch.ops.aten.permute.default(permute_2, [1, 0]);  permute_2 = None
