...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        return (buf10, buf1, primals_4, reinterpret_tensor(primals_3, (128, 512), (512, 1), 0), buf6, buf8, reinterpret_tensor(primals_1, (50265, 512), (512, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((1, 128, 512), (65536, 512, 1), device='cuda:0', dtype=torch.float32)
