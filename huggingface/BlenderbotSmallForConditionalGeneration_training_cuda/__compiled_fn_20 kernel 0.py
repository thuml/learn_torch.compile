...
# kernel path: /tmp/torchinductor_youkaichao/ij/cijjyxbohudnsybul4d5bclcboli4hvrudtzjskrmxfhlnay2qke.py
...
def call(args):
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty((1, 1, 128, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        stream0 = get_cuda_stream(0)
        triton_poi_fused_0.run(buf0, 16384, grid=grid(16384), stream=stream0)
        return (buf0, )
