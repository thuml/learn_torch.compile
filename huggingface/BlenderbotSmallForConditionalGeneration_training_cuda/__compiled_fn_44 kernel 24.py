...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf5, (512, 128), (1, 512), 0), view_18, out=buf7)
        del view_18
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf9, (2048, 128), (1, 2048), 0), view_16, out=buf11)
        del view_16
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf18, (512, 128), (1, 512), 0), view_14, out=buf20)
        del view_14
        ...
        # Source Nodes: [attn_weights_1], Original ATen: [aten._softmax, aten._softmax_backward_data]
        triton_per_fused__softmax__softmax_backward_data_7.run(buf23, bmm, amax, sum_1, buf25, 2048, 128, grid=grid(2048), stream=stream0)
        del amax
        del bmm
        del sum_1
        buf26 = reinterpret_tensor(buf19, (16, 32, 128), (4096, 128, 1), 0); del buf19  # reuse
        # Source Nodes: [], Original ATen: [aten.bmm]
        extern_kernels.bmm(permute_26, buf25, out=buf26)
        del permute_26
        buf27 = reinterpret_tensor(buf10, (16, 128, 32), (4096, 32, 1), 0); del buf10  # reuse
        # Source Nodes: [], Original ATen: [aten.bmm]
        extern_kernels.bmm(buf25, permute_27, out=buf27)
        del permute_27
        ...
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf26, (128, 512), (1, 128), 0), permute_36, out=buf32)
        del permute_36
        buf33 = reinterpret_tensor(buf23, (512, 512), (512, 1), 0); del buf23  # reuse
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf26, (512, 128), (128, 1), 0), view, out=buf33)
        ...
        buf35 = reinterpret_tensor(buf26, (128, 512), (512, 1), 0); del buf26  # reuse
        # Source Nodes: [], Original ATen: [aten.mul, aten.view]
        triton_poi_fused_mul_view_10.run(buf27, buf35, 65536, grid=grid(65536), stream=stream0)
        buf36 = reinterpret_tensor(buf27, (128, 512), (512, 1), 0); del buf27  # reuse
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(buf35, permute_40, out=buf36)
        del permute_40
        buf37 = empty((512, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf35, (512, 128), (1, 512), 0), view, out=buf37)
        del view
        buf38 = empty((1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.sum]
        triton_red_fused_sum_2.run(buf35, buf38, 512, 128, grid=grid(512), stream=stream0)
        del buf35
        buf39 = buf15; del buf15  # reuse
        # Source Nodes: [], Original ATen: [aten.add]
        triton_poi_fused_add_11.run(buf39, buf29, buf32, buf36, 65536, grid=grid(65536), stream=stream0)
        return (reinterpret_tensor(buf37, (512, 512), (512, 1), 0), reinterpret_tensor(buf38, (512, ), (1, ), 0), reinterpret_tensor(buf33, (512, 512), (512, 1), 0), reinterpret_tensor(buf34, (512, ), (1, ), 0), reinterpret_tensor(buf30, (512, 512), (512, 1), 0), reinterpret_tensor(buf31, (512, ), (1, ), 0), reinterpret_tensor(buf20, (512, 512), (512, 1), 0), reinterpret_tensor(buf21, (512, ), (1, ), 0), buf16, buf17, reinterpret_tensor(buf11, (2048, 512), (512, 1), 0), reinterpret_tensor(buf12, (2048, ), (1, ), 0), reinterpret_tensor(buf7, (512, 2048), (2048, 1), 0), reinterpret_tensor(buf8, (512, ), (1, ), 0), buf3, buf4, buf39, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    view_14 = rand_strided((128, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    view_18 = rand_strided((128, 2048), (2048, 1), device='cuda:0', dtype=torch.float32)
