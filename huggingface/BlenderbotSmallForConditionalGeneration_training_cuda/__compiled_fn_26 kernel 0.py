...
# kernel path: /tmp/torchinductor_youkaichao/uh/cuhfhnltjdnnh2mwoz56leej2idyon3jm2rdvutcev2zzbh4l5ou.py
...
def triton_(in_ptr0, in_ptr1, out_ptr2, out_ptr3, xnumel, rnumel, XBLOCK : tl.constexpr):
    ...
    tmp13 = tmp8 / tmp12
    tl.store(out_ptr2 + (r2 + (128*x3)), tmp13, rmask)
    tl.store(out_ptr3 + (r2 + (128*x3)), tmp13, rmask)
''')
...
# kernel path: /tmp/torchinductor_youkaichao/ve/cve5aiazg6r6rg3ga2tfhlkuijx6jeavzuruscul77qtk2rmy727.py
...
# kernel path: /tmp/torchinductor_youkaichao/ji/cjiy7orxfqxefxxmqgaajdt2kmsdqlxild2adq36gnqzxc237hf6.py
...
# kernel path: /tmp/torchinductor_youkaichao/gg/cgg6lhpceb6o56eapqmmzatmocmytwv6ketvqvr73aha7pem6fqu.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.mm(reinterpret_tensor(primals_27, (128, 512), (512, 1), 0), reinterpret_tensor(primals_1, (512, 512), (1, 512), 0), out=buf0)
        buf1 = empty((128, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(primals_27, (128, 512), (512, 1), 0), reinterpret_tensor(primals_3, (512, 512), (1, 512), 0), out=buf1)
        buf2 = empty((128, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(primals_27, (128, 512), (512, 1), 0), reinterpret_tensor(primals_5, (512, 512), (1, 512), 0), out=buf2)
        ...
        buf56 = empty((16, 128, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_probs, attn_weights_3], Original ATen: [aten._softmax, aten.clone, aten.detach]
        triton_per_fused__softmax_clone_detach_2.run(buf6, primals_28, buf9, buf56, 2048, 128, grid=grid(2048), stream=stream0)
        del primals_28
        ...
        buf55 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_2, l__self___encoder_attn_q_proj, residual_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_4.run(primals_27, buf14, primals_9, primals_10, buf19, buf20, buf55, 128, 512, grid=grid(128), stream=stream0)
        buf21 = reinterpret_tensor(buf14, (128, 512), (512, 1), 0); del buf14  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf20, reinterpret_tensor(primals_11, (512, 512), (1, 512), 0), out=buf21)
        buf22 = empty((128, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(primals_29, (128, 512), (512, 1), 0), reinterpret_tensor(primals_13, (512, 512), (1, 512), 0), out=buf22)
        buf23 = empty((128, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(primals_29, (128, 512), (512, 1), 0), reinterpret_tensor(primals_15, (512, 512), (1, 512), 0), out=buf23)
        buf24 = empty((1, 16, 128, 32), device='cuda', dtype=torch.float32)
        # Source Nodes: [contiguous_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_0.run(buf21, primals_12, buf24, 65536, grid=grid(65536), stream=stream0)
        del primals_12
        buf25 = reinterpret_tensor(buf21, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf21  # reuse
        # Source Nodes: [value_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf23, primals_16, buf25, 65536, grid=grid(65536), stream=stream0)
        del primals_16
        buf26 = reinterpret_tensor(buf23, (1, 16, 128, 32), (65536, 4096, 32, 1), 0); del buf23  # reuse
        # Source Nodes: [key_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf22, primals_14, buf26, 65536, grid=grid(65536), stream=stream0)
        del primals_14
        buf27 = buf6; del buf6  # reuse
        # Source Nodes: [attn_weights_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf24, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf26, (16, 32, 128), (4096, 1, 32), 0), out=buf27)
        buf28 = empty((16, 128, 1), device='cuda', dtype=torch.float32)
        buf29 = empty((16, 128, 1), device='cuda', dtype=torch.float32)
        buf30 = empty((16, 128, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_weights_5], Original ATen: [aten._softmax]
        triton_per_fused__softmax_5.run(buf27, buf28, buf29, buf30, 2048, 128, grid=grid(2048), stream=stream0)
        buf31 = reinterpret_tensor(buf22, (16, 128, 32), (4096, 32, 1), 0); del buf22  # reuse
        # Source Nodes: [attn_output_5], Original ATen: [aten.bmm]
        extern_kernels.bmm(buf30, reinterpret_tensor(buf25, (16, 128, 32), (4096, 32, 1), 0), out=buf31)
        buf32 = empty((128, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_4], Original ATen: [aten.view]
        triton_poi_fused_view_3.run(buf31, buf32, 65536, grid=grid(65536), stream=stream0)
        buf33 = reinterpret_tensor(buf31, (128, 512), (512, 1), 0); del buf31  # reuse
        # Source Nodes: [hidden_states_4], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_18, buf32, reinterpret_tensor(primals_17, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf33)
        del primals_18
        # Source Nodes: [hidden_states_5], Original ATen: [aten.native_dropout]
        buf34 = aten.native_dropout(reinterpret_tensor(buf33, (1, 128, 512), (65536, 512, 1), 0), 0.1, True)
        buf35 = buf34[0]
        buf36 = buf34[1]
        del buf34
        buf40 = reinterpret_tensor(buf33, (1, 128, 512), (65536, 512, 1), 0); del buf33  # reuse
        buf41 = empty((128, 512), device='cuda', dtype=torch.float32)
        buf54 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_6, l__self___fc1, residual_1, residual_2], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf19, primals_9, primals_10, buf35, primals_19, primals_20, buf40, buf41, buf54, 128, 512, grid=grid(128), stream=stream0)
        del primals_10
        buf42 = empty((128, 2048), device='cuda', dtype=torch.float32)
        # Source Nodes: [l__self___fc1], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_22, buf41, reinterpret_tensor(primals_21, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf42)
        del primals_22
        buf43 = empty((128, 2048), device='cuda', dtype=torch.float32)
        # Source Nodes: [hidden_states_10, hidden_states_8], Original ATen: [aten.gelu, aten.view]
        triton_poi_fused_gelu_view_7.run(buf42, buf43, 262144, grid=grid(262144), stream=stream0)
        buf44 = reinterpret_tensor(buf35, (128, 512), (512, 1), 0); del buf35  # reuse
        # Source Nodes: [hidden_states_10], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_24, buf43, reinterpret_tensor(primals_23, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf44)
        del primals_24
        # Source Nodes: [hidden_states_11], Original ATen: [aten.native_dropout]
        buf45 = aten.native_dropout(reinterpret_tensor(buf44, (1, 128, 512), (65536, 512, 1), 0), 0.1, True)
        buf46 = buf45[0]
        buf47 = buf45[1]
        del buf45
        buf51 = reinterpret_tensor(buf44, (1, 128, 512), (65536, 512, 1), 0); del buf44  # reuse
        buf52 = empty((1, 128, 512), device='cuda', dtype=torch.float32)
        buf53 = empty((1, 128, 1), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf40, primals_19, primals_20, buf46, primals_25, primals_26, buf51, buf52, buf53, 128, 512, grid=grid(128), stream=stream0)
        del buf46
        del primals_20
        del primals_26
        return (buf52, primals_9, primals_19, primals_25, reinterpret_tensor(primals_27, (128, 512), (512, 1), 0), buf11, buf15, buf19, buf20, reinterpret_tensor(primals_29, (128, 512), (512, 1), 0), buf27, buf28, buf29, buf32, buf36, buf40, buf41, buf42, buf43, buf47, buf51, buf53, reinterpret_tensor(primals_23, (512, 2048), (2048, 1), 0), reinterpret_tensor(primals_21, (2048, 512), (512, 1), 0), buf54, reinterpret_tensor(primals_17, (512, 512), (512, 1), 0), reinterpret_tensor(buf30, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf25, (16, 32, 128), (4096, 1, 32), 0), reinterpret_tensor(buf24, (16, 32, 128), (4096, 1, 32), 0), reinterpret_tensor(buf26, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(primals_15, (512, 512), (512, 1), 0), reinterpret_tensor(primals_13, (512, 512), (512, 1), 0), reinterpret_tensor(primals_11, (512, 512), (512, 1), 0), buf55, reinterpret_tensor(primals_7, (512, 512), (512, 1), 0), reinterpret_tensor(buf9, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf4, (16, 32, 128), (4096, 1, 32), 0), buf56, reinterpret_tensor(buf3, (16, 32, 128), (4096, 1, 32), 0), reinterpret_tensor(buf5, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(primals_5, (512, 512), (512, 1), 0), reinterpret_tensor(primals_3, (512, 512), (512, 1), 0), reinterpret_tensor(primals_1, (512, 512), (512, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_11 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_12 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_13 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_14 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_15 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_16 = rand_strided((512, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_17 = rand_strided((512, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_21 = rand_strided((2048, 512), (512, 1), device='cuda:0', dtype=torch.float32)
    primals_22 = rand_strided((2048, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_23 = rand_strided((512, 2048), (2048, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_27 = rand_strided((1, 128, 512), (65536, 512, 1), device='cuda:0', dtype=torch.float32)
    primals_28 = rand_strided((1, 1, 128, 128), (16384, 16384, 128, 1), device='cuda:0', dtype=torch.float32)
    primals_29 = rand_strided((1, 128, 512), (65536, 512, 1), device='cuda:0', dtype=torch.float32)
