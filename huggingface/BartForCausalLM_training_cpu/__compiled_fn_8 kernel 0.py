...
def call(args):
    ...
    del primals_4
    buf2 = empty((1, 16, 1024, 64), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_17, (1024, 1024), (1024, 1), 0), reinterpret_tensor(primals_5, (1024, 1024), (1, 1024), 0), alpha=1, beta=1, out=buf3)
    del primals_6
    buf4 = empty((1, 16, 1024, 64), device='cpu', dtype=torch.float32)
    buf5 = empty((1, 16, 1024, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_1(c_void_p(buf3.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf5.data_ptr()))
    buf6 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    ...
    buf7 = empty_strided((16, 1024, 1), (1024, 1, 16384), device='cpu', dtype=torch.float32)
    ...
    del buf9
    del primals_18
    buf11 = reinterpret_tensor(buf3, (16, 1024, 64), (65536, 64, 1), 0); del buf3  # reuse
    # Source Nodes: [attn_output], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf10, reinterpret_tensor(buf4, (16, 1024, 64), (65536, 64, 1), 0), out=buf11)
