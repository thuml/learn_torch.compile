...
def call(args):
    ...
    buf2 = empty((1, 1024, 1024), device='cpu', dtype=torch.float32)
    buf3 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf4 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf5 = empty((1, 1024, 1024), device='cpu', dtype=torch.float32)
    ...
    del primals_15
    del tangents_1
    buf6 = empty((1024, 4096), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (1024, 1024), (1, 1024), 0), view_20, out=buf7)
    del view_20
    buf8 = reinterpret_tensor(buf1, (1, 1024), (1024, 1), 0); del buf1  # reuse
    buf9 = reinterpret_tensor(buf6, (1, 1024, 4096), (4194304, 4096, 1), 0); del buf6  # reuse
    ...
    del addmm_4
    buf10 = reinterpret_tensor(buf5, (1024, 1024), (1024, 1), 0); del buf5  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf9, (1024, 4096), (4096, 1), 0), permute_15, out=buf10)
    del permute_15
    buf11 = empty((4096, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf9, (4096, 1024), (1, 4096), 0), view_18, out=buf11)
    del view_18
    buf12 = empty((1, 4096), device='cpu', dtype=torch.float32)
    buf13 = buf0; del buf0  # reuse
    buf14 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf15 = empty((1, 1024, 1024), device='cpu', dtype=torch.float32)
    buf16 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf17 = empty((1024, ), device='cpu', dtype=torch.float32)
    buf18 = empty((1, 1024, 1024), device='cpu', dtype=torch.float32)
    ...
    del mul_1
    del primals_9
    buf19 = reinterpret_tensor(buf2, (1024, 1024), (1024, 1), 0); del buf2  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf18, (1024, 1024), (1024, 1), 0), permute_19, out=buf19)
    del permute_19
    buf20 = buf10; del buf10  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf18, (1024, 1024), (1, 1024), 0), view_16, out=buf20)
    del view_16
    buf21 = reinterpret_tensor(buf14, (1, 1024), (1024, 1), 0); del buf14  # reuse
    cpp_fused_sum_3(c_void_p(buf18.data_ptr()), c_void_p(buf21.data_ptr()))
    buf22 = reinterpret_tensor(buf18, (16, 1024, 64), (65536, 64, 1), 0); del buf18  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_24, reinterpret_tensor(buf19, (16, 1024, 64), (64, 1024, 1), 0), out=buf22)
    del permute_24
    buf23 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf19, (16, 1024, 64), (64, 1024, 1), 0), permute_25, out=buf23)
    del permute_25
    buf24 = empty_strided((16, 1024, 1), (1024, 1, 16384), device='cpu', dtype=torch.float32)
    ...
    del alias_1
    del buf24
    buf26 = reinterpret_tensor(buf19, (16, 64, 1024), (65536, 1024, 1), 0); del buf19  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_26, reinterpret_tensor(buf25, (16, 1024, 1024), (1048576, 1024, 1), 0), out=buf26)
    del permute_26
    buf27 = empty((16, 1024, 64), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf25, (16, 1024, 1024), (1048576, 1024, 1), 0), permute_27, out=buf27)
    del buf25
    del permute_27
    buf28 = empty((1, 1024, 16, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_5(c_void_p(tangents_3.data_ptr()), c_void_p(buf22.data_ptr()), c_void_p(buf28.data_ptr()))
    del tangents_3
    buf29 = reinterpret_tensor(buf22, (1024, 1024), (1024, 1), 0); del buf22  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf28, (1024, 1024), (1024, 1), 0), permute_31, out=buf29)
    del permute_31
    buf30 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf28, (1024, 1024), (1, 1024), 0), view, out=buf30)
    buf31 = reinterpret_tensor(buf13, (1, 1024), (1024, 1), 0); del buf13  # reuse
    buf32 = empty((1, 1024, 16, 64), device='cpu', dtype=torch.float32)
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (1024, 1024), (1024, 1), 0), permute_36, out=buf33)
    del permute_36
    buf34 = reinterpret_tensor(buf26, (1024, 1024), (1024, 1), 0); del buf26  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (1024, 1024), (1, 1024), 0), view, out=buf34)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    view_20 = rand_strided((1024, 4096), (4096, 1), device='cpu', dtype=torch.float32)
    ...
    alias_1 = rand_strided((16, 1024, 1024), (1048576, 1024, 1), device='cpu', dtype=torch.float32)
    ...
    tangents_2 = rand_strided((1, 16, 1024, 64), (1048576, 65536, 64, 1), device='cpu', dtype=torch.float32)
    tangents_3 = rand_strided((1, 16, 1024, 64), (1048576, 65536, 64, 1), device='cpu', dtype=torch.float32)
