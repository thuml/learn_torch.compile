...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140213382084016)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 167849296)) \
        and (___check_type_id(L['input_ids'], 97895888)) \
        ...
        and (___check_type_id(G['torch'].long, 140215380776704)) \
