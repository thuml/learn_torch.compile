...
def __resume_at_108_47(___stack0, mod, collect_outputs, cloned_inputs, pred, loss):
    'Failed to decompile.'

def transformed___resume_at_108_47(___stack0, mod, collect_outputs, cloned_inputs, pred, loss):
    ...
    return __resume_at_108_47(___stack0, mod, collect_outputs, cloned_inputs, pred, loss)

#============ end of __resume_at_108_47 ============#

def __guard_3_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_type_id(L['self'], 145896992)) \
...
def __transformed_code_3_for_resume_in_forward_and_backward_pass(___stack0, self, mod, collect_outputs, cloned_inputs, pred, loss):
    ...
    return __resume_at_108_47(self.optimizer_step(), mod, collect_outputs,
        cloned_inputs, pred, loss)


# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_144_46(___stack0, self, mod, collect_outputs, cloned_inputs, pred, loss):
    'Failed to decompile.'

def transformed___resume_at_144_46(___stack0, self, mod, collect_outputs, cloned_inputs, pred, loss):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_144_46(___stack0, self, mod, collect_outputs, cloned_inputs, pred, loss)

#============ end of __resume_at_144_46 ============#

def __guard_2_for_resume_in_forward_and_backward_pass(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_type_id(L['self'], 145896992)) \
        and (___check_obj_id(L['___stack0'], 14609408)) \
        and (___check_type_id(L['___stack1'], 132536000)) \
        and (hasattr(L['___stack1'].loss, '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].logits, '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['self'].grad_scaler, 131637056)) \
        ...
        and (hasattr(L['___stack1'].past_key_values[0][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[0][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack1'].past_key_values[1][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[1][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack1'].past_key_values[2][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[2][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack1'].past_key_values[3][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[3][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack1'].past_key_values[4][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[4][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack1'].past_key_values[5][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].past_key_values[5][3], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack1'].encoder_last_hidden_state, '_dynamo_dynamic_indices') == False) \
        and (utils_device.CURRENT_DEVICE == None) \
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140382235860496))) \
        and (___compile_config_hash() == 'f0354ca969ec95d221ebd09c87295c79') \
        and (not ___needs_nopython()) \
        and (___check_tensors(L['___stack1'].loss, L['___stack1'].logits, L['___stack1'].past_key_values[0][0], L['___stack1'].past_key_values[0][1], L['___stack1'].past_key_values[0][2], L['___stack1'].past_key_values[0][3], L['___stack1'].past_key_values[1][0], L['___stack1'].past_key_values[1][1], L['___stack1'].past_key_values[1][2], L['___stack1'].past_key_values[1][3], L['___stack1'].past_key_values[2][0], L['___stack1'].past_key_values[2][1], L['___stack1'].past_key_values[2][2], L['___stack1'].past_key_values[2][3], L['___stack1'].past_key_values[3][0], L['___stack1'].past_key_values[3][1], L['___stack1'].past_key_values[3][2], L['___stack1'].past_key_values[3][3], L['___stack1'].past_key_values[4][0], L['___stack1'].past_key_values[4][1], L['___stack1'].past_key_values[4][2], L['___stack1'].past_key_values[4][3], L['___stack1'].past_key_values[5][0], L['___stack1'].past_key_values[5][1], L['___stack1'].past_key_values[5][2], L['___stack1'].past_key_values[5][3], L['___stack1'].encoder_last_hidden_state, tensor_check_names=tensor_check_names))
...
def __resume_at_20_1(___stack0, self, mod, collect_outputs, cloned_inputs):
    with self.autocast() as __temp_122:
        __temp_124 = {}
        __temp_124.update(cloned_inputs)
        pred = mod(*(), **__temp_124)
        loss = self.compute_loss(pred)
    self.grad_scaler.scale(loss).backward()
    self.optimizer_step()
...
def __resume_at_6_0(___stack0, self, mod, collect_outputs):
    ...
    with self.autocast() as __temp_134:
        __temp_136 = {}
        __temp_136.update(cloned_inputs)
        pred = mod(*(), **__temp_136)
        loss = self.compute_loss(pred)
    self.grad_scaler.scale(loss).backward()
    self.optimizer_step()
...
def forward_and_backward_pass(self, mod, inputs, collect_outputs):
    ...
    self.optimizer_zero_grad(mod)
    with self.autocast() as __temp_147:
        __temp_149 = {}
        __temp_149.update(cloned_inputs)
        pred = mod(*(), **__temp_149)
        loss = self.compute_loss(pred)
    self.grad_scaler.scale(loss).backward()
    self.optimizer_step()
