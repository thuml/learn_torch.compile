...
def forward(self, primals_9: "f32[768]", primals_15: "f32[768]", view: "f32[1024, 768]", unsqueeze_default: "f32[1, 12, 1024, 64]", unsqueeze_default_1: "f32[1, 12, 1024, 64]", unsqueeze_default_2: "f32[1, 12, 1024, 64]", getitem_11: "f32[1, 12, 1024]", getitem_12: "i64[]", getitem_13: "i64[]", alias_default_1: "f32[1, 12, 1024, 64]", view_14: "f32[1024, 768]", getitem_3: "b8[1, 1024, 768]", mul_1: "f32[1, 1024, 768]", view_16: "f32[1024, 768]", addmm_4: "f32[1024, 3072]", view_18: "f32[1024, 3072]", getitem_7: "b8[1, 1024, 768]", mul_6: "f32[1, 1024, 768]", div_1: "f32[1, 1024, 1]", permute_11: "f32[768, 3072]", permute_15: "f32[3072, 768]", div_2: "f32[1, 1024, 1]", permute_19: "f32[768, 768]", permute_31: "f32[768, 768]", permute_36: "f32[768, 768]", permute_40: "f32[768, 768]", tangents_1: "f32[1, 1024, 768]"):
    ...
    _scaled_dot_product_efficient_attention_backward_default = torch.ops.aten._scaled_dot_product_efficient_attention_backward.default(unsqueeze_default_3, unsqueeze_default, unsqueeze_default_1, unsqueeze_default_2, None, alias_default_1, getitem_11, getitem_12, getitem_13, 0.1, [True, True, True, False], scale = 1.0);  unsqueeze_default_3 = unsqueeze_default = unsqueeze_default_1 = unsqueeze_default_2 = alias_default_1 = getitem_11 = getitem_12 = getitem_13 = None
    getitem_14: "f32[1, 12, 1024, 64]" = _scaled_dot_product_efficient_attention_backward_default[0]
    squeeze_dim_3: "f32[12, 1024, 64]" = torch.ops.aten.squeeze.dim(getitem_14, 0);  getitem_14 = None
    getitem_15: "f32[1, 12, 1024, 64]" = _scaled_dot_product_efficient_attention_backward_default[1]
    squeeze_dim_2: "f32[12, 1024, 64]" = torch.ops.aten.squeeze.dim(getitem_15, 0);  getitem_15 = None
    getitem_16: "f32[1, 12, 1024, 64]" = _scaled_dot_product_efficient_attention_backward_default[2];  _scaled_dot_product_efficient_attention_backward_default = None
    squeeze_dim_1: "f32[12, 1024, 64]" = torch.ops.aten.squeeze.dim(getitem_16, 0);  getitem_16 = None
    ...
    view_31: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(squeeze_dim_1, [1, 12, 1024, 64]);  squeeze_dim_1 = None
    ...
    view_32: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(squeeze_dim_2, [1, 12, 1024, 64]);  squeeze_dim_2 = None
    ...
    view_33: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(squeeze_dim_3, [1, 12, 1024, 64]);  squeeze_dim_3 = None
