...
def forward(self, primals_4: "i64[1, 1024]", view: "f32[1024, 768]", sub_1: "f32[1024, 50005]", convert_element_type: "f32[]", permute_3: "f32[50005, 768]", tangents_1: "f32[]", tangents_2: "f32[1, 1024, 50005]"):
    ...
    view_5: "f32[1024, 50005]" = torch.ops.aten.reshape.default(add_1, [1024, 50005]);  add_1 = None
