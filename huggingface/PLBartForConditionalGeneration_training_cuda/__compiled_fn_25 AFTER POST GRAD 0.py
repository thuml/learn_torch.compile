...
def forward(self, primals_1: "f32[768, 768]", primals_2: "f32[768]", primals_3: "f32[768, 768]", primals_4: "f32[768]", primals_5: "f32[768, 768]", primals_6: "f32[768]", primals_7: "f32[768, 768]", primals_8: "f32[768]", primals_9: "f32[768]", primals_10: "f32[768]", primals_11: "f32[768, 768]", primals_12: "f32[768]", primals_13: "f32[768, 768]", primals_14: "f32[768]", primals_15: "f32[768, 768]", primals_16: "f32[768]", primals_17: "f32[768, 768]", primals_18: "f32[768]", primals_19: "f32[768]", primals_20: "f32[768]", primals_21: "f32[3072, 768]", primals_22: "f32[3072]", primals_23: "f32[768, 3072]", primals_24: "f32[768]", primals_25: "f32[768]", primals_26: "f32[768]", primals_27: "f32[1, 1024, 768]", primals_28: "f32[1, 1, 1024, 1024]", primals_29: "f32[1, 1024, 768]"):
    ...
    view: "f32[1024, 768]" = torch.ops.aten.reshape.default(primals_27, [1024, 768])
    permute: "f32[768, 768]" = torch.ops.aten.permute.default(primals_1, [1, 0]);  primals_1 = None
    
    # No stacktrace found for following nodes
    mm_default_5: "f32[1024, 768]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_5: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default_5, primals_2);  mm_default_5 = primals_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:188, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 1024, 768]);  add_tensor_5 = None
    ...
    # No stacktrace found for following nodes
    mm_default_4: "f32[1024, 768]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_4: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default_4, primals_4);  mm_default_4 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:213, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 1024, 768]);  add_tensor_4 = None
    ...
    # No stacktrace found for following nodes
    mm_default_3: "f32[1024, 768]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor_3: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default_3, primals_6);  mm_default_3 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:214, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 1024, 768]);  add_tensor_3 = None
    ...
    view_10: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(clone, [12, -1, 64])
    ...
    view_11: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(clone_1, [12, -1, 64])
    ...
    view_12: "f32[1, 12, 1024, 1024]" = torch.ops.aten.reshape.default(bmm, [1, 12, 1024, 1024]);  bmm = None
    ...
    view_13: "f32[12, 1024, 1024]" = torch.ops.aten.reshape.default(add, [12, 1024, 1024]);  add = None
    ...
    view_14: "f32[1, 12, 1024, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 12, 1024, 64]);  bmm_1 = None
    ...
    view_15: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(clone_3, [1, 1024, 768]);  clone_3 = None
    ...
    view_17: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(addmm_3, [1, 1024, 768]);  addmm_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:188, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_18: "f32[1024, 768]" = torch.ops.aten.reshape.default(add_3, [1024, 768])
    permute_9: "f32[768, 768]" = torch.ops.aten.permute.default(primals_11, [1, 0]);  primals_11 = None
    
    # No stacktrace found for following nodes
    mm_default_2: "f32[1024, 768]" = torch.ops.aten.mm.default(view_18, permute_9)
    add_tensor_2: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default_2, primals_12);  mm_default_2 = primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:188, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_19: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 1024, 768]);  add_tensor_2 = None
    ...
    view_20: "f32[1024, 768]" = torch.ops.aten.reshape.default(primals_29, [1024, 768]);  primals_29 = None
    permute_10: "f32[768, 768]" = torch.ops.aten.permute.default(primals_13, [1, 0]);  primals_13 = None
    
    # No stacktrace found for following nodes
    mm_default_1: "f32[1024, 768]" = torch.ops.aten.mm.default(view_20, permute_10)
    add_tensor_1: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default_1, primals_14);  mm_default_1 = primals_14 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:203, code: key_states = self._shape(self.k_proj(key_value_states), -1, bsz)
    view_21: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 1024, 768]);  add_tensor_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:168, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_22: "f32[1, 1024, 12, 64]" = torch.ops.aten.reshape.default(view_21, [1, -1, 12, 64]);  view_21 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[1024, 768]" = torch.ops.aten.mm.default(view_20, permute_12)
    add_tensor: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default, primals_16);  mm_default = primals_16 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:204, code: value_states = self._shape(self.v_proj(key_value_states), -1, bsz)
    view_24: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor, [1, 1024, 768]);  add_tensor = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:168, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_26: "f32[1, 1024, 12, 64]" = torch.ops.aten.reshape.default(mul_3, [1, 1024, 12, 64]);  mul_3 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:227, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_27: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(clone_6, [12, -1, 64]);  clone_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:228, code: key_states = key_states.reshape(*proj_shape)
    view_28: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(clone_4, [12, -1, 64])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:229, code: value_states = value_states.reshape(*proj_shape)
    view_29: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(clone_5, [12, -1, 64])
    ...
    getitem_16: "f32[1, 12, 1024, 64]" = _scaled_dot_product_efficient_attention_default[0]
    getitem_17: "f32[1, 12, 1024]" = _scaled_dot_product_efficient_attention_default[1]
    getitem_18: "i64[]" = _scaled_dot_product_efficient_attention_default[2]
    getitem_19: "i64[]" = _scaled_dot_product_efficient_attention_default[3];  _scaled_dot_product_efficient_attention_default = None
    alias_default: "f32[1, 12, 1024, 64]" = torch.ops.aten.alias.default(getitem_16)
    squeeze_dim: "f32[12, 1024, 64]" = torch.ops.aten.squeeze.dim(getitem_16, 0);  getitem_16 = None
    alias_default_1: "f32[1, 12, 1024, 64]" = torch.ops.aten.alias.default(alias_default);  alias_default = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:279, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[1, 12, 1024, 64]" = torch.ops.aten.reshape.default(squeeze_dim, [1, 12, 1024, 64]);  squeeze_dim = None
    ...
    view_31: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(clone_7, [1, 1024, 768]);  clone_7 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:286, code: attn_output = self.out_proj(attn_output)
    view_32: "f32[1024, 768]" = torch.ops.aten.reshape.default(view_31, [1024, 768]);  view_31 = None
    ...
    view_33: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(addmm_7, [1, 1024, 768]);  addmm_7 = None
    ...
    view_34: "f32[1024, 768]" = torch.ops.aten.reshape.default(add_6, [1024, 768])
    ...
    view_35: "f32[1, 1024, 3072]" = torch.ops.aten.reshape.default(addmm_8, [1, 1024, 3072])
    ...
    view_36: "f32[1024, 3072]" = torch.ops.aten.reshape.default(mul_8, [1024, 3072]);  mul_8 = None
    ...
    view_37: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(addmm_9, [1, 1024, 768]);  addmm_9 = None
