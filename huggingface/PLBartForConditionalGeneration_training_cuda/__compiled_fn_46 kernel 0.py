...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [masked_lm_loss], Original ATen: [aten._log_softmax_backward_data, aten.add, aten.nll_loss_backward, aten.nll_loss_forward]
        triton_red_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_2.run(buf0, primals_4, tangents_1, convert_element_type, tangents_2, sub_1, buf5, 1024, 50005, grid=grid(1024), stream=stream0)
        del buf0
        ...
        del buf5
        del permute_3
        return (reinterpret_tensor(buf6, (50005, 768), (768, 1), 0), None, reinterpret_tensor(buf7, (1, 1024, 768), (786432, 768, 1), 0), None, )
