...
def forward(self, arg0_1: "f32[1, 2]", arg1_1: "i64[1]"):
    ...
    view_1: "i64[1]" = torch.ops.aten.reshape.default(arg1_1, [-1]);  arg1_1 = None
    ne_1: "b8[1]" = torch.ops.aten.ne.Scalar(view_1, -100)
    view: "f32[1, 2]" = torch.ops.aten.reshape.default(arg0_1, [-1, 2]);  arg0_1 = None
    ...
    where: "i64[1]" = torch.ops.aten.where.self(ne, view_1, full_default);  ne = full_default = None
    ...
    where_1: "f32[1]" = torch.ops.aten.where.self(ne_1, neg, full_default_1);  ne_1 = neg = full_default_1 = None
