...
def __guard_0_for_forward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['mod'], 140462016265952)) \
        and (L['mod'].training == False) \
        and (___check_type_id(L['self'], 160960240)) \
        and (___check_type_id(L['inputs'], 7638432)) \
        and (set(L['inputs'].keys()) == {'input_ids', 'labels'}) \
        and (___check_obj_id(L['self'].autocast, 29666608)) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140458751909392))) \
        and (___compile_config_hash() == '14dc1e95a471ab6541b5354afe52ff33') \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_transformers_dot_models_dot_opt_dot_modeling_opt'].torch.bool, 140464013739776)) \
        and (G['__import_transformers_dot_models_dot_opt_dot_modeling_opt'].torch.bool == torch.bool) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_pre_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_forward_pre_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_pre_hooks, 7489504)) \
        and (set(G['__import_torch_dot_nn_dot_modules_dot_module']._global_backward_pre_hooks.keys()) == set()) \
        and (___check_type_id(G['__import_transformers_dot_models_dot_opt_dot_modeling_opt'].torch.float16, 140464013739776)) \
        and (G['__import_transformers_dot_models_dot_opt_dot_modeling_opt'].torch.float16 == torch.float16) \
        and (___check_obj_id(G['__import_transformers_dot_models_dot_opt_dot_modeling_opt']._expand_mask.__defaults__[0], 7628576)) \
        and (___check_type_id(G['__import_transformers_dot_models_dot_opt_dot_modeling_opt']._make_causal_mask.__defaults__[0], 7640416)) \
        and (G['__import_transformers_dot_models_dot_opt_dot_modeling_opt']._make_causal_mask.__defaults__[0] == 0) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[0].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[0].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[1].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[1].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[2].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[2].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[3].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[3].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[4].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[4].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[5].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[5].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[6].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[6].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[7].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[7].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[8].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[8].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[9].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[9].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[10].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[10].forward.__defaults__[4], 7677632)) \
        ...
        and (___check_obj_id(L['mod'].model.decoder.layers[11].forward.__defaults__[3], 7677632)) \
        and (___check_obj_id(L['mod'].model.decoder.layers[11].forward.__defaults__[4], 7677632)) \
...
def __transformed_code_0_for_forward_pass(self, mod, inputs, collect_outputs):
    ...
    return importlib.import_module('transformers.modeling_outputs'
        ...
        graph_out_0[25])), hidden_states=None, attentions=None)
