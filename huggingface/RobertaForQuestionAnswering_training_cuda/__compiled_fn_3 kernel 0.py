...
# Source Nodes: [add_39, end_loss, end_positions, loss, start_loss, start_positions], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_backward, aten.nll_loss_forward]
# add_39 => add_102
# end_loss => convert_element_type_4, div_25, ne_4, neg_1, sum_17, sum_18, where_3
# end_positions => clamp_max_1, clamp_min_1
# loss => div_26
# start_loss => convert_element_type_3, div_24, full_default_1, full_default_2, ne_1, neg, sum_14, sum_15, where_1
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_cumsum_ne_0.run(primals_201, buf0, 512, grid=grid(512), stream=stream0)
        # Source Nodes: [cumsum, mask, ne], Original ATen: [aten._to_copy, aten.cumsum, aten.ne]
        ...
        # Source Nodes: [add, embeddings, embeddings_1, embeddings_2, incremental_indices, inputs_embeds, long, mask, ne, position_embeddings, position_ids, token_type_embeddings, type_as], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mul, aten.native_layer_norm, aten.native_layer_norm_backward, aten.ne]
        triton_per_fused__to_copy_add_embedding_mul_native_layer_norm_native_layer_norm_backward_ne_1.run(buf3, primals_201, primals_1, primals_200, primals_2, primals_3, primals_4, primals_5, buf4, buf8, buf9, buf436, 512, 768, grid=grid(512), stream=stream0)
        del primals_1
        del primals_2
        del primals_3
        del primals_5
        ...
        # Source Nodes: [add_4, attention_output, hidden_states_3], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_4.run(buf27, buf11, primals_14, primals_15, buf32, buf33, buf435, 512, 768, grid=grid(512), stream=stream0)
        ...
        # Source Nodes: [add_5, attention_output, hidden_states_8, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf38, buf32, primals_14, primals_15, primals_20, primals_21, buf43, buf44, buf434, 512, 768, grid=grid(512), stream=stream0)
        del primals_15
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf59, buf43, primals_20, primals_21, primals_30, primals_31, buf64, buf65, buf433, 512, 768, grid=grid(512), stream=stream0)
        del primals_21
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf70, buf64, primals_30, primals_31, primals_36, primals_37, buf75, buf76, buf432, 512, 768, grid=grid(512), stream=stream0)
        del primals_31
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf91, buf75, primals_36, primals_37, primals_46, primals_47, buf96, buf97, buf431, 512, 768, grid=grid(512), stream=stream0)
        del primals_37
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf102, buf96, primals_46, primals_47, primals_52, primals_53, buf107, buf108, buf430, 512, 768, grid=grid(512), stream=stream0)
        del primals_47
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf123, buf107, primals_52, primals_53, primals_62, primals_63, buf128, buf129, buf429, 512, 768, grid=grid(512), stream=stream0)
        del primals_53
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf134, buf128, primals_62, primals_63, primals_68, primals_69, buf139, buf140, buf428, 512, 768, grid=grid(512), stream=stream0)
        del primals_63
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf155, buf139, primals_68, primals_69, primals_78, primals_79, buf160, buf161, buf427, 512, 768, grid=grid(512), stream=stream0)
        del primals_69
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf166, buf160, primals_78, primals_79, primals_84, primals_85, buf171, buf172, buf426, 512, 768, grid=grid(512), stream=stream0)
        del primals_79
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf187, buf171, primals_84, primals_85, primals_94, primals_95, buf192, buf193, buf425, 512, 768, grid=grid(512), stream=stream0)
        del primals_85
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf198, buf192, primals_94, primals_95, primals_100, primals_101, buf203, buf204, buf424, 512, 768, grid=grid(512), stream=stream0)
        del primals_95
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf219, buf203, primals_100, primals_101, primals_110, primals_111, buf224, buf225, buf423, 512, 768, grid=grid(512), stream=stream0)
        del primals_101
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf230, buf224, primals_110, primals_111, primals_116, primals_117, buf235, buf236, buf422, 512, 768, grid=grid(512), stream=stream0)
        del primals_111
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf251, buf235, primals_116, primals_117, primals_126, primals_127, buf256, buf257, buf421, 512, 768, grid=grid(512), stream=stream0)
        del primals_117
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf262, buf256, primals_126, primals_127, primals_132, primals_133, buf267, buf268, buf420, 512, 768, grid=grid(512), stream=stream0)
        del primals_127
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf283, buf267, primals_132, primals_133, primals_142, primals_143, buf288, buf289, buf419, 512, 768, grid=grid(512), stream=stream0)
        del primals_133
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf294, buf288, primals_142, primals_143, primals_148, primals_149, buf299, buf300, buf418, 512, 768, grid=grid(512), stream=stream0)
        del primals_143
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf315, buf299, primals_148, primals_149, primals_158, primals_159, buf320, buf321, buf417, 512, 768, grid=grid(512), stream=stream0)
        del primals_149
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf326, buf320, primals_158, primals_159, primals_164, primals_165, buf331, buf332, buf416, 512, 768, grid=grid(512), stream=stream0)
        del primals_159
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf347, buf331, primals_164, primals_165, primals_174, primals_175, buf352, buf353, buf415, 512, 768, grid=grid(512), stream=stream0)
        del primals_165
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf358, buf352, primals_174, primals_175, primals_180, primals_181, buf363, buf364, buf414, 512, 768, grid=grid(512), stream=stream0)
        del primals_175
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf379, buf363, primals_180, primals_181, primals_190, primals_191, buf384, buf385, buf413, 512, 768, grid=grid(512), stream=stream0)
        del primals_181
        ...
        # Source Nodes: [add_38, attention_output_22, logits, sequence_output], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf390, buf384, primals_190, primals_191, primals_196, primals_197, buf395, buf396, buf412, 512, 768, grid=grid(512), stream=stream0)
        del buf390
        del primals_191
        del primals_197
        buf397 = empty((512, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf396, reinterpret_tensor(primals_198, (768, 2), (1, 768), 0), out=buf397)
        buf398 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf402 = empty((1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_7.run(buf397, primals_199, buf398, buf402, 1, 512, grid=grid(1), stream=stream0)
        buf399 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf406 = empty((1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_8.run(buf397, primals_199, buf399, buf406, 1, 512, grid=grid(1), stream=stream0)
        del buf397
        del primals_199
        buf403 = empty((1, ), device='cuda', dtype=torch.bool)
        buf407 = empty((1, ), device='cuda', dtype=torch.bool)
        buf437 = empty((), device='cuda', dtype=torch.float32)
        buf408 = empty((1, 1), device='cuda', dtype=torch.bool)
        buf409 = empty((1, 1), device='cuda', dtype=torch.int64)
        buf410 = empty((1, 1), device='cuda', dtype=torch.bool)
        buf411 = empty((1, 1), device='cuda', dtype=torch.int64)
        # Source Nodes: [add_39, end_loss, end_positions, loss, start_loss, start_positions], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_backward, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_backward_nll_loss_forward_9.run(primals_202, primals_203, buf402, buf406, buf403, buf407, buf437, buf408, buf409, buf410, buf411, 1, grid=grid(1), stream=stream0)
        del primals_202
        del primals_203
        return (buf437, buf398, buf399, primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_201, primals_200, buf3, buf8, buf12, reinterpret_tensor(buf11, (512, 768), (768, 1), 0), buf16, buf17, buf18, buf21, buf22, buf23, buf20, buf24, buf28, buf32, buf33, buf34, buf35, buf39, buf43, buf44, buf48, buf49, buf50, buf53, buf54, buf55, buf52, buf56, buf60, buf64, buf65, buf66, buf67, buf71, buf75, buf76, buf80, buf81, buf82, buf85, buf86, buf87, buf84, buf88, buf92, buf96, buf97, buf98, buf99, buf103, buf107, buf108, buf112, buf113, buf114, buf117, buf118, buf119, buf116, buf120, buf124, buf128, buf129, buf130, buf131, buf135, buf139, buf140, buf144, buf145, buf146, buf149, buf150, buf151, buf148, buf152, buf156, buf160, buf161, buf162, buf163, buf167, buf171, buf172, buf176, buf177, buf178, buf181, buf182, buf183, buf180, buf184, buf188, buf192, buf193, buf194, buf195, buf199, buf203, buf204, buf208, buf209, buf210, buf213, buf214, buf215, buf212, buf216, buf220, buf224, buf225, buf226, buf227, buf231, buf235, buf236, buf240, buf241, buf242, buf245, buf246, buf247, buf244, buf248, buf252, buf256, buf257, buf258, buf259, buf263, buf267, buf268, buf272, buf273, buf274, buf277, buf278, buf279, buf276, buf280, buf284, buf288, buf289, buf290, buf291, buf295, buf299, buf300, buf304, buf305, buf306, buf309, buf310, buf311, buf308, buf312, buf316, buf320, buf321, buf322, buf323, buf327, buf331, buf332, buf336, buf337, buf338, buf341, buf342, buf343, buf340, buf344, buf348, buf352, buf353, buf354, buf355, buf359, buf363, buf364, buf368, buf369, buf370, buf373, buf374, buf375, buf372, buf376, buf380, buf384, buf385, buf386, buf387, buf391, buf395, buf396, buf402, buf403, buf406, buf407, buf408, buf409, buf410, buf411, reinterpret_tensor(primals_198, (2, 768), (768, 1), 0), buf412, reinterpret_tensor(primals_194, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_192, (3072, 768), (768, 1), 0), buf413, reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), reinterpret_tensor(primals_184, (768, 768), (768, 1), 0), reinterpret_tensor(primals_182, (768, 768), (768, 1), 0), buf414, reinterpret_tensor(primals_178, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_176, (3072, 768), (768, 1), 0), buf415, reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), reinterpret_tensor(primals_168, (768, 768), (768, 1), 0), reinterpret_tensor(primals_166, (768, 768), (768, 1), 0), buf416, reinterpret_tensor(primals_162, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_160, (3072, 768), (768, 1), 0), buf417, reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), reinterpret_tensor(primals_152, (768, 768), (768, 1), 0), reinterpret_tensor(primals_150, (768, 768), (768, 1), 0), buf418, reinterpret_tensor(primals_146, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_144, (3072, 768), (768, 1), 0), buf419, reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), reinterpret_tensor(primals_136, (768, 768), (768, 1), 0), reinterpret_tensor(primals_134, (768, 768), (768, 1), 0), buf420, reinterpret_tensor(primals_130, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_128, (3072, 768), (768, 1), 0), buf421, reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), reinterpret_tensor(primals_120, (768, 768), (768, 1), 0), reinterpret_tensor(primals_118, (768, 768), (768, 1), 0), buf422, reinterpret_tensor(primals_114, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_112, (3072, 768), (768, 1), 0), buf423, reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), reinterpret_tensor(primals_104, (768, 768), (768, 1), 0), reinterpret_tensor(primals_102, (768, 768), (768, 1), 0), buf424, reinterpret_tensor(primals_98, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_96, (3072, 768), (768, 1), 0), buf425, reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), reinterpret_tensor(primals_88, (768, 768), (768, 1), 0), reinterpret_tensor(primals_86, (768, 768), (768, 1), 0), buf426, reinterpret_tensor(primals_82, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_80, (3072, 768), (768, 1), 0), buf427, reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), reinterpret_tensor(primals_72, (768, 768), (768, 1), 0), reinterpret_tensor(primals_70, (768, 768), (768, 1), 0), buf428, reinterpret_tensor(primals_66, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_64, (3072, 768), (768, 1), 0), buf429, reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), reinterpret_tensor(primals_56, (768, 768), (768, 1), 0), reinterpret_tensor(primals_54, (768, 768), (768, 1), 0), buf430, reinterpret_tensor(primals_50, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_48, (3072, 768), (768, 1), 0), buf431, reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), reinterpret_tensor(primals_40, (768, 768), (768, 1), 0), reinterpret_tensor(primals_38, (768, 768), (768, 1), 0), buf432, reinterpret_tensor(primals_34, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_32, (3072, 768), (768, 1), 0), buf433, reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), reinterpret_tensor(primals_24, (768, 768), (768, 1), 0), reinterpret_tensor(primals_22, (768, 768), (768, 1), 0), buf434, reinterpret_tensor(primals_18, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_16, (3072, 768), (768, 1), 0), buf435, reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), reinterpret_tensor(primals_8, (768, 768), (768, 1), 0), reinterpret_tensor(primals_6, (768, 768), (768, 1), 0), buf436, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_202 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
