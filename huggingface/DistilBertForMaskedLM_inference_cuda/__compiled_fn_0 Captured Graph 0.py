...
def forward(self, L_inputs_input_ids_ : torch.Tensor, L_inputs_labels_ : torch.Tensor):
    ...
    input_embeds = self.L__mod___distilbert_embeddings_word_embeddings(l_inputs_input_ids_);  l_inputs_input_ids_ = None
    ...
    prediction_logits = self.L__mod___vocab_transform(hidden_states);  hidden_states = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    prediction_logits_1 = torch._C._nn.gelu(prediction_logits);  prediction_logits = None
    ...
    prediction_logits_2 = self.L__mod___vocab_layer_norm(prediction_logits_1);  prediction_logits_1 = None
    ...
    prediction_logits_3 = self.L__mod___vocab_projector(prediction_logits_2);  prediction_logits_2 = None
    ...
    view_30 = prediction_logits_3.view(-1, 30522)
    view_31 = l_inputs_labels_.view(-1);  l_inputs_labels_ = None
    mlm_loss = self.L__mod___mlm_loss_fct(view_30, view_31);  view_30 = view_31 = None
    return (mlm_loss, prediction_logits_3)
