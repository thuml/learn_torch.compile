...
def forward(self, primals_1: "f32[256, 256]", primals_2: "f32[256]", primals_3: "f32[256, 256]", primals_4: "f32[256]", primals_5: "f32[256, 256]", primals_6: "f32[256]", primals_7: "f32[256, 256]", primals_8: "f32[256]", primals_9: "f32[256]", primals_10: "f32[256]", primals_11: "f32[2048, 256]", primals_12: "f32[2048]", primals_13: "f32[256, 2048]", primals_14: "f32[256]", primals_15: "f32[256]", primals_16: "f32[256]", primals_17: "f32[1, 128, 256]", primals_18: "f32[1, 1, 128, 128]"):
    ...
    view: "f32[128, 256]" = torch.ops.aten.reshape.default(primals_17, [128, 256])
    permute: "f32[256, 256]" = torch.ops.aten.permute.default(primals_1, [1, 0]);  primals_1 = None
    
    # No stacktrace found for following nodes
    mm_default_3: "f32[128, 256]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_3: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_3, primals_2);  mm_default_3 = primals_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 256]);  add_tensor_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_2: "f32[128, 256]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_2: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_2, primals_4);  mm_default_2 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 256]);  add_tensor_2 = None
    ...
    view_4: "f32[1, 128, 4, 64]" = torch.ops.aten.reshape.default(view_3, [1, -1, 4, 64]);  view_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[128, 256]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor_1: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_1, primals_6);  mm_default_1 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 256]);  add_tensor_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:181, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_7: "f32[1, 128, 4, 64]" = torch.ops.aten.reshape.default(view_6, [1, -1, 4, 64]);  view_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:181, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_8: "f32[1, 128, 4, 64]" = torch.ops.aten.reshape.default(mul, [1, 128, 4, 64]);  mul = None
    ...
    view_9: "f32[4, 128, 64]" = torch.ops.aten.reshape.default(clone_2, [4, -1, 64]);  clone_2 = None
    ...
    view_10: "f32[4, 128, 64]" = torch.ops.aten.reshape.default(clone, [4, -1, 64])
    ...
    view_11: "f32[4, 128, 64]" = torch.ops.aten.reshape.default(clone_1, [4, -1, 64])
    ...
    view_12: "f32[1, 4, 128, 128]" = torch.ops.aten.reshape.default(bmm, [1, 4, 128, 128]);  bmm = None
    ...
    view_13: "f32[4, 128, 128]" = torch.ops.aten.reshape.default(add, [4, 128, 128]);  add = None
    ...
    view_14: "f32[1, 4, 128, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 4, 128, 64]);  bmm_1 = None
    ...
    view_15: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(clone_4, [1, 128, 256]);  clone_4 = None
    ...
    view_16: "f32[128, 256]" = torch.ops.aten.reshape.default(view_15, [128, 256]);  view_15 = None
    ...
    view_17: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(addmm_3, [1, 128, 256]);  addmm_3 = None
    ...
    view_18: "f32[128, 256]" = torch.ops.aten.reshape.default(add_3, [128, 256])
    permute_9: "f32[256, 2048]" = torch.ops.aten.permute.default(primals_11, [1, 0]);  primals_11 = None
    
    # No stacktrace found for following nodes
    mm_default: "f32[128, 2048]" = torch.ops.aten.mm.default(view_18, permute_9)
    add_tensor: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default, primals_12);  mm_default = primals_12 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_19: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 2048]);  add_tensor = None
    ...
    view_20: "f32[128, 2048]" = torch.ops.aten.reshape.default(relu, [128, 2048])
    ...
    view_21: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(addmm_5, [1, 128, 256]);  addmm_5 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    le: "b8[1, 128, 2048]" = torch.ops.aten.le.Scalar(relu, 0);  relu = None
