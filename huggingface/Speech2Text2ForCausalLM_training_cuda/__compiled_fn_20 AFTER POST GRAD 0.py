...
def forward(self, primals_1: "f32[10000, 256]", primals_2: "f32[1, 128, 256]", primals_3: "i64[1, 128]"):
    ...
    view: "f32[128, 256]" = torch.ops.aten.reshape.default(primals_2, [128, 256]);  primals_2 = None
    mm: "f32[128, 10000]" = torch.ops.aten.mm.default(view, permute)
    view_1: "f32[1, 128, 10000]" = torch.ops.aten.reshape.default(mm, [1, 128, 10000]);  mm = None
    ...
    view_2: "f32[128, 10000]" = torch.ops.aten.reshape.default(view_1, [-1, 10000])
