...
cpp_fused_tanh_85 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0)
{
    {
...
cpp_fused_add_embedding_native_layer_norm_native_layer_norm_backward_zeros_86 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    buf453 = empty((1, 512, 768), device='cpu', dtype=torch.float32)
    cpp_fused_add_native_layer_norm_84(c_void_p(buf447.data_ptr()), c_void_p(buf441.data_ptr()), c_void_p(primals_194.data_ptr()), c_void_p(primals_195.data_ptr()), c_void_p(primals_200.data_ptr()), c_void_p(primals_201.data_ptr()), c_void_p(buf449.data_ptr()), c_void_p(buf450.data_ptr()), c_void_p(buf452.data_ptr()), c_void_p(buf453.data_ptr()))
    del buf447
    del buf449
    del primals_195
    del primals_201
    ...
    extern_kernels.addmm(primals_203, reinterpret_tensor(buf453, (1, 768), (768, 1), 0), reinterpret_tensor(primals_202, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf454)
    del primals_203
    buf455 = buf454; del buf454  # reuse
    cpp_fused_tanh_85(c_void_p(buf455.data_ptr()))
    # Source Nodes: [pooled_output_4], Original ATen: [aten.native_dropout]
    buf456 = aten.native_dropout(buf455, 0.1, True)
    buf457 = buf456[0]
    buf458 = buf456[1]
    del buf456
    buf459 = empty((1, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_205, buf457, reinterpret_tensor(primals_204, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf459)
    del primals_205
    buf460 = reinterpret_tensor(buf450, (1, 512, 1), (512, 1, 1), 0); del buf450  # reuse
    buf461 = reinterpret_tensor(buf439, (1, 512, 1), (512, 1, 1), 0); del buf439  # reuse
    buf462 = reinterpret_tensor(buf413, (1, 512, 1), (512, 1, 1), 0); del buf413  # reuse
    buf463 = reinterpret_tensor(buf402, (1, 512, 1), (512, 1, 1), 0); del buf402  # reuse
    buf464 = reinterpret_tensor(buf376, (1, 512, 1), (512, 1, 1), 0); del buf376  # reuse
    buf465 = reinterpret_tensor(buf365, (1, 512, 1), (512, 1, 1), 0); del buf365  # reuse
    buf466 = reinterpret_tensor(buf339, (1, 512, 1), (512, 1, 1), 0); del buf339  # reuse
    buf467 = reinterpret_tensor(buf328, (1, 512, 1), (512, 1, 1), 0); del buf328  # reuse
    buf468 = reinterpret_tensor(buf302, (1, 512, 1), (512, 1, 1), 0); del buf302  # reuse
    buf469 = reinterpret_tensor(buf291, (1, 512, 1), (512, 1, 1), 0); del buf291  # reuse
    buf470 = reinterpret_tensor(buf265, (1, 512, 1), (512, 1, 1), 0); del buf265  # reuse
    buf471 = reinterpret_tensor(buf254, (1, 512, 1), (512, 1, 1), 0); del buf254  # reuse
    buf472 = reinterpret_tensor(buf228, (1, 512, 1), (512, 1, 1), 0); del buf228  # reuse
    buf473 = reinterpret_tensor(buf217, (1, 512, 1), (512, 1, 1), 0); del buf217  # reuse
    buf474 = reinterpret_tensor(buf191, (1, 512, 1), (512, 1, 1), 0); del buf191  # reuse
    buf475 = reinterpret_tensor(buf180, (1, 512, 1), (512, 1, 1), 0); del buf180  # reuse
    buf476 = reinterpret_tensor(buf154, (1, 512, 1), (512, 1, 1), 0); del buf154  # reuse
    buf477 = reinterpret_tensor(buf143, (1, 512, 1), (512, 1, 1), 0); del buf143  # reuse
    buf478 = reinterpret_tensor(buf117, (1, 512, 1), (512, 1, 1), 0); del buf117  # reuse
    buf479 = reinterpret_tensor(buf106, (1, 512, 1), (512, 1, 1), 0); del buf106  # reuse
    buf480 = reinterpret_tensor(buf80, (1, 512, 1), (512, 1, 1), 0); del buf80  # reuse
    buf481 = reinterpret_tensor(buf69, (1, 512, 1), (512, 1, 1), 0); del buf69  # reuse
    buf482 = reinterpret_tensor(buf43, (1, 512, 1), (512, 1, 1), 0); del buf43  # reuse
    buf483 = reinterpret_tensor(buf32, (1, 512, 1), (512, 1, 1), 0); del buf32  # reuse
    buf484 = reinterpret_tensor(buf3, (1, 512, 1), (512, 1, 1), 0); del buf3  # reuse
    buf485 = empty((1, 512, 4), device='cpu', dtype=torch.int64)
    cpp_fused_add_embedding_native_layer_norm_native_layer_norm_backward_zeros_86(c_void_p(buf460.data_ptr()), c_void_p(buf461.data_ptr()), c_void_p(buf462.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(buf465.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf468.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()))
    return (buf453, buf455, buf459, primals_8, primals_18, primals_24, primals_34, primals_40, primals_50, primals_56, primals_66, primals_72, primals_82, primals_88, primals_98, primals_104, primals_114, primals_120, primals_130, primals_136, primals_146, primals_152, primals_162, primals_168, primals_178, primals_184, primals_194, primals_200, primals_207, buf0, primals_206, reinterpret_tensor(buf485, (1, 512), (0, 4), 0), reinterpret_tensor(buf485, (1, 512), (0, 4), 1), reinterpret_tensor(buf485, (1, 512), (0, 4), 2), reinterpret_tensor(buf485, (1, 512), (0, 4), 3), buf5, buf9, reinterpret_tensor(buf8, (512, 768), (768, 1), 0), buf22, reinterpret_tensor(buf21, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf23, (12, 64, 512), (32768, 1, 64), 0), buf19, reinterpret_tensor(buf13, (12, 64, 512), (32768, 1, 64), 0), buf25, buf26, buf30, buf34, buf35, buf36, buf37, buf41, buf45, buf46, buf59, reinterpret_tensor(buf58, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf60, (12, 64, 512), (32768, 1, 64), 0), buf56, reinterpret_tensor(buf50, (12, 64, 512), (32768, 1, 64), 0), buf62, buf63, buf67, buf71, buf72, buf73, buf74, buf78, buf82, buf83, buf96, reinterpret_tensor(buf95, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf97, (12, 64, 512), (32768, 1, 64), 0), buf93, reinterpret_tensor(buf87, (12, 64, 512), (32768, 1, 64), 0), buf99, buf100, buf104, buf108, buf109, buf110, buf111, buf115, buf119, buf120, buf133, reinterpret_tensor(buf132, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf134, (12, 64, 512), (32768, 1, 64), 0), buf130, reinterpret_tensor(buf124, (12, 64, 512), (32768, 1, 64), 0), buf136, buf137, buf141, buf145, buf146, buf147, buf148, buf152, buf156, buf157, buf170, reinterpret_tensor(buf169, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf171, (12, 64, 512), (32768, 1, 64), 0), buf167, reinterpret_tensor(buf161, (12, 64, 512), (32768, 1, 64), 0), buf173, buf174, buf178, buf182, buf183, buf184, buf185, buf189, buf193, buf194, buf207, reinterpret_tensor(buf206, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf208, (12, 64, 512), (32768, 1, 64), 0), buf204, reinterpret_tensor(buf198, (12, 64, 512), (32768, 1, 64), 0), buf210, buf211, buf215, buf219, buf220, buf221, buf222, buf226, buf230, buf231, buf244, reinterpret_tensor(buf243, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf245, (12, 64, 512), (32768, 1, 64), 0), buf241, reinterpret_tensor(buf235, (12, 64, 512), (32768, 1, 64), 0), buf247, buf248, buf252, buf256, buf257, buf258, buf259, buf263, buf267, buf268, buf281, reinterpret_tensor(buf280, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf282, (12, 64, 512), (32768, 1, 64), 0), buf278, reinterpret_tensor(buf272, (12, 64, 512), (32768, 1, 64), 0), buf284, buf285, buf289, buf293, buf294, buf295, buf296, buf300, buf304, buf305, buf318, reinterpret_tensor(buf317, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf319, (12, 64, 512), (32768, 1, 64), 0), buf315, reinterpret_tensor(buf309, (12, 64, 512), (32768, 1, 64), 0), buf321, buf322, buf326, buf330, buf331, buf332, buf333, buf337, buf341, buf342, buf355, reinterpret_tensor(buf354, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf356, (12, 64, 512), (32768, 1, 64), 0), buf352, reinterpret_tensor(buf346, (12, 64, 512), (32768, 1, 64), 0), buf358, buf359, buf363, buf367, buf368, buf369, buf370, buf374, buf378, buf379, buf392, reinterpret_tensor(buf391, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf393, (12, 64, 512), (32768, 1, 64), 0), buf389, reinterpret_tensor(buf383, (12, 64, 512), (32768, 1, 64), 0), buf395, buf396, buf400, buf404, buf405, buf406, buf407, buf411, buf415, buf416, buf429, reinterpret_tensor(buf428, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf430, (12, 64, 512), (32768, 1, 64), 0), buf426, reinterpret_tensor(buf420, (12, 64, 512), (32768, 1, 64), 0), buf432, buf433, buf437, buf441, buf442, buf443, buf444, buf448, buf452, reinterpret_tensor(buf453, (1, 768), (768, 1), 0), buf455, buf457, buf458, reinterpret_tensor(primals_204, (2, 768), (768, 1), 0), reinterpret_tensor(primals_202, (768, 768), (768, 1), 0), buf460, reinterpret_tensor(primals_198, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_196, (3072, 768), (768, 1), 0), buf461, reinterpret_tensor(primals_192, (768, 768), (768, 1), 0), reinterpret_tensor(primals_190, (768, 768), (768, 1), 0), reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), buf462, reinterpret_tensor(primals_182, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_180, (3072, 768), (768, 1), 0), buf463, reinterpret_tensor(primals_176, (768, 768), (768, 1), 0), reinterpret_tensor(primals_174, (768, 768), (768, 1), 0), reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), buf464, reinterpret_tensor(primals_166, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_164, (3072, 768), (768, 1), 0), buf465, reinterpret_tensor(primals_160, (768, 768), (768, 1), 0), reinterpret_tensor(primals_158, (768, 768), (768, 1), 0), reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), buf466, reinterpret_tensor(primals_150, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_148, (3072, 768), (768, 1), 0), buf467, reinterpret_tensor(primals_144, (768, 768), (768, 1), 0), reinterpret_tensor(primals_142, (768, 768), (768, 1), 0), reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), buf468, reinterpret_tensor(primals_134, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_132, (3072, 768), (768, 1), 0), buf469, reinterpret_tensor(primals_128, (768, 768), (768, 1), 0), reinterpret_tensor(primals_126, (768, 768), (768, 1), 0), reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), buf470, reinterpret_tensor(primals_118, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_116, (3072, 768), (768, 1), 0), buf471, reinterpret_tensor(primals_112, (768, 768), (768, 1), 0), reinterpret_tensor(primals_110, (768, 768), (768, 1), 0), reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), buf472, reinterpret_tensor(primals_102, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_100, (3072, 768), (768, 1), 0), buf473, reinterpret_tensor(primals_96, (768, 768), (768, 1), 0), reinterpret_tensor(primals_94, (768, 768), (768, 1), 0), reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), buf474, reinterpret_tensor(primals_86, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_84, (3072, 768), (768, 1), 0), buf475, reinterpret_tensor(primals_80, (768, 768), (768, 1), 0), reinterpret_tensor(primals_78, (768, 768), (768, 1), 0), reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), buf476, reinterpret_tensor(primals_70, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_68, (3072, 768), (768, 1), 0), buf477, reinterpret_tensor(primals_64, (768, 768), (768, 1), 0), reinterpret_tensor(primals_62, (768, 768), (768, 1), 0), reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), buf478, reinterpret_tensor(primals_54, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_52, (3072, 768), (768, 1), 0), buf479, reinterpret_tensor(primals_48, (768, 768), (768, 1), 0), reinterpret_tensor(primals_46, (768, 768), (768, 1), 0), reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), buf480, reinterpret_tensor(primals_38, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_36, (3072, 768), (768, 1), 0), buf481, reinterpret_tensor(primals_32, (768, 768), (768, 1), 0), reinterpret_tensor(primals_30, (768, 768), (768, 1), 0), reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), buf482, reinterpret_tensor(primals_22, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_20, (3072, 768), (768, 1), 0), buf483, reinterpret_tensor(primals_16, (768, 768), (768, 1), 0), reinterpret_tensor(primals_14, (768, 768), (768, 1), 0), reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), buf484, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_204 = rand_strided((2, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_205 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
