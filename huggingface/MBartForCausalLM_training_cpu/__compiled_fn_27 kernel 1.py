...
def call(args):
    ...
    buf4 = reinterpret_tensor(buf1, (1, 1024, 4096), (4194304, 4096, 1), 0); del buf1  # reuse
    ...
    del addmm_4
    buf5 = reinterpret_tensor(buf0, (1024, 1024), (1024, 1), 0); del buf0  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf4, (1024, 4096), (4096, 1), 0), permute_15, out=buf5)
    del permute_15
    buf6 = empty((4096, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf4, (4096, 1024), (1, 4096), 0), view_18, out=buf6)
    del view_18
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf13, (1024, 1024), (1024, 1), 0), permute_19, out=buf14)
    del permute_19
    buf15 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf13, (1024, 1024), (1, 1024), 0), view_16, out=buf15)
    del view_16
    buf16 = reinterpret_tensor(buf9, (1, 1024), (1024, 1), 0); del buf9  # reuse
    cpp_fused_sum_3(c_void_p(buf13.data_ptr()), c_void_p(buf16.data_ptr()))
    buf17 = reinterpret_tensor(buf13, (16, 1024, 64), (65536, 64, 1), 0); del buf13  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_24, reinterpret_tensor(buf14, (16, 1024, 64), (64, 1024, 1), 0), out=buf17)
    del permute_24
    buf18 = empty((16, 1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf14, (16, 1024, 64), (64, 1024, 1), 0), permute_25, out=buf18)
    del permute_25
    buf19 = empty_strided((16, 1024, 1), (1024, 1, 16384), device='cpu', dtype=torch.float32)
    buf20 = buf18; del buf18  # reuse
    cpp_fused__softmax_backward_data_4(c_void_p(buf20.data_ptr()), c_void_p(alias_1.data_ptr()), c_void_p(buf19.data_ptr()))
    del alias_1
    del buf19
    buf21 = reinterpret_tensor(buf14, (16, 64, 1024), (65536, 1024, 1), 0); del buf14  # reuse
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(permute_26, reinterpret_tensor(buf20, (16, 1024, 1024), (1048576, 1024, 1), 0), out=buf21)
    del permute_26
    buf22 = empty((16, 1024, 64), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.bmm]
    extern_kernels.bmm(reinterpret_tensor(buf20, (16, 1024, 1024), (1048576, 1024, 1), 0), permute_27, out=buf22)
    del buf20
    del permute_27
    buf23 = empty((1, 1024, 16, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_5(c_void_p(tangents_3.data_ptr()), c_void_p(buf17.data_ptr()), c_void_p(buf23.data_ptr()))
    del tangents_3
    buf24 = reinterpret_tensor(buf17, (1024, 1024), (1024, 1), 0); del buf17  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf23, (1024, 1024), (1024, 1), 0), permute_31, out=buf24)
    del permute_31
    buf25 = empty((1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf23, (1024, 1024), (1, 1024), 0), view, out=buf25)
    buf26 = reinterpret_tensor(buf8, (1, 1024), (1024, 1), 0); del buf8  # reuse
    buf27 = empty((1, 1024, 16, 64), device='cpu', dtype=torch.float32)
    ...
    del tangents_2
    buf28 = reinterpret_tensor(buf23, (1024, 1024), (1024, 1), 0); del buf23  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (1024, 1024), (1024, 1), 0), permute_36, out=buf28)
    del permute_36
    buf29 = reinterpret_tensor(buf21, (1024, 1024), (1024, 1), 0); del buf21  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf27, (1024, 1024), (1, 1024), 0), view, out=buf29)
    ...
    buf32 = reinterpret_tensor(buf27, (1024, 1024), (1024, 1), 0); del buf27  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
