...
cpp_fused__log_softmax_add_embedding_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_38 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_0(c_void_p(primals_108.data_ptr()), c_void_p(primals_1.data_ptr()), c_void_p(primals_107.data_ptr()), c_void_p(primals_2.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()), c_void_p(buf4.data_ptr()))
    del primals_1
    del primals_2
    del primals_4
    ...
    buf226 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_1(c_void_p(buf8.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf226.data_ptr()))
    ...
    buf223 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_7(c_void_p(buf40.data_ptr()), c_void_p(buf43.data_ptr()), c_void_p(buf223.data_ptr()))
    ...
    buf220 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_13(c_void_p(buf71.data_ptr()), c_void_p(buf74.data_ptr()), c_void_p(buf220.data_ptr()))
    ...
    buf217 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_19(c_void_p(buf102.data_ptr()), c_void_p(buf105.data_ptr()), c_void_p(buf217.data_ptr()))
    ...
    buf214 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_25(c_void_p(buf133.data_ptr()), c_void_p(buf136.data_ptr()), c_void_p(buf214.data_ptr()))
    ...
    buf211 = empty_strided((12, 64, 128), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_div_transpose_31(c_void_p(buf164.data_ptr()), c_void_p(buf167.data_ptr()), c_void_p(buf211.data_ptr()))
    ...
    buf194 = empty((128, 768), device='cpu', dtype=torch.float32)
    cpp_fused_add_native_layer_norm_view_36(c_void_p(buf188.data_ptr()), c_void_p(buf182.data_ptr()), c_void_p(primals_93.data_ptr()), c_void_p(primals_94.data_ptr()), c_void_p(primals_99.data_ptr()), c_void_p(primals_100.data_ptr()), c_void_p(buf190.data_ptr()), c_void_p(buf191.data_ptr()), c_void_p(buf193.data_ptr()), c_void_p(buf194.data_ptr()))
    del primals_100
    del primals_94
    buf195 = reinterpret_tensor(buf188, (128, 768), (768, 1), 0); del buf188  # reuse
    # Source Nodes: [prediction_logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_102, buf194, reinterpret_tensor(primals_101, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf195)
    del primals_102
    buf196 = buf190; del buf190  # reuse
    buf197 = empty_strided((1, 128, 1), (128, 1, 128), device='cpu', dtype=torch.float32)
    buf199 = empty((1, 128, 768), device='cpu', dtype=torch.float32)
    buf200 = empty((128, 768), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_native_layer_norm_view_37(c_void_p(buf195.data_ptr()), c_void_p(primals_103.data_ptr()), c_void_p(primals_104.data_ptr()), c_void_p(buf196.data_ptr()), c_void_p(buf197.data_ptr()), c_void_p(buf199.data_ptr()), c_void_p(buf200.data_ptr()))
    del primals_104
    buf201 = empty((128, 30522), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_logits_3], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_106, buf200, reinterpret_tensor(primals_105, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf201)
    del primals_106
    buf202 = reinterpret_tensor(buf196, (128, 1), (1, 128), 0); del buf196  # reuse
    buf203 = empty_strided((128, 1), (1, 128), device='cpu', dtype=torch.float32)
    buf204 = empty((128, 30522), device='cpu', dtype=torch.float32)
    buf205 = empty((), device='cpu', dtype=torch.int64)
    buf207 = empty((), device='cpu', dtype=torch.float32)
    buf206 = empty((), device='cpu', dtype=torch.float32)
    buf228 = buf207; del buf207  # reuse
    buf208 = reinterpret_tensor(buf197, (1, 128, 1), (128, 1, 1), 0); del buf197  # reuse
    buf209 = reinterpret_tensor(buf191, (1, 128, 1), (128, 1, 1), 0); del buf191  # reuse
    buf210 = reinterpret_tensor(buf180, (1, 128, 1), (128, 1, 1), 0); del buf180  # reuse
    buf212 = reinterpret_tensor(buf160, (1, 128, 1), (128, 1, 1), 0); del buf160  # reuse
    buf213 = reinterpret_tensor(buf149, (1, 128, 1), (128, 1, 1), 0); del buf149  # reuse
    buf215 = reinterpret_tensor(buf129, (1, 128, 1), (128, 1, 1), 0); del buf129  # reuse
    buf216 = reinterpret_tensor(buf118, (1, 128, 1), (128, 1, 1), 0); del buf118  # reuse
    buf218 = reinterpret_tensor(buf98, (1, 128, 1), (128, 1, 1), 0); del buf98  # reuse
    buf219 = reinterpret_tensor(buf87, (1, 128, 1), (128, 1, 1), 0); del buf87  # reuse
    buf221 = reinterpret_tensor(buf67, (1, 128, 1), (128, 1, 1), 0); del buf67  # reuse
    buf222 = reinterpret_tensor(buf56, (1, 128, 1), (128, 1, 1), 0); del buf56  # reuse
    buf224 = reinterpret_tensor(buf36, (1, 128, 1), (128, 1, 1), 0); del buf36  # reuse
    buf225 = reinterpret_tensor(buf25, (1, 128, 1), (128, 1, 1), 0); del buf25  # reuse
    buf227 = reinterpret_tensor(buf1, (1, 128, 1), (128, 1, 1), 0); del buf1  # reuse
    cpp_fused__log_softmax_add_embedding_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_38(c_void_p(buf228.data_ptr()), c_void_p(buf208.data_ptr()), c_void_p(buf209.data_ptr()), c_void_p(buf210.data_ptr()), c_void_p(buf212.data_ptr()), c_void_p(buf213.data_ptr()), c_void_p(buf215.data_ptr()), c_void_p(buf216.data_ptr()), c_void_p(buf218.data_ptr()), c_void_p(buf219.data_ptr()), c_void_p(buf221.data_ptr()), c_void_p(buf222.data_ptr()), c_void_p(buf224.data_ptr()), c_void_p(buf225.data_ptr()), c_void_p(buf227.data_ptr()), c_void_p(buf201.data_ptr()), c_void_p(primals_109.data_ptr()), c_void_p(buf202.data_ptr()), c_void_p(buf203.data_ptr()), c_void_p(buf204.data_ptr()), c_void_p(buf205.data_ptr()), c_void_p(buf206.data_ptr()))
    return (buf228, reinterpret_tensor(buf201, (1, 128, 30522), (3906816, 30522, 1), 0), primals_3, primals_13, primals_19, primals_29, primals_35, primals_45, primals_51, primals_61, primals_67, primals_77, primals_83, primals_93, primals_99, primals_103, primals_108, primals_109, reinterpret_tensor(primals_107, (1, 128), (512, 1), 0), buf3, buf7, reinterpret_tensor(buf6, (128, 768), (768, 1), 0), buf13, buf20, buf22, buf27, buf28, buf29, buf30, buf34, buf38, buf39, buf51, buf53, buf58, buf59, buf60, buf61, buf65, buf69, buf70, buf82, buf84, buf89, buf90, buf91, buf92, buf96, buf100, buf101, buf113, buf115, buf120, buf121, buf122, buf123, buf127, buf131, buf132, buf144, buf146, buf151, buf152, buf153, buf154, buf158, buf162, buf163, buf175, buf177, buf182, buf183, buf184, buf185, buf189, buf193, buf194, buf195, buf199, buf200, buf204, buf206, reinterpret_tensor(primals_105, (30522, 768), (768, 1), 0), buf208, reinterpret_tensor(primals_101, (768, 768), (768, 1), 0), buf209, reinterpret_tensor(primals_97, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_95, (3072, 768), (768, 1), 0), buf210, reinterpret_tensor(primals_91, (768, 768), (768, 1), 0), reinterpret_tensor(buf174, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf166, (12, 64, 128), (64, 1, 768), 0), buf172, buf211, reinterpret_tensor(buf165, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_89, (768, 768), (768, 1), 0), reinterpret_tensor(primals_87, (768, 768), (768, 1), 0), reinterpret_tensor(primals_85, (768, 768), (768, 1), 0), buf212, reinterpret_tensor(primals_81, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_79, (3072, 768), (768, 1), 0), buf213, reinterpret_tensor(primals_75, (768, 768), (768, 1), 0), reinterpret_tensor(buf143, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf135, (12, 64, 128), (64, 1, 768), 0), buf141, buf214, reinterpret_tensor(buf134, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_73, (768, 768), (768, 1), 0), reinterpret_tensor(primals_71, (768, 768), (768, 1), 0), reinterpret_tensor(primals_69, (768, 768), (768, 1), 0), buf215, reinterpret_tensor(primals_65, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_63, (3072, 768), (768, 1), 0), buf216, reinterpret_tensor(primals_59, (768, 768), (768, 1), 0), reinterpret_tensor(buf112, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf104, (12, 64, 128), (64, 1, 768), 0), buf110, buf217, reinterpret_tensor(buf103, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_57, (768, 768), (768, 1), 0), reinterpret_tensor(primals_55, (768, 768), (768, 1), 0), reinterpret_tensor(primals_53, (768, 768), (768, 1), 0), buf218, reinterpret_tensor(primals_49, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_47, (3072, 768), (768, 1), 0), buf219, reinterpret_tensor(primals_43, (768, 768), (768, 1), 0), reinterpret_tensor(buf81, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf73, (12, 64, 128), (64, 1, 768), 0), buf79, buf220, reinterpret_tensor(buf72, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_41, (768, 768), (768, 1), 0), reinterpret_tensor(primals_39, (768, 768), (768, 1), 0), reinterpret_tensor(primals_37, (768, 768), (768, 1), 0), buf221, reinterpret_tensor(primals_33, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_31, (3072, 768), (768, 1), 0), buf222, reinterpret_tensor(primals_27, (768, 768), (768, 1), 0), reinterpret_tensor(buf50, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf42, (12, 64, 128), (64, 1, 768), 0), buf48, buf223, reinterpret_tensor(buf41, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_25, (768, 768), (768, 1), 0), reinterpret_tensor(primals_23, (768, 768), (768, 1), 0), reinterpret_tensor(primals_21, (768, 768), (768, 1), 0), buf224, reinterpret_tensor(primals_17, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_15, (3072, 768), (768, 1), 0), buf225, reinterpret_tensor(primals_11, (768, 768), (768, 1), 0), reinterpret_tensor(buf19, (12, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf10, (12, 64, 128), (64, 1, 768), 0), buf17, buf226, reinterpret_tensor(buf9, (12, 128, 64), (64, 768, 1), 0), reinterpret_tensor(primals_9, (768, 768), (768, 1), 0), reinterpret_tensor(primals_7, (768, 768), (768, 1), 0), reinterpret_tensor(primals_5, (768, 768), (768, 1), 0), buf227, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_105 = rand_strided((30522, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_106 = rand_strided((30522, ), (1, ), device='cpu', dtype=torch.float32)
    primals_107 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
