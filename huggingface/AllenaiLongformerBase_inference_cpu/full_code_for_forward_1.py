...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139880779808000)) \
        and (L['self'].training == False) \
        and (___check_obj_id(L['head_mask'], 7628576)) \
        and (___check_type_id(L['input_ids'], 99675808)) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(139877510356496))) \
        and (___compile_config_hash() == '7ca4fce14eb3e18202d133b5f1a6f755') \
        and (not ___needs_nopython()) \
        and (___check_type_id(G['torch'].long, 139882772260608)) \
