...
def forward(self, primals, tangents):
    primals_1: "f32[50265, 1024]"; primals_2: "f32[1, 128, 1024]"; primals_3: "i64[1, 128]"; tangents_1: "f32[]"; tangents_2: "f32[1, 128, 50265]"; 
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:1698, code: loss = loss_fct(logits.view(-1, self.config.vocab_size), labels.view(-1))
    add: "f32[1, 128, 50265]" = torch.ops.aten.add.Tensor(tangents_2, view_4);  tangents_2 = view_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/pegasus/modeling_pegasus.py:1692, code: logits = self.lm_head(outputs[0])
    view_5: "f32[128, 50265]" = torch.ops.aten.view.default(add, [128, 50265]);  add = None
    ...
    view_6: "f32[1, 128, 1024]" = torch.ops.aten.view.default(mm_2, [1, 128, 1024]);  mm_2 = None
