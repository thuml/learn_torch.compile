...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.mm(reinterpret_tensor(primals_2, (128, 1024), (1024, 1), 0), reinterpret_tensor(primals_1, (1024, 50265), (1, 1024), 0), out=buf0)
        ...
        return (buf9, reinterpret_tensor(buf0, (1, 128, 50265), (6433920, 50265, 1), 0), primals_3, reinterpret_tensor(primals_2, (128, 1024), (1024, 1), 0), buf5, buf7, reinterpret_tensor(primals_1, (50265, 1024), (1024, 1), 0), )
