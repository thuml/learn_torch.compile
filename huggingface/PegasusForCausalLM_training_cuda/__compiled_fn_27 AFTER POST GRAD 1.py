...
def forward(self, primals_1: "f32[1024]", primals_11: "f32[1024]", primals_17: "f32[1, 128, 1024]", getitem_1: "f32[1, 128, 1]", rsqrt: "f32[1, 128, 1]", view: "f32[128, 1024]", view_16: "f32[128, 1024]", getitem_3: "b8[1, 128, 1024]", mul_3: "f32[1, 128, 1024]", view_18: "f32[128, 1024]", addmm_4: "f32[128, 4096]", view_20: "f32[128, 4096]", getitem_7: "b8[1, 128, 1024]", permute_11: "f32[1024, 4096]", permute_15: "f32[4096, 1024]", div_1: "f32[1, 128, 1]", permute_19: "f32[1024, 1024]", permute_24: "f32[16, 128, 128]", permute_25: "f32[16, 64, 128]", alias_1: "f32[16, 128, 128]", permute_26: "f32[16, 64, 128]", permute_27: "f32[16, 128, 64]", permute_31: "f32[1024, 1024]", permute_36: "f32[1024, 1024]", permute_40: "f32[1024, 1024]", tangents_1: "f32[1, 128, 1024]", tangents_2: "f32[1, 16, 128, 64]", tangents_3: "f32[1, 16, 128, 64]"):
    ...
    view_35: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 16, 128, 64]);  bmm_2 = None
    ...
    view_36: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 16, 128, 64]);  permute_28 = None
    ...
    view_37: "f32[1, 16, 128, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 16, 128, 64]);  bmm_5 = None
    ...
    view_38: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_8, [1, 128, 1024]);  clone_8 = None
    ...
    view_39: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 1024]);  clone_9 = None
    ...
    view_42: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 1024]);  mm_6 = None
    ...
    view_43: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(clone_10, [1, 128, 1024]);  clone_10 = None
    ...
    view_44: "f32[128, 1024]" = torch.ops.aten.reshape.default(view_43, [128, 1024]);  view_43 = None
    ...
    view_46: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 1024]);  mm_8 = None
    ...
    view_47: "f32[128, 1024]" = torch.ops.aten.reshape.default(mul_28, [128, 1024]);  mul_28 = None
    ...
    view_49: "f32[1, 128, 1024]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 1024]);  mm_10 = None
