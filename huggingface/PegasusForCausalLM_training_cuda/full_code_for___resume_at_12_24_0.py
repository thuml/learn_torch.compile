...
def __guard_0_for___resume_at_12_24(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 148652736)) \
        ...
        and (len(L['value'][9]) == 2) \
        and (___check_obj_id(L['__class__'], 128100384)) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140554587790864))) \
        and (___compile_config_hash() == '5248f9d0ad365fad2036231e135896ce') \
