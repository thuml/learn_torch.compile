...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [loss], Original ATen: [aten._log_softmax_backward_data, aten.nll_loss_backward, aten.nll_loss_forward]
        triton_red_fused__log_softmax_backward_data_nll_loss_backward_nll_loss_forward_2.run(buf0, primals_3, tangents_1, convert_element_type, buf4, 896, 7181, grid=grid(896), stream=stream0)
        ...
        # Source Nodes: [], Original ATen: [aten.add]
        triton_poi_fused_add_4.run(buf6, tangents_2, buf0, primals_3, tangents_1, convert_element_type, sub_1, buf5, 6433920, grid=grid(6433920), stream=stream0)
        del buf0
        del buf5
        ...
        del tangents_1
        del tangents_2
        buf7 = empty((50265, 1024), device='cuda', dtype=torch.float32)
        ...
        del buf6
        del permute_3
        return (reinterpret_tensor(buf7, (50265, 1024), (1024, 1), 0), reinterpret_tensor(buf8, (1, 128, 1024), (131072, 1024, 1), 0), None, )
