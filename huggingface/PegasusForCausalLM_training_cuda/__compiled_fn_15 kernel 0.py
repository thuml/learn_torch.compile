...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [attn_probs, attn_weights_3], Original ATen: [aten._softmax, aten.clone, aten.detach]
        triton_per_fused__softmax_clone_detach_3.run(buf11, primals_18, buf14, buf34, 2048, 128, grid=grid(2048), stream=stream0)
        del buf11
        del primals_18
        buf15 = reinterpret_tensor(buf5, (16, 128, 64), (8192, 64, 1), 0); del buf5  # reuse
