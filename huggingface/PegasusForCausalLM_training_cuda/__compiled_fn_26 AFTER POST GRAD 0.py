...
def forward(self, primals_1: "f32[50265, 1024]", primals_2: "f32[1, 128, 1024]", primals_3: "i64[1, 128]"):
    ...
    view_2: "f32[128, 50265]" = torch.ops.aten.reshape.default(view_1, [-1, 50265])
    view_3: "i64[128]" = torch.ops.aten.reshape.default(primals_3, [-1])
