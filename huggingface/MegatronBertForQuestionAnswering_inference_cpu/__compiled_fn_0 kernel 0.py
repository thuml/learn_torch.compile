...
cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_97 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const long* in_ptr1,
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_zeros_0(c_void_p(arg392_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg391_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(arg4_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf2.data_ptr()), c_void_p(buf4.data_ptr()))
    del arg0_1
    del arg1_1
    del arg2_1
    del arg391_1
    ...
    del buf628
    del buf636
    buf641 = empty((512, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg390_1, reinterpret_tensor(buf640, (512, 1024), (1024, 1), 0), reinterpret_tensor(arg389_1, (1024, 2), (1, 1024), 0), alpha=1, beta=1, out=buf641)
    del arg389_1
    del arg390_1
    del buf640
    buf642 = reinterpret_tensor(buf638, (1, 512), (512, 1), 0); del buf638  # reuse
    buf643 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf644 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf645 = reinterpret_tensor(buf637, (1, 512), (512, 1), 0); del buf637  # reuse
    buf646 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf647 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf648 = reinterpret_tensor(buf643, (), (), 0); del buf643  # reuse
    buf649 = buf648; del buf648  # reuse
    cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_97(c_void_p(buf649.data_ptr()), c_void_p(buf641.data_ptr()), c_void_p(arg393_1.data_ptr()), c_void_p(arg394_1.data_ptr()), c_void_p(buf642.data_ptr()), c_void_p(buf644.data_ptr()), c_void_p(buf645.data_ptr()), c_void_p(buf646.data_ptr()), c_void_p(buf647.data_ptr()))
    del arg393_1
    del arg394_1
    return (buf649, buf642, buf645, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg389_1 = rand_strided((2, 1024), (1024, 1), device='cpu', dtype=torch.float32)
    arg390_1 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
    arg391_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg392_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg393_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
    arg394_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
