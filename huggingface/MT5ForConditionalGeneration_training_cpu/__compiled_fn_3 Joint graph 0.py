...
def forward(self, primals, tangents):
    ...
    full_7: "f32[128, 250112]" = torch.ops.aten.full.default([128, 250112], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_9: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_10: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_11: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_12: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_13: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_14: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_15: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_16: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_17: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_18: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_19: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_20: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_21: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_22: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_23: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_24: "f32[32, 6]" = torch.ops.aten.full.default([32, 6], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_25: "f32[250112, 512]" = torch.ops.aten.full.default([250112, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_26: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_27: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_28: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_29: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_30: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_31: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_32: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_33: "f32[98304]" = torch.ops.aten.full.default([98304], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_34: "f32[32, 6]" = torch.ops.aten.full.default([32, 6], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    ...
    full_35: "f32[250112, 512]" = torch.ops.aten.full.default([250112, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
