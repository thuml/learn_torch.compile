...
def forward(self, L_inputs_input_ids_ : torch.Tensor, L_inputs_labels_ : torch.Tensor):
    ...
    token_type_ids = torch.zeros((1, 128), dtype = torch.int64, device = device(type='cuda', index=0))
    ...
    inputs_embeds = self.L__mod___mobilebert_embeddings_word_embeddings(l_inputs_input_ids_);  l_inputs_input_ids_ = None
    ...
    hidden_states_216 = self.L__mod___cls_predictions_transform_dense(sequence_output);  sequence_output = None
    ...
    hidden_states_217 = self.L__mod___cls_predictions_transform_transform_act_fn(hidden_states_216);  hidden_states_216 = None
    ...
    hidden_states_219 = self.L__mod___cls_predictions_transform_LayerNorm(hidden_states_217);  hidden_states_217 = None
    ...
    l__mod___mobilebert_embeddings_word_embeddings_weight_1 = self.L__mod___mobilebert_embeddings_word_embeddings_weight
    t_1 = l__mod___mobilebert_embeddings_word_embeddings_weight_1.t();  l__mod___mobilebert_embeddings_word_embeddings_weight_1 = None
    l__mod___cls_predictions_dense_weight = self.L__mod___cls_predictions_dense_weight
    cat_1 = torch.cat([t_1, l__mod___cls_predictions_dense_weight], dim = 0);  t_1 = l__mod___cls_predictions_dense_weight = None
    hidden_states_220 = hidden_states_219.matmul(cat_1);  hidden_states_219 = cat_1 = None
    ...
    l__mod___cls_predictions_decoder_bias = self.L__mod___cls_predictions_decoder_bias
    hidden_states_220 += l__mod___cls_predictions_decoder_bias;  prediction_scores = hidden_states_220;  hidden_states_220 = l__mod___cls_predictions_decoder_bias = None
    ...
    view_96 = prediction_scores.view(-1, 30522)
    view_97 = l_inputs_labels_.view(-1);  l_inputs_labels_ = None
    masked_lm_loss = torch.nn.functional.cross_entropy(view_96, view_97, None, None, -100, None, 'mean', 0.0);  view_96 = view_97 = None
