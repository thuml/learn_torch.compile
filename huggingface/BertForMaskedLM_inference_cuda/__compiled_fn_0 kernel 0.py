...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_0.run(arg205_1, arg0_1, arg203_1, arg1_1, arg204_1, arg2_1, arg3_1, arg4_1, buf0, buf4, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg1_1
        del arg203_1
        del arg204_1
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf280, (512, 768), (768, 1), 0), reinterpret_tensor(arg197_1, (768, 768), (1, 768), 0), out=buf281)
        del arg197_1
        buf285 = buf280; del buf280  # reuse
        # Source Nodes: [hidden_states_109, hidden_states_111], Original ATen: [aten.gelu, aten.native_layer_norm]
        triton_per_fused_gelu_native_layer_norm_4.run(buf281, arg198_1, arg199_1, arg200_1, buf285, 512, 768, grid=grid(512), stream=stream0)
        del arg198_1
        del arg199_1
        del arg200_1
        del buf281
        ...
        extern_kernels.addmm(arg202_1, reinterpret_tensor(buf285, (512, 768), (768, 1), 0), reinterpret_tensor(arg201_1, (768, 30522), (1, 768), 0), alpha=1, beta=1, out=buf286)
        del arg201_1
        del arg202_1
        del buf285
        ...
        # Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_6.run(buf291, arg206_1, buf286, buf287, buf288, 1, 512, grid=grid(1), stream=stream0)
        del arg206_1
