...
# kernel path: /tmp/torchinductor_youkaichao/bp/cbpbupsptdrnhxbczb7nlc5fzx3x67hmj5f2mqpamtxkgc7z2tr2.py
# Source Nodes: [hidden_states_184, hidden_states_186, prediction_scores], Original ATen: [aten.gelu, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
# hidden_states_184 => add_111, erf_12, mul_112, mul_113, mul_114
# hidden_states_186 => add_112, add_113, mul_115, mul_116, rsqrt, sub_99, var_mean
# prediction_scores => view_218
triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_12 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_12', 'mutated_arg_names': []}
)
@triton.jit
...
# kernel path: /tmp/torchinductor_youkaichao/of/cofxfbe72taf6b6t5ii5aqrbmvu3evax7tj6b2fntvq2eoifj3eb.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
# loss => amax_12, exp_12, log, sub_100, sub_101, sum_13
...
# kernel path: /tmp/torchinductor_youkaichao/oz/cozutgbz36gsvevrqv6ajarfxfzdj6ugifcusip6ynmxq6hchqkc.py
# Source Nodes: [loss, query_states], Original ATen: [aten.masked_fill, aten.nll_loss_forward]
# loss => convert_element_type_49, div_49, ne, neg, sum_14, sum_15, where_62
# query_states => full_default_1
triton_per_fused_masked_fill_nll_loss_forward_14 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_masked_fill_nll_loss_forward_14', 'mutated_arg_names': ['in_out_ptr0']}
)
@triton.jit
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [add, embeddings, embeddings_1, embeddings_3, hidden_states_1, mean, mul, position_embeddings, pow_1, query_states, sqrt, sub, variance], Original ATen: [aten._to_copy, aten.add, aten.div, aten.embedding, aten.masked_fill, aten.mean, aten.mul, aten.pow, aten.rsub, aten.sqrt, aten.sub]
        triton_red_fused__to_copy_add_div_embedding_masked_fill_mean_mul_pow_rsub_sqrt_sub_1.run(buf3, primals_168, primals_75, primals_167, primals_76, buf5, primals_1, primals_2, buf1, buf8, buf9, 512, 768, grid=grid(512), stream=stream0)
        del primals_2
        del primals_75
        del primals_76
        ...
        buf503 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [query_layer_1, query_layer_2, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf10, primals_3, buf11, buf503, 393216, grid=grid(393216), stream=stream0)
        del primals_3
        ...
        buf502 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [attention_probs, attention_probs_1, query_states], Original ATen: [aten._softmax, aten._to_copy, aten.bitwise_not, aten.detach, aten.lift_fresh, aten.masked_fill, aten.mul, aten.rsub]
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf12, buf16, buf19, buf20, buf502, 6144, 512, grid=grid(6144), stream=stream0)
        buf21 = buf11; del buf11  # reuse
        buf501 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_1], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf10, primals_4, buf21, buf501, 393216, grid=grid(393216), stream=stream0)
        del primals_4
        ...
        buf500 = reinterpret_tensor(buf37, (12, 64, 512), (64, 1, 768), 0); del buf37  # reuse
        # Source Nodes: [query_layer_4, query_layer_5, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf47, primals_9, buf48, buf500, 393216, grid=grid(393216), stream=stream0)
        del primals_9
        ...
        buf499 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf49, buf52, buf55, buf56, buf499, 6144, 512, grid=grid(6144), stream=stream0)
        buf57 = buf48; del buf48  # reuse
        buf498 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_3], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf47, primals_10, buf57, buf498, 393216, grid=grid(393216), stream=stream0)
        del primals_10
        ...
        buf497 = reinterpret_tensor(buf74, (12, 64, 512), (64, 1, 768), 0); del buf74  # reuse
        # Source Nodes: [query_layer_7, query_layer_8, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf84, primals_15, buf85, buf497, 393216, grid=grid(393216), stream=stream0)
        del primals_15
        ...
        buf496 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf86, buf89, buf92, buf93, buf496, 6144, 512, grid=grid(6144), stream=stream0)
        buf94 = buf85; del buf85  # reuse
        buf495 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_5], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf84, primals_16, buf94, buf495, 393216, grid=grid(393216), stream=stream0)
        del primals_16
        ...
        buf494 = reinterpret_tensor(buf111, (12, 64, 512), (64, 1, 768), 0); del buf111  # reuse
        # Source Nodes: [query_layer_10, query_layer_11, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf121, primals_21, buf122, buf494, 393216, grid=grid(393216), stream=stream0)
        del primals_21
        ...
        buf493 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf123, buf126, buf129, buf130, buf493, 6144, 512, grid=grid(6144), stream=stream0)
        buf131 = buf122; del buf122  # reuse
        buf492 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_7], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf121, primals_22, buf131, buf492, 393216, grid=grid(393216), stream=stream0)
        del primals_22
        ...
        buf491 = reinterpret_tensor(buf148, (12, 64, 512), (64, 1, 768), 0); del buf148  # reuse
        # Source Nodes: [query_layer_13, query_layer_14, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf158, primals_27, buf159, buf491, 393216, grid=grid(393216), stream=stream0)
        del primals_27
        ...
        buf490 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf160, buf163, buf166, buf167, buf490, 6144, 512, grid=grid(6144), stream=stream0)
        buf168 = buf159; del buf159  # reuse
        buf489 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_9], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf158, primals_28, buf168, buf489, 393216, grid=grid(393216), stream=stream0)
        del primals_28
        ...
        buf488 = reinterpret_tensor(buf185, (12, 64, 512), (64, 1, 768), 0); del buf185  # reuse
        # Source Nodes: [query_layer_16, query_layer_17, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf195, primals_33, buf196, buf488, 393216, grid=grid(393216), stream=stream0)
        del primals_33
        ...
        buf487 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf197, buf200, buf203, buf204, buf487, 6144, 512, grid=grid(6144), stream=stream0)
        buf205 = buf196; del buf196  # reuse
        buf486 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_11], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf195, primals_34, buf205, buf486, 393216, grid=grid(393216), stream=stream0)
        del primals_34
        ...
        buf485 = reinterpret_tensor(buf222, (12, 64, 512), (64, 1, 768), 0); del buf222  # reuse
        # Source Nodes: [query_layer_19, query_layer_20, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf232, primals_39, buf233, buf485, 393216, grid=grid(393216), stream=stream0)
        del primals_39
        ...
        buf484 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf234, buf237, buf240, buf241, buf484, 6144, 512, grid=grid(6144), stream=stream0)
        buf242 = buf233; del buf233  # reuse
        buf483 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_13], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf232, primals_40, buf242, buf483, 393216, grid=grid(393216), stream=stream0)
        del primals_40
        ...
        buf482 = reinterpret_tensor(buf259, (12, 64, 512), (64, 1, 768), 0); del buf259  # reuse
        # Source Nodes: [query_layer_22, query_layer_23, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf269, primals_45, buf270, buf482, 393216, grid=grid(393216), stream=stream0)
        del primals_45
        ...
        buf481 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf271, buf274, buf277, buf278, buf481, 6144, 512, grid=grid(6144), stream=stream0)
        buf279 = buf270; del buf270  # reuse
        buf480 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_15], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf269, primals_46, buf279, buf480, 393216, grid=grid(393216), stream=stream0)
        del primals_46
        ...
        buf479 = reinterpret_tensor(buf296, (12, 64, 512), (64, 1, 768), 0); del buf296  # reuse
        # Source Nodes: [query_layer_25, query_layer_26, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf306, primals_51, buf307, buf479, 393216, grid=grid(393216), stream=stream0)
        del primals_51
        ...
        buf478 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf308, buf311, buf314, buf315, buf478, 6144, 512, grid=grid(6144), stream=stream0)
        buf316 = buf307; del buf307  # reuse
        buf477 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_17], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf306, primals_52, buf316, buf477, 393216, grid=grid(393216), stream=stream0)
        del primals_52
        ...
        buf476 = reinterpret_tensor(buf333, (12, 64, 512), (64, 1, 768), 0); del buf333  # reuse
        # Source Nodes: [query_layer_28, query_layer_29, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf343, primals_57, buf344, buf476, 393216, grid=grid(393216), stream=stream0)
        del primals_57
        ...
        buf475 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf345, buf348, buf351, buf352, buf475, 6144, 512, grid=grid(6144), stream=stream0)
        buf353 = buf344; del buf344  # reuse
        buf474 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_19], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf343, primals_58, buf353, buf474, 393216, grid=grid(393216), stream=stream0)
        del primals_58
        ...
        buf473 = reinterpret_tensor(buf370, (12, 64, 512), (64, 1, 768), 0); del buf370  # reuse
        # Source Nodes: [query_layer_31, query_layer_32, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf380, primals_63, buf381, buf473, 393216, grid=grid(393216), stream=stream0)
        del primals_63
        ...
        buf472 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf382, buf385, buf388, buf389, buf472, 6144, 512, grid=grid(6144), stream=stream0)
        buf390 = buf381; del buf381  # reuse
        buf471 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_21], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf380, primals_64, buf390, buf471, 393216, grid=grid(393216), stream=stream0)
        del primals_64
        ...
        buf470 = reinterpret_tensor(buf407, (12, 64, 512), (64, 1, 768), 0); del buf407  # reuse
        # Source Nodes: [query_layer_34, query_layer_35, scale], Original ATen: [aten.add, aten.div, aten.sqrt, aten.transpose]
        triton_poi_fused_add_div_sqrt_transpose_2.run(buf417, primals_69, buf418, buf470, 393216, grid=grid(393216), stream=stream0)
        del primals_69
        ...
        buf469 = empty((1, 12, 512, 512), device='cuda', dtype=torch.float32)
        ...
        triton_per_fused__softmax__to_copy_bitwise_not_detach_lift_fresh_masked_fill_mul_rsub_4.run(buf419, buf422, buf425, buf426, buf469, 6144, 512, grid=grid(6144), stream=stream0)
        del buf419
        del buf422
        buf427 = buf418; del buf418  # reuse
        buf468 = empty_strided((12, 64, 512), (64, 1, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [value_layer_23], Original ATen: [aten.add, aten.transpose]
        triton_poi_fused_add_transpose_5.run(buf417, primals_70, buf427, buf468, 393216, grid=grid(393216), stream=stream0)
        del primals_70
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_165 = rand_strided((50265, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_166 = rand_strided((50265, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_167 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
