...
def forward(self, arg0_1: "f32[1026, 256]", arg1_1: "f32[10000, 256]", arg2_1: "f32[256, 256]", arg3_1: "f32[256]", arg4_1: "f32[256, 256]", arg5_1: "f32[256]", arg6_1: "f32[256, 256]", arg7_1: "f32[256]", arg8_1: "f32[256, 256]", arg9_1: "f32[256]", arg10_1: "f32[256]", arg11_1: "f32[256]", arg12_1: "f32[2048, 256]", arg13_1: "f32[2048]", arg14_1: "f32[256, 2048]", arg15_1: "f32[256]", arg16_1: "f32[256]", arg17_1: "f32[256]", arg18_1: "f32[256, 256]", arg19_1: "f32[256]", arg20_1: "f32[256, 256]", arg21_1: "f32[256]", arg22_1: "f32[256, 256]", arg23_1: "f32[256]", arg24_1: "f32[256, 256]", arg25_1: "f32[256]", arg26_1: "f32[256]", arg27_1: "f32[256]", arg28_1: "f32[2048, 256]", arg29_1: "f32[2048]", arg30_1: "f32[256, 2048]", arg31_1: "f32[256]", arg32_1: "f32[256]", arg33_1: "f32[256]", arg34_1: "f32[256, 256]", arg35_1: "f32[256]", arg36_1: "f32[256, 256]", arg37_1: "f32[256]", arg38_1: "f32[256, 256]", arg39_1: "f32[256]", arg40_1: "f32[256, 256]", arg41_1: "f32[256]", arg42_1: "f32[256]", arg43_1: "f32[256]", arg44_1: "f32[2048, 256]", arg45_1: "f32[2048]", arg46_1: "f32[256, 2048]", arg47_1: "f32[256]", arg48_1: "f32[256]", arg49_1: "f32[256]", arg50_1: "f32[256, 256]", arg51_1: "f32[256]", arg52_1: "f32[256, 256]", arg53_1: "f32[256]", arg54_1: "f32[256, 256]", arg55_1: "f32[256]", arg56_1: "f32[256, 256]", arg57_1: "f32[256]", arg58_1: "f32[256]", arg59_1: "f32[256]", arg60_1: "f32[2048, 256]", arg61_1: "f32[2048]", arg62_1: "f32[256, 2048]", arg63_1: "f32[256]", arg64_1: "f32[256]", arg65_1: "f32[256]", arg66_1: "f32[256, 256]", arg67_1: "f32[256]", arg68_1: "f32[256, 256]", arg69_1: "f32[256]", arg70_1: "f32[256, 256]", arg71_1: "f32[256]", arg72_1: "f32[256, 256]", arg73_1: "f32[256]", arg74_1: "f32[256]", arg75_1: "f32[256]", arg76_1: "f32[2048, 256]", arg77_1: "f32[2048]", arg78_1: "f32[256, 2048]", arg79_1: "f32[256]", arg80_1: "f32[256]", arg81_1: "f32[256]", arg82_1: "f32[256, 256]", arg83_1: "f32[256]", arg84_1: "f32[256, 256]", arg85_1: "f32[256]", arg86_1: "f32[256, 256]", arg87_1: "f32[256]", arg88_1: "f32[256, 256]", arg89_1: "f32[256]", arg90_1: "f32[256]", arg91_1: "f32[256]", arg92_1: "f32[2048, 256]", arg93_1: "f32[2048]", arg94_1: "f32[256, 2048]", arg95_1: "f32[256]", arg96_1: "f32[256]", arg97_1: "f32[256]", arg98_1: "f32[10000, 256]", arg99_1: "i64[1, 128]", arg100_1: "i64[1, 128]"):
    ...
    mm_default_35: "f32[128, 256]" = torch.ops.aten.mm.default(view_4, permute);  view_4 = permute = None
    add_tensor_35: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_35, arg3_1);  mm_default_35 = arg3_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_5: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_35, [1, 128, 256]);  add_tensor_35 = None
    ...
    # No stacktrace found for following nodes
    mm_default_34: "f32[128, 256]" = torch.ops.aten.mm.default(view_6, permute_1);  view_6 = permute_1 = None
    add_tensor_34: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_34, arg5_1);  mm_default_34 = arg5_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_7: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_34, [1, 128, 256]);  add_tensor_34 = None
    ...
    # No stacktrace found for following nodes
    mm_default_33: "f32[128, 256]" = torch.ops.aten.mm.default(view_9, permute_3);  view_9 = permute_3 = None
    add_tensor_33: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_33, arg7_1);  mm_default_33 = arg7_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_10: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_33, [1, 128, 256]);  add_tensor_33 = None
    ...
    # No stacktrace found for following nodes
    mm_default_32: "f32[128, 256]" = torch.ops.aten.mm.default(view_20, permute_8);  view_20 = permute_8 = None
    add_tensor_32: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_32, arg9_1);  mm_default_32 = arg9_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_21: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_32, [1, 128, 256]);  add_tensor_32 = None
    ...
    # No stacktrace found for following nodes
    mm_default_31: "f32[128, 2048]" = torch.ops.aten.mm.default(view_22, permute_9);  view_22 = permute_9 = None
    add_tensor_31: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_31, arg13_1);  mm_default_31 = arg13_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_31, [1, 128, 2048]);  add_tensor_31 = None
    ...
    # No stacktrace found for following nodes
    mm_default_30: "f32[128, 256]" = torch.ops.aten.mm.default(view_24, permute_10);  view_24 = permute_10 = None
    add_tensor_30: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_30, arg15_1);  mm_default_30 = arg15_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_25: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_30, [1, 128, 256]);  add_tensor_30 = None
    ...
    # No stacktrace found for following nodes
    mm_default_29: "f32[128, 256]" = torch.ops.aten.mm.default(view_26, permute_11);  view_26 = permute_11 = None
    add_tensor_29: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_29, arg19_1);  mm_default_29 = arg19_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_27: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_29, [1, 128, 256]);  add_tensor_29 = None
    ...
    # No stacktrace found for following nodes
    mm_default_28: "f32[128, 256]" = torch.ops.aten.mm.default(view_28, permute_12);  view_28 = permute_12 = None
    add_tensor_28: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_28, arg21_1);  mm_default_28 = arg21_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_29: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_28, [1, 128, 256]);  add_tensor_28 = None
    ...
    # No stacktrace found for following nodes
    mm_default_27: "f32[128, 256]" = torch.ops.aten.mm.default(view_31, permute_14);  view_31 = permute_14 = None
    add_tensor_27: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_27, arg23_1);  mm_default_27 = arg23_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_32: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_27, [1, 128, 256]);  add_tensor_27 = None
    ...
    # No stacktrace found for following nodes
    mm_default_26: "f32[128, 256]" = torch.ops.aten.mm.default(view_42, permute_19);  view_42 = permute_19 = None
    add_tensor_26: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_26, arg25_1);  mm_default_26 = arg25_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_43: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_26, [1, 128, 256]);  add_tensor_26 = None
    ...
    # No stacktrace found for following nodes
    mm_default_25: "f32[128, 2048]" = torch.ops.aten.mm.default(view_44, permute_20);  view_44 = permute_20 = None
    add_tensor_25: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_25, arg29_1);  mm_default_25 = arg29_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_45: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_25, [1, 128, 2048]);  add_tensor_25 = None
    ...
    # No stacktrace found for following nodes
    mm_default_24: "f32[128, 256]" = torch.ops.aten.mm.default(view_46, permute_21);  view_46 = permute_21 = None
    add_tensor_24: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_24, arg31_1);  mm_default_24 = arg31_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_47: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_24, [1, 128, 256]);  add_tensor_24 = None
    ...
    # No stacktrace found for following nodes
    mm_default_23: "f32[128, 256]" = torch.ops.aten.mm.default(view_48, permute_22);  view_48 = permute_22 = None
    add_tensor_23: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_23, arg35_1);  mm_default_23 = arg35_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_49: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_23, [1, 128, 256]);  add_tensor_23 = None
    ...
    # No stacktrace found for following nodes
    mm_default_22: "f32[128, 256]" = torch.ops.aten.mm.default(view_50, permute_23);  view_50 = permute_23 = None
    add_tensor_22: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_22, arg37_1);  mm_default_22 = arg37_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_51: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_22, [1, 128, 256]);  add_tensor_22 = None
    ...
    # No stacktrace found for following nodes
    mm_default_21: "f32[128, 256]" = torch.ops.aten.mm.default(view_53, permute_25);  view_53 = permute_25 = None
    add_tensor_21: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_21, arg39_1);  mm_default_21 = arg39_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_54: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_21, [1, 128, 256]);  add_tensor_21 = None
    ...
    # No stacktrace found for following nodes
    mm_default_20: "f32[128, 256]" = torch.ops.aten.mm.default(view_64, permute_30);  view_64 = permute_30 = None
    add_tensor_20: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_20, arg41_1);  mm_default_20 = arg41_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_65: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_20, [1, 128, 256]);  add_tensor_20 = None
    ...
    # No stacktrace found for following nodes
    mm_default_19: "f32[128, 2048]" = torch.ops.aten.mm.default(view_66, permute_31);  view_66 = permute_31 = None
    add_tensor_19: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_19, arg45_1);  mm_default_19 = arg45_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_67: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_19, [1, 128, 2048]);  add_tensor_19 = None
    ...
    # No stacktrace found for following nodes
    mm_default_18: "f32[128, 256]" = torch.ops.aten.mm.default(view_68, permute_32);  view_68 = permute_32 = None
    add_tensor_18: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_18, arg47_1);  mm_default_18 = arg47_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_69: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_18, [1, 128, 256]);  add_tensor_18 = None
    ...
    # No stacktrace found for following nodes
    mm_default_17: "f32[128, 256]" = torch.ops.aten.mm.default(view_70, permute_33);  view_70 = permute_33 = None
    add_tensor_17: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_17, arg51_1);  mm_default_17 = arg51_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_71: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_17, [1, 128, 256]);  add_tensor_17 = None
    ...
    # No stacktrace found for following nodes
    mm_default_16: "f32[128, 256]" = torch.ops.aten.mm.default(view_72, permute_34);  view_72 = permute_34 = None
    add_tensor_16: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_16, arg53_1);  mm_default_16 = arg53_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_73: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_16, [1, 128, 256]);  add_tensor_16 = None
    ...
    # No stacktrace found for following nodes
    mm_default_15: "f32[128, 256]" = torch.ops.aten.mm.default(view_75, permute_36);  view_75 = permute_36 = None
    add_tensor_15: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_15, arg55_1);  mm_default_15 = arg55_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_76: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_15, [1, 128, 256]);  add_tensor_15 = None
    ...
    # No stacktrace found for following nodes
    mm_default_14: "f32[128, 256]" = torch.ops.aten.mm.default(view_86, permute_41);  view_86 = permute_41 = None
    add_tensor_14: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_14, arg57_1);  mm_default_14 = arg57_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_87: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_14, [1, 128, 256]);  add_tensor_14 = None
    ...
    # No stacktrace found for following nodes
    mm_default_13: "f32[128, 2048]" = torch.ops.aten.mm.default(view_88, permute_42);  view_88 = permute_42 = None
    add_tensor_13: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_13, arg61_1);  mm_default_13 = arg61_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_89: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_13, [1, 128, 2048]);  add_tensor_13 = None
    ...
    # No stacktrace found for following nodes
    mm_default_12: "f32[128, 256]" = torch.ops.aten.mm.default(view_90, permute_43);  view_90 = permute_43 = None
    add_tensor_12: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_12, arg63_1);  mm_default_12 = arg63_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_91: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_12, [1, 128, 256]);  add_tensor_12 = None
    ...
    # No stacktrace found for following nodes
    mm_default_11: "f32[128, 256]" = torch.ops.aten.mm.default(view_92, permute_44);  view_92 = permute_44 = None
    add_tensor_11: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_11, arg67_1);  mm_default_11 = arg67_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_93: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_11, [1, 128, 256]);  add_tensor_11 = None
    ...
    # No stacktrace found for following nodes
    mm_default_10: "f32[128, 256]" = torch.ops.aten.mm.default(view_94, permute_45);  view_94 = permute_45 = None
    add_tensor_10: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_10, arg69_1);  mm_default_10 = arg69_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_95: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_10, [1, 128, 256]);  add_tensor_10 = None
    ...
    # No stacktrace found for following nodes
    mm_default_9: "f32[128, 256]" = torch.ops.aten.mm.default(view_97, permute_47);  view_97 = permute_47 = None
    add_tensor_9: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_9, arg71_1);  mm_default_9 = arg71_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_98: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_9, [1, 128, 256]);  add_tensor_9 = None
    ...
    # No stacktrace found for following nodes
    mm_default_8: "f32[128, 256]" = torch.ops.aten.mm.default(view_108, permute_52);  view_108 = permute_52 = None
    add_tensor_8: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_8, arg73_1);  mm_default_8 = arg73_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_109: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_8, [1, 128, 256]);  add_tensor_8 = None
    ...
    # No stacktrace found for following nodes
    mm_default_7: "f32[128, 2048]" = torch.ops.aten.mm.default(view_110, permute_53);  view_110 = permute_53 = None
    add_tensor_7: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_7, arg77_1);  mm_default_7 = arg77_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_111: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_7, [1, 128, 2048]);  add_tensor_7 = None
    ...
    # No stacktrace found for following nodes
    mm_default_6: "f32[128, 256]" = torch.ops.aten.mm.default(view_112, permute_54);  view_112 = permute_54 = None
    add_tensor_6: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_6, arg79_1);  mm_default_6 = arg79_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_113: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_6, [1, 128, 256]);  add_tensor_6 = None
    ...
    # No stacktrace found for following nodes
    mm_default_5: "f32[128, 256]" = torch.ops.aten.mm.default(view_114, permute_55);  view_114 = permute_55 = None
    add_tensor_5: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_5, arg83_1);  mm_default_5 = arg83_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:201, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_115: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_5, [1, 128, 256]);  add_tensor_5 = None
    ...
    # No stacktrace found for following nodes
    mm_default_4: "f32[128, 256]" = torch.ops.aten.mm.default(view_116, permute_56);  view_116 = permute_56 = None
    add_tensor_4: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_4, arg85_1);  mm_default_4 = arg85_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:226, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_117: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_4, [1, 128, 256]);  add_tensor_4 = None
    ...
    # No stacktrace found for following nodes
    mm_default_3: "f32[128, 256]" = torch.ops.aten.mm.default(view_119, permute_58);  view_119 = permute_58 = None
    add_tensor_3: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_3, arg87_1);  mm_default_3 = arg87_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:227, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_120: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 128, 256]);  add_tensor_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_2: "f32[128, 256]" = torch.ops.aten.mm.default(view_130, permute_63);  view_130 = permute_63 = None
    add_tensor_2: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default_2, arg89_1);  mm_default_2 = arg89_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:299, code: attn_output = self.out_proj(attn_output)
    view_131: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 128, 256]);  add_tensor_2 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[128, 2048]" = torch.ops.aten.mm.default(view_132, permute_64);  view_132 = permute_64 = None
    add_tensor_1: "f32[128, 2048]" = torch.ops.aten.add.Tensor(mm_default_1, arg93_1);  mm_default_1 = arg93_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:406, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_133: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 128, 2048]);  add_tensor_1 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[128, 256]" = torch.ops.aten.mm.default(view_134, permute_65);  view_134 = permute_65 = None
    add_tensor: "f32[128, 256]" = torch.ops.aten.add.Tensor(mm_default, arg95_1);  mm_default = arg95_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/speech_to_text_2/modeling_speech_to_text_2.py:408, code: hidden_states = self.fc2(hidden_states)
    view_135: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(add_tensor, [1, 128, 256]);  add_tensor = None
