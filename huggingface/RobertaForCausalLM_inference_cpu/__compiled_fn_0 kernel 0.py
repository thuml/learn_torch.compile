...
def call(args):
    ...
    cpp_fused__to_copy_cumsum_ne_0(c_void_p(arg205_1.data_ptr()), c_void_p(buf0.data_ptr()))
    ...
    del buf321
    del buf322
    buf325 = empty((512, 50265), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg202_1, reinterpret_tensor(buf324, (512, 768), (768, 1), 0), reinterpret_tensor(arg201_1, (768, 50265), (1, 768), 0), alpha=1, beta=1, out=buf325)
    del arg201_1
    del arg202_1
    del buf324
    buf326 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf327 = empty_strided((511, 1), (1, 511), device='cpu', dtype=torch.float32)
    buf328 = empty((), device='cpu', dtype=torch.float32)
    buf329 = empty((), device='cpu', dtype=torch.int64)
    buf330 = buf328; del buf328  # reuse
    cpp_fused__log_softmax_nll_loss_forward_51(c_void_p(buf330.data_ptr()), c_void_p(buf325.data_ptr()), c_void_p(arg204_1.data_ptr()), c_void_p(buf326.data_ptr()), c_void_p(buf327.data_ptr()), c_void_p(buf329.data_ptr()))
    del arg204_1
    return (buf330, reinterpret_tensor(buf325, (1, 512, 50265), (25735680, 50265, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg201_1 = rand_strided((50265, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg202_1 = rand_strided((50265, ), (1, ), device='cpu', dtype=torch.float32)
