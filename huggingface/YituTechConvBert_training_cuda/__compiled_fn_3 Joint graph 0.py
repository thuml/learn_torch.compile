...
def forward(self, primals, tangents):
    ...
    iota_48: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_88: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_48, 0);  iota_48 = None
    iota_49: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_50: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_92: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_50, 0);  iota_50 = None
    iota_51: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_2: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_52: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_94: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_52, 0);  iota_52 = None
    iota_53: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_54: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_98: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_54, 0);  iota_54 = None
    iota_55: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_3: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_56: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_100: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_56, 0);  iota_56 = None
    iota_57: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_58: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_104: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_58, 0);  iota_58 = None
    iota_59: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_4: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_60: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_106: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_60, 0);  iota_60 = None
    iota_61: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_62: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_110: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_62, 0);  iota_62 = None
    iota_63: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_5: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_64: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_112: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_64, 0);  iota_64 = None
    iota_65: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_66: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_116: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_66, 0);  iota_66 = None
    iota_67: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_6: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_68: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_118: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_68, 0);  iota_68 = None
    iota_69: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_70: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_122: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_70, 0);  iota_70 = None
    iota_71: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_7: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_72: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_124: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_72, 0);  iota_72 = None
    iota_73: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_74: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_128: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_74, 0);  iota_74 = None
    iota_75: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_8: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_76: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_130: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_76, 0);  iota_76 = None
    iota_77: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_78: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_134: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_78, 0);  iota_78 = None
    iota_79: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_9: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_80: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_136: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_80, 0);  iota_80 = None
    iota_81: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_82: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_140: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_82, 0);  iota_82 = None
    iota_83: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_10: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_84: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_142: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_84, 0);  iota_84 = None
    iota_85: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_86: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_146: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_86, 0);  iota_86 = None
    iota_87: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_11: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_88: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_148: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_88, 0);  iota_88 = None
    iota_89: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_90: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_152: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_90, 0);  iota_90 = None
    iota_91: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_12: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    iota_92: "i64[512]" = torch.ops.prims.iota.default(512, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_154: "i64[1, 512]" = torch.ops.aten.unsqueeze.default(iota_92, 0);  iota_92 = None
    iota_93: "i64[9]" = torch.ops.prims.iota.default(9, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    iota_94: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    unsqueeze_158: "i64[1, 1]" = torch.ops.aten.unsqueeze.default(iota_94, 0);  iota_94 = None
    iota_95: "i64[1]" = torch.ops.prims.iota.default(1, start = 0, step = 1, dtype = torch.int64, device = device(type='cuda', index=0), requires_grad = False)
    ...
    full_13: "f32[1, 384, 520, 1]" = torch.ops.aten.full.default([1, 384, 520, 1], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_14: "f32[2, 768]" = torch.ops.aten.full.default([2, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_15: "f32[512, 768]" = torch.ops.aten.full.default([512, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_16: "f32[30522, 768]" = torch.ops.aten.full.default([30522, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
