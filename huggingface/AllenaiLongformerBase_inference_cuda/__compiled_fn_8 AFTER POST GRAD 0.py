...
def forward(self, arg0_1: "f32[768, 768]", arg1_1: "f32[768]", arg2_1: "f32[768]", arg3_1: "f32[768]", arg4_1: "f32[50265, 768]", arg5_1: "f32[50265]", arg6_1: "f32[1, 1024, 768]", arg7_1: "i64[1, 1024]"):
    ...
    view: "f32[1024, 768]" = torch.ops.aten.reshape.default(arg6_1, [1024, 768]);  arg6_1 = None
    permute: "f32[768, 768]" = torch.ops.aten.permute.default(arg0_1, [1, 0]);  arg0_1 = None
    
    # No stacktrace found for following nodes
    mm_default: "f32[1024, 768]" = torch.ops.aten.mm.default(view, permute);  view = permute = None
    add_tensor: "f32[1024, 768]" = torch.ops.aten.add.Tensor(mm_default, arg1_1);  mm_default = arg1_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/longformer/modeling_longformer.py:1397, code: x = self.dense(features)
    view_1: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(add_tensor, [1, 1024, 768]);  add_tensor = None
    ...
    view_5: "i64[1024]" = torch.ops.aten.reshape.default(arg7_1, [-1]);  arg7_1 = None
    ...
    where: "i64[1024]" = torch.ops.aten.where.self(ne, view_5, full_default);  ne = full_default = None
    ...
    where_1: "f32[1024]" = torch.ops.aten.where.self(ne_1, neg, full_default_1);  ne_1 = neg = full_default_1 = None
