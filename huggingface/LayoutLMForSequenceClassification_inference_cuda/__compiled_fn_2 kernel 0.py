...
# kernel path: /tmp/torchinductor_youkaichao/6a/c6aaquvbsfeympzutoqe64mxjnvigjpgbkkrqfh6n2ty2lzntfoo.py
# Source Nodes: [pooled_output_3], Original ATen: [aten.tanh]
# pooled_output_3 => tanh
triton_poi_fused_tanh_4 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*fp32', 2: 'i32'}, 'device': 0, 'device_type': 'cuda', 'constants': {}, 'configs': [instance_descriptor(divisible_by_16=(0, 1, 2), equal_to_1=(), ids_of_folded_args=(), divisible_by_8=(2,))]},
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_poi_fused_tanh_4', 'mutated_arg_names': ['in_out_ptr0']},
    min_elem_per_thread=0
)
@triton.jit
def triton_(in_out_ptr0, in_ptr0, xnumel, XBLOCK : tl.constexpr):
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_sub_zeros_0.run(arg206_1, arg0_1, arg205_1, arg1_1, arg2_1, arg3_1, arg4_1, arg5_1, arg6_1, arg7_1, arg8_1, buf0, buf4, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg1_1
        del arg205_1
        del arg206_1
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf280, (1, 768), (768, 1), 0), reinterpret_tensor(arg201_1, (768, 768), (1, 768), 0), out=buf281)
        del arg201_1
        buf282 = buf281; del buf281  # reuse
        # Source Nodes: [pooled_output_3], Original ATen: [aten.tanh]
        triton_poi_fused_tanh_4.run(buf282, arg202_1, 768, grid=grid(768), stream=stream0)
        del arg202_1
        buf283 = empty((1, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [logits], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg204_1, buf282, reinterpret_tensor(arg203_1, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf283)
        del arg203_1
        del arg204_1
        return (buf280, buf282, buf283, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg203_1 = rand_strided((2, 768), (768, 1), device='cuda:0', dtype=torch.float32)
