...
def call(args):
    ...
    del buf309
    del buf312
    buf317 = empty((512, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg198_1, reinterpret_tensor(buf316, (512, 768), (768, 1), 0), reinterpret_tensor(arg197_1, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf317)
    del arg197_1
    del arg198_1
    del buf316
    buf318 = reinterpret_tensor(buf314, (1, 512), (512, 1), 0); del buf314  # reuse
    buf319 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf320 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf321 = reinterpret_tensor(buf313, (1, 512), (512, 1), 0); del buf313  # reuse
    buf322 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf323 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf324 = reinterpret_tensor(buf319, (), (), 0); del buf319  # reuse
    buf325 = buf324; del buf324  # reuse
    cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_49(c_void_p(buf325.data_ptr()), c_void_p(buf317.data_ptr()), c_void_p(arg202_1.data_ptr()), c_void_p(arg203_1.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(buf320.data_ptr()), c_void_p(buf321.data_ptr()), c_void_p(buf322.data_ptr()), c_void_p(buf323.data_ptr()))
    del arg202_1
    del arg203_1
    return (buf325, buf318, buf321, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg203_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
