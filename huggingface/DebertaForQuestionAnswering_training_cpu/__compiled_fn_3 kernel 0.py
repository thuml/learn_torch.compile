...
cpp_fused__log_softmax__softmax_add_bitwise_not_clamp_clone_detach_div_masked_fill_nll_loss_backward_nll_loss_forward_92 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
    ...
    #pragma omp parallel num_threads(28)
    {
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(6144L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(512L); x1+=static_cast<long>(1L))
                {
                    auto tmp0 = in_out_ptr1[static_cast<long>(x1 + (512L*x0))];
                    auto tmp1 = in_ptr4[static_cast<long>(x0)];
                    auto tmp2 = tmp0 / tmp1;
                    auto tmp3 = static_cast<bool>(0);
                    auto tmp4 = static_cast<float>(0.0);
                    auto tmp5 = tmp3 ? tmp4 : tmp2;
                    in_out_ptr1[static_cast<long>(x1 + (512L*x0))] = tmp5;
                }
            }
        }
        {
...
def call(args):
    ...
    cpp_fused_add_bernoulli_embedding_mean_pow_sqrt_sub_0(c_void_p(buf3.data_ptr()), c_void_p(primals_164.data_ptr()), c_void_p(primals_75.data_ptr()), c_void_p(primals_163.data_ptr()), c_void_p(primals_76.data_ptr()), c_void_p(buf4.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf5.data_ptr()), c_void_p(buf26.data_ptr()), c_void_p(buf38.data_ptr()))
    del primals_75
    del primals_76
    ...
    buf516 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused_add_div_sqrt_transpose_2(c_void_p(buf10.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf516.data_ptr()))
    del primals_3
    ...
    buf514 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_4(c_void_p(buf17.data_ptr()), c_void_p(buf14.data_ptr()), c_void_p(buf15.data_ptr()), c_void_p(buf10.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(buf20.data_ptr()), c_void_p(buf21.data_ptr()), c_void_p(buf22.data_ptr()), c_void_p(buf514.data_ptr()))
    del primals_4
    ...
    cpp_fused_add_div_sqrt_transpose_9(c_void_p(buf48.data_ptr()), c_void_p(primals_9.data_ptr()), c_void_p(buf49.data_ptr()), c_void_p(buf513.data_ptr()))
    del primals_9
    ...
    buf511 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_11(c_void_p(buf54.data_ptr()), c_void_p(buf52.data_ptr()), c_void_p(buf53.data_ptr()), c_void_p(buf48.data_ptr()), c_void_p(primals_10.data_ptr()), c_void_p(buf57.data_ptr()), c_void_p(buf58.data_ptr()), c_void_p(buf59.data_ptr()), c_void_p(buf511.data_ptr()))
    del primals_10
    ...
    cpp_fused_add_div_sqrt_transpose_17(c_void_p(buf86.data_ptr()), c_void_p(primals_15.data_ptr()), c_void_p(buf87.data_ptr()), c_void_p(buf510.data_ptr()))
    del primals_15
    ...
    buf508 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_19(c_void_p(buf92.data_ptr()), c_void_p(buf90.data_ptr()), c_void_p(buf91.data_ptr()), c_void_p(buf86.data_ptr()), c_void_p(primals_16.data_ptr()), c_void_p(buf95.data_ptr()), c_void_p(buf96.data_ptr()), c_void_p(buf97.data_ptr()), c_void_p(buf508.data_ptr()))
    del primals_16
    ...
    cpp_fused_add_div_sqrt_transpose_24(c_void_p(buf124.data_ptr()), c_void_p(primals_21.data_ptr()), c_void_p(buf125.data_ptr()), c_void_p(buf507.data_ptr()))
    del primals_21
    ...
    buf505 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_26(c_void_p(buf130.data_ptr()), c_void_p(buf128.data_ptr()), c_void_p(buf129.data_ptr()), c_void_p(buf124.data_ptr()), c_void_p(primals_22.data_ptr()), c_void_p(buf133.data_ptr()), c_void_p(buf134.data_ptr()), c_void_p(buf135.data_ptr()), c_void_p(buf505.data_ptr()))
    del primals_22
    ...
    cpp_fused_add_div_sqrt_transpose_32(c_void_p(buf162.data_ptr()), c_void_p(primals_27.data_ptr()), c_void_p(buf163.data_ptr()), c_void_p(buf504.data_ptr()))
    del primals_27
    ...
    buf502 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    ...
    cpp_fused_add_div_sqrt_transpose_39(c_void_p(buf200.data_ptr()), c_void_p(primals_33.data_ptr()), c_void_p(buf201.data_ptr()), c_void_p(buf501.data_ptr()))
    del primals_33
    ...
    buf499 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_41(c_void_p(buf206.data_ptr()), c_void_p(buf204.data_ptr()), c_void_p(buf205.data_ptr()), c_void_p(buf200.data_ptr()), c_void_p(primals_34.data_ptr()), c_void_p(buf209.data_ptr()), c_void_p(buf210.data_ptr()), c_void_p(buf211.data_ptr()), c_void_p(buf499.data_ptr()))
    del primals_34
    ...
    cpp_fused_add_div_sqrt_transpose_47(c_void_p(buf238.data_ptr()), c_void_p(primals_39.data_ptr()), c_void_p(buf239.data_ptr()), c_void_p(buf498.data_ptr()))
    del primals_39
    ...
    cpp_fused_add_div_sqrt_transpose_54(c_void_p(buf276.data_ptr()), c_void_p(primals_45.data_ptr()), c_void_p(buf277.data_ptr()), c_void_p(buf495.data_ptr()))
    del primals_45
    ...
    buf493 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_56(c_void_p(buf282.data_ptr()), c_void_p(buf280.data_ptr()), c_void_p(buf281.data_ptr()), c_void_p(buf276.data_ptr()), c_void_p(primals_46.data_ptr()), c_void_p(buf285.data_ptr()), c_void_p(buf286.data_ptr()), c_void_p(buf287.data_ptr()), c_void_p(buf493.data_ptr()))
    del primals_46
    ...
    cpp_fused_add_div_sqrt_transpose_62(c_void_p(buf314.data_ptr()), c_void_p(primals_51.data_ptr()), c_void_p(buf315.data_ptr()), c_void_p(buf492.data_ptr()))
    del primals_51
    ...
    cpp_fused_add_div_sqrt_transpose_69(c_void_p(buf352.data_ptr()), c_void_p(primals_57.data_ptr()), c_void_p(buf353.data_ptr()), c_void_p(buf489.data_ptr()))
    del primals_57
    ...
    cpp_fused_add_div_sqrt_transpose_77(c_void_p(buf390.data_ptr()), c_void_p(primals_63.data_ptr()), c_void_p(buf391.data_ptr()), c_void_p(buf486.data_ptr()))
    del primals_63
    ...
    buf484 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_masked_fill_mul_rsub_transpose_79(c_void_p(buf396.data_ptr()), c_void_p(buf394.data_ptr()), c_void_p(buf395.data_ptr()), c_void_p(buf390.data_ptr()), c_void_p(primals_64.data_ptr()), c_void_p(buf399.data_ptr()), c_void_p(buf400.data_ptr()), c_void_p(buf401.data_ptr()), c_void_p(buf484.data_ptr()))
    del primals_64
    ...
    cpp_fused_add_div_sqrt_transpose_84(c_void_p(buf428.data_ptr()), c_void_p(primals_69.data_ptr()), c_void_p(buf429.data_ptr()), c_void_p(buf483.data_ptr()))
    del primals_69
    ...
    buf482 = empty((1, 12, 512, 512), device='cpu', dtype=torch.float32)
    buf439 = buf429; del buf429  # reuse
    buf481 = empty_strided((12, 64, 512), (64, 1, 768), device='cpu', dtype=torch.float32)
    cpp_fused__softmax__to_copy_add_bitwise_not_detach_masked_fill_mul_rsub_transpose_86(c_void_p(buf434.data_ptr()), c_void_p(buf432.data_ptr()), c_void_p(buf433.data_ptr()), c_void_p(buf428.data_ptr()), c_void_p(primals_70.data_ptr()), c_void_p(buf437.data_ptr()), c_void_p(buf438.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf439.data_ptr()), c_void_p(buf481.data_ptr()))
    del buf432
    del buf433
    del buf434
    del primals_70
    ...
    del primals_72
    del primals_74
    buf466 = empty((512, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_162, buf465, reinterpret_tensor(primals_161, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf466)
    del primals_162
    buf467 = reinterpret_tensor(buf461, (1, 512), (512, 1), 0); del buf461  # reuse
    buf469 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf468 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf473 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf470 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf471 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf474 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf475 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf472 = empty((1, ), device='cpu', dtype=torch.bool)
    buf476 = empty((1, ), device='cpu', dtype=torch.bool)
    buf517 = empty((), device='cpu', dtype=torch.float32)
    buf477 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf478 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf479 = empty((1, 1), device='cpu', dtype=torch.bool)
    buf480 = empty((1, 1), device='cpu', dtype=torch.int64)
    buf485 = buf394; del buf394  # reuse
    buf488 = buf356; del buf356  # reuse
    buf491 = buf318; del buf318  # reuse
    buf494 = buf280; del buf280  # reuse
    buf497 = buf242; del buf242  # reuse
    buf500 = buf204; del buf204  # reuse
    buf503 = buf166; del buf166  # reuse
    buf506 = buf128; del buf128  # reuse
    buf509 = buf90; del buf90  # reuse
    buf512 = buf52; del buf52  # reuse
    buf515 = buf14; del buf14  # reuse
    cpp_fused__log_softmax__softmax_add_bitwise_not_clamp_clone_detach_div_masked_fill_nll_loss_backward_nll_loss_forward_92(c_void_p(buf485.data_ptr()), c_void_p(buf488.data_ptr()), c_void_p(buf491.data_ptr()), c_void_p(buf494.data_ptr()), c_void_p(buf497.data_ptr()), c_void_p(buf500.data_ptr()), c_void_p(buf503.data_ptr()), c_void_p(buf506.data_ptr()), c_void_p(buf509.data_ptr()), c_void_p(buf512.data_ptr()), c_void_p(buf515.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(primals_165.data_ptr()), c_void_p(primals_166.data_ptr()), c_void_p(buf395.data_ptr()), c_void_p(buf357.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf281.data_ptr()), c_void_p(buf243.data_ptr()), c_void_p(buf205.data_ptr()), c_void_p(buf167.data_ptr()), c_void_p(buf129.data_ptr()), c_void_p(buf91.data_ptr()), c_void_p(buf53.data_ptr()), c_void_p(buf15.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf468.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf517.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()))
    del buf129
    del buf15
    del buf167
    del buf205
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_161 = rand_strided((2, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_162 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
    primals_163 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_164 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    primals_165 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
    primals_166 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
