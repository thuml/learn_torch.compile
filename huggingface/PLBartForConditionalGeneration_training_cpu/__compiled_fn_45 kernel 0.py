        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(1024L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(50000L); x1+=static_cast<long>(8L))
                {
                    ...
                    auto tmp7 = tmp3 - tmp6;
                    tmp7.store(out_ptr2 + static_cast<long>(x1 + (50005L*x0)));
                }
                ...
                for(long x1=static_cast<long>(50000L); x1<static_cast<long>(50005L); x1+=static_cast<long>(1L))
                {
                    ...
                    out_ptr2[static_cast<long>(x1 + (50005L*x0))] = tmp5;
                }
            }
        }
        #pragma omp single
            ...
            {
                {
                    ...
                    for(long x0=static_cast<long>(0L); x0<static_cast<long>(1024L); x0+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp6 = decltype(tmp5)(tmp5 + 50005);
                        auto tmp7 = tmp5 < 0;
                        auto tmp8 = tmp7 ? tmp6 : tmp5;
                        TORCH_CHECK((0 <= tmp8) & (tmp8 < 50005L), "index out of bounds: 0 <= tmp8 < 50005L")
                        auto tmp9 = out_ptr2[static_cast<long>(tmp8 + (50005L*x0))];
...
def call(args):
    ...
    buf4 = empty((1024, 50005), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_1 = rand_strided((50005, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_2 = rand_strided((1, 50005), (50005, 1), device='cpu', dtype=torch.float32)
    primals_3 = rand_strided((1, 1024, 768), (786432, 768, 1), device='cpu', dtype=torch.float32)
