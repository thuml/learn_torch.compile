...
def forward(self, primals, tangents):
    ...
    view_2: "f32[1024, 768]" = torch.ops.aten.view.default(primals_17, [1024, 768])
    ...
    view_5: "f32[1024, 768]" = torch.ops.aten.view.default(primals_17, [1024, 768])
    ...
    view_10: "f32[12, 1024, 64]" = torch.ops.aten.view.default(clone, [12, -1, 64]);  clone = None
    ...
    view_11: "f32[12, 1024, 64]" = torch.ops.aten.view.default(clone_1, [12, -1, 64]);  clone_1 = None
    ...
    sub: "f32[12, 1024, 1024]" = torch.ops.aten.sub.Tensor(bmm, amax);  bmm = amax = None
    ...
    view_13: "f32[1, 1024, 768]" = torch.ops.aten.view.default(clone_3, [1, 1024, 768]);  clone_3 = None
    ...
    view_14: "f32[1024, 768]" = torch.ops.aten.view.default(view_13, [1024, 768]);  view_13 = None
    ...
    view_15: "f32[1, 1024, 768]" = torch.ops.aten.view.default(addmm_3, [1, 1024, 768]);  addmm_3 = None
    ...
    sub_1: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add, getitem_5)
    ...
    view_16: "f32[1024, 768]" = torch.ops.aten.view.default(add_2, [1024, 768])
    ...
    view_17: "f32[1, 1024, 3072]" = torch.ops.aten.view.default(addmm_4, [1, 1024, 3072]);  addmm_4 = None
    ...
    view_18: "f32[1024, 3072]" = torch.ops.aten.view.default(clone_4, [1024, 3072]);  clone_4 = None
    ...
    view_19: "f32[1, 1024, 768]" = torch.ops.aten.view.default(addmm_5, [1, 1024, 768]);  addmm_5 = None
    ...
    sub_2: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add_4, getitem_9)
    mul_6: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(sub_2, rsqrt_1);  sub_2 = None
    mul_7: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(mul_6, primals_15);  mul_6 = None
    add_6: "f32[1, 1024, 768]" = torch.ops.aten.add.Tensor(mul_7, primals_16);  mul_7 = primals_16 = None
    sub_3: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add_4, getitem_9);  add_4 = getitem_9 = None
    mul_8: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    ...
    mul_11: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(mul_9, mul_8);  mul_9 = None
    sum_3: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_11, [2], True);  mul_11 = None
    mul_12: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(mul_8, sum_3);  sum_3 = None
    ...
    mul_14: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(tangents_1, mul_8);  mul_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:341, code: hidden_states = self.fc2(hidden_states)
    view_20: "f32[1024, 768]" = torch.ops.aten.view.default(clone_5, [1024, 768]);  clone_5 = None
    ...
    view_21: "f32[768]" = torch.ops.aten.view.default(sum_6, [768]);  sum_6 = None
    permute_14: "f32[768, 3072]" = torch.ops.aten.permute.default(permute_13, [1, 0]);  permute_13 = None
    view_22: "f32[1, 1024, 3072]" = torch.ops.aten.view.default(mm, [1, 1024, 3072]);  mm = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_17: "f32[1, 1024, 3072]" = torch.ops.aten.mul.Tensor(view_17, 0.7071067811865476)
    erf_1: "f32[1, 1024, 3072]" = torch.ops.aten.erf.default(mul_17);  mul_17 = None
    add_7: "f32[1, 1024, 3072]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_18: "f32[1, 1024, 3072]" = torch.ops.aten.mul.Tensor(add_7, 0.5);  add_7 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:339, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_23: "f32[1024, 3072]" = torch.ops.aten.view.default(mul_23, [1024, 3072]);  mul_23 = None
    ...
    view_24: "f32[3072]" = torch.ops.aten.view.default(sum_7, [3072]);  sum_7 = None
    permute_18: "f32[3072, 768]" = torch.ops.aten.permute.default(permute_17, [1, 0]);  permute_17 = None
    view_25: "f32[1, 1024, 768]" = torch.ops.aten.view.default(mm_2, [1, 1024, 768]);  mm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:339, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    add_9: "f32[1, 1024, 768]" = torch.ops.aten.add.Tensor(mul_13, view_25);  mul_13 = view_25 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:336, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_6: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add, getitem_5);  add = getitem_5 = None
    mul_24: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(sub_6, rsqrt);  sub_6 = None
    ...
    mul_27: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(mul_25, mul_24);  mul_25 = None
    sum_9: "f32[1, 1024, 1]" = torch.ops.aten.sum.dim_IntList(mul_27, [2], True);  mul_27 = None
    mul_28: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(mul_24, sum_9);  sum_9 = None
    ...
    mul_30: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(add_9, mul_24);  mul_24 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:286, code: attn_output = self.out_proj(attn_output)
    view_26: "f32[1024, 768]" = torch.ops.aten.view.default(clone_6, [1024, 768]);  clone_6 = None
    ...
    view_27: "f32[768]" = torch.ops.aten.view.default(sum_12, [768]);  sum_12 = None
    permute_22: "f32[768, 768]" = torch.ops.aten.permute.default(permute_21, [1, 0]);  permute_21 = None
    view_28: "f32[1, 1024, 768]" = torch.ops.aten.view.default(mm_4, [1, 1024, 768]);  mm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:284, code: attn_output = attn_output.reshape(bsz, tgt_len, self.embed_dim)
    view_29: "f32[1, 1024, 12, 64]" = torch.ops.aten.view.default(view_28, [1, 1024, 12, 64]);  view_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:280, code: attn_output = attn_output.transpose(1, 2)
    permute_23: "f32[1, 12, 1024, 64]" = torch.ops.aten.permute.default(view_29, [0, 2, 1, 3]);  view_29 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:279, code: attn_output = attn_output.view(bsz, self.num_heads, tgt_len, self.head_dim)
    view_30: "f32[12, 1024, 64]" = torch.ops.aten.view.default(permute_23, [12, 1024, 64]);  permute_23 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:271, code: attn_output = torch.bmm(attn_probs, value_states)
    permute_24: "f32[12, 1024, 1024]" = torch.ops.aten.permute.default(getitem, [0, 2, 1]);  getitem = None
    bmm_2: "f32[12, 1024, 64]" = torch.ops.aten.bmm.default(permute_24, view_30);  permute_24 = None
    permute_25: "f32[12, 64, 1024]" = torch.ops.aten.permute.default(view_11, [0, 2, 1]);  view_11 = None
    bmm_3: "f32[12, 1024, 1024]" = torch.ops.aten.bmm.default(view_30, permute_25);  view_30 = permute_25 = None
    ...
    bmm_4: "f32[12, 64, 1024]" = torch.ops.aten.bmm.default(permute_26, sub_9);  permute_26 = None
    permute_27: "f32[12, 1024, 64]" = torch.ops.aten.permute.default(permute_6, [0, 2, 1]);  permute_6 = None
    bmm_5: "f32[12, 1024, 64]" = torch.ops.aten.bmm.default(sub_9, permute_27);  sub_9 = permute_27 = None
    permute_28: "f32[12, 1024, 64]" = torch.ops.aten.permute.default(bmm_4, [0, 2, 1]);  bmm_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:229, code: value_states = value_states.reshape(*proj_shape)
    view_31: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(bmm_2, [1, 12, 1024, 64]);  bmm_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:228, code: key_states = key_states.reshape(*proj_shape)
    view_32: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(permute_28, [1, 12, 1024, 64]);  permute_28 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:227, code: query_states = self._shape(query_states, tgt_len, bsz).view(*proj_shape)
    view_33: "f32[1, 12, 1024, 64]" = torch.ops.aten.view.default(bmm_5, [1, 12, 1024, 64]);  bmm_5 = None
    ...
    view_34: "f32[1, 1024, 768]" = torch.ops.aten.view.default(clone_8, [1, 1024, 768]);  clone_8 = None
    ...
    view_35: "f32[1, 1024, 768]" = torch.ops.aten.view.default(clone_9, [1, 1024, 768]);  clone_9 = None
    ...
    view_37: "f32[768]" = torch.ops.aten.view.default(sum_14, [768]);  sum_14 = None
    permute_34: "f32[768, 768]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_38: "f32[1, 1024, 768]" = torch.ops.aten.view.default(mm_6, [1, 1024, 768]);  mm_6 = None
    ...
    view_39: "f32[1, 1024, 768]" = torch.ops.aten.view.default(permute_35, [1, 1024, 768]);  permute_35 = None
    ...
    view_41: "f32[768]" = torch.ops.aten.view.default(sum_15, [768]);  sum_15 = None
    permute_39: "f32[768, 768]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_42: "f32[1, 1024, 768]" = torch.ops.aten.view.default(mm_8, [1, 1024, 768]);  mm_8 = None
    ...
    view_43: "f32[1024, 768]" = torch.ops.aten.view.default(mul_37, [1024, 768]);  mul_37 = None
    ...
    view_44: "f32[768]" = torch.ops.aten.view.default(sum_16, [768]);  sum_16 = None
    permute_43: "f32[768, 768]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_45: "f32[1, 1024, 768]" = torch.ops.aten.view.default(mm_10, [1, 1024, 768]);  mm_10 = None
