            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(12L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(1024L); x1+=static_cast<long>(1L))
                {
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(64L); x2+=static_cast<long>(8L))
                    {
                        ...
                        auto tmp6 = tmp3 * tmp5;
                        tmp6.store(out_ptr1 + static_cast<long>(x2 + (64L*x1) + (65536L*x0)));
                    }
                }
            }
        }
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(12L); x0+=static_cast<long>(1L))
            {
                ...
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(64L); x1+=static_cast<long>(8L))
                {
                    ...
                    for(long x2=static_cast<long>(0L); x2<static_cast<long>(1024L); x2+=static_cast<long>(8L))
                    {
                        ...
                        at::vec::transpose_mxn<float,8,8>(in_ptr2 + static_cast<long>(x1 + (64L*x2) + (65536L*x0)), static_cast<long>(64L), tmp0, 8);
                        for (long x1_inner = 0; x1_inner < 8; x1_inner++)
                        {
                            ...
                            auto tmp4 = tmp1 * tmp3;
                            tmp4.store(out_ptr2 + static_cast<long>(x2 + (1024L*x1) + (1024L*x1_inner) + (65536L*x0)));
                        }
                    }
                }
            }
...
cpp_fused_add_native_layer_norm_native_layer_norm_backward_11 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
...
def call(args):
    ...
    assert_size_stride(primals_15, (768, 768), (768, 1))
    ...
    assert_size_stride(primals_21, (3072, 768), (768, 1))
    assert_size_stride(primals_22, (3072, ), (1, ))
    assert_size_stride(primals_23, (768, 3072), (3072, 1))
    assert_size_stride(primals_24, (768, ), (1, ))
    assert_size_stride(primals_25, (768, ), (1, ))
    assert_size_stride(primals_26, (768, ), (1, ))
    assert_size_stride(primals_27, (1, 1024, 768), (786432, 768, 1))
    assert_size_stride(primals_28, (1, 1, 1024, 1024), (1048576, 1048576, 1024, 1))
    assert_size_stride(primals_29, (1, 1024, 768), (786432, 768, 1))
    buf0 = empty((1024, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_q_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_2, reinterpret_tensor(primals_27, (1024, 768), (768, 1), 0), reinterpret_tensor(primals_1, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf0)
    del primals_2
    buf1 = empty((1024, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_4, reinterpret_tensor(primals_27, (1024, 768), (768, 1), 0), reinterpret_tensor(primals_3, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf1)
    del primals_4
    ...
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_27, (1024, 768), (768, 1), 0), reinterpret_tensor(primals_5, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf3)
    del primals_6
    ...
    cpp_fused__softmax_2(c_void_p(buf10.data_ptr()), c_void_p(primals_28.data_ptr()), c_void_p(buf7.data_ptr()), c_void_p(buf9.data_ptr()))
    del primals_28
    ...
    cpp_fused_add_native_layer_norm_view_4(c_void_p(primals_27.data_ptr()), c_void_p(buf18.data_ptr()), c_void_p(primals_9.data_ptr()), c_void_p(primals_10.data_ptr()), c_void_p(buf20.data_ptr()), c_void_p(buf21.data_ptr()), c_void_p(buf23.data_ptr()), c_void_p(buf24.data_ptr()))
    buf25 = reinterpret_tensor(buf18, (1024, 768), (768, 1), 0); del buf18  # reuse
    # Source Nodes: [l__self___encoder_attn_q_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_12, buf24, reinterpret_tensor(primals_11, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf25)
    del primals_12
    buf26 = empty((1024, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___encoder_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_14, reinterpret_tensor(primals_29, (1024, 768), (768, 1), 0), reinterpret_tensor(primals_13, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf26)
    del primals_14
    buf27 = empty((1, 12, 1024, 64), device='cpu', dtype=torch.float32)
    cpp_fused_clone_5(c_void_p(buf26.data_ptr()), c_void_p(buf27.data_ptr()))
    buf28 = buf26; del buf26  # reuse
    # Source Nodes: [l__self___encoder_attn_v_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_16, reinterpret_tensor(primals_29, (1024, 768), (768, 1), 0), reinterpret_tensor(primals_15, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf28)
    del primals_16
    buf29 = empty((1, 12, 1024, 64), device='cpu', dtype=torch.float32)
    buf30 = empty((1, 12, 1024, 64), device='cpu', dtype=torch.float32)
    buf31 = empty((1, 12, 64, 1024), device='cpu', dtype=torch.float32)
    cpp_fused_clone_6(c_void_p(buf28.data_ptr()), c_void_p(buf25.data_ptr()), c_void_p(buf27.data_ptr()), c_void_p(buf29.data_ptr()), c_void_p(buf30.data_ptr()), c_void_p(buf31.data_ptr()))
    buf32 = empty((12, 1024, 1024), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: []
    extern_kernels.bmm(reinterpret_tensor(buf30, (12, 1024, 64), (65536, 64, 1), 0), reinterpret_tensor(buf31, (12, 64, 1024), (65536, 1024, 1), 0), out=buf32)
    buf33 = reinterpret_tensor(buf9, (1, 12, 1024, 1), (12288, 1024, 1, 12288), 0); del buf9  # reuse
    buf34 = reinterpret_tensor(buf32, (1, 12, 1024, 1024), (12582912, 1048576, 1024, 1), 0); del buf32  # reuse
    buf35 = reinterpret_tensor(buf7, (1, 12, 1024, 1), (12288, 1024, 1, 12288), 0); del buf7  # reuse
    buf36 = buf34; del buf34  # reuse
    cpp_fused_7(c_void_p(buf36.data_ptr()), c_void_p(buf33.data_ptr()), c_void_p(buf35.data_ptr()))
    del buf33
    del buf35
    # Source Nodes: [], Original ATen: []
    buf37 = aten.native_dropout(buf36, 0.1, True)
    buf38 = buf37[0]
    buf39 = buf37[1]
    del buf37
    buf40 = reinterpret_tensor(buf28, (12, 1024, 64), (65536, 64, 1), 0); del buf28  # reuse
    # Source Nodes: [], Original ATen: []
    extern_kernels.bmm(reinterpret_tensor(buf38, (12, 1024, 1024), (1048576, 1024, 1), 0), reinterpret_tensor(buf29, (12, 1024, 64), (65536, 64, 1), 0), out=buf40)
    buf41 = reinterpret_tensor(buf25, (12, 1024, 64), (65536, 64, 1), 0); del buf25  # reuse
    buf42 = empty((1024, 768), device='cpu', dtype=torch.float32)
    cpp_fused_view_8(c_void_p(buf31.data_ptr()), c_void_p(buf40.data_ptr()), c_void_p(buf41.data_ptr()), c_void_p(buf42.data_ptr()))
    buf43 = reinterpret_tensor(buf40, (1024, 768), (768, 1), 0); del buf40  # reuse
    # Source Nodes: [hidden_states_4], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_18, buf42, reinterpret_tensor(primals_17, (768, 768), (1, 768), 0), alpha=1, beta=1, out=buf43)
    del primals_18
    ...
    buf51 = reinterpret_tensor(buf31, (1024, 768), (768, 1), 0); del buf31  # reuse
    cpp_fused_add_native_layer_norm_view_9(c_void_p(buf23.data_ptr()), c_void_p(primals_9.data_ptr()), c_void_p(primals_10.data_ptr()), c_void_p(buf45.data_ptr()), c_void_p(primals_19.data_ptr()), c_void_p(primals_20.data_ptr()), c_void_p(buf47.data_ptr()), c_void_p(buf48.data_ptr()), c_void_p(buf50.data_ptr()), c_void_p(buf51.data_ptr()))
    del primals_10
    buf52 = empty((1024, 3072), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_22, buf51, reinterpret_tensor(primals_21, (768, 3072), (1, 768), 0), alpha=1, beta=1, out=buf52)
    del primals_22
    buf53 = empty((1024, 3072), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_view_10(c_void_p(buf52.data_ptr()), c_void_p(buf53.data_ptr()))
    buf54 = reinterpret_tensor(buf45, (1024, 768), (768, 1), 0); del buf45  # reuse
    # Source Nodes: [hidden_states_10], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_24, buf53, reinterpret_tensor(primals_23, (3072, 768), (1, 3072), 0), alpha=1, beta=1, out=buf54)
    del primals_24
    # Source Nodes: [hidden_states_11], Original ATen: [aten.native_dropout]
    buf55 = aten.native_dropout(reinterpret_tensor(buf54, (1, 1024, 768), (786432, 768, 1), 0), 0.1, True)
    buf56 = buf55[0]
    buf57 = buf55[1]
    del buf55
    buf58 = buf47; del buf47  # reuse
    buf59 = empty_strided((1, 1024, 1), (1024, 1, 1024), device='cpu', dtype=torch.float32)
    buf61 = reinterpret_tensor(buf54, (1, 1024, 768), (786432, 768, 1), 0); del buf54  # reuse
    buf62 = empty((1, 1024, 768), device='cpu', dtype=torch.float32)
    buf63 = reinterpret_tensor(buf59, (1, 1024, 1), (1024, 1, 1), 0); del buf59  # reuse
    buf64 = reinterpret_tensor(buf48, (1, 1024, 1), (1024, 1, 1), 0); del buf48  # reuse
    buf65 = reinterpret_tensor(buf21, (1, 1024, 1), (1024, 1, 1), 0); del buf21  # reuse
    cpp_fused_add_native_layer_norm_native_layer_norm_backward_11(c_void_p(buf63.data_ptr()), c_void_p(buf64.data_ptr()), c_void_p(buf65.data_ptr()), c_void_p(buf50.data_ptr()), c_void_p(primals_19.data_ptr()), c_void_p(primals_20.data_ptr()), c_void_p(buf56.data_ptr()), c_void_p(primals_25.data_ptr()), c_void_p(primals_26.data_ptr()), c_void_p(buf58.data_ptr()), c_void_p(buf61.data_ptr()), c_void_p(buf62.data_ptr()))
    del buf56
    del buf58
    del primals_20
    del primals_26
    return (buf62, buf2, buf4, buf27, buf29, primals_9, primals_19, primals_25, reinterpret_tensor(primals_27, (1024, 768), (768, 1), 0), buf13, buf15, buf19, buf23, buf24, reinterpret_tensor(primals_29, (1024, 768), (768, 1), 0), buf39, reinterpret_tensor(buf38, (12, 1024, 1024), (1048576, 1, 1024), 0), reinterpret_tensor(buf29, (12, 64, 1024), (65536, 1, 64), 0), buf36, reinterpret_tensor(buf30, (12, 64, 1024), (65536, 1, 64), 0), buf41, buf42, buf46, buf50, buf51, buf52, buf53, buf57, buf61, buf63, reinterpret_tensor(primals_23, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_21, (3072, 768), (768, 1), 0), buf64, reinterpret_tensor(primals_17, (768, 768), (768, 1), 0), reinterpret_tensor(primals_15, (768, 768), (768, 1), 0), reinterpret_tensor(primals_13, (768, 768), (768, 1), 0), reinterpret_tensor(primals_11, (768, 768), (768, 1), 0), buf65, reinterpret_tensor(primals_7, (768, 768), (768, 1), 0), reinterpret_tensor(buf12, (12, 1024, 1024), (1048576, 1, 1024), 0), reinterpret_tensor(buf4, (12, 64, 1024), (65536, 1, 64), 0), buf10, reinterpret_tensor(buf5, (12, 64, 1024), (65536, 1, 64), 0), reinterpret_tensor(buf2, (12, 1024, 64), (65536, 64, 1), 0), reinterpret_tensor(primals_5, (768, 768), (768, 1), 0), reinterpret_tensor(primals_3, (768, 768), (768, 1), 0), reinterpret_tensor(primals_1, (768, 768), (768, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_13 = rand_strided((768, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_14 = rand_strided((768, ), (1, ), device='cpu', dtype=torch.float32)
    primals_15 = rand_strided((768, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    primals_21 = rand_strided((3072, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_22 = rand_strided((3072, ), (1, ), device='cpu', dtype=torch.float32)
    primals_23 = rand_strided((768, 3072), (3072, 1), device='cpu', dtype=torch.float32)
    ...
    primals_27 = rand_strided((1, 1024, 768), (786432, 768, 1), device='cpu', dtype=torch.float32)
    primals_28 = rand_strided((1, 1, 1024, 1024), (1048576, 1048576, 1024, 1), device='cpu', dtype=torch.float32)
    primals_29 = rand_strided((1, 1024, 768), (786432, 768, 1), device='cpu', dtype=torch.float32)
