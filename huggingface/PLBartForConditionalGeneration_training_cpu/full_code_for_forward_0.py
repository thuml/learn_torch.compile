...
def __guard_1_for_resume_in_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139631876359792)) \
        and (L['self'].training == True) \
        and (hasattr(L['labels'], '_dynamo_dynamic_indices') == False) \
        and (___check_type_id(L['___stack0'], 137560720)) \
        ...
        and (hasattr(L['___stack0'].past_key_values[0][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[0][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack0'].past_key_values[1][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[1][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack0'].past_key_values[2][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[2][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack0'].past_key_values[3][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[3][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack0'].past_key_values[4][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[4][3], '_dynamo_dynamic_indices') == False) \
        ...
        and (hasattr(L['___stack0'].past_key_values[5][2], '_dynamo_dynamic_indices') == False) \
        and (hasattr(L['___stack0'].past_key_values[5][3], '_dynamo_dynamic_indices') == False) \
...
def __transformed_code_1_for_resume_in_forward(___stack0, self, labels, return_dict):
    ...
    graph_out_0 = __compiled_fn_45(___stack0.last_hidden_state, labels)
    import importlib
...
def __resume_at_96_6(___stack0, self, labels, return_dict):
...
def transformed___resume_at_96_6(___stack0, self, labels, return_dict):
    ...
    return __resume_at_96_6(___stack0, self, labels, return_dict)

#============ end of __resume_at_96_6 ============#
...
def __transformed_code_0_for_forward(self, input_ids, attention_mask, decoder_input_ids, decoder_attention_mask, head_mask, decoder_head_mask, cross_attn_head_mask, encoder_outputs, past_key_values, inputs_embeds, decoder_inputs_embeds, labels, use_cache, output_attentions, output_hidden_states, return_dict):
    ...
    return_dict = self.config.use_return_dict
    return __resume_at_96_6(self.model(input_ids, attention_mask=attention_mask,
        decoder_input_ids=graph_out_0[0], encoder_outputs=encoder_outputs,
        decoder_attention_mask=decoder_attention_mask, head_mask=head_mask,
        decoder_head_mask=decoder_head_mask, cross_attn_head_mask=
        cross_attn_head_mask, past_key_values=past_key_values, inputs_embeds=
        inputs_embeds, decoder_inputs_embeds=decoder_inputs_embeds, use_cache=
        use_cache, output_attentions=output_attentions, output_hidden_states=
        output_hidden_states, return_dict=self.config.use_return_dict), self,
        labels, return_dict)
