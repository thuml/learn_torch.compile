...
def call(args):
    primals_9, primals_15, view, getitem_11, permute_default_1, permute_default_2, alias_default_1, permute_default_3, permute_default_4, view_14, getitem_3, mul_1, view_16, addmm_4, view_18, getitem_7, mul_6, div_1, permute_11, permute_15, div_2, permute_19, permute_31, permute_36, permute_40, tangents_1 = args
    args.clear()
    assert_size_stride(primals_9, (768, ), (1, ))
    assert_size_stride(primals_15, (768, ), (1, ))
    assert_size_stride(view, (1024, 768), (768, 1))
    assert_size_stride(getitem_11, (1, 12, 1024, 1024), (12582912, 1048576, 1024, 1))
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf9, (3072, 1024), (1, 3072), 0), view_16, out=buf11)
    del view_16
    ...
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf18, (768, 1024), (1, 768), 0), view_14, out=buf20)
    del view_14
    ...
    cpp_fused_4(c_void_p(buf25.data_ptr()), c_void_p(getitem_11.data_ptr()), c_void_p(alias_default_1.data_ptr()), c_void_p(buf24.data_ptr()))
    del alias_default_1
    del buf24
    del getitem_11
    ...
    buf28 = empty((1024, 768), device='cpu', dtype=torch.float32)
    cpp_fused_view_5(c_void_p(buf22.data_ptr()), c_void_p(buf28.data_ptr()))
    buf29 = reinterpret_tensor(buf22, (1024, 768), (768, 1), 0); del buf22  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf28, permute_31, out=buf29)
    del permute_31
    ...
    buf32 = reinterpret_tensor(buf26, (1024, 768), (1, 1024), 0); del buf26  # reuse
    cpp_fused_sum_view_6(c_void_p(buf32.data_ptr()), c_void_p(buf28.data_ptr()), c_void_p(buf31.data_ptr()))
    buf33 = buf28; del buf28  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(buf32, permute_36, out=buf33)
    del permute_36
    buf34 = empty((768, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (768, 1024), (1024, 1), 0), view, out=buf34)
    buf35 = empty((1, 768), device='cpu', dtype=torch.float32)
    buf36 = empty((1024, 768), device='cpu', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    getitem_11 = rand_strided((1, 12, 1024, 1024), (12582912, 1048576, 1024, 1), device='cpu', dtype=torch.bool)
    ...
    view_14 = rand_strided((1024, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    view_18 = rand_strided((1024, 3072), (3072, 1), device='cpu', dtype=torch.float32)
    ...
    return print_performance(lambda: call([primals_9, primals_15, view, getitem_11, permute_default_1, permute_default_2, alias_default_1, permute_default_3, permute_default_4, view_14, getitem_3, mul_1, view_16, addmm_4, view_18, getitem_7, mul_6, div_1, permute_11, permute_15, div_2, permute_19, permute_31, permute_36, permute_40, tangents_1]), times=times, repeat=repeat)
