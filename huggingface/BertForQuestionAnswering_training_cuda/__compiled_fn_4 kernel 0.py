...
# kernel path: /tmp/torchinductor_youkaichao/gp/cgpz24rx5ekewnvubgluaa37zmiwfjzg3flo6ce6viz3ydavbj2j.py
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, in_ptr8, in_ptr9, out_ptr3, out_ptr4, out_ptr5, xnumel, rnumel):
    ...
    tmp37 = tmp36 == tmp32
    tmp38 = tl.where(tmp37, tmp34, tmp30)
    ...
    tl.store(out_ptr4 + (r1 + (768*x0)), tmp38, rmask & xmask)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [], Original ATen: [aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_native_dropout_backward_native_layer_norm_backward_5.run(buf9, primals_196, mul_85, div_30, getitem_121, buf15, buf18, 512, 768, grid=grid(512), stream=stream0)
        del div_30
        del getitem_121
        del primals_196
        ...
        # Source Nodes: [], Original ATen: [aten.native_layer_norm_backward]
        triton_per_fused_native_layer_norm_backward_6.run(buf9, mul_85, buf16, buf17, 768, 512, grid=grid(768), stream=stream0)
        del mul_85
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf15, buf24, primals_190, mul_80, div_31, getitem_117, buf30, buf33, 512, 768, grid=grid(512), stream=stream0)
        del div_31
        del getitem_117
        del primals_190
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf15, buf24, mul_80, buf31, buf32, 768, 512, grid=grid(768), stream=stream0)
        del buf15
        del mul_80
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf30, buf42, buf46, buf50, primals_180, mul_78, div_33, getitem_111, buf57, buf60, 512, 768, grid=grid(512), stream=stream0)
        del div_33
        del getitem_111
        del primals_180
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf30, buf42, buf46, buf50, mul_78, buf58, buf59, 768, 512, grid=grid(768), stream=stream0)
        del buf30
        del buf42
        del mul_78
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf57, buf66, primals_174, mul_73, div_34, getitem_107, buf72, buf75, 512, 768, grid=grid(512), stream=stream0)
        del div_34
        del getitem_107
        del primals_174
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf57, buf66, mul_73, buf73, buf74, 768, 512, grid=grid(768), stream=stream0)
        del buf57
        del mul_73
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf72, buf84, buf88, buf92, primals_164, mul_71, div_36, getitem_101, buf99, buf102, 512, 768, grid=grid(512), stream=stream0)
        del div_36
        del getitem_101
        del primals_164
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf72, buf84, buf88, buf92, mul_71, buf100, buf101, 768, 512, grid=grid(768), stream=stream0)
        del buf72
        del buf84
        del mul_71
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf99, buf108, primals_158, mul_66, div_37, getitem_97, buf114, buf117, 512, 768, grid=grid(512), stream=stream0)
        del div_37
        del getitem_97
        del primals_158
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf99, buf108, mul_66, buf115, buf116, 768, 512, grid=grid(768), stream=stream0)
        del buf108
        del mul_66
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf114, buf126, buf130, buf134, primals_148, mul_64, div_39, getitem_91, buf141, buf144, 512, 768, grid=grid(512), stream=stream0)
        del div_39
        del getitem_91
        del primals_148
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf114, buf126, buf130, buf134, mul_64, buf142, buf143, 768, 512, grid=grid(768), stream=stream0)
        del buf114
        del buf126
        del mul_64
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf141, buf150, primals_142, mul_59, div_40, getitem_87, buf156, buf159, 512, 768, grid=grid(512), stream=stream0)
        del div_40
        del getitem_87
        del primals_142
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf141, buf150, mul_59, buf157, buf158, 768, 512, grid=grid(768), stream=stream0)
        del buf141
        del mul_59
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf156, buf168, buf172, buf176, primals_132, mul_57, div_42, getitem_81, buf183, buf186, 512, 768, grid=grid(512), stream=stream0)
        del div_42
        del getitem_81
        del primals_132
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf156, buf168, buf172, buf176, mul_57, buf184, buf185, 768, 512, grid=grid(768), stream=stream0)
        del buf156
        del buf168
        del mul_57
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf183, buf192, primals_126, mul_52, div_43, getitem_77, buf198, buf201, 512, 768, grid=grid(512), stream=stream0)
        del div_43
        del getitem_77
        del primals_126
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf183, buf192, mul_52, buf199, buf200, 768, 512, grid=grid(768), stream=stream0)
        del buf183
        del mul_52
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf198, buf210, buf214, buf218, primals_116, mul_50, div_45, getitem_71, buf225, buf228, 512, 768, grid=grid(512), stream=stream0)
        del div_45
        del getitem_71
        del primals_116
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf198, buf210, buf214, buf218, mul_50, buf226, buf227, 768, 512, grid=grid(768), stream=stream0)
        del buf198
        del buf210
        del mul_50
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf225, buf234, primals_110, mul_45, div_46, getitem_67, buf240, buf243, 512, 768, grid=grid(512), stream=stream0)
        del div_46
        del getitem_67
        del primals_110
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf225, buf234, mul_45, buf241, buf242, 768, 512, grid=grid(768), stream=stream0)
        del buf225
        del mul_45
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf240, buf252, buf256, buf260, primals_100, mul_43, div_48, getitem_61, buf267, buf270, 512, 768, grid=grid(512), stream=stream0)
        del div_48
        del getitem_61
        del primals_100
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf240, buf252, buf256, buf260, mul_43, buf268, buf269, 768, 512, grid=grid(768), stream=stream0)
        del buf240
        del buf252
        del mul_43
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf267, buf276, primals_94, mul_38, div_49, getitem_57, buf282, buf285, 512, 768, grid=grid(512), stream=stream0)
        del div_49
        del getitem_57
        del primals_94
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf267, buf276, mul_38, buf283, buf284, 768, 512, grid=grid(768), stream=stream0)
        del buf267
        del mul_38
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf282, buf294, buf298, buf302, primals_84, mul_36, div_51, getitem_51, buf309, buf312, 512, 768, grid=grid(512), stream=stream0)
        del div_51
        del getitem_51
        del primals_84
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf282, buf294, buf298, buf302, mul_36, buf310, buf311, 768, 512, grid=grid(768), stream=stream0)
        del buf282
        del buf294
        del mul_36
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf309, buf318, primals_78, mul_31, div_52, getitem_47, buf324, buf327, 512, 768, grid=grid(512), stream=stream0)
        del div_52
        del getitem_47
        del primals_78
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf309, buf318, mul_31, buf325, buf326, 768, 512, grid=grid(768), stream=stream0)
        del buf309
        del mul_31
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf324, buf336, buf340, buf344, primals_68, mul_29, div_54, getitem_41, buf351, buf354, 512, 768, grid=grid(512), stream=stream0)
        del div_54
        del getitem_41
        del primals_68
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf324, buf336, buf340, buf344, mul_29, buf352, buf353, 768, 512, grid=grid(768), stream=stream0)
        del buf324
        del buf336
        del mul_29
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf351, buf360, primals_62, mul_24, div_55, getitem_37, buf366, buf369, 512, 768, grid=grid(512), stream=stream0)
        del div_55
        del getitem_37
        del primals_62
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf351, buf360, mul_24, buf367, buf368, 768, 512, grid=grid(768), stream=stream0)
        del buf351
        del mul_24
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf366, buf378, buf382, buf386, primals_52, mul_22, div_57, getitem_31, buf393, buf396, 512, 768, grid=grid(512), stream=stream0)
        del div_57
        del getitem_31
        del primals_52
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf366, buf378, buf382, buf386, mul_22, buf394, buf395, 768, 512, grid=grid(768), stream=stream0)
        del buf366
        del buf378
        del mul_22
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf393, buf402, primals_46, mul_17, div_58, getitem_27, buf408, buf411, 512, 768, grid=grid(512), stream=stream0)
        del div_58
        del getitem_27
        del primals_46
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf393, buf402, mul_17, buf409, buf410, 768, 512, grid=grid(768), stream=stream0)
        del buf393
        del mul_17
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf408, buf420, buf424, buf428, primals_36, mul_15, div_60, getitem_21, buf435, buf438, 512, 768, grid=grid(512), stream=stream0)
        del div_60
        del getitem_21
        del primals_36
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf408, buf420, buf424, buf428, mul_15, buf436, buf437, 768, 512, grid=grid(768), stream=stream0)
        del buf408
        del buf420
        del mul_15
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf435, buf444, primals_30, mul_10, div_61, getitem_17, buf450, buf453, 512, 768, grid=grid(512), stream=stream0)
        del div_61
        del getitem_17
        del primals_30
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf435, buf444, mul_10, buf451, buf452, 768, 512, grid=grid(768), stream=stream0)
        del buf435
        del mul_10
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_14.run(buf450, buf462, buf466, buf470, primals_20, mul_8, div_63, getitem_11, buf477, buf480, 512, 768, grid=grid(512), stream=stream0)
        del div_63
        del getitem_11
        del primals_20
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_15.run(buf450, buf462, buf466, buf470, mul_8, buf478, buf479, 768, 512, grid=grid(768), stream=stream0)
        del buf450
        del buf462
        del mul_8
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_12.run(buf477, buf486, primals_14, mul_3, div_64, getitem_7, buf492, buf495, 512, 768, grid=grid(512), stream=stream0)
        del div_64
        del getitem_7
        del primals_14
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_layer_norm_backward]
        triton_per_fused_add_native_layer_norm_backward_13.run(buf477, buf486, mul_3, buf493, buf494, 768, 512, grid=grid(768), stream=stream0)
        del mul_3
        ...
        # Source Nodes: [start_loss], Original ATen: [aten.add, aten.embedding_dense_backward, aten.native_dropout_backward, aten.native_layer_norm_backward, aten.nll_loss_forward]
        triton_per_fused_add_embedding_dense_backward_native_dropout_backward_native_layer_norm_backward_nll_loss_forward_16.run(buf516, buf504, buf508, buf512, getitem_3, primals_4, mul_1, div_66, slice_4, expand, primals_202, buf523, buf527, buf531, 512, 768, grid=grid(512), stream=stream0)
        del buf504
        del buf508
        del buf512
        del div_66
        ...
        # Source Nodes: [], Original ATen: [aten.native_layer_norm_backward]
        triton_per_fused_native_layer_norm_backward_6.run(buf516, mul_1, buf520, buf521, 768, 512, grid=grid(768), stream=stream0)
        del mul_1
        ...
        aten.index_put_(buf522, [slice_4], buf523, True)
        del buf523
        del slice_4
        ...
        del buf527
        del expand
        buf530 = empty((30522, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_19.run(buf530, 23440896, grid=grid(23440896), stream=stream0)
        aten.index_put_(buf530, [primals_202], buf531, True)
        del buf531
        del primals_202
