...
# kernel path: /tmp/torchinductor_youkaichao/46/c46vskkdzg3lxiaqfy6xymzkfu5e6fhkxxqroq44brtd2zjdlsb4.py
# Source Nodes: [add, embed_pos, hidden_states, hidden_states_1, inputs_embeds, l__mod___model_decoder_embed_tokens], Original ATen: [aten.add, aten.embedding, aten.mul, aten.native_layer_norm]
# add => add
...
# kernel path: /tmp/torchinductor_youkaichao/lz/clz7j2mrubpmypnso3cqzyeizkxhwx54mx4rijvmkexpbj5qbefp.py
...
# kernel path: /tmp/torchinductor_youkaichao/i7/ci7mz7lgw7rtjlwo3lumbrs7a5vqkrv36sjpczbqe5pdsht7e27o.py
...
# kernel path: /tmp/torchinductor_youkaichao/cz/cczxqeqmcloke5q4mnwehtdp3czxsfh5kwu5io6ytzsmqz2eh36l.py
...
def triton_(in_ptr0, out_ptr2, xnumel, rnumel):
    ...
    tmp18 = tmp13 / tmp17
    tl.store(out_ptr2 + (r2 + (256*x3)), tmp18, rmask)
''')


# kernel path: /tmp/torchinductor_youkaichao/ev/cevmknywt6xmguieh5xkydj6j4x4ojdeogcxqvhq6wbnhyj2mrqn.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    x2 = (xindex // 1024)
    x3 = xindex
    tmp0 = tl.load(in_ptr0 + (x0 + (64*x2) + (16384*x1)), None)
    tl.store(out_ptr0 + (x3), tmp0, None)
''')


# kernel path: /tmp/torchinductor_youkaichao/we/cweloytyo2llyia6z4oce6xg3e45k6dcskax6dtecjrtfi6bq7dz.py
...
# kernel path: /tmp/torchinductor_youkaichao/vj/cvjygmv5lmxgizizvaiumbp2di2uzqrsa3rbfbvrp3trxg7oh6ou.py
...
# kernel path: /tmp/torchinductor_youkaichao/cf/ccfpjvnuj7nhmqdeupwmmfs2o36zv32igmvwgeyecwt26qkmshxg.py
...
# kernel path: /tmp/torchinductor_youkaichao/r3/cr3t55cfmbe25pzxgxfjg63rq7a2bjxo4avho6gfud3e4bgtnffy.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf3 = empty((1, 256, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [add, embed_pos, hidden_states, hidden_states_1, inputs_embeds, l__mod___model_decoder_embed_tokens], Original ATen: [aten.add, aten.embedding, aten.mul, aten.native_layer_norm]
        stream0 = get_cuda_stream(0)
        triton_red_fused_add_embedding_mul_native_layer_norm_0.run(arg197_1, arg1_1, arg0_1, arg2_1, arg3_1, buf3, 256, 1024, grid=grid(256), stream=stream0)
        del arg0_1
        del arg197_1
        del arg1_1
        del arg2_1
        del arg3_1
        buf4 = empty((256, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf3, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg4_1, (1024, 1024), (1, 1024), 0), out=buf4)
        del arg4_1
        buf5 = empty((256, 1024), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf3, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg6_1, (1024, 1024), (1, 1024), 0), out=buf5)
        del arg6_1
        buf6 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf5, arg7_1, buf6, 262144, grid=grid(262144), stream=stream0)
        del arg7_1
        buf7 = reinterpret_tensor(buf5, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf5  # reuse
        # Source Nodes: [contiguous_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf4, arg5_1, buf7, 262144, grid=grid(262144), stream=stream0)
        del arg5_1
        buf8 = empty((16, 256, 256), device='cuda', dtype=torch.float32)
        ...
        buf13 = empty((16, 256, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_weights_3], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf8, buf13, 4096, 256, grid=grid(4096), stream=stream0)
        buf11 = reinterpret_tensor(buf7, (256, 1024), (1024, 1), 0); del buf7  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf3, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg8_1, (1024, 1024), (1, 1024), 0), out=buf11)
        del arg8_1
        buf12 = reinterpret_tensor(buf4, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf4  # reuse
        # Source Nodes: [value_states], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf11, arg9_1, buf12, 262144, grid=grid(262144), stream=stream0)
        del arg9_1
        buf14 = reinterpret_tensor(buf11, (16, 256, 64), (16384, 64, 1), 0); del buf11  # reuse
        # Source Nodes: [attn_output, attn_weights_3], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf13, reinterpret_tensor(buf12, (16, 256, 64), (16384, 64, 1), 0), out=buf14)
        buf15 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_3], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf14, buf15, 262144, grid=grid(262144), stream=stream0)
        buf16 = reinterpret_tensor(buf14, (256, 1024), (1024, 1), 0); del buf14  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf15, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg10_1, (1024, 1024), (1, 1024), 0), out=buf16)
        del arg10_1
        buf20 = reinterpret_tensor(buf15, (1, 256, 1024), (262144, 1024, 1), 0); del buf15  # reuse
        # Source Nodes: [hidden_states_5, residual_1], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf3, buf16, arg11_1, arg12_1, arg13_1, buf20, 256, 1024, grid=grid(256), stream=stream0)
        del arg11_1
        del arg12_1
        del arg13_1
        buf21 = reinterpret_tensor(buf13, (256, 4096), (4096, 1), 0); del buf13  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf20, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg14_1, (1024, 4096), (1, 1024), 0), out=buf21)
        del arg14_1
        buf22 = reinterpret_tensor(buf21, (1, 256, 4096), (1048576, 4096, 1), 0); del buf21  # reuse
        # Source Nodes: [hidden_states_7], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf22, arg15_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg15_1
        buf23 = reinterpret_tensor(buf3, (256, 1024), (1024, 1), 0); del buf3  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf22, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg16_1, (4096, 1024), (1, 4096), 0), out=buf23)
        del arg16_1
        buf27 = reinterpret_tensor(buf16, (1, 256, 1024), (262144, 1024, 1), 0); del buf16  # reuse
        # Source Nodes: [hidden_states_11, residual_2], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf20, buf23, arg17_1, arg18_1, arg19_1, buf27, 256, 1024, grid=grid(256), stream=stream0)
        del arg17_1
        del arg18_1
        del arg19_1
        buf28 = buf23; del buf23  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg20_1, (1024, 1024), (1, 1024), 0), out=buf28)
        del arg20_1
        buf29 = reinterpret_tensor(buf20, (256, 1024), (1024, 1), 0); del buf20  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg22_1, (1024, 1024), (1, 1024), 0), out=buf29)
        del arg22_1
        buf30 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf29, arg23_1, buf30, 262144, grid=grid(262144), stream=stream0)
        del arg23_1
        buf31 = reinterpret_tensor(buf29, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf29  # reuse
        # Source Nodes: [contiguous_5], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf28, arg21_1, buf31, 262144, grid=grid(262144), stream=stream0)
        del arg21_1
        buf32 = reinterpret_tensor(buf22, (16, 256, 256), (65536, 256, 1), 0); del buf22  # reuse
        # Source Nodes: [attn_weights_4], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf31, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf30, (16, 64, 256), (16384, 1, 64), 0), out=buf32)
        buf37 = buf8; del buf8  # reuse
        # Source Nodes: [attn_weights_7], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf32, buf37, 4096, 256, grid=grid(4096), stream=stream0)
        buf35 = reinterpret_tensor(buf31, (256, 1024), (1024, 1), 0); del buf31  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf27, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg24_1, (1024, 1024), (1, 1024), 0), out=buf35)
        del arg24_1
        buf36 = reinterpret_tensor(buf28, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf28  # reuse
        # Source Nodes: [value_states_2], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf35, arg25_1, buf36, 262144, grid=grid(262144), stream=stream0)
        del arg25_1
        buf38 = reinterpret_tensor(buf35, (16, 256, 64), (16384, 64, 1), 0); del buf35  # reuse
        # Source Nodes: [attn_output_5, attn_weights_7], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf37, reinterpret_tensor(buf36, (16, 256, 64), (16384, 64, 1), 0), out=buf38)
        buf39 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf38, buf39, 262144, grid=grid(262144), stream=stream0)
        buf40 = reinterpret_tensor(buf38, (256, 1024), (1024, 1), 0); del buf38  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf39, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg26_1, (1024, 1024), (1, 1024), 0), out=buf40)
        del arg26_1
        buf44 = reinterpret_tensor(buf39, (1, 256, 1024), (262144, 1024, 1), 0); del buf39  # reuse
        # Source Nodes: [hidden_states_16, residual_3], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf27, buf40, arg27_1, arg28_1, arg29_1, buf44, 256, 1024, grid=grid(256), stream=stream0)
        del arg27_1
        del arg28_1
        del arg29_1
        buf45 = reinterpret_tensor(buf37, (256, 4096), (4096, 1), 0); del buf37  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf44, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg30_1, (1024, 4096), (1, 1024), 0), out=buf45)
        del arg30_1
        buf46 = reinterpret_tensor(buf45, (1, 256, 4096), (1048576, 4096, 1), 0); del buf45  # reuse
        # Source Nodes: [hidden_states_18], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf46, arg31_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg31_1
        buf47 = buf40; del buf40  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf46, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg32_1, (4096, 1024), (1, 4096), 0), out=buf47)
        del arg32_1
        buf51 = buf27; del buf27  # reuse
        # Source Nodes: [hidden_states_22, residual_4], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf44, buf47, arg33_1, arg34_1, arg35_1, buf51, 256, 1024, grid=grid(256), stream=stream0)
        del arg33_1
        del arg34_1
        del arg35_1
        buf52 = buf47; del buf47  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg36_1, (1024, 1024), (1, 1024), 0), out=buf52)
        del arg36_1
        buf53 = reinterpret_tensor(buf44, (256, 1024), (1024, 1), 0); del buf44  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg38_1, (1024, 1024), (1, 1024), 0), out=buf53)
        del arg38_1
        buf54 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf53, arg39_1, buf54, 262144, grid=grid(262144), stream=stream0)
        del arg39_1
        buf55 = reinterpret_tensor(buf53, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf53  # reuse
        # Source Nodes: [contiguous_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf52, arg37_1, buf55, 262144, grid=grid(262144), stream=stream0)
        del arg37_1
        buf56 = reinterpret_tensor(buf46, (16, 256, 256), (65536, 256, 1), 0); del buf46  # reuse
        # Source Nodes: [attn_weights_8], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf55, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf54, (16, 64, 256), (16384, 1, 64), 0), out=buf56)
        buf61 = buf32; del buf32  # reuse
        # Source Nodes: [attn_weights_11], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf56, buf61, 4096, 256, grid=grid(4096), stream=stream0)
        buf59 = reinterpret_tensor(buf55, (256, 1024), (1024, 1), 0); del buf55  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf51, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg40_1, (1024, 1024), (1, 1024), 0), out=buf59)
        del arg40_1
        buf60 = reinterpret_tensor(buf52, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf52  # reuse
        # Source Nodes: [value_states_4], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf59, arg41_1, buf60, 262144, grid=grid(262144), stream=stream0)
        del arg41_1
        buf62 = reinterpret_tensor(buf59, (16, 256, 64), (16384, 64, 1), 0); del buf59  # reuse
        # Source Nodes: [attn_output_10, attn_weights_11], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf61, reinterpret_tensor(buf60, (16, 256, 64), (16384, 64, 1), 0), out=buf62)
        buf63 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_13], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf62, buf63, 262144, grid=grid(262144), stream=stream0)
        buf64 = reinterpret_tensor(buf62, (256, 1024), (1024, 1), 0); del buf62  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf63, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg42_1, (1024, 1024), (1, 1024), 0), out=buf64)
        del arg42_1
        buf68 = reinterpret_tensor(buf63, (1, 256, 1024), (262144, 1024, 1), 0); del buf63  # reuse
        # Source Nodes: [hidden_states_27, residual_5], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf51, buf64, arg43_1, arg44_1, arg45_1, buf68, 256, 1024, grid=grid(256), stream=stream0)
        del arg43_1
        del arg44_1
        del arg45_1
        buf69 = reinterpret_tensor(buf61, (256, 4096), (4096, 1), 0); del buf61  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf68, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg46_1, (1024, 4096), (1, 1024), 0), out=buf69)
        del arg46_1
        buf70 = reinterpret_tensor(buf69, (1, 256, 4096), (1048576, 4096, 1), 0); del buf69  # reuse
        # Source Nodes: [hidden_states_29], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf70, arg47_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg47_1
        buf71 = buf64; del buf64  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf70, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg48_1, (4096, 1024), (1, 4096), 0), out=buf71)
        del arg48_1
        buf75 = buf51; del buf51  # reuse
        # Source Nodes: [hidden_states_33, residual_6], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf68, buf71, arg49_1, arg50_1, arg51_1, buf75, 256, 1024, grid=grid(256), stream=stream0)
        del arg49_1
        del arg50_1
        del arg51_1
        buf76 = buf71; del buf71  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg52_1, (1024, 1024), (1, 1024), 0), out=buf76)
        del arg52_1
        buf77 = reinterpret_tensor(buf68, (256, 1024), (1024, 1), 0); del buf68  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg54_1, (1024, 1024), (1, 1024), 0), out=buf77)
        del arg54_1
        buf78 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf77, arg55_1, buf78, 262144, grid=grid(262144), stream=stream0)
        del arg55_1
        buf79 = reinterpret_tensor(buf77, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf77  # reuse
        # Source Nodes: [contiguous_11], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf76, arg53_1, buf79, 262144, grid=grid(262144), stream=stream0)
        del arg53_1
        buf80 = reinterpret_tensor(buf70, (16, 256, 256), (65536, 256, 1), 0); del buf70  # reuse
        # Source Nodes: [attn_weights_12], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf79, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf78, (16, 64, 256), (16384, 1, 64), 0), out=buf80)
        buf85 = buf56; del buf56  # reuse
        # Source Nodes: [attn_weights_15], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf80, buf85, 4096, 256, grid=grid(4096), stream=stream0)
        buf83 = reinterpret_tensor(buf79, (256, 1024), (1024, 1), 0); del buf79  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf75, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg56_1, (1024, 1024), (1, 1024), 0), out=buf83)
        del arg56_1
        buf84 = reinterpret_tensor(buf76, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf76  # reuse
        # Source Nodes: [value_states_6], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf83, arg57_1, buf84, 262144, grid=grid(262144), stream=stream0)
        del arg57_1
        buf86 = reinterpret_tensor(buf83, (16, 256, 64), (16384, 64, 1), 0); del buf83  # reuse
        # Source Nodes: [attn_output_15, attn_weights_15], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf85, reinterpret_tensor(buf84, (16, 256, 64), (16384, 64, 1), 0), out=buf86)
        buf87 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf86, buf87, 262144, grid=grid(262144), stream=stream0)
        buf88 = reinterpret_tensor(buf86, (256, 1024), (1024, 1), 0); del buf86  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf87, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg58_1, (1024, 1024), (1, 1024), 0), out=buf88)
        del arg58_1
        buf92 = reinterpret_tensor(buf87, (1, 256, 1024), (262144, 1024, 1), 0); del buf87  # reuse
        # Source Nodes: [hidden_states_38, residual_7], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf75, buf88, arg59_1, arg60_1, arg61_1, buf92, 256, 1024, grid=grid(256), stream=stream0)
        del arg59_1
        del arg60_1
        del arg61_1
        buf93 = reinterpret_tensor(buf85, (256, 4096), (4096, 1), 0); del buf85  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf92, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg62_1, (1024, 4096), (1, 1024), 0), out=buf93)
        del arg62_1
        buf94 = reinterpret_tensor(buf93, (1, 256, 4096), (1048576, 4096, 1), 0); del buf93  # reuse
        # Source Nodes: [hidden_states_40], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf94, arg63_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg63_1
        buf95 = buf88; del buf88  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf94, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg64_1, (4096, 1024), (1, 4096), 0), out=buf95)
        del arg64_1
        buf99 = buf75; del buf75  # reuse
        # Source Nodes: [hidden_states_44, residual_8], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf92, buf95, arg65_1, arg66_1, arg67_1, buf99, 256, 1024, grid=grid(256), stream=stream0)
        del arg65_1
        del arg66_1
        del arg67_1
        buf100 = buf95; del buf95  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg68_1, (1024, 1024), (1, 1024), 0), out=buf100)
        del arg68_1
        buf101 = reinterpret_tensor(buf92, (256, 1024), (1024, 1), 0); del buf92  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg70_1, (1024, 1024), (1, 1024), 0), out=buf101)
        del arg70_1
        buf102 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf101, arg71_1, buf102, 262144, grid=grid(262144), stream=stream0)
        del arg71_1
        buf103 = reinterpret_tensor(buf101, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf101  # reuse
        # Source Nodes: [contiguous_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf100, arg69_1, buf103, 262144, grid=grid(262144), stream=stream0)
        del arg69_1
        buf104 = reinterpret_tensor(buf94, (16, 256, 256), (65536, 256, 1), 0); del buf94  # reuse
        # Source Nodes: [attn_weights_16], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf103, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf102, (16, 64, 256), (16384, 1, 64), 0), out=buf104)
        buf109 = buf80; del buf80  # reuse
        # Source Nodes: [attn_weights_19], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf104, buf109, 4096, 256, grid=grid(4096), stream=stream0)
        buf107 = reinterpret_tensor(buf103, (256, 1024), (1024, 1), 0); del buf103  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf99, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg72_1, (1024, 1024), (1, 1024), 0), out=buf107)
        del arg72_1
        buf108 = reinterpret_tensor(buf100, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf100  # reuse
        # Source Nodes: [value_states_8], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf107, arg73_1, buf108, 262144, grid=grid(262144), stream=stream0)
        del arg73_1
        buf110 = reinterpret_tensor(buf107, (16, 256, 64), (16384, 64, 1), 0); del buf107  # reuse
        # Source Nodes: [attn_output_20, attn_weights_19], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf109, reinterpret_tensor(buf108, (16, 256, 64), (16384, 64, 1), 0), out=buf110)
        buf111 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_23], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf110, buf111, 262144, grid=grid(262144), stream=stream0)
        buf112 = reinterpret_tensor(buf110, (256, 1024), (1024, 1), 0); del buf110  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf111, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg74_1, (1024, 1024), (1, 1024), 0), out=buf112)
        del arg74_1
        buf116 = reinterpret_tensor(buf111, (1, 256, 1024), (262144, 1024, 1), 0); del buf111  # reuse
        # Source Nodes: [hidden_states_49, residual_9], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf99, buf112, arg75_1, arg76_1, arg77_1, buf116, 256, 1024, grid=grid(256), stream=stream0)
        del arg75_1
        del arg76_1
        del arg77_1
        buf117 = reinterpret_tensor(buf109, (256, 4096), (4096, 1), 0); del buf109  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf116, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg78_1, (1024, 4096), (1, 1024), 0), out=buf117)
        del arg78_1
        buf118 = reinterpret_tensor(buf117, (1, 256, 4096), (1048576, 4096, 1), 0); del buf117  # reuse
        # Source Nodes: [hidden_states_51], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf118, arg79_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg79_1
        buf119 = reinterpret_tensor(buf99, (256, 1024), (1024, 1), 0); del buf99  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf118, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg80_1, (4096, 1024), (1, 4096), 0), out=buf119)
        del arg80_1
        buf123 = reinterpret_tensor(buf112, (1, 256, 1024), (262144, 1024, 1), 0); del buf112  # reuse
        # Source Nodes: [hidden_states_55, residual_10], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf116, buf119, arg81_1, arg82_1, arg83_1, buf123, 256, 1024, grid=grid(256), stream=stream0)
        del arg81_1
        del arg82_1
        del arg83_1
        buf124 = buf119; del buf119  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg84_1, (1024, 1024), (1, 1024), 0), out=buf124)
        del arg84_1
        buf125 = reinterpret_tensor(buf116, (256, 1024), (1024, 1), 0); del buf116  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg86_1, (1024, 1024), (1, 1024), 0), out=buf125)
        del arg86_1
        buf126 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf125, arg87_1, buf126, 262144, grid=grid(262144), stream=stream0)
        del arg87_1
        buf127 = reinterpret_tensor(buf125, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf125  # reuse
        # Source Nodes: [contiguous_17], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf124, arg85_1, buf127, 262144, grid=grid(262144), stream=stream0)
        del arg85_1
        buf128 = reinterpret_tensor(buf118, (16, 256, 256), (65536, 256, 1), 0); del buf118  # reuse
        # Source Nodes: [attn_weights_20], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf127, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf126, (16, 64, 256), (16384, 1, 64), 0), out=buf128)
        buf133 = buf104; del buf104  # reuse
        # Source Nodes: [attn_weights_23], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf128, buf133, 4096, 256, grid=grid(4096), stream=stream0)
        buf131 = reinterpret_tensor(buf127, (256, 1024), (1024, 1), 0); del buf127  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf123, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg88_1, (1024, 1024), (1, 1024), 0), out=buf131)
        del arg88_1
        buf132 = reinterpret_tensor(buf124, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf124  # reuse
        # Source Nodes: [value_states_10], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf131, arg89_1, buf132, 262144, grid=grid(262144), stream=stream0)
        del arg89_1
        buf134 = reinterpret_tensor(buf131, (16, 256, 64), (16384, 64, 1), 0); del buf131  # reuse
        # Source Nodes: [attn_output_25, attn_weights_23], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf133, reinterpret_tensor(buf132, (16, 256, 64), (16384, 64, 1), 0), out=buf134)
        buf135 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_28], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf134, buf135, 262144, grid=grid(262144), stream=stream0)
        buf136 = reinterpret_tensor(buf134, (256, 1024), (1024, 1), 0); del buf134  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf135, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg90_1, (1024, 1024), (1, 1024), 0), out=buf136)
        del arg90_1
        buf140 = reinterpret_tensor(buf135, (1, 256, 1024), (262144, 1024, 1), 0); del buf135  # reuse
        # Source Nodes: [hidden_states_60, residual_11], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf123, buf136, arg91_1, arg92_1, arg93_1, buf140, 256, 1024, grid=grid(256), stream=stream0)
        del arg91_1
        del arg92_1
        del arg93_1
        buf141 = reinterpret_tensor(buf133, (256, 4096), (4096, 1), 0); del buf133  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf140, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg94_1, (1024, 4096), (1, 1024), 0), out=buf141)
        del arg94_1
        buf142 = reinterpret_tensor(buf141, (1, 256, 4096), (1048576, 4096, 1), 0); del buf141  # reuse
        # Source Nodes: [hidden_states_62], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf142, arg95_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg95_1
        buf143 = buf136; del buf136  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf142, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg96_1, (4096, 1024), (1, 4096), 0), out=buf143)
        del arg96_1
        buf147 = buf123; del buf123  # reuse
        # Source Nodes: [hidden_states_66, residual_12], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf140, buf143, arg97_1, arg98_1, arg99_1, buf147, 256, 1024, grid=grid(256), stream=stream0)
        del arg97_1
        del arg98_1
        del arg99_1
        buf148 = buf143; del buf143  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg100_1, (1024, 1024), (1, 1024), 0), out=buf148)
        del arg100_1
        buf149 = reinterpret_tensor(buf140, (256, 1024), (1024, 1), 0); del buf140  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg102_1, (1024, 1024), (1, 1024), 0), out=buf149)
        del arg102_1
        buf150 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf149, arg103_1, buf150, 262144, grid=grid(262144), stream=stream0)
        del arg103_1
        buf151 = reinterpret_tensor(buf149, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf149  # reuse
        # Source Nodes: [contiguous_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf148, arg101_1, buf151, 262144, grid=grid(262144), stream=stream0)
        del arg101_1
        buf152 = reinterpret_tensor(buf142, (16, 256, 256), (65536, 256, 1), 0); del buf142  # reuse
        # Source Nodes: [attn_weights_24], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf151, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf150, (16, 64, 256), (16384, 1, 64), 0), out=buf152)
        buf157 = buf128; del buf128  # reuse
        # Source Nodes: [attn_weights_27], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf152, buf157, 4096, 256, grid=grid(4096), stream=stream0)
        buf155 = reinterpret_tensor(buf151, (256, 1024), (1024, 1), 0); del buf151  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf147, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg104_1, (1024, 1024), (1, 1024), 0), out=buf155)
        del arg104_1
        buf156 = reinterpret_tensor(buf148, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf148  # reuse
        # Source Nodes: [value_states_12], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf155, arg105_1, buf156, 262144, grid=grid(262144), stream=stream0)
        del arg105_1
        buf158 = reinterpret_tensor(buf155, (16, 256, 64), (16384, 64, 1), 0); del buf155  # reuse
        # Source Nodes: [attn_output_30, attn_weights_27], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf157, reinterpret_tensor(buf156, (16, 256, 64), (16384, 64, 1), 0), out=buf158)
        buf159 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_33], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf158, buf159, 262144, grid=grid(262144), stream=stream0)
        buf160 = reinterpret_tensor(buf158, (256, 1024), (1024, 1), 0); del buf158  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf159, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg106_1, (1024, 1024), (1, 1024), 0), out=buf160)
        del arg106_1
        buf164 = reinterpret_tensor(buf159, (1, 256, 1024), (262144, 1024, 1), 0); del buf159  # reuse
        # Source Nodes: [hidden_states_71, residual_13], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf147, buf160, arg107_1, arg108_1, arg109_1, buf164, 256, 1024, grid=grid(256), stream=stream0)
        del arg107_1
        del arg108_1
        del arg109_1
        buf165 = reinterpret_tensor(buf157, (256, 4096), (4096, 1), 0); del buf157  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf164, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg110_1, (1024, 4096), (1, 1024), 0), out=buf165)
        del arg110_1
        buf166 = reinterpret_tensor(buf165, (1, 256, 4096), (1048576, 4096, 1), 0); del buf165  # reuse
        # Source Nodes: [hidden_states_73], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf166, arg111_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg111_1
        buf167 = buf160; del buf160  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf166, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg112_1, (4096, 1024), (1, 4096), 0), out=buf167)
        del arg112_1
        buf171 = buf147; del buf147  # reuse
        # Source Nodes: [hidden_states_77, residual_14], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf164, buf167, arg113_1, arg114_1, arg115_1, buf171, 256, 1024, grid=grid(256), stream=stream0)
        del arg113_1
        del arg114_1
        del arg115_1
        buf172 = buf167; del buf167  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg116_1, (1024, 1024), (1, 1024), 0), out=buf172)
        del arg116_1
        buf173 = reinterpret_tensor(buf164, (256, 1024), (1024, 1), 0); del buf164  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg118_1, (1024, 1024), (1, 1024), 0), out=buf173)
        del arg118_1
        buf174 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf173, arg119_1, buf174, 262144, grid=grid(262144), stream=stream0)
        del arg119_1
        buf175 = reinterpret_tensor(buf173, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf173  # reuse
        # Source Nodes: [contiguous_23], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf172, arg117_1, buf175, 262144, grid=grid(262144), stream=stream0)
        del arg117_1
        buf176 = reinterpret_tensor(buf166, (16, 256, 256), (65536, 256, 1), 0); del buf166  # reuse
        # Source Nodes: [attn_weights_28], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf175, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf174, (16, 64, 256), (16384, 1, 64), 0), out=buf176)
        buf181 = buf152; del buf152  # reuse
        # Source Nodes: [attn_weights_31], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf176, buf181, 4096, 256, grid=grid(4096), stream=stream0)
        buf179 = reinterpret_tensor(buf175, (256, 1024), (1024, 1), 0); del buf175  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf171, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg120_1, (1024, 1024), (1, 1024), 0), out=buf179)
        del arg120_1
        buf180 = reinterpret_tensor(buf172, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf172  # reuse
        # Source Nodes: [value_states_14], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf179, arg121_1, buf180, 262144, grid=grid(262144), stream=stream0)
        del arg121_1
        buf182 = reinterpret_tensor(buf179, (16, 256, 64), (16384, 64, 1), 0); del buf179  # reuse
        # Source Nodes: [attn_output_35, attn_weights_31], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf181, reinterpret_tensor(buf180, (16, 256, 64), (16384, 64, 1), 0), out=buf182)
        buf183 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_38], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf182, buf183, 262144, grid=grid(262144), stream=stream0)
        buf184 = reinterpret_tensor(buf182, (256, 1024), (1024, 1), 0); del buf182  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf183, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg122_1, (1024, 1024), (1, 1024), 0), out=buf184)
        del arg122_1
        buf188 = reinterpret_tensor(buf183, (1, 256, 1024), (262144, 1024, 1), 0); del buf183  # reuse
        # Source Nodes: [hidden_states_82, residual_15], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf171, buf184, arg123_1, arg124_1, arg125_1, buf188, 256, 1024, grid=grid(256), stream=stream0)
        del arg123_1
        del arg124_1
        del arg125_1
        buf189 = reinterpret_tensor(buf181, (256, 4096), (4096, 1), 0); del buf181  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf188, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg126_1, (1024, 4096), (1, 1024), 0), out=buf189)
        del arg126_1
        buf190 = reinterpret_tensor(buf189, (1, 256, 4096), (1048576, 4096, 1), 0); del buf189  # reuse
        # Source Nodes: [hidden_states_84], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf190, arg127_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg127_1
        buf191 = buf184; del buf184  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf190, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg128_1, (4096, 1024), (1, 4096), 0), out=buf191)
        del arg128_1
        buf195 = buf171; del buf171  # reuse
        # Source Nodes: [hidden_states_88, residual_16], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf188, buf191, arg129_1, arg130_1, arg131_1, buf195, 256, 1024, grid=grid(256), stream=stream0)
        del arg129_1
        del arg130_1
        del arg131_1
        buf196 = buf191; del buf191  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf195, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg132_1, (1024, 1024), (1, 1024), 0), out=buf196)
        del arg132_1
        buf197 = reinterpret_tensor(buf188, (256, 1024), (1024, 1), 0); del buf188  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf195, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg134_1, (1024, 1024), (1, 1024), 0), out=buf197)
        del arg134_1
        buf198 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf197, arg135_1, buf198, 262144, grid=grid(262144), stream=stream0)
        del arg135_1
        buf199 = reinterpret_tensor(buf197, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf197  # reuse
        # Source Nodes: [contiguous_26], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf196, arg133_1, buf199, 262144, grid=grid(262144), stream=stream0)
        del arg133_1
        buf200 = reinterpret_tensor(buf190, (16, 256, 256), (65536, 256, 1), 0); del buf190  # reuse
        # Source Nodes: [attn_weights_32], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf199, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf198, (16, 64, 256), (16384, 1, 64), 0), out=buf200)
        buf205 = buf176; del buf176  # reuse
        # Source Nodes: [attn_weights_35], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf200, buf205, 4096, 256, grid=grid(4096), stream=stream0)
        buf203 = reinterpret_tensor(buf199, (256, 1024), (1024, 1), 0); del buf199  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf195, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg136_1, (1024, 1024), (1, 1024), 0), out=buf203)
        del arg136_1
        buf204 = reinterpret_tensor(buf196, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf196  # reuse
        # Source Nodes: [value_states_16], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf203, arg137_1, buf204, 262144, grid=grid(262144), stream=stream0)
        del arg137_1
        buf206 = reinterpret_tensor(buf203, (16, 256, 64), (16384, 64, 1), 0); del buf203  # reuse
        # Source Nodes: [attn_output_40, attn_weights_35], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf205, reinterpret_tensor(buf204, (16, 256, 64), (16384, 64, 1), 0), out=buf206)
        buf207 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_43], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf206, buf207, 262144, grid=grid(262144), stream=stream0)
        buf208 = reinterpret_tensor(buf206, (256, 1024), (1024, 1), 0); del buf206  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf207, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg138_1, (1024, 1024), (1, 1024), 0), out=buf208)
        del arg138_1
        buf212 = reinterpret_tensor(buf207, (1, 256, 1024), (262144, 1024, 1), 0); del buf207  # reuse
        # Source Nodes: [hidden_states_93, residual_17], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf195, buf208, arg139_1, arg140_1, arg141_1, buf212, 256, 1024, grid=grid(256), stream=stream0)
        del arg139_1
        del arg140_1
        del arg141_1
        buf213 = reinterpret_tensor(buf205, (256, 4096), (4096, 1), 0); del buf205  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf212, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg142_1, (1024, 4096), (1, 1024), 0), out=buf213)
        del arg142_1
        buf214 = reinterpret_tensor(buf213, (1, 256, 4096), (1048576, 4096, 1), 0); del buf213  # reuse
        # Source Nodes: [hidden_states_95], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf214, arg143_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg143_1
        buf215 = buf208; del buf208  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf214, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg144_1, (4096, 1024), (1, 4096), 0), out=buf215)
        del arg144_1
        buf219 = buf195; del buf195  # reuse
        # Source Nodes: [hidden_states_99, residual_18], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf212, buf215, arg145_1, arg146_1, arg147_1, buf219, 256, 1024, grid=grid(256), stream=stream0)
        del arg145_1
        del arg146_1
        del arg147_1
        buf220 = buf215; del buf215  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg148_1, (1024, 1024), (1, 1024), 0), out=buf220)
        del arg148_1
        buf221 = reinterpret_tensor(buf212, (256, 1024), (1024, 1), 0); del buf212  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg150_1, (1024, 1024), (1, 1024), 0), out=buf221)
        del arg150_1
        buf222 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf221, arg151_1, buf222, 262144, grid=grid(262144), stream=stream0)
        del arg151_1
        buf223 = reinterpret_tensor(buf221, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf221  # reuse
        # Source Nodes: [contiguous_29], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf220, arg149_1, buf223, 262144, grid=grid(262144), stream=stream0)
        del arg149_1
        buf224 = reinterpret_tensor(buf214, (16, 256, 256), (65536, 256, 1), 0); del buf214  # reuse
        # Source Nodes: [attn_weights_36], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf223, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf222, (16, 64, 256), (16384, 1, 64), 0), out=buf224)
        buf229 = buf200; del buf200  # reuse
        # Source Nodes: [attn_weights_39], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf224, buf229, 4096, 256, grid=grid(4096), stream=stream0)
        buf227 = reinterpret_tensor(buf223, (256, 1024), (1024, 1), 0); del buf223  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf219, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg152_1, (1024, 1024), (1, 1024), 0), out=buf227)
        del arg152_1
        buf228 = reinterpret_tensor(buf220, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf220  # reuse
        # Source Nodes: [value_states_18], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf227, arg153_1, buf228, 262144, grid=grid(262144), stream=stream0)
        del arg153_1
        buf230 = reinterpret_tensor(buf227, (16, 256, 64), (16384, 64, 1), 0); del buf227  # reuse
        # Source Nodes: [attn_output_45, attn_weights_39], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf229, reinterpret_tensor(buf228, (16, 256, 64), (16384, 64, 1), 0), out=buf230)
        buf231 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_48], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf230, buf231, 262144, grid=grid(262144), stream=stream0)
        buf232 = reinterpret_tensor(buf230, (256, 1024), (1024, 1), 0); del buf230  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf231, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg154_1, (1024, 1024), (1, 1024), 0), out=buf232)
        del arg154_1
        buf236 = reinterpret_tensor(buf231, (1, 256, 1024), (262144, 1024, 1), 0); del buf231  # reuse
        # Source Nodes: [hidden_states_104, residual_19], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf219, buf232, arg155_1, arg156_1, arg157_1, buf236, 256, 1024, grid=grid(256), stream=stream0)
        del arg155_1
        del arg156_1
        del arg157_1
        buf237 = reinterpret_tensor(buf229, (256, 4096), (4096, 1), 0); del buf229  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf236, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg158_1, (1024, 4096), (1, 1024), 0), out=buf237)
        del arg158_1
        buf238 = reinterpret_tensor(buf237, (1, 256, 4096), (1048576, 4096, 1), 0); del buf237  # reuse
        # Source Nodes: [hidden_states_106], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf238, arg159_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg159_1
        buf239 = buf232; del buf232  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf238, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg160_1, (4096, 1024), (1, 4096), 0), out=buf239)
        del arg160_1
        buf243 = buf219; del buf219  # reuse
        # Source Nodes: [hidden_states_110, residual_20], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf236, buf239, arg161_1, arg162_1, arg163_1, buf243, 256, 1024, grid=grid(256), stream=stream0)
        del arg161_1
        del arg162_1
        del arg163_1
        buf244 = buf239; del buf239  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf243, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg164_1, (1024, 1024), (1, 1024), 0), out=buf244)
        del arg164_1
        buf245 = reinterpret_tensor(buf236, (256, 1024), (1024, 1), 0); del buf236  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf243, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg166_1, (1024, 1024), (1, 1024), 0), out=buf245)
        del arg166_1
        buf246 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf245, arg167_1, buf246, 262144, grid=grid(262144), stream=stream0)
        del arg167_1
        buf247 = reinterpret_tensor(buf245, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf245  # reuse
        # Source Nodes: [contiguous_32], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf244, arg165_1, buf247, 262144, grid=grid(262144), stream=stream0)
        del arg165_1
        buf248 = reinterpret_tensor(buf238, (16, 256, 256), (65536, 256, 1), 0); del buf238  # reuse
        # Source Nodes: [attn_weights_40], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf247, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf246, (16, 64, 256), (16384, 1, 64), 0), out=buf248)
        buf253 = buf224; del buf224  # reuse
        # Source Nodes: [attn_weights_43], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf248, buf253, 4096, 256, grid=grid(4096), stream=stream0)
        buf251 = reinterpret_tensor(buf247, (256, 1024), (1024, 1), 0); del buf247  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf243, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg168_1, (1024, 1024), (1, 1024), 0), out=buf251)
        del arg168_1
        buf252 = reinterpret_tensor(buf244, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf244  # reuse
        # Source Nodes: [value_states_20], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf251, arg169_1, buf252, 262144, grid=grid(262144), stream=stream0)
        del arg169_1
        buf254 = reinterpret_tensor(buf251, (16, 256, 64), (16384, 64, 1), 0); del buf251  # reuse
        # Source Nodes: [attn_output_50, attn_weights_43], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf253, reinterpret_tensor(buf252, (16, 256, 64), (16384, 64, 1), 0), out=buf254)
        buf255 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_53], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf254, buf255, 262144, grid=grid(262144), stream=stream0)
        buf256 = reinterpret_tensor(buf254, (256, 1024), (1024, 1), 0); del buf254  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf255, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg170_1, (1024, 1024), (1, 1024), 0), out=buf256)
        del arg170_1
        buf260 = reinterpret_tensor(buf255, (1, 256, 1024), (262144, 1024, 1), 0); del buf255  # reuse
        # Source Nodes: [hidden_states_115, residual_21], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf243, buf256, arg171_1, arg172_1, arg173_1, buf260, 256, 1024, grid=grid(256), stream=stream0)
        del arg171_1
        del arg172_1
        del arg173_1
        buf261 = reinterpret_tensor(buf253, (256, 4096), (4096, 1), 0); del buf253  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf260, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg174_1, (1024, 4096), (1, 1024), 0), out=buf261)
        del arg174_1
        buf262 = reinterpret_tensor(buf261, (1, 256, 4096), (1048576, 4096, 1), 0); del buf261  # reuse
        # Source Nodes: [hidden_states_117], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf262, arg175_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg175_1
        buf263 = buf256; del buf256  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf262, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg176_1, (4096, 1024), (1, 4096), 0), out=buf263)
        del arg176_1
        buf267 = buf243; del buf243  # reuse
        # Source Nodes: [hidden_states_121, residual_22], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf260, buf263, arg177_1, arg178_1, arg179_1, buf267, 256, 1024, grid=grid(256), stream=stream0)
        del arg177_1
        del arg178_1
        del arg179_1
        buf268 = buf263; del buf263  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg180_1, (1024, 1024), (1, 1024), 0), out=buf268)
        del arg180_1
        buf269 = reinterpret_tensor(buf260, (256, 1024), (1024, 1), 0); del buf260  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg182_1, (1024, 1024), (1, 1024), 0), out=buf269)
        del arg182_1
        buf270 = empty((1, 16, 256, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [key_states_22], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf269, arg183_1, buf270, 262144, grid=grid(262144), stream=stream0)
        del arg183_1
        buf271 = reinterpret_tensor(buf269, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf269  # reuse
        # Source Nodes: [contiguous_35], Original ATen: [aten.clone]
        triton_poi_fused_clone_2.run(buf268, arg181_1, buf271, 262144, grid=grid(262144), stream=stream0)
        del arg181_1
        buf272 = reinterpret_tensor(buf262, (16, 256, 256), (65536, 256, 1), 0); del buf262  # reuse
        # Source Nodes: [attn_weights_44], Original ATen: [aten.bmm]
        extern_kernels.bmm(reinterpret_tensor(buf271, (16, 256, 64), (16384, 64, 1), 0), reinterpret_tensor(buf270, (16, 64, 256), (16384, 1, 64), 0), out=buf272)
        buf277 = buf248; del buf248  # reuse
        # Source Nodes: [attn_weights_47], Original ATen: [aten._softmax]
        triton_per_fused__softmax_3.run(buf272, buf277, 4096, 256, grid=grid(4096), stream=stream0)
        del buf272
        buf275 = reinterpret_tensor(buf271, (256, 1024), (1024, 1), 0); del buf271  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf267, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg184_1, (1024, 1024), (1, 1024), 0), out=buf275)
        del arg184_1
        buf276 = reinterpret_tensor(buf268, (1, 16, 256, 64), (262144, 16384, 64, 1), 0); del buf268  # reuse
        # Source Nodes: [value_states_22], Original ATen: [aten.clone]
        triton_poi_fused_clone_1.run(buf275, arg185_1, buf276, 262144, grid=grid(262144), stream=stream0)
        del arg185_1
        buf278 = reinterpret_tensor(buf275, (16, 256, 64), (16384, 64, 1), 0); del buf275  # reuse
        # Source Nodes: [attn_output_55, attn_weights_47], Original ATen: [aten._softmax, aten.bmm]
        extern_kernels.bmm(buf277, reinterpret_tensor(buf276, (16, 256, 64), (16384, 64, 1), 0), out=buf278)
        buf279 = empty((1, 256, 16, 64), device='cuda', dtype=torch.float32)
        # Source Nodes: [attn_output_58], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf278, buf279, 262144, grid=grid(262144), stream=stream0)
        buf280 = reinterpret_tensor(buf278, (256, 1024), (1024, 1), 0); del buf278  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf279, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg186_1, (1024, 1024), (1, 1024), 0), out=buf280)
        del arg186_1
        buf284 = reinterpret_tensor(buf279, (1, 256, 1024), (262144, 1024, 1), 0); del buf279  # reuse
        # Source Nodes: [hidden_states_126, residual_23], Original ATen: [aten.add, aten.native_layer_norm]
        triton_per_fused_add_native_layer_norm_5.run(buf267, buf280, arg187_1, arg188_1, arg189_1, buf284, 256, 1024, grid=grid(256), stream=stream0)
        del arg187_1
        del arg188_1
        del arg189_1
        buf285 = reinterpret_tensor(buf277, (256, 4096), (4096, 1), 0); del buf277  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf284, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg190_1, (1024, 4096), (1, 1024), 0), out=buf285)
        del arg190_1
        buf286 = reinterpret_tensor(buf285, (1, 256, 4096), (1048576, 4096, 1), 0); del buf285  # reuse
        # Source Nodes: [hidden_states_128], Original ATen: [aten.gelu]
        triton_poi_fused_gelu_6.run(buf286, arg191_1, 1048576, grid=grid(1048576), stream=stream0)
        del arg191_1
        buf287 = buf280; del buf280  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf286, (256, 4096), (4096, 1), 0), reinterpret_tensor(arg192_1, (4096, 1024), (1, 4096), 0), out=buf287)
        del arg192_1
        del buf286
        ...
        triton_per_fused_add_native_layer_norm_5.run(buf284, buf287, arg193_1, arg194_1, arg195_1, buf291, 256, 1024, grid=grid(256), stream=stream0)
        del arg193_1
        del arg194_1
        del arg195_1
        del buf284
        del buf287
        buf292 = empty((256, 50265), device='cuda', dtype=torch.float32)
        # Source Nodes: [logits], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf291, (256, 1024), (1024, 1), 0), reinterpret_tensor(arg196_1, (1024, 50265), (1, 1024), 0), out=buf292)
        del arg196_1
        del buf291
        buf293 = empty_strided((256, 1), (1, 256), device='cuda', dtype=torch.float32)
        buf294 = empty_strided((256, 1), (1, 256), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_7.run(buf292, buf293, buf294, 256, 50265, grid=grid(256), stream=stream0)
        buf295 = empty((), device='cuda', dtype=torch.float32)
        buf297 = buf295; del buf295  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_8.run(buf297, arg198_1, buf292, buf293, buf294, 1, 256, grid=grid(1), stream=stream0)
        del arg198_1
        return (buf297, reinterpret_tensor(buf292, (1, 256, 50265), (12867840, 50265, 1), 0), buf6, buf12, buf30, buf36, buf54, buf60, buf78, buf84, buf102, buf108, buf126, buf132, buf150, buf156, buf174, buf180, buf198, buf204, buf222, buf228, buf246, buf252, buf270, buf276, )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    arg0_1 = rand_strided((514, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg197_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.int64)
    arg198_1 = rand_strided((1, 256), (256, 1), device='cuda:0', dtype=torch.int64)
