...
def forward(self, L_inputs_input_ids_ : torch.Tensor, L_inputs_labels_ : torch.Tensor):
    ...
    inputs_embeds = self.L__mod___roberta_embeddings_word_embeddings(l_inputs_input_ids_);  l_inputs_input_ids_ = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/camembert/modeling_camembert.py:1007, code: labels = labels.to(prediction_scores.device)
    ...
    view_48 = prediction_scores.view(-1, 32005)
