...
{
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(1L))
            {
                ...
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x2 + (32L*x1) + (4096L*x0)));
                    auto tmp1 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x2 + (32L*x1) + (4096L*x0)));
                    auto tmp2 = tmp0 + tmp1;
                    tmp2.store(out_ptr0 + static_cast<long>(x2 + (32L*x0) + (512L*x1)));
                }
            }
        }
    }
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(16L); x0+=static_cast<long>(1L))
        {
            ...
            for(long x1=static_cast<long>(0L); x1<static_cast<long>(128L); x1+=static_cast<long>(8L))
            {
                ...
                for(long x2=static_cast<long>(0L); x2<static_cast<long>(32L); x2+=static_cast<long>(8L))
                {
                    ...
                    at::vec::transpose_mxn<float,8,8>(in_ptr2 + static_cast<long>(x1 + (128L*x2) + (4096L*x0)), static_cast<long>(128L), tmp1, 8);
                    for (long x1_inner = 0; x1_inner < 8; x1_inner++)
                    {
                        auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x2 + (32L*x1) + (32L*x1_inner) + (4096L*x0)));
                        auto tmp2 = at::vec::Vectorized<float>::loadu(tmp1 + static_cast<long>(8L*x1_inner));
                        auto tmp3 = tmp0 + tmp2;
                        tmp3.store(out_ptr1 + static_cast<long>(x2 + (32L*x0) + (512L*x1) + (512L*x1_inner)));
                    }
                }
            }
        }
...
def call(args):
    ...
    buf2 = empty((1, 128, 512), device='cpu', dtype=torch.float32)
    buf3 = empty((512, ), device='cpu', dtype=torch.float32)
    buf4 = empty((512, ), device='cpu', dtype=torch.float32)
    buf5 = empty((1, 128, 512), device='cpu', dtype=torch.float32)
    ...
    del permute_11
    buf7 = empty((512, 2048), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (512, 128), (1, 512), 0), view_20, out=buf7)
    del view_20
    buf8 = empty((1, 512), device='cpu', dtype=torch.float32)
    ...
    del permute_15
    buf11 = empty((2048, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    ...
    buf16 = empty((512, ), device='cpu', dtype=torch.float32)
    ...
    del view_16
    buf21 = empty((1, 512), device='cpu', dtype=torch.float32)
    ...
    del permute_25
    buf24 = empty_strided((16, 128, 1), (128, 1, 2048), device='cpu', dtype=torch.float32)
    ...
    del permute_27
    buf28 = empty((1, 128, 16, 32), device='cpu', dtype=torch.float32)
    ...
    buf31 = empty((1, 512), device='cpu', dtype=torch.float32)
    buf32 = empty((1, 128, 16, 32), device='cpu', dtype=torch.float32)
    ...
    del tangents_2
    buf33 = reinterpret_tensor(buf28, (128, 512), (512, 1), 0); del buf28  # reuse
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf32, (128, 512), (512, 1), 0), permute_36, out=buf33)
    del permute_36
    buf34 = empty((512, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    ...
    buf36 = reinterpret_tensor(buf26, (128, 512), (512, 1), 0); del buf26  # reuse
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    tangents_2 = rand_strided((1, 16, 128, 32), (65536, 4096, 32, 1), device='cpu', dtype=torch.float32)
    tangents_3 = rand_strided((1, 16, 128, 32), (65536, 4096, 32, 1), device='cpu', dtype=torch.float32)
