...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140634163934016)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 152935184)) \
        and (___check_type_id(L['input_ids_shape'], 140636160884448)) \
        ...
        and (___check_type_id(G['torch'].long, 140636160878336)) \
