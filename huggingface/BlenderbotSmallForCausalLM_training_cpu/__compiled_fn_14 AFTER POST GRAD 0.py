...
def forward(self, primals_1: "f32[512, 512]", primals_2: "f32[512]", primals_3: "f32[512, 512]", primals_4: "f32[512]", primals_5: "f32[512, 512]", primals_6: "f32[512]", primals_7: "f32[512, 512]", primals_8: "f32[512]", primals_9: "f32[512]", primals_10: "f32[512]", primals_11: "f32[2048, 512]", primals_12: "f32[2048]", primals_13: "f32[512, 2048]", primals_14: "f32[512]", primals_15: "f32[512]", primals_16: "f32[512]", primals_17: "f32[1, 128, 512]", primals_18: "f32[1, 1, 128, 128]"):
    ...
    view_3: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(addmm_1, [1, 128, 512]);  addmm_1 = None
    ...
    view_6: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(addmm_2, [1, 128, 512]);  addmm_2 = None
    ...
    view_10: "f32[16, 128, 32]" = torch.ops.aten.reshape.default(clone, [16, -1, 32])
    ...
    view_11: "f32[16, 128, 32]" = torch.ops.aten.reshape.default(clone_1, [16, -1, 32])
    ...
    view_19: "f32[1, 128, 2048]" = torch.ops.aten.reshape.default(addmm_4, [1, 128, 2048])
    ...
    view_20: "f32[128, 2048]" = torch.ops.aten.reshape.default(mul_5, [128, 2048]);  mul_5 = None
    ...
    view_21: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(addmm_5, [1, 128, 512]);  addmm_5 = None
