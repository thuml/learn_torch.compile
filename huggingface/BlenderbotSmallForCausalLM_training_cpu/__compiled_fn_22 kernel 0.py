...
def call(args):
    ...
    return (buf7, reinterpret_tensor(buf0, (1, 128, 50265), (6433920, 50265, 1), 0), primals_3, reinterpret_tensor(primals_2, (128, 512), (512, 1), 0), buf3, buf5, reinterpret_tensor(primals_1, (50265, 512), (512, 1), 0), )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_1 = rand_strided((50265, 512), (512, 1), device='cpu', dtype=torch.float32)
    primals_2 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.float32)
