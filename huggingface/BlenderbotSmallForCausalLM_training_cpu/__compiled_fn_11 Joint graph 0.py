...
def forward(self, primals, tangents):
    ...
    view: "f32[128, 512]" = torch.ops.aten.view.default(primals_17, [128, 512])
    ...
    view_2: "f32[128, 512]" = torch.ops.aten.view.default(primals_17, [128, 512])
    ...
    view_5: "f32[128, 512]" = torch.ops.aten.view.default(primals_17, [128, 512])
    ...
    view_10: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone, [16, -1, 32])
    ...
    view_11: "f32[16, 128, 32]" = torch.ops.aten.view.default(clone_1, [16, -1, 32])
    ...
    add: "f32[1, 16, 128, 128]" = torch.ops.aten.add.Tensor(view_12, primals_18);  view_12 = primals_18 = None
    ...
    add_1: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(primals_17, getitem);  primals_17 = getitem = None
    ...
    mul_3: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_19, 0.5)
    ...
    mul_5: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(mul_3, add_4);  mul_3 = add_4 = None
    ...
    clone_5: "f32[1, 128, 2048]" = torch.ops.aten.clone.default(mul_5);  mul_5 = None
    ...
    add_5: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(add_3, getitem_4);  add_3 = getitem_4 = None
    ...
    sub_2: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_5, getitem_7)
    mul_6: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_2, rsqrt_1);  sub_2 = None
    mul_7: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_6, primals_15);  mul_6 = None
    add_7: "f32[1, 128, 512]" = torch.ops.aten.add.Tensor(mul_7, primals_16);  mul_7 = primals_16 = None
    sub_3: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_5, getitem_7);  add_5 = getitem_7 = None
    mul_8: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_3, rsqrt_1);  sub_3 = None
    ...
    mul_11: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_9, mul_8);  mul_9 = None
    sum_3: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_11, [2], True);  mul_11 = None
    mul_12: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_8, sum_3);  sum_3 = None
    ...
    mul_14: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(tangents_1, mul_8);  mul_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_17: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476)
    erf_1: "f32[1, 128, 2048]" = torch.ops.aten.erf.default(mul_17);  mul_17 = None
    add_8: "f32[1, 128, 2048]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_18: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(add_8, 0.5);  add_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/blenderbot_small/modeling_blenderbot_small.py:422, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_6: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_1, getitem_3);  add_1 = getitem_3 = None
    mul_24: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(sub_6, rsqrt);  sub_6 = None
    ...
    mul_27: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_25, mul_24);  mul_25 = None
    sum_9: "f32[1, 128, 1]" = torch.ops.aten.sum.dim_IntList(mul_27, [2], True);  mul_27 = None
    mul_28: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(mul_24, sum_9);  sum_9 = None
    ...
    mul_30: "f32[1, 128, 512]" = torch.ops.aten.mul.Tensor(add_10, mul_24);  mul_24 = None
    ...
    mm_7: "f32[512, 512]" = torch.ops.aten.mm.default(permute_32, view_5);  permute_32 = view_5 = None
    ...
    mm_9: "f32[512, 512]" = torch.ops.aten.mm.default(permute_37, view_2);  permute_37 = view_2 = None
