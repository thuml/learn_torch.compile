...
def call(args):
    ...
    extern_kernels.addmm(primals_2, reinterpret_tensor(primals_17, (128, 512), (512, 1), 0), reinterpret_tensor(primals_1, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf0)
    del primals_2
    buf1 = empty((128, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [l__self___self_attn_k_proj], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_4, reinterpret_tensor(primals_17, (128, 512), (512, 1), 0), reinterpret_tensor(primals_3, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf1)
    del primals_4
    buf2 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.addmm(primals_6, reinterpret_tensor(primals_17, (128, 512), (512, 1), 0), reinterpret_tensor(primals_5, (512, 512), (1, 512), 0), alpha=1, beta=1, out=buf3)
    del primals_6
    buf4 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    buf5 = empty((1, 16, 128, 32), device='cpu', dtype=torch.float32)
    ...
    extern_kernels.bmm(reinterpret_tensor(buf5, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(buf2, (16, 32, 128), (4096, 1, 32), 0), out=buf6)
    buf7 = empty_strided((16, 128, 1), (128, 1, 2048), device='cpu', dtype=torch.float32)
    ...
    del buf9
    del primals_18
    buf11 = reinterpret_tensor(buf3, (16, 128, 32), (4096, 32, 1), 0); del buf3  # reuse
    # Source Nodes: [attn_output], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf10, reinterpret_tensor(buf4, (16, 128, 32), (4096, 32, 1), 0), out=buf11)
    ...
    buf22 = reinterpret_tensor(buf8, (128, 2048), (2048, 1), 0); del buf8  # reuse
    # Source Nodes: [l__self___fc1], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_12, buf21, reinterpret_tensor(primals_11, (512, 2048), (1, 512), 0), alpha=1, beta=1, out=buf22)
    del primals_12
    buf23 = empty((128, 2048), device='cpu', dtype=torch.float32)
    cpp_fused_gelu_view_5(c_void_p(buf22.data_ptr()), c_void_p(buf23.data_ptr()))
    buf24 = reinterpret_tensor(buf15, (128, 512), (512, 1), 0); del buf15  # reuse
    # Source Nodes: [hidden_states_6], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_14, buf23, reinterpret_tensor(primals_13, (2048, 512), (1, 2048), 0), alpha=1, beta=1, out=buf24)
    del primals_14
    # Source Nodes: [hidden_states_7], Original ATen: [aten.native_dropout]
    buf25 = aten.native_dropout(reinterpret_tensor(buf24, (1, 128, 512), (65536, 512, 1), 0), 0.1, True)
    buf26 = buf25[0]
    buf27 = buf25[1]
    del buf25
    buf28 = buf17; del buf17  # reuse
    buf29 = empty_strided((1, 128, 1), (128, 1, 128), device='cpu', dtype=torch.float32)
    buf31 = reinterpret_tensor(buf24, (1, 128, 512), (65536, 512, 1), 0); del buf24  # reuse
    buf32 = empty((1, 128, 512), device='cpu', dtype=torch.float32)
    buf33 = reinterpret_tensor(buf29, (1, 128, 1), (128, 1, 1), 0); del buf29  # reuse
    buf34 = reinterpret_tensor(buf18, (1, 128, 1), (128, 1, 1), 0); del buf18  # reuse
    ...
    del primals_10
    del primals_16
    return (buf32, buf2, buf4, primals_9, primals_15, reinterpret_tensor(primals_17, (128, 512), (512, 1), 0), buf12, buf16, buf20, buf21, buf22, buf23, buf27, buf31, buf33, reinterpret_tensor(primals_13, (512, 2048), (2048, 1), 0), reinterpret_tensor(primals_11, (2048, 512), (512, 1), 0), buf34, reinterpret_tensor(primals_7, (512, 512), (512, 1), 0), reinterpret_tensor(buf10, (16, 128, 128), (16384, 1, 128), 0), reinterpret_tensor(buf4, (16, 32, 128), (4096, 1, 32), 0), buf35, reinterpret_tensor(buf5, (16, 32, 128), (4096, 1, 32), 0), reinterpret_tensor(buf2, (16, 128, 32), (4096, 32, 1), 0), reinterpret_tensor(primals_5, (512, 512), (512, 1), 0), reinterpret_tensor(primals_3, (512, 512), (512, 1), 0), reinterpret_tensor(primals_1, (512, 512), (512, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_11 = rand_strided((2048, 512), (512, 1), device='cpu', dtype=torch.float32)
    primals_12 = rand_strided((2048, ), (1, ), device='cpu', dtype=torch.float32)
    primals_13 = rand_strided((512, 2048), (2048, 1), device='cpu', dtype=torch.float32)
    ...
    primals_17 = rand_strided((1, 128, 512), (65536, 512, 1), device='cpu', dtype=torch.float32)
