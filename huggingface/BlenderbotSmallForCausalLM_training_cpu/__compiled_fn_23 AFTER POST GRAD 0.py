...
def forward(self, primals_3: "i64[1, 128]", view: "f32[128, 512]", sub_1: "f32[128, 50265]", convert_element_type: "f32[]", permute_3: "f32[50265, 512]", tangents_1: "f32[]", tangents_2: "f32[1, 128, 50265]"):
    ...
    view_5: "f32[128, 50265]" = torch.ops.aten.reshape.default(add, [128, 50265]);  add = None
    ...
    view_6: "f32[1, 128, 512]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 512]);  mm_2 = None
