                       ...
                       long* out_ptr1)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(6433920L); x0+=static_cast<long>(8L))
            {
...
def call(args):
    ...
    buf0 = empty((128, 50265), device='cpu', dtype=torch.float32)
    ...
    buf3 = empty((128, 50265), device='cpu', dtype=torch.float32)
    buf5 = reinterpret_tensor(buf3, (1, 128, 50265), (6433920, 50265, 1), 0); del buf3  # reuse
    ...
    del tangents_1
    del tangents_2
    buf6 = empty((50265, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (50265, 128), (1, 50265), 0), view, out=buf6)
    del view
    buf7 = empty((128, 512), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (128, 50265), (50265, 1), 0), permute_3, out=buf7)
    del buf5
    del permute_3
    return (reinterpret_tensor(buf6, (50265, 512), (512, 1), 0), reinterpret_tensor(buf7, (1, 128, 512), (65536, 512, 1), 0), None, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    sub_1 = rand_strided((128, 50265), (50265, 1), device='cpu', dtype=torch.float32)
    convert_element_type = rand_strided((), (), device='cpu', dtype=torch.float32)
    permute_3 = rand_strided((50265, 512), (512, 1), device='cpu', dtype=torch.float32)
    tangents_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    tangents_2 = rand_strided((1, 128, 50265), (6433920, 50265, 1), device='cpu', dtype=torch.float32)
