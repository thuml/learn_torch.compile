...
def forward(self, iota: "i64[128]", tangents_1: "f32[128, 512]"):
    ...
    full_default_2: "f32[512, 512]" = torch.ops.aten.full.default([512, 512], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
    _unsafe_index_put: "f32[512, 512]" = torch.ops.prims._unsafe_index_put_.default(full_default_2, [iota], where, True);  full_default_2 = iota = where = None
