...
def forward(self, L_cloned_inputs_input_ids_ : torch.Tensor, L_cloned_inputs_labels_ : torch.Tensor):
    ...
    view_37 = l_cloned_inputs_labels_.view(-1);  l_cloned_inputs_labels_ = None
    loss = torch.nn.functional.cross_entropy(view_36, view_37, None, None, -100, None, 'mean', 0.0);  view_36 = view_37 = None
