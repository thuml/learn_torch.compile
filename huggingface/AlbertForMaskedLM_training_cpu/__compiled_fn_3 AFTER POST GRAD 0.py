...
def forward(self, primals_1: "f32[30000, 128]", primals_2: "f32[2, 128]", primals_3: "f32[512, 128]", primals_4: "f32[128]", primals_5: "f32[128]", primals_6: "f32[4096, 128]", primals_7: "f32[4096]", primals_8: "f32[4096, 4096]", primals_9: "f32[4096]", primals_10: "f32[4096, 4096]", primals_11: "f32[4096]", primals_12: "f32[4096, 4096]", primals_13: "f32[4096]", primals_14: "f32[4096, 4096]", primals_15: "f32[4096]", primals_16: "f32[4096]", primals_17: "f32[4096]", primals_18: "f32[16384, 4096]", primals_19: "f32[16384]", primals_20: "f32[4096, 16384]", primals_21: "f32[4096]", primals_22: "f32[4096]", primals_23: "f32[4096]", primals_24: "f32[128, 4096]", primals_25: "f32[128]", primals_26: "f32[128]", primals_27: "f32[128]", primals_28: "f32[30000, 128]", primals_29: "f32[30000]", primals_30: "i64[1, 512]", primals_31: "i64[1, 512]", primals_32: "i64[1, 512]", primals_33: "i64[1, 512]"):
    ...
    view_23: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_6, [1, 512, 4096]);  addmm_6 = None
    ...
    addmm_10: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_40, permute_9)
    ...
    addmm_12: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_44, permute_11)
    view_45: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_12, [1, 512, 4096]);  addmm_12 = None
    ...
    addmm_16: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_62, permute_9)
    ...
    addmm_18: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_66, permute_11)
    view_67: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_18, [1, 512, 4096]);  addmm_18 = None
    ...
    addmm_22: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_84, permute_9)
    ...
    addmm_24: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_88, permute_11)
    view_89: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_24, [1, 512, 4096]);  addmm_24 = None
    ...
    addmm_28: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_106, permute_9)
    ...
    addmm_30: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_110, permute_11)
    view_111: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_30, [1, 512, 4096]);  addmm_30 = None
    ...
    addmm_34: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_128, permute_9)
    ...
    addmm_36: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_132, permute_11)
    view_133: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_36, [1, 512, 4096]);  addmm_36 = None
    ...
    addmm_40: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_150, permute_9)
    ...
    addmm_42: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_154, permute_11)
    view_155: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_42, [1, 512, 4096]);  addmm_42 = None
    ...
    addmm_46: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_172, permute_9)
    ...
    addmm_48: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_176, permute_11)
    view_177: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_48, [1, 512, 4096]);  addmm_48 = None
    ...
    addmm_52: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_194, permute_9)
    ...
    addmm_54: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_198, permute_11)
    view_199: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_54, [1, 512, 4096]);  addmm_54 = None
    ...
    addmm_58: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_216, permute_9)
    ...
    addmm_60: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_220, permute_11)
    view_221: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_60, [1, 512, 4096]);  addmm_60 = None
    ...
    addmm_64: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_238, permute_9)
    ...
    addmm_66: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_242, permute_11)
    view_243: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_66, [1, 512, 4096]);  addmm_66 = None
    ...
    addmm_70: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_15, view_260, permute_9);  primals_15 = None
    ...
    addmm_72: "f32[512, 4096]" = torch.ops.aten.addmm.default(primals_21, view_264, permute_11);  primals_21 = None
    view_265: "f32[1, 512, 4096]" = torch.ops.aten.reshape.default(addmm_72, [1, 512, 4096]);  addmm_72 = None
