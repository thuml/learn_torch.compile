...
def forward(self, primals_1: "f32[30000, 128]", primals_2: "f32[2, 128]", primals_3: "f32[512, 128]", primals_4: "f32[128]", primals_5: "f32[128]", primals_6: "f32[4096, 128]", primals_7: "f32[4096]", primals_8: "f32[4096, 4096]", primals_9: "f32[4096]", primals_10: "f32[4096, 4096]", primals_11: "f32[4096]", primals_12: "f32[4096, 4096]", primals_13: "f32[4096]", primals_14: "f32[4096, 4096]", primals_15: "f32[4096]", primals_16: "f32[4096]", primals_17: "f32[4096]", primals_18: "f32[16384, 4096]", primals_19: "f32[16384]", primals_20: "f32[4096, 16384]", primals_21: "f32[4096]", primals_22: "f32[4096]", primals_23: "f32[4096]", primals_24: "f32[128, 4096]", primals_25: "f32[128]", primals_26: "f32[128]", primals_27: "f32[128]", primals_28: "f32[30000, 128]", primals_29: "f32[30000]", primals_30: "i64[1, 512]", primals_31: "i64[1, 512]", primals_32: "i64[1, 512]", primals_33: "i64[1, 512]"):
    ...
    view_21: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_5, [1, 512, 16384])
    ...
    view_43: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_11, [1, 512, 16384])
    ...
    view_65: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_17, [1, 512, 16384])
    ...
    view_87: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_23, [1, 512, 16384])
    ...
    view_109: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_29, [1, 512, 16384])
    ...
    view_131: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_35, [1, 512, 16384])
    ...
    view_153: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_41, [1, 512, 16384])
    ...
    view_175: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_47, [1, 512, 16384])
    ...
    view_197: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_53, [1, 512, 16384])
    ...
    view_219: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_59, [1, 512, 16384])
    ...
    view_241: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_65, [1, 512, 16384])
    ...
    view_263: "f32[1, 512, 16384]" = torch.ops.aten.view.default(addmm_71, [1, 512, 16384])
    ...
    view_271: "i64[512]" = torch.ops.aten.view.default(primals_33, [-1])
