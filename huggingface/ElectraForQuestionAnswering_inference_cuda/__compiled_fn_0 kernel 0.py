...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_0.run(arg203_1, arg0_1, arg201_1, arg1_1, arg202_1, arg2_1, arg3_1, arg4_1, buf0, buf4, 512, 128, grid=grid(512), stream=stream0)
        del arg0_1
        del arg1_1
        del arg201_1
        del arg202_1
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf281, (512, 256), (256, 1), 0), reinterpret_tensor(arg199_1, (256, 2), (1, 256), 0), out=buf282)
        del arg199_1
        del buf281
        ...
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_4.run(buf282, arg200_1, buf283, buf284, buf285, 1, 512, grid=grid(1), stream=stream0)
        ...
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_5.run(buf282, arg200_1, buf286, buf287, buf288, 1, 512, grid=grid(1), stream=stream0)
        del arg200_1
        del buf282
        buf289 = reinterpret_tensor(buf284, (), (), 0); del buf284  # reuse
        buf290 = buf289; del buf289  # reuse
        # Source Nodes: [add_37, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_forward_6.run(buf290, arg204_1, buf283, buf285, arg205_1, buf286, buf287, buf288, 1, grid=grid(1), stream=stream0)
        del arg204_1
        del arg205_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg199_1 = rand_strided((2, 256), (256, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg204_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg205_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
