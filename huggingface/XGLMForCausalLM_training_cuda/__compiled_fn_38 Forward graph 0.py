...
def forward(self, primals_1: "f32[256008, 1024]", primals_2: "f32[1, 128, 1024]", primals_3: "i64[1, 128]"):
    ...
    full: "i64[1, 128]" = torch.ops.aten.full.default([1, 128], 0, dtype = torch.int64, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    slice_4: "i64[1, 127]" = torch.ops.aten.slice.Tensor(slice_3, 1, 0, -1)
    copy: "i64[1, 127]" = torch.ops.aten.copy.default(slice_4, clone);  slice_4 = clone = None
    slice_scatter: "i64[1, 128]" = torch.ops.aten.slice_scatter.default(slice_3, copy, 1, 0, -1);  slice_3 = copy = None
    ...
    select_1: "i64[1]" = torch.ops.aten.select.int(slice_9, 1, -1)
    copy_1: "i64[1]" = torch.ops.aten.copy.default(select_1, full_default);  select_1 = full_default = None
    select_scatter: "i64[1, 128]" = torch.ops.aten.select_scatter.default(slice_9, copy_1, 1, -1);  slice_9 = copy_1 = None
    ...
    view_4: "i64[128]" = torch.ops.aten.view.default(slice_scatter_2, [-1])
    ...
    return [div, view_1, view, slice_scatter_2, sub_1, convert_element_type, permute_3]
