...
def forward(self, primals, tangents):
    ...
    full_1: "f32[128, 256008]" = torch.ops.aten.full.default([128, 256008], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
