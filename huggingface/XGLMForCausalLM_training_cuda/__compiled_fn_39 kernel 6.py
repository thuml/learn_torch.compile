...
# kernel path: /tmp/torchinductor_youkaichao/ed/cedyadjfq35hcagrto55yfkuh3gnlqutt4av5waonw632r3lg24z.py
# Source Nodes: [], Original ATen: [aten._softmax_backward_data, aten.div, aten.masked_fill, aten.native_dropout_backward, aten.where]

triton_per_fused__softmax_backward_data_div_masked_fill_native_dropout_backward_where_6 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_native_dropout_backward_0.run(tangents_1, getitem_9, buf0, 131072, grid=grid(131072), stream=stream0)
        del getitem_9
        ...
        # Source Nodes: [], Original ATen: [aten.add, aten.native_dropout_backward, aten.native_layer_norm_backward]
        triton_per_fused_add_native_dropout_backward_native_layer_norm_backward_4.run(buf5, primals_11, mul_3, tangents_1, div_1, getitem_5, buf12, buf13, 128, 1024, grid=grid(128), stream=stream0)
        del div_1
        del getitem_5
        del primals_11
        del tangents_1
        ...
        del permute_25
        buf20 = empty((1, 16, 128, 128), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten._softmax_backward_data, aten.div, aten.masked_fill, aten.native_dropout_backward, aten.where]
        triton_per_fused__softmax_backward_data_div_masked_fill_native_dropout_backward_where_6.run(buf18, getitem_3, alias_1, lt, eq, buf20, 2048, 128, grid=grid(2048), stream=stream0)
        del alias_1
        del buf18
        del eq
        del getitem_3
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    getitem_3 = rand_strided((16, 128, 128), (16384, 128, 1), device='cuda:0', dtype=torch.bool)
    view_16 = rand_strided((128, 1024), (1024, 1), device='cuda:0', dtype=torch.float32)
    getitem_5 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cuda:0', dtype=torch.bool)
    ...
    getitem_9 = rand_strided((1, 128, 1024), (131072, 1024, 1), device='cuda:0', dtype=torch.bool)
    ...
    eq = rand_strided((1, 16, 128, 128), (262144, 16384, 128, 1), device='cuda:0', dtype=torch.bool)
    lt = rand_strided((1, 16, 128, 128), (262144, 16384, 128, 1), device='cuda:0', dtype=torch.bool)
