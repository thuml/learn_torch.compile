...
def forward(self, primals_9: "f32[768]", primals_15: "f32[768]", view: "f32[1024, 768]", getitem_1: "b8[12, 1024, 1024]", view_16: "f32[1024, 768]", getitem_3: "b8[1, 1024, 768]", mul_1: "f32[1, 1024, 768]", view_18: "f32[1024, 768]", addmm_4: "f32[1024, 3072]", view_20: "f32[1024, 3072]", getitem_7: "b8[1, 1024, 768]", mul_6: "f32[1, 1024, 768]", div_1: "f32[1, 1024, 1]", permute_11: "f32[768, 3072]", permute_15: "f32[3072, 768]", div_2: "f32[1, 1024, 1]", permute_19: "f32[768, 768]", permute_24: "f32[12, 1024, 1024]", permute_25: "f32[12, 64, 1024]", alias_1: "f32[12, 1024, 1024]", permute_26: "f32[12, 64, 1024]", permute_27: "f32[12, 1024, 64]", permute_31: "f32[768, 768]", permute_36: "f32[768, 768]", permute_40: "f32[768, 768]", tangents_1: "f32[1, 1024, 768]", tangents_2: "f32[1, 12, 1024, 64]", tangents_3: "f32[1, 12, 1024, 64]"):
    ...
    view_19: "f32[1, 1024, 3072]" = torch.ops.aten.reshape.default(addmm_4, [1, 1024, 3072]);  addmm_4 = None
    ...
    view_22: "f32[1024, 768]" = torch.ops.aten.reshape.default(mul_16, [1024, 768]);  mul_16 = None
    ...
    view_24: "f32[1, 1024, 3072]" = torch.ops.aten.reshape.default(mm, [1, 1024, 3072]);  mm = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:460, code: hidden_states = self.activation_fn(self.fc1(hidden_states))
    view_25: "f32[1024, 3072]" = torch.ops.aten.reshape.default(mul_23, [1024, 3072]);  mul_23 = None
    ...
    view_27: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(mm_2, [1, 1024, 768]);  mm_2 = None
    ...
    view_28: "f32[1024, 768]" = torch.ops.aten.reshape.default(mul_32, [1024, 768]);  mul_32 = None
    ...
    view_30: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(mm_4, [1, 1024, 768]);  mm_4 = None
    ...
    view_31: "f32[1, 1024, 12, 64]" = torch.ops.aten.reshape.default(view_30, [1, 1024, 12, 64]);  view_30 = None
    ...
    view_32: "f32[12, 1024, 64]" = torch.ops.aten.reshape.default(permute_23, [12, 1024, 64]);  permute_23 = None
    ...
    mul_35: "f32[12, 1024, 1024]" = torch.ops.aten.mul.Tensor(mul_34, alias_1);  mul_34 = None
    ...
    view_33: "f32[1, 12, 1024, 1024]" = torch.ops.aten.reshape.default(sub_9, [1, 12, 1024, 1024]);  sub_9 = None
    ...
    view_34: "f32[12, 1024, 1024]" = torch.ops.aten.reshape.default(view_33, [12, 1024, 1024]);  view_33 = None
    ...
    view_35: "f32[1, 12, 1024, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 12, 1024, 64]);  bmm_2 = None
    ...
    view_36: "f32[1, 12, 1024, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 12, 1024, 64]);  permute_28 = None
    ...
    view_37: "f32[1, 12, 1024, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 12, 1024, 64]);  bmm_5 = None
    ...
    view_38: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(clone_8, [1, 1024, 768]);  clone_8 = None
    ...
    view_39: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(clone_9, [1, 1024, 768]);  clone_9 = None
    ...
    view_42: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(mm_6, [1, 1024, 768]);  mm_6 = None
    ...
    view_43: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(clone_10, [1, 1024, 768]);  clone_10 = None
    ...
    view_44: "f32[1024, 768]" = torch.ops.aten.reshape.default(view_43, [1024, 768]);  view_43 = None
    ...
    view_45: "f32[768]" = torch.ops.aten.reshape.default(sum_15, [768]);  sum_15 = None
    permute_39: "f32[768, 768]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_46: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(mm_8, [1, 1024, 768]);  mm_8 = None
    ...
    view_47: "f32[1024, 768]" = torch.ops.aten.reshape.default(mul_37, [1024, 768]);  mul_37 = None
    ...
    view_49: "f32[1, 1024, 768]" = torch.ops.aten.reshape.default(mm_10, [1, 1024, 768]);  mm_10 = None
