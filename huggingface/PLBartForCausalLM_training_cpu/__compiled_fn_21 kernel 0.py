                       ...
                       long* out_ptr1)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(51205120L); x0+=static_cast<long>(8L))
            {
    ...
    #pragma omp parallel num_threads(28)
    {
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(1024L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(50000L); x1+=static_cast<long>(8L))
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr4 + static_cast<long>(x1 + (50005L*x0)));
                    auto tmp1 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x1 + (50005L*x0)));
                    auto tmp2 = in_ptr1[static_cast<long>(x0)];
                    auto tmp5 = in_ptr2[static_cast<long>(0L)];
                    auto tmp6 = in_ptr3[static_cast<long>(0L)];
                    auto tmp12 = at::vec::Vectorized<float>::loadu(in_ptr5 + static_cast<long>(x1 + (50005L*x0)));
                    ...
                    tmp18.store(in_out_ptr0 + static_cast<long>(x1 + (50005L*x0)));
                }
                #pragma omp simd simdlen(4) 
                for(long x1=static_cast<long>(50000L); x1<static_cast<long>(50005L); x1+=static_cast<long>(1L))
                {
                    auto tmp0 = in_ptr4[static_cast<long>(x1 + (50005L*x0))];
                    auto tmp1 = in_ptr0[static_cast<long>(x1 + (50005L*x0))];
                    auto tmp2 = in_ptr1[static_cast<long>(x0)];
                    auto tmp5 = in_ptr2[static_cast<long>(0L)];
                    auto tmp6 = in_ptr3[static_cast<long>(0L)];
                    auto tmp11 = in_ptr5[static_cast<long>(x1 + (50005L*x0))];
                    ...
                    in_out_ptr0[static_cast<long>(x1 + (50005L*x0))] = tmp16;
                }
            }
        }
    }
...
def call(args):
    ...
    assert_size_stride(sub_1, (1024, 50005), (50005, 1))
    assert_size_stride(convert_element_type, (), ())
    assert_size_stride(permute_3, (50005, 768), (768, 1))
    assert_size_stride(tangents_1, (), ())
    assert_size_stride(tangents_2, (1, 1024, 50005), (51205120, 50005, 1))
    buf0 = empty((1024, 50005), device='cpu', dtype=torch.float32)
    ...
    buf3 = empty((1024, 50005), device='cpu', dtype=torch.float32)
    buf5 = reinterpret_tensor(buf3, (1, 1024, 50005), (51205120, 50005, 1), 0); del buf3  # reuse
    cpp_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_1(c_void_p(buf5.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(primals_3.data_ptr()), c_void_p(tangents_1.data_ptr()), c_void_p(convert_element_type.data_ptr()), c_void_p(tangents_2.data_ptr()), c_void_p(sub_1.data_ptr()), c_void_p(buf4.data_ptr()))
    del buf0
    del buf4
    ...
    del tangents_1
    del tangents_2
    buf6 = empty((50005, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (50005, 1024), (1, 50005), 0), view, out=buf6)
    del view
    buf7 = empty((1024, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (1024, 50005), (50005, 1), 0), permute_3, out=buf7)
    del buf5
    del permute_3
    return (reinterpret_tensor(buf6, (50005, 768), (768, 1), 0), reinterpret_tensor(buf7, (1, 1024, 768), (786432, 768, 1), 0), None, )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_3 = rand_strided((1, 1024), (1024, 1), device='cpu', dtype=torch.int64)
    view = rand_strided((1024, 768), (768, 1), device='cpu', dtype=torch.float32)
    sub_1 = rand_strided((1024, 50005), (50005, 1), device='cpu', dtype=torch.float32)
    convert_element_type = rand_strided((), (), device='cpu', dtype=torch.float32)
    permute_3 = rand_strided((50005, 768), (768, 1), device='cpu', dtype=torch.float32)
    tangents_1 = rand_strided((), (), device='cpu', dtype=torch.float32)
    tangents_2 = rand_strided((1, 1024, 50005), (51205120, 50005, 1), device='cpu', dtype=torch.float32)
