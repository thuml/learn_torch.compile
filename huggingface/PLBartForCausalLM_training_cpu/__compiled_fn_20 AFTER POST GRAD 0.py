...
def forward(self, primals_1: "f32[50005, 768]", primals_2: "f32[1, 1024, 768]", primals_3: "i64[1, 1024]"):
    ...
    view: "f32[1024, 768]" = torch.ops.aten.reshape.default(primals_2, [1024, 768]);  primals_2 = None
    ...
    view_2: "f32[1024, 50005]" = torch.ops.aten.reshape.default(view_1, [-1, 50005])
