...
def __resume_at_14_15(self, hidden_states, attentions, cross_attentions):
...
def transformed___resume_at_14_15(self, hidden_states, attentions, cross_attentions):
    ...
    return __resume_at_14_15(self, hidden_states, attentions, cross_attentions)

#============ end of __resume_at_14_15 ============#

def __guard_0_for_resume_in___init__(L):
    return (___guarded_code.valid) \
        and (___check_global_state()) \
        and (___check_type_id(L['self'], 152516432)) \
        ...
        and (___check_tensors(L['past_key_values'][0][0], L['past_key_values'][0][1], L['past_key_values'][1][0], L['past_key_values'][1][1], L['past_key_values'][2][0], L['past_key_values'][2][1], L['past_key_values'][3][0], L['past_key_values'][3][1], L['past_key_values'][4][0], L['past_key_values'][4][1], L['past_key_values'][5][0], L['past_key_values'][5][1], L['self'].last_hidden_state, tensor_check_names=tensor_check_names))
...
# Note: if there is a transformed version below, this function might well not be executed directly. Please check the transformed version if possible.
def __resume_at_6_14(self, past_key_values, hidden_states, attentions, cross_attentions):
    self.past_key_values = past_key_values
    self.hidden_states = hidden_states
    self.attentions = attentions
    self.cross_attentions = cross_attentions
...
def transformed___resume_at_6_14(self, past_key_values, hidden_states, attentions, cross_attentions):
    ...
    # Note: this function might well not be executed directly. It might well be transformed again, i.e. adding one more guards and transformed code.
    return __resume_at_6_14(self, past_key_values, hidden_states, attentions, cross_attentions)

#============ end of __resume_at_6_14 ============#
...
def __transformed_code_0_for___init__(self, last_hidden_state, past_key_values, hidden_states, attentions, cross_attentions):
    ...
    return __resume_at_6_14(self, past_key_values, hidden_states, attentions,
        cross_attentions)
