...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140586934127920)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 166363824)) \
        and (___check_type_id(L['input_ids'], 96499152)) \
        ...
        and (___check_type_id(G['torch'].long, 140588900062976)) \
