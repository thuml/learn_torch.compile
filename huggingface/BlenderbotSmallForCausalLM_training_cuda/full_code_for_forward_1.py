...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 139973860717568)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 161186064)) \
        and (___check_type_id(L['input_ids_shape'], 139975855890144)) \
        ...
        and (___check_type_id(G['torch'].long, 139975855884032)) \
