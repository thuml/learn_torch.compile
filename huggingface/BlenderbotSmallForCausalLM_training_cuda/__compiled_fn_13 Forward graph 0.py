...
def forward(self, primals_1: "f32[512, 512]", primals_2: "f32[512]", primals_3: "f32[512, 512]", primals_4: "f32[512]", primals_5: "f32[512, 512]", primals_6: "f32[512]", primals_7: "f32[512, 512]", primals_8: "f32[512]", primals_9: "f32[512]", primals_10: "f32[512]", primals_11: "f32[2048, 512]", primals_12: "f32[2048]", primals_13: "f32[512, 2048]", primals_14: "f32[512]", primals_15: "f32[512]", primals_16: "f32[512]", primals_17: "f32[1, 128, 512]", primals_18: "f32[1, 1, 128, 128]"):
    ...
    view_19: "f32[1, 128, 2048]" = torch.ops.aten.view.default(addmm_4, [1, 128, 2048])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_3: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_19, 0.5)
    mul_4: "f32[1, 128, 2048]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476);  view_19 = None
    ...
    sub_2: "f32[1, 128, 512]" = torch.ops.aten.sub.Tensor(add_5, getitem_7);  add_5 = getitem_7 = None
