...
# kernel path: /tmp/torchinductor_youkaichao/it/citgzpvhecrejkhldfq23h5yt75cubxidradsgpustw4nf37hzs4.py
...
def triton_(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    xmask = xindex < xnumel
    x0 = xindex
    tmp0 = tl.load(in_ptr0 + (1536 + x0), None)
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [embedding], Original ATen: [aten.embedding]
        triton_poi_fused_embedding_1.run(primals_1, buf1, 786432, grid=grid(786432), stream=stream0)
        del primals_1
        return (buf1, buf0, )
