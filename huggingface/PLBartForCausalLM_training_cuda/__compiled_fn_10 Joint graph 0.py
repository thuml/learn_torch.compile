...
def forward(self, primals, tangents):
    primals_1: "f32[768, 768]"; primals_2: "f32[768]"; primals_3: "f32[768, 768]"; primals_4: "f32[768]"; primals_5: "f32[768, 768]"; primals_6: "f32[768]"; primals_7: "f32[768, 768]"; primals_8: "f32[768]"; primals_9: "f32[768]"; primals_10: "f32[768]"; primals_11: "f32[3072, 768]"; primals_12: "f32[3072]"; primals_13: "f32[768, 3072]"; primals_14: "f32[768]"; primals_15: "f32[768]"; primals_16: "f32[768]"; primals_17: "f32[1, 1024, 768]"; primals_18: "f32[1, 1, 1024, 1024]"; tangents_1: "f32[1, 1024, 768]"; tangents_2: "f32[1, 12, 1024, 64]"; tangents_3: "f32[1, 12, 1024, 64]"; 
    ...
    sub_2: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add_5, getitem_9)
    ...
    sub_3: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add_5, getitem_9);  add_5 = getitem_9 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_17: "f32[1, 1024, 3072]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476)
    erf_1: "f32[1, 1024, 3072]" = torch.ops.aten.erf.default(mul_17);  mul_17 = None
    add_8: "f32[1, 1024, 3072]" = torch.ops.aten.add.Tensor(erf_1, 1);  erf_1 = None
    mul_18: "f32[1, 1024, 3072]" = torch.ops.aten.mul.Tensor(add_8, 0.5);  add_8 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/plbart/modeling_plbart.py:433, code: hidden_states = self.self_attn_layer_norm(hidden_states)
    sub_6: "f32[1, 1024, 768]" = torch.ops.aten.sub.Tensor(add_1, getitem_5);  add_1 = getitem_5 = None
    ...
    mul_30: "f32[1, 1024, 768]" = torch.ops.aten.mul.Tensor(add_10, mul_24);  mul_24 = None
