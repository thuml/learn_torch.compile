...
def forward(self, primals, tangents):
    primals_1: "f32[50005, 768]"; primals_2: "f32[1, 1024, 768]"; primals_3: "i64[1, 1024]"; tangents_1: "f32[]"; tangents_2: "f32[1, 1024, 50005]"; 
    ...
    view: "f32[1024, 768]" = torch.ops.aten.view.default(primals_2, [1024, 768]);  primals_2 = None
    ...
    view_2: "f32[1024, 50005]" = torch.ops.aten.view.default(view_1, [-1, 50005])
    ...
    full: "f32[1024, 50005]" = torch.ops.aten.full.default([1024, 50005], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
