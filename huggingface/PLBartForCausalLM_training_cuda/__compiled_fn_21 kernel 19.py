...
# kernel path: /tmp/torchinductor_youkaichao/lo/clok7ofjbh6egm3inl7ev73c4hy6r2uxtsvhft2aifgrsoch2rzj.py
...
# kernel path: /tmp/torchinductor_youkaichao/d7/cd7iwokgzmd33twgwbljrykofqjswfom7hcya3tluct3mf5tcpuz.py
# Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty((1026, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        stream0 = get_cuda_stream(0)
        triton_poi_fused_embedding_dense_backward_0.run(buf0, 787968, grid=grid(787968), stream=stream0)
        buf1 = empty((1, 1024, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: [aten.embedding_dense_backward]
        triton_poi_fused_embedding_dense_backward_1.run(tangents_1, buf1, 786432, grid=grid(786432), stream=stream0)
        del tangents_1
