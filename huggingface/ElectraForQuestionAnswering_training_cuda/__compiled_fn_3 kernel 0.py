...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_native_layer_norm_native_layer_norm_backward_0.run(primals_204, primals_1, primals_202, primals_2, primals_203, primals_3, primals_4, primals_5, buf0, buf4, buf5, buf433, 512, 128, grid=grid(512), stream=stream0)
        del buf0
        del primals_1
        del primals_2
        del primals_3
        ...
        # Source Nodes: [add_2, attention_output, hidden_states_5], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_3.run(buf24, buf9, primals_16, primals_17, buf29, buf30, buf432, 512, 256, grid=grid(512), stream=stream0)
        ...
        # Source Nodes: [add_3, attention_output, hidden_states_10, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf35, buf29, primals_16, primals_17, primals_22, primals_23, buf40, buf41, buf431, 512, 256, grid=grid(512), stream=stream0)
        del primals_17
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf56, buf40, primals_22, primals_23, primals_32, primals_33, buf61, buf62, buf430, 512, 256, grid=grid(512), stream=stream0)
        del primals_23
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf67, buf61, primals_32, primals_33, primals_38, primals_39, buf72, buf73, buf429, 512, 256, grid=grid(512), stream=stream0)
        del primals_33
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf88, buf72, primals_38, primals_39, primals_48, primals_49, buf93, buf94, buf428, 512, 256, grid=grid(512), stream=stream0)
        del primals_39
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf99, buf93, primals_48, primals_49, primals_54, primals_55, buf104, buf105, buf427, 512, 256, grid=grid(512), stream=stream0)
        del primals_49
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf120, buf104, primals_54, primals_55, primals_64, primals_65, buf125, buf126, buf426, 512, 256, grid=grid(512), stream=stream0)
        del primals_55
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf131, buf125, primals_64, primals_65, primals_70, primals_71, buf136, buf137, buf425, 512, 256, grid=grid(512), stream=stream0)
        del primals_65
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf152, buf136, primals_70, primals_71, primals_80, primals_81, buf157, buf158, buf424, 512, 256, grid=grid(512), stream=stream0)
        del primals_71
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf163, buf157, primals_80, primals_81, primals_86, primals_87, buf168, buf169, buf423, 512, 256, grid=grid(512), stream=stream0)
        del primals_81
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf184, buf168, primals_86, primals_87, primals_96, primals_97, buf189, buf190, buf422, 512, 256, grid=grid(512), stream=stream0)
        del primals_87
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf195, buf189, primals_96, primals_97, primals_102, primals_103, buf200, buf201, buf421, 512, 256, grid=grid(512), stream=stream0)
        del primals_97
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf216, buf200, primals_102, primals_103, primals_112, primals_113, buf221, buf222, buf420, 512, 256, grid=grid(512), stream=stream0)
        del primals_103
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf227, buf221, primals_112, primals_113, primals_118, primals_119, buf232, buf233, buf419, 512, 256, grid=grid(512), stream=stream0)
        del primals_113
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf248, buf232, primals_118, primals_119, primals_128, primals_129, buf253, buf254, buf418, 512, 256, grid=grid(512), stream=stream0)
        del primals_119
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf259, buf253, primals_128, primals_129, primals_134, primals_135, buf264, buf265, buf417, 512, 256, grid=grid(512), stream=stream0)
        del primals_129
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf280, buf264, primals_134, primals_135, primals_144, primals_145, buf285, buf286, buf416, 512, 256, grid=grid(512), stream=stream0)
        del primals_135
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf291, buf285, primals_144, primals_145, primals_150, primals_151, buf296, buf297, buf415, 512, 256, grid=grid(512), stream=stream0)
        del primals_145
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf312, buf296, primals_150, primals_151, primals_160, primals_161, buf317, buf318, buf414, 512, 256, grid=grid(512), stream=stream0)
        del primals_151
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf323, buf317, primals_160, primals_161, primals_166, primals_167, buf328, buf329, buf413, 512, 256, grid=grid(512), stream=stream0)
        del primals_161
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf344, buf328, primals_166, primals_167, primals_176, primals_177, buf349, buf350, buf412, 512, 256, grid=grid(512), stream=stream0)
        del primals_167
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf355, buf349, primals_176, primals_177, primals_182, primals_183, buf360, buf361, buf411, 512, 256, grid=grid(512), stream=stream0)
        del primals_177
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf376, buf360, primals_182, primals_183, primals_192, primals_193, buf381, buf382, buf410, 512, 256, grid=grid(512), stream=stream0)
        del primals_183
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_5.run(buf387, buf381, primals_192, primals_193, primals_198, primals_199, buf392, buf393, buf409, 512, 256, grid=grid(512), stream=stream0)
        del buf387
        del primals_193
        del primals_199
        buf394 = empty((512, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf393, reinterpret_tensor(primals_200, (256, 2), (1, 256), 0), out=buf394)
        buf395 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf399 = empty((1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_6.run(buf394, primals_201, buf395, buf399, 1, 512, grid=grid(1), stream=stream0)
        buf396 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf403 = empty((1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_7.run(buf394, primals_201, buf396, buf403, 1, 512, grid=grid(1), stream=stream0)
        del buf394
        del primals_201
        buf400 = empty((1, ), device='cuda', dtype=torch.bool)
        buf404 = empty((1, ), device='cuda', dtype=torch.bool)
        buf434 = empty((), device='cuda', dtype=torch.float32)
        buf405 = empty((1, 1), device='cuda', dtype=torch.bool)
        buf406 = empty((1, 1), device='cuda', dtype=torch.int64)
        buf407 = empty((1, 1), device='cuda', dtype=torch.bool)
        buf408 = empty((1, 1), device='cuda', dtype=torch.int64)
        # Source Nodes: [add_37, end_loss, end_positions, loss, start_loss, start_positions], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_backward, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_backward_nll_loss_forward_8.run(primals_205, primals_206, buf399, buf403, buf400, buf404, buf434, buf405, buf406, buf407, buf408, 1, grid=grid(1), stream=stream0)
        del primals_205
        del primals_206
        return (buf434, buf395, buf396, primals_4, primals_16, primals_22, primals_32, primals_38, primals_48, primals_54, primals_64, primals_70, primals_80, primals_86, primals_96, primals_102, primals_112, primals_118, primals_128, primals_134, primals_144, primals_150, primals_160, primals_166, primals_176, primals_182, primals_192, primals_198, primals_204, primals_202, primals_203, buf4, buf8, reinterpret_tensor(buf7, (512, 128), (128, 1), 0), reinterpret_tensor(buf9, (512, 256), (256, 1), 0), buf13, buf14, buf15, buf18, buf19, buf20, buf17, buf21, buf25, buf29, buf30, buf31, buf32, buf36, buf40, buf41, buf45, buf46, buf47, buf50, buf51, buf52, buf49, buf53, buf57, buf61, buf62, buf63, buf64, buf68, buf72, buf73, buf77, buf78, buf79, buf82, buf83, buf84, buf81, buf85, buf89, buf93, buf94, buf95, buf96, buf100, buf104, buf105, buf109, buf110, buf111, buf114, buf115, buf116, buf113, buf117, buf121, buf125, buf126, buf127, buf128, buf132, buf136, buf137, buf141, buf142, buf143, buf146, buf147, buf148, buf145, buf149, buf153, buf157, buf158, buf159, buf160, buf164, buf168, buf169, buf173, buf174, buf175, buf178, buf179, buf180, buf177, buf181, buf185, buf189, buf190, buf191, buf192, buf196, buf200, buf201, buf205, buf206, buf207, buf210, buf211, buf212, buf209, buf213, buf217, buf221, buf222, buf223, buf224, buf228, buf232, buf233, buf237, buf238, buf239, buf242, buf243, buf244, buf241, buf245, buf249, buf253, buf254, buf255, buf256, buf260, buf264, buf265, buf269, buf270, buf271, buf274, buf275, buf276, buf273, buf277, buf281, buf285, buf286, buf287, buf288, buf292, buf296, buf297, buf301, buf302, buf303, buf306, buf307, buf308, buf305, buf309, buf313, buf317, buf318, buf319, buf320, buf324, buf328, buf329, buf333, buf334, buf335, buf338, buf339, buf340, buf337, buf341, buf345, buf349, buf350, buf351, buf352, buf356, buf360, buf361, buf365, buf366, buf367, buf370, buf371, buf372, buf369, buf373, buf377, buf381, buf382, buf383, buf384, buf388, buf392, buf393, buf399, buf400, buf403, buf404, buf405, buf406, buf407, buf408, reinterpret_tensor(primals_200, (2, 256), (256, 1), 0), buf409, reinterpret_tensor(primals_196, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_194, (1024, 256), (256, 1), 0), buf410, reinterpret_tensor(primals_190, (256, 256), (256, 1), 0), reinterpret_tensor(primals_188, (256, 256), (256, 1), 0), reinterpret_tensor(primals_186, (256, 256), (256, 1), 0), reinterpret_tensor(primals_184, (256, 256), (256, 1), 0), buf411, reinterpret_tensor(primals_180, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_178, (1024, 256), (256, 1), 0), buf412, reinterpret_tensor(primals_174, (256, 256), (256, 1), 0), reinterpret_tensor(primals_172, (256, 256), (256, 1), 0), reinterpret_tensor(primals_170, (256, 256), (256, 1), 0), reinterpret_tensor(primals_168, (256, 256), (256, 1), 0), buf413, reinterpret_tensor(primals_164, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_162, (1024, 256), (256, 1), 0), buf414, reinterpret_tensor(primals_158, (256, 256), (256, 1), 0), reinterpret_tensor(primals_156, (256, 256), (256, 1), 0), reinterpret_tensor(primals_154, (256, 256), (256, 1), 0), reinterpret_tensor(primals_152, (256, 256), (256, 1), 0), buf415, reinterpret_tensor(primals_148, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_146, (1024, 256), (256, 1), 0), buf416, reinterpret_tensor(primals_142, (256, 256), (256, 1), 0), reinterpret_tensor(primals_140, (256, 256), (256, 1), 0), reinterpret_tensor(primals_138, (256, 256), (256, 1), 0), reinterpret_tensor(primals_136, (256, 256), (256, 1), 0), buf417, reinterpret_tensor(primals_132, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals