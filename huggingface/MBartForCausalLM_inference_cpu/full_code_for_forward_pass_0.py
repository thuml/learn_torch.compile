...
def __guard_0_for_forward_pass(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['mod'], 140217755563824)) \
        and (L['mod'].training == False) \
        and (___check_type_id(L['self'], 145566464)) \
        ...
        and (___check_type_id(L['inputs']['input_ids'], 76137920)) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140214489144848))) \
        and (___compile_config_hash() == 'f553eb009ec99a3bb399b6e10855dee9') \
        ...
        and (___check_type_id(G['__import_transformers_dot_models_dot_mbart_dot_modeling_mbart'].torch.long, 140219751077632)) \
