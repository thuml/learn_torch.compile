...
# kernel path: /tmp/torchinductor_youkaichao/vk/cvkuas647bwzf3vwdkqol5yg5erg6lzcdrv3u4jiin5wsjsk4jcw.py
# Source Nodes: [hidden_states_184, hidden_states_186], Original ATen: [aten.gelu, aten.native_layer_norm]
# hidden_states_184 => add_111, erf_12, mul_75, mul_76, mul_77
# hidden_states_186 => add_112, add_113, mul_78, mul_79, rsqrt, sub_62, var_mean
triton_per_fused_gelu_native_layer_norm_7 = async_compile.triton('triton_', '''
import triton
import triton.language as tl
from torch._inductor.ir import ReductionHint
from torch._inductor.ir import TileHint
...
@persistent_reduction(
    ...
    inductor_meta={'autotune_hints': set(), 'kernel_name': 'triton_per_fused_gelu_native_layer_norm_7', 'mutated_arg_names': []}
)
@triton.jit
...
# kernel path: /tmp/torchinductor_youkaichao/qg/cqgfr2iewlqhaumpmqmzj72l5wmg4jozrlsefqvp4vodxv26bccn.py
# Source Nodes: [masked_lm_loss], Original ATen: [aten._log_softmax]
# masked_lm_loss => amax_12, exp_12, sub_63, sum_13
...
# kernel path: /tmp/torchinductor_youkaichao/yf/cyfqu47ofyunfkkbvtlz3lmushh4mlzy7gn33wgzdc4xl3ccdxy3.py
# Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
# masked_lm_loss => convert_element_type_12, div_49, full_default_50, ne_1, ne_2, neg, sum_14, sum_15, where_25
...
def call(args):
    ...
    assert_size_stride(arg164_1, (50265, 768), (768, 1))
    assert_size_stride(arg165_1, (50265, ), (1, ))
    assert_size_stride(arg166_1, (1, 512), (512, 1))
    assert_size_stride(arg167_1, (1, 512), (512, 1))
    assert_size_stride(arg168_1, (1, 512), (512, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0) # no-op to ensure context
        buf2 = empty((1, 512, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [add, embeddings, embeddings_1, hidden_states_1, mean, mul, position_embeddings, pow_1, query_states, sqrt, sub, sub_1, variance], Original ATen: [aten.add, aten.div, aten.embedding, aten.mean, aten.mul, aten.pow, aten.sqrt, aten.sub]
        stream0 = get_cuda_stream(0)
        triton_red_fused_add_div_embedding_mean_mul_pow_sqrt_sub_0.run(arg167_1, arg74_1, arg166_1, arg75_1, arg0_1, arg1_1, buf2, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg166_1
        del arg167_1
        del arg1_1
        ...
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf230, (512, 768), (768, 1), 0), reinterpret_tensor(arg160_1, (768, 768), (1, 768), 0), out=buf231)
        del arg160_1
        buf235 = buf230; del buf230  # reuse
        # Source Nodes: [hidden_states_184, hidden_states_186], Original ATen: [aten.gelu, aten.native_layer_norm]
        triton_per_fused_gelu_native_layer_norm_7.run(buf231, arg161_1, arg162_1, arg163_1, buf235, 512, 768, grid=grid(512), stream=stream0)
        del arg161_1
        del arg162_1
        del arg163_1
        del buf231
        buf236 = empty((512, 50265), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg165_1, reinterpret_tensor(buf235, (512, 768), (768, 1), 0), reinterpret_tensor(arg164_1, (768, 50265), (1, 768), 0), alpha=1, beta=1, out=buf236)
        del arg164_1
        del arg165_1
        del buf235
        buf237 = empty_strided((512, 1), (1, 512), device='cuda', dtype=torch.float32)
        buf238 = empty_strided((512, 1), (1, 512), device='cuda', dtype=torch.float32)
        # Source Nodes: [masked_lm_loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_8.run(buf236, buf237, buf238, 512, 50265, grid=grid(512), stream=stream0)
        buf239 = empty((), device='cuda', dtype=torch.float32)
        buf241 = buf239; del buf239  # reuse
        # Source Nodes: [masked_lm_loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_9.run(buf241, arg168_1, buf236, buf237, buf238, 1, 512, grid=grid(1), stream=stream0)
        del arg168_1
        return (buf241, reinterpret_tensor(buf236, (1, 512, 50265), (25735680, 50265, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg164_1 = rand_strided((50265, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg165_1 = rand_strided((50265, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg166_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg167_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
    arg168_1 = rand_strided((1, 512), (512, 1), device='cuda:0', dtype=torch.int64)
