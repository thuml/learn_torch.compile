...
cpp_fused__to_copy_argmax_eq_index_145 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(const long* in_ptr0,
                       const float* in_ptr1,
                       long* out_ptr0,
                       float* out_ptr1)
{
    ...
    }
    {
        ...
        for(long x0=static_cast<long>(0L); x0<static_cast<long>(2L); x0+=static_cast<long>(1L))
        {
            ...
            auto tmp3 = decltype(tmp2)(tmp2 + 128);
            auto tmp4 = tmp2 < 0;
            auto tmp5 = tmp4 ? tmp3 : tmp2;
            TORCH_CHECK((0 <= tmp5) & (tmp5 < 128L), "index out of bounds: 0 <= tmp5 < 128L")
...
def call(args):
    ...
    cpp_fused_add_native_layer_norm_view_144(c_void_p(buf532.data_ptr()), c_void_p(buf517.data_ptr()), c_void_p(buf539.data_ptr()), c_void_p(arg314_1.data_ptr()), c_void_p(arg315_1.data_ptr()), c_void_p(buf540.data_ptr()), c_void_p(buf541.data_ptr()), c_void_p(buf543.data_ptr()))
    del arg314_1
    del arg315_1
    del buf517
    del buf532
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg316_1 = rand_strided((2, 2048), (2048, 1), device='cpu', dtype=torch.float32)
