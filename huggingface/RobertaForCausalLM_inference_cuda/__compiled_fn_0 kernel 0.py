...
# kernel path: /tmp/torchinductor_youkaichao/dz/cdzas75iqm2eznpqa6bm6f4qvvfddqi6azsj43lo6e5whirssnmg.py
...
# kernel path: /tmp/torchinductor_youkaichao/cp/ccpx6f46ouo2svtztazub22hjve53lo7gdt45m422iq22csib47u.py
...
# kernel path: /tmp/torchinductor_youkaichao/pb/cpbkt4koumgktq4t3h34a4eout7fveotai3s3h55z3v3p7xg54z5.py
# Source Nodes: [lm_loss], Original ATen: [aten.nll_loss_forward]
# lm_loss => convert_element_type_3, div_24, full_default_2, ne_2, ne_3, neg, sum_14, sum_15, where_1
...
def call(args):
    ...
    assert_size_stride(arg201_1, (50265, 768), (768, 1))
    assert_size_stride(arg202_1, (50265, ), (1, ))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_cumsum_ne_0.run(arg205_1, buf0, 512, grid=grid(512), stream=stream0)
        # Source Nodes: [cumsum, mask, ne], Original ATen: [aten._to_copy, aten.cumsum, aten.ne]
        ...
        # Source Nodes: [add, embeddings, embeddings_1, embeddings_2, incremental_indices, inputs_embeds, long, mask, ne, position_embeddings, position_ids, token_type_embeddings, type_as], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mul, aten.native_layer_norm, aten.ne]
        triton_per_fused__to_copy_add_embedding_mul_native_layer_norm_ne_1.run(arg205_1, arg0_1, arg203_1, arg1_1, buf2, arg2_1, arg3_1, arg4_1, buf3, buf7, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg1_1
        del arg203_1
        del arg205_1
        ...
        del arg200_1
        del buf284
        buf289 = empty((512, 50265), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg202_1, reinterpret_tensor(buf288, (512, 768), (768, 1), 0), reinterpret_tensor(arg201_1, (768, 50265), (1, 768), 0), alpha=1, beta=1, out=buf289)
        del arg201_1
        del arg202_1
        del buf288
        buf290 = empty_strided((511, 1), (1, 511), device='cuda', dtype=torch.float32)
        buf291 = empty_strided((511, 1), (1, 511), device='cuda', dtype=torch.float32)
        # Source Nodes: [lm_loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_6.run(buf289, buf290, buf291, 511, 50265, grid=grid(511), stream=stream0)
        buf292 = empty((), device='cuda', dtype=torch.float32)
        buf294 = buf292; del buf292  # reuse
        # Source Nodes: [lm_loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_7.run(buf294, arg204_1, buf289, buf290, buf291, 1, 511, grid=grid(1), stream=stream0)
        del arg204_1
        return (buf294, reinterpret_tensor(buf289, (1, 512, 50265), (25735680, 50265, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg201_1 = rand_strided((50265, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    arg202_1 = rand_strided((50265, ), (1, ), device='cuda:0', dtype=torch.float32)
