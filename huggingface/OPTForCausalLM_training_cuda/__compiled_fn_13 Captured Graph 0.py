...
def forward(self, L_hidden_states_ : torch.Tensor, L_attention_mask_ : torch.Tensor):
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:153, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_2 = query_states.view(1, 2048, 12, 64);  query_states = None
    ...
    view_6 = attn_weights.view(1, 12, 2048, 2048);  attn_weights = None
    ...
    attn_probs = torch.nn.functional.dropout(attn_weights_4, p = 0.0, training = True);  attn_weights_4 = None
    ...
    hidden_states_3 = residual + hidden_states_2;  residual = hidden_states_2 = None
    ...
    residual_1 = hidden_states_3.reshape(-1, 768);  hidden_states_3 = None
    ...
    hidden_states_5 = self.L__self___final_layer_norm(residual_1)
    ...
    hidden_states_6 = self.L__self___fc1(hidden_states_5);  hidden_states_5 = None
    ...
    hidden_states_7 = self.L__self___activation_fn(hidden_states_6);  hidden_states_6 = None
    ...
    hidden_states_8 = self.L__self___fc2(hidden_states_7);  hidden_states_7 = None
    ...
    hidden_states_9 = torch.nn.functional.dropout(hidden_states_8, p = 0.1, training = True);  hidden_states_8 = None
    ...
    add_2 = residual_1 + hidden_states_9;  residual_1 = hidden_states_9 = None
    hidden_states_10 = add_2.view((1, 2048, 768));  add_2 = None
    return (hidden_states_10, key_states, value_states)
