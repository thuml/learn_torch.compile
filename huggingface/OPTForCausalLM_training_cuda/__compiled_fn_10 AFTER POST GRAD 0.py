...
def forward(self, primals_1: "f32[768]", primals_2: "f32[768]", primals_3: "f32[768, 768]", primals_4: "f32[768]", primals_5: "f32[768, 768]", primals_6: "f32[768]", primals_7: "f32[768, 768]", primals_8: "f32[768]", primals_9: "f32[768, 768]", primals_10: "f32[768]", primals_11: "f32[768]", primals_12: "f32[768]", primals_13: "f32[3072, 768]", primals_14: "f32[3072]", primals_15: "f32[768, 3072]", primals_16: "f32[768]", primals_17: "f32[1, 2048, 768]", primals_18: "f32[1, 1, 2048, 2048]"):
    ...
    view: "f32[2048, 768]" = torch.ops.aten.reshape.default(add_1, [2048, 768]);  add_1 = None
    permute: "f32[768, 768]" = torch.ops.aten.permute.default(primals_3, [1, 0]);  primals_3 = None
    
    # No stacktrace found for following nodes
    mm_default_3: "f32[2048, 768]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_3: "f32[2048, 768]" = torch.ops.aten.add.Tensor(mm_default_3, primals_4);  mm_default_3 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:173, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(add_tensor_3, [1, 2048, 768]);  add_tensor_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_2: "f32[2048, 768]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_2: "f32[2048, 768]" = torch.ops.aten.add.Tensor(mm_default_2, primals_6);  mm_default_2 = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:191, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 2048, 768]);  add_tensor_2 = None
    ...
    view_4: "f32[1, 2048, 12, 64]" = torch.ops.aten.reshape.default(view_3, [1, -1, 12, 64]);  view_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[2048, 768]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor_1: "f32[2048, 768]" = torch.ops.aten.add.Tensor(mm_default_1, primals_8);  mm_default_1 = primals_8 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:192, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 2048, 768]);  add_tensor_1 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:153, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_7: "f32[1, 2048, 12, 64]" = torch.ops.aten.reshape.default(view_6, [1, -1, 12, 64]);  view_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/opt/modeling_opt.py:153, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_8: "f32[1, 2048, 12, 64]" = torch.ops.aten.reshape.default(mul_2, [1, 2048, 12, 64]);  mul_2 = None
    ...
    view_9: "f32[12, 2048, 64]" = torch.ops.aten.reshape.default(clone_2, [12, -1, 64]);  clone_2 = None
    ...
    view_10: "f32[12, 2048, 64]" = torch.ops.aten.reshape.default(clone, [12, -1, 64])
    ...
    view_11: "f32[12, 2048, 64]" = torch.ops.aten.reshape.default(clone_1, [12, -1, 64])
    ...
    view_12: "f32[1, 12, 2048, 2048]" = torch.ops.aten.reshape.default(bmm, [1, 12, 2048, 2048]);  bmm = None
    ...
    view_13: "f32[12, 2048, 2048]" = torch.ops.aten.reshape.default(maximum, [12, 2048, 2048]);  maximum = None
    ...
    view_14: "f32[1, 12, 2048, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 12, 2048, 64]);  bmm_1 = None
    ...
    view_15: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(clone_4, [1, 2048, 768]);  clone_4 = None
    ...
    view_17: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(addmm_3, [1, 2048, 768]);  addmm_3 = None
    ...
    view_18: "f32[2048, 768]" = torch.ops.aten.reshape.default(add_3, [-1, 768]);  add_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[2048, 3072]" = torch.ops.aten.mm.default(add_5, permute_9)
    add_tensor: "f32[2048, 3072]" = torch.ops.aten.add.Tensor(mm_default, primals_14);  mm_default = primals_14 = None
    ...
    relu: "f32[2048, 3072]" = torch.ops.aten.relu.default(add_tensor);  add_tensor = None
    ...
    view_19: "f32[1, 2048, 768]" = torch.ops.aten.reshape.default(add_6, [1, 2048, 768]);  add_6 = None
