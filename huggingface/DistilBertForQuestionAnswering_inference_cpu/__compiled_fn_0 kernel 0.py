...
cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_43 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       const float* in_ptr0,
                       const long* in_ptr1,
...
def call(args):
    ...
    cpp_fused_add_embedding_native_layer_norm_0(c_void_p(arg103_1.data_ptr()), c_void_p(arg0_1.data_ptr()), c_void_p(arg102_1.data_ptr()), c_void_p(arg1_1.data_ptr()), c_void_p(arg2_1.data_ptr()), c_void_p(arg3_1.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()), c_void_p(buf3.data_ptr()))
    del arg0_1
    del arg102_1
    del arg103_1
    del arg1_1
    ...
    del buf134
    del buf137
    buf142 = empty((128, 2), device='cpu', dtype=torch.float32)
    # Source Nodes: [logits], Original ATen: [aten.addmm]
    extern_kernels.addmm(arg101_1, reinterpret_tensor(buf141, (128, 768), (768, 1), 0), reinterpret_tensor(arg100_1, (768, 2), (1, 768), 0), alpha=1, beta=1, out=buf142)
    del arg100_1
    del arg101_1
    del buf141
    buf143 = reinterpret_tensor(buf139, (1, 128), (128, 1), 0); del buf139  # reuse
    buf144 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf145 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf146 = reinterpret_tensor(buf138, (1, 128), (128, 1), 0); del buf138  # reuse
    buf147 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf148 = empty((1, 1), device='cpu', dtype=torch.float32)
    buf149 = reinterpret_tensor(buf144, (), (), 0); del buf144  # reuse
    buf150 = buf149; del buf149  # reuse
    cpp_fused__log_softmax_add_clamp_clone_div_nll_loss_forward_43(c_void_p(buf150.data_ptr()), c_void_p(buf142.data_ptr()), c_void_p(arg104_1.data_ptr()), c_void_p(arg105_1.data_ptr()), c_void_p(buf143.data_ptr()), c_void_p(buf145.data_ptr()), c_void_p(buf146.data_ptr()), c_void_p(buf147.data_ptr()), c_void_p(buf148.data_ptr()))
    del arg104_1
    del arg105_1
    return (buf150, buf143, buf146, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg100_1 = rand_strided((2, 768), (768, 1), device='cpu', dtype=torch.float32)
    arg101_1 = rand_strided((2, ), (1, ), device='cpu', dtype=torch.float32)
    arg102_1 = rand_strided((1, 512), (512, 1), device='cpu', dtype=torch.int64)
    arg103_1 = rand_strided((1, 128), (128, 1), device='cpu', dtype=torch.int64)
    arg104_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
    arg105_1 = rand_strided((1, ), (1, ), device='cpu', dtype=torch.int64)
