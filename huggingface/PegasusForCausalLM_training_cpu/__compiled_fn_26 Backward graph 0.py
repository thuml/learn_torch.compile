...
def forward(self, primals_3: "i64[1, 128]", view: "f32[128, 1024]", sub_1: "f32[128, 50265]", convert_element_type: "f32[]", permute_3: "f32[50265, 1024]", tangents_1: "f32[]", tangents_2: "f32[1, 128, 50265]"):
    ...
    alias: "f32[128, 50265]" = torch.ops.aten.alias.default(sub_1);  sub_1 = None
    ...
    full_default_3: "f32[128, 50265]" = torch.ops.aten.full.default([128, 50265], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cpu'), pin_memory = False)
