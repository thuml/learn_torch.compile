...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140268232777568)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 153968848)) \
        and (___check_type_id(L['input_ids_shape'], 140270429818592)) \
        ...
        and (___check_type_id(G['torch'].long, 140270429812480)) \
