...
def call(args):
    ...
    del buf14
    del primals_18
    buf16 = reinterpret_tensor(buf8, (16, 128, 64), (8192, 64, 1), 0); del buf8  # reuse
    # Source Nodes: [attn_output], Original ATen: [aten.bmm]
    extern_kernels.bmm(buf15, reinterpret_tensor(buf9, (16, 128, 64), (8192, 64, 1), 0), out=buf16)
    ...
    buf30 = aten.native_dropout(reinterpret_tensor(buf29, (1, 128, 1024), (131072, 1024, 1), 0), 0.1, True)
    del buf29
    buf31 = buf30[0]
    buf32 = buf30[1]
    del buf30
