...
def call(args):
    ...
    return (buf7, reinterpret_tensor(buf0, (1, 128, 50265), (6433920, 50265, 1), 0), primals_3, reinterpret_tensor(primals_2, (128, 1024), (1024, 1), 0), buf3, buf5, reinterpret_tensor(primals_1, (50265, 1024), (1024, 1), 0), )
