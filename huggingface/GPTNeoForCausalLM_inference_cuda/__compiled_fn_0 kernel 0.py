...
# kernel path: /tmp/torchinductor_youkaichao/wx/cwxywwrkjisiga5b67fan7ohznnggtn4ziplyxpog6ec3gomykxg.py
...
def triton_(in_ptr0, out_ptr0, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        r2 = rindex
        tmp0 = r2 + (7180*x0)
        tmp1 = tl.full([1, 1], 50257, tl.int32)
        tmp2 = tmp0 < tmp1
        tmp3 = tl.load(in_ptr0 + (r2 + (7180*x0) + (50257*x1)), rmask & tmp2 & xmask, eviction_policy='evict_last', other=0.0)
...
# kernel path: /tmp/torchinductor_youkaichao/jh/cjhiaqjjxmhpfz3lhrx7fz2se76sjjrfxqe5dsetpuyoxipm3slp.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
# loss => amax_24
...
# kernel path: /tmp/torchinductor_youkaichao/s3/cs3a574tpu6dod2f5unozsjzq2pura2jttdnvuw7aehkzk5qkv73.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
...
# kernel path: /tmp/torchinductor_youkaichao/gd/cgdrhaq3qil37bcgmbyp37cvgh6hqfsgnd6lzhuqwipyr24q5vid.py
# Source Nodes: [loss], Original ATen: [aten._log_softmax]
# loss => exp_24, sub_73, sum_25
...
# kernel path: /tmp/torchinductor_youkaichao/zg/czgl7kp45ulgt7yoxz6a3apnqspgtyjlligb3z32g4znk5dlhp64.py
# Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
# loss => convert_element_type_24, div_24, full_default_25, ne_1, ne_2, neg, sum_26, sum_27, where_25
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Source Nodes: [hidden_states_217, hidden_states_218], Original ATen: [aten.add, aten.native_layer_norm]
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg316_1 = rand_strided((50257, 2048), (2048, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg342_1 = rand_strided((1, 128), (128, 1), device='cuda:0', dtype=torch.int64)
