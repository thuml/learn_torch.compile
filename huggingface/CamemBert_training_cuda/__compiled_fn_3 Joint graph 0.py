...
def forward(self, primals, tangents):
    ...
    full_1: "f32[512, 32005]" = torch.ops.aten.full.default([512, 32005], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_2: "f32[514, 768]" = torch.ops.aten.full.default([514, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_3: "f32[1, 768]" = torch.ops.aten.full.default([1, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
    ...
    full_4: "f32[32005, 768]" = torch.ops.aten.full.default([32005, 768], 0, dtype = torch.float32, layout = torch.strided, device = device(type='cuda', index=0), pin_memory = False)
