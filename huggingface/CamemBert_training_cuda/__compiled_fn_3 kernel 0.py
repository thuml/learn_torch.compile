...
# kernel path: /tmp/torchinductor_youkaichao/4h/c4hxgpn6c2new4hfodlcwjcxrgrr5bqlxfi6e533bqsxywgnvp66.py
...
# kernel path: /tmp/torchinductor_youkaichao/qz/cqzpkupbm5h5xu7j5dhk5wcchs4umar6xq4z7myl6ig2d6ezcecn.py
...
# kernel path: /tmp/torchinductor_youkaichao/gf/cgfahvfg4smawrplrtlfn6mabrngvjlwvryoee2nkxiv25xq6t3h.py
...
# kernel path: /tmp/torchinductor_youkaichao/4c/c4chf6rixagi7e525reoo4rlucziwh5opjaq77b5tkm2oxvdnxuu.py
...
# kernel path: /tmp/torchinductor_youkaichao/3p/c3po727zpmsctv2hyfca5tui2quxp5frq335dyd7jpssaj25dnya.py
...
def triton_(in_ptr0, out_ptr2, xnumel, rnumel, XBLOCK : tl.constexpr, RBLOCK : tl.constexpr):
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp4 = tl.load(in_ptr0 + (r1 + (32005*x0)), rmask & xmask, eviction_policy='evict_last', other=0.0)
        tmp5 = tmp4 - tmp2
        tmp6 = tl.exp(tmp5)
    ...
    for roffset in range(0, rnumel, RBLOCK):
        ...
        rmask = rindex < rnumel
        r1 = rindex
        tmp10 = tl.load(in_ptr0 + (r1 + (32005*x0)), rmask & xmask, eviction_policy='evict_first', other=0.0)
        tmp11 = tmp10 - tmp2
        tmp12 = tl.log(tmp8)
        tmp13 = tmp11 - tmp12
        tl.store(out_ptr2 + (r1 + (32005*x0)), tmp13, rmask & xmask)
''')


# kernel path: /tmp/torchinductor_youkaichao/cc/ccc2zz2wkgwy3qfjommjnmiuub2kgdcghcwezhhsvjidhmlceaid.py
# Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
# loss => convert_element_type_3, div_24, full_default_2, ne_1, neg, sum_14, sum_15, where_1
...
def triton_(in_out_ptr0, in_ptr0, in_ptr1, out_ptr1, xnumel, rnumel):
    ...
    tmp13 = tl.load(in_ptr1 + (tmp12 + (32005*r0)), rmask, eviction_policy='evict_last', other=0.0)
    tmp14 = -tmp13
    tmp15 = 0.0
...
def call(args):
    ...
    args.clear()
    assert_size_stride(primals_1, (32005, 768), (768, 1))
    assert_size_stride(primals_2, (1, 768), (768, 1))
    assert_size_stride(primals_3, (514, 768), (768, 1))
    ...
    assert_size_stride(primals_202, (32005, 768), (768, 1))
    assert_size_stride(primals_203, (32005, ), (1, ))
    assert_size_stride(primals_204, (1, 514), (514, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_cumsum_ne_0.run(primals_205, buf0, 512, grid=grid(512), stream=stream0)
        # Source Nodes: [cumsum, mask, ne], Original ATen: [aten._to_copy, aten.cumsum, aten.ne]
        ...
        # Source Nodes: [add, embeddings, embeddings_1, embeddings_2, incremental_indices, inputs_embeds, long, mask, ne, position_embeddings, position_ids, token_type_embeddings, type_as], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mul, aten.native_layer_norm, aten.native_layer_norm_backward, aten.ne]
        triton_per_fused__to_copy_add_embedding_mul_native_layer_norm_native_layer_norm_backward_ne_1.run(buf3, primals_205, primals_1, primals_204, primals_2, primals_3, primals_4, primals_5, buf4, buf8, buf9, buf435, 512, 768, grid=grid(512), stream=stream0)
        del primals_1
        del primals_2
        del primals_3
        del primals_5
        ...
        # Source Nodes: [add_4, attention_output, hidden_states_3], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_4.run(buf27, buf11, primals_14, primals_15, buf32, buf33, buf434, 512, 768, grid=grid(512), stream=stream0)
        ...
        # Source Nodes: [add_5, attention_output, hidden_states_8, mixed_query_layer_1], Original ATen: [aten.add, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf38, buf32, primals_14, primals_15, primals_20, primals_21, buf43, buf44, buf433, 512, 768, grid=grid(512), stream=stream0)
        del primals_15
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf59, buf43, primals_20, primals_21, primals_30, primals_31, buf64, buf65, buf432, 512, 768, grid=grid(512), stream=stream0)
        del primals_21
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf70, buf64, primals_30, primals_31, primals_36, primals_37, buf75, buf76, buf431, 512, 768, grid=grid(512), stream=stream0)
        del primals_31
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf91, buf75, primals_36, primals_37, primals_46, primals_47, buf96, buf97, buf430, 512, 768, grid=grid(512), stream=stream0)
        del primals_37
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf102, buf96, primals_46, primals_47, primals_52, primals_53, buf107, buf108, buf429, 512, 768, grid=grid(512), stream=stream0)
        del primals_47
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf123, buf107, primals_52, primals_53, primals_62, primals_63, buf128, buf129, buf428, 512, 768, grid=grid(512), stream=stream0)
        del primals_53
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf134, buf128, primals_62, primals_63, primals_68, primals_69, buf139, buf140, buf427, 512, 768, grid=grid(512), stream=stream0)
        del primals_63
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf155, buf139, primals_68, primals_69, primals_78, primals_79, buf160, buf161, buf426, 512, 768, grid=grid(512), stream=stream0)
        del primals_69
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf166, buf160, primals_78, primals_79, primals_84, primals_85, buf171, buf172, buf425, 512, 768, grid=grid(512), stream=stream0)
        del primals_79
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf187, buf171, primals_84, primals_85, primals_94, primals_95, buf192, buf193, buf424, 512, 768, grid=grid(512), stream=stream0)
        del primals_85
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf198, buf192, primals_94, primals_95, primals_100, primals_101, buf203, buf204, buf423, 512, 768, grid=grid(512), stream=stream0)
        del primals_95
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf219, buf203, primals_100, primals_101, primals_110, primals_111, buf224, buf225, buf422, 512, 768, grid=grid(512), stream=stream0)
        del primals_101
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf230, buf224, primals_110, primals_111, primals_116, primals_117, buf235, buf236, buf421, 512, 768, grid=grid(512), stream=stream0)
        del primals_111
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf251, buf235, primals_116, primals_117, primals_126, primals_127, buf256, buf257, buf420, 512, 768, grid=grid(512), stream=stream0)
        del primals_117
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf262, buf256, primals_126, primals_127, primals_132, primals_133, buf267, buf268, buf419, 512, 768, grid=grid(512), stream=stream0)
        del primals_127
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf283, buf267, primals_132, primals_133, primals_142, primals_143, buf288, buf289, buf418, 512, 768, grid=grid(512), stream=stream0)
        del primals_133
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf294, buf288, primals_142, primals_143, primals_148, primals_149, buf299, buf300, buf417, 512, 768, grid=grid(512), stream=stream0)
        del primals_143
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf315, buf299, primals_148, primals_149, primals_158, primals_159, buf320, buf321, buf416, 512, 768, grid=grid(512), stream=stream0)
        del primals_149
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf326, buf320, primals_158, primals_159, primals_164, primals_165, buf331, buf332, buf415, 512, 768, grid=grid(512), stream=stream0)
        del primals_159
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf347, buf331, primals_164, primals_165, primals_174, primals_175, buf352, buf353, buf414, 512, 768, grid=grid(512), stream=stream0)
        del primals_165
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf358, buf352, primals_174, primals_175, primals_180, primals_181, buf363, buf364, buf413, 512, 768, grid=grid(512), stream=stream0)
        del primals_175
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf379, buf363, primals_180, primals_181, primals_190, primals_191, buf384, buf385, buf412, 512, 768, grid=grid(512), stream=stream0)
        del primals_181
        ...
        triton_per_fused_add_native_layer_norm_native_layer_norm_backward_view_6.run(buf390, buf384, primals_190, primals_191, primals_196, primals_197, buf395, buf396, buf411, 512, 768, grid=grid(512), stream=stream0)
        del primals_191
        del primals_197
        ...
        # Source Nodes: [prediction_scores, x_37, x_38], Original ATen: [aten.gelu, aten.native_layer_norm, aten.native_layer_norm_backward, aten.view]
        triton_per_fused_gelu_native_layer_norm_native_layer_norm_backward_view_7.run(buf397, primals_200, primals_201, buf401, buf402, buf410, 512, 768, grid=grid(512), stream=stream0)
        del primals_201
        buf403 = empty((512, 32005), device='cuda', dtype=torch.float32)
        # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
        extern_kernels.addmm(primals_203, buf402, reinterpret_tensor(primals_202, (768, 32005), (1, 768), 0), alpha=1, beta=1, out=buf403)
        del primals_203
        buf406 = empty((512, 32005), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        triton_red_fused__log_softmax_8.run(buf403, buf406, 512, 32005, grid=grid(512), stream=stream0)
        buf409 = empty((), device='cuda', dtype=torch.float32)
        buf408 = empty((), device='cuda', dtype=torch.float32)
        buf436 = buf409; del buf409  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_9.run(buf436, primals_206, buf406, buf408, 1, 512, grid=grid(1), stream=stream0)
        return (buf436, reinterpret_tensor(buf403, (1, 512, 32005), (16386560, 32005, 1), 0), primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_200, primals_205, primals_206, reinterpret_tensor(primals_204, (1, 512), (514, 1), 0), buf3, buf8, buf12, reinterpret_tensor(buf11, (512, 768), (768, 1), 0), buf16, buf17, buf18, buf21, buf22, buf23, buf20, buf24, buf28, buf32, buf33, buf34, buf35, buf39, buf43, buf44, buf48, buf49, buf50, buf53, buf54, buf55, buf52, buf56, buf60, buf64, buf65, buf66, buf67, buf71, buf75, buf76, buf80, buf81, buf82, buf85, buf86, buf87, buf84, buf88, buf92, buf96, buf97, buf98, buf99, buf103, buf107, buf108, buf112, buf113, buf114, buf117, buf118, buf119, buf116, buf120, buf124, buf128, buf129, buf130, buf131, buf135, buf139, buf140, buf144, buf145, buf146, buf149, buf150, buf151, buf148, buf152, buf156, buf160, buf161, buf162, buf163, buf167, buf171, buf172, buf176, buf177, buf178, buf181, buf182, buf183, buf180, buf184, buf188, buf192, buf193, buf194, buf195, buf199, buf203, buf204, buf208, buf209, buf210, buf213, buf214, buf215, buf212, buf216, buf220, buf224, buf225, buf226, buf227, buf231, buf235, buf236, buf240, buf241, buf242, buf245, buf246, buf247, buf244, buf248, buf252, buf256, buf257, buf258, buf259, buf263, buf267, buf268, buf272, buf273, buf274, buf277, buf278, buf279, buf276, buf280, buf284, buf288, buf289, buf290, buf291, buf295, buf299, buf300, buf304, buf305, buf306, buf309, buf310, buf311, buf308, buf312, buf316, buf320, buf321, buf322, buf323, buf327, buf331, buf332, buf336, buf337, buf338, buf341, buf342, buf343, buf340, buf344, buf348, buf352, buf353, buf354, buf355, buf359, buf363, buf364, buf368, buf369, buf370, buf373, buf374, buf375, buf372, buf376, buf380, buf384, buf385, buf386, buf387, buf391, buf395, buf396, buf397, buf401, buf402, buf406, buf408, reinterpret_tensor(primals_202, (32005, 768), (768, 1), 0), buf410, reinterpret_tensor(primals_198, (768, 768), (768, 1), 0), buf411, reinterpret_tensor(primals_194, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_192, (3072, 768), (768, 1), 0), buf412, reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), reinterpret_tensor(primals_184, (768, 768), (768, 1), 0), reinterpret_tensor(primals_182, (768, 768), (768, 1), 0), buf413, reinterpret_tensor(primals_178, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_176, (3072, 768), (768, 1), 0), buf414, reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), reinterpret_tensor(primals_168, (768, 768), (768, 1), 0), reinterpret_tensor(primals_166, (768, 768), (768, 1), 0), buf415, reinterpret_tensor(primals_162, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_160, (3072, 768), (768, 1), 0), buf416, reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), reinterpret_tensor(primals_152, (768, 768), (768, 1), 0), reinterpret_tensor(primals_150, (768, 768), (768, 1), 0), buf417, reinterpret_tensor(primals_146, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_144, (3072, 768), (768, 1), 0), buf418, reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), reinterpret_tensor(primals_136, (768, 768), (768, 1), 0), reinterpret_tensor(primals_134, (768, 768), (768, 1), 0), buf419, reinterpret_tensor(primals_130, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_128, (3072, 768), (768, 1), 0), buf420, reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), reinterpret_tensor(primals_120, (768, 768), (768, 1), 0), reinterpret_tensor(primals_118, (768, 768), (768, 1), 0), buf421, reinterpret_tensor(primals_114, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_112, (3072, 768), (768, 1), 0), buf422, reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), reinterpret_tensor(primals_104, (768, 768), (768, 1), 0), reinterpret_tensor(primals_102, (768, 768), (768, 1), 0), buf423, reinterpret_tensor(primals_98, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_96, (3072, 768), (768, 1), 0), buf424, reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), reinterpret_tensor(primals_88, (768, 768), (768, 1), 0), reinterpret_tensor(primals_86, (768, 768), (768, 1), 0), buf425, reinterpret_tensor(primals_82, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_80, (3072, 768), (768, 1), 0), buf426, reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), reinterpret_tensor(primals_72, (768, 768), (768, 1), 0), reinterpret_tensor(primals_70, (768, 768), (768, 1), 0), buf427, reinterpret_tensor(primals_66, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_64, (3072, 768), (768, 1), 0), buf428, reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), reinterpret_tensor(primals_56, (768, 768), (768, 1), 0), reinterpret_tensor(primals_54, (768, 768), (768, 1), 0), buf429, reinterpret_tensor(primals_50, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_48, (3072, 768), (768, 1), 0), buf430, reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), reinterpret_tensor(primals_40, (768, 768), (768, 1), 0), reinterpret_tensor(primals_38, (768, 768), (768, 1), 0), buf431, reinterpret_tensor(primals_34, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_32, (3072, 768), (768, 1), 0), buf432, reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), reinterpret_tensor(primals_24, (768, 768), (768, 1), 0), reinterpret_tensor(primals_22, (768, 768), (768, 1), 0), buf433, reinterpret_tensor(primals_18, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_16, (3072, 768), (768, 1), 0), buf434, reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), reinterpret_tensor(primals_8, (768, 768), (768, 1), 0), reinterpret_tensor(primals_6, (768, 768), (768, 1), 0), buf435, )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_1 = rand_strided((32005, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_2 = rand_strided((1, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_3 = rand_strided((514, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    ...
    primals_202 = rand_strided((32005, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    primals_203 = rand_strided((32005, ), (1, ), device='cuda:0', dtype=torch.float32)
    primals_204 = rand_strided((1, 514), (514, 1), device='cuda:0', dtype=torch.int64)
