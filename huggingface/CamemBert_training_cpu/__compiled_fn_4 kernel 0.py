                       ...
                       long* out_ptr1)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(16386560L); x0+=static_cast<long>(8L))
            {
    ...
    #pragma omp parallel num_threads(28)
    {
            ...
            {
                {
                    ...
                    {
                        auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x1 + (32005L*x0)));
                    ...
                    for(long x1=static_cast<long>(32000L); x1<static_cast<long>(32005L); x1+=static_cast<long>(1L))
                    {
                        auto tmp0 = in_ptr0[static_cast<long>(x1 + (32005L*x0))];
                        auto tmp1 = in_ptr1[static_cast<long>(x0)];
                        auto tmp4 = in_ptr2[static_cast<long>(0L)];
                        auto tmp5 = in_ptr3[static_cast<long>(0L)];
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(32000L); x1+=static_cast<long>(8L))
                {
                    auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr4 + static_cast<long>(x1 + (32005L*x0)));
                    auto tmp1 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x1 + (32005L*x0)));
                    auto tmp2 = in_ptr1[static_cast<long>(x0)];
                    auto tmp5 = in_ptr2[static_cast<long>(0L)];
                    auto tmp6 = in_ptr3[static_cast<long>(0L)];
                    auto tmp12 = at::vec::Vectorized<float>::loadu(in_ptr5 + static_cast<long>(x1 + (32005L*x0)));
                    ...
                    tmp18.store(in_out_ptr0 + static_cast<long>(x1 + (32005L*x0)));
                }
                #pragma omp simd simdlen(4) 
                for(long x1=static_cast<long>(32000L); x1<static_cast<long>(32005L); x1+=static_cast<long>(1L))
                {
                    auto tmp0 = in_ptr4[static_cast<long>(x1 + (32005L*x0))];
                    auto tmp1 = in_ptr0[static_cast<long>(x1 + (32005L*x0))];
                    auto tmp2 = in_ptr1[static_cast<long>(x0)];
                    auto tmp5 = in_ptr2[static_cast<long>(0L)];
                    auto tmp6 = in_ptr3[static_cast<long>(0L)];
                    auto tmp11 = in_ptr5[static_cast<long>(x1 + (32005L*x0))];
                    ...
                    in_out_ptr0[static_cast<long>(x1 + (32005L*x0))] = tmp16;
                }
            }
        }
    }
    ...
    {
        {
            ...
            {
                {
                    ...
                    {
                        auto tmp0 = at::vec::Vectorized<float>::loadu(in_ptr0 + static_cast<long>(x0 + (32005L*x1)));
            ...
            for(long x0=static_cast<long>(32000L); x0<static_cast<long>(32005L); x0+=static_cast<long>(1L))
            {
                {
                    float tmp_acc0 = 0;
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(512L); x1+=static_cast<long>(1L))
                    {
                        auto tmp0 = in_ptr0[static_cast<long>(x0 + (32005L*x1))];
                       ...
                       float* out_ptr9)
{
    #pragma omp parallel num_threads(28)
    {
        ...
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(394752L); x0+=static_cast<long>(8L))
            {
                auto tmp0 = static_cast<float>(0.0);
                auto tmp1 = at::vec::Vectorized<float>(tmp0);
...
extern "C" void kernel(float* out_ptr0)
{
    #pragma omp parallel num_threads(28)
    {
        {
            #pragma omp for 
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(24579840L); x0+=static_cast<long>(8L))
            {
                auto tmp0 = static_cast<float>(0.0);
                auto tmp1 = at::vec::Vectorized<float>(tmp0);
                tmp1.store(out_ptr0 + static_cast<long>(x0));
...
def call(args):
    ...
    buf0 = empty((512, 32005), device='cpu', dtype=torch.float32)
    buf1 = empty_strided((512, 1), (1, 512), device='cpu', dtype=torch.int64)
    cpp_fused_nll_loss_backward_nll_loss_forward_0(c_void_p(primals_206.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(buf1.data_ptr()))
    aten.scatter_(buf0,1,buf1,-1.0)
    del buf1
    buf4 = empty_strided((512, 1), (1, 512), device='cpu', dtype=torch.float32)
    buf3 = empty((512, 32005), device='cpu', dtype=torch.float32)
    buf5 = reinterpret_tensor(buf3, (1, 512, 32005), (16386560, 32005, 1), 0); del buf3  # reuse
    cpp_fused__log_softmax_backward_data_add_nll_loss_backward_nll_loss_forward_1(c_void_p(buf5.data_ptr()), c_void_p(buf0.data_ptr()), c_void_p(primals_206.data_ptr()), c_void_p(tangents_1.data_ptr()), c_void_p(convert_element_type_3.data_ptr()), c_void_p(tangents_2.data_ptr()), c_void_p(sub_40.data_ptr()), c_void_p(buf4.data_ptr()))
    del buf0
    ...
    del permute_134
    buf7 = empty((32005, 768), device='cpu', dtype=torch.float32)
    # Source Nodes: [], Original ATen: [aten.mm]
    extern_kernels.mm(reinterpret_tensor(buf5, (32005, 512), (1, 32005), 0), view_266, out=buf7)
    del view_266
    buf8 = empty((1, 32005), device='cpu', dtype=torch.float32)
    ...
    cpp_fused_gelu_gelu_backward_native_layer_norm_backward_sum_2(c_void_p(buf13.data_ptr()), c_void_p(buf5.data_ptr()), c_void_p(primals_200.data_ptr()), c_void_p(mul_91.data_ptr()), c_void_p(div_26.data_ptr()), c_void_p(addmm_72.data_ptr()), c_void_p(buf8.data_ptr()), c_void_p(buf9.data_ptr()), c_void_p(buf10.data_ptr()), c_void_p(buf11.data_ptr()), c_void_p(buf12.data_ptr()))
    del addmm_72
    del buf5
    del div_26
    del mul_91
    ...
    cpp_fused_native_dropout_backward_native_layer_norm_backward_sum_3(c_void_p(buf13.data_ptr()), c_void_p(buf14.data_ptr()), c_void_p(primals_196.data_ptr()), c_void_p(mul_86.data_ptr()), c_void_p(div_27.data_ptr()), c_void_p(getitem_121.data_ptr()), c_void_p(buf16.data_ptr()), c_void_p(buf17.data_ptr()), c_void_p(buf18.data_ptr()), c_void_p(buf19.data_ptr()), c_void_p(buf20.data_ptr()), c_void_p(buf21.data_ptr()), c_void_p(buf22.data_ptr()))
    del div_27
    del getitem_121
    del mul_86
    del primals_196
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_5(c_void_p(buf26.data_ptr()), c_void_p(buf19.data_ptr()), c_void_p(buf27.data_ptr()), c_void_p(primals_190.data_ptr()), c_void_p(mul_81.data_ptr()), c_void_p(div_28.data_ptr()), c_void_p(getitem_117.data_ptr()), c_void_p(buf29.data_ptr()), c_void_p(buf30.data_ptr()), c_void_p(buf31.data_ptr()), c_void_p(buf32.data_ptr()), c_void_p(buf33.data_ptr()), c_void_p(buf34.data_ptr()), c_void_p(buf35.data_ptr()))
    del div_28
    del getitem_117
    del mul_81
    del primals_190
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_11(c_void_p(buf60.data_ptr()), c_void_p(buf53.data_ptr()), c_void_p(buf32.data_ptr()), c_void_p(buf46.data_ptr()), c_void_p(buf50.data_ptr()), c_void_p(buf54.data_ptr()), c_void_p(primals_180.data_ptr()), c_void_p(mul_79.data_ptr()), c_void_p(div_30.data_ptr()), c_void_p(getitem_111.data_ptr()), c_void_p(buf56.data_ptr()), c_void_p(buf58.data_ptr()), c_void_p(buf59.data_ptr()), c_void_p(buf61.data_ptr()), c_void_p(buf62.data_ptr()), c_void_p(buf63.data_ptr()))
    del div_30
    del getitem_111
    del mul_79
    del primals_180
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_13(c_void_p(buf67.data_ptr()), c_void_p(buf60.data_ptr()), c_void_p(buf68.data_ptr()), c_void_p(primals_174.data_ptr()), c_void_p(mul_74.data_ptr()), c_void_p(div_31.data_ptr()), c_void_p(getitem_107.data_ptr()), c_void_p(buf70.data_ptr()), c_void_p(buf71.data_ptr()), c_void_p(buf72.data_ptr()), c_void_p(buf73.data_ptr()), c_void_p(buf74.data_ptr()), c_void_p(buf75.data_ptr()), c_void_p(buf76.data_ptr()))
    del div_31
    del getitem_107
    del mul_74
    del primals_174
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_19(c_void_p(buf101.data_ptr()), c_void_p(buf94.data_ptr()), c_void_p(buf73.data_ptr()), c_void_p(buf87.data_ptr()), c_void_p(buf91.data_ptr()), c_void_p(buf95.data_ptr()), c_void_p(primals_164.data_ptr()), c_void_p(mul_72.data_ptr()), c_void_p(div_33.data_ptr()), c_void_p(getitem_101.data_ptr()), c_void_p(buf97.data_ptr()), c_void_p(buf99.data_ptr()), c_void_p(buf100.data_ptr()), c_void_p(buf102.data_ptr()), c_void_p(buf103.data_ptr()), c_void_p(buf104.data_ptr()))
    del div_33
    del getitem_101
    del mul_72
    del primals_164
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_21(c_void_p(buf108.data_ptr()), c_void_p(buf101.data_ptr()), c_void_p(buf109.data_ptr()), c_void_p(primals_158.data_ptr()), c_void_p(mul_67.data_ptr()), c_void_p(div_34.data_ptr()), c_void_p(getitem_97.data_ptr()), c_void_p(buf111.data_ptr()), c_void_p(buf112.data_ptr()), c_void_p(buf113.data_ptr()), c_void_p(buf114.data_ptr()), c_void_p(buf115.data_ptr()), c_void_p(buf116.data_ptr()), c_void_p(buf117.data_ptr()))
    del div_34
    del getitem_97
    del mul_67
    del primals_158
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_35(c_void_p(buf183.data_ptr()), c_void_p(buf176.data_ptr()), c_void_p(buf155.data_ptr()), c_void_p(buf169.data_ptr()), c_void_p(buf173.data_ptr()), c_void_p(buf177.data_ptr()), c_void_p(primals_132.data_ptr()), c_void_p(mul_58.data_ptr()), c_void_p(div_39.data_ptr()), c_void_p(getitem_81.data_ptr()), c_void_p(buf179.data_ptr()), c_void_p(buf181.data_ptr()), c_void_p(buf182.data_ptr()), c_void_p(buf184.data_ptr()), c_void_p(buf185.data_ptr()), c_void_p(buf186.data_ptr()))
    del div_39
    del getitem_81
    del mul_58
    del primals_132
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_43(c_void_p(buf224.data_ptr()), c_void_p(buf217.data_ptr()), c_void_p(buf196.data_ptr()), c_void_p(buf210.data_ptr()), c_void_p(buf214.data_ptr()), c_void_p(buf218.data_ptr()), c_void_p(primals_116.data_ptr()), c_void_p(mul_51.data_ptr()), c_void_p(div_42.data_ptr()), c_void_p(getitem_71.data_ptr()), c_void_p(buf220.data_ptr()), c_void_p(buf222.data_ptr()), c_void_p(buf223.data_ptr()), c_void_p(buf225.data_ptr()), c_void_p(buf226.data_ptr()), c_void_p(buf227.data_ptr()))
    del div_42
    del getitem_71
    del mul_51
    del primals_116
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_51(c_void_p(buf265.data_ptr()), c_void_p(buf258.data_ptr()), c_void_p(buf237.data_ptr()), c_void_p(buf251.data_ptr()), c_void_p(buf255.data_ptr()), c_void_p(buf259.data_ptr()), c_void_p(primals_100.data_ptr()), c_void_p(mul_44.data_ptr()), c_void_p(div_45.data_ptr()), c_void_p(getitem_61.data_ptr()), c_void_p(buf261.data_ptr()), c_void_p(buf263.data_ptr()), c_void_p(buf264.data_ptr()), c_void_p(buf266.data_ptr()), c_void_p(buf267.data_ptr()), c_void_p(buf268.data_ptr()))
    del div_45
    del getitem_61
    del mul_44
    del primals_100
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_53(c_void_p(buf272.data_ptr()), c_void_p(buf265.data_ptr()), c_void_p(buf273.data_ptr()), c_void_p(primals_94.data_ptr()), c_void_p(mul_39.data_ptr()), c_void_p(div_46.data_ptr()), c_void_p(getitem_57.data_ptr()), c_void_p(buf275.data_ptr()), c_void_p(buf276.data_ptr()), c_void_p(buf277.data_ptr()), c_void_p(buf278.data_ptr()), c_void_p(buf279.data_ptr()), c_void_p(buf280.data_ptr()), c_void_p(buf281.data_ptr()))
    del div_46
    del getitem_57
    del mul_39
    del primals_94
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_59(c_void_p(buf306.data_ptr()), c_void_p(buf299.data_ptr()), c_void_p(buf278.data_ptr()), c_void_p(buf292.data_ptr()), c_void_p(buf296.data_ptr()), c_void_p(buf300.data_ptr()), c_void_p(primals_84.data_ptr()), c_void_p(mul_37.data_ptr()), c_void_p(div_48.data_ptr()), c_void_p(getitem_51.data_ptr()), c_void_p(buf302.data_ptr()), c_void_p(buf304.data_ptr()), c_void_p(buf305.data_ptr()), c_void_p(buf307.data_ptr()), c_void_p(buf308.data_ptr()), c_void_p(buf309.data_ptr()))
    del div_48
    del getitem_51
    del mul_37
    del primals_84
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_61(c_void_p(buf313.data_ptr()), c_void_p(buf306.data_ptr()), c_void_p(buf314.data_ptr()), c_void_p(primals_78.data_ptr()), c_void_p(mul_32.data_ptr()), c_void_p(div_49.data_ptr()), c_void_p(getitem_47.data_ptr()), c_void_p(buf316.data_ptr()), c_void_p(buf317.data_ptr()), c_void_p(buf318.data_ptr()), c_void_p(buf319.data_ptr()), c_void_p(buf320.data_ptr()), c_void_p(buf321.data_ptr()), c_void_p(buf322.data_ptr()))
    del div_49
    del getitem_47
    del mul_32
    del primals_78
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_69(c_void_p(buf354.data_ptr()), c_void_p(buf347.data_ptr()), c_void_p(buf355.data_ptr()), c_void_p(primals_62.data_ptr()), c_void_p(mul_25.data_ptr()), c_void_p(div_52.data_ptr()), c_void_p(getitem_37.data_ptr()), c_void_p(buf357.data_ptr()), c_void_p(buf358.data_ptr()), c_void_p(buf359.data_ptr()), c_void_p(buf360.data_ptr()), c_void_p(buf361.data_ptr()), c_void_p(buf362.data_ptr()), c_void_p(buf363.data_ptr()))
    del div_52
    del getitem_37
    del mul_25
    del primals_62
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_77(c_void_p(buf395.data_ptr()), c_void_p(buf388.data_ptr()), c_void_p(buf396.data_ptr()), c_void_p(primals_46.data_ptr()), c_void_p(mul_18.data_ptr()), c_void_p(div_55.data_ptr()), c_void_p(getitem_27.data_ptr()), c_void_p(buf398.data_ptr()), c_void_p(buf399.data_ptr()), c_void_p(buf400.data_ptr()), c_void_p(buf401.data_ptr()), c_void_p(buf402.data_ptr()), c_void_p(buf403.data_ptr()), c_void_p(buf404.data_ptr()))
    del div_55
    del getitem_27
    del mul_18
    del primals_46
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_85(c_void_p(buf436.data_ptr()), c_void_p(buf429.data_ptr()), c_void_p(buf437.data_ptr()), c_void_p(primals_30.data_ptr()), c_void_p(mul_11.data_ptr()), c_void_p(div_58.data_ptr()), c_void_p(getitem_17.data_ptr()), c_void_p(buf439.data_ptr()), c_void_p(buf440.data_ptr()), c_void_p(buf441.data_ptr()), c_void_p(buf442.data_ptr()), c_void_p(buf443.data_ptr()), c_void_p(buf444.data_ptr()), c_void_p(buf445.data_ptr()))
    del div_58
    del getitem_17
    del mul_11
    del primals_30
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_91(c_void_p(buf470.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(buf442.data_ptr()), c_void_p(buf456.data_ptr()), c_void_p(buf460.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(primals_20.data_ptr()), c_void_p(mul_9.data_ptr()), c_void_p(div_60.data_ptr()), c_void_p(getitem_11.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf468.data_ptr()), c_void_p(buf469.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()))
    del div_60
    del getitem_11
    del mul_9
    del primals_20
    ...
    cpp_fused_add_native_dropout_backward_native_layer_norm_backward_sum_93(c_void_p(buf477.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(primals_14.data_ptr()), c_void_p(mul_4.data_ptr()), c_void_p(div_61.data_ptr()), c_void_p(getitem_7.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()), c_void_p(buf486.data_ptr()))
    del buf477
    del div_61
    del getitem_7
    del mul_4
    ...
    buf514 = empty((514, 768), device='cpu', dtype=torch.float32)
    cpp_fused_add_embedding_dense_backward_native_dropout_backward_native_layer_norm_backward_nll_loss_forward_sum_99(c_void_p(buf508.data_ptr()), c_void_p(buf504.data_ptr()), c_void_p(buf497.data_ptr()), c_void_p(buf501.data_ptr()), c_void_p(buf505.data_ptr()), c_void_p(getitem_3.data_ptr()), c_void_p(primals_4.data_ptr()), c_void_p(mul_2.data_ptr()), c_void_p(div_63.data_ptr()), c_void_p(add_1.data_ptr()), c_void_p(expand.data_ptr()), c_void_p(primals_205.data_ptr()), c_void_p(buf507.data_ptr()), c_void_p(buf509.data_ptr()), c_void_p(buf510.data_ptr()), c_void_p(buf515.data_ptr()), c_void_p(buf519.data_ptr()), c_void_p(buf523.data_ptr()), c_void_p(buf512.data_ptr()), c_void_p(buf513.data_ptr()), c_void_p(buf514.data_ptr()))
    del buf497
    del buf501
    del buf504
    del buf505
    ...
    del mul_2
    del primals_4
    aten.index_put_(buf514, [add_1], buf515, True)
    del add_1
    del buf515
    ...
    del buf519
    del expand
    buf522 = empty((32005, 768), device='cpu', dtype=torch.float32)
    cpp_fused_embedding_dense_backward_101(c_void_p(buf522.data_ptr()))
    aten.index_put_(buf522, [primals_205], buf523, True)
    del buf523
    del primals_205
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    expand = rand_strided((1, 512), (514, 1), device='cpu', dtype=torch.int64)
    ...
    sub_40 = rand_strided((512, 32005), (32005, 1), device='cpu', dtype=torch.float32)
    convert_element_type_3 = rand_strided((), (), device='cpu', dtype=torch.float32)
    permute_134 = rand_strided((32005, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    tangents_2 = rand_strided((1, 512, 32005), (16386560, 32005, 1), device='cpu', dtype=torch.float32)
