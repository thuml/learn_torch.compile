            ...
            {
                {
                    ...
                    for(long x1=static_cast<long>(0L); x1<static_cast<long>(768L); x1+=static_cast<long>(8L))
                    {
                        ...
                        auto tmp1 = decltype(tmp0)(tmp0 + 32005);
                        auto tmp2 = tmp0 < 0;
                        auto tmp3 = tmp2 ? tmp1 : tmp0;
                        TORCH_CHECK((0 <= tmp3) & (tmp3 < 32005L), "index out of bounds: 0 <= tmp3 < 32005L")
                        auto tmp4 = at::vec::Vectorized<float>::loadu(in_ptr1 + static_cast<long>(x1 + (768L*tmp3)));
                        auto tmp6 = decltype(tmp5)(tmp5 + 1);
                        auto tmp7 = tmp5 < 0;
                        auto tmp8 = tmp7 ? tmp6 : tmp5;
                        TORCH_CHECK((0 <= tmp8) & (tmp8 < 1L), "index out of bounds: 0 <= tmp8 < 1L")
                        auto tmp10 = tmp4 + tmp9;
                        auto tmp12 = decltype(tmp11)(tmp11 + 514);
                        auto tmp13 = tmp11 < 0;
                        auto tmp14 = tmp13 ? tmp12 : tmp11;
                        TORCH_CHECK((0 <= tmp14) & (tmp14 < 514L), "index out of bounds: 0 <= tmp14 < 514L")
...
cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_87 = async_compile.cpp('''
#include "/tmp/torchinductor_youkaichao/2l/c2ljzlm4sosod7u6lyrroqdba6hmfcyijrric6p4t3fhbcmw6osp.h"
extern "C" void kernel(float* in_out_ptr0,
                       float* in_out_ptr1,
                       float* in_out_ptr2,
        ...
        }
        {
            ...
            for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
            {
                for(long x1=static_cast<long>(0L); x1<static_cast<long>(32000L); x1+=static_cast<long>(8L))
                {
                    ...
                    auto tmp7 = tmp3 - tmp6;
                    tmp7.store(out_ptr2 + static_cast<long>(x1 + (32005L*x0)));
                }
                ...
                for(long x1=static_cast<long>(32000L); x1<static_cast<long>(32005L); x1+=static_cast<long>(1L))
                {
                    ...
                    out_ptr2[static_cast<long>(x1 + (32005L*x0))] = tmp5;
                }
            }
        }
        #pragma omp single
            ...
            {
                {
                    ...
                    for(long x0=static_cast<long>(0L); x0<static_cast<long>(512L); x0+=static_cast<long>(1L))
                    {
                        ...
                        auto tmp6 = decltype(tmp5)(tmp5 + 32005);
                        auto tmp7 = tmp5 < 0;
                        auto tmp8 = tmp7 ? tmp6 : tmp5;
                        TORCH_CHECK((0 <= tmp8) & (tmp8 < 32005L), "index out of bounds: 0 <= tmp8 < 32005L")
                        auto tmp9 = out_ptr2[static_cast<long>(tmp8 + (32005L*x0))];
...
def call(args):
    ...
    cpp_fused__to_copy_cumsum_ne_0(c_void_p(primals_205.data_ptr()), c_void_p(buf0.data_ptr()))
    ...
    del primals_201
    buf463 = empty((512, 32005), device='cpu', dtype=torch.float32)
    # Source Nodes: [prediction_scores], Original ATen: [aten.addmm]
    extern_kernels.addmm(primals_203, buf462, reinterpret_tensor(primals_202, (768, 32005), (1, 768), 0), alpha=1, beta=1, out=buf463)
    del primals_203
    buf464 = reinterpret_tensor(buf458, (512, 1), (1, 512), 0); del buf458  # reuse
    buf465 = empty_strided((512, 1), (1, 512), device='cpu', dtype=torch.float32)
    buf466 = empty((512, 32005), device='cpu', dtype=torch.float32)
    ...
    buf470 = reinterpret_tensor(buf459, (1, 512, 1), (512, 1, 1), 0); del buf459  # reuse
    buf471 = reinterpret_tensor(buf453, (1, 512, 1), (512, 1, 1), 0); del buf453  # reuse
    buf472 = reinterpret_tensor(buf442, (1, 512, 1), (512, 1, 1), 0); del buf442  # reuse
    buf473 = reinterpret_tensor(buf416, (1, 512, 1), (512, 1, 1), 0); del buf416  # reuse
    buf474 = reinterpret_tensor(buf405, (1, 512, 1), (512, 1, 1), 0); del buf405  # reuse
    buf475 = reinterpret_tensor(buf379, (1, 512, 1), (512, 1, 1), 0); del buf379  # reuse
    buf476 = reinterpret_tensor(buf368, (1, 512, 1), (512, 1, 1), 0); del buf368  # reuse
    buf477 = reinterpret_tensor(buf342, (1, 512, 1), (512, 1, 1), 0); del buf342  # reuse
    buf478 = reinterpret_tensor(buf331, (1, 512, 1), (512, 1, 1), 0); del buf331  # reuse
    buf479 = reinterpret_tensor(buf305, (1, 512, 1), (512, 1, 1), 0); del buf305  # reuse
    buf480 = reinterpret_tensor(buf294, (1, 512, 1), (512, 1, 1), 0); del buf294  # reuse
    buf481 = reinterpret_tensor(buf268, (1, 512, 1), (512, 1, 1), 0); del buf268  # reuse
    buf482 = reinterpret_tensor(buf257, (1, 512, 1), (512, 1, 1), 0); del buf257  # reuse
    buf483 = reinterpret_tensor(buf231, (1, 512, 1), (512, 1, 1), 0); del buf231  # reuse
    buf484 = reinterpret_tensor(buf220, (1, 512, 1), (512, 1, 1), 0); del buf220  # reuse
    buf485 = reinterpret_tensor(buf194, (1, 512, 1), (512, 1, 1), 0); del buf194  # reuse
    buf486 = reinterpret_tensor(buf183, (1, 512, 1), (512, 1, 1), 0); del buf183  # reuse
    buf487 = reinterpret_tensor(buf157, (1, 512, 1), (512, 1, 1), 0); del buf157  # reuse
    buf488 = reinterpret_tensor(buf146, (1, 512, 1), (512, 1, 1), 0); del buf146  # reuse
    buf489 = reinterpret_tensor(buf120, (1, 512, 1), (512, 1, 1), 0); del buf120  # reuse
    buf490 = reinterpret_tensor(buf109, (1, 512, 1), (512, 1, 1), 0); del buf109  # reuse
    buf491 = reinterpret_tensor(buf83, (1, 512, 1), (512, 1, 1), 0); del buf83  # reuse
    buf492 = reinterpret_tensor(buf72, (1, 512, 1), (512, 1, 1), 0); del buf72  # reuse
    buf493 = reinterpret_tensor(buf46, (1, 512, 1), (512, 1, 1), 0); del buf46  # reuse
    buf494 = reinterpret_tensor(buf35, (1, 512, 1), (512, 1, 1), 0); del buf35  # reuse
    buf495 = reinterpret_tensor(buf6, (1, 512, 1), (512, 1, 1), 0); del buf6  # reuse
    cpp_fused__log_softmax_add_gelu_native_layer_norm_native_layer_norm_backward_nll_loss_forward_87(c_void_p(buf496.data_ptr()), c_void_p(buf470.data_ptr()), c_void_p(buf471.data_ptr()), c_void_p(buf472.data_ptr()), c_void_p(buf473.data_ptr()), c_void_p(buf474.data_ptr()), c_void_p(buf475.data_ptr()), c_void_p(buf476.data_ptr()), c_void_p(buf477.data_ptr()), c_void_p(buf478.data_ptr()), c_void_p(buf479.data_ptr()), c_void_p(buf480.data_ptr()), c_void_p(buf481.data_ptr()), c_void_p(buf482.data_ptr()), c_void_p(buf483.data_ptr()), c_void_p(buf484.data_ptr()), c_void_p(buf485.data_ptr()), c_void_p(buf486.data_ptr()), c_void_p(buf487.data_ptr()), c_void_p(buf488.data_ptr()), c_void_p(buf489.data_ptr()), c_void_p(buf490.data_ptr()), c_void_p(buf491.data_ptr()), c_void_p(buf492.data_ptr()), c_void_p(buf493.data_ptr()), c_void_p(buf494.data_ptr()), c_void_p(buf495.data_ptr()), c_void_p(buf463.data_ptr()), c_void_p(primals_206.data_ptr()), c_void_p(buf464.data_ptr()), c_void_p(buf465.data_ptr()), c_void_p(buf466.data_ptr()), c_void_p(buf467.data_ptr()), c_void_p(buf468.data_ptr()))
    return (buf496, reinterpret_tensor(buf463, (1, 512, 32005), (16386560, 32005, 1), 0), primals_4, primals_14, primals_20, primals_30, primals_36, primals_46, primals_52, primals_62, primals_68, primals_78, primals_84, primals_94, primals_100, primals_110, primals_116, primals_126, primals_132, primals_142, primals_148, primals_158, primals_164, primals_174, primals_180, primals_190, primals_196, primals_200, primals_205, primals_206, reinterpret_tensor(primals_204, (1, 512), (514, 1), 0), buf3, buf8, buf12, reinterpret_tensor(buf11, (512, 768), (768, 1), 0), buf25, reinterpret_tensor(buf24, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf26, (12, 64, 512), (32768, 1, 64), 0), buf22, reinterpret_tensor(buf16, (12, 64, 512), (32768, 1, 64), 0), buf28, buf29, buf33, buf37, buf38, buf39, buf40, buf44, buf48, buf49, buf62, reinterpret_tensor(buf61, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf63, (12, 64, 512), (32768, 1, 64), 0), buf59, reinterpret_tensor(buf53, (12, 64, 512), (32768, 1, 64), 0), buf65, buf66, buf70, buf74, buf75, buf76, buf77, buf81, buf85, buf86, buf99, reinterpret_tensor(buf98, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf100, (12, 64, 512), (32768, 1, 64), 0), buf96, reinterpret_tensor(buf90, (12, 64, 512), (32768, 1, 64), 0), buf102, buf103, buf107, buf111, buf112, buf113, buf114, buf118, buf122, buf123, buf136, reinterpret_tensor(buf135, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf137, (12, 64, 512), (32768, 1, 64), 0), buf133, reinterpret_tensor(buf127, (12, 64, 512), (32768, 1, 64), 0), buf139, buf140, buf144, buf148, buf149, buf150, buf151, buf155, buf159, buf160, buf173, reinterpret_tensor(buf172, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf174, (12, 64, 512), (32768, 1, 64), 0), buf170, reinterpret_tensor(buf164, (12, 64, 512), (32768, 1, 64), 0), buf176, buf177, buf181, buf185, buf186, buf187, buf188, buf192, buf196, buf197, buf210, reinterpret_tensor(buf209, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf211, (12, 64, 512), (32768, 1, 64), 0), buf207, reinterpret_tensor(buf201, (12, 64, 512), (32768, 1, 64), 0), buf213, buf214, buf218, buf222, buf223, buf224, buf225, buf229, buf233, buf234, buf247, reinterpret_tensor(buf246, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf248, (12, 64, 512), (32768, 1, 64), 0), buf244, reinterpret_tensor(buf238, (12, 64, 512), (32768, 1, 64), 0), buf250, buf251, buf255, buf259, buf260, buf261, buf262, buf266, buf270, buf271, buf284, reinterpret_tensor(buf283, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf285, (12, 64, 512), (32768, 1, 64), 0), buf281, reinterpret_tensor(buf275, (12, 64, 512), (32768, 1, 64), 0), buf287, buf288, buf292, buf296, buf297, buf298, buf299, buf303, buf307, buf308, buf321, reinterpret_tensor(buf320, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf322, (12, 64, 512), (32768, 1, 64), 0), buf318, reinterpret_tensor(buf312, (12, 64, 512), (32768, 1, 64), 0), buf324, buf325, buf329, buf333, buf334, buf335, buf336, buf340, buf344, buf345, buf358, reinterpret_tensor(buf357, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf359, (12, 64, 512), (32768, 1, 64), 0), buf355, reinterpret_tensor(buf349, (12, 64, 512), (32768, 1, 64), 0), buf361, buf362, buf366, buf370, buf371, buf372, buf373, buf377, buf381, buf382, buf395, reinterpret_tensor(buf394, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf396, (12, 64, 512), (32768, 1, 64), 0), buf392, reinterpret_tensor(buf386, (12, 64, 512), (32768, 1, 64), 0), buf398, buf399, buf403, buf407, buf408, buf409, buf410, buf414, buf418, buf419, buf432, reinterpret_tensor(buf431, (12, 512, 512), (262144, 1, 512), 0), reinterpret_tensor(buf433, (12, 64, 512), (32768, 1, 64), 0), buf429, reinterpret_tensor(buf423, (12, 64, 512), (32768, 1, 64), 0), buf435, buf436, buf440, buf444, buf445, buf446, buf447, buf451, buf455, buf456, buf457, buf461, buf462, buf466, buf468, reinterpret_tensor(primals_202, (32005, 768), (768, 1), 0), buf470, reinterpret_tensor(primals_198, (768, 768), (768, 1), 0), buf471, reinterpret_tensor(primals_194, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_192, (3072, 768), (768, 1), 0), buf472, reinterpret_tensor(primals_188, (768, 768), (768, 1), 0), reinterpret_tensor(primals_186, (768, 768), (768, 1), 0), reinterpret_tensor(primals_184, (768, 768), (768, 1), 0), reinterpret_tensor(primals_182, (768, 768), (768, 1), 0), buf473, reinterpret_tensor(primals_178, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_176, (3072, 768), (768, 1), 0), buf474, reinterpret_tensor(primals_172, (768, 768), (768, 1), 0), reinterpret_tensor(primals_170, (768, 768), (768, 1), 0), reinterpret_tensor(primals_168, (768, 768), (768, 1), 0), reinterpret_tensor(primals_166, (768, 768), (768, 1), 0), buf475, reinterpret_tensor(primals_162, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_160, (3072, 768), (768, 1), 0), buf476, reinterpret_tensor(primals_156, (768, 768), (768, 1), 0), reinterpret_tensor(primals_154, (768, 768), (768, 1), 0), reinterpret_tensor(primals_152, (768, 768), (768, 1), 0), reinterpret_tensor(primals_150, (768, 768), (768, 1), 0), buf477, reinterpret_tensor(primals_146, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_144, (3072, 768), (768, 1), 0), buf478, reinterpret_tensor(primals_140, (768, 768), (768, 1), 0), reinterpret_tensor(primals_138, (768, 768), (768, 1), 0), reinterpret_tensor(primals_136, (768, 768), (768, 1), 0), reinterpret_tensor(primals_134, (768, 768), (768, 1), 0), buf479, reinterpret_tensor(primals_130, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_128, (3072, 768), (768, 1), 0), buf480, reinterpret_tensor(primals_124, (768, 768), (768, 1), 0), reinterpret_tensor(primals_122, (768, 768), (768, 1), 0), reinterpret_tensor(primals_120, (768, 768), (768, 1), 0), reinterpret_tensor(primals_118, (768, 768), (768, 1), 0), buf481, reinterpret_tensor(primals_114, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_112, (3072, 768), (768, 1), 0), buf482, reinterpret_tensor(primals_108, (768, 768), (768, 1), 0), reinterpret_tensor(primals_106, (768, 768), (768, 1), 0), reinterpret_tensor(primals_104, (768, 768), (768, 1), 0), reinterpret_tensor(primals_102, (768, 768), (768, 1), 0), buf483, reinterpret_tensor(primals_98, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_96, (3072, 768), (768, 1), 0), buf484, reinterpret_tensor(primals_92, (768, 768), (768, 1), 0), reinterpret_tensor(primals_90, (768, 768), (768, 1), 0), reinterpret_tensor(primals_88, (768, 768), (768, 1), 0), reinterpret_tensor(primals_86, (768, 768), (768, 1), 0), buf485, reinterpret_tensor(primals_82, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_80, (3072, 768), (768, 1), 0), buf486, reinterpret_tensor(primals_76, (768, 768), (768, 1), 0), reinterpret_tensor(primals_74, (768, 768), (768, 1), 0), reinterpret_tensor(primals_72, (768, 768), (768, 1), 0), reinterpret_tensor(primals_70, (768, 768), (768, 1), 0), buf487, reinterpret_tensor(primals_66, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_64, (3072, 768), (768, 1), 0), buf488, reinterpret_tensor(primals_60, (768, 768), (768, 1), 0), reinterpret_tensor(primals_58, (768, 768), (768, 1), 0), reinterpret_tensor(primals_56, (768, 768), (768, 1), 0), reinterpret_tensor(primals_54, (768, 768), (768, 1), 0), buf489, reinterpret_tensor(primals_50, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_48, (3072, 768), (768, 1), 0), buf490, reinterpret_tensor(primals_44, (768, 768), (768, 1), 0), reinterpret_tensor(primals_42, (768, 768), (768, 1), 0), reinterpret_tensor(primals_40, (768, 768), (768, 1), 0), reinterpret_tensor(primals_38, (768, 768), (768, 1), 0), buf491, reinterpret_tensor(primals_34, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_32, (3072, 768), (768, 1), 0), buf492, reinterpret_tensor(primals_28, (768, 768), (768, 1), 0), reinterpret_tensor(primals_26, (768, 768), (768, 1), 0), reinterpret_tensor(primals_24, (768, 768), (768, 1), 0), reinterpret_tensor(primals_22, (768, 768), (768, 1), 0), buf493, reinterpret_tensor(primals_18, (768, 3072), (3072, 1), 0), reinterpret_tensor(primals_16, (3072, 768), (768, 1), 0), buf494, reinterpret_tensor(primals_12, (768, 768), (768, 1), 0), reinterpret_tensor(primals_10, (768, 768), (768, 1), 0), reinterpret_tensor(primals_8, (768, 768), (768, 1), 0), reinterpret_tensor(primals_6, (768, 768), (768, 1), 0), buf495, )


def benchmark_compiled_module(times=10, repeat=10):
    from torch._dynamo.testing import rand_strided
    from torch._inductor.utils import print_performance
    primals_1 = rand_strided((32005, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_2 = rand_strided((1, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_3 = rand_strided((514, 768), (768, 1), device='cpu', dtype=torch.float32)
    ...
    primals_202 = rand_strided((32005, 768), (768, 1), device='cpu', dtype=torch.float32)
    primals_203 = rand_strided((32005, ), (1, ), device='cpu', dtype=torch.float32)
    primals_204 = rand_strided((1, 514), (514, 1), device='cpu', dtype=torch.int64)
