...
# kernel path: /tmp/torchinductor_youkaichao/dv/cdvz7hszcrtecjvzy22y2f3wpfvquniqnyd62dbgzijsf45zs6zk.py
...
# kernel path: /tmp/torchinductor_youkaichao/u4/cu4iewlzub3vpgmawoqyz74xvfwydholts3xxz25cc7qcktsfpqp.py
...
# Source Nodes: [add_39, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
# add_39 => add_102
# end_loss => convert_element_type_4, div_25, full_default_4, ne_5, ne_6, neg_1, sum_17, sum_18, where_3
# end_positions => clamp_max_1, clamp_min_1
# start_loss => convert_element_type_3, div_24, full_default_2, ne_2, ne_3, neg, sum_14, sum_15, where_1
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_cumsum_ne_0.run(arg200_1, buf0, 512, grid=grid(512), stream=stream0)
        # Source Nodes: [cumsum, mask, ne], Original ATen: [aten._to_copy, aten.cumsum, aten.ne]
        ...
        # Source Nodes: [add, embeddings, embeddings_1, embeddings_2, incremental_indices, inputs_embeds, long, mask, ne, position_embeddings, position_ids, token_type_embeddings, type_as], Original ATen: [aten._to_copy, aten.add, aten.embedding, aten.mul, aten.native_layer_norm, aten.ne]
        triton_per_fused__to_copy_add_embedding_mul_native_layer_norm_ne_1.run(arg200_1, arg0_1, arg199_1, arg1_1, buf2, arg2_1, arg3_1, arg4_1, buf3, buf7, 512, 768, grid=grid(512), stream=stream0)
        del arg0_1
        del arg199_1
        del arg1_1
        del arg200_1
        ...
        del buf276
        del buf279
        buf284 = empty((512, 2), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(reinterpret_tensor(buf283, (512, 768), (768, 1), 0), reinterpret_tensor(arg197_1, (768, 2), (1, 768), 0), out=buf284)
        del arg197_1
        del buf283
        ...
        # Source Nodes: [start_logits_1, start_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_5.run(buf284, arg198_1, buf285, buf286, buf287, 1, 512, grid=grid(1), stream=stream0)
        buf288 = empty((1, 512), device='cuda', dtype=torch.float32)
        buf289 = empty((1, 1), device='cuda', dtype=torch.float32)
        buf290 = empty((1, 1), device='cuda', dtype=torch.float32)
        # Source Nodes: [end_logits_1, end_loss], Original ATen: [aten._log_softmax, aten.clone]
        triton_per_fused__log_softmax_clone_6.run(buf284, arg198_1, buf288, buf289, buf290, 1, 512, grid=grid(1), stream=stream0)
        del arg198_1
        del buf284
        buf291 = reinterpret_tensor(buf286, (), (), 0); del buf286  # reuse
        buf292 = buf291; del buf291  # reuse
        # Source Nodes: [add_39, end_loss, end_positions, start_loss, start_positions, total_loss], Original ATen: [aten.add, aten.clamp, aten.div, aten.nll_loss_forward]
        triton_poi_fused_add_clamp_div_nll_loss_forward_7.run(buf292, arg201_1, buf285, buf287, arg202_1, buf288, buf289, buf290, 1, grid=grid(1), stream=stream0)
        del arg201_1
        del arg202_1
        return (buf292, buf285, buf288, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg201_1 = rand_strided((1, ), (1, ), device='cuda:0', dtype=torch.int64)
