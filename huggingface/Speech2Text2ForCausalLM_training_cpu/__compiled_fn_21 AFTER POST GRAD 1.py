...
def forward(self, primals_9: "f32[256]", primals_15: "f32[256]", view: "f32[128, 256]", view_16: "f32[128, 256]", getitem_1: "b8[1, 128, 256]", mul_1: "f32[1, 128, 256]", view_18: "f32[128, 256]", view_20: "f32[128, 2048]", getitem_5: "b8[1, 128, 256]", mul_3: "f32[1, 128, 256]", div_1: "f32[1, 128, 1]", permute_11: "f32[256, 2048]", le: "b8[1, 128, 2048]", permute_15: "f32[2048, 256]", div_2: "f32[1, 128, 1]", permute_19: "f32[256, 256]", permute_24: "f32[4, 128, 128]", permute_25: "f32[4, 64, 128]", alias_3: "f32[4, 128, 128]", permute_26: "f32[4, 64, 128]", permute_27: "f32[4, 128, 64]", permute_31: "f32[256, 256]", permute_36: "f32[256, 256]", permute_40: "f32[256, 256]", tangents_1: "f32[1, 128, 256]", tangents_2: "f32[1, 4, 128, 64]", tangents_3: "f32[1, 4, 128, 64]"):
    ...
    view_22: "f32[128, 256]" = torch.ops.aten.reshape.default(mul_13, [128, 256]);  mul_13 = None
    ...
    view_23: "f32[256]" = torch.ops.aten.reshape.default(sum_6, [256]);  sum_6 = None
    ...
    view_25: "f32[128, 2048]" = torch.ops.aten.reshape.default(where, [128, 2048]);  where = None
    ...
    view_27: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(mm_2, [1, 128, 256]);  mm_2 = None
    ...
    view_28: "f32[128, 256]" = torch.ops.aten.reshape.default(mul_22, [128, 256]);  mul_22 = None
    ...
    view_29: "f32[256]" = torch.ops.aten.reshape.default(sum_12, [256]);  sum_12 = None
    permute_22: "f32[256, 256]" = torch.ops.aten.permute.default(permute_21, [1, 0]);  permute_21 = None
    view_30: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(mm_4, [1, 128, 256]);  mm_4 = None
    ...
    view_31: "f32[1, 128, 4, 64]" = torch.ops.aten.reshape.default(view_30, [1, 128, 4, 64]);  view_30 = None
    ...
    view_32: "f32[4, 128, 64]" = torch.ops.aten.reshape.default(permute_23, [4, 128, 64]);  permute_23 = None
    ...
    view_33: "f32[1, 4, 128, 128]" = torch.ops.aten.reshape.default(sub_9, [1, 4, 128, 128]);  sub_9 = None
    ...
    view_34: "f32[4, 128, 128]" = torch.ops.aten.reshape.default(view_33, [4, 128, 128]);  view_33 = None
    ...
    view_35: "f32[1, 4, 128, 64]" = torch.ops.aten.reshape.default(bmm_2, [1, 4, 128, 64]);  bmm_2 = None
    ...
    view_36: "f32[1, 4, 128, 64]" = torch.ops.aten.reshape.default(permute_28, [1, 4, 128, 64]);  permute_28 = None
    ...
    view_37: "f32[1, 4, 128, 64]" = torch.ops.aten.reshape.default(bmm_5, [1, 4, 128, 64]);  bmm_5 = None
    ...
    view_38: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(clone_8, [1, 128, 256]);  clone_8 = None
    ...
    view_39: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(clone_9, [1, 128, 256]);  clone_9 = None
    ...
    view_40: "f32[128, 256]" = torch.ops.aten.reshape.default(view_39, [128, 256]);  view_39 = None
    ...
    view_41: "f32[256]" = torch.ops.aten.reshape.default(sum_14, [256]);  sum_14 = None
    permute_34: "f32[256, 256]" = torch.ops.aten.permute.default(permute_33, [1, 0]);  permute_33 = None
    view_42: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(mm_6, [1, 128, 256]);  mm_6 = None
    ...
    view_43: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(clone_10, [1, 128, 256]);  clone_10 = None
    ...
    view_44: "f32[128, 256]" = torch.ops.aten.reshape.default(view_43, [128, 256]);  view_43 = None
    ...
    view_45: "f32[256]" = torch.ops.aten.reshape.default(sum_15, [256]);  sum_15 = None
    permute_39: "f32[256, 256]" = torch.ops.aten.permute.default(permute_38, [1, 0]);  permute_38 = None
    view_46: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(mm_8, [1, 128, 256]);  mm_8 = None
    ...
    view_47: "f32[128, 256]" = torch.ops.aten.reshape.default(mul_25, [128, 256]);  mul_25 = None
    ...
    view_48: "f32[256]" = torch.ops.aten.reshape.default(sum_16, [256]);  sum_16 = None
    permute_43: "f32[256, 256]" = torch.ops.aten.permute.default(permute_42, [1, 0]);  permute_42 = None
    view_49: "f32[1, 128, 256]" = torch.ops.aten.reshape.default(mm_10, [1, 128, 256]);  mm_10 = None
