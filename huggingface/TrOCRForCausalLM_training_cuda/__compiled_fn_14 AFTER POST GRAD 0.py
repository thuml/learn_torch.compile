...
def forward(self, primals_1: "f32[1024, 1024]", primals_2: "f32[1024]", primals_3: "f32[1024, 1024]", primals_4: "f32[1024]", primals_5: "f32[1024, 1024]", primals_6: "f32[1024]", primals_7: "f32[1024, 1024]", primals_8: "f32[1024]", primals_9: "f32[1024]", primals_10: "f32[1024]", primals_11: "f32[4096, 1024]", primals_12: "f32[4096]", primals_13: "f32[1024, 4096]", primals_14: "f32[1024]", primals_15: "f32[1024]", primals_16: "f32[1024]", primals_17: "f32[1, 256, 1024]", primals_18: "f32[1, 1, 256, 256]"):
    ...
    view: "f32[256, 1024]" = torch.ops.aten.reshape.default(primals_17, [256, 1024])
    permute: "f32[1024, 1024]" = torch.ops.aten.permute.default(primals_1, [1, 0]);  primals_1 = None
    
    # No stacktrace found for following nodes
    mm_default_2: "f32[256, 1024]" = torch.ops.aten.mm.default(view, permute)
    add_tensor_2: "f32[256, 1024]" = torch.ops.aten.add.Tensor(mm_default_2, primals_2);  mm_default_2 = primals_2 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:219, code: query_states = self.q_proj(hidden_states) * self.scaling
    view_1: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(add_tensor_2, [1, 256, 1024]);  add_tensor_2 = None
    ...
    # No stacktrace found for following nodes
    mm_default_1: "f32[256, 1024]" = torch.ops.aten.mm.default(view, permute_1)
    add_tensor_1: "f32[256, 1024]" = torch.ops.aten.add.Tensor(mm_default_1, primals_4);  mm_default_1 = primals_4 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:237, code: key_states = self._shape(self.k_proj(hidden_states), -1, bsz)
    view_3: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 256, 1024]);  add_tensor_1 = None
    ...
    view_4: "f32[1, 256, 16, 64]" = torch.ops.aten.reshape.default(view_3, [1, -1, 16, 64]);  view_3 = None
    ...
    # No stacktrace found for following nodes
    mm_default: "f32[256, 1024]" = torch.ops.aten.mm.default(view, permute_3)
    add_tensor: "f32[256, 1024]" = torch.ops.aten.add.Tensor(mm_default, primals_6);  mm_default = primals_6 = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:238, code: value_states = self._shape(self.v_proj(hidden_states), -1, bsz)
    view_6: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(add_tensor, [1, 256, 1024]);  add_tensor = None
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:200, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_7: "f32[1, 256, 16, 64]" = torch.ops.aten.reshape.default(view_6, [1, -1, 16, 64]);  view_6 = None
    ...
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/models/trocr/modeling_trocr.py:200, code: return tensor.view(bsz, seq_len, self.num_heads, self.head_dim).transpose(1, 2).contiguous()
    view_8: "f32[1, 256, 16, 64]" = torch.ops.aten.reshape.default(mul, [1, 256, 16, 64]);  mul = None
    ...
    view_9: "f32[16, 256, 64]" = torch.ops.aten.reshape.default(clone_2, [16, -1, 64]);  clone_2 = None
    ...
    view_10: "f32[16, 256, 64]" = torch.ops.aten.reshape.default(clone, [16, -1, 64])
    ...
    view_11: "f32[16, 256, 64]" = torch.ops.aten.reshape.default(clone_1, [16, -1, 64])
    ...
    view_12: "f32[1, 16, 256, 256]" = torch.ops.aten.reshape.default(bmm, [1, 16, 256, 256]);  bmm = None
    ...
    view_13: "f32[16, 256, 256]" = torch.ops.aten.reshape.default(add, [16, 256, 256]);  add = None
    ...
    view_14: "f32[1, 16, 256, 64]" = torch.ops.aten.reshape.default(bmm_1, [1, 16, 256, 64]);  bmm_1 = None
    ...
    view_15: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(clone_4, [1, 256, 1024]);  clone_4 = None
    ...
    view_16: "f32[256, 1024]" = torch.ops.aten.reshape.default(view_15, [256, 1024]);  view_15 = None
    ...
    view_17: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(addmm_3, [1, 256, 1024]);  addmm_3 = None
    ...
    sub_1: "f32[1, 256, 1024]" = torch.ops.aten.sub.Tensor(add_1, getitem_3);  add_1 = getitem_3 = None
    mul_1: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(sub_1, rsqrt);  sub_1 = None
    mul_2: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_1, primals_9)
    ...
    view_18: "f32[256, 1024]" = torch.ops.aten.reshape.default(add_3, [256, 1024])
    ...
    view_19: "f32[1, 256, 4096]" = torch.ops.aten.reshape.default(addmm_4, [1, 256, 4096])
    
    # File: /workspace/youkaichao/miniconda3/envs/build_torch/lib/python3.10/site-packages/transformers/activations.py:78, code: return self.act(input)
    mul_3: "f32[1, 256, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.5)
    mul_4: "f32[1, 256, 4096]" = torch.ops.aten.mul.Tensor(view_19, 0.7071067811865476);  view_19 = None
    ...
    view_20: "f32[256, 4096]" = torch.ops.aten.reshape.default(mul_5, [256, 4096]);  mul_5 = None
    ...
    view_21: "f32[1, 256, 1024]" = torch.ops.aten.reshape.default(addmm_5, [1, 256, 1024]);  addmm_5 = None
    ...
    sub_2: "f32[1, 256, 1024]" = torch.ops.aten.sub.Tensor(add_5, getitem_7);  add_5 = getitem_7 = None
    mul_6: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(sub_2, rsqrt_1);  sub_2 = None
    mul_7: "f32[1, 256, 1024]" = torch.ops.aten.mul.Tensor(mul_6, primals_15)
