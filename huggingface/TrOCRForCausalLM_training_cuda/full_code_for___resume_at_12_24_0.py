...
def __guard_0_for___resume_at_12_24(L):
    return (___guarded_code.valid) \
        ...
        and (___check_type_id(L['self'], 139560192)) \
        ...
        and (len(L['value'][9]) == 2) \
        and (___check_obj_id(L['__class__'], 119008128)) \
        ...
        and ((___skip_backend_check() or ___current_backend() == ___lookup_backend(140008926961168))) \
        and (___compile_config_hash() == 'bf53afe1d391542aa7854437d3dbf35e') \
