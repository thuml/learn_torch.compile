...
# kernel path: /tmp/torchinductor_youkaichao/m5/cm5qxtcgcvkpt5k7lzdpshgyrh5prxny47gn6eqjs26urybdhewk.py
...
# kernel path: /tmp/torchinductor_youkaichao/wq/cwqsrw5ni2nfvg6m7zqxoqwfqc2znexzvwvgr2hwgc3tpdgq4o2v.py
...
def call(args):
    ...
    assert_size_stride(primals_2, (1, 256, 1024), (262144, 1024, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.mm(reinterpret_tensor(primals_2, (256, 1024), (1024, 1), 0), reinterpret_tensor(primals_1, (1024, 50265), (1, 1024), 0), out=buf0)
        buf3 = empty((256, 50265), device='cuda', dtype=torch.float32)
        # Source Nodes: [loss], Original ATen: [aten._log_softmax]
        stream0 = get_cuda_stream(0)
        triton_red_fused__log_softmax_0.run(buf0, buf3, 256, 50265, grid=grid(256), stream=stream0)
        buf6 = empty((), device='cuda', dtype=torch.float32)
        buf5 = empty((), device='cuda', dtype=torch.float32)
        buf7 = buf6; del buf6  # reuse
        # Source Nodes: [loss], Original ATen: [aten.nll_loss_forward]
        triton_per_fused_nll_loss_forward_1.run(buf7, primals_3, buf3, buf5, 1, 256, grid=grid(1), stream=stream0)
        return (buf7, reinterpret_tensor(buf0, (1, 256, 50265), (12867840, 50265, 1), 0), primals_3, reinterpret_tensor(primals_2, (256, 1024), (1024, 1), 0), buf3, buf5, reinterpret_tensor(primals_1, (50265, 1024), (1024, 1), 0), )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_2 = rand_strided((1, 256, 1024), (262144, 1024, 1), device='cuda:0', dtype=torch.float32)
