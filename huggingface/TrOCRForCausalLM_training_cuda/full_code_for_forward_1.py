...
def __guard_1_for_forward(L):
    return (___guarded_code.valid) \
        ...
        and (___check_obj_id(L['self'], 140012205111568)) \
        and (L['self'].training == True) \
        and (___check_obj_id(L['__class__'], 153454512)) \
        and (___check_type_id(L['input_ids'], 83580768)) \
        ...
        and (___check_type_id(G['torch'].long, 140014188599040)) \
